...
undefined4
set_PIC16F1704_flash_point32_ter(undefined1 param_1,undefined1 param_2,byte param_3,byte param_4)

{
  ...
  if ((local_1c[0] == 1) && (local_1c[1] == 1)) {
    ...
    printf("\n--- %s failed! read_back_data[0] = 0x%02x, read_back_data[1] = 0x%02x\n\n",
           "set_PIC16F1704_flash_point32_ter",(uint)local_1c[0],(uint)local_1c[1]);
    uVar3 = 0;
  }
  return uVar3;
}
