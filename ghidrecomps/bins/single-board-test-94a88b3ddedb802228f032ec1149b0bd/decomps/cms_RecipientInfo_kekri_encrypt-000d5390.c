...

{
  ...
  if (*(uchar **)(iVar2 + 0x10) == (uchar *)0x0) {
    ERR_put_error(0x2e,0x88,0x82,"cms_env.c",0x2b6);
    uVar3 = 0;
  }
  else {
    iVar1 = AES_set_encrypt_key(*(uchar **)(iVar2 + 0x10),*(int *)(iVar2 + 0x14) << 3,&AStack_10c);
    if (iVar1 == 0) {
      out = (uchar *)CRYPTO_malloc(*(int *)(iVar4 + 0x14) + 8,"cms_env.c",0x2c0);
      if (out == (uchar *)0x0) {
        ERR_put_error(0x2e,0x88,0x41,"cms_env.c",0x2c3);
        uVar3 = 0;
      }
      else {
        iVar4 = AES_wrap_key(&AStack_10c,(uchar *)0x0,out,*(uchar **)(iVar4 + 0x10),
                             *(uint *)(iVar4 + 0x14));
        if (iVar4 < 1) {
          ERR_put_error(0x2e,0x88,0x9f,"cms_env.c",0x2ca);
          CRYPTO_free(out);
          uVar3 = 0;
        }
        else {
      ...
      ERR_put_error(0x2e,0x88,0x73,"cms_env.c",700);
      uVar3 = 0;
    }
