...
void smb_format_message(int *param_1,void *param_2,undefined1 param_3,short param_4)

{
  ...
  *(undefined1 *)((int)param_2 + 8) = param_3;
  *(undefined4 *)((int)param_2 + 4) = 0x424d53ff;
  *(undefined1 *)((int)param_2 + 0xd) = 0x18;
  *(undefined1 *)((int)param_2 + 0xe) = 0x41;
  *(undefined1 *)((int)param_2 + 0xf) = 0;
  *(ushort *)((int)param_2 + 2) = (param_4 + 0x20U) * 0x100 | (ushort)(param_4 + 0x20U) >> 8;
  *(short *)((int)param_2 + 0x20) = (short)param_1[0xf6];
