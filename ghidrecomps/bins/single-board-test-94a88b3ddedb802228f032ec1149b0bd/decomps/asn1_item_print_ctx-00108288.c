...

{
  ...
  case '\x04':
    ...
    iVar4 = (**(code **)(pcVar7 + 0x18))(param_1,param_2,param_3,&DAT_0013a6fc,param_8);
    if (iVar4 == 0) {
      return 0;
    }
    if (iVar4 != 2) {
...
LAB_001084c8:
  ...
  if (uVar3 == 0xfffffffc) {
    ...
    if (-1 < (int)(*param_8 << 0x1b)) goto LAB_00108750;
LAB_00108596:
    if (uVar3 != 5) {
LAB_0010859e:
      switch(uVar3) {
    ...
    if (-1 < (int)(*param_8 << 0x1c)) goto LAB_00108596;
LAB_00108750:
