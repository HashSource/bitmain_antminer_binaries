...

{
  ...
  *param_1 = (int)uVar1;
  ...
  if ((CARRY4(uVar5,uVar3)) && (bVar8 = uVar4 == 0xffffffff, uVar4 = uVar4 + 1, bVar8)) {
    uVar3 = 1;
  }
  else {
    uVar3 = 0;
