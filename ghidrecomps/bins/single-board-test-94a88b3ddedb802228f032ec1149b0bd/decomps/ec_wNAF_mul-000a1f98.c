...
LAB_000a1fb4:
  ...
  if (param_4 != (EC_POINT *)0x0) {
    ...
    while (*(int *)param_1 == iVar7) {
      pEVar8 = pEVar8 + 1;
      if (pEVar8 == param_4) goto LAB_000a2002;
      puVar1 = puVar1 + 1;
      iVar7 = *(int *)*puVar1;
    }
    iVar7 = 0x172;
...
LAB_000a22cc:
    ...
    local_70 = (EC_POINT *)
               EC_EX_DATA_get_data(*(undefined4 *)(param_1 + 0x44),0xa1d4d,0xa1f49,0xa1ee9);
    ...
    if (pEVar14 == pEVar11 + (int)pEVar13 * 4) {
      ...
      if (pEVar10 == (EC_POINT *)0x0) {
        ...
        for (local_70 = (EC_POINT *)0x0; local_70 != pEVar9; local_70 = local_70 + 1) {
          ...
          if (pEVar14 == (EC_POINT *)0x0) goto LAB_000a2188;
