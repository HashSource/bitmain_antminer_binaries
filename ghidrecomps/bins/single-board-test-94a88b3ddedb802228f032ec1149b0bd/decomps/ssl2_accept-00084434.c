...

{
  ...
  *piVar5 = 0;
  uVar6 = param_1->state;
  if (0x2041 < (int)uVar6) goto LAB_000844ec;
LAB_000844a4:
  if (0x203f < (int)uVar6) {
    if (uVar6 == 0x2040) {
...
LAB_00084b66:
        ...
        if (iVar7 < 1) goto LAB_000846ca;
      }
      else {
        pBVar12 = param_1->init_buf;
        pcVar8 = pBVar12->data;
        if (uVar6 == 0x2011) goto LAB_00084c3c;
        psVar15 = param_1->s2;
LAB_00084554:
        pcVar8 = pBVar12->data;
        ...
        if (iVar22 != iVar7) goto LAB_00084b66;
...
LAB_000844ce:
      ...
      if (uVar20 == uVar6) goto LAB_000844e2;
      do {
        param_1->state = uVar6;
...
LAB_000844e2:
        do {
          uVar6 = uVar20;
          if (uVar6 < 0x2042) goto LAB_000844a4;
LAB_000844ec:
          if ((int)uVar6 < 0x2062) {
            if (0x205f < (int)uVar6) {
              if (uVar6 == 0x2060) {
            ...
            if (1 < uVar6 - 0x2050) goto LAB_000846b4;
            pcVar8 = param_1->init_buf->data;
            if (uVar6 == 0x2050) {
...
LAB_00084aa6:
              ...
              iVar7 = ssl2_read(param_1,pcVar8 + param_1->init_num,iVar22);
              if (iVar7 < iVar22) goto LAB_00084c86;
              if (param_1->msg_callback != (_func_3292 *)0x0) {
                (*param_1->msg_callback)
          ...
          if (uVar6 != 0x2080) {
            if (0x2080 < (int)uVar6) {
              if ((uVar6 == 0x4000) || (uVar6 == 0x6000)) goto LAB_00084912;
              goto LAB_000846b4;
            }
            if (3 < uVar6 - 0x2070) goto LAB_000846b4;
...
LAB_000850e6:
                ...
                if (iVar7 < 3 - param_1->init_num) goto LAB_00084f28;
...
LAB_00084682:
              ...
              if (uVar6 == 0x2071) goto LAB_000850cc;
              if (uVar6 == 0x2072) {
...
LAB_00084a2c:
    ...
    if (uVar6 == 0x2000) goto LAB_00084912;
    if (uVar6 == 0x2003) goto LAB_00084912;
    if (uVar6 != 3) goto LAB_000846b4;
...
LAB_000846b4:
  ...
  if (0x2021 < (int)uVar6) {
    if (1 < uVar6 - 0x2030) goto LAB_000846b4;
    pBVar12 = param_1->init_buf;
...
LAB_000852e0:
      ...
      if (iVar22 != iVar7) goto LAB_00084b7a;
      if (param_1->msg_callback != (_func_3292 *)0x0) {
        (*param_1->msg_callback)
...
LAB_00084912:
  ...
  if (param_1->init_buf == (BUF_MEM *)0x0) {
    pBVar12 = BUF_MEM_new();
    if (pBVar12 == (BUF_MEM *)0x0) goto LAB_00084e6a;
