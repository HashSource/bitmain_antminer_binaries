...
LAB_00121ff6:
  ...
  uVar8 = *n->d;
  if ((uVar8 & 1) == 0) {
    if ((iVar7 != 1) || (uVar8 != 2)) goto LAB_00121ff6;
    if (ret != (BIGNUM *)0x0) {
    ...
    if ((iVar7 == 1) && (uVar8 == 1)) goto LAB_00121ff6;
    iVar7 = a->top;
    if ((iVar7 == 0) || (((iVar7 == 1 && (*a->d == 1)) && (a->neg == 0)))) {
      pBVar5 = ret;
      if (ret == (BIGNUM *)0x0) {
        pBVar5 = BN_new();
        if (pBVar5 == (BIGNUM *)0x0) goto LAB_0012206a;
        iVar7 = a->top;
      }
      if ((iVar7 == 1) && (*a->d == 1)) {
        uVar1 = 1 - a->neg;
...
LAB_00122122:
                ...
                if (-1 < iVar3) {
                  pcVar10 = (code *)0xef101;
                  if (n->neg != 0) {
                    pcVar10 = (code *)0xef09d;
                  }
              ...
              if (iVar3 + 1 < 0 != SCARRY4(iVar3,1)) goto LAB_00122066;
              if (iVar3 == 0) {
                iVar7 = 0xf9;
LAB_001223d2:
...
joined_r0x0012237e:
  if (iVar3 == 0) goto LAB_00122066;
  if (((pBVar6->top == 1) && (*pBVar6->d == 1)) && (pBVar6->neg == 0)) goto LAB_00122224;
  ...
  if (pBVar2 == (BIGNUM *)0x0) goto LAB_00122066;
  iVar7 = iVar7 - iVar9;
  ...
  if ((iVar7 == 0) || (iVar7 = BN_mod_mul(r_00,r_00,r,n,ctx), iVar7 == 0)) goto LAB_00122066;
