...
LAB_000d3d4e:
  if (-1 < (int)(flags << 0x1d)) {
    ...
    if (pkey != (EVP_PKEY *)0x0) {
      iVar10 = ASN1_item_verify((ASN1_ITEM *)OCSP_RESPDATA_it,bs->signatureAlgorithm,bs->signature,
  ...
  if (iVar10 < 1) {
    ...
    if (iVar10 < 1) {
      ...
      if (iVar10 < 1) {
        ...
        puVar3 = (undefined4 *)sk_value(p_Var11,0);
        local_b8 = (OCSP_CERTID *)*puVar3;
        if (iVar10 != 1) {
          iVar1 = 1;
          do {
            puVar3 = (undefined4 *)sk_value(p_Var11,iVar1);
            b = (OCSP_CERTID *)*puVar3;
            iVar1 = iVar1 + 1;
...
LAB_000d3dd4:
  ...
  if (st_00 != (_STACK *)0x0) {
    sk_pop_free(st_00,(func *)0xb7c0d);
  }
LAB_000d3d1e:
