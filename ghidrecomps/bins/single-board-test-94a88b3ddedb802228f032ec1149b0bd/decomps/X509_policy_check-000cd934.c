...
LAB_000cdd2e:
        ...
        if (iVar15 < 0) goto LAB_000cdc48;
        if (iVar15 <= local_60) {
          local_60 = iVar15;
        }
        if (iVar16 != 0) goto LAB_000cdd2e;
LAB_000cdc4e:
            ...
            if (iVar15 != iVar1) {
              for (iVar1 = 0; iVar15 = sk_num(p_Var3), iVar1 < iVar15; iVar1 = iVar1 + 1) {
                ...
                if (iVar15 == 0) {
                  ...
                  if (puVar9 == (uint *)0x0) goto LAB_000cda7a;
...
LAB_000cdf56:
      do {
        ...
        iVar17 = iVar14 + 1;
        if (iVar15 <= iVar14) goto LAB_000ce066;
...
LAB_000ce066:
  iVar16 = iVar16 + 1;
  if (*(int *)(tree + 4) <= iVar16) goto LAB_000ce082;
  iVar1 = *(int *)(iVar11 + 0x18);
  HintPreloadData(iVar11 + 0x48);
  iVar11 = iVar11 + 0x10;
  if (iVar1 == 0) goto LAB_000ce082;
  goto LAB_000cdf50;
  while( true ) {
    if (st == (_STACK *)0x0) {
      st = sk_new_null();
