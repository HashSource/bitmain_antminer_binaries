...

{
  ...
  EC_EX_DATA_free_data(param_1 + 0x44,0xa1d4d,0xa1f49,0xa1ee9);
              ...
              if (iVar2 != 0) {
                ...
                if (iVar2 != 0) {
                  *ptr = param_1;
                  ...
                  ptr[3] = local_38;
                  ptr[5] = num;
                  iVar2 = EC_EX_DATA_set_data(param_1 + 0x44,ptr,0xa1d4d,0xa1f49,0xa1ee9);
                  if (iVar2 == 0) {
                    points = (EC_POINT *)0x0;
                    uVar9 = 0;
                  }
...
LAB_000a290a:
      ...
      if (ptr == (undefined4 *)0x0) goto LAB_000a2936;
    }
  }
