...

{
  ...
  for (iVar10 = 0; iVar3 = sk_num(&db->data->stack), iVar10 < iVar3; iVar10 = iVar10 + 1) {
    ...
    if (*(char *)*puVar2 == 'I') {
      ...
      if (puVar4 == (undefined4 *)0x0) goto LAB_000d7e58;
...
LAB_000d7ee0:
        ...
        *puVar7 = pcVar13;
        if (pcVar13 != (char *)0x0) goto LAB_000d7ee0;
LAB_000d7f16:
        local_3c = (char *)0x4;
      }
      BN_free((BIGNUM *)puVar7[1]);
...
LAB_000d7e3a:
      ...
      local_3c = (char *)0x2;
      if (puVar2 == (undefined4 *)0x0) goto LAB_000d7e58;
    }
    else {
      iVar10 = 0;
      do {
        iVar3 = sk_num(sk);
        iVar6 = iVar10 + 1;
        if (iVar3 <= iVar10) goto LAB_000d7e3a;
