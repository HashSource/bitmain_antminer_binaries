...
int int_new_ex_data(undefined4 param_1,undefined4 param_2,undefined4 *param_3)
    ...
    if (iVar2 < 1) {
      ...
      if (ptr == (undefined4 *)0x0) {
        ...
        do {
          ...
          if ((puVar9 != (undefined4 *)0x0) && (pcVar7 = (code *)puVar9[2], pcVar7 != (code *)0x0))
          {
