...

{
  ...
  iVar2 = Curl_MD5_init(&Curl_DIGEST_MD5);
  iVar3 = 0x1b;
  if (iVar2 != 0) {
    ...
    do {
      ...
      iVar3 = iVar3 + 1;
      curl_msnprintf(auStack_3c + iVar2,3,&DAT_001397a8,*puVar1);
    } while (iVar3 != 0x10);
    iVar3 = Curl_pp_sendf(param_1 + 0x3c0,"APOP %s %s",*(undefined4 *)(param_1 + 0x120),auStack_3c);
    if (iVar3 == 0) {
