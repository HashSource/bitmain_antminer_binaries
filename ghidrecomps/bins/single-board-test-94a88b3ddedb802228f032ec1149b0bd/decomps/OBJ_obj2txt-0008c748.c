...

{
  ...
  if (uVar11 == 0) {
    ...
    if ((added == (_LHASH *)0x0) ||
      ...
      uVar11 = *(uint *)(&DAT_00147268 + *piVar7 * 0x18);
    }
    else {
      uVar11 = *(uint *)(*(int *)((int)pvVar5 + 4) + 8);
    }
    if (uVar11 != 0) goto LAB_0008c980;
  }
  else {
LAB_0008c980:
    if (uVar11 < 0x3be) {
      puVar10 = &nid_objs + uVar11 * 0x18;
      if (*(int *)(&DAT_00147268 + uVar11 * 0x18) == 0) {
        iVar13 = 0x176;
        goto LAB_0008c99c;
      }
LAB_0008ca0e:
...
LAB_0008c782:
  ...
  do {
    ...
    while( true ) {
      ...
      bVar1 = *pbVar16;
      iVar13 = iVar13 + -1;
      if ((iVar13 == 0 & bVar1 >> 7) != 0) goto joined_r0x0008ca68;
      if (bVar14) {
