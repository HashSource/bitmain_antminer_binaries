...
LAB_0003fbf0:
    ...
    *(undefined1 *)(param_1 + 0x7f) = 0;
    ...
    uVar7 = 0;
LAB_0003fbb6:
    if ((int)((iVar9 - uVar7) - (uint)(uVar8 < sVar5)) < 0 !=
        (SBORROW4(iVar9,uVar7) != SBORROW4(iVar9 - uVar7,(uint)(uVar8 < sVar5)))) {
      uVar2 = 1;
    }
    *(undefined1 *)(param_1 + 0x7f) = 0;
  ...
  if ((((*(int *)(iVar10 + 0x8634) == 8) || (*(int *)(iVar10 + 0x8624) == 8)) ||
    ...
    if ((((int)((uVar7 - iVar9) - (uint)(sVar5 < uVar8)) < (int)(uint)(sVar5 - uVar8 < 2000)) ||
        (param_1[0x9d] != 0)) || (param_1[0xa3] != 0)) {
      if (cVar1 != '\0') {
        return 0;
      }
      *(undefined1 *)(param_1 + 0x7f) = 1;
      Curl_infof(iVar10,"Rewind stream after send\n");
      return 0;
    }
    if (*(char *)((int)param_1 + 0x1ed) != '\0') {
      return 0;
    }
    Curl_infof(iVar10,"NTLM send, close instead of sending %lld bytes\n");
  }
