...

{
  ...
  *param_1 = (int)((ulonglong)uVar4 * (ulonglong)uVar3);
  ...
  if ((CARRY4(uVar6,uVar4)) && (bVar8 = uVar3 == 0xffffffff, uVar3 = uVar3 + 1, bVar8)) {
    uVar4 = 1;
  }
  else {
    uVar4 = 0;
