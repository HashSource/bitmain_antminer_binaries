...

{
  ...
  for (iVar1 = 0; iVar2 = sk_num(param_1), iVar1 < iVar2; iVar1 = iVar1 + 1) {
    puVar3 = (undefined4 *)sk_value(param_1,iVar1);
    BIO_printf(param_2,"%*s",param_3 + 2,&DAT_0013a6fc);
    ...
    if (gen->type == 7) {
      ...
      if (psVar5 == (stack_st_X509_NAME_ENTRY *)0x8) {
        ...
        BIO_puts(param_2,"/");
        BIO_printf(param_2,"%X",
                   (uint)CONCAT11(*(undefined1 *)&pBVar4[1].data,
                                  *(undefined1 *)((int)&pBVar4[1].data + 1)));
        BIO_puts(param_2,":");
        BIO_printf(param_2,"%X",
                   (uint)CONCAT11(*(undefined1 *)((int)&pBVar4[1].data + 2),
                                  *(undefined1 *)((int)&pBVar4[1].data + 3)));
        BIO_puts(param_2,":");
        BIO_printf(param_2,"%X",
                   (uint)CONCAT11((char)pBVar4[1].max,*(undefined1 *)((int)&pBVar4[1].max + 1)));
        BIO_puts(param_2,":");
        BIO_printf(param_2,"%X",
                   (uint)CONCAT11(*(undefined1 *)((int)&pBVar4[1].max + 2),
                                  *(undefined1 *)((int)&pBVar4[1].max + 3)));
        BIO_puts(param_2,":");
        BIO_printf(param_2,"%X",
                   (uint)CONCAT11((char)pBVar4[2].length,*(undefined1 *)((int)&pBVar4[2].length + 1)
                                 ));
        BIO_puts(param_2,":");
        BIO_printf(param_2,"%X",
                   (uint)CONCAT11(*(undefined1 *)((int)&pBVar4[2].length + 2),
                                  *(undefined1 *)((int)&pBVar4[2].length + 3)));
        BIO_puts(param_2,":");
        BIO_printf(param_2,"%X",
                   (uint)CONCAT11(*(undefined1 *)&pBVar4[2].data,
                                  *(undefined1 *)((int)&pBVar4[2].data + 1)));
        BIO_puts(param_2,":");
        BIO_printf(param_2,"%X",
                   (uint)CONCAT11(*(undefined1 *)((int)&pBVar4[2].data + 2),
                                  *(undefined1 *)((int)&pBVar4[2].data + 3)));
      }
      else {
