...

{
  ...
  if (iVar4 < 0) {
    ...
    if (bVar1) {
      ...
      pcVar6 = (char *)_cgmalloc(sVar9 + 10,"api-btm.c","mcast",0x13f0);
      ...
      do {
        while( true ) {
          ...
          if ((opt_debug != false) &&
            ...
            snprintf(tmp42,0x800,"API mcast failed count=%d (%s) (%d)",count,pcVar11,mcast_sock);
        ...
        if (_Var3) {
          ...
          if ((sVar9 + 9 < (uint)rep) && (iVar4 = memcmp(buf,pcVar6,sVar9 + 9), iVar4 == 0)) {
            ...
            if (((int)pcVar12 < 1) || (0xffff < (int)pcVar12)) {
              if ((opt_debug != false) &&
                 (((use_syslog != false || (opt_log_output != false)) || (6 < opt_log_level)))) {
                ...
                if (reply_sock == -1) {
                  ...
                  if (sVar10 < 0) {
                    if ((opt_debug != false) &&
                      ...
                      piVar5 = __errno_location();
                      pcVar11 = strerror(*piVar5);
                      snprintf(tmp42,0x800,"API mcast send reply failed (%s) (%d)",pcVar11,
                               reply_sock);
                      _applog(7,tmp42,false);
                    }
                  }
