...

{
  ...
  if (val_local._4_4_ == 0 && (uint)val_local < 1000000000) {
    if (val_local._4_4_ == 0 && (uint)val_local < 1000000) {
      if (val_local._4_4_ == 0 && (uint)val_local < 1000) {
        dval = (double)__aeabi_ul2d((uint)val_local,val_local._4_4_);
        bVar1 = false;
      }
      else {
        dVar2 = (double)__aeabi_ul2d((uint)val_local,val_local._4_4_);
        dval = dVar2 / 1000.0;
        suffix[0] = 'K';
        suffix[1] = '\0';
      }
      ...
      dVar2 = (double)__aeabi_ul2d((int)uVar4,(int)((ulonglong)uVar4 >> 0x20));
      dval = dVar2 / 1000.0;
      suffix[0] = 'M';
      suffix[1] = '\0';
    }
  ...
  if (sigdigits == 0) {
    if (bVar1) {
      snprintf(buf,bufsiz,"%.3g%s",suffix,dval._0_4_,dval._4_4_,suffix);
    }
    else {
