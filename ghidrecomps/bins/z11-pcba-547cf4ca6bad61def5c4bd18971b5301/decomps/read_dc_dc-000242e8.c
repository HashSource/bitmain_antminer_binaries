...
undefined4
read_dc_dc(undefined1 param_1,undefined1 param_2,char param_3,undefined1 param_4,int param_5,
          int param_6)

{
  ...
  for (local_18 = 2; local_18 < 7; local_18 = local_18 + 1) {
    local_12 = local_12 + (ushort)local_3c[local_18];
  }
  uVar2 = (undefined1)((ushort)local_12 >> 8);
  local_34 = (undefined1)local_12;
  ...
  for (local_13 = 0; (uint)local_13 < local_1d + 2; local_13 = local_13 + 1) {
    write_pic(param_2,param_1,local_3c[local_13]);
  }
  usleep(100000);
