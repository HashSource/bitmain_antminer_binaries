...

{
  ...
  while( true ) {
    ...
    if (((use_syslog != false) || (opt_log_output != false)) || (4 < opt_log_level)) {
      builtin_strncpy(tmp42,"initiate_stratum",0x10);
          ...
          if (pcVar8 != (char *)0x0) {
            ...
            if (val == (json_t *)0x0) {
              ...
              if (((pjVar9 == (json_t *)0x0) ||
                ...
                _Var5 = _valid_hex(s_00,"util.c","initiate_stratum",0xcfd);
                uVar4 = tmp42._44_4_;
                if (_Var5) {
                  ...
                  if (((int)uVar10 < 2) || (0x10 < (int)uVar10)) {
                    ...
                    pool->n1_len = sVar6 >> 1;
                    free(pool->nonce1bin);
                    puVar12 = (uchar *)_cgcalloc(pool->n1_len,1,"util.c","initiate_stratum",0xd19);
