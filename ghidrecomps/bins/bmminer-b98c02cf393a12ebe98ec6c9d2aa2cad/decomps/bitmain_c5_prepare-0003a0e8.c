...

{
  ...
  *(int *)((int)__mutex + 0x29c) = param_1;
  iVar3 = pthread_mutex_init((pthread_mutex_t *)((int)__mutex + 0x2a4),(pthread_mutexattr_t *)0x0);
  if (iVar3 == 0) {
  ...
  iVar3 = pthread_mutex_init((pthread_mutex_t *)((int)__mutex + 0x3b4),(pthread_mutexattr_t *)0x0);
  if (iVar3 != 0) {
    _mutex_init_part_3_constprop_28(0x40e5);
  }
  _rwlock_init_constprop_22((int)__mutex + 0x3cc,0x40e5);
  iVar3 = pthread_mutex_init((pthread_mutex_t *)((int)__mutex + 0xaec),(pthread_mutexattr_t *)0x0);
  if (iVar3 != 0) {
    _mutex_init_part_3_constprop_28(0x40e6);
  }
  _rwlock_init_constprop_22((int)__mutex + 0xb04,0x40e6);
  iVar3 = pthread_mutex_init((pthread_mutex_t *)((int)__mutex + 0x1224),(pthread_mutexattr_t *)0x0);
  if (iVar3 != 0) {
  ...
  local_34 = CONCAT31(local_34._1_3_,(opt_bitmain_fan_ctrl & 1) << 1) | 0xfd;
  bVar4 = 0x81;
  local_20 = CONCAT31(local_20._1_3_,4);
  local_20 = CONCAT22(400,(undefined2)local_20);
  local_1c = CONCAT22(local_1c._2_2_,600);
  bVar1 = 0xbc;
  bVar2 = 0xff;
  while (bVar5 = bVar1, __s != (byte *)((int)&local_1c + 1)) {
    __s = __s + 1;
    bVar1 = *__s ^ bVar4 ^ bVar2;
    bVar4 = chCRCHTalbe[bVar1];
    bVar1 = chCRCLTalbe[bVar1];
    bVar2 = bVar5;
  }
  local_1c = CONCAT22(CONCAT11(bVar5,bVar4 ^ bVar2),600);
  bitmain_c5_init(local_38,local_34,local_30,local_2c,local_28,uStack_24,local_20,local_1c);
  return 1;
}
