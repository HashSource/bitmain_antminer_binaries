...

{
  ...
  *param_2 = iVar2;
  ...
  if (iVar2 != 0) {
    ...
    _mutex_lock_part_47_constprop_75("get_work_by_nonce2",0x202b);
  }
  iVar2 = pthread_rwlock_wrlock((pthread_rwlock_t *)(param_3 + 0xec));
  if (iVar2 == 0) {
    unaff_r8 = "get_work_by_nonce2";
    ...
    *(undefined4 *)(param_3 + 0x274) = param_6;
    _cg_memcpy(param_3 + 0x62c,&param_7,4,"cgminer.c","get_work_by_nonce2",0x202f);
      ...
      if (iVar2 == 0) {
        ...
        *(uint *)(iVar2 + 0x1bc) = param_7;
        return;
                    ...
                    /* WARNING: Subroutine does not return */
      _mutex_unlock_noyield_part_48_constprop_77("get_work_by_nonce2",0x2030);
    }
  }
  else {
    _wr_lock_part_54_constprop_73("get_work_by_nonce2",0x202b);
  }
                    /* WARNING: Subroutine does not return */
