...

{
  ...
  if (iVar3 != 0) {
    _mutex_lock_part_3_constprop_27("minecoin",0xec1);
  }
  _rd_lock_constprop_25(0x80cc34,"minecoin",0xec1);
  iVar3 = pthread_mutex_unlock((pthread_mutex_t *)ch_lock);
  if (iVar3 != 0) {
    _mutex_unlock_noyield_part_5_constprop_32("minecoin",0xec1);
  }
  ...
  iVar3 = pthread_rwlock_unlock((pthread_rwlock_t *)(ch_lock + 0x18));
  if (iVar3 != 0) {
    _rw_unlock_part_4_constprop_30("minecoin",0xec4);
  }
  (*selective_yield)();
