...
void cg_logwork(int param_1,undefined1 *param_2,int param_3)

{
  ...
  if (opt_logwork_path != (char *)0x0) {
    ...
    puVar9 = &local_c88;
    puVar6 = (undefined1 *)((int)&uStack_c6c + 3);
    do {
      uVar1 = *(undefined1 *)puVar9;
      puVar11 = (undefined4 *)((int)puVar9 + 1);
      *(undefined1 *)puVar9 = *puVar6;
      *puVar6 = uVar1;
      puVar9 = puVar11;
      puVar6 = puVar6 + -1;
    } while (&local_c78 != puVar11);
    puVar6 = (undefined1 *)((int)&uStack_c60 + 3);
    puVar9 = &local_c68;
    do {
      uVar1 = *(undefined1 *)puVar9;
      puVar11 = (undefined4 *)((int)puVar9 + 1);
      ...
      *puVar6 = uVar1;
      puVar6 = puVar6 + -1;
      puVar9 = puVar11;
    } while ((undefined4 *)(auStack_c64 + 2) != puVar11);
    puVar6 = (undefined1 *)((int)&uStack_c2c + 3);
    puVar9 = &local_c48;
    do {
      uVar1 = *(undefined1 *)puVar9;
      puVar11 = (undefined4 *)((int)puVar9 + 1);
    ...
    uVar13 = uVar5;
    sprintf(acStack_c28,"%s %08x midstate %s data %s nonce %s hash %s diff %I64d",puVar7,
      ...
      if (g_logwork_file != (FILE *)0x0) {
        if (param_3 == 0) {
          ...
          if (opt_logwork_diff != '\0') {
            iVar3 = 0;
            do {
              uVar10 = (uint)(uVar12 >> 0x21);
              uVar8 = (uint)((uVar12 & 0x100000000) != 0) << 0x1f | (uint)uVar12 >> 1;
              uVar12 = CONCAT44(uVar10,uVar8);
