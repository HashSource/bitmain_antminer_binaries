...
undefined4 write_hash_ID_PIC16F1704(undefined1 param_1,undefined1 param_2,int param_3)

{
  ...
  local_30 = 0x1210aa55;
  for (local_13 = 0; local_13 < 0xc; local_13 = local_13 + 1) {
    *(undefined1 *)((int)&local_2c + (uint)local_13) = *(undefined1 *)(param_3 + (uint)local_13);
  }
  _local_20 = CONCAT11((char)local_12,uVar1);
  pthread_mutex_lock((pthread_mutex_t *)&i2c_mutex);
  for (local_13 = 0; local_13 < 0x12; local_13 = local_13 + 1) {
    write_pic(param_2,param_1,*(undefined1 *)((int)&local_30 + (uint)local_13));
  }
  usleep(400000);
  ...
  if ((local_1c[0] == 0x12) && (local_1c[1] == 1)) {
    ...
    printf("\n--- %s failed! read_back_data[0] = 0x%02x, read_back_data[1] = 0x%02x\n\n",
           "write_hash_ID_PIC16F1704",(uint)local_1c[0],(uint)local_1c[1]);
    uVar3 = 0;
  }
  return uVar3;
}
