...
int __fastcall zynq_set_iic(unsigned __int8 a1, unsigned __int8 a2, char a3, char a4, unsigned __int8 a5, unsigned __int8 a6);
...
_UNKNOWN *_frame_dummy_init_array_entry = (_UNKNOWN *)0x105DD; // weak
_UNKNOWN *_do_global_dtors_aux_fini_array_entry = (_UNKNOWN *)0x105C5; // weak
        ...
        unsigned __int8 a6)
{
  ...
  if ( a4 )
    v7 |= (a5 << 8) | 0x1000000;
  return set_iic(a6 | (a1 << 16) & 0x70000 | (a1 >> 3 << 20) & 0xF00000 | (a2 << 26) & 0xC000000 | v7);
}
...
// 20F08: using guessed type _UNKNOWN *_frame_dummy_init_array_entry;
// 20F0C: using guessed type _UNKNOWN *_do_global_dtors_aux_fini_array_entry;
