...
size_t __fastcall get_BM1722_asic_register(unsigned __int8 a1, char a2, char a3, char a4);
size_t __fastcall set_BM1722_asic_register(unsigned __int8 a1, char a2, char a3, char a4, int a5);
size_t __fastcall set_BM1722_freq(unsigned __int8 a1, char a2, char a3);
int __fastcall BM1722_chain_inactive(unsigned __int8 a1);
size_t __fastcall BM1722_set_address(unsigned __int8 a1, char a2);
unsigned int __fastcall BM1722_set_address_all(unsigned __int8 a1);
int __fastcall BM1722_open_core(unsigned __int8 a1);
unsigned int __fastcall check_BM1722_asic_reg(unsigned __int8 a1, char a2, char a3, char a4);
int singleAsicTest_BM1722();
int singleBoardTest_BBD12601();
size_t __fastcall get_BM1725_asic_register(unsigned __int8 a1, char a2, char a3, char a4);
size_t __fastcall set_BM1725_asic_register(unsigned __int8 a1, char a2, char a3, char a4, int a5);
size_t __fastcall BM1725_set_address(unsigned __int8 a1, char a2);
int __fastcall BM1725_chain_inactive(unsigned __int8 a1);
int __fastcall BM1725_set_address_all(unsigned __int8 a1);
size_t __fastcall set_BM1725_freq(unsigned __int8 a1, char a2, char a3);
int __fastcall BM1725_open_core(unsigned __int8 a1);
unsigned int __fastcall check_BM1725_asic_reg(unsigned __int8 a1, char a2, char a3, char a4);
...
size_t __fastcall enable_read_temperature_from_asic_chain(size_t result, char a2);
...
void __fastcall json_decref(int a1);
...
int __fastcall dump_to_strbuffer(const void *a1, size_t a2, int a3);
int __fastcall dump_to_file(const void *a1, size_t a2, FILE *a3);
...
int __fastcall do_dump(_DWORD *a1, int a2, int a3, int (__fastcall *a4)(const char *, int, int), int a5);
void *__fastcall json_dumps(_DWORD *a1, __int16 a2);
int __fastcall json_dumpf(_DWORD *a1, int a2, __int16 a3);
int __fastcall json_dump_file(_DWORD *a1, const char *a2, __int16 a3);
...
int __fastcall list_insert(int result, _DWORD *a2);
_DWORD *__fastcall list_remove(_DWORD *result);
bool __fastcall bucket_is_empty(int a1, _DWORD *a2);
int __fastcall insert_to_bucket(int a1, int *a2, _DWORD *a3);
int __fastcall num_buckets(int a1);
int __fastcall hashtable_find_pair(int a1, int *a2, const char *a3, int a4);
int __fastcall hashtable_do_del(_DWORD *a1, const char *a2, unsigned int a3);
...
int __fastcall hashtable_set(unsigned int *a1, char *a2, int a3, int a4);
int __fastcall hashtable_get(int a1, char *a2);
int __fastcall hashtable_del(_DWORD *a1, char *a2);
...
int __fastcall json_incref(int result);
void __fastcall json_decref_1(int a1);
int __fastcall json_object_set_nocheck(_DWORD *a1, char *a2, int a3);
int __fastcall json_array_append(_DWORD *a1, int a2);
int error_set(int result, _DWORD *a2, const char *a3, ...);
int __fastcall stream_init(int result, int a2, int a3);
int __fastcall stream_get(int a1, int a2);
_DWORD *__fastcall stream_unget(_DWORD *result, int a2);
int __fastcall lex_get(int a1, int a2);
int __fastcall lex_save(int a1, char a2);
...
int __fastcall lex_save_cached(int result);
int __fastcall decode_unicode_escape(_BYTE *a1);
void __fastcall lex_scan_string(int a1, int a2);
int __fastcall lex_scan_number(int a1, int a2, int a3);
int __fastcall lex_scan(int a1, int a2);
int __fastcall lex_steal_string(int a1);
int __fastcall lex_init(int a1, int a2, int a3);
void __fastcall lex_close(int a1);
_DWORD *__fastcall parse_object(_DWORD *a1, int a2, int a3);
_DWORD *__fastcall parse_array(_DWORD *a1, int a2, int a3);
void *__fastcall parse_value(double a1, int a2);
void *__fastcall parse_json(_DWORD *a1, unsigned int a2, int a3);
int __fastcall string_get(_DWORD *a1);
void *__fastcall json_loads(int a1, unsigned int a2, char *a3);
int __fastcall buffer_get(_DWORD *a1);
void *__fastcall json_loadb(int a1, int a2, unsigned int a3, char *a4);
void *__fastcall json_loadf(int a1, unsigned int a2, char *a3);
void *__fastcall json_load_file(const char *a1, unsigned int a2, char *a3);
int __fastcall callback_get(int a1);
void *__fastcall json_load_callback(int a1, int a2, unsigned int a3, char *a4);
void *__fastcall jsonp_malloc(size_t a1);
...
int __fastcall strbuffer_init(void **a1);
...
int __fastcall strbuffer_append(int a1, const char *a2);
...
_BYTE **__fastcall to_locale(const char **a1);
_BYTE *__fastcall from_locale(const char *a1);
...
int __fastcall utf8_check_first(unsigned __int8 a1);
...
int __fastcall json_array_append_0(_DWORD *a1, int a2);
_DWORD *__fastcall json_init(_DWORD *result, int a2);
_DWORD *json_object();
void __fastcall json_delete_object(void *a1);
int __fastcall json_object_size(_DWORD *a1);
...
int __fastcall json_object_equal(_DWORD *a1, _DWORD *a2);
_DWORD *__fastcall json_object_copy(_DWORD *a1);
_DWORD *__fastcall json_object_deep_copy(_DWORD *a1);
_DWORD *json_array();
void __fastcall json_delete_array(int a1);
int __fastcall json_array_size(_DWORD *a1);
...
void *__fastcall array_move(int a1, int a2, int a3, int a4);
void *__fastcall array_copy(int a1, int a2, int a3, int a4, size_t n);
void *__fastcall json_array_grow(_DWORD *a1, int a2, int a3);
int __fastcall json_array_append_new(_DWORD *a1, int a2);
int __fastcall json_array_insert_new(_DWORD *a1, size_t a2, int a3);
...
int __fastcall json_array_equal(_DWORD *a1, _DWORD *a2);
_DWORD *__fastcall json_array_copy(_DWORD *a1);
_DWORD *__fastcall json_array_deep_copy(_DWORD *a1);
_DWORD *__fastcall json_string_nocheck(const char *a1);
_DWORD *__fastcall json_string(const char *a1);
int __fastcall json_string_value(_DWORD *a1);
int __fastcall json_string_set_nocheck(int a1, const char *a2);
int __fastcall json_string_set(int a1, const char *a2);
void __fastcall json_delete_string(void **a1);
bool __fastcall json_string_equal(_DWORD *a1, _DWORD *a2);
_DWORD *__fastcall json_string_copy(_DWORD *a1);
...
bool __fastcall json_integer_equal(int a1, int a2);
_QWORD *__fastcall json_integer_copy(int a1);
...
int json_real_equal();
_QWORD *json_real_copy();
void __fastcall json_number_value(_DWORD *a1);
void *json_true();
void *json_false();
void *json_null();
void __fastcall json_delete(void **a1);
int __fastcall json_equal(_DWORD *a1, _DWORD *a2);
_DWORD *__fastcall json_copy(_DWORD *a1);
_QWORD *__fastcall json_deep_copy(_DWORD *a1);
char *__fastcall jsonp_error_init(char *result, const char *a2);
char *__fastcall jsonp_error_set_source(char *result, const char *a2);
int jsonp_error_set(int a1, int a2, int a3, int a4, char *format, ...);
int __fastcall jsonp_error_vset(int result, int a2, int a3, int a4, char *format, __gnuc_va_list arg); // idb
    ...
    if ( v13 )
    {
      ...
      for ( i = 0; i < v13; ++i )
      {
        ...
        if ( a1 == *(unsigned __int8 *)(reg_value_buf + 10 * *(_DWORD *)(reg_value_buf + 4) + 25) )
        {
          ...
          LOWORD(s[1]) = v5;
          BYTE2(s[1]) = v4;
          if ( CRC5(s, 0x33u) == *(unsigned __int8 *)(reg_value_buf + 10 * *(_DWORD *)(reg_value_buf + 4) + 24) )
          {
            if ( !a3 )
    ...
    if ( v13 )
    {
      ...
      for ( i = 0; i < v13; ++i )
      {
        ...
        if ( a1 == *(unsigned __int8 *)(reg_value_buf + 10 * *(_DWORD *)(reg_value_buf + 4) + 25) )
        {
          ...
          s[1] = v5;
          if ( CRC5(s, 0x3Bu) == *(unsigned __int8 *)(reg_value_buf + 10 * *(_DWORD *)(reg_value_buf + 4) + 24) )
          {
            if ( !a3 )
              printf(
  ...
  for ( i = 0; i <= 2; ++i )
  {
    ...
    if ( v4 )
    {
      ...
      do
      {
        if ( dword_336850 == 1722 )
        {
          result = check_BM1722_asic_reg(a1, gChain_Asic_Interval * (v4 - 1), 32, 0);
          v5 = result;
        }
        else if ( dword_336850 == 1725 )
        {
          result = check_BM1725_asic_reg(a1, gChain_Asic_Interval * (v4 - 1), 32, 0);
          v5 = result;
        }
        ++v3;
      }
  ...
  for ( i = 0; i <= 2; ++i )
  {
    ...
    if ( v15 )
    {
      ...
      do
      {
        if ( dword_336850 == 1722 )
        {
          v16 = check_BM1722_asic_reg(a1, gChain_Asic_Interval * (v15 - 1), 32, 0);
        }
        else if ( dword_336850 == 1725 )
        {
          v16 = check_BM1725_asic_reg(a1, gChain_Asic_Interval * (v15 - 1), 32, 0);
        }
        ++v14;
      }
  ...
  for ( i = 0; i <= 2; ++i )
  {
    ...
    if ( v9 )
    {
      ...
      do
      {
        if ( dword_336850 == 1722 )
        {
          result = check_BM1722_asic_reg(a1, gChain_Asic_Interval * (v9 - 1), 32, 0);
          v4 = result;
        }
        else if ( dword_336850 == 1725 )
        {
          result = check_BM1725_asic_reg(a1, gChain_Asic_Interval * (v9 - 1), 32, 0);
          v4 = result;
        }
        ++v6;
      }
  ...
  for ( i = 0; i <= 2; ++i )
  {
    ...
    if ( v7 )
    {
      ...
      do
      {
        if ( dword_336850 == 1722 )
        {
          v8 = check_BM1722_asic_reg(a1, gChain_Asic_Interval * (v7 - 1), 32, 0);
        }
        else if ( dword_336850 == 1725 )
        {
          v8 = check_BM1725_asic_reg(a1, gChain_Asic_Interval * (v7 - 1), 32, 0);
        }
        ++v4;
      }
...
unsigned int __fastcall blake32_close(_DWORD *a1, char a2, int a3, int a4, unsigned int a5)
{
  ...
  if ( v15 > 0x1BE )
  {
    ...
    result = blake32((unsigned int)a1, s, 0x40u);
  }
  else
  {
    ...
    sph_enc32be_aligned(&v9, v12);
    sph_enc32be_aligned(&v10, v13);
    result = blake32((unsigned int)a1, &s[v16], 64 - v16);
  }
  v11 = a4;
  for ( i = 0; i < a5; ++i )
...
int __fastcall hal_load_conf(const char *a1)
{
  ...
  int v9; // r0
  unsigned int v10; // r4
  char v13[252]; // [sp+8h] [bp+8h] BYREF
  ...
  _DWORD *v22; // [sp+124h] [bp+124h]
  _DWORD *v23; // [sp+128h] [bp+128h]
  _DWORD *file; // [sp+12Ch] [bp+12Ch]
  ...
  if ( file && !*file )
  {
    ...
    printf("json = %s \n", (const char *)ptr);
    free(ptr);
    v23 = (_DWORD *)json_object_get(file, "chain");
    if ( v23 && *v23 == 1 )
    {
      for ( i = 0; ; ++i )
      {
      ...
      v23 = (_DWORD *)json_object_get(file, "fan");
      if ( v23 && *v23 == 1 )
      {
        for ( j = 0; ; ++j )
        {
          ...
          if ( v10 >= json_array_size(v23) || j > 5 )
            break;
          v22 = (_DWORD *)json_array_get(v23, j);
          if ( !v22 || *v22 )
          {
        ...
        v22 = (_DWORD *)json_object_get(file, "red");
        if ( v22 && *v22 == 3 )
        {
          red_addr = json_integer_value((int)v22);
          v22 = (_DWORD *)json_object_get(file, "green");
          if ( v22 && *v22 == 3 )
          {
            green_addr = json_integer_value((int)v22);
            v22 = (_DWORD *)json_object_get(file, "reset");
            if ( v22 && *v22 == 3 )
            {
              reset_addr = json_integer_value((int)v22);
              v22 = (_DWORD *)json_object_get(file, "ipreport");
              if ( v22 && *v22 == 3 )
              {
...
int __fastcall dump_to_strbuffer(const void *a1, size_t a2, int a3)
{
  return strbuffer_append_bytes(a3, a1, a2);
}
...
int __fastcall do_dump(_DWORD *a1, int a2, int a3, int (__fastcall *a4)(const char *, int, int), int a5)
{
  ...
  int v22; // [sp+8Ch] [bp+84h]
  _DWORD *v23; // [sp+90h] [bp+88h]
  int v24; // [sp+94h] [bp+8Ch]
  _DWORD *v25; // [sp+98h] [bp+90h]
...
LABEL_74:
          ...
          while ( v33 )
          {
            *((_DWORD *)base + 2 * i) = hashtable_iter_serial(v33);
...
LABEL_60:
        ...
        else
        {
          while ( v33 )
          {
            ...
            if ( a4(v32, v31, a5) )
              goto LABEL_74;
            v11 = json_object_iter_value(v33);
...
LABEL_29:
        ...
        return -1;
      case 2:
        v8 = (unsigned __int8 *)json_string_value(a1);
...
// 22F98: using guessed type int dump_to_strbuffer();
...
int __fastcall insert_to_bucket(int a1, int *a2, _DWORD *a3)
{
  ...
  {
    result = list_insert(a1 + 12, a3);
    a2[1] = (int)a3;
    *a2 = a2[1];
  }
  else
  {
    result = list_insert(*a2, a3);
    *a2 = (int)a3;
  }
  return result;
}
...
int __fastcall hashtable_do_del(_DWORD *a1, const char *a2, unsigned int a3)
{
  _DWORD *pair; // [sp+14h] [bp+14h]
  int *v9; // [sp+18h] [bp+18h]

  v9 = (int *)(a1[1] + 8 * (a3 % num_buckets((int)a1)));
  pair = (_DWORD *)hashtable_find_pair((int)a1, v9, a2, a3);
  if ( !pair )
    return -1;
  if ( pair + 1 == (_DWORD *)*v9 && pair + 1 == (_DWORD *)v9[1] )
  {
    v9[1] = (int)(a1 + 3);
    *v9 = v9[1];
  }
  else if ( pair + 1 == (_DWORD *)*v9 )
  {
    *v9 = pair[2];
  }
  else if ( pair + 1 == (_DWORD *)v9[1] )
  {
    v9[1] = pair[1];
  }
  list_remove(pair + 1);
  json_decref_0(pair[3]);
  jsonp_free(pair);
  --*a1;
  return 0;
}
...
int __fastcall hashtable_do_rehash(int a1)
{
  ...
  *(_DWORD *)(a1 + 4) = jsonp_malloc(8 * v6);
  ...
  while ( (_DWORD *)(a1 + 12) != v8 )
  {
    v5 = (_DWORD *)v8[1];
    insert_to_bucket(a1, (int *)(*(_DWORD *)(a1 + 4) + 8 * (*(v8 - 1) % v6)), v8);
    v8 = v5;
  }
  return 0;
}
...
int __fastcall hashtable_set(unsigned int *a1, char *a2, int a3, int a4)
{
  ...
  {
    v15 = hash_str(a2);
    v14 = (int *)(a1[1] + 8 * (v15 % num_buckets((int)a1)));
    pair = hashtable_find_pair((int)a1, v14, a2, v15);
    if ( pair )
    {
    ...
    {
      v6 = strlen(a2);
      v13 = jsonp_malloc(v6 + 21);
      if ( !v13 )
        return -1;
      *(_DWORD *)v13 = v15;
      *((_DWORD *)v13 + 4) = a3;
      strcpy((char *)v13 + 20, a2);
      *((_DWORD *)v13 + 3) = a4;
      list_init((_DWORD *)v13 + 1);
      insert_to_bucket((int)a1, v14, (_DWORD *)v13 + 1);
      ++*a1;
    }
    return 0;
  }
...
int __fastcall hashtable_get(int a1, char *a2)
{
  ...
  v9 = hash_str(a2);
  v2 = *(_DWORD *)(a1 + 4);
  v8 = (int *)(v2 + 8 * (v9 % num_buckets(a1)));
  pair = hashtable_find_pair(a1, v8, a2, v9);
  if ( pair )
...
int error_set(int result, _DWORD *a2, const char *a3, ...)
{
  ...
  *(_DWORD *)v10 = s;
  if ( result )
  {
    ...
    if ( a2 )
    {
      v9 = (const char *)strbuffer_value((int)(a2 + 10));
      v13 = a2[6];
      v12 = a2[7];
      v11 = a2[9];
      if ( v9 && *v9 )
    ...
    return jsonp_error_set(v4, v13, v12, v11, "%s", *(const char **)v10);
  }
  return result;
}
...
LABEL_22:
        *(_DWORD *)(a1 + 20) = -2;
        error_set(a2, (_DWORD *)a1, "unable to decode byte 0x%x", v8);
        return -2;
      }
      *(_BYTE *)(a1 + v7 + 8) = 0;
    }
...
int __fastcall lex_get(int a1, int a2)
{
  return stream_get(a1, a2);
}

//----- (000246F4) --------------------------------------------------------
int __fastcall lex_save(int a1, char a2)
{
  return strbuffer_append_byte(a1 + 40, a2);
}
...
_DWORD *__fastcall lex_unget_unsave(_DWORD *result, int a2)
{
  ...
  if ( a2 != -1 && a2 != -2 )
  {
    ...
    result = (_DWORD *)strbuffer_pop(v3 + 10);
...
int __fastcall lex_save_cached(int result)
{
  ...
  {
    result = lex_save(i, *(_BYTE *)(i + *(_DWORD *)(i + 16) + 8));
    ++*(_DWORD *)(i + 16);
  }
  return result;
}
...
void __fastcall lex_scan_string(int a1, int a2)
{
  ...
  _BYTE src[4]; // [sp+14h] [bp+Ch] BYREF
      ...
      for ( i = (_BYTE *)(strbuffer_value(a1 + 40) + 1); ; ++i )
      {
        while ( 1 )
        {
          ...
          if ( v8 <= 55295 || v8 > 56319 )
          {
            ...
            {
LABEL_49:
              error_set(a2, (_DWORD *)a1, "invalid Unicode '\\u%04X'", v8);
              goto LABEL_79;
            }
            if ( !v8 )
            {
              error_set(a2, (_DWORD *)a1, "\\u0000 is not allowed");
              goto LABEL_79;
            }
          }
          else
          {
            ...
            {
              error_set(a2, (_DWORD *)a1, "invalid Unicode '\\u%04X\\u%04X'", v8, v7);
              goto LABEL_79;
            }
...
LABEL_75:
    ...
    if ( (unsigned int)save < 0x20 )
    {
      ...
      if ( save == 10 )
        error_set(a2, (_DWORD *)a1, "unexpected newline", 10);
      else
        error_set(a2, (_DWORD *)a1, "control character 0x%x", save);
      goto LABEL_79;
    }
    if ( save != 92 )
      goto LABEL_32;
    ...
    else
    {
      ...
      {
LABEL_18:
        error_set(a2, (_DWORD *)a1, "invalid escape");
        goto LABEL_79;
      }
LABEL_32:
      save = lex_get_save(a1, a2);
  ...
  error_set(a2, (_DWORD *)a1, "premature end of input");
LABEL_79:
...
LABEL_6:
  ...
  if ( save == 46 || save == 69 || save == 101 )
  {
    if ( save == 46 )
    {
      ...
      lex_save(a1, v7);
      for ( save = lex_get_save(a1, a3); save > 47 && save <= 57; save = lex_get_save(a1, a3) )
        ;
    }
    if ( save == 69 || save == 101 )
    {
    ...
    {
      error_set(a3, (_DWORD *)a1, "real number overflow");
      return -1;
    }
    *(_DWORD *)(a1 + 52) = 258;
    *(double *)(a1 + 56) = v9;
  ...
  else
  {
    ...
    *_errno_location() = 0;
    ...
    {
      if ( v11 >= 0 )
        error_set(a3, (_DWORD *)a1, "too big integer");
      else
        error_set(a3, (_DWORD *)a1, "too big negative integer");
      return -1;
    }
...
_DWORD *__fastcall parse_object(_DWORD *a1, int a2, int a3)
{
  ...
  while ( 1 )
  {
    ...
    lex_scan((int)a1, a3);
    v8 = parse_value(a1, a2, a3);
    if ( !v8 )
    {
      jsonp_free(v9);
      goto LABEL_23;
    }
    if ( json_object_set_nocheck(v10, (char *)v9, v8) )
    {
      jsonp_free(v9);
      json_decref_1(v8);
      goto LABEL_23;
...
void *__fastcall parse_value(double a1, int a2)
{
  ...
  if ( v2 == 91 )
  {
    v9 = parse_array((_DWORD *)LODWORD(a1), SHIDWORD(a1), a2);
LABEL_29:
    if ( v9 )
      return v9;
    else
  ...
  if ( v2 > 91 )
  {
    if ( v2 == 123 )
    {
      v9 = parse_object((_DWORD *)LODWORD(a1), SHIDWORD(a1), a2);
    }
    else
    {
      if ( v2 != 256 )
...
void *__fastcall parse_json(_DWORD *a1, unsigned int a2, int a3)
{
  ...
  lex_scan((int)a1, a3);
  if ( (a2 & 4) != 0 || a1[13] == 91 || a1[13] == 123 )
  {
    v8 = parse_value(COERCE_DOUBLE(__PAIR64__(a2, (unsigned int)a1)), a3);
    if ( v8 )
    {
      if ( (a2 & 2) != 0 || (lex_scan((int)a1, a3), !a1[13]) )
      {
        if ( a3 )
          *(_DWORD *)(a3 + 8) = a1[9];
        return v8;
...
{
  _DWORD v8[2]; // [sp+10h] [bp+10h] BYREF
  _DWORD v9[17]; // [sp+18h] [bp+18h] BYREF
  ...
  {
    error_set((int)a3, 0, "wrong arguments");
    return 0;
  }
}
...
void *__fastcall json_loadb(int a1, int a2, unsigned int a3, char *a4)
{
  ...
  _DWORD v11[17]; // [sp+20h] [bp+20h] BYREF
  ...
  {
    error_set((int)a4, 0, "wrong arguments");
    return 0;
  }
}
...
void *__fastcall json_loadf(int a1, unsigned int a2, char *a3)
{
  _DWORD v8[16]; // [sp+10h] [bp+10h] BYREF
...
void *__fastcall json_load_file(const char *a1, unsigned int a2, char *a3)
{
  ...
  if ( a1 )
  {
    ...
    else
    {
      v4 = _errno_location();
      v5 = strerror(*v4);
      error_set((int)a3, 0, "unable to open %s: %s", a1, v5);
      return 0;
    }
  }
  else
...
void *__fastcall json_load_callback(int a1, int a2, unsigned int a3, char *a4)
{
  ...
  _DWORD v11[17]; // [sp+420h] [bp+420h] BYREF
  ...
  if ( a2 )
  {
    if ( a1 )
    {
      if ( !*a1 && a1 != (_DWORD *)a3 )
      {
        v4 = a1[7];
        a1[7] = v4 + 1;
        if ( !hashtable_set(a1 + 2, a2, v4, a3) )
          return 0;
      }
    }
  }
...
int __fastcall json_object_update(_DWORD *a1, _DWORD *a2)
{
  ...
  for ( i = (char *)json_object_iter_key(v3); i; i = (char *)json_object_iter_key(v5) )
  {
    ...
    if ( !v10 )
      break;
    if ( json_object_set_nocheck_0(a1, i, v10) )
      return -1;
    v4 = json_object_key_to_iter((int)i);
...
int __fastcall json_object_update_existing(_DWORD *a1, _DWORD *a2)
{
  ...
  for ( i = (char *)json_object_iter_key(v3); i; i = (char *)json_object_iter_key(v5) )
  {
    ...
    if ( json_object_get(a1, i) )
      json_object_set_nocheck_0(a1, i, v10);
    v4 = json_object_key_to_iter((int)i);
    v5 = json_object_iter_next(a2, v4);
  }
  return 0;
...
int __fastcall json_object_equal(_DWORD *a1, _DWORD *a2)
{
  ...
  for ( i = (char *)json_object_iter_key(v4); i; i = (char *)json_object_iter_key(v6) )
  {
    ...
    v12 = (_DWORD *)json_object_iter_value(v7);
    if ( !v12 )
      break;
    v11 = (_DWORD *)json_object_get(a2, i);
...
_DWORD *__fastcall json_object_copy(_DWORD *a1)
{
  ...
  for ( i = (char *)json_object_iter_key(v2); i; i = (char *)json_object_iter_key(v4) )
  {
    ...
    v3 = json_object_key_to_iter((int)i);
...
_DWORD *__fastcall json_object_deep_copy(_DWORD *a1)
{
  ...
  for ( i = json_object_iter(a1); i; i = json_object_iter_next(a1, i) )
  {
    ...
    v5 = (_DWORD *)json_object_iter_value(i);
...
void __fastcall json_delete_array(int a1)
{
  ...
  for ( i = 0; *(_DWORD *)(a1 + 12) > i; ++i )
    json_decref_2(*(_DWORD *)(*(_DWORD *)(a1 + 16) + 4 * i));
...
int __fastcall json_array_set_new(_DWORD *a1, unsigned int a2, int a3)
{
  ...
  {
    json_decref_2(*(_DWORD *)(a1[4] + 4 * a2));
    *(_DWORD *)(a1[4] + 4 * a2) = a3;
    return 0;
  }
  else
...
void *__fastcall array_copy(int a1, int a2, int a3, int a4, size_t n)
{
  return memcpy((void *)(a1 + 4 * a2), (const void *)(a3 + 4 * a4), 4 * n);
}
...
void *__fastcall json_array_grow(_DWORD *a1, int a2, int a3)
{
  ...
  if ( !a3 )
    return v10;
  array_copy(a1[4], 0, (int)v10, 0, a1[3]);
  jsonp_free(v10);
  return (void *)a1[4];
}
...
int __fastcall json_array_append_new(_DWORD *a1, int a2)
{
  if ( !a2 )
    return -1;
  if ( a1 && *a1 == 1 && a1 != (_DWORD *)a2 && json_array_grow(a1, 1, 1) )
  {
...
int __fastcall json_array_insert_new(_DWORD *a1, size_t a2, int a3)
{
  void *v8; // [sp+18h] [bp+10h]

  if ( !a3 )
    return -1;
  if ( a1 && *a1 == 1 && a1 != (_DWORD *)a3 && a1[3] >= a2 )
  {
    v8 = json_array_grow(a1, 1, 0);
    if ( v8 )
    {
      if ( (void *)a1[4] == v8 )
      {
        array_move((int)a1, a2 + 1, a2, a1[3] - a2);
      }
      else
      {
        array_copy(a1[4], 0, (int)v8, 0, a2);
        array_copy(a1[4], a2 + 1, (int)v8, a2, a1[3] - a2);
        jsonp_free(v8);
      }
      *(_DWORD *)(a1[4] + 4 * a2) = a3;
      ++a1[3];
...
int __fastcall json_array_remove(_DWORD *a1, unsigned int a2)
{
  ...
  json_decref_2(*(_DWORD *)(a1[4] + 4 * a2));
  if ( a1[3] - 1 > a2 )
    array_move((int)a1, a2, a2 + 1, a1[3] - a2 - 1);
  --a1[3];
  return 0;
}
...
int __fastcall json_array_extend(_DWORD *a1, _DWORD *a2)
{
  ...
  if ( !a1 || *a1 != 1 || !a2 || *a2 != 1 )
    return -1;
  if ( !json_array_grow(a1, a2[3], 1) )
    return -1;
  for ( i = 0; a2[3] > i; ++i )
    json_incref_0(*(_DWORD *)(a2[4] + 4 * i));
  array_copy(a1[4], a1[3], a2[4], 0, a2[3]);
  a1[3] += a2[3];
  return 0;
}
...
bool __fastcall json_string_equal(_DWORD *a1, _DWORD *a2)
{
  ...
  v2 = (const char *)json_string_value(a1);
  v3 = (const char *)json_string_value(a2);
...
_DWORD *__fastcall json_string_copy(_DWORD *a1)
{
  ...
  v1 = (const char *)json_string_value(a1);
...
// 27410: variable 'v2' is possibly undefined
// 27426: variable 'v1' is possibly undefined
...
// 274A6: variable 'v0' is possibly undefined
...
int __fastcall json_equal(_DWORD *a1, _DWORD *a2)
{
  ...
  switch ( *a1 )
  {
    ...
    case 3:
      return json_integer_equal((int)a1, (int)a2);
    case 4:
      return json_real_equal();
  }
  return 0;
}
...
// 26850: using guessed type int __fastcall json_object_equal(_DWORD, _DWORD);
...
_DWORD *__fastcall json_copy(_DWORD *a1)
{
  ...
  switch ( *a1 )
  {
    ...
    case 2:
      return json_string_copy(a1);
    case 3:
      return json_integer_copy((int)a1);
    case 4:
      return json_real_copy();
    case 5:
    case 6:
    case 7:
      return a1;
...
_QWORD *__fastcall json_deep_copy(_DWORD *a1)
{
  ...
  {
    case 0:
      return (_QWORD *)json_object_deep_copy(a1);
    case 1:
...
// 2695C: using guessed type int __fastcall json_object_deep_copy(_DWORD);
...
char *__fastcall jsonp_error_init(char *result, const char *a2)
{
  if ( result )
  {
    ...
    *((_DWORD *)result + 2) = 0;
    if ( a2 )
      return jsonp_error_set_source(result, a2);
    else
      result[12] = 0;
  }
  return result;
...
int jsonp_error_set(int a1, int a2, int a3, int a4, char *format, ...)
{
  ...
  va_start(va, format);
  return jsonp_error_vset(a1, a2, a3, a4, format, va);
}
