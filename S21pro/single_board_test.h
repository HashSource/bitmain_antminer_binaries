...
struct Elf32_Sym
{
  unsigned __int32 st_name __offset(OFF32,0x134A4);
...
struct Elf32_Verneed
{
  ...
  unsigned __int32 vn_file __offset(OFF32,0x134A4);
...
struct Elf32_Vernaux
{
  ...
  unsigned __int32 vna_name __offset(OFF32,0x134A4);
...
struct __attribute__((aligned(8))) history_result
{
  ...
  uint8_t asic_core_nonce_num[65][2048];
  uint16_t every_asic_got_nonce_num[65];
  uint16_t every_asic_reg_ntick_nonce_num[65];
  uint16_t every_asic_reg_nonce_error_num[65];
  uint16_t every_asic_reg_got_nonce_num[65];
  bool ok_asic_list[65];
  bool bad_asic_list[65];
  bool pic_sensor_OK[4];
  bool asic_sensor_OK[65];
  bool ctrlboard_sensor_OK[4];
  int8_t sensor_local_temperature_from_pic[4];
  int8_t sensor_local_temperature_from_ctrlboard[4];
...
struct ctrlboard_sensor
{
  ...
  uint32_t trlBoard_Sensor_Addr[4];
};
...
{
  uint32_t nonce_stats[65][9];
  uint32_t nonce_num_asic[65];
...
struct _pattern_runtime_ctx
{
  ...
  uint16_t last_succ_asic_nonce_num[65];
  sweep_ctx sweep;
  pattern_work *works[65];
  config_ctx *config;
  ...
  uint32_t recv_nonce;
  uint32_t read_temp;
  uint32_t read_sensor_power_by_hashboard;
