...
_UNKNOWN *_frame_dummy_init_array_entry = (_UNKNOWN *)0x864D; // weak
_UNKNOWN *_do_global_dtors_aux_fini_array_entry = (_UNKNOWN *)0x8635; // weak
...
int __fastcall main(int argc, const char **argv, const char **envp)
{
  ...
  int v5; // r1
  int v6; // r2
  _BYTE v8[161]; // [sp+3Fh] [bp-A1h] BYREF
  struct timeval v9; // [sp+E0h] [bp+0h] BYREF
  timeval tv; // [sp+E8h] [bp+8h] BYREF
  unsigned __int8 v11[164]; // [sp+F0h] [bp+10h] BYREF
  char dest[161]; // [sp+194h] [bp+B4h] BYREF
  ...
  *(_DWORD *)((unsigned int)v8 & 0xFFFFFFC0) += 5;
  ...
  while ( v3 != 1000000 );
  gettimeofday(&tv, 0);
  v4 = tv.tv_usec - v9.tv_usec;
  LOWORD(v5) = 16960;
  v6 = tv.tv_sec - v9.tv_sec;
  if ( tv.tv_usec - v9.tv_usec < 0 )
  {
    v4 += 1000000;
    --v6;
  }
...
int __fastcall blake2b_hash(_DWORD *a1, char *a2)
{
  ...
  int v9; // r2
  int v10; // r3
  _BYTE v11[289]; // [sp+3Fh] [bp-121h] BYREF
...
__int64 *__fastcall blake2b_compress(int a1, int a2)
{
  ...
  unsigned __int64 v65; // [sp+38h] [bp-160h]
  __int64 v66; // [sp+40h] [bp-158h]
  __int64 v67; // [sp+40h] [bp-158h]
  ...
  unsigned __int64 v72; // [sp+50h] [bp-148h]
  __int64 v73; // [sp+58h] [bp-140h]
  unsigned __int64 v74; // [sp+60h] [bp-138h]
  ...
  unsigned __int8 *v108; // [sp+158h] [bp-40h] BYREF
  ...
  unsigned __int64 v114; // [sp+180h] [bp-18h]
  unsigned __int64 v115; // [sp+188h] [bp-10h]
  unsigned __int64 v116; // [sp+190h] [bp-8h]
  __int64 v117; // [sp+198h] [bp+0h] BYREF
  __int64 v118; // [sp+1A0h] [bp+8h] BYREF
  unsigned __int64 v119; // [sp+1A8h] [bp+10h]
  ...
  int v126; // [sp+258h] [bp+C0h] BYREF
  _BYTE dest[192]; // [sp+260h] [bp+C8h] BYREF
  ...
  do
  {
    ...
    HIDWORD(v90) = ((unsigned int)((v52 ^ __PAIR64__((unsigned int)v85 ^ (unsigned int)v21, HIDWORD(v85) ^ HIDWORD(v21))) >> 32) >> 16)
                 | (((unsigned int)v52 ^ HIDWORD(v85) ^ HIDWORD(v21)) << 16);
...
// 11624: using guessed type _UNKNOWN *_frame_dummy_init_array_entry;
// 11628: using guessed type _UNKNOWN *_do_global_dtors_aux_fini_array_entry;
