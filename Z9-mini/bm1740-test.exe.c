...
size_t __fastcall midd_send_work_to_hardware(unsigned __int8 a1, unsigned __int8 *a2, int a3);
...
int __fastcall bm1740_parse_reg_respond(_BYTE *a1, size_t a2, void *a3, unsigned int a4);
...
int __fastcall bm1740_pack_ioctl_pkg(int a1, unsigned int a2, int a3, int a4);
int bm1740_soc_init();
int bm1740_soc_exit();
...
int __fastcall set_BM1385_freq(unsigned __int8 a1, unsigned __int8 a2, int a3, char a4);
...
unsigned int __fastcall single_BM1385_set_address(unsigned __int8 a1);
...
unsigned int __fastcall single_BM1385_print_lcd(int a1, char a2);
void __fastcall __noreturn single_BM1385_show_status_func(unsigned __int8 *a1);
bool __fastcall BM1385_is_nonce_or_reg_value(char a1);
...
size_t __fastcall uart_send(unsigned __int8 a1, unsigned __int8 *a2, size_t a3);
...
int __fastcall twoc2hex(unsigned __int8 a1, unsigned __int8 a2);
...
int __fastcall write_sensor_info_into_pic(unsigned __int8 a1, unsigned __int8 a2);
...
_UNKNOWN *_frame_dummy_init_array_entry = (_UNKNOWN *)0x9189; // weak
_UNKNOWN *_do_global_dtors_aux_fini_array_entry = (_UNKNOWN *)0x9171; // weak
void *(*memset_v_4649)(void *s, int c, size_t n) = &memset; // weak
...
_UNKNOWN *Single_BM1385_WorkDataPathPrefix = (_UNKNOWN *)0x2CDB8; // weak
...
// 30214: using guessed type void *(*memset_v_4649)(void *s, int c, size_t n);
...
int __fastcall blake2b_init0(void *a1)
{
  ...
  memset(a1, 0, 0x168u);
  for ( i = 0; i <= 7; ++i )
    *((_QWORD *)a1 + i) = *(_QWORD *)&blake2b_IV[2 * i];
  return 0;
}
// 2BA98: using guessed type int blake2b_IV[];
...
int __fastcall blake2b_init_key(void *a1, unsigned __int8 a2, const void *a3, unsigned __int8 a4)
{
  ...
  _BYTE v11[4]; // [sp+90h] [bp+90h] BYREF
...
int __fastcall blake2b_compress(_QWORD *a1, int a2)
{
  ...
  unsigned __int64 v15; // [sp+50h] [bp+50h]
...
int __fastcall blake2b_final(int a1, void *a2, unsigned __int8 a3)
{
  ...
  blake2b_compress((_QWORD *)a1, a1 + 96);
  for ( i = 0; i <= 7; ++i )
    store64(&s[2 * i], (int)&s[2 * i], *(_DWORD *)(a1 + 8 * i), *(_DWORD *)(a1 + 8 * i + 4));
  memcpy(a2, s, a3);
  return 0;
}
...
size_t __fastcall midd_ioctl(unsigned __int8 a1, int a2, int a3)
{
  unsigned __int8 s[256]; // [sp+14h] [bp+14h] BYREF
  signed int v9; // [sp+114h] [bp+114h]

  memset(s, 0, sizeof(s));
  v9 = bm1740_pack_ioctl_pkg((int)s, 0x100u, a2, a3);
  if ( v9 >= 0 )
...
int __fastcall bm1740_handle_nonce(unsigned __int8 *a1)
{
  ...
  _DWORD v6[3]; // [sp+18Ch] [bp+16Ch] BYREF
  _BYTE v7[364]; // [sp+198h] [bp+178h] BYREF
  _BYTE dest[1344]; // [sp+304h] [bp+2E4h] BYREF
  char s[140]; // [sp+844h] [bp+824h] BYREF
  ...
  v14 = 0;
  memcpy(s, &g_test_header, sizeof(s));
  memcpy(&s[116], a1 + 1352, 4u);
  memcpy(dest, a1, sizeof(dest));
  v6[0] = 200;
  v6[1] = 9;
  v6[2] = v7;
  digestInit(v7, 200, 9);
  blake2b_update((int)v7, s, 0x8Cu);
  v13 = now();
  v14 = sortValidator(v6, (int)dest);
  v12 = now();
  v11 = targetValidator(s, dest);
  if ( v14 || v11 < g_tm )
  {
  ...
  else
  {
    ...
    ++asic_nonce_6391;
    v10 = now();
    if ( (unsigned __int64)(v10 - *(_QWORD *)&time_first_6394) > 0x39386FF )
    {
      *(_QWORD *)&time_first_6394 = v10;
      v1 = k_6393;
...
// 31240: using guessed type int time_first_6394;
...
int __fastcall bm1740_verify_nonce_integrality(_BYTE *a1)
{
  char s[258]; // [sp+14h] [bp+Ch] BYREF
  unsigned __int16 s1; // [sp+116h] [bp+10Eh] BYREF
  ...
  for ( i = 0; i <= 15; ++i )
  {
    s1 = CRC16((_BYTE *)&g_nonce_list + 91 * i, 89);
    s1 = HIBYTE(s1) | (s1 << 8);
    if ( memcmp(&s1, (char *)&g_nonce_list + 91 * i + 89, 2u) )
    {
      if ( use_syslog || opt_log_output || opt_log_level >= 0 )
      {
        snprintf(
          ...
          s1,
          *((unsigned __int8 *)&g_nonce_list + 91 * i + 89));
        applog(0, s);
      }
      v13 |= 1 << i;
    }
  ...
  for ( j = 0; j <= 15; ++j )
  {
    if ( (*((_BYTE *)&g_nonce_list + 91 * j) & 0xF) != j )
    {
      if ( use_syslog || opt_log_output || opt_log_level >= 0 )
      {
        snprintf(s, 0x100u, "nonce is not continous i=%d\n", j);
        applog(0, s);
      }
      return -1;
    }
  ...
  for ( k = 0; k <= 14; ++k )
  {
    if ( *((unsigned __int8 *)&g_nonce_list + 91 * k + 1) != *((unsigned __int8 *)&g_nonce_list + 91 * k + 92) )
    {
      if ( use_syslog || opt_log_output || opt_log_level >= 0 )
      {
        snprintf(
          ...
          *((unsigned __int8 *)&g_nonce_list + 91 * k + 1),
          *((unsigned __int8 *)&g_nonce_list + 91 * k + 92));
        applog(0, s);
      }
      return -1;
    }
  ...
  for ( m = 0; m <= 14; ++m )
  {
    if ( *((unsigned __int8 *)&g_nonce_list + 91 * m + 2) != *((unsigned __int8 *)&g_nonce_list + 91 * m + 93) )
    {
      if ( use_syslog || opt_log_output || opt_log_level >= 0 )
      {
        snprintf(
          ...
          *((unsigned __int8 *)&g_nonce_list + 91 * m + 2),
          *((unsigned __int8 *)&g_nonce_list + 91 * m + 93));
        applog(0, s);
      }
      return -1;
    }
  ...
  for ( n = 0; ; ++n )
  {
    if ( n > 14 )
    {
      ...
      for ( ii = 0; ii <= 14; ++ii )
      {
        memcpy(dest, (char *)&g_nonce_list + 91 * ii + 4, 0x55u);
        dest = (char *)dest + 85;
      }
    ...
    if ( *((unsigned __int8 *)&g_nonce_list + 91 * n + 3) != *((unsigned __int8 *)&g_nonce_list + 91 * n + 94) )
      break;
  }
  if ( use_syslog || opt_log_output || opt_log_level >= 0 )
  {
    snprintf(
      s,
      0x100u,
      "nonceID is different %02x != %02x\n",
      *((unsigned __int8 *)&g_nonce_list + 91 * n + 3),
      *((unsigned __int8 *)&g_nonce_list + 91 * n + 94));
    applog(0, s);
  }
  return -1;
}
...
int __fastcall bm1740_combine_one_nonce(_BYTE *a1, _BYTE *a2, unsigned __int8 a3)
{
  ...
  {
    memcpy((char *)&g_nonce_list + 91 * v12, a2, 0x5Bu);
    if ( v12 == 15 && !retransmit_6460 )
    {
      ...
      if ( v13 > 0 && g_txok_en == 1 )
      {
        ...
        v9[0] = a1[1344];
        v10 = v13;
        midd_ioctl(g_chain[10 * a3], 12, (int)v9);
        retransmit_6460 = 1;
        if ( use_syslog || opt_log_output || opt_log_level > 2 )
        {
...
void __noreturn bm1740_get_nonce()
{
  ...
  char s[200]; // [sp+108h] [bp+108h] BYREF
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      midd_recv_work(s, 0x5Du);
      midd_recv_work((char *)&v2, 1u);
      v5 = bm1740_combine_one_nonce(v4, &s[2], v2);
      if ( v5 )
        break;
...
unsigned int __fastcall i2c_status(unsigned __int8 a1, unsigned __int8 a2)
{
  ...
  int v8; // [sp+Ch] [bp+Ch]
  _BYTE v9[8]; // [sp+14h] [bp+14h] BYREF
  ...
  v9[0] = a2;
  v9[2] = 32;
  midd_ioctl(g_chain[10 * a1], 0, (int)v9);
...
int __fastcall i2c_recv(unsigned __int8 a1, unsigned __int8 a2, char a3, char a4, _BYTE *a5)
{
  ...
  _BYTE v14[8]; // [sp+11Ch] [bp+114h] BYREF
  _BYTE v15[4]; // [sp+124h] [bp+11Ch] BYREF
  signed int v16; // [sp+128h] [bp+120h]
  ...
  if ( v16 <= 0 )
  {
    if ( v16 >= 0 )
    {
      if ( use_syslog || opt_log_output || opt_log_level >= 0 )
      {
        snprintf(s, 0x100u, "%s[%d]i2c is idle\n", "i2c_recv", 470);
        applog(0, s);
      }
      v15[1] = 0;
      v15[0] = a2;
      v15[2] = a3;
      v15[3] = a4;
      midd_ioctl(g_chain[10 * a1], 7, (int)v15);
      ...
      if ( v16 <= 0 )
      {
        if ( v16 >= 0 )
        {
          ...
          v14[0] = a2;
          v14[2] = 32;
          midd_ioctl(g_chain[10 * a1], 0, (int)v14);
          usleep(0x7A120u);
          v13[0] = a1;
          v13[1] = a2;
          v13[2] = 32;
        ...
        else
        {
          if ( use_syslog || opt_log_output || opt_log_level >= 0 )
          {
            snprintf(s, 0x100u, "%s[%d]-not received the i2c response\n", "i2c_recv", 486);
            applog(0, s);
          }
          return -1;
        }
      ...
      else
      {
        if ( use_syslog || opt_log_output || opt_log_level >= 0 )
        {
          snprintf(s, 0x100u, "%s[%d]-i2c is busy\n", "i2c_recv", 483);
          applog(0, s);
        }
        return -1;
      }
...
size_t __fastcall i2c_send(unsigned __int8 a1, char a2, char a3, char a4, char a5)
{
  ...
  v6[3] = a4;
  v6[4] = a5;
  return midd_ioctl(g_chain[10 * a1], 8, (int)v6);
}
// 61D04: using guessed type int g_chain[10];
...
int asic_num_calculate()
{
  ...
  v1[2] = 0;
  for ( i = 0; i <= 0; ++i )
    midd_ioctl(g_chain[10 * i], 0, (int)v1);
...
int __fastcall calculate_asic_number(unsigned int a1)
{
  ...
  {
    snprintf(s, 0x100u, "actual_asic_number = %d, but it is error\n", a1);
    applog(4, s);
  }
  return -1;
}
...
int asic_addr_interval()
{
  ...
  if ( use_syslog || opt_log_output || opt_log_level > 2 )
  {
    snprintf(s, 0x100u, "addr-interval %d\n", addr_interval);
    return applog(3, s);
  }
  return result;
}
...
size_t __fastcall set_frequency(size_t result)
{
  ...
  char s[256]; // [sp+14h] [bp+Ch] BYREF
  _BYTE v3[4]; // [sp+114h] [bp+10Ch] BYREF
  size_t v4; // [sp+118h] [bp+110h]
  ...
  for ( i = 0; i <= 0; ++i )
  {
    result = midd_ioctl(g_chain[10 * i], 25, (int)v3);
    if ( use_syslog || opt_log_output || opt_log_level > 2 )
    {
      snprintf(s, 0x100u, "chain %d freq %u\n", i, v1);
      result = applog(3, s);
    }
  }
  return result;
...
int __fastcall set_ticket_mask(int result)
{
  ...
  for ( i = 0; i <= 0; ++i )
  {
    result = midd_ioctl(g_chain[10 * i], 9, (int)v3);
    if ( use_syslog || opt_log_output || opt_log_level > 2 )
    {
      snprintf(s, 0x100u, "chain %d ticket-mask %08x\n", i, v1);
      result = applog(3, s);
    }
  }
  return result;
...
int set_address()
{
  ...
  for ( i = 0; i <= 0; ++i )
  {
    ...
    {
      v2 = j * addr_interval;
      midd_ioctl(g_chain[10 * i], 19, (int)&v2);
      if ( use_syslog || opt_log_output || opt_log_level > 2 )
      {
        snprintf(s, 0x100u, "chain %d chip %d addres %08x\n", i, j, v2);
        applog(3, s);
      }
...
size_t __fastcall set_core_timeout(size_t result)
{
  ...
  for ( i = 0; i <= 0; ++i )
  {
    result = midd_ioctl(g_chain[10 * i], 14, (int)v3);
    if ( use_syslog || opt_log_output || opt_log_level > 2 )
    {
      snprintf(s, 0x100u, "chain %d core-timeout %08x\n", i, v1);
      result = applog(3, s);
    }
  }
  return result;
...
size_t __fastcall set_timeout(size_t result)
{
  ...
  for ( i = 0; i <= 0; ++i )
  {
    result = midd_ioctl(g_chain[10 * i], 31, (int)v3);
    if ( use_syslog || opt_log_output || opt_log_level > 2 )
    {
      snprintf(s, 0x100u, "chain %d timeout %08x\n", i, v1);
      result = applog(3, s);
    }
  }
  return result;
...
int set_i2c_enable()
{
  int result; // r0
  char s[256]; // [sp+Ch] [bp+4h] BYREF
  _BYTE v2[4]; // [sp+10Ch] [bp+104h] BYREF
  int j; // [sp+110h] [bp+108h]
  int i; // [sp+114h] [bp+10Ch]
  ...
  for ( i = 0; i <= 0; ++i )
  {
    for ( j = 0; j <= 1; ++j )
    {
      ...
      midd_ioctl(g_chain[10 * i], 5, (int)v2);
      if ( use_syslog || opt_log_output || opt_log_level > 2 )
      {
        snprintf(s, 0x100u, "enable i2c, chain %d sensor %08x\n", i, j);
        applog(3, s);
      }
      result = usleep(0xC350u);
    }
...
void __fastcall __noreturn midd_recv_comm(int a1)
{
  ...
  {
    usleep(0xBB8u);
    v3 = uart_receive(g_chain[10 * *(unsigned __int8 *)(v4 + 4)], (int)s, 1u);
    rt_ringbuffer_put((int)&bm_comm_rb, s, v3);
  }
}
// 61D04: using guessed type int g_chain[10];
...
void __fastcall __noreturn midd_dispatch_packet(int a1)
{
  ...
  unsigned int v13; // [sp+1030h] [bp+1028h]
  ...
  while ( 1 )
  {
    ...
    {
      usleep(0x2710u);
      v8 = midd_recv_comm_from_rb(s, v13);
    }
    while ( v8 != v13 );
    v9 = bm1740_parse_respond_len(s, v13, &v3);
    if ( v9 )
    {
      if ( v9 == 1 )
      {
...
size_t send_work_example()
{
  ...
  unsigned __int8 dest[280]; // [sp+120h] [bp+120h] BYREF
  ...
  while ( v21 )
  {
    ...
    switch ( (char)v18 )
    {
      ...
      case 's':
        ...
        v13[2] = v16;
        v14 = v15;
        midd_ioctl(g_chain[0], 1, (int)v13);
        break;
      case 't':
        bm1740_app_test();
        break;
      case 'w':
        ...
        if ( strlen(s) > 0x117 )
        {
          ...
          hex2bin(src, (unsigned __int8 *)s, 140);
          memcpy(v6, src, sizeof(v6));
          memcpy(&g_test_header, src, 0x8Cu);
          for ( i = 0; i <= 0; ++i )
...
int __fastcall bm1740_pack_work_pkg(int a1, int a2)
{
  char s[258]; // [sp+8h] [bp+8h] BYREF
  unsigned __int16 v5; // [sp+10Ah] [bp+10Ah]
...
{
  char v4; // r0
  char s[256]; // [sp+18h] [bp+10h] BYREF
  ...
  else
  {
    if ( use_syslog || opt_log_output || opt_log_level >= 0 )
    {
      snprintf(s, 0x100u, "%s input param error: str length = %u\n", "bm1740_makeup_set_address_cmd", 7);
      applog(0, s);
    }
    return -1;
  }
...
int __fastcall bm1740_makeup_bist_write_wait_read_cmd(char a1, char a2, int a3, int a4, unsigned int a5)
{
  ...
  int v7; // r1
  char v8; // r3
  char s[256]; // [sp+1Ch] [bp+14h] BYREF
...
int __fastcall bm1740_set_reg_table(char a1, int a2)
{
  ...
  switch ( a1 )
  {
    ...
    default:
      if ( use_syslog || opt_log_output || opt_log_level > 2 )
      {
        snprintf(s, 0x100u, "error: %s unknow reg type\n", "bm1740_set_reg_table");
        applog(3, s);
      }
      break;
  }
...
int __fastcall bm1740_parse_nonce_respond(const void *a1, size_t a2, void *a3, unsigned int a4)
{
  char s[260]; // [sp+18h] [bp+10h] BYREF
  ...
  else
  {
    if ( use_syslog || opt_log_output || opt_log_level >= 0 )
    {
      snprintf(s, 0x100u, "%s input str len error, input len=%d\n", "bm1740_parse_nonce_respond", a2);
      applog(0, s);
    }
    return -1;
  }
...
int __fastcall bm1740_parse_reg_respond(_BYTE *a1, size_t a2, void *a3, unsigned int a4)
{
  ...
  if ( a2 == 9 && a4 > 8 )
  {
    ...
    else
    {
      if ( use_syslog || opt_log_output || opt_log_level >= 0 )
      {
        snprintf(s, 0x100u, "%s CRC error crc = %02x\n", "bm1740_parse_reg_respond", v11);
        applog(0, s);
      }
      return -1;
    }
  ...
  else
  {
    if ( use_syslog || opt_log_output || opt_log_level >= 0 )
    {
      snprintf(s, 0x100u, "%s length error\n", "bm1740_parse_reg_respond");
      applog(0, s);
    }
    return -1;
  }
...
int __fastcall bm1740_parse_pmonitor_respond(int a1, size_t a2, void *a3, unsigned int a4)
{
  int src; // [sp+14h] [bp+Ch] BYREF
  char s[259]; // [sp+18h] [bp+10h] BYREF
...
int __fastcall bm1740_pack_ioctl_pkg(int a1, unsigned int a2, int a3, int a4)
{
  ...
  unsigned int v27; // [sp+164h] [bp+15Ch] BYREF
  unsigned int v28; // [sp+168h] [bp+160h] BYREF
  unsigned int v29; // [sp+16Ch] [bp+164h] BYREF
  int v30[7]; // [sp+170h] [bp+168h] BYREF
  int v31; // [sp+18Ch] [bp+184h]
  int v32; // [sp+190h] [bp+188h]
  char *v33; // [sp+194h] [bp+18Ch]
  char *v34; // [sp+198h] [bp+190h]
  char *v35; // [sp+19Ch] [bp+194h]
  int v36; // [sp+1A0h] [bp+198h]
  int v37; // [sp+1A4h] [bp+19Ch]
  int v38; // [sp+1A8h] [bp+1A0h]
  int v39; // [sp+1ACh] [bp+1A4h]
  char *v40; // [sp+1B0h] [bp+1A8h]
  int v41; // [sp+1B4h] [bp+1ACh]
  int v42; // [sp+1B8h] [bp+1B0h]
  int v43; // [sp+1BCh] [bp+1B4h]
  char *v44; // [sp+1C0h] [bp+1B8h]
  char *v45; // [sp+1C4h] [bp+1BCh]
  char *v46; // [sp+1C8h] [bp+1C0h]
  char *v47; // [sp+1CCh] [bp+1C4h]
  int v48; // [sp+1D0h] [bp+1C8h]
  int v49; // [sp+1D4h] [bp+1CCh]
  int v50; // [sp+1D8h] [bp+1D0h]
  int v51; // [sp+1DCh] [bp+1D4h]
  int v52; // [sp+1E0h] [bp+1D8h]
  int v53; // [sp+1E4h] [bp+1DCh]
  char *v54; // [sp+1E8h] [bp+1E0h]
  int v55; // [sp+1ECh] [bp+1E4h]
  int v56; // [sp+1F0h] [bp+1E8h]
  int v57; // [sp+1F4h] [bp+1ECh]
  int v58; // [sp+1F8h] [bp+1F0h]
  int v59; // [sp+1FCh] [bp+1F4h]
  int v60; // [sp+200h] [bp+1F8h]
  int v61; // [sp+204h] [bp+1FCh]

  switch ( a3 )
  {
    case 0:
      v56 = a4;
      status_cmd = bm1740_makeup_get_status_cmd(a1, a2, *(_BYTE *)(a4 + 1), *(_BYTE *)a4, *(_BYTE *)(a4 + 2));
      break;
    case 1:
      v55 = a4;
      bm1740_set_reg_table(*(_BYTE *)(a4 + 2), *(_DWORD *)(a4 + 4));
      status_cmd = bm1740_makeup_set_config_cmd(
                     a1,
                     a2,
                     *(_BYTE *)(v55 + 1),
                     *(_BYTE *)v55,
    ...
    case 2:
      ...
      bt8d_from_baud = get_bt8d_from_baud(*(_DWORD *)(v61 + 4));
      v30[0] = v30[0] & 0xFFFFE0FF | ((bt8d_from_baud & 0x1F) << 8);
      bm1740_set_reg_table(28, v30[0]);
      status_cmd = bm1740_makeup_set_config_cmd(a1, a2, *(_BYTE *)(v61 + 1), *(_BYTE *)v61, 28, v30[0]);
      break;
    case 3:
      v60 = a4;
      status_cmd = bm1740_makeup_get_status_cmd(a1, a2, *(_BYTE *)(a4 + 1), *(_BYTE *)a4, 28);
      break;
    case 4:
      v33 = (char *)a4;
    ...
    case 9:
      ...
      v25 = v25 & 0xFFFFFF00 | (unsigned __int8)*(_DWORD *)(v49 + 4);
      bm1740_set_reg_table(20, v25);
      status_cmd = bm1740_makeup_set_config_cmd(a1, a2, *(_BYTE *)(v49 + 1), *(_BYTE *)v49, 20, v25);
      break;
    case 10:
      v48 = a4;
      status_cmd = bm1740_makeup_get_status_cmd(a1, a2, *(_BYTE *)(a4 + 1), *(_BYTE *)a4, 20);
      break;
    case 11:
      v44 = (char *)a4;
    ...
    case 12:
      ...
      LOWORD(v20) = *(_DWORD *)(v43 + 4);
      bm1740_set_reg_table(36, v20);
      status_cmd = bm1740_makeup_set_config_cmd(a1, a2, *(_BYTE *)(v43 + 1), *(_BYTE *)v43, 36, v20);
      break;
    case 14:
      v41 = a4;
      ...
      status_cmd = bm1740_makeup_set_config_cmd(a1, a2, *(_BYTE *)(v41 + 1), *(_BYTE *)v41, 40, v19);
      break;
    case 15:
    case 16:
      v59 = a4;
    ...
    case 17:
      ...
      v29 = v29 & 0xFFFFDFFF | ((*(_DWORD *)(v58 + 4) & 1) << 13);
      bm1740_set_reg_table(28, v29);
      status_cmd = bm1740_makeup_set_config_cmd(a1, a2, *(_BYTE *)(v58 + 1), *(_BYTE *)v58, 28, v29);
      break;
    case 18:
      v57 = a4;
      bm1740_get_reg_table(28, &v28);
      v28 = v28 & 0xFFFFFFFC | *(_DWORD *)(v57 + 4) & 3;
      bm1740_set_reg_table(28, v28);
      status_cmd = bm1740_makeup_set_config_cmd(a1, a2, *(_BYTE *)(v57 + 1), *(_BYTE *)v57, 28, v28);
      break;
    case 19:
      v54 = (char *)a4;
    ...
    case 22:
      v53 = a4;
      status_cmd = bm1740_makeup_get_status_cmd(a1, a2, *(_BYTE *)(a4 + 1), *(_BYTE *)a4, 0);
      break;
    case 23:
      v52 = a4;
      v26[1] = 0;
      status_cmd = bm1740_makeup_set_config_cmd(a1, a2, *(_BYTE *)(a4 + 1), *(_BYTE *)a4, 8, 0);
      break;
    case 24:
      v51 = a4;
      status_cmd = bm1740_makeup_get_status_cmd(a1, a2, *(_BYTE *)(a4 + 1), *(_BYTE *)a4, 8);
      break;
    case 25:
      v50 = a4;
      bm1740_get_reg_table(12, v26);
      bm1740_get_plldata(*(_DWORD *)(v50 + 4), v26);
      bm1740_set_reg_table(12, v26[0]);
      status_cmd = bm1740_makeup_set_config_cmd(a1, a2, *(_BYTE *)(v50 + 1), *(_BYTE *)v50, 12, v26[0]);
      break;
    case 26:
      v42 = a4;
      status_cmd = bm1740_makeup_get_status_cmd(a1, a2, *(_BYTE *)(a4 + 1), *(_BYTE *)a4, 36);
      break;
    case 27:
      v40 = (char *)a4;
    ...
    case 28:
      ...
      status_cmd = bm1740_makeup_set_config_cmd(a1, a2, *(_BYTE *)(v39 + 1), *(_BYTE *)v39, 52, v17);
      break;
    case 29:
      v38 = a4;
      status_cmd = bm1740_makeup_get_status_cmd(a1, a2, *(_BYTE *)(a4 + 1), *(_BYTE *)a4, 52);
      break;
    case 30:
      v37 = a4;
      bm1740_get_reg_table(56, &v16);
      v16 = (unsigned __int16)v16 | ((unsigned __int16)*(_DWORD *)(v37 + 4) << 16);
      bm1740_set_reg_table(56, v16);
      status_cmd = bm1740_makeup_set_config_cmd(a1, a2, *(_BYTE *)(v37 + 1), *(_BYTE *)v37, 56, v16);
      break;
    case 31:
      v36 = a4;
      bm1740_get_reg_table(56, &v15);
      LOWORD(v15) = *(_DWORD *)(v36 + 4);
      bm1740_set_reg_table(56, v15);
      status_cmd = bm1740_makeup_set_config_cmd(a1, a2, *(_BYTE *)(v36 + 1), *(_BYTE *)v36, 56, v15);
      break;
    case 32:
      v35 = (char *)a4;
    ...
    case 34:
      ...
      status_cmd = bm1740_makeup_set_config_cmd(a1, a2, *(_BYTE *)(v32 + 1), *(_BYTE *)v32, 84, v11);
      break;
    case 35:
      v31 = a4;
      bm1740_get_reg_table(88, &v10);
      v10 = v10 & 0xFFFFFFFD | (2 * (*(_DWORD *)(v31 + 4) & 1));
      v10 = v10 & 0xFFFFFFFE | *(_DWORD *)(v31 + 8) & 1;
      bm1740_set_reg_table(88, v10);
      status_cmd = bm1740_makeup_set_config_cmd(a1, a2, *(_BYTE *)(v31 + 1), *(_BYTE *)v31, 88, v10);
      break;
    case 36:
      v30[6] = a4;
      status_cmd = bm1740_makeup_bist_setup_cmd(*(_BYTE *)(a4 + 1), *(_BYTE *)a4, a1, a2);
      break;
    case 37:
      v30[5] = a4;
      status_cmd = bm1740_makeup_bist_write_wait_cmd(
                     *(_BYTE *)(a4 + 1),
                     *(_BYTE *)a4,
                     a4 + 2,
                     *(_BYTE *)(a4 + 8),
    ...
    case 38:
      v30[4] = a4;
      status_cmd = bm1740_makeup_bist_write_wait_read_cmd(*(_BYTE *)(a4 + 1), *(_BYTE *)a4, a4 + 2, a1, a2);
      break;
    case 39:
      v30[3] = a4;
      status_cmd = bm1740_makeup_bist_wait_cmd(*(_BYTE *)(a4 + 1), *(_BYTE *)a4, a4 + 2, a1, a2);
      break;
    case 40:
      v30[2] = a4;
      status_cmd = bm1740_makeup_bist_read_cmd(*(_BYTE *)(a4 + 1), *(_BYTE *)a4, a1, a2);
      break;
    case 41:
      v30[1] = a4;
      status_cmd = bm1740_makeup_bist_disable_cmd(*(_BYTE *)(a4 + 1), *(_BYTE *)a4, a1, a2);
      break;
    default:
      if ( use_syslog || opt_log_output || opt_log_level >= 0 )
      {
        snprintf(s, 0x100u, "unknow ioctl type %d\n", a3);
        applog(0, s);
      }
      status_cmd = 0;
      break;
...
int __fastcall rt_ringbuffer_put(int a1, char *a2, unsigned __int16 a3)
{
  ...
  if ( *(unsigned __int16 *)(a1 + 12) - (*(_WORD *)(a1 + 6) >> 1) <= a3 )
  {
    ...
    *(_WORD *)(a1 + 6) = *(_WORD *)(a1 + 6) & 1
                       | (2 * (((*(_WORD *)(a1 + 6) >> 1) - *(_WORD *)(a1 + 12) + a3) & 0x7FFF));
  }
  else
  {
...
int __fastcall rt_ringbuffer_get(int a1, char *a2, unsigned __int16 a3)
{
  ...
  if ( *(unsigned __int16 *)(a1 + 12) - (*(_WORD *)(a1 + 4) >> 1) <= a3 )
  {
    ...
    *(_WORD *)(a1 + 4) = *(_WORD *)(a1 + 4) & 1
                       | (2 * (((*(_WORD *)(a1 + 4) >> 1) - *(_WORD *)(a1 + 12) + a3) & 0x7FFF));
...
_BYTE *__fastcall Sha256_Transform(_BYTE *result, int a2)
{
  ...
  _BYTE v12[4]; // [sp+70h] [bp+70h] BYREF
  ...
  for ( i = 0; i <= 0x3F; i += 16 )
  {
    for ( j = 0; j <= 0xF; ++j )
    {
      v2 = (7 - (_BYTE)j) & 7;
      v3 = v9[v2];
      v4 = (__ROR4__(*(_DWORD *)&v12[4 * ((4 - (_BYTE)j) & 7) - 104], 6)
          ^ __ROR4__(*(_DWORD *)&v12[4 * ((4 - (_BYTE)j) & 7) - 104], 11)
          ^ __ROR4__(*(_DWORD *)&v12[4 * ((4 - (_BYTE)j) & 7) - 104], 25))
         + ((*(_DWORD *)&v12[4 * ((6 - (_BYTE)j) & 7) - 104]
           ^ *(_DWORD *)&v12[4 * ((5 - (_BYTE)j) & 7) - 104])
          & *(_DWORD *)&v12[4 * ((4 - (_BYTE)j) & 7) - 104]
          ^ *(_DWORD *)&v12[4 * ((6 - (_BYTE)j) & 7) - 104])
         + K[j + i];
      if ( i )
      {
        v5 = j;
        *(_DWORD *)&v12[4 * j - 72] = *(_DWORD *)&v12[4 * (j & 0xF) - 72]
                                    + (__ROR4__(*(_DWORD *)&v12[4 * (((_BYTE)j - 2) & 0xF) - 72], 17)
                                     ^ __ROR4__(*(_DWORD *)&v12[4 * (((_BYTE)j - 2) & 0xF) - 72], 19)
                                     ^ (*(_DWORD *)&v12[4 * (((_BYTE)j - 2) & 0xF) - 72] >> 10))
                                    + *(_DWORD *)&v12[4 * (((_BYTE)j - 7) & 0xF) - 72]
                                    + (__ROR4__(*(_DWORD *)&v12[4 * (((_BYTE)j - 15) & 0xF) - 72], 7)
                                     ^ __ROR4__(*(_DWORD *)&v12[4 * (((_BYTE)j - 15) & 0xF) - 72], 18)
                                     ^ (*(_DWORD *)&v12[4 * (((_BYTE)j - 15) & 0xF) - 72] >> 3));
        v6 = v9[v5 + 8];
      }
      else
      {
        *(_DWORD *)&v12[4 * j - 72] = *(_DWORD *)(a2 + 4 * j);
        v6 = *(_DWORD *)&v12[4 * j - 72];
      }
      v9[v2] = v3 + v4 + v6;
      *(_DWORD *)&v12[4 * ((3 - (_BYTE)j) & 7) - 104] = v9[(3 - (_BYTE)j) & 7]
                                                      + *(_DWORD *)&v12[4 * ((7 - (_BYTE)j) & 7) - 104];
      result = v12;
      v9[(7 - (_BYTE)j) & 7] += (__ROR4__(*(_DWORD *)&v12[4 * (-j & 7) - 104], 2)
                               ^ __ROR4__(*(_DWORD *)&v12[4 * (-j & 7) - 104], 13)
                               ^ __ROR4__(*(_DWORD *)&v12[4 * (-j & 7) - 104], 22))
                              + ((*(_DWORD *)&v12[4 * ((1 - (_BYTE)j) & 7) - 104] | *(_DWORD *)&v12[4 * (-j & 7) - 104])
                               & *(_DWORD *)&v12[4 * ((2 - (_BYTE)j) & 7) - 104]
                               | *(_DWORD *)&v12[4 * (-j & 7) - 104] & *(_DWORD *)&v12[4 * ((1 - (_BYTE)j) & 7) - 104]);
    }
  }
  for ( i = 0; i <= 7; ++i )
    *(_DWORD *)&v8[4 * i] += *(_DWORD *)&v12[4 * i - 104];
  return result;
}
...
int __fastcall Sha256_Onestep(_BYTE *a1, int a2, _BYTE *a3)
{
  _BYTE v7[104]; // [sp+10h] [bp+10h] BYREF
...
int __fastcall sortValidator(_DWORD *a1, int a2)
{
  ...
  signed int v10; // [sp+110h] [bp+108h] BYREF
  _BYTE v11[12]; // [sp+114h] [bp+10Ch] BYREF
  _BYTE v12[12]; // [sp+134h] [bp+12Ch] BYREF
  _BYTE v13[1356]; // [sp+154h] [bp+14Ch] BYREF
  _BYTE src[28]; // [sp+E94h] [bp+E8Ch] BYREF
  __int16 v15; // [sp+EB0h] [bp+EA8h]
  _DWORD s[8]; // [sp+EB4h] [bp+EACh] BYREF
  _DWORD v17[509]; // [sp+ED4h] [bp+ECCh] BYREF
  char *v18; // [sp+16D4h] [bp+16CCh]
  char *v19; // [sp+16D8h] [bp+16D0h]
  signed int v20; // [sp+16DCh] [bp+16D4h]
  _BYTE *v21; // [sp+16E0h] [bp+16D8h]
  int v22; // [sp+16E4h] [bp+16DCh]
  unsigned int v23; // [sp+16E8h] [bp+16E0h]
  int v24; // [sp+16ECh] [bp+16E4h]
  int v25; // [sp+16F0h] [bp+16E8h]
  unsigned int v26; // [sp+16F4h] [bp+16ECh]
  int v27; // [sp+16F8h] [bp+16F0h]
  unsigned int v28; // [sp+16FCh] [bp+16F4h]
  const void *v29; // [sp+1700h] [bp+16F8h]
  int v30; // [sp+1704h] [bp+16FCh]
  int v31; // [sp+1708h] [bp+1700h]
  _DWORD *v32; // [sp+170Ch] [bp+1704h]
  unsigned int i3; // [sp+1710h] [bp+1708h]
  size_t i2; // [sp+1714h] [bp+170Ch]
  ...
  else
  {
    ...
    if ( isZero((int)s, 0x1Eu) )
    {
      ...
      for ( m = 0; m <= 8; ++m )
      {
        ...
        {
          for ( ii = 0; ii < v26; ++ii )
            src[ii] = v49[(n + 1) * (v26 + v52) + ii] ^ v49[n * (v26 + v52) + ii];
          memcpy(&v48[(n >> 1) * (2 * v52 + v26)], src, v26);
      ...
      for ( nn = 0; nn < v22; ++nn )
      {
        ...
        v21 = bin2hex((int)&v49[nn * (v26 + v52)], 34);
        free(v21);
      }
      for ( i1 = 0; i1 <= 8; ++i1 )
      {
        ...
        {
          for ( i3 = 0; i3 < v26; ++i3 )
            src[i3] = v49[(i2 + 1) * (v26 + v52) + i3] ^ v49[i2 * (v26 + v52) + i3];
          memcpy(&v48[(i2 >> 1) * (2 * v52 + v26)], src, v26);
      ...
      v21 = bin2hex((int)v13, 1344);
      free(v21);
      v21 = bin2hex((int)v49, v26 + v52);
      free(v21);
      v3 = *((_DWORD *)v49 + 1);
      v4 = *((_DWORD *)v49 + 2);
      v5 = *((_DWORD *)v49 + 3);
...
_BYTE *__fastcall _bin2hex(_BYTE *result, int a2, int a3)
{
  _BYTE *v3; // [sp+Ch] [bp+Ch]
  _BYTE *v4; // [sp+Ch] [bp+Ch]
  int i; // [sp+14h] [bp+14h]

  v3 = result;
  for ( i = 0; a3 > i; ++i )
  {
    *v3 = hex_5140[*(_BYTE *)(a2 + i) >> 4];
    v4 = v3 + 1;
    *v4 = hex_5140[*(_BYTE *)(a2 + i) & 0xF];
    v3 = v4 + 1;
  }
  *v3 = 0;
  return result;
...
int __fastcall get_BM1385_plldata(int a1, _DWORD *a2, unsigned __int16 *a3, _DWORD *a4)
{
  _DWORD v8[8]; // [sp+18h] [bp+10h] BYREF
  _DWORD v9[8]; // [sp+38h] [bp+30h] BYREF
  _DWORD v10[8]; // [sp+58h] [bp+50h] BYREF
  char s[12]; // [sp+78h] [bp+70h] BYREF
  ...
  sprintf(s, "%d", a1);
  for ( i = 0; i <= 0x7B && memcmp((&freq_pll_1385)[4 * i], s, 4u); ++i )
    ;
  ...
  sprintf((char *)v10, "%08x", (&freq_pll_1385)[4 * i + 1]);
  sprintf((char *)v9, "%04x", (&freq_pll_1385)[4 * i + 2]);
  sprintf((char *)v8, "%04x", (&freq_pll_1385)[4 * i + 3]);
  printf(
...
int __fastcall set_BM1385_freq(unsigned __int8 a1, unsigned __int8 a2, int a3, char a4)
{
  ...
  _DWORD v13[4]; // [sp+14h] [bp+14h] BYREF
  unsigned __int8 s[4]; // [sp+24h] [bp+24h] BYREF
  ...
  while ( v12 <= 2 )
  {
    ...
    if ( v10 )
    {
      ...
      for ( i = 0; i < v10; ++i )
      {
        ...
        {
          memset(s, 0, 5u);
          s[3] = *(_DWORD *)(reg_value_buf + 8 * (*(_DWORD *)(reg_value_buf + 4) + 2));
          s[2] = BYTE1(*(_DWORD *)(reg_value_buf + 8 * (*(_DWORD *)(reg_value_buf + 4) + 2)));
          s[1] = BYTE2(*(_DWORD *)(reg_value_buf + 8 * (*(_DWORD *)(reg_value_buf + 4) + 2)));
          s[0] = HIBYTE(*(_DWORD *)(reg_value_buf + 8 * (*(_DWORD *)(reg_value_buf + 4) + 2)));
          if ( CRC5(s, 0x23u) == *(unsigned __int8 *)(reg_value_buf + 8 * (*(_DWORD *)(reg_value_buf + 4) + 2) + 4) )
          {
            if ( !a3 )
...
{
  int result; // r0
  unsigned __int8 s[64]; // [sp+Ch] [bp+Ch] BYREF
...
{
  int v1; // r3
  unsigned __int8 s[64]; // [sp+14h] [bp+Ch] BYREF
  ...
  for ( j = 0; j < v19; ++j )
  {
    ...
    for ( k = 0; dword_61BA0 > k; ++k )
    {
      ...
      s[51] = k;
      for ( i = 0; i <= 11; ++i )
        s[i + 52] = *((_BYTE *)src + i + 8);
      uart_send(v11, s, 0x40u);
...
int __fastcall single_BM1385_receive_func(unsigned __int8 *a1)
{
  unsigned __int8 v2[8]; // [sp+Ch] [bp+Ch] BYREF
  _BYTE v3[500]; // [sp+14h] [bp+14h] BYREF
  _BYTE s[1000]; // [sp+208h] [bp+208h] BYREF
...
LABEL_28:
  while ( start_receive )
  {
    ...
    {
      memset(s, 0, sizeof(s));
      v8 = uart_receive(v10, (int)s, 0x3E8u);
      if ( v8 && v17 <= 2 )
      {
        for ( j = 0; j < v8; ++j )
          v3[v16++] = s[j];
        if ( v16 > 4 )
        {
          ...
          for ( j = 0; j < v7; ++j )
          {
            ...
            for ( k = 0; k <= 4; ++k )
              v2[k] = v3[v15++];
            if ( BM1385_is_nonce_or_reg_value(v2[4]) )
            {
              if ( gStartTest )
              {
                if ( gIsOpenCoreEnd )
                {
                  v5 = single_BM1385_check_nonce(v10, v2);
                  if ( v5 == -1 )
                    ++v17;
                }
              }
...
int singleAsicTest_BM1385()
{
  ...
  else
  {
    ...
    if ( *((unsigned __int8 *)&cgpu + (unsigned __int8)gChain + 131836) == dword_61BCC )
    {
      ...
      pthread_cancel(newthread);
      LOBYTE(v3) = single_BM1385_get_result(gChain);
      single_BM1385_print_lcd((unsigned __int8)gChain, v3);
      set_fan_speed(0);
    ...
    else
    {
      pthread_cancel(dword_5184C);
      pthread_cancel(newthread);
      sprintf(&v1[7], "%d", *((unsigned __int8 *)&cgpu + (unsigned __int8)gChain + 131836));
...
// 308A4: using guessed type _UNKNOWN *Single_BM1385_WorkDataPathPrefix;
...
// 61B60: using guessed type char Conf;
...
int __fastcall CRC16(_BYTE *a1, __int16 a2)
{
  ...
  while ( a2-- != 0 )
  {
    v6 = (unsigned __int8)(v7 ^ *a1++);
    v7 = v8 ^ chCRCHTalbe[v6];
    v8 = chCRCLTalbe[v6];
  }
  return (unsigned __int16)v7 | (unsigned __int16)(v8 << 8);
}
...
int __fastcall check_hw(_DWORD *a1, unsigned int a2, char a3)
{
  ...
  int v7; // r2
  int v8; // r3
  _DWORD s[58]; // [sp+14h] [bp+14h] BYREF
  unsigned int src; // [sp+FCh] [bp+FCh] BYREF
  _BYTE v16[32]; // [sp+100h] [bp+100h] BYREF
  unsigned int dest[8]; // [sp+120h] [bp+120h] BYREF
  unsigned int *v18; // [sp+140h] [bp+140h]
  ...
  memset(v16, 0, sizeof(v16));
  v18 = dest;
  src = (a2 << 24) | HIBYTE(a2) | ((a2 & 0xFF0000) >> 8) | ((a2 & 0xFF00) << 8);
  v3 = a1[6];
  v4 = a1[7];
  v5 = a1[8];
  s[2] = a1[5];
  ...
  s[0] = 80;
  s[1] = 0;
  memcpy(dest, a1 + 2, 0xCu);
  rev((int)dest, 12);
  flip_swab((unsigned int)&s[10], (int)dest, 0xCu);
  memcpy(dest, &src, 4u);
  rev((int)dest, 4);
  flip_swab((unsigned int)&s[13], (int)dest, 4u);
  sha2_finish(s, dest);
  memset(s, 0, sizeof(s));
  sha2(dest, 32, v16);
  flip32((unsigned int)dest, (int)v16);
  if ( !v18[7] )
    return 0;
  if ( a3 )
  {
...
size_t __fastcall uart_send(unsigned __int8 a1, unsigned __int8 *a2, size_t a3)
{
  ...
  size_t v12; // [sp+218h] [bp+218h]
  int v13; // [sp+21Ch] [bp+21Ch]
  signed int v14; // [sp+220h] [bp+220h]
  int v15; // [sp+224h] [bp+224h]
  size_t i; // [sp+228h] [bp+228h]
  int v17; // [sp+22Ch] [bp+22Ch]
  int v18; // [sp+230h] [bp+230h]
  int v19; // [sp+234h] [bp+234h]
  int v20; // [sp+238h] [bp+238h]
  int v21; // [sp+23Ch] [bp+23Ch]
  signed int j; // [sp+240h] [bp+240h]
  int v23; // [sp+244h] [bp+244h]
...
LABEL_15:
  ...
  while ( 1 )
  {
    axi_fpga = read_axi_fpga(v20);
    v11 = (unsigned __int8)(axi_fpga >> v17);
    if ( v11 >= a3 )
      break;
    usleep(0xBB8u);
    if ( ++v23 > 20 )
  ...
  for ( j = 0; j < v14; ++j )
  {
    v21 = (unsigned __int8)s[4 * j + 3]
        | ((unsigned __int8)s[4 * j] << 24)
        | ((unsigned __int8)s[4 * j + 1] << 16)
        | ((unsigned __int8)s[4 * j + 2] << 8);
    write_axi_fpga(v18, v21);
  }
  v14 = v12 & 3;
  if ( (v12 & 3) != 0 )
  {
    ...
    {
      case 2:
        v21 = ((unsigned __int8)s[4 * j + 1] << 16) | ((unsigned __int8)s[4 * j] << 24);
        break;
      case 3:
        v21 = ((unsigned __int8)s[4 * j + 2] << 8)
            | ((unsigned __int8)s[4 * j] << 24)
            | ((unsigned __int8)s[4 * j + 1] << 16);
        break;
      case 1:
        v21 = (unsigned __int8)s[4 * j] << 24;
        break;
      default:
  ...
  write_axi_fpga(v19, v12 | 0x80000000);
  pthread_mutex_unlock(&uart_send_mutex[a1]);
  return v12;
}
// 1FD8C: variable 'v3' is possibly undefined
// 417F0: using guessed type pthread_mutex_t uart_send_mutex[1];
...
int __fastcall twoc2hex(unsigned __int8 a1, unsigned __int8 a2)
{
  ...
  v4 = c2hex(a1);
  return (unsigned __int8)c2hex(a2) ^ (unsigned __int8)(16 * v4);
}
...
int __fastcall get_work(int a1, int a2)
{
  ...
  *((_DWORD *)&cgpu + a1 + 16427) = malloc(56 * a2);
  if ( *((_DWORD *)&cgpu + a1 + 16427) )
  {
    while ( 1 )
    {
      if ( !fgets(s, 1023, *((FILE **)&cgpu + a1)) || v11 >= a2 )
        return v11;
        ...
        if ( v15 > 31 )
        {
          if ( v15 > 63 )
          {
            if ( v15 > 95 )
            {
              if ( (v9 & 1) != 0 )
              {
                sprintf(s, "%s%s%02i.txt", dest, byte_518B4, v15++);
                v9 >>= 1;
                break;
              }
              v9 >>= 1;
  ...
  else
  {
    for ( k = 0; v18 > k; ++k )
    {
      *((_DWORD *)&cgpu + k + 16427) = malloc(56 * v17 * dword_61BA0);
      ...
      for ( m = 0; v17 > m; ++m )
      {
        sprintf(s, "%s%02i%s%02i.txt", dest, k, byte_518B4, m);
        v3 = k * v17 + m;
        *((_DWORD *)&cgpu + v3) = fopen(s, "r");
...
int __fastcall PIC1704_update_pic_app_program(unsigned __int8 a1, unsigned __int8 a2)
{
  ...
  if ( v17 )
  {
    ...
    if ( v18 )
    {
      ...
      if ( v18 )
      {
        v18 = set_PIC16F1704_flash_pointer(a1, a2, 6u, 0);
        if ( v18 )
        {
          for ( i = 0; 4 * (v19 >> 5) > i; ++i )
          {
...
{
  int v4; // r4
  _BYTE s[100]; // [sp+24h] [bp+14h] BYREF
...
{
  int v4; // r4
  _BYTE v11[100]; // [sp+10h] [bp+10h] BYREF
  _BYTE s[100]; // [sp+74h] [bp+74h] BYREF
  ...
  {
    for ( i = 0; i < *(unsigned __int8 *)(a3 + 2) + 3; ++i )
      printf("\n--- %s failed! read_back_data[%d] = 0x%02x\n\n", "read_PIC16F1705_iic_slave", i, (unsigned __int8)s[i]);
    return 0;
  }
}
// 41830: using guessed type pthread_mutex_t i2c_mutex;
...
int __fastcall sha256_transf(int result, int a2, int a3)
{
  ...
  for ( i = 0; a3 > i; ++i )
  {
    ...
    for ( j = 0; j <= 63; ++j )
    {
      v14 = v11 + (__ROR4__(v8, 25) ^ __ROR4__(v8, 6) ^ __ROR4__(v8, 11)) + (v10 & ~v8 ^ v8 & v9) + sha256_k[j] + v12[j];
      result = v5;
...
int __fastcall sha256_final(_DWORD *a1, int a2)
{
  ...
  *((_BYTE *)a1 + v6 + 4) = HIBYTE(v7);
  ...
  for ( i = 0; i <= 7; ++i )
  {
    *(_BYTE *)(a2 + 4 * i + 3) = a1[i + 34];
    *(_BYTE *)(a2 + 4 * i + 2) = BYTE1(a1[i + 34]);
    *(_BYTE *)(a2 + 4 * i + 1) = BYTE2(a1[i + 34]);
...
int __fastcall sha2_process(_DWORD *a1, unsigned int *a2)
{
  ...
  v66 = (__ROR4__(v180, 6) ^ __ROR4__(v180, 11) ^ __ROR4__(v180, 25))
      ...
      + 1116352408;
  v196 = a1[5] + v66;
  v130 = v66 + (__ROR4__(v246, 2) ^ __ROR4__(v246, 13) ^ __ROR4__(v246, 22)) + (v212 & (v246 | v229) | v246 & v229);
  v67 = (__ROR4__(v196, 6) ^ __ROR4__(v196, 11) ^ __ROR4__(v196, 25))
      ...
      + 1899447441;
  v213 = v212 + v67;
  v147 = v67 + (__ROR4__(v130, 2) ^ __ROR4__(v130, 13) ^ __ROR4__(v130, 22)) + (v229 & (v130 | v246) | v130 & v246);
  v68 = (__ROR4__(v213, 6) ^ __ROR4__(v213, 11) ^ __ROR4__(v213, 25))
      ...
      - 1245643825;
  v230 = v229 + v68;
  v164 = v68 + (__ROR4__(v147, 2) ^ __ROR4__(v147, 13) ^ __ROR4__(v147, 22)) + (v246 & (v147 | v130) | v147 & v130);
  v69 = (__ROR4__(v230, 6) ^ __ROR4__(v230, 11) ^ __ROR4__(v230, 25))
      ...
      - 373957723;
  v247 = v246 + v69;
  v181 = v69 + (__ROR4__(v164, 2) ^ __ROR4__(v164, 13) ^ __ROR4__(v164, 22)) + (v130 & (v164 | v147) | v164 & v147);
  v70 = (__ROR4__(v247, 6) ^ __ROR4__(v247, 11) ^ __ROR4__(v247, 25))
      ...
      + 961987163;
  v131 = v130 + v70;
  v197 = v70 + (__ROR4__(v181, 2) ^ __ROR4__(v181, 13) ^ __ROR4__(v181, 22)) + (v147 & (v181 | v164) | v181 & v164);
  v71 = (__ROR4__(v131, 6) ^ __ROR4__(v131, 11) ^ __ROR4__(v131, 25))
      ...
      + 1508970993;
  v148 = v147 + v71;
  v214 = v71 + (__ROR4__(v197, 2) ^ __ROR4__(v197, 13) ^ __ROR4__(v197, 22)) + (v164 & (v197 | v181) | v197 & v181);
  v72 = (__ROR4__(v148, 6) ^ __ROR4__(v148, 11) ^ __ROR4__(v148, 25))
      ...
      - 1841331548;
  v165 = v164 + v72;
  v231 = v72 + (__ROR4__(v214, 2) ^ __ROR4__(v214, 13) ^ __ROR4__(v214, 22)) + (v181 & (v214 | v197) | v214 & v197);
  v73 = (__ROR4__(v165, 6) ^ __ROR4__(v165, 11) ^ __ROR4__(v165, 25))
      ...
      - 1424204075;
  v182 = v181 + v73;
  v248 = v73 + (__ROR4__(v231, 2) ^ __ROR4__(v231, 13) ^ __ROR4__(v231, 22)) + (v197 & (v231 | v214) | v231 & v214);
  v74 = (__ROR4__(v182, 6) ^ __ROR4__(v182, 11) ^ __ROR4__(v182, 25))
      ...
      - 670586216;
  v198 = v197 + v74;
  v132 = v74 + (__ROR4__(v248, 2) ^ __ROR4__(v248, 13) ^ __ROR4__(v248, 22)) + (v214 & (v248 | v231) | v248 & v231);
  v75 = (__ROR4__(v198, 6) ^ __ROR4__(v198, 11) ^ __ROR4__(v198, 25))
      ...
      + 310598401;
  v215 = v214 + v75;
  v149 = v75 + (__ROR4__(v132, 2) ^ __ROR4__(v132, 13) ^ __ROR4__(v132, 22)) + (v231 & (v132 | v248) | v132 & v248);
  v76 = (__ROR4__(v215, 6) ^ __ROR4__(v215, 11) ^ __ROR4__(v215, 25))
      ...
      + 607225278;
  v232 = v231 + v76;
  v166 = v76 + (__ROR4__(v149, 2) ^ __ROR4__(v149, 13) ^ __ROR4__(v149, 22)) + (v248 & (v149 | v132) | v149 & v132);
  v77 = (__ROR4__(v232, 6) ^ __ROR4__(v232, 11) ^ __ROR4__(v232, 25))
      ...
      + 1426881987;
  v249 = v248 + v77;
  v183 = v77 + (__ROR4__(v166, 2) ^ __ROR4__(v166, 13) ^ __ROR4__(v166, 22)) + (v132 & (v166 | v149) | v166 & v149);
  v78 = (__ROR4__(v249, 6) ^ __ROR4__(v249, 11) ^ __ROR4__(v249, 25))
      ...
      + 1925078388;
  v133 = v132 + v78;
  v199 = v78 + (__ROR4__(v183, 2) ^ __ROR4__(v183, 13) ^ __ROR4__(v183, 22)) + (v149 & (v183 | v166) | v183 & v166);
  v79 = (__ROR4__(v133, 6) ^ __ROR4__(v133, 11) ^ __ROR4__(v133, 25))
      ...
      - 2132889090;
  v150 = v149 + v79;
  v216 = v79 + (__ROR4__(v199, 2) ^ __ROR4__(v199, 13) ^ __ROR4__(v199, 22)) + (v166 & (v199 | v183) | v199 & v183);
  v80 = (__ROR4__(v150, 6) ^ __ROR4__(v150, 11) ^ __ROR4__(v150, 25))
      ...
      - 1680079193;
  v167 = v166 + v80;
  v233 = v80 + (__ROR4__(v216, 2) ^ __ROR4__(v216, 13) ^ __ROR4__(v216, 22)) + (v183 & (v216 | v199) | v216 & v199);
  v81 = (__ROR4__(v167, 6) ^ __ROR4__(v167, 11) ^ __ROR4__(v167, 25))
      ...
      - 1046744716;
  v184 = v183 + v81;
  v250 = v81 + (__ROR4__(v233, 2) ^ __ROR4__(v233, 13) ^ __ROR4__(v233, 22)) + (v199 & (v233 | v216) | v233 & v216);
  ...
  v82 = (__ROR4__(v184, 6) ^ __ROR4__(v184, 11) ^ __ROR4__(v184, 25))
      ...
      - 459576895;
  v200 = v199 + v82;
  v134 = v82 + (__ROR4__(v250, 2) ^ __ROR4__(v250, 13) ^ __ROR4__(v250, 22)) + (v216 & (v250 | v233) | v250 & v233);
  ...
  v83 = (__ROR4__(v200, 6) ^ __ROR4__(v200, 11) ^ __ROR4__(v200, 25))
      ...
      - 272742522;
  v217 = v216 + v83;
  v151 = v83 + (__ROR4__(v134, 2) ^ __ROR4__(v134, 13) ^ __ROR4__(v134, 22)) + (v233 & (v134 | v250) | v134 & v250);
  ...
  v84 = (__ROR4__(v217, 6) ^ __ROR4__(v217, 11) ^ __ROR4__(v217, 25))
      ...
      + 264347078;
  v234 = v233 + v84;
  v168 = v84 + (__ROR4__(v151, 2) ^ __ROR4__(v151, 13) ^ __ROR4__(v151, 22)) + (v250 & (v151 | v134) | v151 & v134);
  ...
  v85 = (__ROR4__(v234, 6) ^ __ROR4__(v234, 11) ^ __ROR4__(v234, 25))
      ...
      + 604807628;
  v251 = v250 + v85;
  v185 = v85 + (__ROR4__(v168, 2) ^ __ROR4__(v168, 13) ^ __ROR4__(v168, 22)) + (v134 & (v168 | v151) | v168 & v151);
  ...
  v86 = (__ROR4__(v251, 6) ^ __ROR4__(v251, 11) ^ __ROR4__(v251, 25))
      ...
      + 770255983;
  v135 = v134 + v86;
  v201 = v86 + (__ROR4__(v185, 2) ^ __ROR4__(v185, 13) ^ __ROR4__(v185, 22)) + (v151 & (v185 | v168) | v185 & v168);
  ...
  v87 = (__ROR4__(v135, 6) ^ __ROR4__(v135, 11) ^ __ROR4__(v135, 25))
      ...
      + 1249150122;
  v152 = v151 + v87;
  v218 = v87 + (__ROR4__(v201, 2) ^ __ROR4__(v201, 13) ^ __ROR4__(v201, 22)) + (v168 & (v201 | v185) | v201 & v185);
  ...
  v88 = (__ROR4__(v152, 6) ^ __ROR4__(v152, 11) ^ __ROR4__(v152, 25))
      ...
      + 1555081692;
  v169 = v168 + v88;
  v235 = v88 + (__ROR4__(v218, 2) ^ __ROR4__(v218, 13) ^ __ROR4__(v218, 22)) + (v185 & (v218 | v201) | v218 & v201);
  ...
  v89 = (__ROR4__(v169, 6) ^ __ROR4__(v169, 11) ^ __ROR4__(v169, 25))
      ...
      + 1996064986;
  v186 = v185 + v89;
  v252 = v89 + (__ROR4__(v235, 2) ^ __ROR4__(v235, 13) ^ __ROR4__(v235, 22)) + (v201 & (v235 | v218) | v235 & v218);
  ...
  v90 = (__ROR4__(v186, 6) ^ __ROR4__(v186, 11) ^ __ROR4__(v186, 25))
      ...
      - 1740746414;
  v202 = v201 + v90;
  v136 = v90 + (__ROR4__(v252, 2) ^ __ROR4__(v252, 13) ^ __ROR4__(v252, 22)) + (v218 & (v252 | v235) | v252 & v235);
  ...
  v91 = (__ROR4__(v202, 6) ^ __ROR4__(v202, 11) ^ __ROR4__(v202, 25))
      ...
      - 1473132947;
  v219 = v218 + v91;
  v153 = v91 + (__ROR4__(v136, 2) ^ __ROR4__(v136, 13) ^ __ROR4__(v136, 22)) + (v235 & (v136 | v252) | v136 & v252);
  ...
  v92 = (__ROR4__(v219, 6) ^ __ROR4__(v219, 11) ^ __ROR4__(v219, 25))
      ...
      - 1341970488;
  v236 = v235 + v92;
  v170 = v92 + (__ROR4__(v153, 2) ^ __ROR4__(v153, 13) ^ __ROR4__(v153, 22)) + (v252 & (v153 | v136) | v153 & v136);
  ...
  v93 = (__ROR4__(v236, 6) ^ __ROR4__(v236, 11) ^ __ROR4__(v236, 25))
      ...
      - 1084653625;
  v253 = v252 + v93;
  v187 = v93 + (__ROR4__(v170, 2) ^ __ROR4__(v170, 13) ^ __ROR4__(v170, 22)) + (v136 & (v170 | v153) | v170 & v153);
  ...
  v94 = (__ROR4__(v253, 6) ^ __ROR4__(v253, 11) ^ __ROR4__(v253, 25))
      ...
      - 958395405;
  v137 = v136 + v94;
  v203 = v94 + (__ROR4__(v187, 2) ^ __ROR4__(v187, 13) ^ __ROR4__(v187, 22)) + (v153 & (v187 | v170) | v187 & v170);
  ...
  v95 = (__ROR4__(v137, 6) ^ __ROR4__(v137, 11) ^ __ROR4__(v137, 25))
      ...
      - 710438585;
  v154 = v153 + v95;
  v220 = v95 + (__ROR4__(v203, 2) ^ __ROR4__(v203, 13) ^ __ROR4__(v203, 22)) + (v170 & (v203 | v187) | v203 & v187);
  ...
  v96 = (__ROR4__(v154, 6) ^ __ROR4__(v154, 11) ^ __ROR4__(v154, 25))
      ...
      + 113926993;
  v171 = v170 + v96;
  v237 = v96 + (__ROR4__(v220, 2) ^ __ROR4__(v220, 13) ^ __ROR4__(v220, 22)) + (v187 & (v220 | v203) | v220 & v203);
  ...
  v97 = (__ROR4__(v171, 6) ^ __ROR4__(v171, 11) ^ __ROR4__(v171, 25))
      ...
      + 338241895;
  v188 = v187 + v97;
  v254 = v97 + (__ROR4__(v237, 2) ^ __ROR4__(v237, 13) ^ __ROR4__(v237, 22)) + (v203 & (v237 | v220) | v237 & v220);
  ...
  v98 = (__ROR4__(v188, 6) ^ __ROR4__(v188, 11) ^ __ROR4__(v188, 25))
      ...
      + 666307205;
  v204 = v203 + v98;
  v138 = v98 + (__ROR4__(v254, 2) ^ __ROR4__(v254, 13) ^ __ROR4__(v254, 22)) + (v220 & (v254 | v237) | v254 & v237);
  ...
  v99 = (__ROR4__(v204, 6) ^ __ROR4__(v204, 11) ^ __ROR4__(v204, 25))
      ...
      + 773529912;
  v221 = v220 + v99;
  v155 = v99 + (__ROR4__(v138, 2) ^ __ROR4__(v138, 13) ^ __ROR4__(v138, 22)) + (v237 & (v138 | v254) | v138 & v254);
  ...
  v100 = (__ROR4__(v221, 6) ^ __ROR4__(v221, 11) ^ __ROR4__(v221, 25))
       ...
       + 1294757372;
  v238 = v237 + v100;
  v172 = v100 + (__ROR4__(v155, 2) ^ __ROR4__(v155, 13) ^ __ROR4__(v155, 22)) + (v254 & (v155 | v138) | v155 & v138);
  ...
  v101 = (__ROR4__(v238, 6) ^ __ROR4__(v238, 11) ^ __ROR4__(v238, 25))
       ...
       + 1396182291;
  v255 = v254 + v101;
  v189 = v101 + (__ROR4__(v172, 2) ^ __ROR4__(v172, 13) ^ __ROR4__(v172, 22)) + (v138 & (v172 | v155) | v172 & v155);
  ...
  v102 = (__ROR4__(v255, 6) ^ __ROR4__(v255, 11) ^ __ROR4__(v255, 25))
       ...
       + 1695183700;
  v139 = v138 + v102;
  v205 = v102 + (__ROR4__(v189, 2) ^ __ROR4__(v189, 13) ^ __ROR4__(v189, 22)) + (v155 & (v189 | v172) | v189 & v172);
  ...
  v103 = (__ROR4__(v139, 6) ^ __ROR4__(v139, 11) ^ __ROR4__(v139, 25))
       ...
       + 1986661051;
  v156 = v155 + v103;
  v222 = v103 + (__ROR4__(v205, 2) ^ __ROR4__(v205, 13) ^ __ROR4__(v205, 22)) + (v172 & (v205 | v189) | v205 & v189);
  ...
  v104 = (__ROR4__(v156, 6) ^ __ROR4__(v156, 11) ^ __ROR4__(v156, 25))
       ...
       - 2117940946;
  v173 = v172 + v104;
  v239 = v104 + (__ROR4__(v222, 2) ^ __ROR4__(v222, 13) ^ __ROR4__(v222, 22)) + (v189 & (v222 | v205) | v222 & v205);
  ...
  v105 = (__ROR4__(v173, 6) ^ __ROR4__(v173, 11) ^ __ROR4__(v173, 25))
       ...
       - 1838011259;
  v190 = v189 + v105;
  v256 = v105 + (__ROR4__(v239, 2) ^ __ROR4__(v239, 13) ^ __ROR4__(v239, 22)) + (v205 & (v239 | v222) | v239 & v222);
  ...
  v106 = (__ROR4__(v190, 6) ^ __ROR4__(v190, 11) ^ __ROR4__(v190, 25))
       ...
       - 1564481375;
  v206 = v205 + v106;
  v140 = v106 + (__ROR4__(v256, 2) ^ __ROR4__(v256, 13) ^ __ROR4__(v256, 22)) + (v222 & (v256 | v239) | v256 & v239);
  ...
  v107 = (__ROR4__(v206, 6) ^ __ROR4__(v206, 11) ^ __ROR4__(v206, 25))
       ...
       - 1474664885;
  v223 = v222 + v107;
  v157 = v107 + (__ROR4__(v140, 2) ^ __ROR4__(v140, 13) ^ __ROR4__(v140, 22)) + (v239 & (v140 | v256) | v140 & v256);
  ...
  v108 = (__ROR4__(v223, 6) ^ __ROR4__(v223, 11) ^ __ROR4__(v223, 25))
       ...
       - 1035236496;
  v240 = v239 + v108;
  v174 = v108 + (__ROR4__(v157, 2) ^ __ROR4__(v157, 13) ^ __ROR4__(v157, 22)) + (v256 & (v157 | v140) | v157 & v140);
  ...
  v109 = (__ROR4__(v240, 6) ^ __ROR4__(v240, 11) ^ __ROR4__(v240, 25))
       ...
       - 949202525;
  v257 = v256 + v109;
  v191 = v109 + (__ROR4__(v174, 2) ^ __ROR4__(v174, 13) ^ __ROR4__(v174, 22)) + (v140 & (v174 | v157) | v174 & v157);
  ...
  v110 = (__ROR4__(v257, 6) ^ __ROR4__(v257, 11) ^ __ROR4__(v257, 25))
       ...
       - 778901479;
  v141 = v140 + v110;
  v207 = v110 + (__ROR4__(v191, 2) ^ __ROR4__(v191, 13) ^ __ROR4__(v191, 22)) + (v157 & (v191 | v174) | v191 & v174);
  ...
  v111 = (__ROR4__(v141, 6) ^ __ROR4__(v141, 11) ^ __ROR4__(v141, 25))
       ...
       - 694614492;
  v158 = v157 + v111;
  v224 = v111 + (__ROR4__(v207, 2) ^ __ROR4__(v207, 13) ^ __ROR4__(v207, 22)) + (v174 & (v207 | v191) | v207 & v191);
  ...
  v112 = (__ROR4__(v158, 6) ^ __ROR4__(v158, 11) ^ __ROR4__(v158, 25))
       ...
       - 200395387;
  v175 = v174 + v112;
  v241 = v112 + (__ROR4__(v224, 2) ^ __ROR4__(v224, 13) ^ __ROR4__(v224, 22)) + (v191 & (v224 | v207) | v224 & v207);
  ...
  v113 = (__ROR4__(v175, 6) ^ __ROR4__(v175, 11) ^ __ROR4__(v175, 25))
       ...
       + 275423344;
  v192 = v191 + v113;
  v258 = v113 + (__ROR4__(v241, 2) ^ __ROR4__(v241, 13) ^ __ROR4__(v241, 22)) + (v207 & (v241 | v224) | v241 & v224);
  ...
  v114 = (__ROR4__(v192, 6) ^ __ROR4__(v192, 11) ^ __ROR4__(v192, 25))
       ...
       + 430227734;
  v208 = v207 + v114;
  v142 = v114 + (__ROR4__(v258, 2) ^ __ROR4__(v258, 13) ^ __ROR4__(v258, 22)) + (v224 & (v258 | v241) | v258 & v241);
  ...
  v115 = (__ROR4__(v208, 6) ^ __ROR4__(v208, 11) ^ __ROR4__(v208, 25))
       ...
       + 506948616;
  v225 = v224 + v115;
  v159 = v115 + (__ROR4__(v142, 2) ^ __ROR4__(v142, 13) ^ __ROR4__(v142, 22)) + (v241 & (v142 | v258) | v142 & v258);
  ...
  v116 = (__ROR4__(v225, 6) ^ __ROR4__(v225, 11) ^ __ROR4__(v225, 25))
       ...
       + 659060556;
  v242 = v241 + v116;
  v176 = v116 + (__ROR4__(v159, 2) ^ __ROR4__(v159, 13) ^ __ROR4__(v159, 22)) + (v258 & (v159 | v142) | v159 & v142);
  ...
  v117 = (__ROR4__(v242, 6) ^ __ROR4__(v242, 11) ^ __ROR4__(v242, 25))
       ...
       + 883997877;
  v259 = v258 + v117;
  v193 = v117 + (__ROR4__(v176, 2) ^ __ROR4__(v176, 13) ^ __ROR4__(v176, 22)) + (v142 & (v176 | v159) | v176 & v159);
  ...
  v118 = (__ROR4__(v259, 6) ^ __ROR4__(v259, 11) ^ __ROR4__(v259, 25))
       ...
       + 958139571;
  v143 = v142 + v118;
  v209 = v118 + (__ROR4__(v193, 2) ^ __ROR4__(v193, 13) ^ __ROR4__(v193, 22)) + (v159 & (v193 | v176) | v193 & v176);
  ...
  v119 = (__ROR4__(v143, 6) ^ __ROR4__(v143, 11) ^ __ROR4__(v143, 25))
       ...
       + 1322822218;
  v160 = v159 + v119;
  v226 = v119 + (__ROR4__(v209, 2) ^ __ROR4__(v209, 13) ^ __ROR4__(v209, 22)) + (v176 & (v209 | v193) | v209 & v193);
  ...
  v120 = (__ROR4__(v160, 6) ^ __ROR4__(v160, 11) ^ __ROR4__(v160, 25))
       ...
       + 1537002063;
  v177 = v176 + v120;
  v243 = v120 + (__ROR4__(v226, 2) ^ __ROR4__(v226, 13) ^ __ROR4__(v226, 22)) + (v193 & (v226 | v209) | v226 & v209);
  ...
  v121 = (__ROR4__(v177, 6) ^ __ROR4__(v177, 11) ^ __ROR4__(v177, 25))
       ...
       + 1747873779;
  v194 = v193 + v121;
  v260 = v121 + (__ROR4__(v243, 2) ^ __ROR4__(v243, 13) ^ __ROR4__(v243, 22)) + (v209 & (v243 | v226) | v243 & v226);
  ...
  v122 = (__ROR4__(v194, 6) ^ __ROR4__(v194, 11) ^ __ROR4__(v194, 25))
       ...
       + 1955562222;
  v210 = v209 + v122;
  v144 = v122 + (__ROR4__(v260, 2) ^ __ROR4__(v260, 13) ^ __ROR4__(v260, 22)) + (v226 & (v260 | v243) | v260 & v243);
  ...
  v123 = (__ROR4__(v210, 6) ^ __ROR4__(v210, 11) ^ __ROR4__(v210, 25))
       ...
       + 2024104815;
  v227 = v226 + v123;
  v161 = v123 + (__ROR4__(v144, 2) ^ __ROR4__(v144, 13) ^ __ROR4__(v144, 22)) + (v243 & (v144 | v260) | v144 & v260);
  ...
  v124 = (__ROR4__(v227, 6) ^ __ROR4__(v227, 11) ^ __ROR4__(v227, 25))
       ...
       - 2067236844;
  v244 = v243 + v124;
  v178 = v124 + (__ROR4__(v161, 2) ^ __ROR4__(v161, 13) ^ __ROR4__(v161, 22)) + (v260 & (v161 | v144) | v161 & v144);
  ...
  v125 = (__ROR4__(v244, 6) ^ __ROR4__(v244, 11) ^ __ROR4__(v244, 25))
       ...
       - 1933114872;
  v261 = v260 + v125;
  v195 = v125 + (__ROR4__(v178, 2) ^ __ROR4__(v178, 13) ^ __ROR4__(v178, 22)) + (v144 & (v178 | v161) | v178 & v161);
  ...
  v126 = (__ROR4__(v261, 6) ^ __ROR4__(v261, 11) ^ __ROR4__(v261, 25))
       ...
       - 1866530822;
  v145 = v144 + v126;
  v211 = v126 + (__ROR4__(v195, 2) ^ __ROR4__(v195, 13) ^ __ROR4__(v195, 22)) + (v161 & (v195 | v178) | v195 & v178);
  ...
  v127 = (__ROR4__(v145, 6) ^ __ROR4__(v145, 11) ^ __ROR4__(v145, 25))
       ...
       - 1538233109;
  v162 = v161 + v127;
  v228 = v127 + (__ROR4__(v211, 2) ^ __ROR4__(v211, 13) ^ __ROR4__(v211, 22)) + (v178 & (v211 | v195) | v211 & v195);
  v128 = (__ROR4__(v162, 6) ^ __ROR4__(v162, 11) ^ __ROR4__(v162, 25))
       ...
       - 1090935817;
  v179 = v178 + v128;
  v245 = v128 + (__ROR4__(v228, 2) ^ __ROR4__(v228, 13) ^ __ROR4__(v228, 22)) + (v195 & (v228 | v211) | v228 & v211);
  v129 = (__ROR4__(v179, 6) ^ __ROR4__(v179, 11) ^ __ROR4__(v179, 25))
       ...
       - 965641998;
  result = v245 | v228;
  a1[2] += v129 + (__ROR4__(v245, 2) ^ __ROR4__(v245, 13) ^ __ROR4__(v245, 22)) + (v211 & (v245 | v228) | v245 & v228);
  a1[3] += v245;
  a1[4] += v228;
  a1[5] += v211;
  a1[6] += v195 + v129;
...
// 2F6C0: using guessed type unsigned int sha2_padding[16];
  ...
  for ( i = 0; i <= 3; ++i )
  {
    ...
    for ( j = 0; j <= 0x31; ++j )
    {
      for ( k = 0; dword_61BA0 > k; ++k )
      {
        ...
        s[51] = k;
        for ( m = 0; m <= 11; ++m )
          s[m + 52] = *((_BYTE *)src + m + 8);
        uart_send(v9, s, 0x40u);
...
int __fastcall V9_receive_func(unsigned __int8 *a1)
{
  unsigned __int8 v2[8]; // [sp+8h] [bp+8h] BYREF
  _BYTE v3[500]; // [sp+10h] [bp+10h] BYREF
  _BYTE s[1052]; // [sp+204h] [bp+204h] BYREF
...
int singleBoardTest_V9_BM1385_45()
{
  ...
  _BYTE v7[16]; // [sp+2Ch] [bp+24h] BYREF
  int v8; // [sp+3Ch] [bp+34h]
  int v9; // [sp+40h] [bp+38h]
