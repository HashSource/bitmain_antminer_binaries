...
struct Elf32_Sym
{
  unsigned __int32 st_name __offset(OFF32,0x134E0);
...
struct Elf32_Verneed
{
  ...
  unsigned __int32 vn_file __offset(OFF32,0x134E0);
...
struct Elf32_Vernaux
{
  ...
  unsigned __int32 vna_name __offset(OFF32,0x134E0);
...
/* 346 */
struct __attribute__((aligned(4))) history_result
{
  bool asic_ok;
  bool nonce_rate_ok;
  bool eeprom_ok;
  ...
  uint8_t asic_core_nonce_num[256][2048];
...
/* 183 */
struct sensor_attached_to_switch
{
  uint8_t channel;
  bool power_supply_ctrlboard;
...
/* 182 */
struct __attribute__((aligned(4))) switch_sensor
{
  char switch_model[16];
  uint32_t switch_addr;
  uint8_t sensor_num;
  sensor_attached_to_switch switch_sensor_info[8];
};
...
/* 202 */
struct pt1_format_v1_t
{
  char board_sn[18];
  char factory_job[24];
  char chip_die[3];
  char chip_marking[14];
  char ft_version[10];
  char chip_tech[3];
  uint8_t chip_bin;
  __attribute__((packed)) __attribute__((aligned(1))) uint16_t pcb_version;
  uint8_t bom_version;
  uint8_t sensor_type;
  uint8_t pt1_result;
  uint8_t pt1_count;
...
struct sweep_format_v1_t
{
  ...
  uint8_t sweep_count;
  uint8_t temp_offset[4];
  uint8_t placeholder[2];
  uint8_t sweep_crc;
};

/* 196 */
struct eeprom_format_v1
{
  pt1_format_v1_t pt1;
  pt2_format_v1_t pt2;
  sweep_format_v1_t sweep;
};

/* 199 */
struct pt1_format_v2_t
{
  uint8_t pt1_data;
};

/* 198 */
struct pt2_format_v2_t
{
  uint8_t pt2_data;
};

/* 197 */
struct sweep_format_v2_t
{
  uint8_t sweep_data;
};

/* 195 */
struct eeprom_format_v2
{
  pt1_format_v2_t pt1;
  pt2_format_v2_t pt2;
  sweep_format_v2_t sweep;
};

/* 458 */
union eeprom_v1_t::$E184FB4B0340E71DABABA3E39BD0824F::$94B9B996444CD2384B2BD3509732C159
{
  eeprom_format_v1 format_v1;
  eeprom_format_v2 format_v2;
  uint8_t raw[240];
};

/* 459 */
struct eeprom_v1_t::$E184FB4B0340E71DABABA3E39BD0824F
{
  uint8_t version;
  char board_name[15];
  union
...
/* 460 */
struct __attribute__((aligned(4))) eeprom_v1_t::$67559C5A13BC8808C58572379CBD7AE3
{
  uint8_t board_id;
  uint32_t nonce;
  uint8_t key_raw[32];
...
struct eeprom_v1_t
{
  bool (*is_version_available)(eeprom_v1_t *);
  bool (*is_board_name_available)(eeprom_v1_t *);
  bool (*is_pt1_available)(eeprom_v1_t *);
  bool (*is_pt2_available)(eeprom_v1_t *);
  bool (*is_sweep_available)(eeprom_v1_t *);
  int (*version_store)(eeprom_v1_t *);
  int (*board_name_store)(eeprom_v1_t *);
  int (*pt1_store)(eeprom_v1_t *);
  int (*pt2_store)(eeprom_v1_t *);
  int (*sweep_store)(eeprom_v1_t *);
  int (*version_retrieve)(eeprom_v1_t *);
  int (*board_name_retrieve)(eeprom_v1_t *);
  int (*pt1_retrieve)(eeprom_v1_t *);
  int (*pt2_retrieve)(eeprom_v1_t *);
  int (*sweep_retrieve)(eeprom_v1_t *);
  void (*set_sweep_freq)(eeprom_v1_t *, uint16_t *, uint8_t);
  void (*get_sweep_freq)(eeprom_v1_t *, uint16_t *, uint16_t *, uint16_t *, uint8_t);
  eeprom_v1_t::$E184FB4B0340E71DABABA3E39BD0824F data;
  eeprom_v1_t::$67559C5A13BC8808C58572379CBD7AE3 private;
};

/* 205 */
struct repaire_info_t
{
  int err;
  int test_process;
  char err_code[64];
...
struct switch_ctx
{
  bool read_from_switch;
  uint8_t switch_addr;
  uint8_t switch_sensor_num;
  switch_sensor_ctx switch_sensor_info[8];
};

/* 456 */
struct __attribute__((aligned(2))) _hash_board
{
  char asic_type[16];
  char board_name[16];
  uint32_t wait_temp;
  sensor_ctx sensor;
  switch_ctx switch_sensor;
};
...
/* 429 */
struct __attribute__((aligned(8))) _asic_status
{
  uint8_t asic_core_nonce_num[256][2048];
  uint16_t every_asic_got_nonce_num[256];
  uint16_t every_asic_reg_ntick_nonce_num[256];
  uint16_t every_asic_reg_nonce_error_num[256];
  uint16_t every_asic_reg_got_nonce_num[256];
  double every_asic_nonce_rate[256];
  bool ok_asic_list[256];
  bool bad_asic_list[256];
  uint32_t valid_nonce_num;
};
...
/* 280 */
struct asic_bad_list
{
  int bad_asic_num;
  int bad_asic_list[256];
};

/* 447 */
struct __attribute__((packed)) __attribute__((aligned(2))) multi_ft_value::$D4B52A253C48D69F2E8229249A0064D6
{
  uint8_t head;
  uint32_t data[2];
  uint8_t tail;
...
/* 285 */
union multi_ft_value
{
  multi_ft_value::$D4B52A253C48D69F2E8229249A0064D6 u;
  uint8_t v[10];
};

/* 284 */
struct __attribute__((packed)) __attribute__((aligned(1))) ft_bin_list_t
{
  multi_ft_value ft_value;
  char chip_ftversion[2][16];
  uint8_t chip_bin[2];
  uint8_t chip_col[2];
  uint8_t ft_bin_id;
};
...
/* 289 */
struct __attribute__((aligned(4))) asic_vol_dv_data
{
  int asic_returned_vol_count;
  int asic_returned_vol_data;
  bool asic_finish_vol_data_flag;
};

/* 286 */
struct chain_vol_dv_data
{
  int got_vol_asics_everytime;
  bool got_vol_flag_everytime[256];
  asic_vol_dv_data asic_vol_data_info[256];
  int finish_read_vol_asics;
};
...
/* 496 */
enum calibration_crrent : __int32
{
  calibration_crrent::POWER_CAL_CURRENT_300A = 0x0,
  calibration_crrent::POWER_CAL_CURRENT_200A = 0x1,
  calibration_crrent::POWER_CAL_CURRENT_100A = 0x2,
  calibration_crrent::POWER_CAL_CURRENT_50A = 0x3,
};
...
enum SWEEP_ERROR_CODE : __int32
{
  ...
  SWEEP_ERROR_CODE::SWEEP_SMALL_CORE_UNBALANCE = 0x12,
};
