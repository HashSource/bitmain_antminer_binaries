    ...
    if (param_1 == 0) {
      ...
      *(undefined4 *)(param_1 + 0x18) = 0;
      if (pcVar3 == (code *)0x0) {
        ...
        *(undefined4 *)(param_1 + 0x20) = 0x41e85;
      ...
      if (iVar2 == 0) {
        *(undefined4 *)(param_1 + 0x24) = 0x41e8d;
      }
      iVar1 = (*pcVar3)(*(undefined4 *)(param_1 + 0x28),1,0x1bcc,pcVar3,param_4);
      if (iVar1 == 0) {
        iVar2 = -4;
      }
      else {
        ...
        *(undefined4 *)(iVar1 + 0x34) = 0;
        iVar2 = inflateReset2(param_1,0xf);
        if (iVar2 != 0) {
