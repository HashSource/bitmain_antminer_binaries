...

{
  ...
  handler.sa_flags = 0;
  handler.__sigaction_handler = (anon_union_4_2_5ad2d23e_for___sigaction_handler)(code *)0x1aabd;
  ...
  for (; 0xb < _hj_k; _hj_k = _hj_k - 0xc) {
    iVar4 = _hj_j + (uint)_hj_key[4] + (uint)_hj_key[5] * 0x100 + (uint)_hj_key[6] * 0x10000 +
    ...
    uVar16 = uVar15 >> 0xd ^
             ((_hj_i + (uint)*_hj_key + (uint)_hj_key[1] * 0x100 + (uint)_hj_key[2] * 0x10000 +
                       (uint)_hj_key[3] * 0x1000000) - iVar4) - uVar15;
  ...
  uVar15 = uVar15 & ((blocks->hh).tbl)->num_buckets - 1;
    ...
    for (_he_bkt_i = 0; _he_bkt_i < ((__s->hh).tbl)->num_buckets; _he_bkt_i = _he_bkt_i + 1) {
      ...
      while (_he_thh != (UT_hash_handle *)0x0) {
        ...
        if (((__s->hh).tbl)->ideal_chain_maxlen < pUVar19->count) {
          ...
          uVar15 = __aeabi_uidiv(pUVar19->count,((__s->hh).tbl)->ideal_chain_maxlen);
  ...
  opt_parse(&argc_local,argv_local,(_func_void_char_ptr_varargs *)0x16119);
  uVar21 = tmp42._36_4_;
  if (argc_local != 1) {
    builtin_strncpy(tmp42,"Unexpected extra commandline arguments",0x27);
    tmp42[0x27] = SUB41(uVar21,3);
    _applog(3,tmp42,true);
    __quit(1,false);
  }
  ...
  if ((opt_benchmark != false) || (opt_benchfile != (char *)0x0)) {
    ppVar9 = add_pool();
    pcVar5 = (char *)_cgmalloc(0xff,"cgminer.c","main",0x2d16);
    ...
    if (pFVar10 == (FILE *)0x0) {
      ...
      if ((int)pcVar5 < 1) {
        ...
        if (pcVar5 == (char *)0x0) {
          ...
          pcVar23 = "main";
          _cg_memcpy(g_miner_compiletime,tmp,(int)pcVar5 - (int)tmp,"cgminer.c","main",0x2d51);
          strcpy(tmp,pcVar5 + 1);
          pcVar5 = strchr(tmp,10);
          if (pcVar5 == (char *)0x0) {
            ...
            pcVar23 = "main";
            _cg_memcpy(g_miner_type,tmp,(int)pcVar5 - (int)tmp,"cgminer.c","main",0x2d5a);
          }
        }
  ...
  builtin_strncpy(g_logfile_path,"/tmp/pattern_test_log",0x16);
  ...
  mining_threads = 0;
  for (i = 0; uVar21 = tmp42._32_4_, i < total_devices; i = i + 1) {
    enable_device(devices[i]);
  }
  if (total_devices == 0) {
    builtin_strncpy(tmp42,"All devices disabled, cannot mint!",0x23);
    tmp42[0x23] = SUB41(uVar21,3);
    _applog(3,tmp42,true);
    __quit(1,false);
  }
  ...
  for (i = 0; i < total_pools; i = i + 1) {
    ...
    if (ppVar9->rpc_userpass == (char *)0x0) {
      ...
      uVar15 = sVar6 + sVar11 + 2;
      pcVar23 = (char *)_cgmalloc(uVar15,"cgminer.c","main",0x2e68);
      ppVar9->rpc_userpass = pcVar23;
      snprintf(ppVar9->rpc_userpass,uVar15,"%s:%s",ppVar9->rpc_user,ppVar9->rpc_pass);
    }
  }
  currentpool = *pools;
  if (use_syslog != false) {
  ...
  for (i = 0; i < mining_threads; i = i + 1) {
    ...
    ptVar13 = (thr_info *)_cgcalloc(1,0x40,"cgminer.c","main",0x2e7d);
    *pptVar12 = ptVar13;
  }
  k = 0;
  for (i = 0; i < total_devices; i = i + 1) {
    pcVar20 = devices[i];
    pptVar12 = (thr_info **)_cgmalloc((pcVar20->threads + 1) * 4,"cgminer.c","main",0x2e86);
    ...
    for (j = 0; j < pcVar20->threads; j = j + 1) {
      ...
      if (_Var2) {
        iVar4 = thr_info_create(ptVar13,(pthread_attr_t *)0x0,(_func_void_ptr_void_ptr *)0x292c5,
                                ptVar13);
        if (iVar4 != 0) {
        ...
        if (pcVar20->deven != DEV_DISABLED) {
          ...
          _cgsem_post(&ptVar13->sem,"cgminer.c","main",0x2ea2);
        }
      }
      k = k + 1;
    }
  ...
  if ((opt_benchmark == false) && (opt_benchfile == (char *)0x0)) {
    for (i = 0; uVar21 = tmp42._24_4_, i < total_pools; i = i + 1) {
      ppVar9 = pools[i];
      enable_pool(ppVar9);
      ppVar9->idle = true;
    }
    ...
    while (pools_active != true) {
      if (!bVar1) {
        if (((use_syslog != false) || (opt_log_output != false)) || (2 < opt_log_level)) {
          builtin_strncpy(tmp42,"No servers were found that could be used to get work fro",0x38);
          tmp42[0x38] = 'm';
          tmp42[0x39] = '.';
          tmp42[0x3a] = '\0';
          _applog(3,tmp42,false);
      ...
      uVar21 = tmp42._32_4_;
      if (use_curses != true) {
        builtin_strncpy(tmp42,"No servers could be used! Exiting.",0x23);
        tmp42[0x23] = SUB41(uVar21,3);
        _applog(3,tmp42,true);
        __quit(0,false);
      }
  ...
  for (i = 0; i < total_devices; i = i + 1) {
    ...
    *(undefined4 *)((int)&pcVar20->total_mhashes + 4) = 0;
    uVar21 = *(undefined4 *)((int)&pcVar20->total_mhashes + 4);
    *(undefined4 *)&pcVar20->rolling = *(undefined4 *)&pcVar20->total_mhashes;
    *(undefined4 *)((int)&pcVar20->rolling + 4) = uVar21;
  }
  ...
  ptVar13 = control_thr;
  watchpool_thr_id = 2;
  iVar4 = thr_info_create(control_thr + 2,(pthread_attr_t *)0x0,(_func_void_ptr_void_ptr *)0x299f9,
                          (void *)0x0);
  uVar21 = tmp42._28_4_;
  if (iVar4 != 0) {
    builtin_strncpy(tmp42,"watchpool thread create failed",0x1f);
    tmp42[0x1f] = SUB41(uVar21,3);
    _applog(3,tmp42,true);
    __quit(1,false);
  }
  ...
  ptVar13 = control_thr;
  watchdog_thr_id = 3;
  iVar4 = thr_info_create(control_thr + 3,(pthread_attr_t *)0x0,(_func_void_ptr_void_ptr *)0x29ce9,
                          (void *)0x0);
  uVar21 = tmp42._28_4_;
  if (iVar4 != 0) {
    builtin_strncpy(tmp42,"watchdog thread create failed",0x1e);
    tmp42._30_2_ = SUB42(uVar21,2);
    _applog(3,tmp42,true);
    __quit(1,false);
  }
  pthread_detach(ptVar13[3].pth);
  api_thr_id = 5;
  iVar4 = thr_info_create(control_thr + 5,(pthread_attr_t *)0x0,(_func_void_ptr_void_ptr *)0x20079,
                          control_thr + 5);
  if (iVar4 != 0) {
