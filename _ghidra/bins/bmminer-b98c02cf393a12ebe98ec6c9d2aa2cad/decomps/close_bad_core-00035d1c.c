...

{
  ...
  if ((((*(int *)(dev + (param_1 + 2) * 4) == 1) &&
    ...
    iVar6 = dev;
    local_8a4._0_3_ = CONCAT12(*(undefined1 *)(dev + 0x542f),0x2000) & 0x1fffff | 0x800000;
        ...
        if ((byte)disabledcore_pos_buf[iVar9 + 2] < 0x54) {
          ...
          do {
            if (((byte)puVar10[2] < 0x54) && ((byte)puVar10[3] < 0x72)) {
              ...
              local_8a8._0_3_ = CONCAT12(bVar5,(undefined2)local_8a8);
              local_8a0 = CRC5(&local_8a8,0x40);
              local_8cc = (undefined1)(param_1 | 0xffffff80);
                  ...
                  if (3 < log_level) {
                    ...
                    if (pFVar2 != (FILE *)0x0) {
                      fprintf(pFVar2,"%s:%d:%s: Disable Chain[%d] Chip[%d] Core[%d]!\n",
                              "driver-btm-c5.c",0x2a15,"close_bad_core",param_1,
                              (uint)(byte)puVar10[2],(uint)(byte)puVar10[3]);
                    }
                    fclose(pFVar2);
                  }
                  local_854[0] = 0;
                    ...
                    if (3 < log_level) {
                      ...
                      if (pFVar2 != (FILE *)0x0) {
                        fprintf(pFVar2,"%s:%d:%s: Error: send open core work Failed on Chain[%d]!\n"
                                ,"driver-btm-c5.c",0x2a30,"close_bad_core",param_1);
                      }
                      fclose(pFVar2);
                    }
                    goto LAB_000360ba;
