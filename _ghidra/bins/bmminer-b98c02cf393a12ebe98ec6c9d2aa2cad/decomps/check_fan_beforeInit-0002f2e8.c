...
LAB_0002f360:
      ...
      *(uint *)(iVar7 + 0x538c) = uVar5;
      if (local_2c[0] == 0) {
        if (*(char *)(iVar1 + 0x5384) == '\x01') {
          *(undefined1 *)(iVar1 + 0x5384) = 0;
          ...
          *(uint *)(iVar4 + 0x4c) = uVar5;
          uVar5 = *(uint *)(iVar7 + 0x538c);
        }
      }
      else {
        if (*(char *)(iVar1 + 0x5384) == '\0') {
          *(undefined1 *)(iVar1 + 0x5384) = 1;
        ...
        if ((print_num_13028 < 100) && (print_num_13028 = print_num_13028 + 1, 3 < log_level)) {
          ...
          if (pFVar2 != (FILE *)0x0) {
            fprintf(pFVar2,"%s:%d:%s: get fan[%d] speed=%d\n","driver-btm-c5.c",0xbbe,
                    "check_fan_beforeInit",(uint)local_2d,
                    *(undefined4 *)(dev + (local_2d + 0x14e2) * 4 + 4));
          }
          fclose(pFVar2);
          if ((print_num_13028 < 100) || (log_level < 4)) {
            ...
            if (pFVar2 != (FILE *)0x0) {
              fprintf(pFVar2,"%s:%d:%s: Fatal Error: some Fan lost or Fan speed low!\n",
                      "driver-btm-c5.c",0xbc2,"check_fan_beforeInit");
            }
            fclose(pFVar2);
            uVar3 = (uint)local_2d;
            uVar5 = *(uint *)(dev + (uVar3 + 0x14e2) * 4 + 4);
...
LAB_0002f338:
      ...
      if ((uVar5 != 0 && uVar5 < *(uint *)(iVar4 + 0x5404)) || (*(uint *)(iVar4 + 0x5404) == 0)) {
