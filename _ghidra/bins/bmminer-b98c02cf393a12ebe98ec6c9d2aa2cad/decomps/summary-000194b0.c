...

{
  ...
  local_74 = 0;
  message(param_1,0xb,0,0,param_4);
  pcVar5 = ",\"SUMMARY\":[";
  if (param_4 == 0) {
    pcVar5 = "SUMMARY,";
  }
  ...
  if (is_certification == '\0') {
    ...
    a = extraout_d0;
    if (iVar3 != 0) {
      uVar4 = _mutex_lock_part_3_constprop_27("summary",0xb32);
      a = (DFtype)CONCAT44(extraout_s1,uVar4);
    }
    DVar10 = __fixdfdi(a);
    total_diff1 = DVar10;
    local_70 = (double)__aeabi_l2d((undefined4)total_accepted,total_accepted._4_4_);
    dVar8 = total_secs;
    local_80 = (undefined4)DVar10;
    uStack_7c = (undefined4)((ulonglong)DVar10 >> 0x20);
    if (total_secs == 0.0) {
      local_70 = local_70 * 60.0;
      local_68 = ((total_mhashes_done - new_total_mhashes_done) / 1000.0) /
                 (total_secs - new_total_secs);
      dVar7 = (double)__aeabi_l2d(local_80,uStack_7c);
      dVar9 = 1.0;
    }
    else {
      local_70 = (local_70 / total_secs) * 60.0;
      local_68 = ((total_mhashes_done - new_total_mhashes_done) / 1000.0) /
                 (total_secs - new_total_secs);
      dVar7 = (double)__aeabi_l2d(local_80,uStack_7c);
      dVar9 = dVar8;
    }
    local_58 = (double)(longlong)mined_time_record + dVar8;
    local_60 = (dVar7 / dVar9) * 60.0;
    ...
    iVar3 = total_diff1._4_4_ + ((int)hw_errors >> 0x1f) + (uint)CARRY4((uint)total_diff1,hw_errors)
    ;
    local_74 = uVar4;
    if ((uint)total_diff1 + hw_errors == 0 && iVar3 == 0) {
      dVar8 = 0.0;
    }
    else {
      lVar1 = (longlong)(int)hw_errors;
      dVar8 = (double)__aeabi_l2d((uint)total_diff1 + hw_errors,iVar3);
    ...
    if (iVar3 != 0) {
      _mutex_unlock_noyield_part_5_constprop_32("summary",0xb65);
    }
    (*selective_yield)();
  }
  else {
