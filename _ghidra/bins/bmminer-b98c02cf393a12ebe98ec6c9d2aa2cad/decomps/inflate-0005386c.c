...
LAB_000538dc:
  ...
  case 0:
    ...
    for (; puVar28 < (uint *)0x10; puVar28 = puVar28 + 2) {
      if (puVar27 == (uint *)0x0) goto LAB_0005402a;
...
LAB_00053ca2:
  ...
  case 2:
    pbVar17 = __src;
    if (puVar28 < (uint *)0x20) goto LAB_00053ca2;
LAB_00053cca:
    if (puVar29[8] != 0) {
...
LAB_00053cea:
  ...
  case 3:
    pbVar17 = __src;
    if (puVar28 < (uint *)0x10) goto LAB_00053cea;
LAB_00053d12:
    uVar10 = puVar29[8];
    if (uVar10 != 0) {
...
LAB_00053d9c:
    if (uVar19 != 0) {
      ...
      if (puVar14 != (uint *)0x0) goto LAB_0005402a;
      uVar10 = puVar29[4];
    }
    puVar29[0x10] = 0;
    *puVar29 = 6;
...
LAB_00053e86:
  ...
  case 4:
    uVar10 = puVar29[4];
    if ((int)(uVar10 << 0x15) < 0) goto joined_r0x000546a8;
    goto LAB_00054732;
  case 5:
    uVar10 = puVar29[4];
    uVar19 = uVar10 & 0x400;
...
switchD_000538e2_caseD_b:
    if ((char *)((int)param_2 + -5) < (char *)0x2) goto LAB_0005402a;
...
LAB_00054266:
  ...
  case 0x11:
    uVar10 = puVar29[0x17];
    uVar19 = puVar29[0x1a];
    if (uVar19 < uVar10) goto LAB_00054266;
LAB_000542ae:
    if (uVar19 < 0x13) {
      puVar6 = (ushort *)(order_6170 + (uVar19 - 1) * 2);
      do {
...
LAB_000543f2:
          ...
          if ((uint *)(uVar10 + (int)local_50) < puVar12) goto LAB_00054f98;
          uVar21 = uVar19 - 1;
...
LAB_000544ce:
            ...
            if (uVar19 - uVar24 != uVar20 * 2) goto LAB_000544ce;
          }
...
LAB_000548e0:
                      ...
                      if ((uint *)(uVar10 * 4) != puVar16) goto LAB_000548e0;
                    }
