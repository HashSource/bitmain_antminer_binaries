...
undefined4 dsPIC33EP16GS202_pic_get_an_voltage2(undefined4 param_1)

{
  ...
  do {
    ...
    uVar1 = T9_plus_write_pic_iic(1,0,0,param_1,0);
    local_2c._0_2_ = CONCAT11(uVar1,(undefined1)local_2c);
    uVar1 = T9_plus_write_pic_iic(1,0,0,param_1,0);
      ...
      if (5 < log_level) {
        ...
        if (pFVar2 != (FILE *)0x0) {
          fprintf(pFVar2,"%s:%d:%s: Receive AN voltage response from IIC[%d]\n","power.c",0x220,
                  "dsPIC33EP16GS202_pic_get_an_voltage2",param_1);
        }
        fclose(pFVar2);
      }
