...
uint hashlittle(ushort *param_1,uint param_2,int param_3)
  ...
  if (((uint)param_1 & 3) == 0) {
    ...
    if (0xc < param_2) {
      ...
      do {
        param_1 = puVar1;
        param_2 = param_2 - 0xc;
        uVar5 = uVar5 + *(int *)(param_1 + -2);
        uVar4 = (*(int *)(param_1 + -6) - uVar5) + uVar7 ^ (uVar5 >> 0x1c | uVar5 * 0x10);
        iVar2 = uVar5 + *(int *)(param_1 + -4) + uVar6;
        iVar8 = uVar4 + iVar2;
        uVar4 = (*(int *)(param_1 + -4) + uVar6) - uVar4 ^ (uVar4 >> 0x1a | uVar4 << 6);
        iVar3 = uVar4 + iVar8;
    ...
    switch(param_2) {
    case 3:
      uVar7 = uVar7 + (uint)(byte)param_1[1] * 0x10000;
    case 2:
    ...
    case 1:
      ...
      break;
    case 7:
      uVar6 = uVar6 + (uint)(byte)param_1[3] * 0x10000;
    case 6:
      uVar6 = uVar6 + (uint)*(byte *)((int)param_1 + 5) * 0x100;
    case 5:
      uVar6 = uVar6 + (byte)param_1[2];
    case 4:
      uVar7 = *(int *)param_1 + uVar7;
      break;
    case 0xb:
      uVar4 = uVar4 + (uint)(byte)param_1[5] * 0x10000;
    case 10:
      uVar4 = uVar4 + (uint)*(byte *)((int)param_1 + 9) * 0x100;
    case 9:
      uVar4 = uVar4 + (byte)param_1[4];
    case 8:
      uVar6 = uVar6 + *(int *)(param_1 + 2);
      uVar7 = *(int *)param_1 + uVar7;
      break;
    case 0xc:
      uVar4 = uVar4 + *(int *)(param_1 + 4);
      uVar6 = uVar6 + *(int *)(param_1 + 2);
      uVar7 = *(int *)param_1 + uVar7;
      break;
    default:
      goto switchD_0004f4b4_default;
    }
  }
    ...
    if (0xc < param_2) {
      ...
      do {
        param_1 = puVar1;
        param_2 = param_2 - 0xc;
        uVar5 = uVar5 + (uint)(byte)param_1[-2] +
                        (uint)(byte)param_1[-1] * 0x10000 +
                        (uint)*(byte *)((int)param_1 + -3) * 0x100 +
                        (uint)*(byte *)((int)param_1 + -1) * 0x1000000;
        uVar7 = (((uint)(byte)param_1[-6] +
                  (uint)(byte)param_1[-5] * 0x10000 + (uint)*(byte *)((int)param_1 + -0xb) * 0x100 +
                 (uint)*(byte *)((int)param_1 + -9) * 0x1000000) - uVar5) + uVar7 ^
                (uVar5 >> 0x1c | uVar5 * 0x10);
        iVar3 = uVar6 + (uint)(byte)param_1[-4] +
                        (uint)(byte)param_1[-3] * 0x10000 +
    ...
    if (0xc < param_2) {
      ...
      do {
        param_1 = puVar1;
        param_2 = param_2 - 0xc;
        uVar4 = uVar4 + (uint)param_1[-2] + (uint)param_1[-1] * 0x10000;
        uVar5 = uVar5 + (((uint)param_1[-6] + (uint)param_1[-5] * 0x10000) - uVar4) ^
                (uVar4 >> 0x1c | uVar4 * 0x10);
        iVar2 = (uint)param_1[-4] + (uint)param_1[-3] * 0x10000 + uVar6;
        iVar3 = uVar4 + iVar2;
        iVar8 = uVar5 + iVar3;
    ...
    case 1:
      ...
      break;
    case 3:
      uVar5 = uVar5 + (uint)(byte)param_1[1] * 0x10000;
    case 2:
      uVar7 = *param_1 + uVar5;
      break;
    case 5:
      uVar6 = uVar6 + (byte)param_1[2];
    case 4:
      uVar7 = *param_1 + uVar5 + (uint)param_1[1] * 0x10000;
      break;
    case 7:
      uVar6 = uVar6 + (uint)(byte)param_1[3] * 0x10000;
    case 6:
    ...
    case 9:
      uVar4 = uVar4 + (byte)param_1[4];
    case 8:
      uVar6 = param_1[2] + uVar6 + (uint)param_1[3] * 0x10000;
      uVar7 = *param_1 + uVar5 + (uint)param_1[1] * 0x10000;
      break;
    case 0xb:
      uVar4 = uVar4 + (uint)(byte)param_1[5] * 0x10000;
    case 10:
      uVar6 = param_1[2] + uVar6 + (uint)param_1[3] * 0x10000;
      uVar7 = *param_1 + uVar5 + (uint)param_1[1] * 0x10000;
      uVar4 = uVar4 + param_1[4];
      break;
    case 0xc:
      uVar4 = uVar4 + param_1[4] + (uint)param_1[5] * 0x10000;
      uVar6 = param_1[2] + uVar6 + (uint)param_1[3] * 0x10000;
      uVar7 = *param_1 + uVar5 + (uint)param_1[1] * 0x10000;
      break;
    default:
switchD_0004f4b4_default:
      return uVar4;
    }
  }
