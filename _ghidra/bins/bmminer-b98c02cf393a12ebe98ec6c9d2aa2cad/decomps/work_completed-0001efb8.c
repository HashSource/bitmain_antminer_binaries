...

{
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      (*selective_yield)();
      _free_work(local_14,"cgminer.c","work_completed",0x251d);
      return;
    }
  }
  else {
    _wr_lock_part_54_constprop_73("work_completed",0x2519);
  }
                    /* WARNING: Subroutine does not return */
  _rw_unlock_part_40_constprop_79("work_completed",0x251b);
}
