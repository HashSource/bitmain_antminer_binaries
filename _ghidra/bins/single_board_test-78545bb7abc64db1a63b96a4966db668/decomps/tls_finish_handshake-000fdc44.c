...
LAB_000fdc84:
    ...
    if (((-1 < *(int *)((*(int **)(param_1 + 4))[0x19] + 0x30) << 0x1c) &&
       ...
       (*(int *)(*(int *)(param_1 + 0x7c) + 0x204) != 0)) goto LAB_000fdca8;
  }
  else {
...
LAB_000fdce6:
    ...
    *(undefined4 *)(param_1 + 0x55c) = 0;
    ...
    if (*(int *)(param_1 + 0x1c) == 0) {
      ...
      *(undefined4 *)(param_1 + 0x18) = 0xf7841;
      do {
        ExclusiveAccess(piVar3);
        bVar6 = (bool)hasExclusiveAccess(piVar3);
      } while (!bVar6);
      ...
      *piVar3 = *piVar3 + 1;
      *(undefined4 *)(param_1 + 0x18) = 0xf7849;
    }
