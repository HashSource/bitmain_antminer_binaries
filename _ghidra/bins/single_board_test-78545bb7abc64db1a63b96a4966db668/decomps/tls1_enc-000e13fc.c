...
LAB_000e142e:
      ...
      if (ctx == (EVP_CIPHER_CTX *)0x0) goto LAB_000e144c;
      local_2f0 = EVP_CIPHER_CTX_cipher(ctx);
      goto LAB_000e1440;
    }
    pEVar4 = EVP_MD_CTX_md((EVP_MD_CTX *)param_1[0xf8]);
    iVar5 = EVP_MD_size(pEVar4);
    if (-1 < iVar5) goto LAB_000e142e;
    uVar16 = 0x3e6;
  }
  else {
    ...
    if (((*(int *)(*(int *)(param_1[1] + 100) + 0x30) << 0x1f < 0) &&
      ...
      if (buf == *(uchar **)(param_2 + 0x14)) {
        ...
        do {
          ...
          if (param_3 == uVar18) goto LAB_000e1440;
    ...
    do {
      *puVar21 = *(uint *)(iVar15 + 8);
      ...
      if ((int)(uVar7 << 10) < 0) {
        ...
        if (param_4 == 0) {
          if (-1 < iVar14 << 0x1c) goto LAB_000e16ba;
...
LAB_000e16ba:
        ...
        *(char *)((int)puVar19 + 9) = (char)((uint)uVar17 >> 8);
        ...
        if (param_4 == 0) goto LAB_000e1694;
        iVar14 = *(int *)(iVar15 + 8);
...
LAB_000e17fa:
    ...
    if (-1 < local_304) goto LAB_000e17fa;
    uVar16 = 0x483;
  }
LAB_000e188c:
  uVar17 = 0x44;
