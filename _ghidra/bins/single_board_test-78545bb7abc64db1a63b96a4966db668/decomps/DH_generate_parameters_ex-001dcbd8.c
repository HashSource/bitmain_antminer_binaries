...

{
  ...
  if (UNRECOVERED_JUMPTABLE != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x001dcbec. Too many branches */
  ...
  if (ctx != (BN_CTX *)0x0) {
    ...
    if (a_00 != (BIGNUM *)0x0) {
      if (dh->p == (BIGNUM *)0x0) {
        pBVar2 = BN_new();
        dh->p = pBVar2;
        if (pBVar2 == (BIGNUM *)0x0) goto LAB_001dcc36;
      }
      if (dh->g == (BIGNUM *)0x0) {
        pBVar2 = BN_new();
        dh->g = pBVar2;
...
joined_r0x001dcc68:
          if (iVar1 == 0) goto LAB_001dcc36;
          iVar1 = BN_set_word(a_00,0xb);
        }
        else {
          if (generator != 5) {
            iVar1 = BN_set_word(a,0xc);
            goto joined_r0x001dcc68;
          }
