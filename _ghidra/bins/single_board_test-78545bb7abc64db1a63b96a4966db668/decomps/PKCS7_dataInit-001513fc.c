...
LAB_00151640:
        ...
        if (pPVar10 == (PKCS7_SIGNED *)0x0) {
          ...
          if (pPVar10->version != (ASN1_INTEGER *)0x4) goto LAB_00151640;
          pEVar12 = (EVP_CIPHER *)0x0;
...
LAB_001516aa:
        ...
        if (pPVar10 == (PKCS7_SIGNED *)0x0) {
          ...
          if (pPVar10->version != (ASN1_INTEGER *)0x4) goto LAB_001516aa;
          pEVar12 = (EVP_CIPHER *)0x0;
          pAVar15 = (ASN1_OCTET_STRING *)pPVar10->md_algs;
          pEVar14 = (EVP_CIPHER *)0x0;
          pEVar13 = (EVP_CIPHER *)0x0;
  ...
  do {
    ...
    if (iVar4 <= iVar2) {
      if ((local_a4 == (BIO *)0x0) ||
        ...
        pBVar1 = local_84;
        if (cipher == (EVP_CIPHER *)0x0) goto LAB_00151704;
        pBVar5 = BIO_f_cipher();
...
LAB_001515b8:
  ...
  if (iVar4 <= iVar2) goto LAB_001516ea;
  p2 = (void *)OPENSSL_sk_value(pEVar14,iVar2);
  pkey = (EVP_PKEY *)X509_get0_pubkey(*(undefined4 *)((int)p2 + 0x10));
  if ((pkey == (EVP_PKEY *)0x0) ||
     (ctx = EVP_PKEY_CTX_new(pkey,(ENGINE *)0x0), ctx == (EVP_PKEY_CTX *)0x0)) goto LAB_0015160c;
...
LAB_00151704:
  local_84 = pBVar1;
  local_a0 = bio;
  if (bio != (BIO *)0x0) goto LAB_0015170a;
  iVar2 = OBJ_obj2nid(p7->type);
