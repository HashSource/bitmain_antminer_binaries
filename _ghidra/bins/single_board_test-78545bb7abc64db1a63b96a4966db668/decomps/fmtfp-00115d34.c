...
LAB_00115d68:
    local_88 = 1;
    if (param_8 != 2) goto LAB_00115d6e;
LAB_00115ffc:
    if (in_d0 != 0.0) {
...
LAB_00116176:
    ...
    if (param_8 == 2) goto LAB_00115ffc;
LAB_00115d6e:
    if (param_8 != 0) {
      local_94 = param_8;
      if (in_d0 == 0.0) {
...
LAB_00116122:
        ...
        if (param_8 == 2) goto LAB_00116010;
      }
      goto LAB_00116176;
    }
    local_94 = param_8;
  ...
  if (param_6 != 0) {
    ...
    do {
      ...
      if ((iVar14 == 0 && param_8 == 2) && (uVar20 % 10 == 0)) {
        param_6 = param_6 + -1;
        iVar13 = 0;
        if (param_6 == 0) goto code_r0x00115f24;
      }
      else {
        acStack_50[iVar14] = "0123456789"[uVar20 % 10];
        if (param_6 <= iVar13) goto LAB_00115f2a;
      }
      uVar20 = uVar20 / 10;
      iVar14 = iVar13;
    } while( true );
...
LAB_00115f5c:
    ...
    if (-1 < (int)(param_7 << 0x1b)) {
      if (0 < (int)local_88) {
        ...
        if (uVar20 != 0) goto LAB_00116232;
LAB_001161ea:
        if (uVar19 <= uVar4) goto LAB_001161fe;
        iVar11 = *param_1;
        if (iVar11 == 0) goto LAB_0011629a;
        do {
          *param_3 = uVar4 + 1;
...
LAB_0011629a:
    ...
    if (local_88 == 0) goto LAB_00115f5c;
    piVar5 = param_2;
    if (local_84 != 0) {
      if (param_2 != (int *)0x0) {
        piVar5 = (int *)0x1;
      ...
      iVar11 = doapr_outch_part_0(param_1,param_2,param_3,param_4,local_84);
      if (iVar11 != 0) goto joined_r0x0011634e;
      return 0;
    }
    if (param_2 != (int *)0x0) {
      piVar5 = (int *)0x1;
