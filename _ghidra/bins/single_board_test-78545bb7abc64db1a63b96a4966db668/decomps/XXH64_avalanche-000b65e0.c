...

{
  ...
  uVar2 = uVar3 * -0x3d4d51c3 + h64_local._4_4_ * 0x27d4eb4f + (int)((ulonglong)lVar1 >> 0x20);
  uVar3 = (uint)lVar1;
  uVar3 = uVar3 ^ (uVar3 >> 0x1d | uVar2 * 8);
  lVar1 = (ulonglong)uVar3 * 0x9e3779f9;
  uVar3 = uVar3 * 0x165667b1 + (uVar2 ^ uVar2 >> 0x1d) * -0x61c88607 +
