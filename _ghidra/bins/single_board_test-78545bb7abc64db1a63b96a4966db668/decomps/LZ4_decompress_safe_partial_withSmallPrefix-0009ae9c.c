...
/* WARNING: Removing unreachable block (ram,0x0009b38a) */
/* WARNING: Removing unreachable block (ram,0x0009b394) */
/* WARNING: Removing unreachable block (ram,0x0009b396) */
/* WARNING: Removing unreachable block (ram,0x0009b398) */
/* WARNING: Removing unreachable block (ram,0x0009b39e) */
/* WARNING: Removing unreachable block (ram,0x0009af6e) */
/* WARNING: Removing unreachable block (ram,0x0009af76) */
/* WARNING: Removing unreachable block (ram,0x0009af86) */
/* WARNING: Removing unreachable block (ram,0x0009af7e) */
...
LAB_0009b0c6:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_0009b822;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_0009b822;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_0009b0c6;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_0009b822;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_0009b822;
              op = pBVar10;
