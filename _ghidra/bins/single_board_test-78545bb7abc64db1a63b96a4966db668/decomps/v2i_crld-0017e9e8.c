...
LAB_0017ec24:
    ...
    OPENSSL_sk_pop_free(iVar2,(undefined *)0x17e4ad);
    return 0;
  }
  if (0 < iVar1) {
    local_48 = 0;
          ...
          if (iVar5 == 0) {
            ...
            if (psVar6 == (stack_st_CONF_VALUE *)0x0) {
              ...
              if (*pcVar11 == '@') {
                ...
                OPENSSL_sk_pop_free(psVar6,0x1830d1);
              }
              pGVar9 = pGVar7;
...
LAB_0017ebfa:
            OPENSSL_sk_pop_free(pGVar9,(undefined *)0x17f325);
            OPENSSL_sk_pop_free(pGVar12,0x177061);
            goto LAB_0017ec12;
          }
                ...
                if (iVar4 == 0) {
                  ...
                  if (0 < iVar4) {
                    ...
                    if (*(int *)(iVar4 + 8) == 0) {
                      ...
                      pGVar9 = (GENERAL_NAMES *)0x0;
                      if (pDVar13 != (DIST_POINT_NAME *)0x0) goto LAB_0017ebe4;
                      goto LAB_0017eb5a;
                    }
...
joined_r0x0017ec7a:
            if (pGVar7 == (GENERAL_NAMES *)0x0) goto LAB_0017ec12;
          }
          else {
