...
LAB_001bf77c:
      ...
      if (((int)(uVar2 << 0x18) < 0) || (bVar1 = puVar9[uVar2], bVar1 == 0xff)) {
        ...
        while( true ) {
          if (uVar2 == 0x3d) {
            iVar6 = iVar6 + 1;
            if (iVar6 == 3) goto LAB_001bf6bc;
          }
          else if ((iVar6 != 0) && ((bVar1 | 0x13) != 0xf3)) goto LAB_001bf6bc;
          if (bVar1 == 0xf2) break;
          if ((bVar1 | 0x13) != 0xf3) {
            if (0x3f < (int)uVar4) goto LAB_001bf6bc;
            puVar7[uVar4] = (uchar)uVar2;
            uVar4 = uVar4 + 1;
          }
          if (uVar4 == 0x40) {
            iVar3 = evp_decodeblock_int(ctx,out,puVar7,0x40);
            if (iVar3 < iVar6 || iVar3 < 0) goto LAB_001bf77c;
            iVar8 = iVar8 + (iVar3 - iVar6);
            out = out + (iVar3 - iVar6);
            uVar4 = 0;
          }
          if (pbVar5 == in + inl) goto LAB_001bf742;
          uVar2 = (uint)*pbVar5;
          if (((int)(uVar2 << 0x18) < 0) ||
             (bVar1 = puVar9[uVar2], pbVar5 = pbVar5 + 1, bVar1 == 0xff)) goto LAB_001bf6bc;
        }
        if ((int)uVar4 < 1) {
          inl = 0;
          goto LAB_001bf6c0;
