...
undefined4 sm4_cfb128_cipher(undefined4 param_1,int param_2,int param_3,uint param_4)

{
  ...
  if (param_4 != 0) {
    do {
      ...
      iVar6 = param_2 + uVar5;
      CRYPTO_cfb128_encrypt(param_3,param_2,uVar5,uVar1,uVar2,local_2c,uVar3,0x1caca5);
