...

{
  ...
  if (algor2 == (X509_ALGOR *)0x0) {
    if (algor1 == (X509_ALGOR *)0x0) goto LAB_00189cce;
    ...
    if (type->pkey_type == 0x71) {
      ...
      md = pAVar2;
      cnt = pAVar2;
      if (pAVar2 == (ASN1_TYPE *)0x0) goto LAB_00189d5e;
      pAVar2->type = 5;
    }
...
LAB_00189ea4:
      ...
      if (pAVar1->length != 0) goto LAB_00189cce;
LAB_00189e7c:
      line = 0x45;
      iVar3 = 0x9a;
    }
    ...
    if (algor1 == (X509_ALGOR *)0x0) {
      do {
        ...
        if (pAVar1 == (ASN1_OBJECT *)0x0) goto LAB_00189ea4;
        if (pAVar1->length == 0) goto LAB_00189e7c;
      } while (iVar3 != 2);
    }
    else {
      iVar3 = 0;
