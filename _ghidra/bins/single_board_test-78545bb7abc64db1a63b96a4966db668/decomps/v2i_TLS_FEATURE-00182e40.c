...
LAB_00182e78:
        ...
        a = ASN1_INTEGER_new();
        if (a != (ASN1_INTEGER *)0x0) goto LAB_00182eb6;
LAB_00182f02:
        ERR_put_error(0x22,0xa5,0x41,"crypto/x509v3/v3_tlsf.c",0x80);
LAB_00182f14:
        OPENSSL_sk_pop_free(iVar1,0x113aad);
        return 0;
      }
      __s1 = (char *)puVar3[1];
      iVar2 = strcasecmp(__s1,"status_request");
      if (iVar2 != 0) goto LAB_00182e78;
LAB_00182ef4:
      a = ASN1_INTEGER_new();
      v = 5;
      if (a == (ASN1_INTEGER *)0x0) goto LAB_00182f02;
LAB_00182eb6:
      iVar2 = ASN1_INTEGER_set(a,v);
      if ((iVar2 == 0) || (iVar2 = OPENSSL_sk_push(iVar1,a), iVar2 < 1)) goto LAB_00182f02;
    }
  }
  return iVar1;
}
