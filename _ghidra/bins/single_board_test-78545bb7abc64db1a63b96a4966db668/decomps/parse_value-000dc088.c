    ...
    if (iVar5 == 0x5b) {
      ...
      if (iVar5 != 0x5d) {
        while (iVar5 != 0) {
          ...
          lex_scan(lex,error);
          if (lex->token != 0x2c) {
            if (lex->token == 0x5d) goto LAB_000dc11c;
            break;
          }
          lex_scan(lex,error);
          iVar5 = lex->token;
        ...
        if (lex->token != 0x7d) {
          if (lex->token == 0x100) {
            ...
            while( true ) {
              ...
              lex_scan(lex,error);
              if (lex->token != 0x100) goto LAB_000dc2f6;
              pcVar8 = (lex->value).string.val;
              __n = (lex->value).string.len;
              (lex->value).string.val = (char *)0x0;
              (lex->value).string.len = 0;
            ...
            if (lex->token == 0x7d) goto LAB_000dc11c;
            error_set(error,lex,json_error_invalid_syntax,"\'}\' expected");
          }
          else {
LAB_000dc2f6:
...
LAB_000dc302:
        ...
        if (iVar5 != 0x100) goto LAB_000dc0ca;
        pcVar8 = (lex->value).string.val;
    ...
    if (iVar5 != 0x105) goto LAB_000dc0ca;
    json = json_null();
  }
LAB_000dc11c:
  if (json != (json_t *)0x0) {
