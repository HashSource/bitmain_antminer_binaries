...
LAB_00196b50:
                  ...
                  if (iVar6 == 0) goto LAB_00196b74;
                  iVar6 = BN_is_one(a_00);
                  if (iVar6 != 0) goto LAB_00196b50;
                  iVar6 = BN_cmp(a_00,pBVar3);
                }
              }
              iVar2 = BN_GENCB_call(cb,1,local_30);
              if (iVar2 == 0) goto LAB_00196b74;
              local_30 = local_30 + 1;
...
LAB_001969c0:
    ...
    do {
      ...
      if (uVar5 == 0xffffffff) goto LAB_00196a3e;
      if (uVar5 == 0) {
        iVar2 = BN_is_word(p,(uint)uVar1);
        return iVar2;
      }
    } while (puVar7 != (ushort *)&UNK_00231e4e);
    iVar2 = BN_GENCB_call(cb,1,-1);
    if (iVar2 != 0) goto LAB_00196974;
  }
LAB_00196a3e:
  iVar2 = -1;
  mont = (BN_MONT_CTX *)0x0;
