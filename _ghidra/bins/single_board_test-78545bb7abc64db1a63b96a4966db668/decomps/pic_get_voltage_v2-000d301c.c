...
LAB_000d3104:
        ...
        if (iVar3 == 8) {
          ...
          if (((read_back_data._0_4_ & 0xff) == 8) && (uVar5 == 0x41)) {
            uVar5 = ((uint)read_back_data._4_4_ >> 8 & 0xff) +
                    (uint)(ushort)((ushort)read_back_data[2] + (ushort)read_back_data[3] + 0x49 +
                                  (ushort)read_back_data[4]);
      ...
      if (ana_channel != 6) {
        if (ana_channel != 2) goto LAB_000d30d8;
        uVar8 = g_bitmain_pic_state[uVar4].pic_fd;
        send_data[0] = 'U';
        send_data[1] = 0xaa;
        send_data[2] = '\x05';
  ...
  if (iVar3 == 7) {
    ...
    if (((read_back_data._0_4_ & 0xff) == 0xc) && (uVar4 == 0x41)) {
      ...
      while( true ) {
        uVar4 = uVar5 + uVar4;
        uVar5 = uVar4 & 0xffff;
        if (data == (byte *)((int)&local_82c + 1)) break;
        data = data + 1;
        uVar4 = (uint)*data;
      }
