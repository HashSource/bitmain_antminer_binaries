...

{
  ...
  ui_flicker_map = new_c_map((clib_compare)0xceb51,(clib_destroy)0x0,(clib_destroy)0x0);
  pthread_attr_init((pthread_attr_t *)&tattr_ctrl);
  pthread_attr_setstacksize((pthread_attr_t *)&tattr_ctrl,0x200000);
  iVar1 = pthread_create(&ui_thread,(pthread_attr_t *)&tattr_ctrl,(__start_routine *)0xceb81,
                         (void *)0x0);
  ui_pull_thread = 1;
  return iVar1;
}
