...

{
  ...
  case 3:
    ...
    OPENSSL_sk_pop_free(data[1].idp,(undefined *)0x17f37d);
    return 1;
  case 4:
  ...
  if (pXVar2 == (X509_ALGOR *)0x0) {
    if (local_30 != -1) goto LAB_001769e6;
  }
  else {
    ...
    if ((int)pAVar12 < 1) {
      unaff_r6 = iVar1;
      if (0 < (int)pAVar11) goto LAB_0017698c;
    }
    else {
...
LAB_001769e6:
  ...
  if (pAVar5 == (AUTHORITY_KEYID *)0x0) {
    if (local_30 == -1) goto LAB_00176a32;
  }
  else if (data[1].flags != 0) goto LAB_00176a32;
  data->meth_data = (void *)((uint)data->meth_data | 0x80);
LAB_00176a32:
  ...
  do {
    while( true ) {
      ...
      iVar18 = iVar1 + 1;
      if (iVar6 <= iVar1) goto LAB_00176a92;
      ...
      if ((iVar18 != 0) && (iVar6 != 0x8c && (iVar6 != 0x5a && iVar6 != 0x302))) goto LAB_00176a8a;
    }
...
LAB_00176bec:
    ...
    if (a == (ASN1_INTEGER *)0x0) {
      if (local_2c[0] == -1) goto LAB_00176ae0;
LAB_00176be4:
      data->meth_data = (void *)((uint)data->meth_data | 0x80);
      goto LAB_00176bec;
    }
    ...
    if (pIVar9 == (ISSUING_DIST_POINT *)0x0) {
      ...
      data[1].idp = pIVar9;
      if (pIVar9 == (ISSUING_DIST_POINT *)0x0) goto LAB_00176bc2;
    }
...
LAB_00176ae0:
    ...
    if (a_00 == (ASN1_ENUMERATED *)0x0) {
      if (local_2c[0] != -1) goto LAB_00176be4;
