...
LAB_001dbb78:
            ...
            if (0 < iVar10) {
              ...
              if (-1 < (int)(uVar13 << 0x18)) goto LAB_001dbb9e;
            }
...
LAB_001dbbdc:
            do {
              ...
              if ((uVar1 & 0x800) != 0) goto LAB_001dbdb0;
...
LAB_001dbc2c:
            ...
            if ((int)(uVar13 << 0x18) < 0) goto LAB_001dbdb0;
            if ((int)(uVar13 << 0x15) < 0) goto LAB_001dbc72;
            if ((int)(uVar13 << 0x19) < 0) {
              do {
                do {
                  ...
                  uVar1 = *(ushort *)((int)pvVar17 + uVar13 * 2);
                  if ((uVar1 & 8) != 0) {
                    if (uVar12 == uVar13) goto LAB_001dbc2c;
                    goto joined_r0x001dbbea;
                  }
                  if (uVar12 == uVar13) goto LAB_001dbc2c;
            ...
            if (-1 < (int)(uVar13 << 0x1c)) goto LAB_001dbc2c;
            goto LAB_001dbcce;
          }
          iVar10 = iVar20 + sVar4;
          if (0 < iVar10) goto LAB_001dbdcc;
          goto LAB_001dbc62;
        }
...
LAB_001dbdcc:
          ...
          uVar13 = (uint)*(byte *)((int)pCVar2 + iVar20);
          pcVar16 = (char *)((int)pCVar2 + iVar20);
          if ((int)(uVar13 << 0x18) < 0) goto LAB_001dbc62;
          bVar22 = true;
LAB_001dbb9e:
          pvVar17 = param_1->meth_data;
...
LAB_001dbcce:
  ...
  if (-1 < (int)(uVar13 << 0x18)) {
    ...
    if ((int)(uVar12 << 0x1b) < 0) {
      do {
        if ((int)(uVar12 << 0x1c) < 0) goto LAB_001dbdbe;
        pCVar2 = (CONF_VALUE *)((int)&pCVar2->section + 1);
        uVar13 = (uint)*(byte *)&pCVar2->section;
        if ((int)(uVar13 << 0x18) < 0) goto LAB_001dbcf8;
        uVar1 = *(ushort *)((int)pvVar17 + uVar13 * 2);
        uVar12 = (uint)uVar1;
      } while ((uVar1 & 0x10) != 0);
    }
    if ((uVar12 & 8) == 0) {
      if (uVar13 != 0x5b) goto LAB_001dbcf8;
...
LAB_001dc1d0:
      ...
      while (((uVar1 & 0x10) != 0 && (-1 < (int)((uint)uVar1 << 0x1c)))) {
        ...
        bVar14 = *pbVar19;
        uVar13 = (uint)bVar14;
        if ((char)bVar14 < '\0') goto LAB_001dc1d0;
        uVar1 = *(ushort *)((int)pvVar17 + uVar13 * 2);
      }
      if (uVar13 != 0x5d) goto LAB_001dc1d0;
      *pbVar18 = 0;
...
LAB_001dbd04:
  if (-1 < (char)bVar14) {
    while (uVar1 = *(ushort *)((int)pvVar17 + uVar13 * 2), (int)((uint)uVar1 << 0x1a) < 0) {
      ...
      if ((char)bVar14 < '\0') goto LAB_001dbd36;
    }
    if ((uVar1 & 0x307) == 0) {
...
joined_r0x001dbd48:
    do {
      ...
      if ((int)(uVar13 << 0x18) < 0) goto LAB_001dbd64;
      uVar12 = (uint)*(ushort *)((int)pvVar17 + uVar13 * 2);
    } while( true );
  }
  iVar10 = strncmp((char *)pCVar21,".include",8);
  if (iVar10 != 0) {
    if (uVar13 != 0x3d) goto LAB_001dbd8e;
...
LAB_001dbc72:
  while( true ) {
    ...
    if (uVar12 == uVar13) {
      ...
      if (uVar12 != uVar13) goto LAB_001dbc2e;
...
LAB_001dc2ca:
  ...
  if (-1 < (char)bVar14) {
    ...
    if ((int)(uVar12 << 0x1a) < 0) {
      ...
      pCVar9 = pCVar11;
      if ((uVar1 & 0x307) == 0) goto joined_r0x001dbd48;
      bVar14 = *(byte *)((int)&pCVar11->section + 1);
      uVar13 = (uint)bVar14;
      pCVar11 = (CONF_VALUE *)((int)&pCVar11->section + 1);
    }
  ...
  *(char *)((int)&pCVar2->section + 1) = '\0';
  ...
  if ((local_80.st_mode & 0xf000) == 0x4000) {
    if (local_88 == 0) {
      ...
      if (a == (BIO *)0x0) goto LAB_001dbfb8;
      ptr = local_84;
      if (pCVar2 != local_84) goto LAB_001dbf5c;
      goto LAB_001dbed6;
    }
