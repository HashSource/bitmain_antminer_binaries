...
/* WARNING: Removing unreachable block (ram,0x0009bd40) */
/* WARNING: Removing unreachable block (ram,0x0009bd4a) */
/* WARNING: Removing unreachable block (ram,0x0009bd4c) */
/* WARNING: Removing unreachable block (ram,0x0009bd4e) */
/* WARNING: Removing unreachable block (ram,0x0009bd54) */
/* WARNING: Removing unreachable block (ram,0x0009b91e) */
...
LAB_0009ba7c:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_0009c1de;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_0009c1de;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar5) == 0) goto LAB_0009ba7c;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_0009c1de;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar6 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_0009c1de;
              op = pBVar11;
