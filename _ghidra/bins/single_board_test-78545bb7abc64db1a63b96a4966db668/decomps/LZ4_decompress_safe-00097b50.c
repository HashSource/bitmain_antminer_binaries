...
/* WARNING: Removing unreachable block (ram,0x00098024) */
/* WARNING: Removing unreachable block (ram,0x0009802e) */
/* WARNING: Removing unreachable block (ram,0x00098030) */
/* WARNING: Removing unreachable block (ram,0x00098032) */
/* WARNING: Removing unreachable block (ram,0x00098038) */
/* WARNING: Removing unreachable block (ram,0x00097c02) */
...

{
  ...
  local_24 = 0;
  local_28 = 0;
  if ((source == (char *)0x0) || (maxDecompressedSize < 0)) {
    pBVar8 = (BYTE *)0xffffffff;
  }
  else {
    iend = (BYTE *)(source + compressedSize);
    oend = (BYTE *)(dest + maxDecompressedSize);
    dictEnd = (BYTE *)0x0;
    checkOffset = 1;
    shortiend = iend + -0x10;
    shortoend = oend + -0x20;
    iVar9 = maxDecompressedSize;
...
LAB_00097d60:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000984bc;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000984bc;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_00097d60;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000984bc;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000984bc;
              op = pBVar10;
