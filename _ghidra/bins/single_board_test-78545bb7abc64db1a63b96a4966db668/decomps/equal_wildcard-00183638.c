      ...
      do {
        ...
        if (uVar6 == 0x2a) {
          ...
          if ((((pbVar11 != (byte *)0x0) || (bVar12 || iVar10 != 0)) ||
             ...
             ((uVar8 & 1) == 0 && uVar6 == 0)) goto LAB_001837c2;
          ...
          if (uVar8 != 0) goto LAB_001837c2;
          iVar10 = iVar10 + 1;
          uVar8 = 1;
          bVar12 = false;
        }
        else {
          if ((uVar6 != 0x2d) || ((int)(uVar8 << 0x1f) < 0)) goto LAB_001837c2;
          uVar8 = uVar8 | 4;
        }
        pbVar7 = pbVar7 + 1;
        pbVar3 = pbVar9;
          ...
          do {
            ...
            if (uVar6 != uVar8) {
              if (uVar8 - 0x41 < 0x1a) {
                ...
                if (uVar6 - 0x41 < 0x1a) goto LAB_00183872;
              }
              else {
                if (0x19 < uVar6 - 0x41) {
                  return 0;
...
LAB_00183872:
            ...
            if (param_1 == pbVar11) {
              ...
              if (pbVar7 != (byte *)0x0) goto LAB_00183894;
              goto LAB_00183940;
            }
            bVar2 = *param_1;
            pbVar3 = pbVar3 + 1;
        ...
        do {
          if (uVar6 != uVar5) {
            if (uVar5 - 0x41 < 0x1a) {
              ...
              if ((uVar6 - 0x41 & 0xff) < 0x1a) goto LAB_001838e8;
            }
            else {
  ...
  if (uVar8 != 0) {
    ...
    do {
      ...
      if (uVar8 != uVar6) {
        if (uVar8 - 0x41 < 0x1a) {
          uVar8 = uVar8 + 0x20 & 0xff;
          if (uVar6 - 0x41 < 0x1a) goto LAB_0018386a;
        }
        else {
          if (0x19 < uVar6 - 0x41) {
            return 0;
