...
LAB_001051b2:
    ...
    pSVar6 = ses;
    if (pcVar5 == (code *)0x0) goto LAB_001051ca;
    if (0xf < param_3) {
      param_3 = 0x10;
    }
    ...
    case 3:
    case 4:
      if (1 < local_80) goto switchD_001052b6_default;
      if (iVar3 == 3) {
        uVar4 = 5;
        break;
      }
      uVar4 = 6;
      if (*(int *)(param_1 + 0x58c) != 0) goto LAB_001051d0;
      goto LAB_001051fc;
    default:
switchD_001052b6_default:
      uVar4 = 1;
    }
    if (*(int *)(param_1 + 0x58c) == 0) goto LAB_00105202;
LAB_001051d0:
    if ((*(int *)((*(int **)(param_1 + 4))[0x19] + 0x30) << 0x1c < 0) ||
       (iVar3 = **(int **)(param_1 + 4), iVar3 == 0x10000 || iVar3 < 0x304)) goto LAB_00105202;
  }
  else {
    if ((((*(int *)((*(int **)(param_1 + 4))[0x19] + 0x30) << 0x1c < 0) ||
