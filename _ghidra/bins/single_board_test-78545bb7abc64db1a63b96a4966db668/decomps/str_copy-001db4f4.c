          ...
          if ((int)(uVar8 << 0x19) < 0) {
            do {
              ...
              if (-1 < (char)bVar7) {
                ...
                if ((uVar2 & 8) != 0) goto LAB_001db5c0;
                if (uVar11 == uVar8) goto LAB_001db5c4;
                if ((uVar2 & 0x20) != 0) {
                  bVar7 = pbVar10[2];
                  uVar8 = (uint)bVar7;
                  param_4 = pbVar13;
          ...
          if ((int)(uVar8 << 0x15) < 0) {
            while( true ) {
              ...
              if (uVar11 == uVar8) {
                bVar7 = pbVar10[2];
                uVar8 = (uint)bVar7;
                if (uVar11 != uVar8) goto LAB_001db5c6;
                param_4 = pbVar10 + 2;
              }
              str->data[iVar4] = bVar7;
              iVar4 = iVar4 + 1;
...
LAB_001db604:
              ...
              if ((int)((uint)*(ushort *)((int)pvVar6 + uVar8 * 2) << 0x1c) < 0) goto LAB_001db756;
              if (uVar8 != 0x72) goto LAB_001db604;
              bVar7 = 0xd;
            }
            str->data[iVar4] = bVar7;
            iVar4 = iVar4 + 1;
...
LAB_001db704:
            ...
            if ((bVar7 & 0x80) == 0) {
              uVar2 = *(ushort *)((int)pvVar6 + uVar11 * 2);
              pbVar9 = pbVar13;
              goto joined_r0x001db65c;
            }
            bVar7 = (byte)uVar11;
            *pbVar13 = 0;
            pbVar12 = pbVar13;
            goto joined_r0x001db71e;
          }
        }
LAB_001db5ce:
        param_4 = pbVar10 + 1;
...
LAB_001db744:
  ...
  return 0;
LAB_001db5c0:
  if (uVar11 != uVar8) goto LAB_001db530;
LAB_001db5c4:
  uVar8 = (uint)param_4[1];
LAB_001db5c6:
  pbVar10 = param_4 + 1;
  uVar11 = uVar8;
  if ((char)uVar8 < '\0') goto LAB_001db5ce;
  goto LAB_001db534;
joined_r0x001db65c:
  if ((uVar2 & 0x107) == 0) goto LAB_001db7c8;
  pbVar9 = pbVar9 + 1;
  uVar11 = (uint)*pbVar9;
  if ((*pbVar9 & 0x80) != 0) goto LAB_001db676;
  uVar2 = *(ushort *)((int)pvVar6 + uVar11 * 2);
  goto joined_r0x001db65c;
LAB_001db7c8:
    ...
    *pbVar9 = 0;
    ...
    if ((bVar7 & 0x80) == 0) {
      ...
      while ((uVar2 & 0x107) != 0) {
        ...
        bVar7 = *pbVar12;
        uVar11 = (uint)bVar7;
        if ((bVar7 & 0x80) != 0) goto LAB_001db812;
        uVar2 = *(ushort *)((int)param_1->meth_data + uVar11 * 2);
      }
      bVar7 = (byte)uVar11;
      *pbVar12 = 0;
...
LAB_001db79c:
    ...
    param_4 = pbVar12 + 1;
    if (pbVar9 == (byte *)0x0) goto LAB_001db6ac;
  }
  *pbVar9 = local_3c;
LAB_001db6ac:
  *pbVar12 = bVar7;
