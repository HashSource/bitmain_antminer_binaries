...

{
  ...
  snprintf(tmp1,0x100,"Read_Temperature_From_Switch : %s",pcVar1);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : switch type : %s\n","print_local_config_after_parse_MES_system_information",
         &(Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor);
  snprintf(tmp1,0x100,"switch type : %s",
           &(Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : switch addr : %d\n","print_local_config_after_parse_MES_system_information",
         (Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.switch_addr);
  snprintf(tmp1,0x100,"switch addr : %d",
           (Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.switch_addr);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : sensor num attached to switch : %d\n",
         "print_local_config_after_parse_MES_system_information",
         (uint)(Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.sensor_num);
  snprintf(tmp1,0x100,"sensor num attached to switch : %d",
           (uint)(Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.sensor_num);
  log_to_file(tmp1,time_stamp);
  for (index = 0;
      index < (Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.sensor_num;
      index = index + 1) {
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : sensor[%d],switch channel : %d\n",
           "print_local_config_after_parse_MES_system_information",index,
           (uint)(Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.switch_sensor_info
                 [index].channel);
    snprintf(tmp1,0x100,"sensor[%d],switch channel : %d",index,
             (uint)(Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.
                   switch_sensor_info[index].channel);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : sensor[%d],sensor type : %s\n",
           "print_local_config_after_parse_MES_system_information",index,
           (Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.switch_sensor_info
           [index].sensor_model);
    snprintf(tmp1,0x100,"sensor[%d],sensor type : %s",index,
             (Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.switch_sensor_info
             [index].sensor_model);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : sensor[%d],sensor addr : %d\n",
           "print_local_config_after_parse_MES_system_information",index,
           (uint)(Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.switch_sensor_info
                 [index].sensor_addr);
    snprintf(tmp1,0x100,"sensor[%d],sensor addr : %d",index,
             (uint)(Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.
                   switch_sensor_info[index].sensor_addr);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : sensor[%d],sensor bind asic : %d\n",
           "print_local_config_after_parse_MES_system_information",index,
           (uint)(Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.switch_sensor_info
                 [index].bind_asic);
    snprintf(tmp1,0x100,"sensor[%d],sensor bind asic : %d",index,
             (uint)(Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.
                   switch_sensor_info[index].bind_asic);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    if ((Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.switch_sensor_info[index].
        power_supply_ctrlboard == false) {
      pcVar1 = "false";
    }
    else {
      pcVar1 = "true";
    }
    printf("%s : sensor[%d],supply by ctrlboard : %s\n",
           "print_local_config_after_parse_MES_system_information",index,pcVar1);
    if ((Local_Config_Information->Hash_Board).Sensor_Info.switch_sensor.switch_sensor_info[index].
        power_supply_ctrlboard == false) {
      pcVar1 = "false";
    }
    ...
    snprintf(tmp1,0x100,"sensor[%d],supply by ctrlboard : %s",index,pcVar1);
    log_to_file(tmp1,time_stamp);
  }
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  snprintf(tmp1,0x100,"leakage_current : %d",
           (Local_Config_Information->Test_Info).Test_Standard.leakage_current);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
