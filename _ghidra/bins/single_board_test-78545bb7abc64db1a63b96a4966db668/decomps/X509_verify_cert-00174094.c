...
LAB_0017420c:
  ...
  if (0 < iVar3) {
    if (iVar1 != 0) {
      ...
      if (*(int *)(&minbits_table + (iVar3 + -1) * 4) <= iVar1) goto LAB_00174100;
    }
...
LAB_0017418c:
    ...
    if (iVar1 == 0) {
      if (((psVar5[1].stack.num & 5U) != 0) || (-1 < (int)psVar5[1].stack.data)) goto LAB_0017418c;
