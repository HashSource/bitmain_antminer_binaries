...

{
  ...
  if (gScanCodeGun_data_ready == '\x03') {
    ...
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : SN data::[%s]\n","scan_code_from_hashboard",0x21bba29);
    snprintf(tmp1,0x100,"SN data::[%s]",0x21bba29);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    ...
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : chip_die::[%s].\n","scan_code_from_hashboard",0x21bb988);
    snprintf(tmp1,0x100,"chip_die::[%s].",0x21bb988);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : chip_marking::[%s].\n","scan_code_from_hashboard",0x21bb998);
    snprintf(tmp1,0x100,"chip_marking::[%s].",0x21bb998);
    log_to_file(tmp1,time_stamp);
    ...
    if (_Var2) {
      ...
      print_time_stamp(time_stamp,0x30);
      printf("%s ",time_stamp);
      printf("%s : chip_bin::[%s].\n","scan_code_from_hashboard",0x21bb9a8);
      snprintf(tmp1,0x100,"chip_bin::[%s].",0x21bb9a8);
      log_to_file(tmp1,time_stamp);
      print_time_stamp(time_stamp,0x30);
      printf("%s ",time_stamp);
      printf("%s : chip_ftversion::[%s].\n","scan_code_from_hashboard",0x21bb9b8);
      snprintf(tmp1,0x100,"chip_ftversion::[%s].",0x21bb9b8);
      log_to_file(tmp1,time_stamp);
    }
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : temp_sensor_type::[%s].\n","scan_code_from_hashboard",0x21bb9c8);
    snprintf(tmp1,0x100,"temp_sensor_type::[%s].",0x21bb9c8);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : hashboard_ctrl_code::[%s].\n","scan_code_from_hashboard",0x21bb9d8);
    snprintf(tmp1,0x100,"hashboard_ctrl_code::[%s].",0x21bb9d8);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : hashboard_index::[%s].\n","scan_code_from_hashboard",0x21bb9e8);
    snprintf(tmp1,0x100,"hashboard_index::[%s].",0x21bb9e8);
    log_to_file(tmp1,time_stamp);
