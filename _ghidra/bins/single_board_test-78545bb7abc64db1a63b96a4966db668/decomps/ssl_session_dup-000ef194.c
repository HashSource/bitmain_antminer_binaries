    ...
    *(int *)(ses[1].key_arg + 4) = iVar1;
    if ((iVar1 != 0) &&
      ...
      if (*(char **)((int)param_1 + 400) != (char *)0x0) {
        ...
        if (pcVar3 == (char *)0x0) goto LAB_000ef316;
      }
      ...
      if (iVar1 != 0) {
        if (*(char **)((int)param_1 + 0x1cc) != (char *)0x0) {
          ...
          ses->prev = psVar4;
          if (psVar4 == (ssl_session_st *)0x0) goto LAB_000ef316;
        }
        if ((param_2 == 0) || (*(int *)((int)param_1 + 0x1d0) == 0)) {
          ...
          ses->next = ppsVar6;
          if (ppsVar6 == (ssl_session_st **)0x0) goto LAB_000ef316;
        }
        if (*(int *)((int)param_1 + 0x1e4) != 0) {
          ...
          if (puVar5 == (uchar *)0x0) goto LAB_000ef316;
        }
