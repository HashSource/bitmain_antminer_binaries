...
LAB_00103690:
    ...
    if (uVar9 - 3 < uVar11) goto LAB_00103690;
    iVar8 = (uVar9 - 3) - uVar11;
    *param_2 = pbVar2 + uVar11;
    param_2[1] = iVar8;
    if (iVar8 != 0) goto LAB_00103690;
    if (uVar11 != 0) {
      if (2 < uVar11) {
        in = &local_38;
...
LAB_00103788:
              ...
              if (uVar11 - 2 < uVar9) goto LAB_00103788;
...
LAB_001038e0:
      ...
      *(int *)(iVar3 + 0x1a4) = iVar8;
      OPENSSL_sk_pop_free(*(undefined4 *)(iVar3 + 0x1a0),(undefined *)0x178169);
...
LAB_00103a88:
    ...
    if ((*(int *)(param_1[0x1f] + 0xd4) == 0) ||
       (iVar8 = ssl3_digest_cached_records(param_1,0), iVar8 != 0)) goto LAB_001038e0;
  }
  else {
    if (param_2[1] != 0) {
      uVar9 = param_2[1] - 1;
...
LAB_001036b8:
  X509_free(a);
  OPENSSL_sk_pop_free(iVar1,(undefined *)0x178169);
  return uVar13;
}
