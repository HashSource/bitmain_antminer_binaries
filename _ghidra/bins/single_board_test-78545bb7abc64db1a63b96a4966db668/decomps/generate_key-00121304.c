...
LAB_00121424:
    ...
    if (a_00 == (BIGNUM *)0x0) {
      ...
      bVar1 = true;
      if (a_00 == (BIGNUM *)0x0) goto LAB_00121424;
    }
    ...
    if ((a_01 != (BIGNUM *)0x0) || (a_01 = BN_new(), a_01 != (BIGNUM *)0x0)) {
      if ((*(uint *)(param_1 + 0x1c) & 1) == 0) {
        ...
        if (pBVar3 == (BN_MONT_CTX *)0x0) goto LAB_00121362;
      }
      if (bVar1) {
        ...
        if (iVar2 == 0) {
          ...
          if ((iVar2 != 0) &&
             (((iVar2 = BN_is_word(*(undefined4 *)(param_1 + 0xc),2), iVar2 == 0 ||
              ...
              (iVar2 = BN_clear_bit(a_00,0), iVar2 != 0)))) goto LAB_001213c4;
        }
        else {
          while (iVar2 = BN_priv_rand_range(a_00,iVar2), iVar2 != 0) {
            iVar2 = BN_is_zero(a_00);
            if ((iVar2 == 0) && (iVar2 = BN_is_one(a_00), iVar2 == 0)) goto LAB_001213c4;
            iVar2 = *(int *)(param_1 + 0x24);
          }
        }
      }
