...

{
  ...
  if (((uint)key & 3) != 0) {
    if ((int)key << 0x1f < 0) {
      ...
      switch(length) {
      case 1:
        goto switchD_000daed6_caseD_1;
      case 3:
        uVar8 = uVar8 + (uint)*(byte *)((int)key + 2) * 0x10000;
      case 2:
switchD_000daed6_caseD_2:
                    /* WARNING: Load size is inaccurate */
  ...
  switch(length) {
  case 1:
switchD_000daed6_caseD_1:
                    /* WARNING: Load size is inaccurate */
    uVar3 = (byte)*key + uVar8;
    break;
  case 2:
    goto switchD_000daed6_caseD_2;
  case 3:
                    /* WARNING: Load size is inaccurate */
