  ...
  if (param_2 < 0x1009) {
    if (param_2 == 0x1003) {
      ...
      if (param_3 == 0xfffffffe) {
        return (uint)(byte)puVar2[10];
      }
      if (param_3 - 1 < 2) {
        *(char *)(puVar2 + 10) = (char)param_3;
        return 1;
      }
    }
    else if (param_2 == 0x1007) {
      puVar2[0xc] = (uint)param_4;
      return 1;
    }
  }
  else {
    ...
    if (param_2 < 0x100d) {
      ...
      if (0x100a < param_2) {
        CRYPTO_free((void *)puVar2[0xd]);
        puVar2[0xd] = (uint)param_4;
        if (param_4 != (uint *)0x0) {
          puVar2[0xe] = param_3;
          return 1;
        }
      ...
      if (param_2 < 0x100e) {
        ASN1_OBJECT_free((ASN1_OBJECT *)puVar2[0xb]);
        puVar2[0xb] = (uint)param_4;
        return 1;
      }
      if (param_2 == 0x100f) {
        if ((0 < (int)param_3) && (puVar2[6] == 0)) {
          puVar2[7] = param_3;
          return 1;
        }
      }
      else if (param_2 == 0x1010) {
        puVar2[4] = param_3;
        return 1;
      }
    }
