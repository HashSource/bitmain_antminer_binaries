...

{
  ...
  if (param_2 < 0xd) {
    ...
    if (3 < param_2) {
      if (param_2 != 10) {
        if (param_2 != 0xb) goto LAB_00117b5c;
      ...
      if (param_2 != 0x75) {
        if (param_2 == 0x7a) {
          if ((int)pbVar6->method < (int)param_3) {
            ...
            if (pcVar3 == (char *)0x0) goto LAB_00117dce;
...
LAB_00117b5c:
      ...
      if (((int)pBVar1 < 0x1001) || (pBVar1 == pbVar6->method)) {
        ...
        pcVar3 = pbVar6->cb_arg;
        if (pBVar7 == (BIO_METHOD *)pbVar6->callback) goto LAB_00117c7a;
LAB_00117da2:
...
LAB_00117dce:
        ...
        if (pcVar3 == (char *)0x0) goto LAB_00117dce;
        if ((0x1000 < (int)pBVar7) && (pBVar7 != (BIO_METHOD *)pbVar6->callback)) goto LAB_00117da2;
      }
      if (pbVar6->cb_arg == pcVar3) {
        ptr = (void *)pbVar6->flags;
      }
