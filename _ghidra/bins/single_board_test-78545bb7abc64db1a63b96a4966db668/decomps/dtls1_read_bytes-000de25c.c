...
LAB_000de3c6:
          ...
          uVar5 = param_1[5].options;
          if (uVar5 != 0x15) goto LAB_000de3c6;
        }
...
LAB_000de516:
          ...
          if (uVar5 == 0x14) {
            if (param_3 != (ulong *)0x0 && param_2 == 0x16) goto LAB_000de60a;
            if ((int)(uVar8 << 0x1f) < 0) {
LAB_000de718:
              param_1->bbio = (BIO *)0x1;
              param_1[5].tlsext_debug_arg = (void *)0x1;
...
LAB_000de744:
                ...
                if (uVar5 != 0x17) goto LAB_000de744;
