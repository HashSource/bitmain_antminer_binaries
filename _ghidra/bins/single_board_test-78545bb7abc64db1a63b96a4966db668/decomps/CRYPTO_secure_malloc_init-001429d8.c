...

{
  ...
  DAT_021b88e4 = param_1;
  DAT_021b88f0 = param_2;
  iVar1 = __aeabi_uidiv(param_1,param_2);
  DAT_021b88fc = iVar1 << 1;
  if (DAT_021b88fc >> 3 == 0) {
    ptr = (void *)0x0;
  }
  else {
    ...
    do {
      DAT_021b88ec = iVar1;
      uVar2 = uVar2 >> 1;
      iVar1 = DAT_021b88ec + 1;
    } while (uVar2 != 0);
    DAT_021b88e8 = (void *)CRYPTO_zalloc(DAT_021b88ec << 2,"crypto/mem_sec.c",0x1a0);
    if (DAT_021b88e8 == (void *)0x0) {
                    /* WARNING: Subroutine does not return */
      OPENSSL_die("assertion failed: sh.freelist != NULL","crypto/mem_sec.c",0x1a1);
    }
    DAT_021b88f4 = (void *)CRYPTO_zalloc(DAT_021b88fc >> 3,"crypto/mem_sec.c",0x1a5);
    if (DAT_021b88f4 == (void *)0x0) {
                    /* WARNING: Subroutine does not return */
      OPENSSL_die("assertion failed: sh.bittable != NULL","crypto/mem_sec.c",0x1a6);
    }
    DAT_021b88f8 = (void *)CRYPTO_zalloc(DAT_021b88fc >> 3,"crypto/mem_sec.c",0x1aa);
    if (DAT_021b88f8 == (void *)0x0) {
                    /* WARNING: Subroutine does not return */
    ...
    DAT_021b88dc = iVar1 + DAT_021b88e4;
    sh = mmap((void *)0x0,DAT_021b88dc,3,0x22,-1,0);
    if (sh != (void *)0xffffffff) {
      DAT_021b88e0 = (void *)((int)sh + __len);
      sh_setbit(DAT_021b88e0,0,DAT_021b88f4);
      sh_add_to_list(DAT_021b88e8,DAT_021b88e0);
      ...
      iVar1 = mprotect((void *)(((DAT_021b88e4 - 1) + __len * 2 & -__len) + (int)sh),__len,0);
      if (iVar1 < 0) {
        sVar3 = 2;
      }
      iVar1 = mlock(DAT_021b88e0,DAT_021b88e4);
      if (iVar1 < 0) {
        sVar3 = 2;
      }
      iVar1 = madvise(DAT_021b88e0,DAT_021b88e4,0x10);
      if (iVar1 < 0) {
        sVar3 = 2;
      }
