...

{
  ...
  int iVar2;
  int iVar3;
  stack_st_CONF_VALUE *local_14;
  
  local_14 = extlist;
  if (*(int *)((int)method->usr_data + 4) != 0) {
    iVar3 = (int)method->usr_data + 0x58;
    do {
      while( true ) {
        HintPreloadData(iVar3);
        iVar2 = ASN1_BIT_STRING_get_bit(bits,*(int *)(iVar3 + -0x58));
        if (iVar2 == 0) break;
        X509V3_add_value(*(char **)(iVar3 + -0x54),(char *)0x0,&local_14);
