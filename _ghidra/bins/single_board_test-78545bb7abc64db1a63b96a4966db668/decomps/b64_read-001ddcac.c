...
LAB_001ddd88:
  do {
    ...
    if (outl[5] == 0) {
LAB_001dddb8:
      if (((int)uVar14 < 0x400) && (0 < (int)outl[6])) goto LAB_001ddd88;
LAB_001dddc8:
...
LAB_001ddf08:
        ...
        outl[5] = 0;
LAB_001ddf28:
        if ((uVar14 != sVar5) || (local_2c[0] != 0)) goto LAB_001de0a4;
        if (in == puVar4) {
          if (uVar14 == 0x400) {
            outl[2] = 0;
            outl[3] = 1;
