...

{
  ...
  if ((param_1[1].references & 0x100U) != 0) goto LAB_001822b6;
  type = EVP_sha1();
  ...
  if (a == (BASIC_CONSTRAINTS *)0x0) {
    ...
    if (a_00 == (ASN1_INTEGER *)0x0) {
      ...
      if (a_00->type != 0x102) {
        ...
        if (pAVar3 == (ASN1_BIT_STRING *)0x0 || iVar2 != 0) goto LAB_00182096;
      }
...
LAB_001820c8:
  ...
  if (pvVar6 == (void *)0x0) {
    ...
    OPENSSL_sk_pop_free(pvVar6,0x18981d);
  }
    ...
    while (iVar2 = OPENSSL_sk_num(pvVar6), local_24[0] < iVar2) {
      ...
      if (((int *)*piVar13 != (int *)0x0) && (*(int *)*piVar13 == 1)) {
        ...
        do {
          ...
          if (iVar9 <= iVar2) goto LAB_001821ec;
