    ...
    if ((uVar12 & 0x84) == 0) {
      ...
      if ((int)(uVar12 << 0x18) < 0) {
        ...
        if ((pEVar3 == (EVP_PKEY *)0x0) &&
           (pEVar3 = *(EVP_PKEY **)(uVar12 + 0x7c), pEVar3 == (EVP_PKEY *)0x0)) goto LAB_00102d68;
      }
      else {
...
LAB_0010319c:
      ...
      *param_2 = (uint)(pbVar16 + uVar11);
      ...
      if (uVar12 - uVar11 != 0) goto LAB_0010319c;
...
LAB_0010302e:
    ...
    *param_2 = (uint)puVar7;
    ...
    if (uVar11 != uVar12) goto LAB_0010302e;
    pEVar18 = *(EVP_PKEY **)(param_1[0x1f] + 0x214);
    if (pEVar18 == (EVP_PKEY *)0x0) {
