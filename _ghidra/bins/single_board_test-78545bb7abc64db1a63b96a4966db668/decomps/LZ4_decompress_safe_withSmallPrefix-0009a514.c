...
/* WARNING: Removing unreachable block (ram,0x0009a9f0) */
/* WARNING: Removing unreachable block (ram,0x0009a9fa) */
/* WARNING: Removing unreachable block (ram,0x0009a9fc) */
/* WARNING: Removing unreachable block (ram,0x0009a9fe) */
/* WARNING: Removing unreachable block (ram,0x0009aa04) */
/* WARNING: Removing unreachable block (ram,0x0009a5ce) */
...
LAB_0009a72c:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_0009ae88;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_0009ae88;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_0009a72c;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_0009ae88;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_0009ae88;
              op = pBVar10;
