...

{
  ...
  while( true ) {
    ...
    if (((iVar4 == 0) && (cnf->value != (char *)0x0)) &&
      ...
      if (param_2 == (X509V3_CTX *)0x0) goto LAB_001d204c;
      if (param_2->flags != 1) {
        if (param_2->subject_cert == (X509 *)0x0) {
          if (param_2->subject_req == (X509_REQ *)0x0) goto LAB_001d204c;
        ...
        while( true ) {
          ...
          if ((pAVar7 == (ASN1_STRING *)0x0) ||
             (a = (ASN1_STRING *)GENERAL_NAME_new(), a == (ASN1_STRING *)0x0)) goto LAB_001d1fc6;
          ((_union_851 *)&a->type)->otherName = (OTHERNAME *)pAVar7;
          a->length = 1;
          iVar8 = OPENSSL_sk_push(iVar2,a);
          if (iVar8 == 0) goto LAB_001d2010;
        }
      }
    }
    else {
      pGVar3 = v2i_GENERAL_NAME(param_1,param_2,cnf);
      if (pGVar3 == (GENERAL_NAME *)0x0) goto LAB_001d1fe0;
...
LAB_001d1fe0:
  OPENSSL_sk_pop_free(iVar2,(undefined *)0x17f325);
  return 0;
LAB_001d1fc6:
