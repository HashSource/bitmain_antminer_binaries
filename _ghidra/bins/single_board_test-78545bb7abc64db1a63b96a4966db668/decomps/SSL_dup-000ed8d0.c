...

{
  ...
  if (iVar2 != 0) {
    ...
    if (0 < iVar2) {
      iVar15 = 0;
      iVar2 = OPENSSL_sk_num(ssl->cert);
      OPENSSL_sk_pop_free(s->cert,0xe92f9);
      s->cert = (cert_st *)0x0;
      OPENSSL_sk_pop_free(s->sid_ctx_length,(undefined *)0x178169);
      a = *(X509 **)(s->sid_ctx + 4);
      s->sid_ctx_length = 0;
      X509_free(a);
      pSVar13 = s[3].method;
    ...
    if (iVar2 != 0) {
      ...
      if (ssl->session != (SSL_SESSION *)0x0) {
        ...
        s->session = pSVar6;
        if (pSVar6 == (SSL_SESSION *)0x0) goto LAB_000ed9dc;
      }
      iVar2 = ssl[3].rwstate;
      if (iVar2 == 0) {
        s[3].rwstate = 0;
LAB_000edb3c:
        ...
        if (iVar15 != 0) {
          ...
          do {
            ...
            if (pXVar7 == (X509_NAME *)0x0) goto LAB_000edbe8;
            iVar16 = OPENSSL_sk_insert(iVar15,pXVar7,iVar14);
            iVar14 = iVar14 + 1;
          } while (iVar16 != 0);
          X509_NAME_free(pXVar7);
LAB_000edbe8:
          OPENSSL_sk_pop_free(iVar15,(undefined *)0x177669);
        }
      }
      else {
        iVar15 = OPENSSL_sk_new_null();
        if (iVar15 != 0) {
          ...
          do {
            ...
            pXVar7 = (X509_NAME *)OPENSSL_sk_value(iVar2,iVar14);
            pXVar7 = X509_NAME_dup(pXVar7);
            if (pXVar7 == (X509_NAME *)0x0) goto LAB_000edb8c;
            iVar16 = OPENSSL_sk_insert(iVar15,pXVar7,iVar14);
            iVar14 = iVar14 + 1;
          } while (iVar16 != 0);
          X509_NAME_free(pXVar7);
