...
LAB_001cce62:
      ...
      if (iVar10 == 1) {
        ...
        if (0 < iVar10) {
          ...
          if (sVar6 < 0xb) goto LAB_001cceb2;
          iVar10 = PEM_get_EVP_CIPHER_INFO(pcVar11,local_128);
          if (iVar10 != 0) {
            local_12c = &DAT_00245a30;
            local_134 = param_2;
            local_130 = param_3;
            iVar10 = PEM_do_header(local_128,local_140,(long *)&local_13c,(undefined1 *)0x1cd509,
                                   &local_134);
            if (iVar10 != 0) goto LAB_001cceac;
          }
        }
LAB_001cd11c:
        iVar10 = -1;
        ...
        if (-1 < param_1[2] << 0x1f) goto LAB_001cd05a;
LAB_001cd134:
...
LAB_001ccf22:
              if (piVar15 == (int *)&OSSL_STORE_str_functs) goto LAB_001ccf8c;
            }
...
LAB_001ccf8c:
          ...
          if (pvVar2 == (void *)0x0) goto LAB_001cd034;
...
LAB_001cd054:
        iVar10 = local_18c;
        if (param_1[2] << 0x1f < 0) goto LAB_001cd134;
LAB_001cd05a:
      ...
      if (local_18c == 0) {
        if (*param_1 == 2) {
          iVar10 = param_1[4];
LAB_001cd0ca:
          if (iVar10 != 0) goto joined_r0x001cd182;
        }
        else if ((param_1[4] == 0) ||
        ...
        if (0 < param_1[1]) goto joined_r0x001cd182;
        iVar10 = *param_1;
        goto LAB_001cce62;
      }
      if (1 < local_18c) {
...
LAB_001cd22e:
  ...
  do {
    ...
    if (*pcVar11 != '.') {
      if ((char)param_1[6] == '\0') goto LAB_001cd34c;
      uVar13 = param_1[0xb];
      uVar16 = uVar13;
      if (uVar13 != 0) {
        uVar16 = 1;
