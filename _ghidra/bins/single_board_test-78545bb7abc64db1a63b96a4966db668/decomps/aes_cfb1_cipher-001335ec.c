...
undefined4 aes_cfb1_cipher(EVP_CIPHER_CTX *param_1,int param_2,int param_3,uint param_4)

{
  ...
  if (iVar2 != 0) {
    ...
    CRYPTO_cfb128_1_encrypt
              (param_3,param_2,param_4,iVar1,uVar3,local_2c,uVar4,*(undefined4 *)(iVar1 + 0xf8));
  ...
  if (0xfffffff < param_4) {
    ...
    do {
      ...
      uVar4 = EVP_CIPHER_CTX_encrypting(param_1);
      CRYPTO_cfb128_1_encrypt
                (iVar5,iVar2,0x80000000,iVar1,uVar3,local_2c,uVar4,*(undefined4 *)(iVar1 + 0xf8));
      EVP_CIPHER_CTX_set_num(param_1,local_2c[0]);
  ...
  uVar4 = EVP_CIPHER_CTX_encrypting(param_1);
  CRYPTO_cfb128_1_encrypt
            (local_34,local_38,param_4 << 3,iVar1,uVar3,local_2c,uVar4,*(undefined4 *)(iVar1 + 0xf8)
            );
  EVP_CIPHER_CTX_set_num(param_1,local_2c[0]);
  return 1;
}
