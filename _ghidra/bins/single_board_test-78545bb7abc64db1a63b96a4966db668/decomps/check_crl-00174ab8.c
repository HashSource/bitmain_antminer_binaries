...
LAB_00174bc4:
  ...
  if ((int)(param_1[0x1c] << 0x19) < 0) goto LAB_00174b36;
  ...
  if ((int)(uVar3 << 0x1e) < 0) {
    ...
    if (t != (time_t *)0x0) goto LAB_00174b36;
  }
...
joined_r0x00174b8c:
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 == 0) {
      ...
      if ((-1 < iVar1) || ((param_1[0x1c] & 2) != 0)) goto LAB_00174b32;
      param_1[0x18] = 0xc;
      iVar1 = (*(code *)param_1[7])(0,param_1);
    }
    if (iVar1 == 0) {
