...

{
  ...
  if (iVar7 == 0) {
    if (*param_2 == '\x05') {
      ...
      switch(iVar7) {
      case 1:
        goto switchD_001132f8_caseD_1;
      case 5:
        goto switchD_001132f8_caseD_5;
      case 6:
        goto switchD_001132f8_caseD_6;
      case -4:
        goto switchD_001132f8_caseD_fffffffc;
      }
    }
    if (param_3 == 0) goto switchD_00113290_caseD_fffffffd;
  }
  else {
    if (param_3 == 0) {
      if (*(code **)(iVar7 + 8) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00113280. Too many branches */
...
switchD_00113290_caseD_fffffffd:
    ...
    if (*param_2 == '\x05') {
      ...
      switch(iVar7) {
      case 1:
switchD_001132f8_caseD_1:
        *param_1 = *(uint *)(param_2 + 0x14);
        return (ASN1_STRING *)0x1;
      case 5:
switchD_001132f8_caseD_5:
        *param_1 = 1;
        return (ASN1_STRING *)0x1;
      case 6:
switchD_001132f8_caseD_6:
        pAVar2 = OBJ_nid2obj(0);
        *param_1 = (uint)pAVar2;
        return (ASN1_STRING *)0x1;
      case -4:
switchD_001132f8_caseD_fffffffc:
