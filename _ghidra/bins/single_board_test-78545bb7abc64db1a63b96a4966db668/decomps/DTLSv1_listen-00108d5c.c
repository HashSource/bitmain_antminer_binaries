...
LAB_00108e9e:
          ...
          if (uVar14 - 9 < 3) goto LAB_00108e9e;
          uVar13 = (uint)(byte)data_00[0x18] |
                   (uint)(byte)data_00[0x17] << 8 | (uint)(byte)data_00[0x16] << 0x10;
          if ((uVar14 - 0xc < uVar13) || (uVar13 != uVar14 - 0xc)) goto LAB_00108e9e;
          if (data_00[0xd] != '\x01') {
            iVar1 = 0x25c;
            goto LAB_00109274;
          }
...
LAB_00108f9c:
          ...
          if (((uVar13 - 0x23 < uVar3) || (iVar1 = (uVar13 - 0x23) - uVar3, iVar1 == 0)) ||
             (iVar1 - 1U < (uint)(byte)data_00[uVar3 + 0x3c])) goto LAB_00108f9c;
...
LAB_001091e4:
          ...
          if ((iVar1 == 0) || (0xff < local_150)) goto LAB_001091e4;
...
LAB_0010922a:
          ...
          if ((int)uVar16 == 0) goto LAB_0010922a;
          ...
          if (((((int)uVar16 == 0) ||
             ...
             ((iVar1 = WPACKET_get_total_written(auStack_140,&local_14c), iVar1 == 0 ||
              (iVar1 = WPACKET_finish(auStack_140), iVar1 == 0)))) goto LAB_0010922a;
