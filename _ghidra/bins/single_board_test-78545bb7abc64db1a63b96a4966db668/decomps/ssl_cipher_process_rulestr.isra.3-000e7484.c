...
LAB_000e7512:
  ...
  if (iVar10 == 5) {
    if (__n == 8) {
      ...
      if (iVar10 != 0) goto LAB_000e784a;
      iVar10 = ssl_cipher_strength_sort(param_2,param_3);
      if (iVar10 != 0) goto LAB_000e77fe;
    }
    else {
...
LAB_000e77fe:
  ...
  while( true ) {
    if (piVar11 == (int *)0x0) goto LAB_000e7588;
    __s2 = (char *)piVar11[1];
...
LAB_000e7636:
    if ((uVar5 & 0x20) != 0) {
      if (-1 < (int)(local_50 << 0x1a)) goto LAB_000e77ae;
      local_50 = local_50 & (uVar5 | 0xffffffdf);
      if (-1 < (int)(local_50 << 0x1a)) goto LAB_000e7588;
    }
  }
  else {
    if ((local_50 & 0x1f) != 0) {
      local_50 = local_50 & (uVar5 | 0xffffffe0);
      if ((local_50 & 0x1f) == 0) goto LAB_000e7588;
      goto LAB_000e7636;
    }
    local_50 = uVar3;
    if ((uVar5 & 0x20) != 0) {
...
LAB_000e7588:
  ...
  __s1 = param_1;
  if (local_4c == (int *)0x0) goto code_r0x000e7664;
  goto LAB_000e7512;
code_r0x000e7664:
  if (iVar10 != 3) {
    piVar11 = (int *)*param_2;
