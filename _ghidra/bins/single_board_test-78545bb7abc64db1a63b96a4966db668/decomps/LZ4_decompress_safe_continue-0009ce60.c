...
/* WARNING: Removing unreachable block (ram,0x0009d502) */
/* WARNING: Removing unreachable block (ram,0x0009d50c) */
/* WARNING: Removing unreachable block (ram,0x0009d50e) */
/* WARNING: Removing unreachable block (ram,0x0009d510) */
/* WARNING: Removing unreachable block (ram,0x0009d516) */
/* WARNING: Removing unreachable block (ram,0x0009d074) */
...
LAB_0009d30e:
                  ...
                  if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
                    if (local_48 == 0) {
                      if ((iend != ip + length) || (oend < cpy)) goto LAB_0009d9de;
                    }
                    else {
                      if (iend < ip + length) {
                ...
                if ((bVar8 & bVar6) == 0) goto LAB_0009d1fa;
...
LAB_0009d5a0:
                ...
                if ((local_4c == 2) && (match < local_50)) {
                  ...
                  if (cVar7 != '\0') {
                    if (local_48 == 0) goto LAB_0009d9de;
                ...
                if ((local_48 == 0) || (cpy <= oend + -0xc)) {
                  ...
                  if (cVar7 == '\0') {
                    ...
                    *(undefined4 *)(op + 0xc) = uVar2;
                    ...
                    oCopyLimit = oend + -7;
                    if (oend + -5 < cpy) goto LAB_0009d9de;
                    op = pBVar11;
