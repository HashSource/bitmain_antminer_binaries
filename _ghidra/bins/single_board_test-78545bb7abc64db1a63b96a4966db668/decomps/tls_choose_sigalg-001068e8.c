              ...
              if ((*(short *)(iVar4 + 4) == (short)local_2c[0]->type) &&
                ...
                if ((iVar14 != 0) &&
                   ((iVar1 = *(int *)(iVar1 + 0x18), iVar1 != 0 &&
                    ...
                    iVar1 != 0)))) {
                  if (iVar9 != iVar11) goto LAB_0010692c;
                  break;
                }
              }
              iVar11 = iVar11 + 1;
...
LAB_00106c32:
        ...
        if (*(int *)(param_1 + 0xf8c) == 0) goto LAB_00106a84;
...
LAB_001069a0:
        ...
        if (uVar10 == uVar2) goto LAB_00106a74;
      }
      if (uVar12 != 0xffffffff) goto LAB_00106a52;
    }
    else {
      iVar4 = tls1_get_legacy_sigalg(param_1,0xffffffff);
      if (iVar4 == 0) {
