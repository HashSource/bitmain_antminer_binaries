...
/* WARNING: Removing unreachable block (ram,0x000989b6) */
/* WARNING: Removing unreachable block (ram,0x000989c0) */
/* WARNING: Removing unreachable block (ram,0x000989c2) */
/* WARNING: Removing unreachable block (ram,0x000989c4) */
/* WARNING: Removing unreachable block (ram,0x000989ca) */
/* WARNING: Removing unreachable block (ram,0x0009859a) */
/* WARNING: Removing unreachable block (ram,0x000985a2) */
/* WARNING: Removing unreachable block (ram,0x000985b2) */
/* WARNING: Removing unreachable block (ram,0x000985aa) */
...

{
  ...
  local_24 = 1;
  local_28 = 0;
  if ((src == (char *)0x0) || (targetOutputSize < 0)) {
    pBVar8 = (BYTE *)0xffffffff;
  }
  else {
    iend = (BYTE *)(src + compressedSize);
    oend = (BYTE *)(dst + targetOutputSize);
    dictEnd = (BYTE *)0x0;
    checkOffset = 1;
    shortiend = iend + -0x10;
    shortoend = oend + -0x20;
...
LAB_000986f2:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_00098e4e;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_00098e4e;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_000986f2;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_00098e4e;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_00098e4e;
              op = pBVar10;
