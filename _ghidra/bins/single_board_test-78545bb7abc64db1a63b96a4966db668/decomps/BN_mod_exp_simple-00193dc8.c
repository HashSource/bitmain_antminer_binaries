...
LAB_00193f7c:
      ...
      do {
        ...
        pBVar2 = BN_CTX_get(ctx);
        ppBVar5[1] = pBVar2;
        if (pBVar2 == (BIGNUM *)0x0) goto LAB_00193e46;
        a_00 = *ppBVar5;
        ppBVar5 = ppBVar5 + 1;
        iVar3 = BN_mod_mul(pBVar2,a_00,r_00,m,ctx);
        if (iVar3 == 0) goto LAB_00193e46;
    ...
    if (iVar1 != 0) {
      ...
      while( true ) {
        while (iVar1 = BN_is_bit_set(p,local_b8), iVar1 == 0) {
          if ((local_b4 == 0) && (iVar1 = BN_mod_mul(r,r,r,m,ctx), iVar1 == 0)) goto LAB_00193e46;
          if (local_b8 == 0) goto LAB_00194004;
          local_b8 = local_b8 + -1;
        }
        if (local_b0 == 1) {
          iVar1 = 0;
