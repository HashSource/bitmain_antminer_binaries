        ...
        do {
          ...
          do {
            while( true ) {
              ...
              uVar12 = (uint)*pbVar7;
              iVar8 = iVar8 + -1;
              if (uVar12 == 0x2e || uVar12 == 0x20) goto LAB_001894aa;
              ...
              if (((a == (BIGNUM *)0x0) && (a = BN_new(), a == (BIGNUM *)0x0)) ||
                 (iVar4 = BN_set_word(a,w), iVar4 == 0)) goto LAB_00189558;
              bVar2 = true;
LAB_0018948c:
              iVar4 = BN_mul_word(a,10);
              if ((iVar4 == 0) || (iVar4 = BN_add_word(a,uVar12 - 0x30), iVar4 == 0))
              goto LAB_00189558;
              if (iVar8 == 0) goto LAB_001894aa;
            }
            if (bVar2) goto LAB_0018948c;
            w = (uVar12 - 0x30) + w * 10;
          } while (iVar8 != 0);
LAB_001894aa:
          if (local_5c == 0) {
...
LAB_001895dc:
            ...
            if (local_48 < iVar4) {
              ...
              if (local_64 == (uchar *)0x0) goto LAB_00189560;
LAB_00189622:
              iVar10 = 0;
              puVar13 = local_64 + -1;
              do {
                ...
                iVar10 = iVar10 + 1;
                if (uVar6 == 0xffffffff) goto LAB_00189558;
                puVar13 = puVar13 + 1;
                *puVar13 = (uchar)uVar6;
              } while (iVar4 != iVar10);
            }
            else {
              if (iVar4 != 0) goto LAB_00189622;
              iVar10 = 0;
            }
          }
          if (out == (uchar *)0x0) {
