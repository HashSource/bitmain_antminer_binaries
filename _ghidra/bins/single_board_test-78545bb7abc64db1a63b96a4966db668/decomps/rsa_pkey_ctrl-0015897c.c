  ...
  case 5:
    ...
    if ((a != (RSA_PSS_PARAMS *)0x0) &&
      ...
      if (iVar3 == 0x38f) {
        ...
        if (pXVar11 != (X509_ALGOR *)0x0) goto LAB_00158e72;
      }
      else {
...
LAB_00158ec6:
  ...
  case 7:
    ...
    if (param_3 == (ASN1_STRING *)0x0) {
      ...
      pEVar6 = local_2c;
      if (local_28 == (EVP_MD *)0x1) goto LAB_001589f8;
      ...
      if ((((iVar3 < 1) || (iVar3 = RSA_pkey_ctx_ctrl(pEVar2,0x3f8,0x1008,0,&local_34), iVar3 < 1))
        ...
        if ((local_38 != (EVP_MD *)0x0) && (iVar13 = EVP_MD_type(local_38), iVar13 != 0x40)) {
          ...
          *puVar4 = pAVar9;
          if (pAVar9 == (ASN1_OCTET_STRING *)0x0) goto LAB_00158d38;
...
LAB_00158d38:
    ...
    if (puVar4 != (undefined4 *)0x0) {
      ...
      if (puVar10 == (undefined4 *)0x0) {
        ...
        if (puVar10 == (undefined4 *)0x0) {
          pEVar6 = EVP_sha1();
          if (pEVar6 != (EVP_MD *)0x0) goto LAB_00158b38;
        }
        else {
LAB_00158b22:
...
LAB_00158b38:
          if ((undefined4 *)*puVar4 == (undefined4 *)0x0) {
            p2 = EVP_sha1();
            if (p2 == (EVP_MD *)0x0) goto LAB_00158d66;
          }
          else {
            iVar3 = OBJ_obj2nid(*(ASN1_OBJECT **)*puVar4);
            pcVar5 = OBJ_nid2sn(iVar3);
            p2 = EVP_get_digestbyname(pcVar5);
            if (p2 == (EVP_MD *)0x0) goto LAB_00158f1e;
          }
...
LAB_00158d66:
      ...
      if (iVar3 == 0x38f) {
        ...
        puVar4[3] = puVar10;
        if (puVar10 != (undefined4 *)0x0) goto LAB_00158b22;
      }
      else {
        puVar4[3] = 0;
      }
