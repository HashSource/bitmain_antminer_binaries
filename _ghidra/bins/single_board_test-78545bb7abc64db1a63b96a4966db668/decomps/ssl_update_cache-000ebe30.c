...

{
  ...
  if ((uVar4 & param_2) == 0) goto LAB_000ebf1c;
...
LAB_000ebeb0:
        if ((((*(int *)(param_1 + 0x1c) != 0 && (0x303 < iVar2 && iVar2 != 0x10000)) &&
           ...
           (-1 < *(int *)(param_1 + 0x4ec) << 0x11)) goto LAB_000ebef8;
      }
    ...
    if (*(int *)((*(int **)(param_1 + 4))[0x19] + 0x30) << 0x1c < 0) goto LAB_000ebf1c;
    iVar2 = **(int **)(param_1 + 4);
    iVar5 = iVar2 + -0x10000;
    if (iVar5 != 0) {
      iVar5 = 1;
    ...
    if (iVar5 == 0) goto LAB_000ebf1c;
    if ((uVar4 & 0x200) == 0) goto LAB_000ebeb0;
  }
LAB_000ebef8:
