        ...
        if (iVar7 < 1) {
          ...
          if (0 < iVar7) {
            do {
              ...
              if (pAVar3 == (ASN1_TEMPLATE *)0x0) goto LAB_00111df8;
              ppAVar4 = asn1_get_field_ptr(pval,pAVar3);
              puVar2 = local_30;
              if (local_34 == 0) {
                if (local_36 == '\0') goto LAB_001121cc;
                goto LAB_001122b0;
              }
...
LAB_00112056:
          ...
          if (iVar7 != 0) goto joined_r0x00112242;
          goto LAB_0011206e;
        }
