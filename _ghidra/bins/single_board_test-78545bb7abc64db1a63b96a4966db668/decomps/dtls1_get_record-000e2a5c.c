...
LAB_000e2aa8:
        ...
        if ((0 < iVar7) && (local_28 == uVar9)) goto LAB_000e2be0;
LAB_000e2ac8:
...
LAB_000e2be0:
      ...
      *(undefined2 *)((int)param_1 + 0xf26) = *(undefined2 *)(pbVar10 + 9);
      ...
      if (bVar1 == 0x15 || param_1[0x140] != 0) {
        if ((((uint)CONCAT11(bVar5,bVar2) ^ *param_1) & 0xff00) == 0) goto LAB_000e2ba8;
      }
...
LAB_000e2ba8:
        if ((uVar9 < 0x4541) &&
          ...
          if (param_1[0x3bf] - 0xd < uVar9) goto LAB_000e2aa8;
          goto LAB_000e2be0;
        }
      }
    }
