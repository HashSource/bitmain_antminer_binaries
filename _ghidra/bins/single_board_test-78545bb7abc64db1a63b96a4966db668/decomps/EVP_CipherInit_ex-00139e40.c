...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    ...
    if (cipher == (EVP_CIPHER *)0x0) {
      if (pEVar4 == (EVP_CIPHER *)0x0) goto LAB_0013a03e;
      goto LAB_00139ed2;
    }
    if ((pEVar4 != (EVP_CIPHER *)0x0) || (ctx->cipher_data != (void *)0x0)) goto LAB_00139e7c;
  }
  else {
    pEVar4 = ctx->cipher;
...
LAB_0013a03e:
    ...
    else if ((cipher == (EVP_CIPHER *)0x0) || (cipher->nid == pEVar4->nid)) goto LAB_00139ed2;
LAB_00139e7c:
    uVar5 = ctx->flags;
  ...
  if (impl == (ENGINE *)0x0) {
    ...
    if (impl != (ENGINE *)0x0) goto LAB_00139e9e;
  }
  else {
