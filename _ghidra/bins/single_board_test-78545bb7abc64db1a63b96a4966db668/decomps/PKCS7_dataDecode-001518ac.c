...
LAB_001518fa:
    ...
    if (in_bio == (BIO *)0x0 && local_48 == (ASN1_OCTET_STRING *)0x0) goto LAB_00151a22;
    b_00 = (BIO *)0x0;
LAB_00151a4e:
    pBVar4 = BIO_f_cipher();
    bp = BIO_new(pBVar4);
...
LAB_0015197a:
    ...
    if (!bVar1) {
      ...
      pBVar15 = b_00;
      if (cipher != (BIO *)0x0) goto LAB_00151a4e;
LAB_00151b9a:
      local_4c = in_bio;
      if (in_bio != (BIO *)0x0) {
LAB_00151ba0:
      ...
      if (local_48->length < 1) {
        ...
        if (local_4c != (BIO *)0x0) goto LAB_00151ba0;
        bp = (BIO *)0x0;
        pBVar5 = (BIO *)0x0;
        key = pBVar5;
      }
