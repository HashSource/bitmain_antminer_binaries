...
switchD_000b31c8_caseD_9:
    ...
    case dstage_getSuffix:
      ...
      if ((dctx->frameInfo).contentChecksumFlag != LZ4F_noContentChecksum) {
        ...
        if (dctx->dStage == dstage_storeSuffix) goto switchD_000b31c8_caseD_b;
        goto LAB_000b3c94;
      }
      nextSrcSizeHint = 0;
...
LAB_000b3c94:
    ...
    case dstage_getSFrameSize:
      ...
      if (dctx->dStage == dstage_storeSFrameSize) goto switchD_000b31c8_caseD_d;
      goto LAB_000b3d8c;
    case dstage_storeSFrameSize:
switchD_000b31c8_caseD_d:
      uVar16 = dctx->tmpInTarget - dctx->tmpInSize;
      if ((uint)((int)pBVar17 - (int)srcPtr) <= uVar16) {
        uVar16 = (int)pBVar17 - (int)srcPtr;
      }
