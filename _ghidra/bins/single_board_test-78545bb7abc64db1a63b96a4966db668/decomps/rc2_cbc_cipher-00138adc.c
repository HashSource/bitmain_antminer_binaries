...
undefined4 rc2_cbc_cipher(undefined4 param_1,uchar *param_2,uchar *param_3,uint param_4)

{
  ...
  if (param_4 != 0) {
    ...
    iVar2 = EVP_CIPHER_CTX_encrypting(param_1);
    RC2_cbc_encrypt(local_2c,param_2,param_4,(RC2_KEY *)(iVar1 + 4),puVar3,iVar2);
  }
  return 1;
}
