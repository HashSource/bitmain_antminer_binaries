...
LAB_00183a36:
    ...
    if (ptr == (undefined4 *)0x0) goto LAB_001839ec;
...
LAB_001839ce:
      ...
      if (pvVar3 == (void *)0x0) {
        ...
        if (name != (char *)0x0) goto LAB_00183a36;
      }
      else {
        name = (char *)0x0;
      }
...
LAB_001839bc:
      ...
      if (pcVar2 != (char *)0x0) goto LAB_001839ce;
      name = (char *)0x0;
    }
LAB_001839ec:
    ptr = (undefined4 *)0x0;
    ERR_put_error(0x22,0xae,0x41,"crypto/x509v3/v3_utl.c",0x45);
    if (psVar5 != (stack_st_CONF_VALUE *)0x0) goto LAB_00183a06;
    ptr = (undefined4 *)0x0;
  }
