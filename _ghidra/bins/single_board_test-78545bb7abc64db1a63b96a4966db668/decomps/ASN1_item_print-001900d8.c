...
LAB_00190126:
  ...
  if ((it->utype != 1) && (ifld == (ASN1_VALUE *)0x0)) goto LAB_00190126;
...
switchD_00190164_caseD_5:
  ...
  if (it->itype != '\x05') {
    uVar5 = it->utype;
    if (uVar5 != 1) goto LAB_00190350;
    if (*(int *)pctx << 0x1c < 0) {
      a = (ASN1_GENERALIZEDTIME *)0x0;
      goto LAB_001905b2;
    }
    piVar9 = (int *)local_8c;
switchD_0019041a_caseD_1:
    iVar1 = *piVar9;
    if (iVar1 == -1) {
      iVar1 = it->size;
      pcVar8 = "BOOL ABSENT";
      if (iVar1 != -1) goto LAB_001905d4;
    }
    else {
LAB_001905d4:
      if (iVar1 == 0) {
...
LAB_00190364:
    if (uVar5 != 5) goto LAB_00190406;
LAB_0019036a:
    iVar1 = BIO_puts(out,"NULL\n");
    goto joined_r0x0019054c;
  }
  a = local_8c[0];
  if (-1 < *(int *)pctx << 0x1c) {
    piVar9 = (int *)local_8c;
