...

{
  ...
  if (((int)(cflag << 0x1f) < 0) ||
     ((iVar5 = BIO_write(bp,"Certificate:\n",0xd), 0 < iVar5 &&
      (iVar5 = BIO_write(bp,&DAT_0022aec4,10), 0 < iVar5)))) {
    if (-1 < (int)(cflag << 0x1e)) {
...
LAB_0016f606:
      ...
      if (0 < iVar5) {
        ...
        if (0 < iVar5) {
          iVar5 = 0;
          do {
            if (a->length <= iVar5) goto LAB_0016f5ec;
            pbVar1 = a->data + iVar5;
            iVar5 = iVar5 + 1;
            if (a->length == iVar5) {
              uVar8 = 10;
