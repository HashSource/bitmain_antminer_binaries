...
/* WARNING: Removing unreachable block (ram,0x0009c712) */
/* WARNING: Removing unreachable block (ram,0x0009c71c) */
/* WARNING: Removing unreachable block (ram,0x0009c71e) */
/* WARNING: Removing unreachable block (ram,0x0009c720) */
/* WARNING: Removing unreachable block (ram,0x0009c726) */
/* WARNING: Removing unreachable block (ram,0x0009c2f6) */
/* WARNING: Removing unreachable block (ram,0x0009c2fe) */
/* WARNING: Removing unreachable block (ram,0x0009c30e) */
/* WARNING: Removing unreachable block (ram,0x0009c306) */
...
LAB_0009c44e:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_0009cbb0;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_0009cbb0;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar5) == 0) goto LAB_0009c44e;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_0009cbb0;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar6 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_0009cbb0;
              op = pBVar11;
