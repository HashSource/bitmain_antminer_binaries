...
joined_r0x000f7508:
  ...
  if ((uVar3 & 0xfffffffb) == 0) {
    ...
    if (local_58 == (SRTP_PROTECTION_PROFILE *)0x0) {
LAB_000f6f60:
      if (-1 < *(int *)(*(int *)(param_1->type + 100) + 0x30) << 0x1c) goto LAB_000f7476;
...
LAB_000f7228:
      ...
      if (param_1->in_handshake == 0) {
        pcVar12 = (code *)0xf9329;
        pcVar10 = (code *)0xfba8d;
        pcVar9 = (code *)0xfb72d;
        pcVar11 = (code *)0xf8b01;
      }
      else {
        pcVar12 = (code *)0x1019ad;
        pcVar10 = (code *)0x1035c9;
        pcVar9 = (code *)0x103cd1;
        pcVar11 = (code *)0x100e19;
      }
...
LAB_000f726e:
      ...
      do {
        if (!bVar13) {
          ...
          if (iVar2 == 0) goto switchD_000f7346_caseD_3;
          if (pSVar8 != (SRTP_PROTECTION_PROFILE *)0x0) {
            if (param_1->in_handshake == 0) {
...
joined_r0x000f736c:
            ...
            if (-1 < local_44) {
              ...
              param_1->cipher_list = (stack_st_SSL_CIPHER *)0x0;
              if (iVar2 == 1) goto switchD_000f7346_caseD_1;
              if (iVar2 != 0) {
                if (iVar2 == 2) {
                  param_1->rstate = 2;
...
switchD_000f7346_caseD_2:
    ...
    if (uVar3 == 3) {
      ...
      if (param_1->in_handshake == 0) {
        pcVar9 = (code *)0xf9201;
        pcVar10 = (code *)0xfa9d1;
        pcVar12 = (code *)0xf9169;
        pcVar11 = (code *)0xf8edd;
      }
      else {
        pcVar9 = (code *)0x10183d;
        pcVar10 = (code *)0x1015d1;
        pcVar12 = (code *)0x101485;
        pcVar11 = (code *)0x101139;
      }
...
LAB_000f7194:
        ...
        if (iVar2 != 2) goto switchD_000f7134_default;
      ...
      case 1:
        ...
        case 0:
          ...
          break;
        case 1:
          goto switchD_000f7134_caseD_1;
        case 2:
          param_1->shutdown = 2;
        default:
          iVar2 = (*pcVar9)(param_1,&local_40,&local_48,&local_44);
          if (iVar2 != 0) {
            if (local_44 == -1) goto LAB_000f7428;
...
LAB_000f72d0:
            ...
            if (param_1->init_msg != (void *)0x23 && param_1->init_msg != (void *)0x10)
            goto LAB_000f72d0;
            if (-1 < *(int *)(iVar2 + 0x30) << 0x1c) goto LAB_000f72a4;
          }
...
LAB_000f7116:
        if (iVar2 < 1) goto switchD_000f7346_caseD_3;
        iVar2 = 3;
        param_1->shutdown = 3;
        param_1->state = 3;
        break;
