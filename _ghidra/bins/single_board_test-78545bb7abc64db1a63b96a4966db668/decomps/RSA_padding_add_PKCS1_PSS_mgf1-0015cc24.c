...
LAB_0015cc60:
    ...
    if (uVar9 == 0) {
      ...
      *EM = '\0';
      EM = EM + 1;
      if ((int)(cnt + 1) < iVar4) goto LAB_0015cc84;
LAB_0015cd0a:
      iVar4 = 0xbb;
    }
    else {
      if (iVar4 <= (int)(cnt + 1)) goto LAB_0015cd0a;
LAB_0015cc84:
      iVar10 = iVar4 - cnt;
      if (sLen == 0xfffffffd) {
        sLen = iVar10 - 2;
LAB_0015cc9a:
      ...
      if (sLen < iVar10 + -1) goto LAB_0015cc9a;
      iVar4 = 0xc2;
    }
    iVar10 = 0x6e;
  }
    ...
    uVar9 = sLen;
    if (sLen + 3 < 0 == SCARRY4(sLen,3)) goto LAB_0015cc60;
    iVar4 = 0xaf;
    iVar10 = 0x88;
  }
  pEVar6 = (EVP_MD_CTX *)0x0;
