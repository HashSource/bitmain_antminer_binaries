...
LAB_000e5f2a:
  ...
  if (iVar3 != 0) {
    if ((char *)param_1[0x41] != (char *)0x0) {
      ...
      ptr[0x41] = (int)pcVar5;
      if (pcVar5 == (char *)0x0) goto LAB_000e601e;
    }
    return ptr;
  }
LAB_000e601e:
