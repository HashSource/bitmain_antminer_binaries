    ...
    if (param_2 != 0x85) {
      ...
      if ((int)(param_3 << 0x1c) < 0) {
        if ((param_3 & 2) == 0) {
          ...
          OPENSSL_strlcpy(acStack_1c,&DAT_00214ca4,4);
        }
      }
      else if ((param_3 & 6) == 6) {
        OPENSSL_strlcpy(acStack_1c,&DAT_00214ca8,4);
      }
      ...
      ERR_add_error_data(5,"fopen(\'",param_4,&DAT_00214cac,acStack_1c,&DAT_0020e914);
