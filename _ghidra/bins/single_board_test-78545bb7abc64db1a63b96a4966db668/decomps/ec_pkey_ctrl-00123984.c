      ...
      if (iVar4 != 0) {
        ...
        if (iVar4 != 0) {
          if (local_28 != (EVP_PKEY *)0x3b2) {
            if (local_28 != (EVP_PKEY *)0x3b3) goto LAB_00123d04;
            iVar6 = 1;
          }
