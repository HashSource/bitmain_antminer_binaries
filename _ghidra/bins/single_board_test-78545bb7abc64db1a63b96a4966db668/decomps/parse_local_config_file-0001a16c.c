...

{
  ...
  char tmp1 [256];
  json_error_t error;
  json_t *Test_Loop_array [60];
  json_t *CtrlBoard_Sensor_Addr_array [2];
  json_t *Pic_Sensor_Addr_array [4];
  json_t *m_obj;
  int switch_sensor_num;
  json_t *power_supply_ctrlboard;
  json_t *switch_addr;
  json_t *bind_asic;
  json_t *sensor_addr;
  json_t *channel;
    ...
    if ((pjVar4 == (json_t *)0x0) || (pjVar4->type != JSON_STRING)) {
      ...
      if ((pjVar4 == (json_t *)0x0) || (pjVar4->type != JSON_OBJECT)) {
        ...
        if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_STRING)) {
          ...
          pHVar12 = &Local_Config_Information->Hash_Board;
          pcVar5 = json_string_value(pjVar6);
          strcpy(pHVar12->Miner_Type,pcVar5);
          print_time_stamp(time_stamp,0x30);
          printf("%s ",time_stamp);
          ...
          if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_STRING)) {
            ...
            pHVar12 = &Local_Config_Information->Hash_Board;
            pcVar5 = json_string_value(pjVar6);
            strcpy(pHVar12->Board_Name,pcVar5);
            print_time_stamp(time_stamp,0x30);
            printf("%s ",time_stamp);
            ...
            if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_STRING)) {
              ...
              pHVar12 = &Local_Config_Information->Hash_Board;
              pcVar5 = json_string_value(pjVar6);
              strcpy(pHVar12->Asic_Type,pcVar5);
              print_time_stamp(time_stamp,0x30);
              printf("%s ",time_stamp);
              ...
              if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_INTEGER)) {
                ...
                jVar13 = json_integer_value(pjVar6);
                (pLVar2->Hash_Board).Asic_Num = (uint32_t)jVar13;
                print_time_stamp(time_stamp,0x30);
                printf("%s ",time_stamp);
                printf("%s : Asic_Num : %d\n","parse_local_config_file",
                ...
                if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_INTEGER)) {
                  ...
                  jVar13 = json_integer_value(pjVar6);
                  (pLVar2->Hash_Board).Voltage_Domain = (uint32_t)jVar13;
                  print_time_stamp(time_stamp,0x30);
                  printf("%s ",time_stamp);
                  ...
                  if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_INTEGER)) {
                    ...
                    jVar13 = json_integer_value(pjVar6);
                    (pLVar2->Hash_Board).Asic_Num_Per_Voltage_Domain = (uint32_t)jVar13;
                    print_time_stamp(time_stamp,0x30);
                    printf("%s ",time_stamp);
                    ...
                    if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_INTEGER)) {
                      ...
                      jVar13 = json_integer_value(pjVar6);
                      (pLVar2->Hash_Board).Inc_Freq_Delay = (uint32_t)jVar13;
                      print_time_stamp(time_stamp,0x30);
                      printf("%s ",time_stamp);
                      printf("%s : Inc_Freq_Delay : %d\n","parse_local_config_file",
                             (Local_Config_Information->Hash_Board).Inc_Freq_Delay);
                    ...
                    if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_INTEGER)) {
                      ...
                      jVar13 = json_integer_value(pjVar6);
                      (pLVar2->Hash_Board).Voltage_Adjust_Step = (uint32_t)jVar13;
                      print_time_stamp(time_stamp,0x30);
                      printf("%s ",time_stamp);
                      printf("%s : Voltage_Adjust_Step : %d\n","parse_local_config_file",
                             (Local_Config_Information->Hash_Board).Voltage_Adjust_Step);
                    ...
                    if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_INTEGER)) {
                      ...
                      jVar13 = json_integer_value(pjVar6);
                      (pLVar2->Hash_Board).Wait_Board_Temp = (uint32_t)jVar13;
                      print_time_stamp(time_stamp,0x30);
                      printf("%s ",time_stamp);
                      printf("%s : Wait_Board_Temp : %d\n","parse_local_config_file",
                             (Local_Config_Information->Hash_Board).Wait_Board_Temp);
                        ...
                        if (((pjVar7 == (json_t *)0x0) || (pjVar7->type != JSON_TRUE)) &&
                          ...
                          if (((pjVar7 == (json_t *)0x0) || (pjVar7->type != JSON_TRUE)) &&
                            ...
                            printf("%s : Can\'t read out Read_Temperature_From_Switch in %s\n",
                                   "parse_local_config_file",config_file_path);
                            snprintf(tmp1,0x100,"Can\'t read out Read_Temperature_From_Switch in %s"
                                     ,config_file_path);
                            log_to_file(tmp1,time_stamp);
                            ret = false;
                          }
                            ...
                            snprintf(tmp1,0x100,"Read_Temperature_From_Switch : %s",pcVar5);
                            log_to_file(tmp1,time_stamp);
                            ...
                            if ((pjVar7 == (json_t *)0x0) || (pjVar7->type != JSON_OBJECT)) {
                              ...
                              printf("%s : Can\'t read out Pic_Sensor in %s\n",
                                     "parse_local_config_file",config_file_path);
                              snprintf(tmp1,0x100,"Can\'t read out Pic_Sensor in %s",
                                       config_file_path);
                              log_to_file(tmp1,time_stamp);
                              ret = false;
                            }
                              ...
                              if ((pjVar8 == (json_t *)0x0) || (pjVar8->type != JSON_STRING)) {
                                ...
                                strcpy((pHVar12->Sensor_Info).Pic_Sensor.Pic_Sensor_Model,pcVar5);
                                print_time_stamp(time_stamp,0x30);
                                printf("%s ",time_stamp);
                                ...
                                if ((pjVar7 == (json_t *)0x0) || (pjVar7->type != JSON_ARRAY)) {
                                  ...
                                  if (gPic_sensor_num < 5) {
                                    ...
                                    for (index = 0; index < gPic_sensor_num; index = index + 1) {
                                      ...
                                      jVar13 = json_integer_value(Pic_Sensor_Addr_array[index]);
                                      gPic_sensor_low_3_bits_addr[index] = (uint8_t)jVar13;
                                      print_time_stamp(time_stamp,0x30);
                                      printf("%s ",time_stamp);
                                      printf("%s : gPic_sensor_low_3_bits_addr[%d] : %d\n",
                                             "parse_local_config_file",index,
                                             (uint)gPic_sensor_low_3_bits_addr[index]);
                                      snprintf(tmp1,0x100,"gPic_sensor_low_3_bits_addr[%d] : %d",
                                               index,(uint)gPic_sensor_low_3_bits_addr[index]);
                                      log_to_file(tmp1,time_stamp);
                                    }
                                    pjVar7 = json_object_get(pjVar6,"CtrlBoard_Sensor");
                                    if ((pjVar7 == (json_t *)0x0) || (pjVar7->type != JSON_OBJECT))
                                    {
                                      print_time_stamp(time_stamp,0x30);
                                      printf("%s ",time_stamp);
                                      ...
                                      pjVar8 = json_object_get(pjVar7,"CtrlBoard_Sensor_Model");
                                      if ((pjVar8 == (json_t *)0x0) || (pjVar8->type != JSON_STRING)
                                         ) {
                                        print_time_stamp(time_stamp,0x30);
                                        printf("%s ",time_stamp);
                                        ...
                                        pHVar12 = &Local_Config_Information->Hash_Board;
                                        pcVar5 = json_string_value(pjVar8);
                                        strcpy((pHVar12->Sensor_Info).CtrlBoard_Sensor.
                                        ...
                                        pjVar7 = json_object_get(pjVar7,"CtrlBoard_Sensor_Addr");
                                        if ((pjVar7 == (json_t *)0x0) ||
                                          ...
                                          gCtrlBoard_sensor_num = json_array_size(pjVar7);
                                          if (gCtrlBoard_sensor_num < 3) {
                                            ...
                                            for (index = 0; index < gCtrlBoard_sensor_num;
                                                index = index + 1) {
                                              pjVar8 = json_array_get(pjVar7,index);
                                              CtrlBoard_Sensor_Addr_array[index] = pjVar8;
                                            ...
                                            pjVar6 = json_object_get(pjVar6,"switch");
                                            if ((pjVar6 == (json_t *)0x0) ||
                                               (pjVar6->type != JSON_OBJECT)) {
                                              print_time_stamp(time_stamp,0x30);
                                              printf("%s ",time_stamp);
                                              printf("%s : Can\'t read out switch in %s\n",
                                                     "parse_local_config_file",config_file_path);
                                              snprintf(tmp1,0x100,"Can\'t read out switch in %s",
                                                       config_file_path);
                                              log_to_file(tmp1,time_stamp);
                                              ret = false;
                                            }
                                            else {
                                              pjVar7 = json_object_get(pjVar6,"type");
                                              if ((pjVar7 == (json_t *)0x0) ||
                                                 (pjVar7->type != JSON_STRING)) {
                                                print_time_stamp(time_stamp,0x30);
                                                printf("%s ",time_stamp);
                                                printf("%s : Can\'t read out Switch_Model in %s\n",
                                                       "parse_local_config_file",config_file_path);
                                                snprintf(tmp1,0x100,
                                                         "Can\'t read out Switch_Model in %s",
                                                         config_file_path);
                                                log_to_file(tmp1,time_stamp);
                                                ret = false;
                                              }
                                                ...
                                                strcpy((pHVar12->Sensor_Info).switch_sensor.
                                                       switch_model,pcVar5);
                                                print_time_stamp(time_stamp,0x30);
                                                printf("%s ",time_stamp);
                                                printf("%s : type : %s\n","parse_local_config_file",
                                                       &(Local_Config_Information->Hash_Board).
                                                        Sensor_Info.switch_sensor);
                                                snprintf(tmp1,0x100,"type : %s",
                                                         &(Local_Config_Information->Hash_Board).
                                                          Sensor_Info.switch_sensor);
                                                log_to_file(tmp1,time_stamp);
                                                pjVar7 = json_object_get(pjVar6,"switch_addr");
                                                pLVar2 = Local_Config_Information;
                                                if ((pjVar7 == (json_t *)0x0) ||
                                                   (pjVar7->type != JSON_INTEGER)) {
                                                  print_time_stamp(time_stamp,0x30);
                                                  printf("%s ",time_stamp);
                                                  printf("%s : Can\'t read out switch_addr in %s\n",
                                                         "parse_local_config_file",config_file_path)
                                                  ;
                                                  snprintf(tmp1,0x100,
                                                           "Can\'t read out switch_addr in %s",
                                                           config_file_path);
                                                  log_to_file(tmp1,time_stamp);
                                                  ret = false;
                                                }
                                                else {
                                                  jVar13 = json_integer_value(pjVar7);
                                                  (pLVar2->Hash_Board).Sensor_Info.switch_sensor.
                                                  switch_addr = (uint32_t)jVar13;
                                                  print_time_stamp(time_stamp,0x30);
                                                  printf("%s ",time_stamp);
                                                  printf("%s : switch_addr : %d\n",
                                                         "parse_local_config_file",
                                                         (Local_Config_Information->Hash_Board).
                                                         Sensor_Info.switch_sensor.switch_addr);
                                                  snprintf(tmp1,0x100,"switch_addr : %d",
                                                           (Local_Config_Information->Hash_Board).
                                                           Sensor_Info.switch_sensor.switch_addr);
                                                  log_to_file(tmp1,time_stamp);
                                                  pjVar7 = json_object_get(pjVar6,"sensor");
                                                  if ((pjVar7 == (json_t *)0x0) ||
                                                     (pjVar7->type != JSON_ARRAY)) {
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                    printf(
                                                  "%s : Can\'t read out switch sensors in %s\n",
                                                  "parse_local_config_file",config_file_path);
                                                  snprintf(tmp1,0x100,
                                                           "Can\'t read out switch sensors in %s",
                                                           config_file_path);
                                                  log_to_file(tmp1,time_stamp);
                                                  ret = false;
                                                  }
                                                    ...
                                                    (Local_Config_Information->Hash_Board).
                                                    Sensor_Info.switch_sensor.sensor_num =
                                                         (uint8_t)sVar9;
                                                    if ((int)sVar9 < 9) {
                                                      for (index = 0; index < sVar9;
                                                          index = index + 1) {
                                                        pjVar8 = json_array_get(pjVar7,index);
                                                        if ((pjVar8 == (json_t *)0x0) ||
                                                           (pjVar8->type != JSON_OBJECT)) {
                                                          print_time_stamp(time_stamp,0x30);
                                                          printf("%s ",time_stamp);
                                                          printf("%s : Can\'t find sensor[%d]\n",
                                                                 "parse_local_config_file",index);
                                                          snprintf(tmp1,0x100,
                                                                   "Can\'t find sensor[%d]",index);
                                                          log_to_file(tmp1,time_stamp);
                                                          ret = false;
                                                          goto LAB_000220ce;
                                                        }
                                                        pjVar10 = json_object_get(pjVar8,
                                                  "power_supply_ctrlboard");
                                                  if (((pjVar10 == (json_t *)0x0) ||
                                                      (pjVar10->type != JSON_TRUE)) &&
                                                     ((pjVar10 == (json_t *)0x0 ||
                                                      (pjVar10->type != JSON_FALSE)))) {
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                    printf(
                                                  "%s : Can\'t read out power_supply_ctrlboard in %s\n"
                                                  ,"parse_local_config_file",config_file_path);
                                                  snprintf(tmp1,0x100,
                                                                                                                      
                                                  "Can\'t read out power_supply_ctrlboard in %s",
                                                  config_file_path);
                                                  log_to_file(tmp1,time_stamp);
                                                  ret = false;
                                                  goto LAB_000220ce;
                                                  ...
                                                  (Local_Config_Information->Hash_Board).Sensor_Info
                                                  .switch_sensor.switch_sensor_info[index].
                                                  power_supply_ctrlboard = _Var3;
                                                  print_time_stamp(time_stamp,0x30);
                                                  printf("%s ",time_stamp);
                                                  if ((Local_Config_Information->Hash_Board).
                                                      Sensor_Info.switch_sensor.switch_sensor_info
                                                      [index].power_supply_ctrlboard == false) {
                                                    pcVar5 = "false";
                                                  }
                                                  else {
                                                    pcVar5 = "true";
                                                  }
                                                  printf("%s : power_supply_ctrlboard : %s\n",
                                                         "parse_local_config_file",pcVar5);
                                                  if ((Local_Config_Information->Hash_Board).
                                                      Sensor_Info.switch_sensor.switch_sensor_info
                                                      [index].power_supply_ctrlboard == false) {
                                                  ...
                                                  snprintf(tmp1,0x100,"power_supply_ctrlboard : %s",
                                                           pcVar5);
                                                  log_to_file(tmp1,time_stamp);
                                                  pjVar10 = json_object_get(pjVar8,"channel");
                                                  pLVar2 = Local_Config_Information;
                                                  if ((pjVar10 == (json_t *)0x0) ||
                                                     (pjVar10->type != JSON_INTEGER)) {
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                    printf("%s : Can\'t read out channel in %s\n",
                                                           "parse_local_config_file",
                                                           config_file_path);
                                                    snprintf(tmp1,0x100,
                                                             "Can\'t read out channel in %s",
                                                             config_file_path);
                                                    log_to_file(tmp1,time_stamp);
                                                    ret = false;
                                                    goto LAB_000220ce;
                                                  }
                                                  jVar13 = json_integer_value(pjVar10);
                                                  (pLVar2->Hash_Board).Sensor_Info.switch_sensor.
                                                  switch_sensor_info[index].channel =
                                                       (uint8_t)jVar13;
                                                  print_time_stamp(time_stamp,0x30);
                                                  printf("%s ",time_stamp);
                                                  printf("%s : channel : %d\n",
                                                         "parse_local_config_file",
                                                         (uint)(Local_Config_Information->Hash_Board
                                                               ).Sensor_Info.switch_sensor.
                                                               switch_sensor_info[index].channel);
                                                  snprintf(tmp1,0x100,"channel : %d",
                                                           (uint)(Local_Config_Information->
                                                                 Hash_Board).Sensor_Info.
                                                                 switch_sensor.switch_sensor_info
                                                                 [index].channel);
                                                  log_to_file(tmp1,time_stamp);
                                                  pjVar10 = json_object_get(pjVar8,"sensor_addr");
                                                  pLVar2 = Local_Config_Information;
                                                  if ((pjVar10 == (json_t *)0x0) ||
                                                     (pjVar10->type != JSON_INTEGER)) {
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                    printf(
                                                  "%s : Can\'t read out sensor_addr in %s\n",
                                                  "parse_local_config_file",config_file_path);
                                                  snprintf(tmp1,0x100,
                                                           "Can\'t read out sensor_addr in %s",
                                                           config_file_path);
                                                  log_to_file(tmp1,time_stamp);
                                                  ret = false;
                                                  goto LAB_000220ce;
                                                  ...
                                                  jVar13 = json_integer_value(pjVar10);
                                                  (pLVar2->Hash_Board).Sensor_Info.switch_sensor.
                                                  switch_sensor_info[index].sensor_addr =
                                                       (uint16_t)jVar13;
                                                  print_time_stamp(time_stamp,0x30);
                                                  printf("%s ",time_stamp);
                                                  printf("%s : sensor_addr : %d\n",
                                                         "parse_local_config_file",
                                                         (uint)(Local_Config_Information->Hash_Board
                                                               ).Sensor_Info.switch_sensor.
                                                               switch_sensor_info[index].sensor_addr
                                                        );
                                                  snprintf(tmp1,0x100,"sensor_addr : %d",
                                                           (uint)(Local_Config_Information->
                                                                 Hash_Board).Sensor_Info.
                                                                 switch_sensor.switch_sensor_info
                                                                 [index].sensor_addr);
                                                  log_to_file(tmp1,time_stamp);
                                                  pjVar8 = json_object_get(pjVar8,"bind_asic");
                                                  pLVar2 = Local_Config_Information;
                                                  if ((pjVar8 == (json_t *)0x0) ||
                                                     (pjVar8->type != JSON_INTEGER)) {
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                    printf("%s : Can\'t read out bind_asic in %s\n",
                                                           "parse_local_config_file",
                                                           config_file_path);
                                                    snprintf(tmp1,0x100,
                                                             "Can\'t read out bind_asic in %s",
                                                             config_file_path);
                                                    log_to_file(tmp1,time_stamp);
                                                    ret = false;
                                                    goto LAB_000220ce;
                                                  }
                                                  jVar13 = json_integer_value(pjVar8);
                                                  (pLVar2->Hash_Board).Sensor_Info.switch_sensor.
                                                  switch_sensor_info[index].bind_asic =
                                                       (uint16_t)jVar13;
                                                  print_time_stamp(time_stamp,0x30);
                                                  printf("%s ",time_stamp);
                                                  printf("%s : bind_asic : %d\n",
                                                         "parse_local_config_file",
                                                         (uint)(Local_Config_Information->Hash_Board
                                                               ).Sensor_Info.switch_sensor.
                                                               switch_sensor_info[index].bind_asic);
                                                  snprintf(tmp1,0x100,"bind_asic : %d",
                                                           (uint)(Local_Config_Information->
                                                                 Hash_Board).Sensor_Info.
                                                                 switch_sensor.switch_sensor_info
                                                                 [index].bind_asic);
                                                  log_to_file(tmp1,time_stamp);
                                                  pjVar8 = json_object_get(pjVar6,"type");
                                                  if ((pjVar8 == (json_t *)0x0) ||
                                                     (pjVar8->type != JSON_STRING)) {
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                    printf(
                                                  "%s : Can\'t read out switch sensor_type in %s\n",
                                                  "parse_local_config_file",config_file_path);
                                                  snprintf(tmp1,0x100,
                                                                                                                      
                                                  "Can\'t read out switch sensor_type in %s",
                                                  config_file_path);
                                                  log_to_file(tmp1,time_stamp);
                                                  ret = false;
                                                  goto LAB_000220ce;
                                                  ...
                                                  pcVar5 = json_string_value(pjVar8);
                                                  strcpy((pHVar12->Sensor_Info).switch_sensor.
                                                         switch_sensor_info[index].sensor_model,
                                                         pcVar5);
                                                  print_time_stamp(time_stamp,0x30);
                                                  printf("%s ",time_stamp);
                                                  printf("%s :  switch sensor_type : %s\n",
                                                         "parse_local_config_file",
                                                         (Local_Config_Information->Hash_Board).
                                                         Sensor_Info.switch_sensor.
                                                         switch_sensor_info[index].sensor_model);
                                                  snprintf(tmp1,0x100," switch sensor_type : %s",
                                                           (Local_Config_Information->Hash_Board).
                                                           Sensor_Info.switch_sensor.
                                                           switch_sensor_info[index].sensor_model);
                                                  log_to_file(tmp1,time_stamp);
                                                  ...
                                                  jVar13 = json_integer_value(pjVar6);
                                                  APW_power_version[index] = (uint8_t)jVar13;
                                                  print_time_stamp(time_stamp,0x30);
                                                  printf("%s ",time_stamp);
                                                  ...
                                                  jVar13 = json_integer_value(pjVar6);
                                                  (pLVar2->Test_Info).Freq_Flex = (int)jVar13;
                                                  print_time_stamp(time_stamp,0x30);
                                                  printf("%s ",time_stamp);
                                                  ...
                                                  iVar11 = strncmp(Local_Config_Information->
                                                  ...
                                                  ret = false;
                                                    ...
                                                    Invalid_Core_Number = (uint32_t)jVar13;
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                  ...
                                                  ret = false;
                                                    ...
                                                    jVar13 = json_integer_value(pjVar7);
                                                    (pLVar2->Test_Info).Test_Standard.
                                                    Least_Nonce_Per_Core = (uint32_t)jVar13;
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                  ...
                                                  ret = false;
                                                    ...
                                                    jVar13 = json_integer_value(pjVar7);
                                                    (pLVar2->Test_Info).Test_Standard.
                                                    Asic_Nonce_Rate = (uint32_t)jVar13;
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                  ...
                                                  jVar13 = json_integer_value(pjVar7);
                                                  (pLVar2->Test_Info).Test_Standard.Test_Loop[index]
                                                  .Pre_Open_Core_Voltage = (uint32_t)jVar13;
                                                  print_time_stamp(time_stamp,0x30);
                                                  printf("%s ",time_stamp);
                                                  ...
                                                  ret = false;
                                                    ...
                                                    Diode_Vdd_Mux_Sel = (uint32_t)jVar13;
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                  ...
                                                  ret = false;
                                                    ...
                                                    Start_Temp_Gap_Pic = (int32_t)jVar13;
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                  ...
                                                  ret = false;
                                                    ...
                                                    jVar13 = json_integer_value(pjVar7);
                                                    (pLVar2->Test_Info).Temperature.
                                                    Max_Wait_Cooling_Down_Time = (uint32_t)jVar13;
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                  ...
                                                  ret = false;
                                                    ...
                                                    jVar13 = json_integer_value(pjVar7);
                                                    (pLVar2->Test_Info).Temperature.
                                                    Time_For_Cooling_Hashboard = (uint32_t)jVar13;
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                  ...
                                                  ret = false;
                                                    ...
                                                    jVar13 = json_integer_value(pjVar4);
                                                  ...
                                                  ,"parse_local_config_file",gTest_loop,0x3c);
                                                  snprintf(tmp1,0x100,
                                                  ...
                                                  ret = false;
                                                    ...
                                                    printf("%s ",time_stamp);
                                                    printf(
                                                  "%s : There are %d switch sensors in local config file, but LOCAL_CONFIG_MAX_SENSOR_ATTACHED_WITCH_NUM is %d\n"
                                                  ,"parse_local_config_file",sVar9,8);
                                                  snprintf(tmp1,0x100,
                                                                                                                      
                                                  "There are %d switch sensors in local config file, but LOCAL_CONFIG_MAX_SENSOR_ATTACHED_WITCH_NUM is %d"
                                                  ,sVar9,8);
                                                  log_to_file(tmp1,time_stamp);
                                                  ret = false;
                                                  }
