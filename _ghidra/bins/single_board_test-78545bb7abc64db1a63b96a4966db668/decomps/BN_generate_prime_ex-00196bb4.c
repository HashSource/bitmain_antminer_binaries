...
LAB_00196df6:
        while ((iVar2 = BN_priv_rand(ret,bits,1), iVar2 != 0 &&
          ...
          do {
            ...
            if (uVar3 == 0xffffffff) goto LAB_00196e30;
            puVar10 = puVar10 + 1;
            *puVar10 = (ushort)uVar3;
          } while (puVar11 != (ushort *)&UNK_00231e4e);
          uVar3 = 0;
          do {
            if ((int)uVar3 < 0 || 0x1f < bits) {
              if (safe == 0) {
                ...
                while( true ) {
                  ...
                  if (puVar9 == (undefined2 *)&UNK_00231e4e) goto LAB_00197084;
                  puVar9 = puVar9 + 1;
                  uVar6 = *puVar9;
                }
              }
              ...
              while( true ) {
                ...
                if (puVar11 == (ushort *)&UNK_00231e4e) goto LAB_00197084;
                puVar11 = puVar11 + 1;
                uVar12 = (uint)*puVar11;
              }
            }
      ...
      if (pBVar1 != (BIGNUM *)0x0) {
        ...
        while (((iVar2 = BN_rand(ret,bits,0,1), iVar2 != 0 &&
          ...
          do {
            puVar11 = puVar11 + 1;
            uVar3 = BN_mod_word(ret,(uint)*puVar11);
            if (uVar3 == 0xffffffff) goto LAB_00196d50;
            puVar10 = puVar10 + 1;
            *puVar10 = (ushort)uVar3;
          } while (puVar11 != (ushort *)&UNK_00231e4e);
          uVar3 = 0;
            ...
            if ((int)uVar3 < 0 || 0x1f < bits) {
              if (safe == 0) {
                ...
                while( true ) {
                  ...
                  if (puVar9 == (undefined2 *)&UNK_00231e4e) goto LAB_00196ece;
                  puVar9 = puVar9 + 1;
                  uVar6 = *puVar9;
                }
              }
              ...
              while( true ) {
                ...
                if (puVar11 == (ushort *)&UNK_00231e4e) goto LAB_00196ece;
                puVar11 = puVar11 + 1;
                uVar12 = (uint)*puVar11;
              }
            }
...
LAB_00197084:
  ...
  if (iVar2 == 0) goto LAB_00196e30;
  iVar2 = BN_num_bits(ret);
  if (bits == iVar2) goto LAB_00196ee8;
  goto LAB_00196df6;
LAB_00196ece:
  iVar2 = BN_add_word(ret,uVar3);
  if (iVar2 == 0) {
...
LAB_00196ee8:
  ...
  if (pBVar1 == (BIGNUM *)0x0) goto LAB_00196d66;
  if (safe == 0) {
    ...
    while( true ) {
      ...
      if (pBVar1 == (BIGNUM *)0x0) goto LAB_00196d66;
      if (iVar2 == local_5c) goto LAB_00196f70;
    }
  }
  b = b + 1;
  goto LAB_00196c9e;
