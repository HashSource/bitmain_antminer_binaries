...
LAB_000f790a:
    ...
    if (-1 < *(int *)(*(int *)(param_1->type + 100) + 0x30) << 0x1c) goto LAB_000f7934;
...
LAB_000f7920:
    ...
    do {
      ...
      if (p_Var7 != (_func_3297 *)0x0) goto LAB_000f7934;
...
LAB_000f79f6:
    ...
    p_Var7 = (_func_3297 *)((ulonglong)uVar18 >> 0x20);
    if ((int)uVar18 == 0) goto LAB_000f790a;
LAB_000f79e0:
    iVar3 = param_1->mac_flags + 0xac;
    if (*(int *)(*(int *)(param_1->type + 100) + 0x30) << 0x1c < 0) goto LAB_000f7920;
    if (param_1[2].tlsext_debug_cb == (_func_3297 *)0x0) goto LAB_000f79f6;
  }
LAB_000f7934:
...
LAB_000f7b5e:
                    if (iVar8 < iVar6) goto LAB_000f7b62;
                    iVar5 = *(int *)(iVar5 + 0x28);
                    if (iVar5 == 0x100) {
                      iVar5 = 0xff00;
                    }
