...
/* WARNING: Removing unreachable block (ram,0x00099504) */
/* WARNING: Removing unreachable block (ram,0x0009950e) */
/* WARNING: Removing unreachable block (ram,0x00099510) */
/* WARNING: Removing unreachable block (ram,0x00099512) */
/* WARNING: Removing unreachable block (ram,0x00099518) */
/* WARNING: Removing unreachable block (ram,0x000990e2) */
...
LAB_00099240:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_0009999c;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_0009999c;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_00099240;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_0009999c;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_0009999c;
              op = pBVar10;
