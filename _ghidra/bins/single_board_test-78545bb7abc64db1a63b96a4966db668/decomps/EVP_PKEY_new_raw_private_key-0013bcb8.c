...
EVP_PKEY *
EVP_PKEY_new_raw_private_key(int param_1,ENGINE *param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (pkey != (EVP_PKEY *)0x0) {
    ...
    if (*(code **)(pEVar1 + 0x80) == (code *)0x0) {
      ERR_put_error(6,0xbf,0x96,"crypto/evp/p_lib.c",0xf2);
    }
    else {
      iVar3 = (**(code **)(pEVar1 + 0x80))(pkey,param_3,param_4);
      if (iVar3 != 0) {
        return pkey;
      }
      ERR_put_error(6,0xbf,0xb4,"crypto/evp/p_lib.c",0xf7);
    }
  }
LAB_0013bd82:
  EVP_PKEY_free(pkey);
