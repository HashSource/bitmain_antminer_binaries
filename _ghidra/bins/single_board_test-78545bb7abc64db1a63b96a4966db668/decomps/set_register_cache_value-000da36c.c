  ...
  if (level == hashboard_cache_level) {
    ...
    do {
      if (hashboard_register_value[uVar1][iVar2].register_addr == register_address) {
        hashboard_register_value[uVar1][iVar2].register_value = cache_value;
        if (iVar2 == 0x7f) {
          iVar3 = -4;
          goto LAB_000da3d0;
        }
...
LAB_000da3d0:
      ...
      printf("set_register_cache_value failed, ret = %d",iVar3);
      return iVar3;
    }
    iVar2 = 0;
    do {
      if (hashboard_asic_register_value[uVar1][which_asic_address][iVar2].register_addr ==
          register_address) {
        hashboard_asic_register_value[uVar1][which_asic_address][iVar2].register_value = cache_value
        ;
        if (iVar2 == 0x7f) {
          iVar3 = -5;
          goto LAB_000da3d0;
