...

{
  ...
  if (*(int *)(param_1 + 0x44c) == 1) {
    ...
    if (pcVar9 != (code *)0x0) goto LAB_000f24e0;
    if (local_1b0 == (SSL_SESSION *)0x0) goto LAB_000f2534;
    goto LAB_000f2572;
  }
  pcVar9 = *(code **)(param_1 + 0x4cc);
  uVar3 = 0;
...
LAB_000f24e0:
    ...
    if (iVar1 != 0) {
      if (local_1b0 == (SSL_SESSION *)0x0) goto LAB_000f2534;
      if (local_1b0->ssl_version == 0x304) goto LAB_000f2572;
    }
...
LAB_000f262a:
        ...
        if (puVar4 < puVar6) goto LAB_000f262a;
