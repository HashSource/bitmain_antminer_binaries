...
LAB_00150296:
  while( true ) {
    ...
    if (iVar1 == 0) goto LAB_00150312;
    iVar1 = strcmp(param_4,"ANY PRIVATE KEY");
    if (iVar1 != 0) break;
    iVar1 = strcmp(str,"ENCRYPTED PRIVATE KEY");
    if ((iVar1 == 0) || (iVar1 = strcmp(str,"PRIVATE KEY"), iVar1 == 0)) goto LAB_00150312;
...
joined_r0x0015044e:
  ...
  if ((((iVar1 == 0) && (iVar1 = strcmp(param_4,"DH PARAMETERS"), iVar1 == 0)) ||
     ...
     ((iVar2 = strcmp(str,"NEW CERTIFICATE REQUEST"), iVar2 == 0 &&
      (iVar2 = strcmp(param_4,"CERTIFICATE REQUEST"), iVar2 == 0)))) goto LAB_00150312;
  iVar2 = strcmp(str,"CERTIFICATE");
  pcVar7 = str;
  if (iVar2 == 0) {
    iVar1 = strcmp(param_4,"TRUSTED CERTIFICATE");
    if ((iVar1 == 0) || (iVar1 = strcmp(param_4,"PKCS7"), iVar1 == 0)) goto LAB_00150312;
    if (*param_4 != 'C') goto LAB_00150296;
    cVar9 = param_4[1];
    if (((cVar9 == 'M') && (param_4[2] == 'S')) && (param_4[3] == '\0')) goto LAB_00150312;
    iVar1 = strcmp(str,"PKCS7");
    if (iVar1 != 0) goto LAB_00150296;
  }
  else {
    if (((iVar1 == 0) && (iVar1 = strcmp(param_4,"TRUSTED CERTIFICATE"), iVar1 == 0)) ||
       ((iVar1 = strcmp(str,"PKCS #7 SIGNED DATA"), iVar1 == 0 &&
        (iVar1 = strcmp(param_4,"PKCS7"), iVar1 == 0)))) goto LAB_00150312;
    iVar1 = strcmp(str,"PKCS7");
    if ((iVar1 != 0) || (*param_4 != 'C')) goto LAB_00150296;
    cVar9 = param_4[1];
  }
  if (((cVar9 != 'M') || (param_4[2] != 'S')) || (param_4[3] != '\0')) goto LAB_00150296;
LAB_00150312:
