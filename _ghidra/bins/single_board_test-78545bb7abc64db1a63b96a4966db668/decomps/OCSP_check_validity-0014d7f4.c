...

{
  ...
  if (iVar1 == 0) {
    ERR_put_error(0x27,0x73,0x7b,"crypto/ocsp/ocsp_cl.c",0x15a);
    uVar2 = 0;
  }
  else {
    ...
    if (iVar1 >= 1) {
      ERR_put_error(0x27,0x73,0x7e,"crypto/ocsp/ocsp_cl.c",0x15f);
    }
    uVar2 = (uint)(iVar1 < 1);
    if (-1 < maxsec) {
      ...
      if (iVar1 < 0) {
        uVar2 = 0;
        ERR_put_error(0x27,0x73,0x7f,"crypto/ocsp/ocsp_cl.c",0x16a);
      }
    }
  }
  if (nextupd != (ASN1_GENERALIZEDTIME *)0x0) {
    ...
    if (iVar1 == 0) {
      ERR_put_error(0x27,0x73,0x7a,"crypto/ocsp/ocsp_cl.c",0x175);
      ...
      if (iVar1 < 0) {
        uVar2 = 0;
        ERR_put_error(0x27,0x73,0x7d,"crypto/ocsp/ocsp_cl.c",0x17a);
      }
      iVar1 = ASN1_STRING_cmp(nextupd,thisupd);
    }
    if (iVar1 < 0) {
      ERR_put_error(0x27,0x73,0x7c,"crypto/ocsp/ocsp_cl.c",0x182);
      return 0;
    }
  }
  return uVar2;
