...

{
  ...
  if (iVar2 == 0) {
    *(undefined4 *)(param_1 + 0x58) = 0x195ae9;
  }
  else {
    pBVar1 = BN_get0_nist_prime_224();
    iVar2 = BN_ucmp(pBVar1,param_2);
    if (iVar2 == 0) {
      *(undefined4 *)(param_1 + 0x58) = 0x195cf1;
    }
    else {
      pBVar1 = BN_get0_nist_prime_256();
      iVar2 = BN_ucmp(pBVar1,param_2);
      if (iVar2 == 0) {
        *(undefined4 *)(param_1 + 0x58) = 0x195ea1;
      }
      else {
        pBVar1 = BN_get0_nist_prime_384();
        iVar2 = BN_ucmp(pBVar1,param_2);
        if (iVar2 == 0) {
          *(undefined4 *)(param_1 + 0x58) = 0x196209;
        }
        else {
          ...
          *(undefined4 *)(param_1 + 0x58) = 0x1965f1;
        }
      }
    }
  }
