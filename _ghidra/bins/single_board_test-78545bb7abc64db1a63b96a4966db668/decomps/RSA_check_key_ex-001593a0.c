...
LAB_00159572:
    ...
    if (iVar1 <= iVar8 + 1) goto LAB_00159572;
  }
  else {
    iVar8 = 0;
  }
          ...
          if (iVar8 != 0) {
            do {
              ...
              if (((iVar3 == 0) || (iVar3 = BN_mul(r_02,r_02,r_01,ctx), iVar3 == 0)) ||
                 (iVar3 = BN_gcd(r_03,r_03,r_01,ctx), iVar3 == 0)) goto LAB_0015954c;
            } while (iVar8 != iVar1);
          }
...
LAB_001597e6:
              ...
              while (iVar3 = iVar1 + 1, iVar8 != iVar1) {
                ...
                if (pBVar4 == (BIGNUM *)0x0) goto LAB_0015954c;
