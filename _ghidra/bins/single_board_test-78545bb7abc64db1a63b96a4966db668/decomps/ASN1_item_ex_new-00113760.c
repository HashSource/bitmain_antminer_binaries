...
LAB_00113898:
    ...
    *pval = pAVar2;
    if (pAVar2 == (ASN1_VALUE *)0x0) goto LAB_001137f2;
...
switchD_00113778_caseD_4:
    ...
    break;
  case '\x05':
switchD_00113778_caseD_5:
    iVar1 = asn1_primitive_new(pval,it,0);
  }
joined_r0x0011381e:
  if (iVar1 != 0) {
switchD_00113778_caseD_3:
    return 1;
  }
LAB_001137f2:
...
LAB_00113974:
    ...
    if ((uVar4 & 6) == 0) {
      ...
      if (pAVar2 != (ASN1_VALUE *)0x0) goto LAB_00113974;
      ERR_put_error(0xd,0x85,0x41,"crypto/asn1/tasn_new.c",0xe7);
    }
    goto LAB_001137f2;
  }
  iVar1 = asn1_primitive_new(pval,it);
  goto joined_r0x0011381e;
}
