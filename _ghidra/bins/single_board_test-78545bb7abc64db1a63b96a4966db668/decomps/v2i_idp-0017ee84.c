          ...
          if (psVar3 != (stack_st_CONF_VALUE *)0x0) {
            ...
            if (iVar2 == 0) {
              ...
              if (0 < iVar2) {
                ...
                if (*(GENERAL_NAMES **)(iVar2 + 8) == (GENERAL_NAMES *)0x0) goto LAB_0017ef8c;
...
LAB_0017ef26:
    ...
    if (psVar3 == (stack_st_CONF_VALUE *)0x0) {
      ...
      if (*line == '@') {
        ...
        OPENSSL_sk_pop_free(psVar3,0x1830d1);
      }
...
LAB_0017f03c:
    OPENSSL_sk_pop_free(pGVar4,0x17f325);
    OPENSSL_sk_pop_free(pGVar7,0x177061);
  }
LAB_0017f054:
