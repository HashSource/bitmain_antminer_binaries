...

{
  ...
  usleep(10000);
  uVar6 = g_bitmain_pic_state[uVar2].pic_fd;
    ...
    if (size == uVar6) {
      ...
      if (((size == uVar3) && (uVar5 == 0x3c)) && (uVar2 == 1)) {
        ...
        snprintf(tmp42,0x800,
                 ...
                 ,"_pic_read_iic",uVar3,uVar5,uVar2);
        _applog(0,tmp42,false);
      }
      goto LAB_000d4028;
    }
