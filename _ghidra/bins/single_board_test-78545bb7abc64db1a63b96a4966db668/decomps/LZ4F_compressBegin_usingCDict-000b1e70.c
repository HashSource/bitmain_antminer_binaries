...

{
  ...
  prefNull.frameInfo.blockSizeID = LZ4F_default;
  prefNull.frameInfo.blockMode = LZ4F_blockLinked;
  prefNull.frameInfo.contentChecksumFlag = LZ4F_noContentChecksum;
  prefNull.frameInfo.frameType = LZ4F_frame;
  prefNull.frameInfo.contentSize._0_4_ = 0;
  prefNull.frameInfo.contentSize._4_4_ = 0;
  prefNull.frameInfo.dictID = 0;
  prefNull.frameInfo.blockChecksumFlag = LZ4F_noBlockChecksum;
  prefNull.compressionLevel = 0;
  prefNull.autoFlush = 0;
  prefNull.favorDecSpeed = 0;
  prefNull.reserved[0] = 0;
  prefNull.reserved[1] = 0;
  prefNull.reserved[2] = 0;
  if (dstCapacity < 0x13) {
