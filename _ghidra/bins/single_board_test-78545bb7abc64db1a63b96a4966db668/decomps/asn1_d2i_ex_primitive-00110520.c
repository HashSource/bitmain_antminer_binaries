...
LAB_0011055a:
    if (param_5 == 0xffffffff) goto LAB_0011063e;
  }
  pbVar7 = (byte *)*param_2;
  local_4c = pbVar7;
  local_3c = pbVar7;
  if (param_8 == (byte *)0x0) {
    ...
    if (-1 < (int)(uVar1 << 0x18)) goto LAB_00110590;
...
LAB_0011087c:
  ...
  case 3:
    ...
    goto joined_r0x00110856;
  default:
    if (uVar1 == 0x1e) {
      if (-1 < (int)omax << 0x1f) goto LAB_001108f8;
