...

{
  ...
  *(undefined4 *)(param_1 + 0xf8c) = 0;
  if ((*(int *)(param_1 + 0x1c) == 0) &&
    ...
    iVar8 = iVar9;
    local_2c[0] = psVar3;
    if ((*(uint *)(param_1 + 0x4ec) & 0x400000) != 0) goto LAB_00105a7a;
LAB_00105bc0:
    iVar8 = iVar9;
    if (uVar6 != 0) goto LAB_00105a7a;
    ...
    iVar5 = *(int *)(param_1 + 0x7c);
    iVar8 = iVar9;
    if ((*(uint *)(param_1 + 0x4ec) & 0x400000) == 0) goto LAB_00105bc0;
LAB_00105a7a:
...
LAB_00105aa4:
    do {
      ...
      do {
        if (*(short *)(puVar4 + 4) == *psVar3) goto LAB_00105abe;
        puVar4 = puVar4 + 0x20;
...
LAB_00105afc:
      ...
      if (*local_38 != *psVar3) {
        ...
        do {
          iVar1 = iVar1 + 1;
          if (iVar9 == iVar1) goto LAB_00105afc;
          psVar2 = psVar2 + 1;
        } while (*psVar2 != *psVar3);
      }
      iVar5 = iVar5 + 1;
...
LAB_00105c32:
      do {
        puVar4 = &sigalg_lookup_tbl;
        do {
          if (*(short *)(puVar4 + 4) == *local_40) goto LAB_00105c46;
          puVar4 = puVar4 + 0x20;
        } while (puVar4 != legacy_rsa_sigalg);
        puVar4 = (undefined1 *)0x0;
LAB_00105c46:
...
LAB_00105c84:
        ...
        if (*local_38 != *local_40) {
          ...
          do {
            iVar1 = iVar1 + 1;
            if (iVar9 == iVar1) goto LAB_00105c84;
            psVar3 = psVar3 + 1;
          } while (*psVar3 != *local_40);
        }
        local_44 = local_44 + 1;
        if (local_34 == (undefined4 *)0x0) goto LAB_00105c84;
        iVar5 = iVar5 + 1;
        *local_34 = puVar4;
        local_34 = local_34 + 1;
        local_40 = local_40 + 1;
...
LAB_00105b6c:
      if (*(int *)((int)__s + iVar9 * 4) != 0) goto LAB_00105b40;
      ...
      if (((iVar1 == 0x10000 || iVar1 == 0x303) || iVar5 < 0 != bVar10) ||
         (*(int *)(puVar7[iVar8] + 0x10) != 6)) goto LAB_00105b6c;
LAB_00105b40:
      if (uVar6 <= iVar8 + 1U) {
        return 1;
      }
