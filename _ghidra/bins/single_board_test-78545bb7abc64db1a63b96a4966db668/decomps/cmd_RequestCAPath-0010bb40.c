...
void cmd_RequestCAPath(int param_1,char *param_2)

{
  stack_st_X509_NAME *stackCAs;
  
  if (*(stack_st_X509_NAME **)(param_1 + 0x54) != (stack_st_X509_NAME *)0x0) {
    SSL_add_dir_cert_subjects_to_stack(*(stack_st_X509_NAME **)(param_1 + 0x54),param_2);
    return;
  }
  ...
  *(stack_st_X509_NAME **)(param_1 + 0x54) = stackCAs;
  ...
  SSL_add_dir_cert_subjects_to_stack(stackCAs,param_2);
  return;
}
