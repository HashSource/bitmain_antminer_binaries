...

{
  ...
  prefsNull.frameInfo.blockSizeID = LZ4F_default;
  prefsNull.frameInfo.blockMode = LZ4F_blockLinked;
  prefsNull.frameInfo.frameType = LZ4F_frame;
  prefsNull.frameInfo.contentSize._0_4_ = 0;
  prefsNull.frameInfo.contentSize._4_4_ = 0;
  prefsNull.frameInfo.dictID = 0;
  prefsNull.compressionLevel = 0;
  prefsNull.autoFlush = 0;
  prefsNull.favorDecSpeed = 0;
  prefsNull.reserved[0] = 0;
  prefsNull.reserved[1] = 0;
  prefsNull.reserved[2] = 0;
