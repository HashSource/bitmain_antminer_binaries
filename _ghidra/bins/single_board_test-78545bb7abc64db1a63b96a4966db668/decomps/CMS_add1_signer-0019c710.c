...
LAB_0019c752:
      if (piVar10 != (int *)0x0) {
        ...
        if (pAVar2 == (ASN1_VALUE *)0x0) goto LAB_0019c8f0;
        ...
        *(undefined4 *)(pAVar2 + 0x28) = 0;
        ...
        if (iVar1 == 0) goto LAB_0019c8a0;
        if (md == (EVP_MD *)0x0) {
          iVar1 = EVP_PKEY_get_default_digest_nid(pk,(int *)local_2c);
          if (iVar1 < 1) goto LAB_0019c8a0;
...
LAB_0019c832:
          ...
          if (iVar1 == 0) {
            OPENSSL_sk_pop_free(local_2c[0],(undefined *)0x11429d);
          }
          else {
            iVar1 = CMS_add_smimecap((CMS_SignerInfo *)pAVar2,(stack_st_X509_ALGOR *)local_2c[0]);
            OPENSSL_sk_pop_free(local_2c[0],(undefined *)0x11429d);
            if (iVar1 != 0) goto LAB_0019c832;
          }
        }
        else {
LAB_0019c838:
