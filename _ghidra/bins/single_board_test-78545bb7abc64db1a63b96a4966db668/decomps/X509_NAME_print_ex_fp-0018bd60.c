...
LAB_0018be90:
    ...
    if (indent < 0) {
      ...
      iVar1 = 0;
      do {
        sVar4 = fwrite(&DAT_002475a8,1,1,fp);
        if (sVar4 != 1) goto LAB_0018be90;
        iVar1 = iVar1 + 1;
      } while (indent != iVar1);
    }
    uVar7 = flags & 0xf0000;
    if (uVar7 == 0x20000) {
      ...
      if (uVar7 != 0x10000) goto LAB_0018be90;
      local_98 = 1;
      iVar1 = 0;
      local_80 = 1;
      local_8c = 1;
      local_94 = 1;
      local_7c = &DAT_00230188;
      local_9c = ",";
    }
      ...
      if (uVar7 != 0x40000) goto LAB_0018be90;
      local_98 = 1;
      local_94 = 1;
      local_80 = 3;
      local_8c = 3;
    ...
    if ((int)(flags << 8) < 0) {
      local_a8 = 3;
      local_b0 = 3;
      local_a4 = &DAT_00230190;
    }
    else {
      local_a4 = &DAT_0021b6c0;
      local_a8 = 1;
      local_b0 = 1;
    }
        ...
        if (local_cc != -1) {
          ...
          if (iVar3 == local_cc) {
            ...
            if (fp != (FILE *)0x0) {
              ...
              if (sVar4 != local_98) goto LAB_0018be90;
              iVar3 = 0;
              if (iVar1 != 0) {
                do {
                  sVar4 = fwrite(&DAT_002475a8,1,1,fp);
...
LAB_0018c004:
                ...
                indent = indent + iVar8;
                if (fp != (FILE *)0x0) goto LAB_0018bf58;
              }
            }
            else {
              sVar4 = fwrite(buf,1,local_b8,fp);
              if (sVar4 != local_b8) goto LAB_0018be90;
              if (((int)local_b8 < iVar8) && ((flags & 0x2000000) != 0)) goto LAB_0018c004;
LAB_0018bf58:
              sVar4 = fwrite(local_a4,1,local_a8,fp);
              if (local_a8 != sVar4) goto LAB_0018be90;
            }
          }
          else {
            if (uVar7 == 0) {
