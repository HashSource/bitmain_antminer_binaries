...
LAB_0014a944:
  ...
  uVar8 = param_3;
  if (param_3 < 0x10) {
    if (param_3 == 0) goto LAB_0014a944;
    (*param_7)(param_5,param_5,param_4);
    iVar3 = param_3 - 1;
  }
  else {
  ...
  if ((((uint)pbVar11 | (uint)pbVar7 | (uint)pbVar9) & 3) == 0 &&
    ...
    *(uint *)(param_2 + uVar6) = *(uint *)(param_1 + uVar6) ^ *(uint *)(param_5 + uVar6);
    ...
    iVar12 = uVar6 + 5;
    param_2[iVar2] = param_1[iVar2] ^ *(byte *)(param_5 + iVar2);
    if (iVar3 == 4) goto LAB_0014aa76;
    iVar2 = uVar6 + 6;
    param_2[iVar12] = param_1[iVar12] ^ *(byte *)(param_5 + iVar12);
    if (iVar3 == 5) goto LAB_0014aa76;
    iVar12 = uVar6 + 7;
    param_2[iVar2] = param_1[iVar2] ^ *(byte *)(param_5 + iVar2);
    if (iVar3 == 6) goto LAB_0014aa76;
    iVar2 = uVar6 + 8;
    param_2[iVar12] = param_1[iVar12] ^ *(byte *)(param_5 + iVar12);
    if (iVar3 == 7) goto LAB_0014aa76;
    iVar12 = uVar6 + 9;
    param_2[iVar2] = param_1[iVar2] ^ *(byte *)(param_5 + iVar2);
    if (iVar3 == 8) goto LAB_0014aa76;
    iVar2 = uVar6 + 10;
    param_2[iVar12] = param_1[iVar12] ^ *(byte *)(param_5 + iVar12);
    if (iVar3 == 9) goto LAB_0014aa76;
    iVar12 = uVar6 + 0xb;
    param_2[iVar2] = param_1[iVar2] ^ *(byte *)(param_5 + iVar2);
    if (iVar3 == 10) goto LAB_0014aa76;
    iVar2 = uVar6 + 0xc;
    param_2[iVar12] = param_1[iVar12] ^ *(byte *)(param_5 + iVar12);
    if (iVar3 == 0xb) goto LAB_0014aa76;
    iVar12 = uVar6 + 0xd;
    param_2[iVar2] = param_1[iVar2] ^ *(byte *)(param_5 + iVar2);
    if (iVar3 == 0xc) goto LAB_0014aa76;
    iVar2 = uVar6 + 0xe;
    param_2[iVar12] = param_1[iVar12] ^ *(byte *)(param_5 + iVar12);
    if (iVar3 == 0xd) goto LAB_0014aa76;
  }
