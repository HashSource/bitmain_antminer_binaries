...
LAB_000f9486:
  ...
  iVar3 = param_1[0x1f];
  if (uVar5 < 0x20) goto LAB_000f9486;
LAB_000f94d8:
  bVar16 = false;
...
LAB_000f9524:
    ...
    __s1 = pbVar15 + 1;
    uVar9 = (uint)*pbVar15;
    if (iVar3 - 1U < uVar9) goto LAB_000f9524;
...
LAB_000f9708:
              ...
              if ((uVar5 != 0) || (*piVar13 == 0x10000 || *piVar13 < 0x304)) goto LAB_000f95ae;
              uVar10 = 0x200;
              uVar4 = 0x200;
            }
...
LAB_000f98a4:
                if ((uVar9 != 0) && (__n = piVar13[0x52], uVar9 == __n)) goto LAB_000f98b2;
                goto LAB_000f9900;
              }
              piVar13 = (int *)param_1[0x11d];
              if (piVar13[0x74] == 0) goto LAB_000f98a4;
              local_34 = (void *)0x100;
              local_38 = 0;
              ...
              piVar8[0x6e] = iVar3;
              if ((uVar9 == 0) || (__n = piVar13[0x52], __n != uVar9)) goto LAB_000f9836;
LAB_000f98b2:
              iVar3 = memcmp(__s1,piVar13 + 0x53,__n);
              if (iVar3 != 0) goto LAB_000f9836;
              param_1[0x23] = 1;
LAB_000f983e:
...
LAB_000f985e:
              ...
              if (iVar3 == 0) goto LAB_000f94be;
              piVar13 = (int *)param_1[0x11d];
LAB_000f9836:
              if (param_1[0x23] != 0) goto LAB_000f983e;
LAB_000f9900:
              if (piVar13[0x52] != 0) {
          ...
          if (uVar7 <= uVar5 - 5) {
            ...
            if (uVar7 == uVar5 - 5) {
              *param_2 = (int)(pbVar12 + uVar7);
              ...
              local_30 = pbVar12;
              local_2c = uVar7;
              if (!bVar16) goto LAB_000f957a;
              piVar13 = (int *)param_1[1];
              uVar5 = *(uint *)(piVar13[0x19] + 0x30) & 8;
              if (uVar5 == 0) goto LAB_000f96ee;
              goto LAB_000f9708;
            }
          }
        }
