...

{
  ...
  if (param_4 != 0) {
    ...
    do {
      ...
      do {
        if (*(short *)(puVar7 + 4) == *param_3) goto LAB_001056c6;
        puVar7 = puVar7 + 0x20;
                  ...
                  if ((*(int *)(param_1->mac_flags + 0x2a8) < 0x304) &&
                    ...
                    if (iVar1 < 1) {
                      ...
                      do {
                        ...
                        if ((iVar4 == 0) && (*(int *)(iVar3 + 0x10) << 0x1b < 0)) goto LAB_0010577e;
                      } while (iVar1 != iVar6);
                    }
                  }
                  goto LAB_00105760;
...
LAB_0010577e:
          ...
          if ((iVar1 == 0x10000 || iVar1 < 0x304) || (*(int *)(puVar7 + 0x10) != 0x74)) {
            ...
            if (*(int *)(puVar7 + 0x10) != 0x74) {
              ...
              if (bVar11 && (uVar5 != 10 && uVar5 != 1)) goto LAB_0010571e;
            }
          }
        }
      }
