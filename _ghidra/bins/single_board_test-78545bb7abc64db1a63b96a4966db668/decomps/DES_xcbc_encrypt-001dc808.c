...
LAB_001dcaac:
  ...
  if (iVar5 < 1) {
    uVar18 = uVar16;
    uVar21 = uVar17;
    if (iVar5 == -8) goto switchD_001dca22_default;
  }
  else {
    puVar6 = output + 8;
    puVar14 = (uint *)input;
  ...
  case -7:
    goto LAB_001dca6c;
  case -6:
    goto switchD_001dca22_caseD_fffffffa;
  case -5:
    goto LAB_001dca58;
  case -4:
    goto switchD_001dca22_caseD_fffffffc;
  case -3:
    break;
  default:
    goto switchD_001dca22_default;
  }
  puVar6 = local_44 + -1;
  local_44[-1] = (uchar)uVar18;
switchD_001dca22_caseD_fffffffc:
  local_44 = puVar6 + -1;
  puVar6[-1] = (uchar)(uVar21 >> 0x18);
LAB_001dca58:
  puVar6 = local_44 + -1;
  local_44[-1] = (uchar)(uVar21 >> 0x10);
switchD_001dca22_caseD_fffffffa:
  local_44 = puVar6 + -1;
  puVar6[-1] = (uchar)(uVar21 >> 8);
LAB_001dca6c:
  local_44[-1] = (uchar)uVar21;
switchD_001dca22_default:
  (*ivec)[0] = (uchar)uVar17;
  (*ivec)[4] = (uchar)uVar16;
