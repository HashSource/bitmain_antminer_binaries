...

{
  ...
  local_28[2] = (void *)0x0;
  local_28[3] = (void *)0x0;
  if ((added == 0) && (added = OPENSSL_LH_new(0x14c1c5,0x14c125), added == 0)) {
    return 0;
  }
  a = OBJ_dup(obj);
  if (a == (ASN1_OBJECT *)0x0) goto LAB_0014c3bc;
  ...
  if (local_28[3] != (void *)0x0) {
    if ((a->length != 0) && (obj->data != (uchar *)0x0)) {
      ...
      if (local_28[0] == (void *)0x0) goto LAB_0014c3aa;
    }
    if (a->sn != (char *)0x0) {
      local_28[1] = CRYPTO_malloc(8,"crypto/objects/obj_dat.c",0xbf);
      if (local_28[1] == (void *)0x0) goto LAB_0014c3aa;
    }
    if (a->ln == (char **)0x0) {
LAB_0014c36c:
      iVar3 = 0;
    ...
    if (local_28[2] != (void *)0x0) goto LAB_0014c36c;
  }
LAB_0014c3aa:
