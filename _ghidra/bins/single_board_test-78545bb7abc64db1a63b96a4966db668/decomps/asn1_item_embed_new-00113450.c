...

{
  ...
  if (pvVar7 == (void *)0x0) {
    ...
    case '\0':
      goto switchD_00113472_caseD_0;
    case '\x01':
    case '\x06':
      pcVar8 = (code *)0x0;
      if (param_3 == (ASN1_VALUE *)0x0) goto LAB_0011356e;
LAB_0011369c:
      memset(*(ASN1_VALUE **)param_1,0,param_2->size);
      iVar1 = asn1_do_lock((ASN1_VALUE **)param_1,0,param_2);
      if (iVar1 < 0) goto LAB_001134bc;
LAB_00113592:
...
LAB_001136dc:
    ...
    case '\x02':
      pcVar8 = (code *)0x0;
      if (param_3 == (ASN1_VALUE *)0x0) goto LAB_00113500;
LAB_00113690:
      memset(*(ASN1_VALUE **)param_1,0,param_2->size);
LAB_00113512:
...
LAB_0011353a:
  ...
  if (pcVar8 == (code *)0x0) {
    ...
    case '\x01':
    case '\x06':
      goto switchD_00113658_caseD_1;
    case '\x02':
      goto switchD_00113658_caseD_2;
    default:
      goto switchD_00113472_caseD_3;
    case '\x04':
      goto switchD_00113472_caseD_4;
    case '\x05':
      goto switchD_00113472_caseD_5;
    }
  }
...
LAB_0011368c:
      ...
      if ((uVar4 & 6) == 0) {
        ...
        if (pAVar2 != (ASN1_VALUE *)0x0) goto LAB_0011368c;
        ERR_put_error(0xd,0x85,0x41,"crypto/asn1/tasn_new.c",0xe7);
      }
      goto LAB_001134bc;
    }
  case '\x05':
switchD_00113472_caseD_5:
    iVar1 = asn1_primitive_new(param_1,param_2,param_3);
    break;
  case '\x01':
  case '\x06':
    iVar1 = (*pcVar8)(0,param_1,param_2);
    if (iVar1 == 0) goto LAB_0011353a;
    if (iVar1 == 2) {
      return 1;
    }
switchD_00113658_caseD_1:
    if (param_3 != (ASN1_VALUE *)0x0) goto LAB_0011369c;
LAB_0011356e:
    pAVar2 = (ASN1_VALUE *)CRYPTO_zalloc(param_2->size,"crypto/asn1/tasn_new.c",0x7a);
    *(ASN1_VALUE **)param_1 = pAVar2;
    if (pAVar2 == (ASN1_VALUE *)0x0) goto LAB_001134bc;
...
switchD_00113658_caseD_2:
    if (param_3 != (ASN1_VALUE *)0x0) goto LAB_00113690;
LAB_00113500:
