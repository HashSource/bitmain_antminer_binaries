...

{
  ...
  uVar4 = data[1] ^ uVar1 << 4;
  uVar1 = *data ^ uVar1;
  uVar3 = (uVar4 ^ uVar1 >> 0x10) & 0xffff;
  uVar1 = uVar1 ^ uVar3 << 0x10;
  uVar4 = uVar4 ^ uVar3;
  uVar3 = (uVar1 ^ uVar4 >> 2) & 0x33333333;
  uVar4 = uVar4 ^ uVar3 << 2;
  uVar1 = uVar1 ^ uVar3;
  uVar3 = (uVar4 ^ uVar1 >> 8) & 0xff00ff;
  uVar1 = uVar1 ^ uVar3 << 8;
  uVar4 = uVar4 ^ uVar3;
  uVar3 = (uVar1 ^ uVar4 >> 1) & 0x55555555;
  *data = uVar1 ^ uVar3;
  data[1] = uVar4 ^ uVar3 << 1;
  ...
  uVar4 = uVar4 ^ uVar3;
  uVar3 = (uVar2 ^ uVar4 >> 4) & 0xf0f0f0f;
  *data = uVar2 ^ uVar3;
  data[1] = uVar4 ^ uVar3 << 4;
  return;
}
