...

{
  ...
  if (puVar4 == (undefined4 *)0x0) {
    if ((uVar8 & 0x10) != 0) {
      ...
      ERR_add_error_data(2,&DAT_0020fd8c,param_2);
    }
    return 0xfffffffe;
  }
  if (*(short *)((int)puVar4 + 0xe) != 4) {
    ...
    if ((int)(*param_1 << 0x1b) < 0) {
      ...
      ERR_add_error_data(4,&DAT_0020fd8c,param_2,", value=",param_3);
      return 0;
    }
    return 0;
  }
  uVar8 = (int)(puVar4 + -0x9a1df) >> 4;
  if (0x15 < uVar8) {
    return 0;
  }
  puVar5 = (uint *)param_1[5];
  uVar7 = *(uint *)(&DAT_0020fca4 + uVar8 * 8);
  if (puVar5 == (uint *)0x0) {
    return 1;
  }
  if ((int)(uVar7 << 0x1f) < 0) {
