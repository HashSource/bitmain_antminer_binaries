...

{
  ...
  if (0x73 < cmd - 0x10U) {
switchD_000eaf46_caseD_11:
                    /* WARNING: Could not recover jumptable at 0x000eb23c. Too many branches */
  ...
  case 0x10:
    *(void **)(ctx->sid_ctx + 4) = parg;
    return 1;
  default:
    goto switchD_000eaf46_caseD_11;
  case 0x14:
...
LAB_000eb088:
  ...
  case 0x7b:
    ...
    if (larg == 0x100) {
      if ((p_Var9 == (_func_3237 *)0x100) || ((int)p_Var9 >> 8 == 0xfe)) goto LAB_000eb13c;
      bVar1 = true;
    }
    else {
      bVar1 = iVar6 == 0xfe;
...
LAB_000eb13c:
  ...
  case 0x7c:
    ...
    if (iVar8 == 0x100) {
      if ((larg == 0x100) || (iVar6 == 0xfe)) goto LAB_000eb250;
      bVar1 = true;
    }
    else {
      bVar1 = iVar8 >> 8 == 0xfe;
...
LAB_000eb250:
    ...
    break;
  case 0x7d:
    if ((uint)larg <= *(uint *)ctx->tlsext_tick_hmac_key && larg != 0) goto LAB_000eb088;
    break;
  case 0x7e:
    if (larg - 1U < 0x20) {
