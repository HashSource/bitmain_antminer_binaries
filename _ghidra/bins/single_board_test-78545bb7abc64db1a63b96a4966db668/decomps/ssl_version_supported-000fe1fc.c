...
LAB_000fe3ee:
              ...
              if (iVar7 < iVar3) goto LAB_000fe308;
            }
            else {
              if (iVar7 == 0x100) {
                if (iVar3 == 0x100) goto LAB_000fe2bc;
                iVar7 = 0xff00;
              }
              else if (iVar3 == 0x100) {
                iVar3 = 0xff00;
              }
              if (iVar3 < iVar7) goto LAB_000fe308;
            }
          }
        }
        else if ((*(uint *)(*(int *)(param_1[1] + 100) + 0x30) & 8) == 0) {
          if (iVar3 <= iVar7) goto LAB_000fe290;
        }
        else {
          if (iVar7 == 0x100) {
            if (iVar3 == 0x100) goto LAB_000fe290;
            iVar2 = 0xff00;
          }
          else {
            iVar2 = iVar7;
          ...
          if (iVar2 <= iVar3) goto LAB_000fe290;
        }
      }
    }
