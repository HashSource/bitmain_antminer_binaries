...

{
  ...
  if (pBVar2 != (BIGNUM *)0x0) {
    if (m->neg == 0) {
      ...
      if (pBVar3 == (BIGNUM *)0x0) goto LAB_001894e6;
      a_00->neg = 0;
...
LAB_00189610:
        ...
        do {
          ...
          pBVar2 = BN_CTX_get(ctx);
          ppBVar8[1] = pBVar2;
          if (pBVar2 == (BIGNUM *)0x0) goto LAB_001894e6;
          iVar6 = BN_mod_mul_reciprocal(pBVar2,*ppBVar8,a_00,&BStack_dc,ctx);
          if (iVar6 == 0) goto LAB_001894e6;
          ppBVar8 = ppBVar8 + 1;
        } while (iVar5 < iVar4);
      }
