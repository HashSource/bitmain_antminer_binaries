...

{
  ...
  if (algor2 == (X509_ALGOR *)0x0) {
    if (algor1 == (X509_ALGOR *)0x0) goto LAB_001800f6;
    ...
    if (type->pkey_type == 0x71) {
      ...
      md = pAVar2;
      cnt = pAVar2;
      if (pAVar2 == (ASN1_TYPE *)0x0) goto LAB_00180186;
      pAVar2->type = 5;
    }
...
LAB_001802cc:
      ...
      if (pAVar1->length != 0) goto LAB_001800f6;
LAB_001802a4:
      line = 0x45;
      iVar3 = 0x9a;
    }
    ...
    if (algor1 == (X509_ALGOR *)0x0) {
      do {
        ...
        if (pAVar1 == (ASN1_OBJECT *)0x0) goto LAB_001802cc;
        if (pAVar1->length == 0) goto LAB_001802a4;
      } while (iVar3 != 2);
    }
    else {
      iVar3 = 0;
