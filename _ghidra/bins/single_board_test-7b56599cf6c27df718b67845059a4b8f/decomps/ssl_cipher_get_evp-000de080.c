...

{
  ...
  if (param_6 == (undefined4 *)0x0) {
    ...
    CRYPTO_THREAD_run_once(&ssl_load_builtin_comp_once,0xdd41d);
...
LAB_000de1f0:
  ...
  if (iVar5 == 0x40) {
    ...
    if (iVar5 == 2) {
      ...
      if (pEVar3 != (EVP_CIPHER *)0x0) goto LAB_000de24c;
      if (*(int *)(iVar7 + 0x18) == 0x80) goto LAB_000de236;
...
LAB_000de236:
    ...
    if (iVar5 == 2) {
      ...
      if (pEVar3 != (EVP_CIPHER *)0x0) goto LAB_000de24c;
      iVar5 = *(int *)(iVar7 + 0x18);
      if (iVar5 == 0x40) goto LAB_000de2da;
      goto LAB_000de2be;
    }
  }
  if ((iVar5 != 0x10) ||
