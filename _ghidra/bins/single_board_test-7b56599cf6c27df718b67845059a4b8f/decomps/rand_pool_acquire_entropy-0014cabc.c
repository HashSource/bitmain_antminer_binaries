...
/* WARNING: Removing unreachable block (ram,0x0014cb2a) */
/* WARNING: Removing unreachable block (ram,0x0014cb1e) */
/* WARNING: Removing unreachable block (ram,0x0014cb4c) */
/* WARNING: Removing unreachable block (ram,0x0014ccda) */
/* WARNING: Removing unreachable block (ram,0x0014cce6) */
/* WARNING: Removing unreachable block (ram,0x0014cb50) */
...
LAB_0014cb88:
        ...
        piVar5 = __errno_location();
        iVar4 = *piVar5;
        if (iVar4 != 0x26) goto LAB_0014cb88;
        lVar6 = syscall(0x180,uVar3,iVar2,0);
        if (0 < lVar6) goto LAB_0014cb70;
        if (lVar6 != 0) {
          iVar4 = *piVar5;
          goto LAB_0014cb88;
        }
          ...
          if (iVar7 != -1) {
            ...
            do {
              while( true ) {
                ...
                iVar4 = 2;
                if (__nbytes == 0) goto LAB_0014cc6e;
              }
              if ((sVar8 != 0) && (piVar5 = __errno_location(), *piVar5 != 4)) goto LAB_0014cc74;
              bVar1 = 0 < iVar4;
              iVar4 = iVar4 + -1;
            } while (bVar1);
            if (sVar8 < 0) {
...
LAB_0014cc6e:
              if (keep_random_devices_open == 0) goto LAB_0014cc74;
            }
            __nbytes = rand_pool_bytes_needed(param_1,1);
          }
        }
