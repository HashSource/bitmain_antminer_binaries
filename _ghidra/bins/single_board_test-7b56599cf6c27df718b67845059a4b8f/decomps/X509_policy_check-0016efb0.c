...
LAB_0016f162:
      ...
      *(uint *)(local_54 + 4) = uVar1;
      ...
      if (puVar8 == (uint *)0x0) goto LAB_0016f146;
...
LAB_0016f72a:
      ...
      local_44 = uVar17 & 4;
      if (local_44 != 0) goto LAB_0016f0aa;
    }
    local_44 = uVar17 & 2;
    if (local_44 != 0) {
LAB_0016eff8:
...
LAB_0016f38e:
  ...
  if (iVar2 == 0) {
    ...
    if ((1 < iVar19) && (iVar19 = *(int *)(iVar16 + 8), iVar19 != 0)) goto LAB_0016f41e;
LAB_0016f55e:
