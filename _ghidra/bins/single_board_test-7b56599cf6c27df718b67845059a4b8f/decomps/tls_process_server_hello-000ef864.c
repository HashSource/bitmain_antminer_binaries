...
LAB_000ef8ae:
  ...
  iVar3 = param_1[0x1f];
  if (uVar5 < 0x20) goto LAB_000ef8ae;
LAB_000ef900:
  bVar16 = false;
...
LAB_000ef94c:
    ...
    __s1 = pbVar15 + 1;
    uVar9 = (uint)*pbVar15;
    if (iVar3 - 1U < uVar9) goto LAB_000ef94c;
...
LAB_000efb30:
              ...
              if ((uVar5 != 0) || (*piVar13 == 0x10000 || *piVar13 < 0x304)) goto LAB_000ef9d6;
              uVar10 = 0x200;
              uVar4 = 0x200;
            }
...
LAB_000efccc:
                if ((uVar9 != 0) && (__n = piVar13[0x52], uVar9 == __n)) goto LAB_000efcda;
                goto LAB_000efd28;
              }
              piVar13 = (int *)param_1[0x11d];
              if (piVar13[0x74] == 0) goto LAB_000efccc;
              local_34 = (void *)0x100;
              local_38 = 0;
              ...
              piVar8[0x6e] = iVar3;
              if ((uVar9 == 0) || (__n = piVar13[0x52], __n != uVar9)) goto LAB_000efc5e;
LAB_000efcda:
              iVar3 = memcmp(__s1,piVar13 + 0x53,__n);
              if (iVar3 != 0) goto LAB_000efc5e;
              param_1[0x23] = 1;
LAB_000efc66:
...
LAB_000efc86:
              ...
              if (iVar3 == 0) goto LAB_000ef8e6;
              piVar13 = (int *)param_1[0x11d];
LAB_000efc5e:
              if (param_1[0x23] != 0) goto LAB_000efc66;
LAB_000efd28:
              if (piVar13[0x52] != 0) {
          ...
          if (uVar7 <= uVar5 - 5) {
            ...
            if (uVar7 == uVar5 - 5) {
              *param_2 = (int)(pbVar12 + uVar7);
              ...
              local_30 = pbVar12;
              local_2c = uVar7;
              if (!bVar16) goto LAB_000ef9a2;
              piVar13 = (int *)param_1[1];
              uVar5 = *(uint *)(piVar13[0x19] + 0x30) & 8;
              if (uVar5 == 0) goto LAB_000efb16;
              goto LAB_000efb30;
            }
          }
        }
