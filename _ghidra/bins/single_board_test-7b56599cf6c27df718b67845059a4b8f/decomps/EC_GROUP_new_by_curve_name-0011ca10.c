...

{
  ...
  do {
    ...
    if (nid == (&curve_list)[iVar5 * 4]) {
      piVar4 = (int *)(&DAT_0025f4b0)[iVar5 * 4];
      pEVar3 = (EC_METHOD *)(&DAT_0025f4b4)[iVar5 * 4];
      if (piVar4 == (int *)0x0) {
...
LAB_0011cb0e:
          ...
          if (a == (BIGNUM *)0x0) goto LAB_0011caea;
          puVar6 = puVar6 + iVar5;
          b = BN_bin2bn(puVar6,iVar5,(BIGNUM *)0x0);
          if (b == (BIGNUM *)0x0) goto LAB_0011caee;
          if (pEVar3 != (EC_METHOD *)0x0) {
            pEVar3 = (EC_METHOD *)(*(code *)pEVar3)();
            group = (BIGNUM *)EC_GROUP_new(pEVar3);
            if (group != (BIGNUM *)0x0) {
              iVar1 = (*(code *)group->d[6])(group,p,a,b,ctx);
              if (iVar1 != 0) goto LAB_0011cba6;
            }
...
LAB_0011cc62:
          ...
          if (local_3c == (BIGNUM *)0x0) goto LAB_0011cc62;
