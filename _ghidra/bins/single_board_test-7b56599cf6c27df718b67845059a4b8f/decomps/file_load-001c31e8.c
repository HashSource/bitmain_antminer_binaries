...
LAB_001c328a:
      ...
      if (iVar10 == 1) {
        ...
        if (0 < iVar10) {
          ...
          if (sVar6 < 0xb) goto LAB_001c32da;
          iVar10 = PEM_get_EVP_CIPHER_INFO(pcVar11,local_128);
          if (iVar10 != 0) {
            local_12c = &DAT_00239f50;
            local_134 = param_2;
            local_130 = param_3;
            iVar10 = PEM_do_header(local_128,local_140,(long *)&local_13c,(undefined1 *)0x1c3931,
                                   &local_134);
            if (iVar10 != 0) goto LAB_001c32d4;
          }
        }
LAB_001c3544:
        iVar10 = -1;
        ...
        if (-1 < param_1[2] << 0x1f) goto LAB_001c3482;
LAB_001c355c:
...
LAB_001c334a:
              if (piVar15 == (int *)&OSSL_STORE_str_functs) goto LAB_001c33b4;
            }
...
LAB_001c33b4:
          ...
          if (pvVar2 == (void *)0x0) goto LAB_001c345c;
...
LAB_001c347c:
        iVar10 = local_18c;
        if (param_1[2] << 0x1f < 0) goto LAB_001c355c;
LAB_001c3482:
      ...
      if (local_18c == 0) {
        if (*param_1 == 2) {
          iVar10 = param_1[4];
LAB_001c34f2:
          if (iVar10 != 0) goto joined_r0x001c35aa;
        }
        else if ((param_1[4] == 0) ||
        ...
        if (0 < param_1[1]) goto joined_r0x001c35aa;
        iVar10 = *param_1;
        goto LAB_001c328a;
      }
      if (1 < local_18c) {
...
LAB_001c3656:
  ...
  do {
    ...
    if (*pcVar11 != '.') {
      if ((char)param_1[6] == '\0') goto LAB_001c3774;
      uVar13 = param_1[0xb];
      uVar16 = uVar13;
      if (uVar13 != 0) {
        uVar16 = 1;
