...

{
  ...
  lVar1 = (ulonglong)((uint)val_local ^ (uint)acc_local) * 0x85ebca87;
  uVar2 = (uint)lVar1;
  acc_local = CONCAT44((val_local._4_4_ ^ acc_local._4_4_) * -0x7a143579 +
                       ((uint)val_local ^ (uint)acc_local) * -0x61c8864f +
