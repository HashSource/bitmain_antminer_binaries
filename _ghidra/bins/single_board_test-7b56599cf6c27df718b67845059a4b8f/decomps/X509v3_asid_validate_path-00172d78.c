...
LAB_00172f84:
    ...
    if (((int *)puVar9[1] != (int *)0x0) && (*(int *)puVar9[1] == 0)) {
      ...
      *(int *)(param_1 + 100) = iVar4;
      *(undefined4 *)(param_1 + 0x60) = 0x2e;
                    /* WARNING: Could not recover jumptable at 0x0017303a. Too many branches */
