...

{
  ...
  if (indent < 0) {
    ...
    iVar10 = 0;
    do {
      iVar1 = BIO_write(out,&DAT_0023bac8,1);
      if (iVar1 != 1) {
        return -1;
      }
      iVar10 = iVar10 + 1;
  ...
  if ((int)(flags << 8) < 0) {
    local_ac = 3;
    local_9c = &DAT_002246b0;
  }
  else {
    local_9c = &DAT_0020fbdc;
    local_ac = 1;
  }
      ...
      if (iVar11 != -1) {
        ...
        if (iVar2 == iVar11) {
          ...
          if (out != (BIO *)0x0) {
            ...
            if (iVar10 != 0) {
              do {
                iVar2 = BIO_write(out,&DAT_0023bac8,1);
                if (iVar2 != 1) {
                  return -1;
                }
                iVar11 = iVar11 + 1;
...
LAB_00182072:
          if (out == (BIO *)0x0) {
            if (((int)local_c0 < iVar4) && ((flags & 0x2000000) != 0)) goto LAB_0018209a;
          }
          else {
...
LAB_0018209a:
              ...
              if ((0 < iVar4) && (out != (BIO *)0x0)) {
                iVar9 = 0;
                do {
                  iVar6 = BIO_write(out,&DAT_0023bac8,1);
                  if (iVar6 != 1) {
                    return -1;
                  }
                  iVar9 = iVar9 + 1;
              ...
              indent = indent + iVar4;
              if (out == (BIO *)0x0) goto LAB_00181fa2;
            }
LAB_00181f8e:
