      ...
      if (iVar3 != 0) {
        do {
          ...
          if ((iVar3 == 0) || (iVar3 = strcmp(__s1,"X509 CERTIFICATE"), iVar3 == 0)) {
            if (pXVar2->x509 == (X509 *)0x0) goto code_r0x001b90e4;
          }
          else {
            iVar3 = strcmp(__s1,"TRUSTED CERTIFICATE");
            if (iVar3 == 0) {
              if (pXVar2->x509 == (X509 *)0x0) {
                local_58 = (code *)0x16e5cd;
                goto LAB_001b90ee;
              }
            }
            else {
              ...
              if (iVar3 == 0) {
                ...
                if (iVar3 == 0) {
                  ...
                  if (iVar3 == 0) {
                    ...
                    if (iVar3 != 0) goto LAB_001b9140;
                    if (pXVar2->x_pkey == (X509_PKEY *)0x0) {
                      pXVar2->enc_data = (char *)0x0;
                      pXVar2->enc_len = 0;
                      pXVar5 = X509_PKEY_new();
                      pXVar2->x_pkey = pXVar5;
                      if (pXVar5 == (X509_PKEY *)0x0) goto LAB_001b921c;
                      local_5c = (X509_INFO *)&pXVar5->dec_pkey;
                      iVar3 = 0x198;
                      local_54 = local_4c;
                      sVar6 = strlen(local_4c);
...
LAB_001b91ca:
                      ...
                      if ((int)sVar6 < 0xb) goto LAB_001b90f8;
                      iVar3 = PEM_get_EVP_CIPHER_INFO(local_54,&pXVar2->enc_cipher);
                      puVar1 = local_48;
                      if (iVar3 == 0) goto LAB_001b921c;
                      local_48 = (uchar *)0x0;
