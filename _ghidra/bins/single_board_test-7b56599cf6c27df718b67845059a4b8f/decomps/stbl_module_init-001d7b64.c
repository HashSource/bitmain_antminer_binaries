...
LAB_001d7cba:
        OPENSSL_sk_pop_free(psVar4,0x1794f9);
      ...
      for (iVar7 = 0; iVar5 = OPENSSL_sk_num(psVar4), iVar7 < iVar5; iVar7 = iVar7 + 1) {
        ...
        if (*pcVar1 == 'm') {
          if (pcVar1[1] != 'i') {
            ...
            if (*local_30 != '\0') goto LAB_001d7c90;
            goto LAB_001d7c18;
          }
          if ((pcVar1[2] != 'n') || (pcVar1[3] != '\0')) goto LAB_001d7c38;
          uVar10 = strtoul(*(char **)(iVar5 + 8),&local_30,0);
          if (*local_30 == '\0') goto LAB_001d7c18;
LAB_001d7c90:
          ERR_put_error(0xd,0xde,0xda,"crypto/asn1/asn_mstbl.c",99);
...
LAB_001d7c38:
        ...
        if (iVar6 == 0) {
          ...
          if ((iVar6 != 0) && (local_2c[0] != 0)) goto LAB_001d7c18;
          goto LAB_001d7c90;
        }
        iVar6 = strcmp(pcVar1,"flags");
        if (iVar6 != 0) goto LAB_001d7c90;
        pcVar1 = *(char **)(iVar5 + 8);
