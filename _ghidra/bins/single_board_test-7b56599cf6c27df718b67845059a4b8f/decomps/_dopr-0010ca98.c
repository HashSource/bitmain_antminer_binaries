...
joined_r0x0010caca:
  do {
    if (uVar11 == 0) goto LAB_0010cacc;
    if ((param_2 == 0) && (uVar6 = *param_3, uVar6 <= local_2c[0])) goto LAB_0010ce3e;
    switch(uVar12) {
    case 0:
      if (uVar11 == 0x25) {
        uVar12 = 1;
...
joined_r0x0010ccf8:
    ...
    case 2:
      ...
      break;
    case 3:
      if (uVar11 != 0x2e) goto LAB_0010cc9a;
      uVar11 = (uint)*param_6;
      uVar12 = 4;
      param_6 = (byte *)((int)param_6 + 1);
      break;
...
LAB_0010cc9a:
    ...
    case 5:
      ...
      case 0x4c:
        ...
        param_6 = (byte *)((int)param_6 + 1);
        uVar12 = 6;
        goto joined_r0x0010caca;
      default:
        goto switchD_0010cbd6_caseD_4d;
      case 0x68:
        iVar13 = 1;
        uVar11 = (uint)*param_6;
        uVar12 = 6;
...
switchD_0010cbd6_caseD_4d:
    ...
    case 6:
      ...
      case 0x25:
        ...
        break;
      default:
        goto switchD_0010cb20_caseD_26;
      case 0x45:
        uVar7 = uVar7 | 0x20;
      case 0x65:
...
LAB_0010cda4:
      ...
      case 0x73:
        ...
        if ((int)local_58 < 0) {
          ...
          if (-1 < (int)local_58) goto LAB_0010cee0;
          local_44 = OPENSSL_strnlen(pcVar14,0xffffffff);
          uVar12 = uVar10 - local_44;
          if (-1 < (int)(uVar12 | uVar10)) goto LAB_0010cf0e;
          if ((uVar7 & 1) == 0) {
            iVar13 = 0;
            uVar12 = 0;
            goto LAB_0010d1e0;
...
LAB_0010cf0e:
          if ((uVar7 & 1) != 0) goto LAB_0010d12e;
          if (uVar12 == 0) {
            iVar13 = 0;
            uVar12 = 0;
          }
            ...
            local_3c = local_58 >> 0x1f;
            if (local_58 == 0) goto switchD_0010cb20_caseD_26;
            uVar11 = param_2;
            if (param_2 != 0) {
              uVar11 = 1;
            }
            ...
            do {
              ...
              uVar12 = uVar12 - 1;
              if (uVar12 == 0) {
                if (local_44 != 0) goto LAB_0010d140;
                goto switchD_0010cb20_caseD_26;
              }
              uVar7 = local_58 >> 0x1f;
...
LAB_0010d1e0:
          if (local_44 == 0) goto switchD_0010cb20_caseD_26;
          local_3c = local_58 >> 0x1f;
        }
LAB_0010d140:
        uVar11 = local_3c;
        ...
        if (uVar11 != 0) {
          ...
          do {
            ...
            if (pcVar14 + 1 == pcVar9) goto LAB_0010d1fe;
            uVar7 = local_3c;
            if (local_44 < (int)local_58) {
              uVar7 = 1;
            }
...
switchD_0010cb20_caseD_26:
      ...
      break;
    default:
      goto switchD_0010cb0a_default;
    }
  } while( true );
switchD_0010cb0a_default:
  if (uVar12 == 7) {
LAB_0010cacc:
    if (param_2 == 0) {
      uVar6 = *param_3;
