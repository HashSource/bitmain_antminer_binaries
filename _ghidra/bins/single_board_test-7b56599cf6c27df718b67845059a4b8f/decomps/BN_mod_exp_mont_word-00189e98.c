...
LAB_00189f7a:
      ...
      if (w == 1) {
        rem = a_00;
        if (bVar5) goto LAB_0018a140;
      }
      else {
        a = w;
        if (bVar5) goto LAB_0018a0b4;
...
LAB_0018a018:
    if (m_ctx != (BN_MONT_CTX *)0x0) goto LAB_0018a020;
  }
