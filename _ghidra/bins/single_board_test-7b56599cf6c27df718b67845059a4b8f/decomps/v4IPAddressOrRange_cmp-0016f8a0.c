...
int v4IPAddressOrRange_cmp(undefined4 *param_1,undefined4 *param_2)
...
LAB_0016f8b4:
    if (*piVar8 == 0) {
      ...
      iVar10 = 0x20;
      memset(abStack_29 + sVar5 + 1,0,4 - sVar5);
    }
    else {
      iVar10 = 0;
    }
    iVar4 = memcmp(auStack_38,abStack_29 + 1,4);
    if (iVar4 == 0) {
      return iVar7 - iVar10;
    }
  }
