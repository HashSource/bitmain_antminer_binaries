...

{
  ...
  if (ptr != (undefined4 *)0x0) {
    ...
    OPENSSL_sk_pop_free(*ptr,0x16d489);
      ...
      if (str != (BUF_MEM *)0x0) {
        ...
        if (iVar1 != 0) {
          ...
          if (iVar1 == 0) {
            ...
            a->canon_enclen = 0;
LAB_0016dc34:
            OPENSSL_sk_pop_free(local_24,0x16d4b5);
            a->modified = 0;
            *param_1 = a;
            *param_2 = local_28;
            return iVar1;
...
LAB_0016db5a:
  OPENSSL_sk_pop_free(local_24,0x16d4b9);
