...
LAB_00148628:
        ...
        if (local_78 != (ASN1_OCTET_STRING *)0x0) {
          if (local_78->length != 4) goto LAB_00148628;
...
LAB_00148662:
          ...
          while( true ) {
            ...
            if (pBVar4 == (BIO *)0x0) goto LAB_001485b6;
            BIO_ctrl(pBVar4,0x78,0,&local_70);
            if (local_70 == (EVP_MD_CTX *)0x0) goto LAB_001486bc;
...
LAB_00148622:
        ...
        local_78 = (ppVar8->d).data;
        if (local_78 != (ASN1_OCTET_STRING *)0x0) {
          if (local_78->length != 4) goto LAB_00148622;
          local_78 = (ASN1_OCTET_STRING *)local_78->type;
        }
      }
    }
