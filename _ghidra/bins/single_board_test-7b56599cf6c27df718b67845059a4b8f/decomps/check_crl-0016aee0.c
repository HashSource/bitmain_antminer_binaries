...
LAB_0016afec:
  ...
  if ((int)(param_1[0x1c] << 0x19) < 0) goto LAB_0016af5e;
  ...
  if ((int)(uVar3 << 0x1e) < 0) {
    ...
    if (t != (time_t *)0x0) goto LAB_0016af5e;
  }
...
joined_r0x0016afb4:
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 == 0) {
      ...
      if ((-1 < iVar1) || ((param_1[0x1c] & 2) != 0)) goto LAB_0016af5a;
      param_1[0x18] = 0xc;
      iVar1 = (*(code *)param_1[7])(0,param_1);
    }
    if (iVar1 == 0) {
