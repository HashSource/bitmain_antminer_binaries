...
undefined4 aria_256_cfb1_cipher(EVP_CIPHER_CTX *param_1,int param_2,int param_3,uint param_4)

{
  ...
  if (param_4 != 0) {
    do {
      ...
      iVar1 = param_2 + uVar5;
      CRYPTO_cfb128_1_encrypt(param_3,param_2,uVar6,uVar2,uVar3,local_2c,uVar4,0x17c325);
