...

{
  ...
  else if (iVar2 == 4) goto LAB_0012aa4e;
  if ((param_4 & 7) != 0) {
    return -1;
  }
LAB_0012aa4e:
    ...
    if (iVar2 == 4) {
      ...
      if (iVar2 == 0) {
        iVar1 = CRYPTO_128_unwrap_pad
                          (iVar1,*(undefined4 *)(iVar1 + 0xf8),param_2,param_3,param_4,0x17bf15);
      }
      else {
      ...
      if (iVar2 == 0) {
        ...
        iVar1 = CRYPTO_128_wrap(iVar1,*(undefined4 *)(iVar1 + 0xf8),param_2,param_3,param_4,0x17baf9
                               );
      }
    }
    if (iVar1 == 0) {
