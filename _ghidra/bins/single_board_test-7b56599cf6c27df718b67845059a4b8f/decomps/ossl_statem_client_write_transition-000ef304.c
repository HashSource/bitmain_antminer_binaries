  ...
  if (uVar4 == 0) {
    ...
    if (iVar1 != 0) {
      ...
      case 0xb:
        ...
        goto switchD_000ef370_caseD_10;
        break;
      case 0xd:
        ...
        *(undefined4 *)(param_1 + 0x40) = uVar3;
        return 1;
      case 0xf:
        goto switchD_000ef332_caseD_11;
      case 0x2f:
...
LAB_000ef4b2:
  ...
  case 0xd:
    *(undefined4 *)(param_1 + 0x40) = 0xe;
    return 1;
  case 0xb:
    if (*(int *)(param_1 + 0x8c) == 0) goto switchD_000ef370_caseD_9;
  case 0xf:
switchD_000ef332_caseD_f:
...
LAB_000ef556:
  ...
  case 0x10:
    if (*(int *)(param_1 + 0x44c) != 1) {
      if (*(int *)(param_1 + 0x68) == 2) goto LAB_000ef556;
...
switchD_000ef370_caseD_9:
    *(undefined4 *)(param_1 + 0x40) = 1;
    return 1;
  case 0x29:
    iVar1 = ssl3_renegotiate_check(param_1,1);
    if (iVar1 == 0) goto switchD_000ef370_caseD_9;
