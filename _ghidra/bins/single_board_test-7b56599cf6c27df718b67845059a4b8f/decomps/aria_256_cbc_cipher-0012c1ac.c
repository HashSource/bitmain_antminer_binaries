...
undefined4 aria_256_cbc_cipher(undefined4 param_1,int param_2,int param_3,uint param_4)

{
  ...
  if (0x3fffffff < param_4) {
    do {
      ...
      if (iVar3 == 0) {
        CRYPTO_cbc128_decrypt(iVar6,iVar4,0x40000000,uVar1,uVar2,0x17c325);
      }
      else {
  ...
  if (param_4 != 0) {
    ...
    if (iVar4 != 0) {
      CRYPTO_cbc128_encrypt(local_30,local_34,param_4,uVar1,uVar2,0x17c325);
      return 1;
    }
    CRYPTO_cbc128_decrypt(local_30);
    return 1;
  }
  return 1;
}
