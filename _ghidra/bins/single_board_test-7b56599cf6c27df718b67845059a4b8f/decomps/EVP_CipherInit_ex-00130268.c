...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    ...
    if (cipher == (EVP_CIPHER *)0x0) {
      if (pEVar4 == (EVP_CIPHER *)0x0) goto LAB_00130466;
      goto LAB_001302fa;
    }
    if ((pEVar4 != (EVP_CIPHER *)0x0) || (ctx->cipher_data != (void *)0x0)) goto LAB_001302a4;
  }
  else {
    pEVar4 = ctx->cipher;
...
LAB_00130466:
    ...
    else if ((cipher == (EVP_CIPHER *)0x0) || (cipher->nid == pEVar4->nid)) goto LAB_001302fa;
LAB_001302a4:
    uVar5 = ctx->flags;
  ...
  if (impl == (ENGINE *)0x0) {
    ...
    if (impl != (ENGINE *)0x0) goto LAB_001302c6;
  }
  else {
