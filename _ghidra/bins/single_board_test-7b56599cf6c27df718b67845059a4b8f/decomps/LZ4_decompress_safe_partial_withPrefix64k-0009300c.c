...
/* WARNING: Removing unreachable block (ram,0x000934f6) */
/* WARNING: Removing unreachable block (ram,0x00093500) */
/* WARNING: Removing unreachable block (ram,0x00093502) */
/* WARNING: Removing unreachable block (ram,0x00093504) */
/* WARNING: Removing unreachable block (ram,0x0009350a) */
/* WARNING: Removing unreachable block (ram,0x000930da) */
/* WARNING: Removing unreachable block (ram,0x000930e2) */
/* WARNING: Removing unreachable block (ram,0x000930f2) */
/* WARNING: Removing unreachable block (ram,0x000930ea) */
...
LAB_00093232:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_0009398e;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_0009398e;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_00093232;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_0009398e;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_0009398e;
              op = pBVar10;
