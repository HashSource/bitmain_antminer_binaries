...
LAB_00169694:
          ...
          if (iVar2 == 0) {
            ...
            if ((iVar2 != 0) || (local_30 == (X509_CRL *)0x0)) {
              ...
              OPENSSL_sk_pop_free(iVar2,(undefined *)0x16d275);
              goto LAB_0016967a;
            }
          }
          else {
LAB_0016967a:
            if (local_30 == (X509_CRL *)0x0) goto LAB_00169694;
          }
...
LAB_001696c4:
            ...
            goto LAB_001696c4;
            if (iVar2 != 2) goto LAB_00169610;
          }
          X509_CRL_free(local_40);
          X509_CRL_free(a_00);
          iVar2 = *(int *)(param_1 + 0x74);
          local_40 = (X509_CRL *)0x0;
          if (iVar3 == iVar2) goto LAB_00169694;
          iVar3 = iVar2;
        } while (iVar2 != 0x807f);
        X509_CRL_free((X509_CRL *)0x0);
        X509_CRL_free((X509_CRL *)0x0);
