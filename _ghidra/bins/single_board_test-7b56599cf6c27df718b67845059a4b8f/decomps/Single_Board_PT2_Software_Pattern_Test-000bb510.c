...

{
  ...
  bitmain_power_off();
  res = temp_sensor_check();
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : first sensor check res:%d\n","Single_Board_PT2_Software_Pattern_Test",(uint)res);
  snprintf(tmp1,0x100,"first sensor check res:%d",(uint)res);
  ...
  if (res == true) {
    ...
    while (gPattern_test_counter < gTest_loop) {
      print_time_stamp(time_stamp,0x30);
      printf("%s ",time_stamp);
      ...
      thread_ret = pthread_create(&show_id,(pthread_attr_t *)0x0,(__start_routine *)0x279ed,
                                  (void *)0x0);
      if (thread_ret != 0) {
        print_time_stamp(time_stamp,0x30);
        printf("%s ",time_stamp);
      ...
      thread_ret = pthread_create(&read_temp_from_pic_id,(pthread_attr_t *)0x0,
                                  (__start_routine *)0x365d9,(void *)0x0);
      if (thread_ret != 0) {
        print_time_stamp(time_stamp,0x30);
        printf("%s ",time_stamp);
      ...
      iVar3 = get_min_value(gHistory_Result[gPattern_test_counter].
                            sensor_local_temperature_from_ctrlboard,(uint8_t)gCtrlBoard_sensor_num);
      iVar4 = get_ctrlboard_temp_max();
      snprintf(tmp1,0x100,"env temp,min temp:%d,max temp:%d",(int)iVar3,iVar4);
      log_to_file(tmp1,time_stamp);
      gCooling = true;
      cool_time = 0;
      pwm_set(gFan,100);
      while (iVar4 = get_ctrlboard_temp_max(), 0x38 < iVar4) {
        print_time_stamp(time_stamp,0x30);
        printf("%s ",time_stamp);
        iVar4 = get_ctrlboard_temp_max();
        printf("%s : wait temp down,max:%d,target:%d\n","Single_Board_PT2_Software_Pattern_Test",
               iVar4,0x38);
        iVar4 = get_ctrlboard_temp_max();
        snprintf(tmp1,0x100,"wait temp down,max:%d,target:%d",iVar4,0x38);
        log_to_file(tmp1,time_stamp);
        sleep(1);
      ...
      if (env_temp == 0xffff) {
        ...
        iVar4 = get_ctrlboard_temp_max();
        snprintf(tmp1,0x100,"cur env,min temp:%d,max temp:%d",(int)iVar3,iVar4);
        log_to_file(tmp1,time_stamp);
        pwm_set(gFan,100);
      ...
      usleep(50000);
      gStart_receive = true;
      thread_ret = pthread_create(&receive_id,(pthread_attr_t *)0x0,(__start_routine *)0xb8ae9,
                                  (void *)0x0);
      if (thread_ret != 0) {
        _power_down(gChain,false);
        clear_all_thread();
      ...
      if ((((Local_Config_Information->Hash_Board).Asic_Num != gAsic_num) ||
        ...
        if ((Local_Config_Information->Hash_Board).Asic_Num < gAsic_num) {
          ...
          snprintf(tmp1,0x100,"asic num outof %d !!!",
                   (Local_Config_Information->Hash_Board).Asic_Num);
          log_to_file(tmp1,time_stamp);
        }
        else {
      ...
      do {
        iVar4 = get_ctrlboard_temp_max();
        if (0x32 < iVar4) goto LAB_000bc97c;
        print_time_stamp(time_stamp,0x30);
        printf("%s ",time_stamp);
        iVar4 = get_ctrlboard_temp_max();
        printf("%s : wait temp,max:%d,target:%d\n","Single_Board_PT2_Software_Pattern_Test",iVar4,
               0x38);
        iVar4 = get_ctrlboard_temp_max();
        snprintf(tmp1,0x100,"wait temp,max:%d,target:%d",iVar4,0x38);
        log_to_file(tmp1,time_stamp);
        sleep(1);
        get_all_fan_speed();
      ...
      if (iVar4 < 0x34) {
        ...
        snprintf(err_str2,0x10,"Need %d ~ %d",0x34,0x38);
      ...
      printf("%s : warning test max temp:%d,target:%d\n","Single_Board_PT2_Software_Pattern_Test",
             iVar4,0x38);
      iVar4 = get_ctrlboard_temp_max();
      snprintf(tmp1,0x100,"warning test max temp:%d,target:%d",iVar4,0x38);
      log_to_file(tmp1,time_stamp);
LAB_000bc97c:
      gHeating = false;
      ...
      if ((Local_Config_Information->Hash_Board).Smooth_Voltage == false) {
        ...
        step = __aeabi_uidiv(gHistory_Result[gPattern_test_counter].pre_open_core_voltage -
                             target_vol,(Local_Config_Information->Hash_Board).Voltage_Adjust_Step);
        set_vol_ret = set_pattern_test_voltage_by_step
                                (gHistory_Result[gPattern_test_counter].pre_open_core_voltage,
      ...
      log_to_file(tmp1,time_stamp);
      temp_fix = 0x3c;
      while ((temp_fix != 0 && (iVar4 = get_ctrlboard_temp_max(), iVar4 != 0x38))) {
        print_time_stamp(time_stamp,0x30);
        printf("%s ",time_stamp);
        iVar4 = get_ctrlboard_temp_max();
        printf("%s : wait temp come to %d,now:%d,time:%d\n","Single_Board_PT2_Software_Pattern_Test"
               ,0x38,iVar4,temp_fix);
        iVar4 = get_ctrlboard_temp_max();
        snprintf(tmp1,0x100,"wait temp come to %d,now:%d,time:%d",0x38,iVar4,temp_fix);
        log_to_file(tmp1,time_stamp);
        temp_fix = temp_fix + -1;
        get_all_fan_speed();
        sleep(1);
      }
      _Var2 = read_temp_from_asic_once(true);
      if (!_Var2) {
        err_exit("asic temp outof range");
      }
      _Var2 = read_chain_domain_voltage(true);
      if (!_Var2) {
      ...
      log_to_file(tmp1,time_stamp);
      gNoncing = true;
      thread_ret = pthread_create(&send_id,(pthread_attr_t *)0x0,(__start_routine *)0xb8df5,
                                  (void *)0x0);
      if (thread_ret != 0) {
        print_time_stamp(time_stamp,0x30);
        printf("%s ",time_stamp);
      ...
      if (gHistory_Result[gPattern_test_counter].test_standard == '\0') {
        ...
        snprintf(tmp1,0x100,"All base PT2 test done. STRICT_STANDARD: gPattern_test_counter: %d\n",
                 (uint)gPattern_test_counter);
        log_to_file(tmp1,time_stamp);
        iVar5 = do_PT2_summary_work(gPattern_test_counter);
        return iVar5;
      }
      if (gTest_loop - 1 <= (uint)gPattern_test_counter) {
        print_time_stamp(time_stamp,0x30);
        ...
        iVar5 = do_PT2_summary_work(history_result_index);
        return iVar5;
      }
