...
/* WARNING: Removing unreachable block (ram,0x00095398) */
/* WARNING: Removing unreachable block (ram,0x000953a2) */
/* WARNING: Removing unreachable block (ram,0x000953a4) */
/* WARNING: Removing unreachable block (ram,0x000953a6) */
/* WARNING: Removing unreachable block (ram,0x000953ac) */
/* WARNING: Removing unreachable block (ram,0x00094f76) */
...
LAB_000950d4:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_00095836;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_00095836;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar5) == 0) goto LAB_000950d4;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_00095836;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar6 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_00095836;
              op = pBVar11;
