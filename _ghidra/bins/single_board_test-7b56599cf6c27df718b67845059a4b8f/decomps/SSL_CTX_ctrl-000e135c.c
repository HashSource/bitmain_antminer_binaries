...

{
  ...
  if (0x73 < cmd - 0x10U) {
switchD_000e136e_caseD_11:
                    /* WARNING: Could not recover jumptable at 0x000e1664. Too many branches */
  ...
  case 0x10:
    *(void **)(ctx->sid_ctx + 4) = parg;
    return 1;
  default:
    goto switchD_000e136e_caseD_11;
  case 0x14:
...
LAB_000e14b0:
  ...
  case 0x7b:
    ...
    if (larg == 0x100) {
      if ((p_Var9 == (_func_3237 *)0x100) || ((int)p_Var9 >> 8 == 0xfe)) goto LAB_000e1564;
      bVar1 = true;
    }
    else {
      bVar1 = iVar6 == 0xfe;
...
LAB_000e1564:
  ...
  case 0x7c:
    ...
    if (iVar8 == 0x100) {
      if ((larg == 0x100) || (iVar6 == 0xfe)) goto LAB_000e1678;
      bVar1 = true;
    }
    else {
      bVar1 = iVar8 >> 8 == 0xfe;
...
LAB_000e1678:
    ...
    break;
  case 0x7d:
    if ((uint)larg <= *(uint *)ctx->tlsext_tick_hmac_key && larg != 0) goto LAB_000e14b0;
    break;
  case 0x7e:
    if (larg - 1U < 0x20) {
