...
/* WARNING: Removing unreachable block (ram,0x00092b6a) */
/* WARNING: Removing unreachable block (ram,0x00092b6c) */
/* WARNING: Removing unreachable block (ram,0x00092b6e) */
/* WARNING: Removing unreachable block (ram,0x00092b74) */
/* WARNING: Removing unreachable block (ram,0x0009273e) */
...
LAB_0009289c:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_00092ff8;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_00092ff8;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_0009289c;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_00092ff8;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_00092ff8;
              op = pBVar10;
