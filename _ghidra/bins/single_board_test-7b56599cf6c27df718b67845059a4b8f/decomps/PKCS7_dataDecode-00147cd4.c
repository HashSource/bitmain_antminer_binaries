...
LAB_00147d22:
    ...
    if (in_bio == (BIO *)0x0 && local_48 == (ASN1_OCTET_STRING *)0x0) goto LAB_00147e4a;
    b_00 = (BIO *)0x0;
LAB_00147e76:
    pBVar4 = BIO_f_cipher();
    bp = BIO_new(pBVar4);
...
LAB_00147da2:
    ...
    if (!bVar1) {
      ...
      pBVar15 = b_00;
      if (cipher != (BIO *)0x0) goto LAB_00147e76;
LAB_00147fc2:
      local_4c = in_bio;
      if (in_bio != (BIO *)0x0) {
LAB_00147fc8:
      ...
      if (local_48->length < 1) {
        ...
        if (local_4c != (BIO *)0x0) goto LAB_00147fc8;
        bp = (BIO *)0x0;
        pBVar5 = (BIO *)0x0;
        key = pBVar5;
      }
