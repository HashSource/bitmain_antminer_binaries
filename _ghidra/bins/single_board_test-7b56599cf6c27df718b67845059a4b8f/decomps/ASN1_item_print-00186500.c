...
LAB_0018654e:
  ...
  if ((it->utype != 1) && (ifld == (ASN1_VALUE *)0x0)) goto LAB_0018654e;
...
switchD_0018658c_caseD_5:
  ...
  if (it->itype != '\x05') {
    uVar5 = it->utype;
    if (uVar5 != 1) goto LAB_00186778;
    if (*(int *)pctx << 0x1c < 0) {
      a = (ASN1_GENERALIZEDTIME *)0x0;
      goto LAB_001869da;
    }
    piVar9 = (int *)local_8c;
switchD_00186842_caseD_1:
    iVar1 = *piVar9;
    if (iVar1 == -1) {
      iVar1 = it->size;
      pcVar8 = "BOOL ABSENT";
      if (iVar1 != -1) goto LAB_001869fc;
    }
    else {
LAB_001869fc:
      if (iVar1 == 0) {
...
LAB_0018678c:
    if (uVar5 != 5) goto LAB_0018682e;
LAB_00186792:
    iVar1 = BIO_puts(out,"NULL\n");
    goto joined_r0x00186974;
  }
  a = local_8c[0];
  if (-1 < *(int *)pctx << 0x1c) {
    piVar9 = (int *)local_8c;
