      ...
      if ((sha1_md == (EVP_MD *)0x0) &&
         ((((pEVar3 = (EVP_MD *)EVP_MD_meth_new(0x40,0x41), pEVar3 == (EVP_MD *)0x0 ||
          ...
          (((iVar1 = EVP_MD_meth_set_app_datasize(pEVar3,100), iVar1 == 0 ||
           ...
           ((iVar1 = EVP_MD_meth_set_init(pEVar3,0x1b2c0d), iVar1 == 0 ||
            ((iVar1 = EVP_MD_meth_set_update(pEVar3,0x1b2bf5), iVar1 == 0 ||
             (iVar1 = EVP_MD_meth_set_final(pEVar3,0x1b2be1), iVar1 == 0)))))))))) {
