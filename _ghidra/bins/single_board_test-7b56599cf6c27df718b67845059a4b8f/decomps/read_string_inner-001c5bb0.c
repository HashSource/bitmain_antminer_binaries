...

{
  ...
  local_2028[0] = (_union_1051)0x1c5b25;
  uVar7 = 1;
  ...
  if (param_3 == 0) {
    ...
    if (is_a_tty == 0) goto LAB_001c5c64;
    iVar3 = fileno(tty_in);
    iVar3 = tcsetattr(iVar3,0,(termios *)tty_new);
    if (iVar3 != -1) goto LAB_001c5c64;
    uVar7 = 0xffffffff;
    if (intr_signal != 2) {
      uVar7 = 0;
    }
LAB_001c5d0a:
    ...
    if (ps_21040 < 2) {
LAB_001c5d9a:
      if (ps_21040 < 1) goto LAB_001c5ccc;
    }
    else {
      tty_new._0_4_ = tty_orig._0_4_;
      tty_new._4_4_ = tty_orig._4_4_;
...
LAB_001c5c8a:
      ...
      if (pcVar2 == (char *)0x0) {
        do {
          ...
          if (pcVar2 == (char *)0x0) goto LAB_001c5c8a;
    ...
    if (param_3 == 0) goto LAB_001c5d0a;
    if (ps_21040 < 2) goto LAB_001c5d9a;
  }
  psVar4 = (sigaction *)(savsig + 0x8c);
  iVar3 = 1;
  do {
