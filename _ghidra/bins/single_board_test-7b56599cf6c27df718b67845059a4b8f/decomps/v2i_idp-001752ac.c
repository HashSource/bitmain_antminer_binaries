          ...
          if (psVar3 != (stack_st_CONF_VALUE *)0x0) {
            ...
            if (iVar2 == 0) {
              ...
              if (0 < iVar2) {
                ...
                if (*(GENERAL_NAMES **)(iVar2 + 8) == (GENERAL_NAMES *)0x0) goto LAB_001753b4;
...
LAB_0017534e:
    ...
    if (psVar3 == (stack_st_CONF_VALUE *)0x0) {
      ...
      if (*line == '@') {
        ...
        OPENSSL_sk_pop_free(psVar3,0x1794f9);
      }
...
LAB_00175464:
    OPENSSL_sk_pop_free(pGVar4,0x17574d);
    OPENSSL_sk_pop_free(pGVar7,0x16d489);
  }
LAB_0017547c:
