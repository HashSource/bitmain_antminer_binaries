...

{
  ...
  local_28[2] = (void *)0x0;
  local_28[3] = (void *)0x0;
  if ((added == 0) && (added = OPENSSL_LH_new(0x1425ed,0x14254d), added == 0)) {
    return 0;
  }
  a = OBJ_dup(obj);
  if (a == (ASN1_OBJECT *)0x0) goto LAB_001427e4;
  ...
  if (local_28[3] != (void *)0x0) {
    if ((a->length != 0) && (obj->data != (uchar *)0x0)) {
      ...
      if (local_28[0] == (void *)0x0) goto LAB_001427d2;
    }
    if (a->sn != (char *)0x0) {
      local_28[1] = CRYPTO_malloc(8,"crypto/objects/obj_dat.c",0xbf);
      if (local_28[1] == (void *)0x0) goto LAB_001427d2;
    }
    if (a->ln == (char **)0x0) {
LAB_00142794:
      iVar3 = 0;
    ...
    if (local_28[2] != (void *)0x0) goto LAB_00142794;
  }
LAB_001427d2:
