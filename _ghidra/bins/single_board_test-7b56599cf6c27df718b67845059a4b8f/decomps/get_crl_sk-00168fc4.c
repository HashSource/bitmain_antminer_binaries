...
LAB_00168ffe:
    ...
    if (-1 < (int)(uVar13 << 0x1e)) {
      ...
      if (-1 < *(int *)(*(int *)(param_1 + 0x10) + 0xc) << 0x13) {
        if ((uVar13 & 0x60) == 0) goto LAB_00169026;
        goto LAB_0016910c;
      }
      if ((int)(uVar13 << 0x19) < 0) {
        if ((*(uint *)(iVar1 + 0x58) & ~local_78) != 0) goto LAB_00169026;
        goto LAB_0016910c;
      }
      if (*(int *)(iVar1 + 0x60) != 0) goto LAB_0016910c;
LAB_00169026:
      ...
      if (iVar4 == 0) {
        ...
        if (-1 < *(int *)(iVar1 + 0x54) << 0x1a) goto LAB_0016910c;
        uVar13 = 0x100;
        uVar12 = 0;
      }
...
LAB_00169070:
        ...
        if (ptVar15 == (time_t *)0x0) goto LAB_00169070;
LAB_001693d0:
        uVar13 = uVar13 | 0x40;
      }
LAB_00169082:
      ...
      if ((iVar18 == 0) && ((uVar13 & 0x20) != 0)) {
        ...
        do {
          ...
          iVar16 = iVar4 + 1;
          if (iVar18 <= iVar4) {
            if (-1 < *(int *)(*(int *)(param_1 + 0x10) + 0xc) << 0x13) goto LAB_00169100;
            iVar4 = 0;
            goto LAB_00169354;
          }
          pXVar6 = (X509 *)OPENSSL_sk_value(*(undefined4 *)(param_1 + 0x50),iVar4);
...
LAB_00169100:
      if ((uVar13 & 4) == 0) goto LAB_0016910c;
      goto LAB_00169236;
    }
    goto LAB_0016910c;
  }
...
LAB_00169354:
    ...
    iVar16 = iVar4 + 1;
    if (iVar18 <= iVar4) goto LAB_00169100;
  }
  uVar13 = uVar13 | 4;
  local_6c = pXVar6;
LAB_00169236:
...
LAB_0016948c:
      ...
      if (((*(int **)(iVar1 + 0x50) == (int *)0x0) || (**(int **)(iVar1 + 0x50) == 0)) &&
         ((uVar13 & 0x20) != 0)) {
LAB_001693fe:
        if ((local_5c & ~local_78) == 0) goto LAB_0016910c;
        uVar13 = uVar13 | 0x80;
  ...
  if ((int)local_70 <= (int)uVar13 && uVar13 != 0) {
    if (local_74 != 0 && local_70 == uVar13) {
      ...
      if ((iVar4 == 0) || ((local_30 < 1 && (local_2c[0] < 1)))) goto LAB_0016910c;
    }
    local_68 = local_78;
    local_64 = local_6c;
    local_74 = iVar1;
...
LAB_0016910c:
  iVar20 = iVar20 + 1;
  iVar1 = OPENSSL_sk_num(param_7);
  if (iVar1 <= iVar20) goto LAB_00169118;
  goto LAB_00168ffe;
}
