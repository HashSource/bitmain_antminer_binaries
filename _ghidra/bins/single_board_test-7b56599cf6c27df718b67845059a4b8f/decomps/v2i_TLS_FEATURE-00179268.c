...
LAB_001792a0:
        ...
        a = ASN1_INTEGER_new();
        if (a != (ASN1_INTEGER *)0x0) goto LAB_001792de;
LAB_0017932a:
        ERR_put_error(0x22,0xa5,0x41,"crypto/x509v3/v3_tlsf.c",0x80);
LAB_0017933c:
        OPENSSL_sk_pop_free(iVar1,0x109ed5);
        return 0;
      }
      __s1 = (char *)puVar3[1];
      iVar2 = strcasecmp(__s1,"status_request");
...
LAB_0017931c:
      a = ASN1_INTEGER_new();
      v = 5;
      if (a == (ASN1_INTEGER *)0x0) goto LAB_0017932a;
LAB_001792de:
      iVar2 = ASN1_INTEGER_set(a,v);
      if ((iVar2 == 0) || (iVar2 = OPENSSL_sk_push(iVar1,a), iVar2 < 1)) goto LAB_0017932a;
    }
  }
  return iVar1;
}
