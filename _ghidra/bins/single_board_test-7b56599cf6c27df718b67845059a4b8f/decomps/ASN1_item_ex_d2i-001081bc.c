        ...
        if (iVar7 < 1) {
          ...
          if (0 < iVar7) {
            do {
              ...
              if (pAVar3 == (ASN1_TEMPLATE *)0x0) goto LAB_00108220;
              ppAVar4 = asn1_get_field_ptr(pval,pAVar3);
              puVar2 = local_30;
              if (local_34 == 0) {
                if (local_36 == '\0') goto LAB_001085f4;
                goto LAB_001086d8;
              }
...
LAB_0010847e:
          ...
          if (iVar7 != 0) goto joined_r0x0010866a;
          goto LAB_00108496;
        }
