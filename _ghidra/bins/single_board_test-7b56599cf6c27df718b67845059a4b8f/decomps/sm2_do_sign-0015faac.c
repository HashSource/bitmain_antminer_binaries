...
undefined4
sm2_do_sign(undefined4 param_1,EVP_MD *param_2,undefined4 param_3,undefined4 param_4,void *param_5,
           size_t param_6)

{
  ...
  if ((int)cnt < 0) {
    ...
    if (md == (uchar *)0x0 || ctx == (EVP_MD_CTX *)0x0) {
      ...
      iVar1 = sm2_compute_z_digest(md,param_2,param_3,param_4,param_1);
      if (iVar1 != 0) {
        ...
        if ((((iVar1 == 0) || (iVar1 = EVP_DigestUpdate(ctx,md,cnt), iVar1 == 0)) ||
          ...
          if (pBVar2 != (BIGNUM *)0x0) {
            CRYPTO_free(md);
            EVP_MD_CTX_free(ctx);
            uVar3 = sm2_sig_gen(param_1,pBVar2);
            BN_free(pBVar2);
            return uVar3;
          }
