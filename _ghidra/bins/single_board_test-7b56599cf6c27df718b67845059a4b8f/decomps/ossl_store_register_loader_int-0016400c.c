...
LAB_001640b6:
    ...
    iVar2 = ossl_ctype_check(*pbVar4,3);
    if (iVar2 == 0) goto LAB_00164098;
    do {
      do {
        do {
          pbVar4 = pbVar4 + 1;
          if (*pbVar4 == 0) goto LAB_00164026;
          iVar2 = ossl_ctype_check(*pbVar4,3);
        } while (iVar2 != 0);
LAB_00164098:
