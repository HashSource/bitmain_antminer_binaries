...
int32_t set_asic_pllparameter_postdivider
...

{
  ...
  if (which_pll < 3) {
    ...
    get_register_cache_value
              (asic_cache_level,which_chain,which_asic_address,(uint)bVar1,&pllparameter.v);
    pllparameter.v._0_1_ = pllparameter.v._0_1_ & 0x88 | (postdiv1 & 7) << 4 | postdiv2 & 7;
    iVar2 = send_set_config_command(which_chain,'\0',which_asic_address,(uint)bVar1,pllparameter.v);
  }
  else {
    iVar2 = -1;
  }
