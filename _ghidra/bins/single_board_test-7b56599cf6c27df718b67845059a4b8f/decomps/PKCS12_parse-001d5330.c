...
joined_r0x001d5402:
          if (psVar4 == (stack_st_PKCS12_SAFEBAG *)0x0) {
            OPENSSL_sk_pop_free(psVar2,0x147251,pkey);
            goto LAB_001d5412;
          }
          iVar3 = parse_bags_constprop_1(psVar4,pass,pkey,iVar1);
          if (iVar3 == 0) {
            OPENSSL_sk_pop_free(psVar4,0x1d51dd);
            OPENSSL_sk_pop_free(psVar2,0x147251);
            goto LAB_001d5412;
          }
          OPENSSL_sk_pop_free(psVar4,0x1d51dd);
        }
      ...
      do {
        ...
        if (ppsVar7 != (stack_st_X509 **)0x0) {
          ...
          if (psVar5 == (stack_st_X509 *)0x0) {
            ...
            *ca = psVar5;
            if (psVar5 == (stack_st_X509 *)0x0) goto LAB_001d5426;
          }
          iVar6 = OPENSSL_sk_push(psVar5,x509);
          if (iVar6 == 0) goto LAB_001d5426;
          x509 = (X509 *)0x0;
        }
        X509_free(x509);
        x509 = (X509 *)OPENSSL_sk_pop(iVar1);
