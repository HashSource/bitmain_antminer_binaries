...

{
  ...
  iVar3 = pthread_create(&show_id,(pthread_attr_t *)0x0,(__start_routine *)0x27775,(void *)0x0);
  if (iVar3 != 0) {
  ...
  usleep(200000);
  read_temperature_from_CtrlBoard_N_times('\x03');
  ...
  iVar3 = pthread_create(&m_board_protect_id,(pthread_attr_t *)0x0,(__start_routine *)0xb961d,
                         (void *)0x0);
  if (iVar3 != 0) {
    err_exit("thread err");
  }
  ...
  usleep(100000);
  gStart_receive = true;
  iVar3 = pthread_create(&receive_id,(pthread_attr_t *)0x0,(__start_routine *)0xb8ae9,(void *)0x0);
  if (iVar3 != 0) {
