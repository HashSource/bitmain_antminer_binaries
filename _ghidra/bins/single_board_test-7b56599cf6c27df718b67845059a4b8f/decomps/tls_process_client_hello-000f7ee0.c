...
LAB_000f8106:
              ...
              param_2[1] = iVar12;
              *param_2 = iVar9 + 0x20;
              if (iVar12 == 0) goto LAB_000f8106;
              uVar11 = (uint)*(byte *)(iVar9 + 0x20);
              uVar6 = iVar14 - 0x21;
              if (uVar6 < uVar11) goto LAB_000f8106;
...
LAB_000f80b2:
              ...
              *param_2 = (int)(pbVar8 + 4);
              param_2[1] = iVar12 - 4U;
              if (iVar12 - 4U < 2) goto LAB_000f80b2;
              bVar3 = pbVar8[4];
              bVar4 = pbVar8[5];
              *param_2 = (int)(pbVar8 + 6);
              param_2[1] = iVar12 - 6U;
              if (iVar12 - 6U < 2) goto LAB_000f80b2;
        ...
        if (param_2[1] != 0) {
          ...
          *param_2 = (int)((char *)*param_2 + 1);
          param_2[1] = uVar11;
          if (cVar5 == '\x01') goto LAB_000f7ff0;
        }
        uVar10 = 0x5ae;
LAB_000f7f46:
