...

{
  ...
  char data [10];
  json_error_t error;
  json_t *pattern_asic_nonces_array [108];
  ...
  memset(pattern_asic_nonces_array,0,0x1b0);
  data[0] = '\0';
  data[1] = '\0';
  data[2] = '\0';
  data[3] = '\0';
  ...
  if ((json == (json_t *)0x0) || (json->type != JSON_OBJECT)) {
    ...
    pcVar3 = json_dumps(json,0);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : content: %s\n","prepare_MES_system_submit_information",pcVar3);
    snprintf(tmp1,0x100,"content: %s",pcVar3);
    log_to_file(tmp1,time_stamp);
    pjVar4 = json_object_get(json,"params");
    if ((pjVar4 == (json_t *)0x0) || (pjVar4->type != JSON_OBJECT)) {
      ...
      pjVar5 = json_object_get(pjVar4,"software_commit_id");
      if ((pjVar5 == (json_t *)0x0) || (pjVar5->type != JSON_STRING)) {
        ...
        json_string_set(pjVar5,zhiju_software_commit_id);
        print_time_stamp(time_stamp,0x30);
        printf("%s ",time_stamp);
        pcVar3 = json_string_value(pjVar5);
        printf("%s : software_commit_id: %s\n","prepare_MES_system_submit_information",pcVar3);
        pcVar3 = json_string_value(pjVar5);
        snprintf(tmp1,0x100,"software_commit_id: %s",pcVar3);
        log_to_file(tmp1,time_stamp);
        pjVar4 = json_object_get(pjVar4,"datas");
        if ((pjVar4 == (json_t *)0x0) || (pjVar4->type != JSON_ARRAY)) {
          ...
          sVar6 = json_array_size(pjVar4);
          for (datas_array_index = 0; datas_array_index < sVar6;
              datas_array_index = datas_array_index + 1) {
            pjVar5 = json_array_get(pjVar4,datas_array_index);
            datas_array[datas_array_index] = pjVar5;
            ...
            pjVar5 = json_object_get(datas_array[datas_array_index],"miner_type");
            if ((pjVar5 == (json_t *)0x0) || (pjVar5->type != JSON_STRING)) {
              print_time_stamp(time_stamp,0x30);
              printf("%s ",time_stamp);
            ...
            json_string_set(pjVar5,(Local_Config_Information->Hash_Board).Miner_Type);
            print_time_stamp(time_stamp,0x30);
            printf("%s ",time_stamp);
            pcVar3 = json_string_value(pjVar5);
            printf("%s : miner_type: %s\n","prepare_MES_system_submit_information",pcVar3);
            pcVar3 = json_string_value(pjVar5);
            snprintf(tmp1,0x100,"miner_type: %s",pcVar3);
            log_to_file(tmp1,time_stamp);
            pjVar5 = json_object_get(datas_array[datas_array_index],"board_name");
            if ((pjVar5 == (json_t *)0x0) || (pjVar5->type != JSON_STRING)) {
              print_time_stamp(time_stamp,0x30);
              printf("%s ",time_stamp);
            ...
            json_string_set(pjVar5,(Local_Config_Information->Hash_Board).Board_Name);
            print_time_stamp(time_stamp,0x30);
            printf("%s ",time_stamp);
            pcVar3 = json_string_value(pjVar5);
            printf("%s : board_name: %s\n","prepare_MES_system_submit_information",pcVar3);
            pcVar3 = json_string_value(pjVar5);
            snprintf(tmp1,0x100,"board_name: %s",pcVar3);
            log_to_file(tmp1,time_stamp);
            pjVar5 = json_object_get(datas_array[datas_array_index],"sn");
            if ((pjVar5 == (json_t *)0x0) || (pjVar5->type != JSON_STRING)) {
              print_time_stamp(time_stamp,0x30);
              printf("%s ",time_stamp);
            ...
            json_string_set(pjVar5,sn.board_sn);
            print_time_stamp(time_stamp,0x30);
            printf("%s ",time_stamp);
            pcVar3 = json_string_value(pjVar5);
            printf("%s : sn: %s\n","prepare_MES_system_submit_information",pcVar3);
            pcVar3 = json_string_value(pjVar5);
            snprintf(tmp1,0x100,"sn: %s",pcVar3);
            log_to_file(tmp1,time_stamp);
            pjVar5 = json_object_get(datas_array[datas_array_index],"order_id");
            if ((pjVar5 == (json_t *)0x0) || (pjVar5->type != JSON_STRING)) {
              print_time_stamp(time_stamp,0x30);
              printf("%s ",time_stamp);
            ...
            json_string_set(pjVar5,qr_code.factory_job);
            print_time_stamp(time_stamp,0x30);
            printf("%s ",time_stamp);
            pcVar3 = json_string_value(pjVar5);
            printf("%s : order_id: %s\n","prepare_MES_system_submit_information",pcVar3);
            pcVar3 = json_string_value(pjVar5);
            snprintf(tmp1,0x100,"order_id: %s",pcVar3);
            log_to_file(tmp1,time_stamp);
            pjVar5 = json_object_get(datas_array[datas_array_index],"hardware_version");
            if ((pjVar5 == (json_t *)0x0) || (pjVar5->type != JSON_STRING)) {
              print_time_stamp(time_stamp,0x30);
              printf("%s ",time_stamp);
            ...
            json_string_set(pjVar5,data);
            print_time_stamp(time_stamp,0x30);
            printf("%s ",time_stamp);
            pcVar3 = json_string_value(pjVar5);
            printf("%s : hardware_version: %s\n","prepare_MES_system_submit_information",pcVar3);
            pcVar3 = json_string_value(pjVar5);
            snprintf(tmp1,0x100,"hardware_version: %s",pcVar3);
            log_to_file(tmp1,time_stamp);
            pjVar5 = json_object_get(datas_array[datas_array_index],"bom_version");
            if ((pjVar5 == (json_t *)0x0) || (pjVar5->type != JSON_STRING)) {
              print_time_stamp(time_stamp,0x30);
              printf("%s ",time_stamp);
            ...
            pcVar3 = json_string_value(pjVar5);
            snprintf(tmp1,0x100,"bom_version: %s",pcVar3);
            log_to_file(tmp1,time_stamp);
            pjVar5 = json_object_get(datas_array[datas_array_index],"chip_technology");
            if ((pjVar5 == (json_t *)0x0) || (pjVar5->type != JSON_STRING)) {
              print_time_stamp(time_stamp,0x30);
              printf("%s ",time_stamp);
            ...
            pcVar3 = json_string_value(pjVar5);
            snprintf(tmp1,0x100,"chip_technology: %s",pcVar3);
            log_to_file(tmp1,time_stamp);
            pjVar5 = json_object_get(datas_array[datas_array_index],"ft_version");
            if ((pjVar5 == (json_t *)0x0) || (pjVar5->type != JSON_STRING)) {
              print_time_stamp(time_stamp,0x30);
              printf("%s ",time_stamp);
            ...
            json_string_set(pjVar5,qr_code.chip_ftversion);
            print_time_stamp(time_stamp,0x30);
            printf("%s ",time_stamp);
            pcVar3 = json_string_value(pjVar5);
            printf("%s : ft_version: %s\n","prepare_MES_system_submit_information",pcVar3);
            pcVar3 = json_string_value(pjVar5);
            snprintf(tmp1,0x100,"ft_version: %s",pcVar3);
            log_to_file(tmp1,time_stamp);
            pjVar5 = json_object_get(datas_array[datas_array_index],"bin");
            if ((pjVar5 == (json_t *)0x0) || (pjVar5->type != JSON_INTEGER)) {
              print_time_stamp(time_stamp,0x30);
              printf("%s ",time_stamp);
            ...
            json_integer_set(pjVar5,(ulonglong)(uint)bVar2);
            print_time_stamp(time_stamp,0x30);
            printf("%s ",time_stamp);
            jVar18 = json_integer_value(pjVar5);
            printf("%s : bin: %d\n","prepare_MES_system_submit_information",(int)jVar18);
            jVar18 = json_integer_value(pjVar5);
            snprintf(tmp1,0x100,"bin: %d",(int)jVar18);
            log_to_file(tmp1,time_stamp);
            pjVar5 = json_object_get(datas_array[datas_array_index],"rule_version");
            if ((pjVar5 == (json_t *)0x0) || (pjVar5->type != JSON_STRING)) {
              print_time_stamp(time_stamp,0x30);
              printf("%s ",time_stamp);
            ...
            json_string_set(pjVar5,(Local_Config_Information->Test_Info).Test_Config_Data_Version);
            print_time_stamp(time_stamp,0x30);
            printf("%s ",time_stamp);
            pcVar3 = json_string_value(pjVar5);
            printf("%s : rule_version: %s\n","prepare_MES_system_submit_information",pcVar3);
            pcVar3 = json_string_value(pjVar5);
            snprintf(tmp1,0x100,"rule_version: %s",pcVar3);
            log_to_file(tmp1,time_stamp);
            pjVar5 = json_object_get(datas_array[datas_array_index],"rule_level");
            level_info.level = 0;
            ...
            if (sweep_mode) {
              if (level_info.level < 1) {
                json_integer_set(pjVar5,(ulonglong)(gHistory_Result[test_loop_index].level + 100));
              }
              else {
                json_integer_set(pjVar5,(longlong)level_info.level);
              }
            }
              ...
              json_integer_set(pjVar5,(ulonglong)
            ...
            jVar18 = json_integer_value(pjVar5);
            snprintf(tmp1,0x100,"rule_level: %d",(int)jVar18);
            log_to_file(tmp1,time_stamp);
            pjVar5 = json_object_get(datas_array[datas_array_index],"rule_result");
            ...
            pjVar7 = json_object_get(pjVar5,"result");
            ...
            if (temp) {
              pjVar7 = json_true();
              json_object_set(pjVar5,"result",pjVar7);
              print_time_stamp(time_stamp,0x30);
              printf("%s ",time_stamp);
            ...
            snprintf(tmp1,0x100,"result: %s",pcVar3);
            log_to_file(tmp1,time_stamp);
            pjVar7 = json_object_get(pjVar5,"sensors");
            ...
            if ((Local_Config_Information->Hash_Board).Sensor_Info.Read_Temperature_From_CtrlBoard
              ...
              log_to_file(tmp1,time_stamp);
              iVar8 = json_array_remove(pjVar7,2);
              if (iVar8 != 0) {
                print_time_stamp(time_stamp,0x30);
                printf("%s ",time_stamp);
            ...
            if ((Local_Config_Information->Hash_Board).Sensor_Info.Read_Temperature_From_Asic !=
              ...
              tmp1._28_4_ = tmp1._28_4_ & 0xffffff00;
              log_to_file(tmp1,time_stamp);
              iVar8 = json_array_remove(pjVar7,1);
              if (iVar8 != 0) {
                print_time_stamp(time_stamp,0x30);
                printf("%s ",time_stamp);
            ...
            for (sensors_array_index = 0; sensors_array_index < sVar9;
              ...
              print_time_stamp(time_stamp,0x30);
              printf("%s ",time_stamp);
              pcVar3 = json_string_value(pjVar14);
              printf("%s : name in sensors[%d]: %s\n","prepare_MES_system_submit_information",
                     sensors_array_index,pcVar3);
              pcVar3 = json_string_value(pjVar14);
              snprintf(tmp1,0x100,"name in sensors[%d]: %s",sensors_array_index,pcVar3);
              log_to_file(tmp1,time_stamp);
              ...
              for (sensors_datas_array_index = 0; sensors_datas_array_index < sVar10;
                ...
                pcVar3 = json_string_value(pjVar14);
                iVar8 = strcmp(pcVar3,"PIC");
                if (iVar8 == 0) {
                  json_string_set(pjVar11,qr_code.temp_sensor_type);
                  print_time_stamp(time_stamp,0x30);
                  printf("%s ",time_stamp);
                  pcVar3 = json_string_value(pjVar11);
                  printf("%s : sensors[%d]->datas[%d]->type: %s\n",
                         "prepare_MES_system_submit_information",sensors_array_index,
                         sensors_datas_array_index,pcVar3);
                  pcVar3 = json_string_value(pjVar11);
            ...
            jVar18 = json_integer_value(pjVar14);
            snprintf(tmp1,0x100,"nonce_rate: %d",(int)jVar18);
            log_to_file(tmp1,time_stamp);
            ...
            printf("%s : code: %s\n","prepare_MES_system_submit_information",pcVar3);
            pcVar3 = json_string_value(pjVar14);
            snprintf(tmp1,0x100,"code: %s",pcVar3);
            log_to_file(tmp1,time_stamp);
            ...
            printf("%s : msg: %s\n","prepare_MES_system_submit_information",pcVar3);
            pcVar3 = json_string_value(pjVar14);
            snprintf(tmp1,0x100,"msg: %s",pcVar3);
            log_to_file(tmp1,time_stamp);
            ...
            jVar18 = json_integer_value(pjVar14);
            snprintf(tmp1,0x100,"asic_number: %d",(int)jVar18);
            log_to_file(tmp1,time_stamp);
            ...
            for (pattern_asic_nonces_array_index = 0; pattern_asic_nonces_array_index < sVar9;
              ...
              if (sweep_mode) {
                get_succ_asic_nonce_num((uint16_t *)time_stamp,0x6c);
                ...
                print_time_stamp(time_stamp_84,0x30);
                printf("%s ",time_stamp_84);
                ...
                snprintf(tmp1,0x100,"sensors->asic_nonces[%d]: %d",pattern_asic_nonces_array_index,
                         (int)jVar18);
                log_to_file(tmp1,time_stamp_84);
              }
              else {
                json_integer_set(pattern_asic_nonces_array[pattern_asic_nonces_array_index],
                                 (ulonglong)
            ...
            pjVar5 = json_object_get(pjVar5,"commons");
            ...
            for (commons_array_index = 0; commons_array_index < sVar9;
              ...
              printf("%s : commons[%d]->name: %s\n","prepare_MES_system_submit_information",
                     commons_array_index,pcVar3);
              pcVar3 = json_string_value(pjVar7);
              snprintf(tmp1,0x100,"commons[%d]->name: %s",commons_array_index,pcVar3);
              log_to_file(tmp1,time_stamp);
              ...
              printf("%s : commons[%d]->code: %s\n","prepare_MES_system_submit_information",
                     commons_array_index,pcVar3);
              pcVar3 = json_string_value(pjVar14);
              snprintf(tmp1,0x100,"commons[%d]->code: %s",commons_array_index,pcVar3);
              log_to_file(tmp1,time_stamp);
              ...
              printf("%s : commons[%d]->msg: %s\n","prepare_MES_system_submit_information",
                     commons_array_index,pcVar3);
              pcVar3 = json_string_value(pjVar14);
              snprintf(tmp1,0x100,"commons[%d]->msg: %s",commons_array_index,pcVar3);
              log_to_file(tmp1,time_stamp);
            }
          }
          pcVar3 = json_dumps(json,0);
          mes_system_submit_result_file_length = strlen(pcVar3);
          memcpy(submit_result_handshake_information,pcVar3,mes_system_submit_result_file_length);
          print_time_stamp(time_stamp,0x30);
          printf("%s ",time_stamp);
