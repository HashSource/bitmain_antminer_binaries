...
LAB_00115400:
      ...
      if (iVar2 < 0) {
        ...
        if ((-1 < iVar3) || (-1 < iVar1)) goto LAB_001153c4;
      }
      x = X509_dup(param_2);
      if (x != (X509 *)0x0) {
        ...
        if (param_3 != (X509 *)0x0) {
          ...
          if ((uVar7 != 0 || iVar3 < -1) || uVar5 != 0) goto LAB_001153c6;
          bVar8 = iVar1 == 0;
          if (-1 < iVar1) {
            bVar8 = iVar2 == -1;
          }
          if (bVar8) goto LAB_001153c6;
          bVar8 = iVar2 == 0;
          if (-1 < iVar2) {
            bVar8 = iVar1 == -1;
          }
          ...
          if (iVar1 != -1) {
            ...
            if ((((pXVar4 == (X509_EXTENSION *)0x0) || (ex == (X509_EXTENSION *)0x0)) ||
               ...
               (iVar1 = X509_EXTENSION_set_data(ex,data), iVar1 == 0)) goto LAB_001153c6;
          }
        }
