      ...
      if (param_6 != 0) {
        ...
        do {
          while (((HintPreloadData(puVar6 + 0x29), puVar6[2] == 0 || ((param_3 & puVar6[1]) == 0))
            ...
            puVar6 = puVar6 + 8;
            if (puVar6 == &tls_version_table) goto LAB_000e7398;
          }
          iVar4 = (*(code *)puVar6[2])(param_1,param_3);
          if (iVar4 == 0) goto LAB_000e725e;
          puVar6 = puVar6 + 8;
    ...
    if (1 < uVar13) {
      ...
      do {
        ...
        do {
          if (uVar11 == *puVar8) {
            uVar9 = puVar8[1];
            if ((param_3 & uVar9) == 0) goto LAB_000e72ce;
            ...
            if (iVar1 < 0) goto LAB_000e72ce;
            puVar6 = (undefined4 *)((int)ptr + iVar5 * 0x18);
            if (puVar6 != (undefined4 *)0x0) goto LAB_000e718c;
            goto LAB_000e72c4;
          }
          iVar5 = iVar5 + 1;
          puVar8 = puVar8 + 8;
        ...
        if (iVar4 != 0) {
          ...
          if (iVar5 == 0) goto LAB_000e72c4;
          uVar9 = *(uint *)(iVar5 + 8);
          if ((param_3 & uVar9) != 0) {
            if (-1 < *(int *)(*(int *)(*(int *)(param_1 + 4) + 100) + 0x30) << 0x1c) {
              if (-1 < (int)(uVar9 << 0x1e)) goto LAB_000e72b4;
              goto LAB_000e72ce;
            }
            if ((int)(uVar9 << 0x1f) < 0) goto LAB_000e72ce;
LAB_000e72b4:
            puVar6 = (undefined4 *)((int)ptr + (local_2c[0] + 0x1a) * 0x18);
            if (puVar6 == (undefined4 *)0x0) goto LAB_000e72c4;
LAB_000e718c:
            if (puVar6[2] == 1) goto LAB_000e72ce;
            goto LAB_000e7194;
          }
LAB_000e72ce:
...
LAB_000e7194:
        if ((uVar7 != 0 && uVar11 == 0x29) && (uVar13 != 0)) goto LAB_000e72ce;
