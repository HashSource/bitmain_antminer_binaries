...

{
  ...
  if (r_00 != (BIGNUM *)0x0) {
    if (*(int *)(param_3 + 4) == 1) {
      ...
      if (2 < iVar9 - 1U) goto LAB_00150a42;
    }
    else {
      iVar9 = 0;
    }
    ...
    if (iVar6 << 0x1d < 0) {
      mod = BN_new();
      if (mod == (BIGNUM *)0x0) goto LAB_00150a42;
...
LAB_00150c60:
          ...
          BN_free(mod);
          if (*(undefined **)(*(int *)(param_3 + 8) + 0x18) != (undefined *)0x189b61)
          goto LAB_00150c60;
          iVar8 = BN_num_bits(*(BIGNUM **)(param_3 + 0x20));
          iVar4 = BN_num_bits(*(BIGNUM **)(param_3 + 0x1c));
          iVar6 = *(int *)(param_3 + 0x40);
          if (iVar8 != iVar4) goto LAB_00150a2e;
          if ((((((iVar6 << 0x1e < 0) &&
                 (pBVar2 = BN_MONT_CTX_set_locked
...
LAB_00150a2e:
    if (((-1 < iVar6 << 0x1e) ||
      ...
      if (mod != (BIGNUM *)0x0) {
        ...
        if (pBVar7 == (BIGNUM *)0x0) goto LAB_00150c68;
        BN_free(mod);
        if (iVar9 != 0) {
          mod = BN_new();
          a = BN_new();
...
LAB_00150bb2:
        ...
        if (((iVar6 != 0) &&
          ...
          if ((((iVar6 == 0) ||
            ...
            if (iVar9 != 0) {
              pBVar1 = BN_new();
              if (pBVar1 == (BIGNUM *)0x0) goto LAB_00150a42;
              iVar6 = 0;
              do {
