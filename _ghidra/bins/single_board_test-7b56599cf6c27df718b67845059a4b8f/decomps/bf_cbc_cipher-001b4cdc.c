...
undefined4 bf_cbc_cipher(undefined4 param_1,uchar *param_2,uchar *param_3,uint param_4)

{
  ...
  if (0x3fffffff < param_4) {
    do {
      ...
      BF_cbc_encrypt(in,puVar3,0x40000000,pBVar1,ivec,iVar2);
  ...
  if (param_4 != 0) {
    ...
    iVar2 = EVP_CIPHER_CTX_encrypting(param_1);
    BF_cbc_encrypt(local_2c,param_2,param_4,pBVar1,puVar3,iVar2);
  }
  return 1;
}
