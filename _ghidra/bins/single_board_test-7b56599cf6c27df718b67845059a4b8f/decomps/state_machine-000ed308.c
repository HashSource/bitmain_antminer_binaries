...
joined_r0x000ed930:
  ...
  if ((uVar3 & 0xfffffffb) == 0) {
    ...
    if (local_58 == (SRTP_PROTECTION_PROFILE *)0x0) {
LAB_000ed388:
      if (-1 < *(int *)(*(int *)(param_1->type + 100) + 0x30) << 0x1c) goto LAB_000ed89e;
...
LAB_000ed650:
      ...
      if (param_1->in_handshake == 0) {
        pcVar12 = (code *)0xef751;
        pcVar10 = (code *)0xf1eb5;
        pcVar9 = (code *)0xf1b55;
        pcVar11 = (code *)0xeef29;
      }
      else {
        pcVar12 = (code *)0xf7dd5;
        pcVar10 = (code *)0xf99f1;
        pcVar9 = (code *)0xfa0f9;
        pcVar11 = (code *)0xf7241;
      }
...
LAB_000ed696:
      ...
      do {
        if (!bVar13) {
          ...
          if (iVar2 == 0) goto switchD_000ed76e_caseD_3;
          if (pSVar8 != (SRTP_PROTECTION_PROFILE *)0x0) {
            if (param_1->in_handshake == 0) {
...
joined_r0x000ed794:
            ...
            if (-1 < local_44) {
              ...
              param_1->cipher_list = (stack_st_SSL_CIPHER *)0x0;
              if (iVar2 == 1) goto switchD_000ed76e_caseD_1;
              if (iVar2 != 0) {
                if (iVar2 == 2) {
                  param_1->rstate = 2;
...
switchD_000ed76e_caseD_2:
    ...
    if (uVar3 == 3) {
      ...
      if (param_1->in_handshake == 0) {
        pcVar9 = (code *)0xef629;
        pcVar10 = (code *)0xf0df9;
        pcVar12 = (code *)0xef591;
        pcVar11 = (code *)0xef305;
      }
      else {
        pcVar9 = (code *)0xf7c65;
        pcVar10 = (code *)0xf79f9;
        pcVar12 = (code *)0xf78ad;
        pcVar11 = (code *)0xf7561;
      }
...
LAB_000ed5bc:
        ...
        if (iVar2 != 2) goto switchD_000ed55c_default;
      ...
      case 1:
        ...
        case 0:
          ...
          break;
        case 1:
          goto switchD_000ed55c_caseD_1;
        case 2:
          param_1->shutdown = 2;
        default:
          iVar2 = (*pcVar9)(param_1,&local_40,&local_48,&local_44);
          if (iVar2 != 0) {
            if (local_44 == -1) goto LAB_000ed850;
...
LAB_000ed6f8:
            ...
            if (param_1->init_msg != (void *)0x23 && param_1->init_msg != (void *)0x10)
            goto LAB_000ed6f8;
            if (-1 < *(int *)(iVar2 + 0x30) << 0x1c) goto LAB_000ed6cc;
          }
...
LAB_000ed53e:
        if (iVar2 < 1) goto switchD_000ed76e_caseD_3;
        iVar2 = 3;
        param_1->shutdown = 3;
        param_1->state = 3;
        break;
