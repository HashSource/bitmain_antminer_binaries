...

{
  ...
  *(undefined4 *)(param_1 + 0xf8c) = 0;
  if ((*(int *)(param_1 + 0x1c) == 0) &&
    ...
    iVar8 = iVar9;
    local_2c[0] = psVar3;
    if ((*(uint *)(param_1 + 0x4ec) & 0x400000) != 0) goto LAB_000fbea2;
LAB_000fbfe8:
    iVar8 = iVar9;
    if (uVar6 != 0) goto LAB_000fbea2;
    ...
    iVar5 = *(int *)(param_1 + 0x7c);
    iVar8 = iVar9;
    if ((*(uint *)(param_1 + 0x4ec) & 0x400000) == 0) goto LAB_000fbfe8;
LAB_000fbea2:
...
LAB_000fbecc:
    do {
      ...
      do {
        if (*(short *)(puVar4 + 4) == *psVar3) goto LAB_000fbee6;
        puVar4 = puVar4 + 0x20;
...
LAB_000fbf24:
      ...
      if (*local_38 != *psVar3) {
        ...
        do {
          iVar1 = iVar1 + 1;
          if (iVar9 == iVar1) goto LAB_000fbf24;
          psVar2 = psVar2 + 1;
        } while (*psVar2 != *psVar3);
      }
      iVar5 = iVar5 + 1;
...
LAB_000fc05a:
      do {
        puVar4 = &sigalg_lookup_tbl;
        do {
          if (*(short *)(puVar4 + 4) == *local_40) goto LAB_000fc06e;
          puVar4 = puVar4 + 0x20;
        } while (puVar4 != legacy_rsa_sigalg);
        puVar4 = (undefined1 *)0x0;
LAB_000fc06e:
...
LAB_000fc0ac:
        ...
        if (*local_38 != *local_40) {
          ...
          do {
            iVar1 = iVar1 + 1;
            if (iVar9 == iVar1) goto LAB_000fc0ac;
            psVar3 = psVar3 + 1;
          } while (*psVar3 != *local_40);
        }
        local_44 = local_44 + 1;
        if (local_34 == (undefined4 *)0x0) goto LAB_000fc0ac;
        iVar5 = iVar5 + 1;
        *local_34 = puVar4;
        local_34 = local_34 + 1;
        local_40 = local_40 + 1;
...
LAB_000fbf94:
      if (*(int *)((int)__s + iVar9 * 4) != 0) goto LAB_000fbf68;
      ...
      if (((iVar1 == 0x10000 || iVar1 == 0x303) || iVar5 < 0 != bVar10) ||
         (*(int *)(puVar7[iVar8] + 0x10) != 6)) goto LAB_000fbf94;
LAB_000fbf68:
      if (uVar6 <= iVar8 + 1U) {
        return 1;
      }
