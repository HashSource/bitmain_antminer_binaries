...
LAB_0018a63a:
    if (m_ctx != (BN_MONT_CTX *)0x0) goto LAB_0018a640;
  }
  else {
        ...
        if (iVar6 == 0) {
          ...
          if (r_01 != (BIGNUM *)0x0) {
            if (local_144 != 1) {
              ...
              if (r_01 == (BIGNUM *)0x0) goto LAB_0018a63a;
              iVar6 = 1;
              ppBVar10 = local_128;
              do {
                iVar6 = iVar6 + 1;
