...

{
  ...
  if (UNRECOVERED_JUMPTABLE_00 != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x001bdbf2. Too many branches */
  ...
  if (UNRECOVERED_JUMPTABLE_00 != (code *)0x0) {
    if (param_3 != 2) {
      return 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x001bdc14. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    if (r != (BIGNUM *)0x0) {
      ...
      if (*(int *)(param_1 + 0x10) == 0) {
        ...
        *(BIGNUM **)(param_1 + 0x10) = pBVar4;
        if (pBVar4 == (BIGNUM *)0x0) goto LAB_001bdd8c;
      }
      if (*(int *)(param_1 + 0x18) == 0) {
        iVar2 = BN_secure_new();
        *(int *)(param_1 + 0x18) = iVar2;
        if (iVar2 == 0) goto LAB_001bdd8c;
      }
      ...
      if (param_3 < 3) {
        ...
        *(undefined4 *)(param_1 + 4) = 1;
        ...
        if (*(int *)(param_1 + 0x30) != 0) {
          OPENSSL_sk_pop_free(*(int *)(param_1 + 0x30),0x150845);
        }
        iVar10 = 2;
        *(int *)(param_1 + 0x30) = iVar2;
        do {
          ...
          iVar10 = iVar10 + 1;
          if (local_48 == (undefined4 *)0x0) goto LAB_001bdd8c;
...
LAB_001bddfa:
        ...
        if (pBVar9 == (BIGNUM *)0x0) {
          ...
          if ((uVar8 >> 0x18 != 3) || ((uVar8 & 0xfff) != 0x6c)) goto LAB_001bdd8c;
          ERR_pop_to_mark();
        ...
        if (iVar13 == 1) {
          ...
          if (iVar13 == 0) {
            ...
            if (iVar13 == 0) goto LAB_001bdd8c;
            iVar13 = 1;
            goto LAB_001bddca;
          }
          iVar5 = BN_mul(ret,*(BIGNUM **)(param_1 + 0x10),pBVar4,ctx);
        }
        if ((iVar5 == 0) || (iVar5 = BN_rshift(r,ret,iVar12 + -4), iVar5 == 0)) goto LAB_001bdd8c;
        uVar8 = BN_get_word(r);
        if (uVar8 - 9 < 7) {
          if ((((1 < iVar13) &&
             ...
             (iVar14 = BN_GENCB_call(param_5,3,iVar13), iVar14 == 0)) goto LAB_001bdd8c;
          iVar13 = iVar13 + 1;
          if (iVar13 < param_3) goto LAB_001bddca;
          ...
          if (iVar10 == 0) goto LAB_001bdd8c;
          pBVar9 = *(BIGNUM **)(param_1 + 0x20);
          pBVar4 = BN_value_one();
          iVar10 = BN_sub(r,pBVar9,pBVar4);
          if ((iVar10 == 0) || (iVar10 = BN_mul(pBVar3,ret,r,ctx), iVar10 == 0)) goto LAB_001bdd8c;
          iVar10 = 2;
          goto LAB_001be074;
        }
        iVar5 = BN_GENCB_call(param_5,2,iVar10);
        if (iVar5 == 0) goto LAB_001bdd8c;
        if (param_3 < 5) {
          if (local_60 == 4) goto code_r0x001bdee6;
        }
        else {
          if (uVar8 < 9) {
            local_58 = local_58 + 1;
...
LAB_001be074:
  if (param_3 <= iVar10) {
    ...
    if (pBVar4 != (BIGNUM *)0x0) {
      ...
      if (pBVar3 == (BIGNUM *)0x0) goto LAB_001be13e;
      BN_free(pBVar4);
      pBVar4 = BN_new();
      if (pBVar4 != (BIGNUM *)0x0) {
