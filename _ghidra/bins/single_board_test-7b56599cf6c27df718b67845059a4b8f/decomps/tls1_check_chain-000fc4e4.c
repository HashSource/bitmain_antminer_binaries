...
LAB_000fc746:
      ...
      if (uVar11 == 0) goto LAB_000fc59e;
      if (*(int *)(param_1->mac_flags + 0x26c) == 0) {
        iVar2 = 0;
        if (*(int *)(param_1->mac_flags + 0x268) != 0) goto LAB_000fc774;
        if (6 < param_5) {
          iVar2 = -1;
          goto LAB_000fc774;
        }
        iVar2 = *(int *)(CSWTCH_165 + local_3c);
        if (iVar2 < 1) goto LAB_000fc774;
        if (piVar18[0x34] == 0) {
LAB_000fc9ce:
          piVar18 = (int *)param_1->type;
          local_3c = iVar2;
          if (-1 < *(int *)(piVar18[0x19] + 0x30) << 0x1c) goto LAB_000fc77e;
          goto LAB_000fc880;
        }
        iVar4 = piVar18[0x35];
        uVar11 = uVar15;
            ...
            do {
              if (*(short *)(puVar13 + 4) == *psVar14) {
                if ((*(int *)(puVar13 + 8) == 0x40) &&
                  ...
                  if (iVar6 != iVar4) goto LAB_000fc9ce;
                  goto joined_r0x000fc9be;
                }
                break;
              }
...
joined_r0x000fc9be:
        uVar15 = uVar16;
        if (local_40 == 0) goto LAB_000fc54e;
        goto LAB_000fc710;
      }
      local_3c = 0;
      iVar2 = local_3c;
...
LAB_000fc89c:
        ...
        do {
          ...
          if (iVar4 <= iVar2) goto LAB_000fc7d0;
...
LAB_000fc77e:
      if (*piVar18 == 0x10000 || *piVar18 < 0x304) goto LAB_000fc87a;
      iVar2 = find_sig_alg(param_1,param_2,param_3);
      if (iVar2 != 0) goto LAB_000fc7a6;
LAB_000fc7aa:
      uVar16 = uVar15 | 0x20;
      if (local_3c != -1) goto LAB_000fc89c;
      iVar2 = 0;
      while( true ) {
        iVar4 = OPENSSL_sk_num(param_4);
...
LAB_000fc5d6:
        uVar15 = uVar11 | 0x600;
        if (local_40 != 0) goto LAB_000fc704;
      }
      else {
LAB_000fc7ea:
...
LAB_000fc834:
          ...
          if (*(int *)(iVar2 + 0x220) != 0) {
            if (*pcVar12 != cVar1) {
              ...
              do {
                pcVar12 = pcVar12 + 1;
                if (pcVar9 == pcVar12) goto LAB_000fc85a;
              } while (*pcVar12 != cVar1);
            }
            uVar15 = uVar15 | 0x400;
          }
...
LAB_000fc8f8:
          ...
          if (iVar4 < iVar6) goto LAB_000fc8e8;
...
LAB_000fc818:
        if (local_40 != 0) goto LAB_000fc704;
        if (-1 < (int)(uVar15 << 0x16)) goto LAB_000fc54e;
      }
    }
    else {
      uVar15 = uVar11 | 0x80;
      iVar2 = 0;
      if (uVar17 == 0) goto LAB_000fc5d6;
      do {
        iVar4 = OPENSSL_sk_num(param_4);
        if (iVar4 <= iVar2) {
      ...
      if (local_40 == 0) goto LAB_000fc54e;
      uVar15 = uVar11;
      if (param_1->in_handshake == 0) goto LAB_000fc7ea;
      uVar15 = uVar11 | 0x600;
LAB_000fc704:
      if ((local_40 & ~uVar15) != 0) goto LAB_000fc54e;
    }
    uVar15 = uVar15 | 1;
    iVar2 = SSL_version(param_1);
  }
