...
/* WARNING: Removing unreachable block (ram,0x000949e2) */
/* WARNING: Removing unreachable block (ram,0x000949ec) */
/* WARNING: Removing unreachable block (ram,0x000949ee) */
/* WARNING: Removing unreachable block (ram,0x000949f0) */
/* WARNING: Removing unreachable block (ram,0x000949f6) */
/* WARNING: Removing unreachable block (ram,0x000945c6) */
/* WARNING: Removing unreachable block (ram,0x000945ce) */
/* WARNING: Removing unreachable block (ram,0x000945de) */
/* WARNING: Removing unreachable block (ram,0x000945d6) */
...
LAB_0009471e:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_00094e7a;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_00094e7a;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_0009471e;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_00094e7a;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_00094e7a;
              op = pBVar10;
