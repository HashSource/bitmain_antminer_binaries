...
uint aria_ccm_cipher(undefined4 param_1,undefined4 *param_2,undefined4 *param_3,uint param_4)

{
  ...
  if (-1 < *(int *)(iVar1 + 0x130)) {
    iVar1 = EVP_CIPHER_CTX_get_cipher_data(param_1);
    if (param_2 != param_3) {
      return 0xffffffff;
    }
    if (param_4 < *(int *)(iVar1 + 300) + 8U) {
      return 0xffffffff;
    }
    ...
    *(undefined4 *)(iVar6 + 8) = uVar3;
    ...
    len = (param_4 - iVar6) - 8;
    iVar6 = CRYPTO_ccm128_setiv(iVar2,uVar3,0xf - *(int *)(iVar1 + 0x128),len);
    if (iVar6 != 0) {
      return 0xffffffff;
    }
    param_2 = param_2 + 2;
    uVar3 = EVP_CIPHER_CTX_buf_noconst(param_1);
    CRYPTO_ccm128_aad(iVar2,uVar3,*(undefined4 *)(iVar1 + 0x130));
    iVar6 = EVP_CIPHER_CTX_encrypting(param_1);
    ...
    if (iVar6 == 0) {
      ...
      if (iVar6 == 0) {
        iVar6 = CRYPTO_ccm128_tag(iVar2,auStack_30,*(undefined4 *)(iVar1 + 300));
        if ((iVar6 != 0) &&
           (iVar1 = CRYPTO_memcmp(auStack_30,(void *)((int)param_2 + len),*(size_t *)(iVar1 + 300)),
           iVar1 == 0)) {
          return len;
        }
      }
    ...
    iVar6 = CRYPTO_ccm128_tag(iVar2,(int)param_2 + len,*(undefined4 *)(iVar1 + 300));
    if (iVar6 == 0) {
      return 0xffffffff;
    }
    return *(int *)(iVar1 + 300) + 8 + len;
  }
  ...
  if (param_2 == (undefined4 *)0x0) {
    if (param_3 == (undefined4 *)0x0) {
      uVar3 = EVP_CIPHER_CTX_iv_noconst(param_1);
      iVar6 = CRYPTO_ccm128_setiv(iVar6,uVar3,0xf - *(int *)(iVar1 + 0x128),param_4);
      if (iVar6 != 0) {
        return 0xffffffff;
      }
    ...
    if (param_4 != 0 && *(int *)(iVar1 + 0x124) == 0) {
      return 0xffffffff;
    }
  ...
  if ((iVar2 == 0) && (*(int *)(iVar1 + 0x120) == 0)) {
    return 0xffffffff;
  }
  if (*(int *)(iVar1 + 0x124) == 0) {
    uVar3 = EVP_CIPHER_CTX_iv_noconst(param_1);
    iVar2 = CRYPTO_ccm128_setiv(iVar6,uVar3,0xf - *(int *)(iVar1 + 0x128),param_4);
    if (iVar2 != 0) {
      return 0xffffffff;
    }
    *(undefined4 *)(iVar1 + 0x124) = 1;
  ...
  if (iVar2 == 0) {
    iVar6 = CRYPTO_ccm128_tag(iVar6,auStack_30,*(undefined4 *)(iVar1 + 300));
    if (iVar6 != 0) {
      b = (void *)EVP_CIPHER_CTX_buf_noconst(param_1);
      iVar6 = CRYPTO_memcmp(auStack_30,b,*(size_t *)(iVar1 + 300));
      if ((iVar6 == 0) && (param_4 != 0xffffffff)) goto LAB_0012bffa;
    }
  }
