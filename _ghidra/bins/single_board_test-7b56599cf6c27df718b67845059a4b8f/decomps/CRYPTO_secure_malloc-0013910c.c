...

{
  ...
  local_38 = DAT_00a27fd0;
  uVar13 = DAT_00a27fdc;
  uVar2 = DAT_00a27fd8;
  if (param_1 <= DAT_00a27fd0) {
    for (; uVar2 = uVar2 - 1, uVar13 < param_1; uVar13 = uVar13 * 2) {
    }
    if (-1 < (int)uVar2) {
      piVar9 = DAT_00a27fd4 + uVar2;
      uVar13 = uVar2;
      do {
        piVar12 = (int *)*piVar9;
        if (piVar12 != (int *)0x0) {
          piVar7 = DAT_00a27fd4;
          if (uVar2 == uVar13) goto LAB_001393e4;
          if ((int)DAT_00a27fd8 <= (int)uVar13) goto LAB_001394b2;
          uVar14 = DAT_00a27fd0 >> (uVar13 & 0xff);
          uVar10 = (int)piVar12 - (int)DAT_00a27fcc;
          if ((uVar14 - 1 & uVar10) != 0) goto LAB_001394c2;
          iVar3 = (int)piVar9 - (int)DAT_00a27fd4;
          iVar6 = (uVar13 + 1) * 4;
          goto LAB_00139386;
        }
        bVar17 = uVar13 != 0;
...
LAB_001394a2:
    ...
    if (((uint)*(byte *)(iVar3 + (uVar13 >> 3)) & 1 << (uVar13 & 7)) != 0) {
      ...
      *(int *)piVar12[1] = iVar3;
      if (((*piVar12 == 0) ||
          ((piVar9 = *(int **)(*piVar12 + 4), DAT_00a27fd4 <= piVar9 &&
           (piVar9 < DAT_00a27fd4 + DAT_00a27fd8)))) ||
         ((DAT_00a27fcc <= piVar9 && (piVar9 < (int *)(DAT_00a27fd0 + (int)DAT_00a27fcc))))) {
        if ((piVar12 < DAT_00a27fcc) || ((int *)((int)DAT_00a27fcc + DAT_00a27fd0) <= piVar12)) {
                    /* WARNING: Subroutine does not return */
  ...
  while( true ) {
    ...
    iVar3 = __aeabi_uidiv();
    uVar10 = iVar3 + iVar5;
    if ((uVar10 == 0) || (DAT_00a27fe8 <= uVar10)) goto LAB_001394a2;
    ...
    sh_setbit(piVar12,uVar13,DAT_00a27fe0);
    sh_add_to_list((int)DAT_00a27fd4 + iVar6,piVar12);
    iVar3 = DAT_00a27fe4;
    if (*(int **)((int)DAT_00a27fd4 + iVar6) != piVar12) {
                    /* WARNING: Subroutine does not return */
      OPENSSL_die("assertion failed: sh.freelist[slist] == temp","crypto/mem_sec.c",0x23e);
    }
    uVar10 = DAT_00a27fd0 >> (uVar13 & 0xff);
    piVar12 = (int *)((int)piVar12 + uVar10);
    if ((int)DAT_00a27fd8 <= (int)uVar13) goto LAB_001394b2;
    if ((uVar10 - 1 & (int)piVar12 - (int)DAT_00a27fcc) != 0) break;
    ...
    piVar7 = DAT_00a27fd4;
    piVar9 = DAT_00a27fcc;
    if (piVar12 != *(int **)((int)DAT_00a27fd4 + iVar6)) {
                    /* WARNING: Subroutine does not return */
    ...
    uVar16 = uVar4 & 7;
    bVar1 = *(byte *)(DAT_00a27fe0 + uVar15) >> uVar16;
    piVar8 = (int *)(bVar1 & 1);
    if ((bVar1 & 1) != 0) {
      if ((*(byte *)(DAT_00a27fe4 + uVar15) >> uVar16 & 1) == 0) {
    ...
    if (uVar13 == uVar2) goto LAB_001393e4;
    if ((int)DAT_00a27fd8 <= (int)uVar13) goto LAB_001394b2;
    iVar3 = iVar6;
    iVar6 = iVar6 + 4;
...
LAB_00139386:
    ...
    sh_clearbit(piVar12,uVar13,DAT_00a27fe0);
    iVar11 = *piVar12;
    if (iVar11 != 0) {
    ...
    *(int *)piVar12[1] = iVar11;
    iVar11 = DAT_00a27fe4;
    if (((*piVar12 != 0) &&
        ((piVar9 = *(int **)(*piVar12 + 4), piVar9 < DAT_00a27fd4 ||
         (DAT_00a27fd4 + DAT_00a27fd8 <= piVar9)))) &&
       ((piVar9 < DAT_00a27fcc || ((int *)(DAT_00a27fd0 + (int)DAT_00a27fcc) <= piVar9)))) {
                    /* WARNING: Subroutine does not return */
      OPENSSL_die("assertion failed: WITHIN_FREELIST(temp2->p_next) || WITHIN_ARENA(temp2->p_next)",
                  "crypto/mem_sec.c",0x17a);
    }
    if (*(int **)((int)DAT_00a27fd4 + iVar3) == piVar12) {
                    /* WARNING: Subroutine does not return */
      OPENSSL_die("assertion failed: temp != sh.freelist[slist]","crypto/mem_sec.c",0x235);
    }
    uVar13 = uVar13 + 1;
    if (((int)uVar13 < 0) || ((int)DAT_00a27fd8 <= (int)uVar13)) goto LAB_001394b2;
    if (((DAT_00a27fd0 >> (uVar13 & 0xff)) - 1 & (int)piVar12 - (int)DAT_00a27fcc) != 0) break;
  }
LAB_001394c2:
                    /* WARNING: Subroutine does not return */
