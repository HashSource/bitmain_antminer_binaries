...

{
  ...
  if ((iVar2 == 0) && (iVar2 = BN_is_zero(*(undefined4 *)(param_1 + 0xc)), iVar2 == 0)) {
    ...
    if (param_3 != (BIGNUM *)0x0 || param_4 != 1) goto LAB_0011f8ce;
...
LAB_0011f8ce:
    if (param_3 == (BIGNUM *)0x0) goto LAB_0011fca4;
...
LAB_0011f9ae:
              ...
              piVar13[1] = 0;
              if (param_4 <= uVar18) goto LAB_0011fa40;
            }
            else {
              uVar3 = 6;
              puVar14[1] = 6;
            ...
            *piVar13 = iVar2;
            ...
            if (uVar3 < 2000) goto LAB_0011f9ae;
            local_38 = local_38 + 0x20;
            uVar3 = 6;
            puVar14[1] = 6;
            piVar13[1] = 0;
