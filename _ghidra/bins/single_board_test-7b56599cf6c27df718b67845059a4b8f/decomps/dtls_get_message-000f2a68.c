...
LAB_000f2a90:
  ...
  do {
    ...
    if (ppVar7 == (pitem *)0x0) goto LAB_000f2aba;
LAB_000f2aa4:
    pvVar19 = ppVar7->data;
    iVar6 = param_1[0x20];
...
LAB_000f2db6:
        ...
        if (ppVar7 != (pitem *)0x0) goto LAB_000f2aa4;
        goto LAB_000f2aba;
      }
...
LAB_000f2e08:
      ...
      if (uVar20 != local_150) goto LAB_000f2db6;
      uVar15 = 0x454c;
