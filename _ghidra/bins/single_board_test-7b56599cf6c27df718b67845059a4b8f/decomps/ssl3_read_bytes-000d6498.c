...
LAB_000d6544:
      do {
        ...
        if (pvVar24 == (void *)0x0) goto LAB_000d66e8;
...
LAB_000d65c0:
          ...
          if (piVar25[2] != 0) goto LAB_000d65c0;
        }
          ...
          if (iVar10 == 0x10000) {
            ...
            if (param_1->new_session << 0x1f < 0) {
              ...
              if (uVar18 != 0) {
                ...
                piVar25[8] = 1;
                piVar25[2] = 0;
                if (-1 < iVar15 << 0x1d) goto LAB_000d6916;
                goto LAB_000d6544;
              }
LAB_000d662e:
              uVar18 = 4 - uVar16;
...
LAB_000d66a6:
                  ...
                  if (iVar15 != 0x17) goto LAB_000d6966;
              ...
              if (iVar15 == 0x16) goto LAB_000d662e;
              if (iVar15 != 0x14) {
                if (3 < uVar16) goto LAB_000d6690;
                if (0x13 < iVar15) goto LAB_000d66a6;
                goto LAB_000d6966;
              }
            }
            uVar22 = 0x677;
            ...
            if (iVar15 == 2) {
              ...
              if (cVar3 == '\x01') {
                ...
                *(uint *)(param_1->mac_flags + 0xe0) = uVar16;
                ...
                if (pKVar20 == (KSSL_CTX *)&DAT_00000005) goto LAB_000d6a30;
                if (bVar6) {
                  if (uVar16 != 0x5a) goto LAB_000d69d4;
                  goto LAB_000d6544;
                }
                if (uVar16 == 0) goto LAB_000d6c6e;
LAB_000d6ad0:
                bVar4 = bVar7;
                if (cVar3 == '\x02') {
                  bVar4 = true;
...
LAB_000d6c6e:
                ...
                if (cVar3 == '\x02') goto LAB_000d6c7a;
              }
              if (cVar3 != '\x01') {
...
LAB_000d6a5c:
            ...
            else if (piVar25[2] == uVar18) goto LAB_000d6a5c;
            uVar16 = uVar16 + uVar18;
          } while (pvVar23 < pvVar24 && (uVar16 < param_5 && bVar4));
        }
        if (uVar16 != 0) {
