...
int RAND_DRBG_new(undefined4 param_1,undefined4 param_2,int param_3)

{
  ...
  iVar3 = CRYPTO_zalloc(0x104,"crypto/rand/drbg_lib.c",0xc0);
  if (iVar3 == 0) {
    ERR_put_error(0x24,0x6d,0x41,"crypto/rand/drbg_lib.c",0xc3);
    return 0;
  }
  *(undefined4 *)(iVar3 + 8) = 0;
  _Var4 = openssl_get_fork_id();
  *(int *)(iVar3 + 4) = param_3;
  *(__pid_t *)(iVar3 + 0x10) = _Var4;
  if (param_3 == 0) {
    *(undefined4 *)(iVar3 + 0xf4) = 0x14c439;
    *(undefined4 *)(iVar3 + 0xf8) = 0x14bcf9;
    uVar2 = master_reseed_time_interval;
    uVar1 = master_reseed_interval;
    *(undefined4 *)(iVar3 + 0xfc) = 0x14c255;
    *(undefined4 *)(iVar3 + 0x44) = uVar1;
    *(undefined4 *)(iVar3 + 0x4c) = uVar2;
    *(undefined4 *)(iVar3 + 0x100) = 0x14bd31;
    iVar5 = RAND_DRBG_set(iVar3,param_1,param_2);
    if (iVar5 != 0) {
      return iVar3;
    }
  }
