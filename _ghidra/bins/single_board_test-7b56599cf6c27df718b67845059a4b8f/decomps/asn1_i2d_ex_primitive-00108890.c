...

{
  ...
  if (local_30 - 1 < 10) {
    unaff_r5 = (code *)((int)&switchD_00108980::switchdataD_00108984 +
                       (&switchD_00108980::switchdataD_00108984)[local_30 - 1]);
    switch(local_30) {
    case 1:
...
switchD_00108980_caseD_4:
  ...
  if (param_2 == (uchar **)0x0) goto LAB_0010891a;
  ...
  if ((*(int *)(param_3 + 0x10) == 0) ||
    ...
    if (*param_3 == '\0') {
      ...
      if (iVar6 != 1) {
        puVar5 = (uint *)*param_1;
        if (puVar5 == (uint *)0x0) goto switchD_001089d4_caseD_5;
LAB_001089be:
        if (iVar6 == -4) {
          param_1 = puVar5 + 1;
          local_30 = *puVar5;
...
LAB_00108aea:
        ...
        if (uVar4 == 0) {
          if (*(int *)(param_3 + 0x14) != 0) goto LAB_00108aea;
        }
        else if (*(int *)(param_3 + 0x14) < 1) goto LAB_00108aea;
      }
      break;
    case 2:
    case 10:
