  ...
  if ((uVar6 & 6) != 0) {
    ...
    if (0 < iVar1) {
      do {
        ...
        if (pAVar9->itype != '\0') {
          if (local_88 == (ASN1_UTCTIME *)0x0) goto LAB_00185992;
          switch(pAVar9->itype) {
          case '\x01':
          case '\x06':
            if (local_a8 != (code *)0x0) {
          ...
          case '\x04':
            ...
            break;
          case '\x05':
            goto switchD_00185a22_caseD_5;
          }
          goto LAB_001859ac;
        }
        if ((pAVar9->utype != 1) && (local_88 == (ASN1_UTCTIME *)0x0)) {
LAB_00185992:
          if (-1 < (int)(*param_5 << 0x1f)) goto LAB_001859ac;
          iVar1 = BIO_puts(param_1,"<ABSENT>\n");
          goto joined_r0x001859a8;
        }
...
switchD_00185d0e_caseD_1:
          iVar1 = *piVar15;
          if (iVar1 == -1) {
            iVar1 = pAVar9->size;
            pcVar8 = "BOOL ABSENT";
            if (iVar1 != -1) goto LAB_00185dfe;
          }
          else {
LAB_00185dfe:
            pcVar8 = local_94;
...
LAB_00185b90:
        if (uVar6 == 0xfffffffc) {
          ...
          if ((int)(*param_5 << 0x1b) < 0) goto LAB_00185ba6;
          pcVar8 = ASN1_tag2str(uVar6);
LAB_00185cda:
          if (uVar6 == 5) goto LAB_00185bae;
          if (pcVar8 != (char *)0x0) {
...
LAB_00185bae:
        ...
        case 4:
          ...
          if (a_00->length < 1) goto LAB_001859ac;
...
LAB_00185c02:
  ...
  if ((pAVar9->utype != 1) && ((ASN1_VALUE *)*param_2 == (ASN1_VALUE *)0x0)) goto LAB_00185c02;
  if (pAVar9->templates != (ASN1_TEMPLATE *)0x0) {
...
LAB_00186102:
  if (uVar6 != 0xfffffffc) {
    if ((int)(*param_5 << 0x1c) < 0) goto LAB_0018618e;
LAB_00186110:
    if (uVar6 != 5) goto LAB_001861b8;
LAB_00186114:
    iVar1 = BIO_puts(param_1,"NULL\n");
    goto joined_r0x001861fc;
  }
  param_2 = &a->type;
  uVar6 = a->length;
  a = (ASN1_GENERALIZEDTIME *)a->type;
  if ((int)(*param_5 << 0x1b) < 0) goto LAB_00186110;
LAB_0018618e:
  pcVar8 = ASN1_tag2str(uVar6);
  if (uVar6 == 5) goto LAB_00186114;
  if (pcVar8 != (char *)0x0) {
    iVar1 = BIO_puts(param_1,pcVar8);
    if (iVar1 < 1) {
      return 0;
