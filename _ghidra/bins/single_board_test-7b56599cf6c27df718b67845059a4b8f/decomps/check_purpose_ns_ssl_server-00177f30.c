...

{
  ...
  if ((-1 < (int)(uVar2 << 0x1d)) || (uVar1 = *(uint *)(param_2 + 0x88) & 0x11, uVar1 != 0)) {
    if (param_3 == 0) {
      if (((int)(uVar2 << 0x1c) < 0) && (-1 < *(int *)(param_2 + 0x8c) << 0x19)) {
        return 0;
      }
      if ((int)(uVar2 << 0x1e) < 0) {
        uVar1 = *(uint *)(param_2 + 0x84) & 0xa8;
        if (uVar1 != 0) {
          uVar1 = (*(uint *)(param_2 + 0x84) << 0x1a) >> 0x1f;
        }
      }
      else {
        uVar1 = 1;
