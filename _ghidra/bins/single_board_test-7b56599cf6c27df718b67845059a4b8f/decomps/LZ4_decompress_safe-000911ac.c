...
/* WARNING: Removing unreachable block (ram,0x00091680) */
/* WARNING: Removing unreachable block (ram,0x0009168a) */
/* WARNING: Removing unreachable block (ram,0x0009168c) */
/* WARNING: Removing unreachable block (ram,0x0009168e) */
/* WARNING: Removing unreachable block (ram,0x00091694) */
/* WARNING: Removing unreachable block (ram,0x0009125e) */
...
LAB_000913bc:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_00091b18;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_00091b18;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_000913bc;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_00091b18;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_00091b18;
              op = pBVar10;
