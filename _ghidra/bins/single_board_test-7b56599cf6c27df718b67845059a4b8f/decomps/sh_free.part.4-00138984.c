...

{
  ...
  uVar10 = DAT_00a27fd0;
  uVar8 = DAT_00a27fcc;
  uVar3 = __aeabi_uidiv((int)param_1 + (DAT_00a27fd0 - DAT_00a27fcc),DAT_00a27fdc);
  iVar6 = DAT_00a27fe0;
  uVar16 = iVar4 - 1;
  while ((uVar3 != 0 &&
         (-1 < (int)((uint)(*(byte *)(DAT_00a27fe0 + (uVar3 >> 3)) >> (uVar3 & 7)) << 0x1f)))) {
    if ((int)(uVar3 << 0x1f) < 0) {
...
LAB_00138cd6:
    ...
    local_40 = uVar16 * 4;
    sh_clearbit(param_1,uVar16,DAT_00a27fe4);
    sh_add_to_list(DAT_00a27fd4 + local_40,param_1);
    while( true ) {
      uVar3 = DAT_00a27fcc;
      local_40 = local_40 + -4;
      iVar12 = 1 << (uVar16 & 0xff);
      uVar14 = DAT_00a27fd0 >> (uVar16 & 0xff);
      uVar10 = (int)param_1 - DAT_00a27fcc;
      iVar7 = __aeabi_uidiv(uVar10,uVar14);
      iVar6 = DAT_00a27fe4;
      iVar4 = DAT_00a27fe0;
      uVar11 = iVar7 + iVar12;
      uVar8 = (uVar11 ^ 1) & 7;
      if ((-1 < (int)((uint)(*(byte *)(DAT_00a27fe0 + (uVar11 >> 3)) >> uVar8) << 0x1f)) ||
         (bVar1 = *(byte *)(DAT_00a27fe4 + (uVar11 >> 3)) >> uVar8, (bVar1 & 1) != 0)) {
        return;
      }
      ...
      if (((int)uVar16 < 0) || (DAT_00a27fd8 <= (int)uVar16)) break;
      if ((uVar14 - 1 & uVar10) != 0) goto LAB_00138ce6;
      if ((uVar11 == 0) || (DAT_00a27fe8 <= uVar11)) goto LAB_00138cd6;
      ...
      *(int *)param_1[1] = iVar4;
      iVar4 = DAT_00a27fe4;
      if (((*param_1 != 0) &&
          ((uVar8 = *(uint *)(*param_1 + 4), uVar8 < DAT_00a27fd4 ||
           (DAT_00a27fd4 + DAT_00a27fd8 * 4 <= uVar8)))) &&
         ((uVar8 < DAT_00a27fcc || (DAT_00a27fd0 + DAT_00a27fcc <= uVar8)))) {
LAB_00138cf6:
...
LAB_00138cfa:
      ...
      if (DAT_00a27fd8 <= (int)uVar16) break;
      if (((DAT_00a27fd0 >> (uVar16 & 0xff)) - 1 & (int)param_1 - DAT_00a27fcc) != 0)
      goto LAB_00138ce6;
      iVar6 = __aeabi_uidiv();
      uVar8 = iVar6 + iVar12;
      if ((uVar8 == 0) || (DAT_00a27fe8 <= uVar8)) goto LAB_00138cd6;
      if (((uint)*(byte *)(iVar4 + (uVar8 >> 3)) & 1 << (uVar8 & 7)) != 0) goto LAB_00138cfa;
      sh_clearbit(piVar13,uVar16,DAT_00a27fe0);
      ...
      *(int *)piVar13[1] = iVar4;
      if (((*(int *)(uVar3 + iVar7) != 0) &&
          ((uVar3 = *(uint *)(*(int *)(uVar3 + iVar7) + 4), uVar3 < DAT_00a27fd4 ||
           (DAT_00a27fd4 + DAT_00a27fd8 * 4 <= uVar3)))) &&
         ((uVar3 < DAT_00a27fcc || (DAT_00a27fd0 + DAT_00a27fcc <= uVar3)))) goto LAB_00138cf6;
      uVar16 = uVar16 - 1;
      piVar9 = param_1;
      if (param_1 < piVar13) {
        piVar9 = piVar13;
      ...
      *piVar9 = 0;
      piVar9[1] = 0;
      iVar4 = DAT_00a27fe4;
      if ((uVar16 == 0xffffffff) || (DAT_00a27fd8 <= (int)uVar16)) break;
      if (((DAT_00a27fd0 >> (uVar16 & 0xff)) - 1 & (int)piVar13 - DAT_00a27fcc) != 0)
      goto LAB_00138ce6;
      iVar6 = __aeabi_uidiv();
      uVar3 = (1 << (uVar16 & 0xff)) + iVar6;
      if ((uVar3 == 0) || (DAT_00a27fe8 <= uVar3)) goto LAB_00138cd6;
      if (((uint)*(byte *)(iVar4 + (uVar3 >> 3)) & 1 << (uVar3 & 7)) != 0) {
                    /* WARNING: Subroutine does not return */
        OPENSSL_die("assertion failed: !sh_testbit(ptr, list, sh.bitmalloc)","crypto/mem_sec.c",
                    0x27a);
      }
      sh_setbit(piVar13,uVar16,DAT_00a27fe0);
      sh_add_to_list(DAT_00a27fd4 + local_40,piVar13);
      param_1 = *(int **)(DAT_00a27fd4 + local_40);
      if (param_1 != piVar13) {
                    /* WARNING: Subroutine does not return */
