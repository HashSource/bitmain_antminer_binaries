  ...
  if ((iVar1 == 0) && (iVar1 = BN_get_flags(param_3,4), iVar1 == 0)) {
    ...
    if (param_1 == (BIGNUM *)0x0) {
      ...
      if ((pBVar9 != (BIGNUM *)0x0) && (iVar1 = BN_set_word(pBVar3,1), iVar1 != 0)) {
        ...
        pBVar13 = pBVar9;
        if (pBVar12 != (BIGNUM *)0x0) goto LAB_0018ab34;
      }
LAB_0018ac24:
      pBVar13 = (BIGNUM *)0x0;
      BN_free(pBVar9);
                  ...
                  if (iVar10 == 0) {
                    ...
                    if (iVar10 == 0) {
                      if (pBVar6->top == 1) {
                        ...
                        if (pBVar3 == (BIGNUM *)0x0) goto LAB_0018ac1c;
...
LAB_0018aed0:
              ...
              if (iVar1 == 0) {
                *param_5 = 1;
                ...
                if (pBVar2 != (BIGNUM *)0x0) goto LAB_0018ab0e;
              }
            }
            else {
              while( true ) {
                iVar1 = BN_is_zero(pBVar2);
                if (iVar1 != 0) goto LAB_0018aed0;
                iVar1 = 0;
                while (iVar10 = BN_is_bit_set(pBVar2,iVar1), iVar10 == 0) {
                  ...
                  if (((iVar10 != 0) && (iVar10 = BN_uadd(pBVar3,pBVar3,param_3), iVar10 == 0)) ||
                     (iVar10 = BN_rshift1(pBVar3,pBVar3), iVar10 == 0)) goto LAB_0018ac1c;
                }
                ...
                while (iVar10 = BN_is_bit_set(pBVar4,iVar1), iVar10 == 0) {
                  ...
                  if (((iVar10 != 0) && (iVar10 = BN_uadd(pBVar5,pBVar5,param_3), iVar10 == 0)) ||
                     (iVar10 = BN_rshift1(pBVar5,pBVar5), iVar10 == 0)) goto LAB_0018ac1c;
                }
...
LAB_0018ac1c:
          pBVar9 = pBVar13;
          if (param_1 == (BIGNUM *)0x0) goto LAB_0018ac24;
        }
      }
      pBVar13 = (BIGNUM *)0x0;
    }
LAB_0018ab0e:
  ...
  if (param_1 == (BIGNUM *)0x0) {
    ...
    if ((local_48 != (BIGNUM *)0x0) && (iVar1 = BN_set_word(pBVar4,1), iVar1 != 0)) {
      ...
      if (pBVar8 != (BIGNUM *)0x0) goto LAB_0018a992;
    }
LAB_0018aa62:
    pBVar2 = local_48;
    local_48 = (BIGNUM *)0x0;
        ...
        if (pBVar8 != (BIGNUM *)0x0) {
          ...
          while (pBVar13 = pBVar7, pBVar8 = pBVar2, iVar1 = BN_is_zero(pBVar3), iVar1 == 0) {
            ...
            if (((iVar1 == 0) || (iVar1 = BN_mul(pBVar8,pBVar5,pBVar4,param_4), iVar1 == 0)) ||
               ...
               pBVar7 = pBVar4, pBVar4 = pBVar8, pBVar6 = pBVar13, iVar1 == 0)) goto LAB_0018aa5e;
          }
...
LAB_0018aa5e:
        if (param_1 == (BIGNUM *)0x0) goto LAB_0018aa62;
      }
    }
    local_48 = (BIGNUM *)0x0;
  }
