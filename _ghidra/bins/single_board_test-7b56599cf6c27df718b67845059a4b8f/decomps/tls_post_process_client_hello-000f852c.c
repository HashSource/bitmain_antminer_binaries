...
/* WARNING: Heritage AFTER dead removal. Example location: r0 : 0x000f86d8 */
...
LAB_000f8894:
    ...
    if (*(int *)(((int *)param_1->type)[0x19] + 0x30) << 0x1c < 0) goto LAB_000f8a44;
    ...
    if (iVar15 != 0) {
      ...
      if (iVar4 << 0x1c < 0) goto LAB_000f8a44;
    }
LAB_000f898a:
    iVar15 = 0;
...
LAB_000f8b76:
      ...
      if ((0x303 < iVar4) && (iVar4 != 0x10000)) {
        ...
        if (iVar4 << 0x1c < 0) goto LAB_000f8d50;
        iVar4 = *piVar21;
      }
      if ((iVar4 == 0x10000) || (iVar4 < 0x304)) goto LAB_000f8d50;
    }
    else {
LAB_000f8b5c:
      ...
      if (iVar4 == 0) goto LAB_000f87bc;
      piVar21 = (int *)param_1->type;
      if (-1 < *(int *)(piVar21[0x19] + 0x30) << 0x1c) goto LAB_000f8b76;
LAB_000f8d50:
...
LAB_000f8be0:
    ...
    if ((char)piVar23[0x57] != '\0') {
      ...
      do {
        if (piVar21 == (int *)(piVar23[0x56] + 0x15b + (int)piVar23)) goto LAB_000f8be0;
      ...
      if ((((0x300 < param_1->version) && (-1 < *(int *)(piVar21[0x19] + 0x30) << 0x1c)) &&
        ...
        iVar15 = (*param_1[3].generate_session_id)
                           (param_1,(uchar *)(param_1[2].tlsext_ticket_expected + 0x48),
                            (uint *)&local_28);
        iVar4 = local_3c;
        if ((iVar15 == 0) || ((int)local_28 < 1)) goto LAB_000f8da6;
...
LAB_000f8c2c:
      ...
      if (param_1->enc_write_ctx == (EVP_CIPHER_CTX *)0x0) {
        ...
        puVar22 = (uint *)0x0;
LAB_000f8f6c:
        if (param_1->enc_write_ctx == (EVP_CIPHER_CTX *)0x0) goto LAB_000f8550;
        piVar21 = (int *)param_1->type;
      }
      else {
        puVar22 = (uint *)0x0;
      ...
      if (((-1 < *(int *)(piVar21[0x19] + 0x30) << 0x1c) && (0x303 < *piVar21)) &&
         (*piVar21 != 0x10000)) goto LAB_000f8550;
    }
    OPENSSL_sk_free(local_3c);
    OPENSSL_sk_free(local_38);
    CRYPTO_free((void *)piVar23[0x9a]);
...
LAB_000f8608:
    ...
    if (-1 < (int)ptr) {
      ...
      if (iVar4 != 0) {
        if (iVar15 == 0x10000) goto LAB_000f8608;
        goto LAB_000f86aa;
      }
    }
