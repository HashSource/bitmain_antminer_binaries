...

{
  ...
  local_2c = 0;
  local_1e4 = 0;
  puVar2 = (uchar *)CONF_parse_list(param_1,0x2c,1,(list_cb *)0x184389,&local_1d0);
  iVar5 = local_1c4;
  if (puVar2 != (uchar *)0x0) {
    *param_4 = 0xc2;
...
LAB_00183ce0:
        ...
        if (psVar11 != (stack_st_CONF_VALUE *)0x0) {
          ...
          do {
            ...
            if (iVar4 <= iVar5) goto LAB_00183ce0;
...
LAB_00183d2a:
    ...
    OPENSSL_sk_pop_free(a,(undefined *)0x10a245);
  ...
  psVar11 = local_1c0;
  if (local_1c0 == (stack_st_CONF_VALUE *)0x0) {
    psVar11 = (stack_st_CONF_VALUE *)0x1fed14;
  }
  switch(local_1c8) {
  case 1:
    if (iVar5 != 1) {
  ...
  case 10:
    ...
    if (pAVar8 != (ASN1_INTEGER *)0x0) goto LAB_00184030;
...
LAB_001840ee:
      ...
      iVar5 = CONF_parse_list((char *)psVar11,0x2c,1,(list_cb *)0x184255,pAVar6);
      if (iVar5 != 0) goto LAB_00184030;
  ...
  case 6:
    ...
    if (pAVar7 != (ASN1_OBJECT *)0x0) goto LAB_00184030;
