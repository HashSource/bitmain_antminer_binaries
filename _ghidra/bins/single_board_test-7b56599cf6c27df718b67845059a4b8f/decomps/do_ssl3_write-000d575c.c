...
LAB_000d5876:
    ...
    iVar1 = *(int *)(param_1[2].sid_ctx + 0x1c);
    if (iVar1 == 0) goto LAB_000d5876;
    pEVar2 = EVP_MD_CTX_md((EVP_MD_CTX *)param_1[2].info_callback);
    if (pEVar2 == (EVP_MD *)0x0) goto LAB_000d5872;
    pEVar2 = EVP_MD_CTX_md((EVP_MD_CTX *)param_1[2].info_callback);
  ...
  if (param_6 != 0 || bVar20) {
    if (param_6 == 0) goto LAB_000d58b6;
...
LAB_000d5a36:
        if (-1 < (int)(uVar10 << 0x1c)) {
          ...
          if (local_948 == 0) goto LAB_000d5a5a;
        }
...
LAB_000d5ed8:
          if (((int)param_1->msg_callback_arg - 1U < 4) ||
             (param_1[2].tlsext_debug_cb == (_func_3297 *)0x1)) goto LAB_000d5b0a;
        }
        else {
          ...
          if ((iVar8 == 0x10000 || iVar8 == 0x303) || iVar11 < 0 != bVar20) goto LAB_000d5ed8;
LAB_000d5b0a:
...
LAB_000d5910:
      ...
      if (ctx == (EVP_CIPHER_CTX *)0x0) {
        ...
        uVar10 = *(uint *)(piVar7[0x19] + 0x30);
        pSVar12 = param_5;
        if ((uVar10 & 1) != 0) goto LAB_000d5a36;
        memset(local_628,0,0x600);
        local_948 = 0;
      }
      goto LAB_000d5ab8;
    ...
    if (ctx != (EVP_CIPHER_CTX *)0x0) {
      piVar7 = (int *)param_1->type;
      uVar10 = *(uint *)(piVar7[0x19] + 0x30);
      if (-1 < (int)(uVar10 << 0x1f)) goto LAB_000d60d0;
      goto LAB_000d5a36;
    }
LAB_000d60d0:
    memset(local_628,0,0x600);
  ...
  if (param_1->read_ahead == 2) {
    ...
    if (0 < iVar1) goto LAB_000d5d28;
    iVar1 = ossl_statem_in_error(param_1);
    if (iVar1 != 0) goto LAB_000d592a;
    uVar9 = 0x3fa;
  }
  else {
