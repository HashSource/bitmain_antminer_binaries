    ...
    if ((uVar12 & 0x84) == 0) {
      ...
      if ((int)(uVar12 << 0x18) < 0) {
        ...
        if ((pEVar3 == (EVP_PKEY *)0x0) &&
           (pEVar3 = *(EVP_PKEY **)(uVar12 + 0x7c), pEVar3 == (EVP_PKEY *)0x0)) goto LAB_000f9190;
      }
      else {
...
LAB_000f95c4:
      ...
      *param_2 = (uint)(pbVar16 + uVar11);
      ...
      if (uVar12 - uVar11 != 0) goto LAB_000f95c4;
...
LAB_000f9456:
    ...
    *param_2 = (uint)puVar7;
    ...
    if (uVar11 != uVar12) goto LAB_000f9456;
    pEVar18 = *(EVP_PKEY **)(param_1[0x1f] + 0x214);
    if (pEVar18 == (EVP_PKEY *)0x0) {
