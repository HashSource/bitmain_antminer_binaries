...

{
  ...
  if (((iVar1 != 0) && (iVar1 = ENGINE_set_name(e,"Software engine support"), iVar1 != 0)) &&
     (iVar1 = ENGINE_set_destroy_function(e,(ENGINE_GEN_INT_FUNC_PTR)0x1b2dc9), iVar1 != 0)) {
      ...
      if (iVar1 != 0) {
        ...
        if (iVar1 != 0) {
          ...
          if (iVar1 != 0) {
            ...
            if (((iVar1 != 0) &&
                (iVar1 = ENGINE_set_ciphers(e,(ENGINE_CIPHERS_PTR)0x1b2d1d), iVar1 != 0)) &&
               ((iVar1 = ENGINE_set_digests(e,(ENGINE_DIGESTS_PTR)0x1b2e75), iVar1 != 0 &&
                (iVar1 = ENGINE_set_load_privkey_function(e,(ENGINE_LOAD_KEY_PTR)0x1b2b91),
                iVar1 != 0)))) {
              ENGINE_add(e);
              ENGINE_free(e);
              ERR_clear_error();
