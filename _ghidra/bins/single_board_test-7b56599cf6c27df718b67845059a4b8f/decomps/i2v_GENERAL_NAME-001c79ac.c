...

{
  ...
  case 2:
    iVar2 = x509v3_add_len_value_uchar
                      (&DAT_0023bc60,((gen->d).rfc822Name)->data,((gen->d).rfc822Name)->length,
                       &local_12c);
    ret = local_12c;
    break;
  case 3:
  ...
  case 6:
    iVar2 = x509v3_add_len_value_uchar
                      (&DAT_0023bc64,((gen->d).rfc822Name)->data,((gen->d).rfc822Name)->length,
                       &local_12c);
    ret = local_12c;
    break;
  case 7:
  ...
  case 8:
    ...
    break;
  default:
    goto switchD_001c79bc_default;
  }
  if (iVar2 == 0) {
LAB_001c7a0e:
    ret = (stack_st_CONF_VALUE *)0x0;
  }
switchD_001c79bc_default:
  return ret;
}
