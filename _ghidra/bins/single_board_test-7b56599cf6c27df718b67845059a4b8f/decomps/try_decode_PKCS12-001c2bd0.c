...
LAB_001c2be8:
  ...
  if (p12 == (PKCS12 *)0x0) goto LAB_001c2cb4;
  *param_6 = 1;
  local_434 = param_1;
  local_430 = param_1;
  local_42c = param_1;
...
LAB_001c2cde:
  ...
  OPENSSL_sk_pop_free(iVar5,(undefined *)0x1c4075);
  EVP_PKEY_free((EVP_PKEY *)local_434);
  X509_free(local_430);
  OPENSSL_sk_pop_free(local_42c,(undefined *)0x16e591);
  *param_5 = 0;
  PKCS12_free(p12);
  return 0;
}
