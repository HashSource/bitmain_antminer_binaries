...
LAB_001631f4:
            ...
            if (puVar3 == (undefined4 *)0x0) goto LAB_0016308e;
          }
          else {
            pcVar4 = pcVar13;
            if (pcVar13 == (char *)0x0) {
              for (; iVar5 = OPENSSL_sk_num(iVar1), (int)pcVar4 < iVar5; pcVar4 = pcVar4 + 1) {
                ...
                if (puVar3 != (undefined4 *)0x0) goto LAB_00163176;
              }
              goto LAB_001631f4;
            }
            pcVar4 = (char *)0x0;
            do {
              ...
              pcVar10 = pcVar4 + 1;
              if (iVar5 <= (int)pcVar4) goto LAB_001631f4;
...
LAB_001631ee:
          ...
          *puVar9 = 0;
          ...
          if ((char *)puVar6[3] != (char *)0x0) {
            ...
            *puVar9 = pcVar13;
            if (pcVar13 == (char *)0x0) goto LAB_001631ee;
          }
          if (pcVar4 != (char *)0x0) {
            pcVar4 = CRYPTO_strdup(pcVar4,"crypto/srp/srp_vfy.c",0xd8);
            puVar9[5] = pcVar4;
            if (pcVar4 == (char *)0x0) goto LAB_001631ee;
          }
...
LAB_00163280:
          ...
          do {
            ...
            iVar11 = iVar5 + 1;
            if (iVar12 <= iVar5) goto LAB_00163280;
