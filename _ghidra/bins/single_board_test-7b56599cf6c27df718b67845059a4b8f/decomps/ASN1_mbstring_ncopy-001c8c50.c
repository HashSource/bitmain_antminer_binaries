...
joined_r0x001c8cbc:
  do {
    if (uVar9 == 0) {
      ...
      switch(iVar8) {
      case 0x1000:
        goto switchD_001c8da0_caseD_1000;
      case 0x1001:
        iVar8 = local_5c + 1;
        pcVar13 = (code *)0x1c8b49;
        goto LAB_001c8e92;
      case 0x1002:
        local_5c = local_5c * 2;
        pcVar13 = (code *)0x1c8b59;
        iVar8 = local_5c + 1;
        goto LAB_001c8e92;
      default:
        local_5c = 0;
    ...
    pbVar12 = pbVar7;
    if ((int)(mask << 0x14) < 0) {
      if (uVar5 < 0x10000) goto joined_r0x001c8cbc;
...
switchD_001c8da0_caseD_1000:
  iVar8 = 1;
  local_5c = len;
  if (len == 0) goto LAB_001c901e;
  if (inform == 0x1001) {
    local_5c = 0;
    uVar9 = len;
    pbVar12 = in;
