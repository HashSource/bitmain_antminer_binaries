...

{
  ...
  char acStack_800 [2024];
  
  bVar11 = 0x61 < _g_power_state.power_version;
  if (_g_power_state.power_version != 0x62) {
    bVar11 = 1 < _g_power_state.power_version - 100;
  }
  if (!bVar11 || (_g_power_state.power_version == 0x62 || _g_power_state.power_version - 100 == 2))
  {
    auStack_870[0] = 'U';
    auStack_870[1] = 0xaa;
    auStack_870[2] = '\x04';
    ...
    if (iVar1 == 0) {
      ...
      if (print) {
        ...
        do {
          iVar4 = iVar2 + 0xc;
          uVar8 = (uint)pbVar3[0xf];
          uVar5 = (uint)pbVar3[0xe];
          uVar9 = (uint)pbVar3[0xd];
          uVar6 = (uint)pbVar3[0xc];
          uVar10 = (uint)pbVar3[0xb];
          uVar7 = (uint)pbVar3[10];
          snprintf(acStack_818,0x800,
                   "data[%02d-%02d]: %02x%02x%02x%02x %02x%02x%02x%02x %02x%02x%02x%02x\n",iVar2,
                   iVar2 + 0xb,(uint)pbVar3[4],(uint)pbVar3[5],(uint)pbVar3[6],(uint)pbVar3[7],
                   (uint)pbVar3[8],(uint)pbVar3[9],uVar7,uVar10,uVar6,uVar9,uVar5,uVar8);
          _applog(3,acStack_818,false);
          iVar2 = iVar4;
          pbVar3 = pbVar3 + 0xc;
        } while (iVar4 != 0x3c);
