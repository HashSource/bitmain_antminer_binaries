...

{
  ...
  if (tree != (X509_POLICY_TREE *)0x0) {
    ...
    OPENSSL_sk_pop_free(*(undefined4 *)(tree + 0x10),0x16eef5);
    if (0 < *(int *)(tree + 4)) {
      iVar2 = 0;
      iVar1 = *(int *)tree + 0x54;
      do {
        ...
        OPENSSL_sk_pop_free(*(undefined4 *)(iVar1 + -0x50),(undefined *)0x1c6e19);
        policy_node_free(*(undefined4 *)(iVar1 + -0x4c));
        iVar1 = iVar1 + 0x10;
      } while (iVar2 < *(int *)(tree + 4));
    }
    OPENSSL_sk_pop_free(*(undefined4 *)(tree + 8),0x16ecf5);
