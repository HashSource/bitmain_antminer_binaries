  ...
  if (0 < iVar1 + -1) {
    do {
      ...
      if (*piVar2 == 0) {
        ...
        if (*piVar2 != 1) goto LAB_0017260e;
        pAVar7 = (ASN1_INTEGER *)((undefined4 *)piVar2[1])[1];
        local_38 = *(ASN1_INTEGER **)piVar2[1];
      }
      if (a == (ASIdOrRange *)0x0) goto LAB_00172610;
      if (a->type == 0) {
        y = (a->u).id;
        local_30 = y;
      }
      else {
        if (a->type != 1) goto LAB_0017260e;
        y = ((a->u).range)->min;
      ...
      if (((0 < iVar3) || (iVar3 = ASN1_INTEGER_cmp(local_38,pAVar7), 0 < iVar3)) ||
         (iVar3 = ASN1_INTEGER_cmp(y,local_30), 0 < iVar3)) goto LAB_0017260e;
      ...
      if (iVar3 == 0) {
        if (*piVar2 == 0) {
          ...
          *piVar2 = 1;
          ...
          if (pAVar7 != (ASN1_INTEGER *)0x0) goto LAB_001725bc;
LAB_0017265a:
          (a->u).id = pAVar7;
        }
        else {
          ...
          pAVar7 = (ASN1_INTEGER *)a->type;
          if (pAVar7 == (ASN1_INTEGER *)0x0) goto LAB_0017265a;
LAB_001725bc:
