...
LAB_00192b7a:
      if (piVar10 != (int *)0x0) {
        ...
        if (pAVar2 == (ASN1_VALUE *)0x0) goto LAB_00192d18;
        ...
        *(undefined4 *)(pAVar2 + 0x28) = 0;
        ...
        if (iVar1 == 0) goto LAB_00192cc8;
        if (md == (EVP_MD *)0x0) {
          iVar1 = EVP_PKEY_get_default_digest_nid(pk,(int *)local_2c);
          if (iVar1 < 1) goto LAB_00192cc8;
...
LAB_00192c5a:
          ...
          if (iVar1 == 0) {
            OPENSSL_sk_pop_free(local_2c[0],(undefined *)0x10a6c5);
          }
          else {
            iVar1 = CMS_add_smimecap((CMS_SignerInfo *)pAVar2,(stack_st_X509_ALGOR *)local_2c[0]);
            OPENSSL_sk_pop_free(local_2c[0],(undefined *)0x10a6c5);
            if (iVar1 != 0) goto LAB_00192c5a;
          }
        }
        else {
LAB_00192c60:
