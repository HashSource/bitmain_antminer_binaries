  ...
  do {
    if (*(ushort *)(puVar13 + 4) == param_2) {
      ...
      if ((iVar1 == *(int *)(puVar13 + 0x10)) || (*(int *)(puVar13 + 0x10) == 0x390 && iVar1 == 6))
      {
        ...
        if (iVar1 != 0x198) {
          if ((*(uint *)(*(int *)(param_1 + 0x404) + 0x10) & 0x30000) == 0) goto LAB_000faeba;
          uVar10 = 0x457;
          goto LAB_000faf92;
        }
        iVar1 = EVP_PKEY_id(param_3);
        if (iVar1 != 0x198) goto LAB_000fafee;
        ...
        if (pVar5 == POINT_CONVERSION_UNCOMPRESSED) {
          ...
          if (iVar1 == 0x196) {
            ...
            if (iVar1 != 0x197) goto LAB_000fb134;
            cVar6 = '\x02';
          }
        }
        pcVar12 = *(char **)(param_1 + 0x56c);
        if (pcVar12 == (char *)0x0) goto LAB_000fafee;
        if (*(int *)(param_1 + 0x568) == 0) goto LAB_000fb134;
        if (*pcVar12 == cVar6) goto LAB_000fafee;
...
LAB_000fb170:
    pcVar12 = pcVar12 + 1;
    if (pcVar12 == pcVar9) goto LAB_000fb134;
  }
LAB_000fafee:
  piVar7 = *(int **)(param_1 + 4);
  if (*(int *)(piVar7[0x19] + 0x30) << 0x1c < 0) {
LAB_000faff8:
    if ((*(uint *)(*(int *)(param_1 + 0x404) + 0x10) & 0x30000) != 0) goto LAB_000fb004;
  }
  else {
...
LAB_000faee8:
    ...
    do {
      local_30 = local_30 + 1;
      iVar8 = iVar8 + 1;
      if (iVar1 == iVar8) goto LAB_000faee8;
  ...
  if (iVar1 != 0) {
    if (local_24[0] == (EVP_MD *)0x0) {
      if (*(short *)(puVar13 + 4) == 0x807) {
        ...
        if (*(short *)(puVar13 + 4) != 0x808) goto LAB_000fafd8;
        iVar1 = 0xe0;
      }
    }
    else {
