...
LAB_000f0870:
    ...
    *param_2 = (int)(pbVar15 + 2);
    ...
    if ((uVar9 == 0) && (*piVar22 != 0x10000 && 0x303 < *piVar22)) {
      if ((__n == 0) || (uVar13 < __n)) goto LAB_000f0838;
LAB_000f08ba:
...
LAB_000f08be:
      ...
      *(int *)(param_1 + 0x474) = iVar14;
      ...
      if (__n != uVar13) goto LAB_000f0838;
      if (__n == 0) {
        return 3;
      }
      if ((uVar9 == 0) && (*piVar22 != 0x10000 && 0x303 < *piVar22)) goto LAB_000f08ba;
      iVar14 = *(int *)(param_1 + 0x474);
      if (*(int *)(iVar14 + 0x148) != 0) goto LAB_000f08be;
    }
