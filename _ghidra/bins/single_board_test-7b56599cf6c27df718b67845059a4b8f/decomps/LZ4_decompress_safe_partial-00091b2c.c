...
/* WARNING: Removing unreachable block (ram,0x00092012) */
/* WARNING: Removing unreachable block (ram,0x0009201c) */
/* WARNING: Removing unreachable block (ram,0x0009201e) */
/* WARNING: Removing unreachable block (ram,0x00092020) */
/* WARNING: Removing unreachable block (ram,0x00092026) */
/* WARNING: Removing unreachable block (ram,0x00091bf6) */
/* WARNING: Removing unreachable block (ram,0x00091bfe) */
/* WARNING: Removing unreachable block (ram,0x00091c0e) */
/* WARNING: Removing unreachable block (ram,0x00091c06) */
...
LAB_00091d4e:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000924aa;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000924aa;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_00091d4e;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000924aa;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000924aa;
              op = pBVar10;
