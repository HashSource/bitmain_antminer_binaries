...
undefined4 bf_cfb64_cipher(undefined4 param_1,uchar *param_2,uchar *param_3,uint param_4)

{
  ...
  if (param_4 != 0) {
    do {
      ...
      BF_cfb64_encrypt(param_3,param_2,length,schedule,ivec,local_2c,enc);
