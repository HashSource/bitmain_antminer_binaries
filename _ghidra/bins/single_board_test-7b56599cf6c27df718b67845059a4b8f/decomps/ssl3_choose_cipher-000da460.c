...
LAB_000da736:
          ...
          if (*(int *)(iVar2 + 0x18) != 0x80000) goto LAB_000da72e;
...
LAB_000da6b8:
        ...
        if (iVar2 == 0x100) goto LAB_000da654;
        iVar9 = 0xff00;
      }
      else {
        iVar4 = iVar9;
...
LAB_000da578:
        if (iVar2 < iVar4) goto LAB_000da57c;
        if (iVar9 == 0x100) goto LAB_000da6b8;
        iVar2 = *(int *)(iVar8 + 0x2c);
        if (iVar2 == 0x100) {
          iVar2 = 0xff00;
        }
...
LAB_000da654:
      ...
      iVar2 = *(int *)param_1[1];
      if (iVar2 < 0x304 || iVar2 == 0x10000) goto LAB_000da654;
LAB_000da5c8:
         ...
         (iVar8 = ssl_security(param_1,0x10002,*(undefined4 *)(iVar8 + 0x38),0,iVar8), iVar8 != 0))
      {
        if ((((int)(uVar11 << 0x1d) < 0) && ((uVar12 & 8) != 0)) &&
          ...
          if (pEVar1 == pEVar3) goto LAB_000da6d0;
          if (local_3c == 0) {
            local_3c = iVar8;
          }
        }
...
LAB_000da72e:
  iVar6 = iVar6 + 1;
  if (iVar8 == iVar6) goto LAB_000da490;
  goto LAB_000da736;
}
