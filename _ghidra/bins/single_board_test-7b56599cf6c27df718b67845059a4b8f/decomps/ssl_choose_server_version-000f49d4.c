      ...
      if ((iVar8 < 0x304 || iVar8 == 0x10000) || (int)(*(uint *)(piVar10[0x19] + 0x30) << 0x1c) < 0)
      {
        ...
        if (uVar11 != uVar9) {
          if ((*(uint *)(piVar10[0x19] + 0x30) & 8) == 0) {
            ...
            if (uVar11 == 0x100) {
              if (uVar9 == 0x100) goto LAB_000f4bf8;
              uVar11 = 0xff00;
            }
            else if (uVar9 == 0x100) {
              uVar9 = 0xff00;
...
LAB_000f4a42:
    ...
    bVar1 = false;
    do {
      if (*(code **)((int)puVar13 + 8) == (code *)0x0) goto LAB_000f4aa6;
      if (uVar11 == uVar9) {
LAB_000f4a6e:
...
LAB_000f4bae:
              ...
              if ((int)uVar4 < (int)uVar9) goto LAB_000f4b5e;
            }
            else {
              if (uVar4 == 0x100) {
                if (uVar9 == 0x100) goto LAB_000f4aa4;
                uVar4 = 0xff00;
              }
              else if (uVar9 == 0x100) {
                uVar9 = 0xff00;
              }
              if ((int)uVar9 < (int)uVar4) goto LAB_000f4b5e;
            }
          }
        }
        else if ((*(uint *)(*(int *)(param_1[1] + 100) + 0x30) & 8) == 0) {
          if ((int)uVar9 <= (int)uVar4) goto LAB_000f4a90;
        }
        else {
          if (uVar4 == 0x100) {
            if (uVar9 == 0x100) goto LAB_000f4a90;
            uVar5 = 0xff00;
          }
          else {
            uVar5 = uVar4;
          ...
          if ((int)uVar5 <= (int)uVar9) goto LAB_000f4a90;
        }
LAB_000f4aa4:
        bVar1 = true;
      }
      else if ((*(uint *)(*(int *)(param_1[1] + 100) + 0x30) & 8) == 0) {
        if ((int)uVar9 <= (int)uVar11) goto LAB_000f4a6e;
      }
      else {
        if (uVar11 == 0x100) {
          if (uVar9 == 0x100) goto LAB_000f4a6e;
          uVar4 = 0xff00;
        }
        else {
          uVar4 = uVar11;
        ...
        if ((int)uVar4 <= (int)uVar9) goto LAB_000f4a6e;
      }
LAB_000f4aa6:
  ...
  uVar4 = *(uint *)(piVar10[0x19] + 0x30);
  if ((uVar4 & 8) != 0) goto LAB_000f4a42;
  ...
  for (pbVar12 = pbVar6 + 3; pbVar12 != pbVar6 + (uVar4 & 0xfe) + 3; pbVar12 = pbVar12 + 2) {
    ...
    if (uVar9 != uVar11) {
      if ((*(uint *)(*(int *)(param_1[1] + 100) + 0x30) & 8) == 0) {
        if (uVar11 <= uVar9) goto LAB_000f4ca6;
      }
      else {
        uVar5 = uVar11;
        if (uVar9 == 0x100) {
          if (uVar11 == 0x100) goto LAB_000f4ca6;
          uVar7 = 0xff00;
        }
        else {
          uVar7 = uVar9;
