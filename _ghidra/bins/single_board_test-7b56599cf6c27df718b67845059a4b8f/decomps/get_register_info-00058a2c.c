...

{
  ...
  case 3:
    ...
    break;
  case 4:
    check_chain_hwsweep_done((uint8_t)(g_rt.config)->chain);
    break;
  case 5:
    send_get_status_command((uint8_t)(g_rt.config)->chain,'\x01',0,0xe0);
    break;
  case 6:
  ...
  case 8:
    send_get_status_command
              ((uint8_t)(g_rt.config)->chain,'\0',which_asic * (g_rt.config)->interval,0x1c);
    break;
  case 9:
    send_get_status_command
              ((uint8_t)(g_rt.config)->chain,'\0',which_asic * (g_rt.config)->interval,0x1c);
