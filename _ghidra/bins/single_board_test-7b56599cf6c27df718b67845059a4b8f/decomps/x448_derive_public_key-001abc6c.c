...
void x448_derive_public_key(undefined4 param_1,undefined4 *param_2)

{
  ...
  puVar7[4] = *puVar6;
  puVar7[5] = uVar2;
  local_90[0] = local_90[0] & 0xfc;
  local_59 = local_59 | 0x80;
  curve448_scalar_decode_long(auStack_58,local_90);
