...

{
  ...
  if (-1 < (int)(param_2 << 0x1f)) {
    *(undefined4 *)(param_1 + 0x60) = 1;
    ...
    if ((param_2 & 0x12) != 0x12) goto LAB_000fd8ce;
LAB_000fd856:
...
LAB_000fde34:
  ...
  if ((param_2 & 0x12) == 0x12) goto LAB_000fd856;
LAB_000fd8ce:
  if ((param_2 & 0x21) == 0x21) goto LAB_000fd856;
  if ((param_2 & 0x80) == 0) {
    pcVar7 = "s ap traffic";
...
LAB_000fd96c:
    ...
    if (pcVar7 == "s ap traffic") {
      ...
      if ((iVar1 == 0) ||
         ...
         sVar2 = local_ec, iVar1 == 0)) goto LAB_000fd974;
    }
    else {
      pcVar8 = "c ap traffic";
      if (pcVar7 == "c ap traffic") {
