...
LAB_000f4e6e:
        ...
        if (iVar5 == 0) goto LAB_000f4e80;
        iVar5 = param_1[0x13e];
        if ((iVar5 != 0) && (iVar8 != iVar5)) {
          if ((*(uint *)(*(int *)(param_1[1] + 100) + 0x30) & 8) == 0) {
            if (iVar8 < iVar5) goto LAB_000f4efc;
          }
          else {
            if (iVar8 == 0x100) {
              if (iVar5 == 0x100) goto LAB_000f4e80;
              iVar8 = 0xff00;
            }
            else if (iVar5 == 0x100) {
              iVar5 = 0xff00;
            }
            if (iVar5 < iVar8) goto LAB_000f4efc;
          }
          goto LAB_000f4e80;
        }
LAB_000f4efc:
        ...
        if ((*(uint *)(*(int *)(param_1[1] + 100) + 0x30) & 8) == 0) {
          if (iVar5 <= iVar8) goto LAB_000f4e6e;
        }
        else {
          if (iVar8 == 0x100) {
            if (iVar5 == 0x100) goto LAB_000f4e6e;
            iVar4 = 0xff00;
          }
          else {
            iVar4 = iVar8;
          ...
          if (iVar4 <= iVar5) goto LAB_000f4e6e;
        }
LAB_000f4e80:
        bVar2 = true;
      }
