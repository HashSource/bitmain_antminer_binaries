...
LAB_000d7856:
      ...
      if (ctx == (EVP_CIPHER_CTX *)0x0) goto LAB_000d7874;
      local_2f0 = EVP_CIPHER_CTX_cipher(ctx);
      goto LAB_000d7868;
    }
    pEVar4 = EVP_MD_CTX_md((EVP_MD_CTX *)param_1[0xf8]);
    iVar5 = EVP_MD_size(pEVar4);
    if (-1 < iVar5) goto LAB_000d7856;
    uVar16 = 0x3e6;
  }
  else {
    ...
    if (((*(int *)(*(int *)(param_1[1] + 100) + 0x30) << 0x1f < 0) &&
      ...
      if (buf == *(uchar **)(param_2 + 0x14)) {
        ...
        do {
          ...
          if (param_3 == uVar18) goto LAB_000d7868;
    ...
    do {
      *puVar21 = *(uint *)(iVar15 + 8);
      ...
      if ((int)(uVar7 << 10) < 0) {
        ...
        if (param_4 == 0) {
          if (-1 < iVar14 << 0x1c) goto LAB_000d7ae2;
...
LAB_000d7ae2:
        ...
        *(char *)((int)puVar19 + 9) = (char)((uint)uVar17 >> 8);
        ...
        if (param_4 == 0) goto LAB_000d7abc;
        iVar14 = *(int *)(iVar15 + 8);
...
LAB_000d7c22:
    ...
    if (-1 < local_304) goto LAB_000d7c22;
    uVar16 = 0x483;
  }
LAB_000d7cb4:
  uVar17 = 0x44;
