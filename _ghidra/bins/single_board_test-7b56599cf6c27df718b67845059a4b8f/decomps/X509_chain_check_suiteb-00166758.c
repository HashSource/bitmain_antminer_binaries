...
LAB_00166852:
      for (; iVar1 = OPENSSL_sk_num(param_3), (int)uVar6 < iVar1; uVar6 = uVar6 + 1) {
        ...
        pEVar2 = (EC_KEY *)EVP_PKEY_get0_EC_KEY(pkey);
        pEVar3 = EC_KEY_get0_group(pEVar2);
        if (pEVar3 == (EC_GROUP *)0x0) goto LAB_0016688a;
        iVar4 = EC_GROUP_get_curve_name(pEVar3);
        if (iVar4 == 0x2cb) {
          if (iVar1 != -1 && iVar1 != 0x31b) goto LAB_001668be;
          if (-1 < (int)(local_2c << 0xe)) goto LAB_001668e8;
          local_2c = local_2c & 0xfffeffff;
        }
        else {
          if (iVar4 != 0x19f) goto LAB_001668ac;
          if (iVar1 != -1 && iVar1 != 0x31a) goto LAB_001668be;
          if (-1 < (int)(local_2c << 0xf)) goto LAB_001668e8;
        }
      }
      iVar1 = X509_get_signature_nid(param_2);
