...

{
  ...
  *ptr_00 = param_7;
  ...
  if (param_2 == 0x12) {
    ...
    if (iVar1 != 0) goto LAB_000ea868;
    SSL_extension_supported(0x12);
  }
  else {
    iVar1 = SSL_extension_supported(param_2);
    if ((iVar1 != 0) || (0xffff < param_2)) goto LAB_000ea868;
  }
  iVar1 = custom_ext_find(iVar3 + 0xf0,1,param_2,0);
  if ((iVar1 == 0) &&
    ...
    *(undefined4 *)((int)__s + 0x1c) = 0xea109;
    *(undefined4 *)((int)__s + 4) = 1;
    *(undefined4 *)((int)__s + 0x10) = 0xea0d1;
    *(undefined4 *)((int)__s + 0x14) = 0xea0f1;
