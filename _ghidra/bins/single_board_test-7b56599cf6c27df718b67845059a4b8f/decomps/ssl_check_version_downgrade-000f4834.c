...

{
  ...
  do {
    if (*(code **)((int)puVar4 + 8) == (code *)0x0) goto LAB_000f488e;
...
LAB_000f4902:
          ...
          if (iVar5 < iVar3) goto LAB_000f4902;
        }
        else {
          if (iVar5 == 0x100) {
            if (iVar3 == 0x100) goto LAB_000f488e;
            iVar5 = 0xff00;
          }
          else if (iVar3 == 0x100) {
            iVar3 = 0xff00;
          }
          if (iVar3 < iVar5) goto LAB_000f4902;
        }
      }
    }
    else if ((*(uint *)(*(int *)(param_1[1] + 100) + 0x30) & 8) == 0) {
      if (iVar3 <= iVar5) goto LAB_000f487e;
    }
    else {
      if (iVar5 == 0x100) {
        if (iVar3 == 0x100) goto LAB_000f487e;
        iVar2 = 0xff00;
      }
      else {
        iVar2 = iVar5;
      ...
      if (iVar2 <= iVar3) goto LAB_000f487e;
    }
LAB_000f488e:
