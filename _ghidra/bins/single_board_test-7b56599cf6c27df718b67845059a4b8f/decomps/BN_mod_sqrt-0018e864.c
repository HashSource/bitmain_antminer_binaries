...
LAB_0018e9e6:
                    ...
                    if (-1 < iVar6) {
                      if (n->neg == 0) {
                        pcVar8 = (code *)0x187591;
                      }
                      else {
                        pcVar8 = (code *)0x18753d;
                      }
                      iVar6 = (*pcVar8)(r_01,r_01,n);
                      if (iVar6 == 0) goto LAB_0018e9f2;
                    }
                    iVar6 = BN_is_zero(r_01);
                    if (iVar6 != 0) goto LAB_0018e9e6;
                  }
                  iVar6 = BN_kronecker(r_01,pBVar5,ctx);
                  if (iVar6 + 1 < 0 != SCARRY4(iVar6,1)) goto LAB_0018e9f2;
                  if (iVar6 == 0) {
                    iVar1 = 0xc9;
LAB_0018eb90:
...
LAB_0018e9f2:
      ...
      if (ret != (BIGNUM *)0x0) {
        uVar2 = BN_is_one(a);
        iVar1 = BN_set_word(ret,uVar2);
        goto joined_r0x0018e8ac;
      }
      pBVar3 = BN_new();
      if (pBVar3 != (BIGNUM *)0x0) {
        uVar2 = BN_is_one(a);
        iVar1 = BN_set_word(pBVar3,uVar2);
        goto joined_r0x0018ebb8;
      }
    }
  }
  r_02 = (BIGNUM *)0x0;
...
joined_r0x0018ec8c:
  ...
  if (pBVar5 == (BIGNUM *)0x0) goto LAB_0018e9f2;
  iVar1 = iVar1 - iVar9;
  ...
  if ((iVar1 == 0) || (iVar1 = BN_mod_mul(r_00,r_00,r,n,ctx), iVar1 == 0)) goto LAB_0018e9f2;
