...
LAB_0014f99a:
    ...
    if (iVar1 <= iVar8 + 1) goto LAB_0014f99a;
  }
  else {
    iVar8 = 0;
  }
          ...
          if (iVar8 != 0) {
            do {
              ...
              if (((iVar3 == 0) || (iVar3 = BN_mul(r_02,r_02,r_01,ctx), iVar3 == 0)) ||
                 (iVar3 = BN_gcd(r_03,r_03,r_01,ctx), iVar3 == 0)) goto LAB_0014f974;
            } while (iVar8 != iVar1);
          }
...
LAB_0014fc0e:
              ...
              while (iVar3 = iVar1 + 1, iVar8 != iVar1) {
                ...
                if (pBVar4 == (BIGNUM *)0x0) goto LAB_0014f974;
