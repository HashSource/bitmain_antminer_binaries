            ...
            if (iVar3 < 1) {
              ...
              if (0 < iVar3) {
                do {
                  ...
                  if (pAVar4 == (ASN1_TEMPLATE *)0x0) goto LAB_001073e2;
                  ppAVar5 = asn1_get_field_ptr(&local_38,pAVar4);
                  puVar2 = local_30;
                  if (local_34 == 0) {
                    if (local_42 == '\0') goto LAB_00107664;
                    goto LAB_00107768;
                  }
...
LAB_0010768e:
              ...
              pAVar10 = pAVar10 + 1;
              if (pAVar4 != (ASN1_TEMPLATE *)0x0) {
                if ((int)(pAVar4->flags << 0x1f) < 0) goto code_r0x0010767e;
...
LAB_00107248:
            ...
            if (iVar3 != 0) {
              if (local_38 == (ASN1_VALUE *)0x0) goto LAB_00107542;
...
code_r0x0010767e:
  ppAVar5 = asn1_get_field_ptr(local_64,pAVar4);
  asn1_template_free(ppAVar5,pAVar4);
  if (it->tcount <= iVar14) goto LAB_001076de;
  goto LAB_0010768e;
}
