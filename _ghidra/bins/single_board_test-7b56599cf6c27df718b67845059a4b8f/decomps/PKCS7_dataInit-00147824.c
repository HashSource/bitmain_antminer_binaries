...
LAB_00147a68:
        ...
        if (pPVar10 == (PKCS7_SIGNED *)0x0) {
          ...
          if (pPVar10->version != (ASN1_INTEGER *)0x4) goto LAB_00147a68;
          pEVar12 = (EVP_CIPHER *)0x0;
...
LAB_00147ad2:
        ...
        if (pPVar10 == (PKCS7_SIGNED *)0x0) {
          ...
          if (pPVar10->version != (ASN1_INTEGER *)0x4) goto LAB_00147ad2;
          pEVar12 = (EVP_CIPHER *)0x0;
          pAVar15 = (ASN1_OCTET_STRING *)pPVar10->md_algs;
          pEVar14 = (EVP_CIPHER *)0x0;
          pEVar13 = (EVP_CIPHER *)0x0;
  ...
  do {
    ...
    if (iVar4 <= iVar2) {
      if ((local_a4 == (BIO *)0x0) ||
        ...
        pBVar1 = local_84;
        if (cipher == (EVP_CIPHER *)0x0) goto LAB_00147b2c;
        pBVar5 = BIO_f_cipher();
...
LAB_001479e0:
  ...
  if (iVar4 <= iVar2) goto LAB_00147b12;
  p2 = (void *)OPENSSL_sk_value(pEVar14,iVar2);
  pkey = (EVP_PKEY *)X509_get0_pubkey(*(undefined4 *)((int)p2 + 0x10));
  if ((pkey == (EVP_PKEY *)0x0) ||
     (ctx = EVP_PKEY_CTX_new(pkey,(ENGINE *)0x0), ctx == (EVP_PKEY_CTX *)0x0)) goto LAB_00147a34;
...
LAB_00147b2c:
  local_84 = pBVar1;
  local_a0 = bio;
  if (bio != (BIO *)0x0) goto LAB_00147b32;
  iVar2 = OBJ_obj2nid(p7->type);
