        ...
        while( true ) {
          ...
          if (0 < (int)param_3) {
            ...
            if (2 < uVar9) {
              ...
              uVar10 = iVar5 * 4;
              if (param_3 == iVar5 * 4) goto LAB_00198020;
            }
              ...
              do {
                ...
                do {
                  ...
                  if ((((iVar7 == 0) ||
                     ...
                     (iVar7 = BN_add(pBVar3,pBVar3,pBVar2), iVar7 == 0)) goto LAB_001981de;
                  iVar11 = iVar11 + 1;
                ...
                local_cc = local_cc + 1;
                if (local_cc == 0x1000) goto LAB_00198066;
