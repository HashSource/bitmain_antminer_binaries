...
/* WARNING: Removing unreachable block (ram,0x00095d6a) */
/* WARNING: Removing unreachable block (ram,0x00095d74) */
/* WARNING: Removing unreachable block (ram,0x00095d76) */
/* WARNING: Removing unreachable block (ram,0x00095d78) */
/* WARNING: Removing unreachable block (ram,0x00095d7e) */
/* WARNING: Removing unreachable block (ram,0x0009594e) */
/* WARNING: Removing unreachable block (ram,0x00095956) */
/* WARNING: Removing unreachable block (ram,0x00095966) */
/* WARNING: Removing unreachable block (ram,0x0009595e) */
...
LAB_00095aa6:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_00096208;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_00096208;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar5) == 0) goto LAB_00095aa6;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_00096208;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar6 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_00096208;
              op = pBVar11;
