...
LAB_00179e5e:
    ...
    if (ptr == (undefined4 *)0x0) goto LAB_00179e14;
...
LAB_00179df6:
      ...
      if (pvVar3 == (void *)0x0) {
        ...
        if (name != (char *)0x0) goto LAB_00179e5e;
      }
      else {
        name = (char *)0x0;
      }
...
LAB_00179de4:
      ...
      if (pcVar2 != (char *)0x0) goto LAB_00179df6;
      name = (char *)0x0;
    }
LAB_00179e14:
    ptr = (undefined4 *)0x0;
    ERR_put_error(0x22,0xae,0x41,"crypto/x509v3/v3_utl.c",0x45);
    if (psVar5 != (stack_st_CONF_VALUE *)0x0) goto LAB_00179e2e;
    ptr = (undefined4 *)0x0;
  }
