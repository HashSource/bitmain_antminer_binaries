  ...
  *(uint *)(param_1 + 0x3c) = uVar13;
  if (*(int *)(param_1 + 0x16c) == 0) {
    ...
    local_34 = uVar12 << 0x18 | (uVar12 >> 8 & 0xff) << 0x10 | (uVar12 >> 0x10 & 0xff) << 8 |
               uVar12 >> 0x18;
    if (uVar13 == 0) goto LAB_0013dd18;
    if (param_4 == 0) goto LAB_0013dcc8;
    ...
    if (uVar13 != 0) goto LAB_0013dcc8;
    gcm_ghash_4bit(param_1 + 0x40,param_1 + 0x60,param_1 + 0x178,local_38);
    local_38 = 0;
    local_44 = param_4;
    if ((((uint)local_40 | (uint)local_3c) & 3) != 0) goto LAB_0013dfd2;
LAB_0013e072:
    local_38 = 0;
  }
  else {
...
LAB_0013dfd2:
  ...
  if (local_44 == 0) goto LAB_0013dcc8;
  ...
  if ((((uint)local_40 | (uint)local_3c | (uint)puVar3) & 3) == 0 &&
    ...
    if (uVar12 < 3) {
      ...
      *(uint *)(param_1 + local_38 + 0x178) = uVar14;
      ...
      if (local_44 == uVar13) goto LAB_0013e120;
    }
