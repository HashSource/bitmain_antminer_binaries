...
LAB_00181344:
    if (param_1 == (FILE *)0x0) {
      if ((int)(param_2 << 0x16) < 0) goto LAB_00181bba;
      pcVar14 = (char *)(param_3.asn1_string)->length;
    }
    else {
      sVar2 = fwrite(&DAT_00224688,1,1,param_1);
      if (sVar2 != 1) {
        return -1;
      }
      ...
      do {
        while( true ) {
          ...
          case 2:
            ...
            if (pbVar19 == pbVar21) goto LAB_001816da;
            goto LAB_001814ba;
          default:
            goto LAB_00181366;
          case 4:
...
LAB_001814fe:
                ...
                if ((uVar16 & 0x61) == 0) goto LAB_001814fe;
...
LAB_00181acc:
                ...
                uVar16 = *(ushort *)(&char_type + uVar16 * 2) & uVar11;
                if ((uVar16 & 0x61) == 0) goto LAB_00181acc;
                if ((int)(uVar16 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_00181aaa:
                ...
                uVar16 = *(ushort *)(&char_type + uVar16 * 2) & uVar11;
                if ((uVar16 & 0x61) == 0) goto LAB_00181aaa;
                if ((int)(uVar16 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_00181b34:
                ...
                if ((uVar16 & 0x61) == 0) goto LAB_00181b34;
                if ((int)(uVar16 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_00181b12:
                ...
                if ((uVar16 & 0x61) == 0) goto LAB_00181b12;
                if ((int)(uVar16 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
              ...
              if (iVar4 != 5) {
                if ((int)((uint)local_37 << 0x18) < 0) {
                  ...
                  if ((uVar11 & 0x61) != 0) goto LAB_001815fa;
                }
                if ((uVar11 & 0x406) == 0) goto LAB_00181606;
                BIO_snprintf((char *)local_34,0xb,"\\%02X");
                iVar15 = iVar15 + 3;
              }
            }
...
LAB_00181a3a:
                ...
                if ((uVar6 & 0x61) == 0) goto LAB_00181a3a;
                if ((int)(uVar6 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_00181c96:
                ...
                uVar6 = *(ushort *)(&char_type + uVar16 * 2) & uVar11;
                if ((uVar6 & 0x61) == 0) goto LAB_00181c96;
                if ((int)(uVar6 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_00181c80:
                ...
                uVar6 = *(ushort *)(&char_type + uVar16 * 2) & uVar11;
                if ((uVar6 & 0x61) == 0) goto LAB_00181c80;
                if ((int)(uVar6 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_00181c6a:
                ...
                uVar6 = *(ushort *)(&char_type + uVar16 * 2) & uVar11;
                if ((uVar6 & 0x61) == 0) goto LAB_00181c6a;
                if ((int)(uVar6 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_00181c54:
                ...
                uVar6 = *(ushort *)(&char_type + uVar16 * 2) & uVar11;
                if ((uVar6 & 0x61) == 0) goto LAB_00181c54;
                if ((int)(uVar6 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_001819fc:
              ...
              if ((uVar11 & 0x61) == 0) goto LAB_001819fc;
LAB_001815fa:
...
LAB_00181608:
          pbVar18 = pbVar19;
          if (pbVar19 == pbVar21) goto LAB_00181614;
        }
LAB_001814ba:
        if (bVar7 != 0) goto LAB_001814c0;
LAB_001816e8:
...
LAB_00181614:
    ...
    if (local_42 == '\0') {
      ...
      sVar2 = fwrite(&DAT_0023dc34,1,1,param_1);
      if (sVar2 != 1) {
        return -1;
      }
    }
...
LAB_00181a6e:
    ...
    else if ((bVar1 == 4) && ((uVar11 & 3) != 0)) goto LAB_001813b8;
    if (pbVar17 != pbVar21) {
      bVar8 = bVar8 & 8;
      pbVar18 = pbVar17;
      do {
            ...
            do {
              while( true ) {
                ...
                if (((int)(uVar10 << 0x18) < 0) ||
                   ...
                   (uVar6 & 0x61) == 0)) break;
                if ((-1 < (int)(uVar6 << 0x1c)) &&
                   (sVar2 = fwrite(&DAT_0022467c,1,1,param_1), sVar2 != 1)) {
                  return -1;
                }
LAB_001817b4:
...
LAB_001817c4:
                if (ppbVar12 == ppbVar20) goto LAB_001817cc;
              }
              if ((uVar6 & 0x406) == 0) {
                if ((uVar10 != 0x5c) || (uVar5 == 0)) goto LAB_001817b4;
                sVar2 = fwrite(&DAT_00200360,1,2,param_1);
                if (sVar2 != 2) {
                  return -1;
                }
                goto LAB_001817c4;
...
LAB_001817cc:
    ...
    if ((local_42 == '\0') || (sVar2 = fwrite(&DAT_0023dc34,1,1,param_1), sVar2 == 1)) {
      return local_68;
    }
  }
  else {
    if ((0x1d < iVar15 - 1U) || (bVar1 = tag2nbyte[iVar15], bVar1 == 0xff)) {
      if ((int)(param_2 << 0x17) < 0) goto LAB_00181344;
      goto LAB_00181408;
    }
    bVar8 = bVar1;
    if ((int)(param_2 << 0x1b) < 0) {
...
LAB_00181394:
    ...
    pbVar21 = pbVar17 + local_64;
    if (bVar1 == 2) {
      if ((int)(local_64 << 0x1f) < 0) goto LAB_00181a6e;
      goto LAB_00181420;
    }
    if ((bVar1 != 4) || ((local_64 & 3) == 0)) goto LAB_00181420;
LAB_001813b8:
