...
LAB_001741f8:
                                ...
                                if (pAVar5 == (ASN1_OBJECT *)0x0) {
                                  ...
                                  if (pUVar11 == (USERNOTICE *)0x0) goto LAB_001741f8;
...
LAB_001741d6:
                                        ...
                                        if (pAVar16 == (ASN1_STRING *)0x0) goto LAB_001741f8;
                                      }
                                      else {
                                        if (iVar12 == 4) {
                                          iVar14 = strncmp(__s,"UTF8",4);
                                          if (iVar14 != 0) goto LAB_001741d6;
                                          iVar14 = 0xc;
                                        }
                                        else if (iVar12 == 10) {
                                          ...
                                          if (iVar12 == 7) {
                                            ...
                                            if (iVar12 != 0xd) goto LAB_001741d6;
...
joined_r0x001740ee:
                                      ...
                                      if (iVar12 == 0) {
                                        ...
                                        if (pNVar17 == (NOTICEREF *)0x0) {
                                          ...
                                          if (pNVar17 == (NOTICEREF *)0x0) goto LAB_001741f8;
...
LAB_001742ba:
                                        ...
                                        ERR_add_error_data(6,"section:",*puVar6,",name:",puVar6[1],
                                                           ",value:",puVar6[2]);
                                        OPENSSL_sk_pop_free(psVar13,0x1794f9);
                                        goto LAB_00174212;
                                      }
                                      psVar13 = X509V3_parse_list(__s);
                                      if (psVar13 == (stack_st_CONF_VALUE *)0x0) goto LAB_001742ba;
LAB_0017414c:
                                      iVar12 = OPENSSL_sk_num();
                                      if (iVar12 == 0) goto LAB_001742ba;
...
LAB_0017417c:
                                      ...
                                      if (iVar12 < iVar14) {
                                        ...
                                        a_00 = s2i_ASN1_INTEGER((X509V3_EXT_METHOD *)0x0,
                                                                *(char **)(iVar14 + 4));
                                        if (a_00 != (ASN1_INTEGER *)0x0) goto code_r0x00174170;
...
LAB_00173f1a:
      ...
      OPENSSL_sk_pop_free(psVar2,0x1794f9);
      return iVar4;
    }
    ERR_put_error(0x22,0x82,0x41,"crypto/x509v3/v3_cpols.c",0x6b);
LAB_0017403e:
    OPENSSL_sk_pop_free(psVar2,0x1794f9);
    OPENSSL_sk_pop_free(iVar4,(undefined *)0x173ce5);
  }
  return 0;
code_r0x00174170:
