...

{
  ...
  if (pEVar2 == (EC_POINT *)0x0) {
    iVar4 = 0;
    iVar8 = 0;
    if (pBVar1 == (BIGNUM *)0x0) goto LAB_0011aeb4;
LAB_0011af0c:
    pBVar1 = EC_KEY_get0_private_key(key);
    if (pBVar1 == (BIGNUM *)0x0) {
      ...
      if (pBVar1 == (BIGNUM *)0x0) goto LAB_0011af02;
    }
    pcVar7 = "Private-Key";
    iVar8 = BIO_indent(bp,off,0x80);
    if (iVar8 == 0) goto LAB_0011aec6;
LAB_0011af36:
...
LAB_0011af02:
      ...
      iVar8 = iVar4;
      if (pBVar1 != (BIGNUM *)0x0) goto LAB_0011af0c;
LAB_0011aeb4:
      pcVar7 = "Public-Key";
      iVar5 = BIO_indent(bp,off,0x80);
      iVar4 = iVar8;
      if (iVar5 != 0) goto LAB_0011af36;
    }
  }
LAB_0011aec6:
  iVar8 = 0;
