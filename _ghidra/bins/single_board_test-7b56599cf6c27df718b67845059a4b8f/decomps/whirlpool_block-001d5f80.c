...

{
  ...
  local_f0 = param_3;
  local_b0 = local_104;
  if (local_ec == 0) goto LAB_001d771e;
  do {
    ...
    while( true ) {
      ...
      do {
        ...
        uVar81 = *(uint *)(&DAT_002474bc + iVar49) ^
                 *(uint *)(&DAT_002474bc + iVar47) ^
                 *(uint *)(&DAT_002474bc + iVar9) ^ *(uint *)(&DAT_002474bc + iVar42) ^
                 *(uint *)(&DAT_002474bc + iVar43) ^ *(uint *)(&DAT_002474bc + iVar51) ^
                 *(uint *)(&DAT_002474bc + iVar53) ^ *(uint *)(&DAT_002474bc + iVar56);
        ...
        local_5c = *(uint *)(&DAT_002474bc + iVar34) ^
                   *(uint *)(&DAT_002474bc + iVar21) ^
                   *(uint *)(&DAT_002474bc + iVar2) ^ *(uint *)(&DAT_002474bc + iVar1) ^
                   *(uint *)(&DAT_002474bc + iVar15) ^ *(uint *)(&DAT_002474bc + iVar20) ^
                   *(uint *)(&DAT_002474bc + iVar33) ^ *(uint *)(&DAT_002474bc + iVar57);
        ...
        local_58 = *(uint *)(&Cx + iVar23) ^
                   ...
                   *(uint *)(&Cx + iVar58);
        local_54 = *(uint *)(&DAT_002474bc + iVar23) ^
                   *(uint *)(&DAT_002474bc + iVar3) ^
                   *(uint *)(&DAT_002474bc + iVar5) ^ *(uint *)(&DAT_002474bc + iVar10) ^
                   *(uint *)(&DAT_002474bc + iVar22) ^ *(uint *)(&DAT_002474bc + iVar36) ^
                   *(uint *)(&DAT_002474bc + iVar38) ^ *(uint *)(&DAT_002474bc + iVar58);
        ...
        local_4c = *(uint *)(&DAT_002474bc + iVar40) ^
                   *(uint *)(&DAT_002474bc + iVar24) ^
                   *(uint *)(&DAT_002474bc + iVar11) ^
                   *(uint *)(&DAT_002474bc + iVar4) ^ *(uint *)(&DAT_002474bc + iVar12) ^
                   *(uint *)(&DAT_002474bc + iVar16) ^ *(uint *)(&DAT_002474bc + iVar37) ^
                   *(uint *)(&DAT_002474bc + iVar9);
        ...
        local_44 = *(uint *)(&DAT_002474bc + iVar59) ^
                   *(uint *)(&DAT_002474bc + iVar18) ^
                   *(uint *)(&DAT_002474bc + iVar17) ^
                   *(uint *)(&DAT_002474bc + iVar13) ^ *(uint *)(&DAT_002474bc + iVar6) ^
                   *(uint *)(&DAT_002474bc + iVar39) ^ *(uint *)(&DAT_002474bc + iVar41) ^
                   *(uint *)(&DAT_002474bc + iVar1);
        iVar1 = ((short)local_1d0 * 8 + 7) * 8;
        local_64 = *(uint *)(&DAT_002474bc + iVar52) ^
                   *(uint *)(&DAT_002474bc + iVar50) ^
                   *(uint *)(&DAT_002474bc + iVar48) ^
                   *(uint *)(&DAT_002474bc + iVar45) ^
                   *(uint *)(&DAT_002474bc + iVar44) ^
                   *(uint *)(&DAT_002474bc + iVar46) ^ local_290[3] ^
                   *(uint *)(&DAT_002474bc + iVar54) ^ *(uint *)(&DAT_002474bc + iVar2);
        ...
        local_3c = *(uint *)(&DAT_002474bc + iVar31) ^
                   *(uint *)(&DAT_002474bc + iVar28) ^
                   *(uint *)(&DAT_002474bc + iVar19) ^
                   *(uint *)(&DAT_002474bc + iVar7) ^ *(uint *)(&DAT_002474bc + iVar14) ^
                   *(uint *)(&DAT_002474bc + iVar26) ^ *(uint *)(&DAT_002474bc + iVar55) ^
                   *(uint *)(&DAT_002474bc + iVar3);
        local_34 = *(uint *)(&DAT_002474bc + iVar35) ^
                   *(uint *)(&DAT_002474bc + iVar30) ^
                   *(uint *)(&DAT_002474bc + iVar27) ^
                   *(uint *)(&DAT_002474bc + iVar8) ^ *(uint *)(&DAT_002474bc + iVar25) ^
                   *(uint *)(&DAT_002474bc + iVar29) ^ *(uint *)(&DAT_002474bc + iVar32) ^
                   *(uint *)(&DAT_002474bc + iVar1);
        ...
        uVar84 = uVar79 ^ *(uint *)(&Cx + iVar7) ^
                          ...
                          *(uint *)(&Cx + iVar9) ^ *(uint *)(&Cx + iVar10) ^ *(uint *)(&Cx + iVar20)
                          ^ *(uint *)(&Cx + iVar19);
        uVar85 = uVar81 ^ *(uint *)(&DAT_002474bc + iVar7) ^
                          *(uint *)(&DAT_002474bc + iVar8) ^
                          *(uint *)(&DAT_002474bc + iVar3) ^ *(uint *)(&DAT_002474bc + iVar5) ^
                          *(uint *)(&DAT_002474bc + iVar9) ^ *(uint *)(&DAT_002474bc + iVar10) ^
                          *(uint *)(&DAT_002474bc + iVar20) ^ *(uint *)(&DAT_002474bc + iVar19);
        ...
        local_a4 = local_64 ^
                   *(uint *)(&DAT_002474bc + iVar5) ^
                   *(uint *)(&DAT_002474bc + iVar25) ^
                   *(uint *)(&DAT_002474bc + iVar59) ^
                   *(uint *)(&DAT_002474bc + iVar16) ^
                   *(uint *)(&DAT_002474bc + iVar13) ^
                   *(uint *)(&DAT_002474bc + iVar6) ^ *(uint *)(&DAT_002474bc + iVar11) ^
                   *(uint *)(&DAT_002474bc + iVar21);
        local_a0 = local_60 ^
                   *(uint *)(&Cx + iVar8) ^
                   *(uint *)(&Cx + iVar26) ^
        ...
        local_9c = local_5c ^
                   *(uint *)(&DAT_002474bc + iVar8) ^
                   *(uint *)(&DAT_002474bc + iVar26) ^
                   *(uint *)(&DAT_002474bc + iVar22) ^
                   *(uint *)(&DAT_002474bc + iVar17) ^
                   *(uint *)(&DAT_002474bc + iVar14) ^
                   *(uint *)(&DAT_002474bc + iVar24) ^
                   *(uint *)(&DAT_002474bc + iVar12) ^ *(uint *)(&DAT_002474bc + iVar1);
        local_98 = local_58 ^
                   *(uint *)(&Cx + iVar9) ^
                   *(uint *)(&Cx + iVar3) ^
                   *(uint *)(&Cx + iVar23) ^
        ...
        local_94 = local_54 ^
                   *(uint *)(&DAT_002474bc + iVar9) ^
                   *(uint *)(&DAT_002474bc + iVar3) ^
                   *(uint *)(&DAT_002474bc + iVar23) ^
                   *(uint *)(&DAT_002474bc + iVar15) ^
                   *(uint *)(&DAT_002474bc + iVar4) ^ *(uint *)(&DAT_002474bc + iVar2) ^
                   *(uint *)(&DAT_002474bc + iVar7) ^ *(uint *)(&DAT_002474bc + iVar18);
        local_90 = local_50 ^
                   *(uint *)(&Cx + iVar46) ^
                   *(uint *)(&Cx + iVar43) ^
                   *(uint *)(&Cx + iVar39) ^
                   ...
                   *(uint *)(&Cx + iVar41);
        local_8c = local_4c ^
                   *(uint *)(&DAT_002474bc + iVar46) ^
                   *(uint *)(&DAT_002474bc + iVar43) ^
                   *(uint *)(&DAT_002474bc + iVar39) ^
                   *(uint *)(&DAT_002474bc + iVar31) ^
                   *(uint *)(&DAT_002474bc + iVar35) ^
                   *(uint *)(&DAT_002474bc + iVar10) ^ *(uint *)(&DAT_002474bc + iVar28) ^
                   *(uint *)(&DAT_002474bc + iVar41);
        local_88 = local_48 ^
                   *(uint *)(&Cx + iVar47) ^
                   *(uint *)(&Cx + iVar44) ^
                   *(uint *)(&Cx + iVar42) ^
        ...
        local_84 = local_44 ^
                   *(uint *)(&DAT_002474bc + iVar47) ^
                   *(uint *)(&DAT_002474bc + iVar44) ^
                   *(uint *)(&DAT_002474bc + iVar42) ^
                   *(uint *)(&DAT_002474bc + iVar37) ^
                   *(uint *)(&DAT_002474bc + iVar33) ^
                   *(uint *)(&DAT_002474bc + iVar32) ^
                   *(uint *)(&DAT_002474bc + iVar29) ^ *(uint *)(&DAT_002474bc + iVar19);
        local_78 = local_38 ^
                   *(uint *)(&Cx + iVar55) ^
                   ...
                   *(uint *)(&Cx + iVar54);
        local_74 = local_34 ^
                   *(uint *)(&DAT_002474bc + iVar55) ^
                   *(uint *)(&DAT_002474bc + iVar50) ^ *(uint *)(&DAT_002474bc + iVar27) ^
                   *(uint *)(&DAT_002474bc + iVar51) ^ *(uint *)(&DAT_002474bc + iVar49) ^
                   *(uint *)(&DAT_002474bc + iVar52) ^ *(uint *)(&DAT_002474bc + iVar53) ^
                   *(uint *)(&DAT_002474bc + iVar54);
        local_80 = local_40 ^
                   *(uint *)(&Cx + iVar48) ^
                   *(uint *)(&Cx + iVar45) ^
                   *(uint *)(&Cx + iVar38) ^
        ...
        local_7c = local_3c ^
                   *(uint *)(&DAT_002474bc + iVar48) ^
                   *(uint *)(&DAT_002474bc + iVar45) ^
                   *(uint *)(&DAT_002474bc + iVar38) ^
                   *(uint *)(&DAT_002474bc + iVar30) ^ *(uint *)(&DAT_002474bc + iVar20) ^
                   *(uint *)(&DAT_002474bc + iVar34) ^ *(uint *)(&DAT_002474bc + iVar36) ^
                   *(uint *)(&DAT_002474bc + iVar40);
        local_290 = puVar80;
        local_30 = uVar79;
        local_2c = uVar81;
      } while (puVar80 != (uint *)&DAT_0024b500);
      if (local_ec == 0) {
