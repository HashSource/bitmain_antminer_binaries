...

{
  ...
  if (s == (SSL *)0x0) goto LAB_0011657e;
  memset(s,0,0x1dc);
  pcVar1 = ctx->cert;
  uVar6 = ctx->mode;
    ...
    *(undefined4 *)(s->sid_ctx + 0x1c) = uVar5;
    ...
    if (to != (X509_VERIFY_PARAM *)0x0) {
      ...
      if (pvVar4 != (void *)0x0) {
        ...
        if (pvVar4 == (void *)0x0) goto LAB_0011655e;
      ...
      if (*(int *)(s->psk_server_callback + 0x1c0) != 0) {
        ...
        s[1].init_buf = __dest;
        if (__dest == (BUF_MEM *)0x0) goto LAB_0011655e;
      ...
      if (iVar7 != 0) {
        ...
        pcVar12 = pSVar11->ssl_accept + -0x115e91;
        if (pcVar12 != (code *)0x0) {
          pcVar12 = (code *)0x1;
        }
    ...
    s->cert = pcVar1;
    if (pcVar1 != (cert_st *)0x0) goto LAB_001163b2;
  }
LAB_0011655e:
