        ...
        if (iVar13 == 0x198) {
          if ((local_28 == 5) || (local_28 == -1)) {
            ...
            if (pEVar3 != (EVP_PKEY *)0x0) {
              ...
              if (local_2c == (EVP_MD *)0x0) goto LAB_00192c44;
              iVar13 = EC_KEY_set_group((EC_KEY *)local_2c,group);
              if (iVar13 != 0) goto LAB_00192e4c;
            }
            goto LAB_00192c2a;
          }
      ...
      if ((iVar13 != 0) && (iVar13 = OBJ_find_sigid_algs(iVar13,&local_28,&local_40), iVar13 != 0))
      {
        ...
        if ((0 < iVar13) &&
          ...
          if ((pEVar8 != (EVP_MD *)0x0) &&
            ...
            if (*local_34->ln != (char *)0x10) goto LAB_00192c8a;
...
LAB_00192c8a:
    ...
    if (param_3 != (EVP_MD *)0x0) goto switchD_00192936_caseD_2;
    local_2c = param_3;
    pEVar2 = (EVP_PKEY_CTX *)CMS_RecipientInfo_get0_pkey_ctx(param_4);
    if (pEVar2 == (EVP_PKEY_CTX *)0x0) {
      return 0;
...
LAB_0019299c:
      ...
      if (pXVar14 == (X509_ALGOR *)0x0) goto LAB_00192994;
