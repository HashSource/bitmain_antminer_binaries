...

{
  ...
  *(undefined4 *)val = 1;
  if (puVar14 == (undefined4 *)0x0 || param_1 == (EC_GROUP *)0x0) goto LAB_001905be;
...
LAB_0019094a:
  ...
  if (iVar4 == 0x196) {
    pBVar8 = BN_new();
    iVar4 = 0x14e;
    if (pBVar8 == (BIGNUM *)0x0) goto LAB_001908e0;
...
joined_r0x00190aa4:
          ...
          if (to != (uchar *)0x0) {
            ...
            if (local_34 != 0) goto LAB_0019077c;
...
joined_r0x00190aa4:
        if (puVar15 != (uchar *)0x0) goto LAB_00190a46;
      }
      else {
...
LAB_00190946:
          ...
          if (iVar4 != 2) goto LAB_001905ac;
          pAVar5 = OBJ_nid2obj(0x2aa);
          *(ASN1_OBJECT **)(pAVar6 + 4) = pAVar5;
          if (pAVar5 == (ASN1_OBJECT *)0x0) goto LAB_00190946;
          pEVar3 = EC_GROUP_method_of(param_1);
          iVar4 = EC_METHOD_get_field_type(pEVar3);
          if (((iVar4 == 0x197) && (*(int *)(param_1 + 0x5c) != 0)) &&
