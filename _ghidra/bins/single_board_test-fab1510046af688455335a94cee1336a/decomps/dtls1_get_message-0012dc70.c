...
LAB_0012de86:
  ...
  if (uVar14 == 0xc) {
    ...
    {
      if (local_158[1] < uVar17 + uVar14) goto LAB_0012dfb8;
      local_16c[0] = '\0';
      local_16c[1] = '\0';
      local_16c[2] = '\0';
      local_16c[3] = '\0';
      ...
      if ((((uVar14 < (local_158[2] & 0xffff)) && ((local_158[2] & 0xffff) <= uVar14 + 10)) &&
        ...
        if (uVar17 != local_158[1]) goto LAB_0012e0fe;
        uVar14 = param_1[0x42];
        if (uVar14 < 0x454c) {
          uVar14 = 0x454c;
        }
...
LAB_0012e06e:
          ...
          if (ppVar8 != (pitem *)0x0) {
            ...
            if (ppVar8 != (pitem *)0x0) goto LAB_0012dcd6;
          ...
          if (uVar17 == uVar14) {
            if (0 < (int)uVar14) goto LAB_0012e06e;
          }
          else {
            uVar14 = 0xffffffff;
          }
...
LAB_0012e0ac:
  ...
  if (0 < (int)uVar14) goto LAB_0012e0a6;
  uVar12 = uVar14 + 3;
LAB_0012dfbe:
  *param_6 = 0;
LAB_0012de8a:
