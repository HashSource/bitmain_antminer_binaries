          ...
          do {
            ...
            do {
              while( true ) {
                ...
                uVar10 = (uint)*pbVar6;
                iVar13 = iVar13 + -1;
                if (uVar10 == 0x20 || uVar10 == 0x2e) goto LAB_001586cc;
                if (9 < uVar10 - 0x30) {
                ...
                if (((a == (BIGNUM *)0x0) && (a = BN_new(), a == (BIGNUM *)0x0)) ||
                   (iVar5 = BN_set_word(a,w), iVar5 == 0)) goto LAB_001587b4;
                bVar2 = true;
LAB_001586b0:
                iVar5 = BN_mul_word(a,10);
                if ((iVar5 == 0) || (iVar5 = BN_add_word(a,uVar10 - 0x30), iVar5 == 0))
                goto LAB_001587b4;
                if (iVar13 == 0) goto LAB_001586cc;
              }
              if (bVar2) goto LAB_001586b0;
              w = (uVar10 + w * 10) - 0x30;
            } while (iVar13 != 0);
LAB_001586cc:
            if (local_64 == 0) {
...
LAB_0015880e:
              ...
              if (local_48 < iVar5) {
                ...
                if (local_5c == (uchar *)0x0) goto LAB_001587bc;
              }
              if (iVar5 != 0) {
                iVar11 = 0;
                do {
