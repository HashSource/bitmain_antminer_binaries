...

{
  ...
  if (g_pt1.board_sn[0] == '\0') {
    ...
    len = 0x20;
    snprintf(board_sn,0x20,"%s",0x10712a4);
    (*v5->board_sn_set)(v5,board_sn,&len);
    snprintf(tmp42,0x100,"board_sn:%s",0x10712a4);
    puts(tmp42);
    len = 0x10;
    memset(chip_die,0,0x10);
    snprintf(chip_die,0x10,"%s",0x1071238);
    (*v5->chip_die_set)(v5,chip_die,&len);
    snprintf(tmp42,0x100,"chip_die:%s",0x1071238);
    puts(tmp42);
    len = 0x10;
    memset(chip_marking,0,0x10);
    snprintf(chip_marking,0x10,"%s",0x1071248);
    (*v5->chip_marking_set)(v5,chip_marking,&len);
    snprintf(tmp42,0x100,"chip_marking:%s",0x1071248);
    puts(tmp42);
    len = 0x10;
    memset(chip_ftversion,0,0x10);
    snprintf(chip_ftversion,0x10,"%s",0x1071258);
    (*v5->ft_version_set)(v5,chip_ftversion,&len);
    snprintf(tmp42,0x100,"chip_ftversion:%s",0x1071258);
    puts(tmp42);
    len = 3;
    memset(chip_tech,0,3);
    snprintf(chip_tech,3,"%s",0x1071298);
    (*v5->chip_tech_set)(v5,chip_tech,&len);
    snprintf(tmp42,0x100,"chip_tech:%s",0x1071298);
    puts(tmp42);
    (*v5->chip_bin_set)(v5,(uint8_t)g_pt1.chip_bin);
    snprintf(tmp42,0x100,"create_v5 set chip_bin %d",g_pt1.chip_bin);
    puts(tmp42);
