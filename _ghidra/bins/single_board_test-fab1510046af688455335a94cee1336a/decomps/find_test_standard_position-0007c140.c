...

{
  ...
  bVar4 = false;
  bVar5 = false;
  find_test_loop[0] = false;
  find_test_loop[1] = false;
  find_test_loop[2] = false;
  find_test_loop[3] = false;
  find_test_loop[4] = false;
  find_test_loop[5] = false;
  find_test_loop[6] = false;
  find_test_loop[7] = false;
  find_test_loop[8] = false;
  find_test_loop[9] = false;
  ...
  snprintf(tmp1,0x800,"%s %s %s%s%s %s %s BIN%d",miner_type,board_name,hardware_version,bom_version,
...
LAB_0007c5ae:
      if (Mes_System_Hw_Info_ptr != (Mes_System_Hw_Info *)0x0) {
        ...
        for (index = 0; index < gPower_version_array_size; index = index + 1) {
          ...
          snprintf(tmp1,0x800,"APW_power_version[%d]: %d",index,(uint)APW_power_version[index]);
          log_to_file(tmp1,time_stamp);
        }
        bVar1 = true;
      }
...
LAB_0007ccca:
        if (Mes_System_Test_Config_ptr != (Mes_System_Test_Config *)0x0) {
          ...
          if ((iVar6 != 0) || (Mes_System_Test_Config_ptr->bin != bin)) goto LAB_0007ccb4;
          ...
          snprintf(tmp1,0x800,"test_method_id: %d",test_method_id);
          log_to_file(tmp1,time_stamp);
          ...
          (Local_Config_Information->Test_Info).Test_Standard.leakage_current =
               Mes_System_Test_Config_ptr->leakage_current;
          print_time_stamp(time_stamp,0x30);
          printf("%s ",time_stamp);
          ...
          snprintf(tmp1,0x800,"gTest_loop_id_array_size: %d",gTest_loop_id_array_size);
          log_to_file(tmp1,time_stamp);
          if (10 < gTest_loop_id_array_size) {
            print_time_stamp(time_stamp,0x30);
            printf("%s ",time_stamp);
            printf("%s: gTest_loop_id_array_size is %d, bigger than %d\n",
                   "find_test_standard_position",gTest_loop_id_array_size,10);
            snprintf(tmp1,0x800,"gTest_loop_id_array_size is %d, bigger than %d",
          ...
          snprintf(tmp1,0x800,"gTest_loop: %d",gTest_loop_id_array_size);
          log_to_file(tmp1,time_stamp);
        ...
        if (bVar2) {
          for (Mes_System_Pattern_ptr = (Mes_System_Configs_ptr->rule).pattern;
            ...
            if (Mes_System_Pattern_ptr->id == pattern_id) {
              ...
              snprintf(tmp1,0x800,"pattern[%d]->id: %d",pattern_array_index,
                       Mes_System_Pattern_ptr->id);
              log_to_file(tmp1,time_stamp);
              ...
              printf("%s: pattern[%d]->Pattern_Number: %d\n","find_test_standard_position",
                     pattern_array_index,
                     (Local_Config_Information->Test_Info).Test_Standard.Pattern_Number);
              snprintf(tmp1,0x800,"pattern[%d]->Pattern_Number: %d",pattern_array_index,
                       (Local_Config_Information->Test_Info).Test_Standard.Pattern_Number);
              log_to_file(tmp1,time_stamp);
              ...
              printf("%s: pattern[%d]->Invalid_Core_Number: %d\n","find_test_standard_position",
                     pattern_array_index,
                     (Local_Config_Information->Test_Info).Test_Standard.Invalid_Core_Number);
              snprintf(tmp1,0x800,"pattern[%d]->Invalid_Core_Number: %d",pattern_array_index,
                       (Local_Config_Information->Test_Info).Test_Standard.Invalid_Core_Number);
              log_to_file(tmp1,time_stamp);
              ...
              printf("%s: pattern[%d]->Most_HW_Num: %d\n","find_test_standard_position",
                     pattern_array_index,
                     (Local_Config_Information->Test_Info).Test_Standard.Most_HW_Num);
              snprintf(tmp1,0x800,"pattern[%d]->Most_HW_Num: %d",pattern_array_index,
                       (Local_Config_Information->Test_Info).Test_Standard.Most_HW_Num);
              log_to_file(tmp1,time_stamp);
              ...
              printf("%s: pattern[%d]->Least_Nonce_Per_Core: %d\n","find_test_standard_position",
                     pattern_array_index,
                     (Local_Config_Information->Test_Info).Test_Standard.Least_Nonce_Per_Core);
              snprintf(tmp1,0x800,"pattern[%d]->Least_Nonce_Per_Core: %d",pattern_array_index,
                       (Local_Config_Information->Test_Info).Test_Standard.Least_Nonce_Per_Core);
              log_to_file(tmp1,time_stamp);
              ...
              printf("%s: pattern[%d]->Nonce_Rate: %d\n","find_test_standard_position",
                     pattern_array_index,
                     (Local_Config_Information->Test_Info).Test_Standard.Nonce_Rate);
              snprintf(tmp1,0x800,"pattern[%d]->Nonce_Rate: %d",pattern_array_index,
                       (Local_Config_Information->Test_Info).Test_Standard.Nonce_Rate);
              log_to_file(tmp1,time_stamp);
              ...
              printf("%s: pattern[%d]->Midstate_Number: %d\n","find_test_standard_position",
                     pattern_array_index,
                     (Local_Config_Information->Test_Info).Test_Method.Midstate_Number);
              snprintf(tmp1,0x800,"pattern[%d]->Midstate_Number: %d",pattern_array_index,
                       (Local_Config_Information->Test_Info).Test_Method.Midstate_Number);
              log_to_file(tmp1,time_stamp);
              bVar3 = true;
              break;
          ...
          if (bVar3) {
            for (Mes_System_Asic_Reg_ptr = (Mes_System_Configs_ptr->rule).asic_reg;
              ...
              if (Mes_System_Asic_Reg_ptr->id == asic_reg_id) {
                ...
                snprintf(tmp1,0x800,"asic_reg[%d]->id: %d",asic_reg_array_index,
                ...
                printf("%s: asic_reg[%d]->CCdly_Sel: %d\n","find_test_standard_position",
                       ...
                       (Local_Config_Information->Test_Info).Asic_Register.CCdly_Sel);
                snprintf(tmp1,0x800,"asic_reg[%d]->CCdly_Sel: %d",asic_reg_array_index,
                         (Local_Config_Information->Test_Info).Asic_Register.CCdly_Sel);
                log_to_file(tmp1,time_stamp);
                ...
                printf("%s: asic_reg[%d]->Pwth_Sel: %d\n","find_test_standard_position",
                       asic_reg_array_index,
                       (Local_Config_Information->Test_Info).Asic_Register.Pwth_Sel);
                snprintf(tmp1,0x800,"asic_reg[%d]->Pwth_Sel: %d",asic_reg_array_index,
                         (Local_Config_Information->Test_Info).Asic_Register.Pwth_Sel);
                log_to_file(tmp1,time_stamp);
                ...
                printf("%s: asic_reg[%d]->Swpf_Mode: %d\n","find_test_standard_position",
                       asic_reg_array_index,
                       (Local_Config_Information->Test_Info).Asic_Register.Swpf_Mode);
                snprintf(tmp1,0x800,"asic_reg[%d]->Swpf_Mode: %d",asic_reg_array_index,
                         (Local_Config_Information->Test_Info).Asic_Register.Swpf_Mode);
                log_to_file(tmp1,time_stamp);
                ...
                printf("%s: asic_reg[%d]->Pulse_Mode: %d\n","find_test_standard_position",
                       asic_reg_array_index,
                       (Local_Config_Information->Test_Info).Asic_Register.Pulse_Mode);
                snprintf(tmp1,0x800,"asic_reg[%d]->Pulse_Mode: %d",asic_reg_array_index,
                         (Local_Config_Information->Test_Info).Asic_Register.Pulse_Mode);
                log_to_file(tmp1,time_stamp);
                ...
                printf("%s: asic_reg[%d]->Clk_Sel: %d\n","find_test_standard_position",
                       asic_reg_array_index,
                       (Local_Config_Information->Test_Info).Asic_Register.Clk_Sel);
                snprintf(tmp1,0x800,"asic_reg[%d]->Clk_Sel: %d",asic_reg_array_index,
                         (Local_Config_Information->Test_Info).Asic_Register.Clk_Sel);
                log_to_file(tmp1,time_stamp);
                ...
                printf("%s: asic_reg[%d]->RO_Relay_En: %d\n","find_test_standard_position",
                       asic_reg_array_index,
                       (Local_Config_Information->Test_Info).Asic_Register.RO_Relay_En);
                snprintf(tmp1,0x800,"asic_reg[%d]->RO_Relay_En: %d",asic_reg_array_index,
                         (Local_Config_Information->Test_Info).Asic_Register.RO_Relay_En);
                log_to_file(tmp1,time_stamp);
                ...
                printf("%s: asic_reg[%d]->CO_Relay_En: %d\n","find_test_standard_position",
                       asic_reg_array_index,
                       (Local_Config_Information->Test_Info).Asic_Register.CO_Relay_En);
                snprintf(tmp1,0x800,"asic_reg[%d]->CO_Relay_En: %d",asic_reg_array_index,
                         (Local_Config_Information->Test_Info).Asic_Register.CO_Relay_En);
                log_to_file(tmp1,time_stamp);
                ...
                printf("%s: asic_reg[%d]->Diode_Vdd_Mux_Sel: %d\n","find_test_standard_position",
                       asic_reg_array_index,
                       (Local_Config_Information->Test_Info).Asic_Register.Diode_Vdd_Mux_Sel);
                snprintf(tmp1,0x800,"asic_reg[%d]->Diode_Vdd_Mux_Sel: %d",asic_reg_array_index,
                         (Local_Config_Information->Test_Info).Asic_Register.Diode_Vdd_Mux_Sel);
                log_to_file(tmp1,time_stamp);
                bVar4 = true;
                break;
            ...
            if (!bVar4) {
              ...
              snprintf(tmp1,0x800,"can\'t find:: asic_reg_id: %d",asic_reg_id);
              log_to_file(tmp1,time_stamp);
              goto LAB_0007e0f6;
            }
...
LAB_0007dcc8:
                if (bVar5) {
                  for (index = 0; index < gTest_loop_id_array_size; index = index + 1) {
                    ...
                    for (Mes_System_Test_Loop_ptr = (Mes_System_Configs_ptr->rule).test_loop;
                      ...
                      if (Mes_System_Test_Loop_ptr->id ==
                        ...
                        snprintf(tmp1,0x800,"test_loop[%d]->id: %d",test_loop_array_index,
                        ...
                        printf("%s: test_loop[%d]->Frequence: %d\n","find_test_standard_position",
                               ...
                               (Local_Config_Information->Test_Info).Test_Standard.Test_Loop[index].
                               Frequence);
                        snprintf(tmp1,0x800,"test_loop[%d]->Frequence: %d",test_loop_array_index,
                        ...
                        printf("%s: test_loop[%d]->Voltage: %d\n","find_test_standard_position",
                               ...
                               (Local_Config_Information->Test_Info).Test_Standard.Test_Loop[index].
                               Voltage);
                        snprintf(tmp1,0x800,"test_loop[%d]->Voltage: %d",test_loop_array_index,
                                 (Local_Config_Information->Test_Info).Test_Standard.Test_Loop
                                 [index].Voltage);
                        log_to_file(tmp1,time_stamp);
                  ...
                  for (index = 0; index < gTest_loop_id_array_size; index = index + 1) {
                    ...
                    if (find_test_loop[index] != true) {
                      ...
                      printf("%s: can\'t find:: test_loop id: %d\n","find_test_standard_position",
                             (Local_Config_Information->Test_Info).Test_Standard.Test_Loop[index].
                             Level);
                      snprintf(tmp1,0x800,"can\'t find:: test_loop id: %d",
                               (Local_Config_Information->Test_Info).Test_Standard.Test_Loop[index].
                               Level);
                      log_to_file(tmp1,time_stamp);
                    }
                  ...
                  printf("%s: can\'t find:: test_method_id: %d\n","find_test_standard_position",
                         test_method_id);
                  snprintf(tmp1,0x800,"can\'t find:: test_method_id: %d",test_method_id);
                  log_to_file(tmp1,time_stamp);
                }
                goto LAB_0007e0f6;
              }
              if (Mes_System_Test_Method_ptr->id == test_method_id) {
                ...
                snprintf(tmp1,0x800,"test_method[%d]->id: %d",test_method_array_index,
                ...
                if (iVar6 == 0) {
                  ...
                  snprintf(tmp1,0x800,"Software_Pattern : %s",pcVar7);
                  log_to_file(tmp1,time_stamp);
                }
                else {
                  ...
                  if (iVar6 == 0) {
                    ...
                    snprintf(tmp1,0x800,"Super_Software_Pattern : %s",pcVar7);
                    log_to_file(tmp1,time_stamp);
                  }
                  else {
                    ...
                    if (iVar6 == 0) {
                      ...
                      if (iVar6 == 0) {
                        ...
                        snprintf(tmp1,0x800,"test_method[%d]: %s. error",test_method_array_index,
          ...
          snprintf(tmp1,0x800,"can\'t find:: pattern_id: %d",pattern_id);
          log_to_file(tmp1,time_stamp);
        }
        else {
          print_time_stamp(time_stamp,0x30);
          ...
          snprintf(tmp1,0x800,"can\'t find::  %s%s%s, %s, BIN%d",hardware_version,bom_version,
        ...
        snprintf(tmp1,0x800,"can\'t find:: board_name: %s, asic_type: %s",board_name,asic_type);
        log_to_file(tmp1,time_stamp);
      }
    }
LAB_0007e0f6:
