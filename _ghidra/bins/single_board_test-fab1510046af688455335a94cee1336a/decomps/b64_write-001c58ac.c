        ...
        if (0 < iVar5) {
          do {
            ...
            if (iVar5 < (int)puVar2) {
              ...
              outl[1] = (int)puVar4;
              if ((int)puVar4 < 0x5df) goto LAB_001c5a36;
LAB_001c5a76:
              OpenSSLDie("bio_b64.c",0x1d1,"ctx->buf_off <= (int)sizeof(ctx->buf)");
              if (*outl < outl[1]) goto LAB_001c5a8a;
            }
            else {
              puVar4 = puVar2 + outl[1];
              outl[1] = (int)puVar4;
              if (0x5de < (int)puVar4) goto LAB_001c5a76;
LAB_001c5a36:
              if (*outl < (int)puVar4) {
LAB_001c5a8a:
    ...
    while (local_30 = (uchar *)BIO_write(param_1->next_bio,(void *)((int)outl + iVar1 + 0x7c),iVar5)
      ...
      if (iVar5 < (int)local_30) {
        ...
        outl[1] = (int)puVar3;
        if ((int)puVar3 < 0x5df) goto LAB_001c5914;
LAB_001c5954:
        OpenSSLDie("bio_b64.c",0x186,"ctx->buf_off <= (int)sizeof(ctx->buf)");
        if (*outl < outl[1]) goto LAB_001c5968;
      }
      else {
        puVar3 = local_30 + outl[1];
        outl[1] = (int)puVar3;
        if (0x5de < (int)puVar3) goto LAB_001c5954;
LAB_001c5914:
        if (*outl < (int)puVar3) {
LAB_001c5968:
      ...
      if (iVar5 - (int)local_30 < 1) goto LAB_001c5978;
      iVar1 = outl[1];
