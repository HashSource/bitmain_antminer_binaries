...
LAB_00125bc0:
  ...
  case 0xe:
    ...
    if (st == (_STACK *)0x0) {
      ...
      *(_STACK **)(param_1 + 0x94) = st;
      if (st == (_STACK *)0x0) goto switchD_0012597e_caseD_8;
    }
    sk_push(st,param_4);
    break;
  case 0x36:
  ...
  case 0x51:
    ...
    *(undefined4 *)(param_1 + 0x170) = 0x124ec9;
    break;
  case 0x52:
  ...
  case 0x53:
    if (*(_STACK **)(param_1 + 0x94) != (_STACK *)0x0) {
      sk_pop_free(*(_STACK **)(param_1 + 0x94),(func *)0x15a509);
