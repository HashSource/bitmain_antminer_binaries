    ...
    if (iVar5 == 0x5b) {
      ...
      if (iVar5 != 0x5d) {
        while (iVar5 != 0) {
          ...
          lex_scan(lex,error);
          if (lex->token != 0x2c) {
            if (lex->token == 0x5d) goto LAB_001d49e8;
            break;
          }
          lex_scan(lex,error);
          iVar5 = lex->token;
        ...
        if (lex->token != 0x7d) {
          if (lex->token == 0x100) {
            ...
            while( true ) {
              ...
              lex_scan(lex,error);
              if (lex->token != 0x100) goto LAB_001d4bc2;
              pcVar8 = (lex->value).string.val;
              __n = (lex->value).string.len;
              (lex->value).string.val = (char *)0x0;
              (lex->value).string.len = 0;
            ...
            if (lex->token == 0x7d) goto LAB_001d49e8;
            error_set(error,lex,json_error_invalid_syntax,"\'}\' expected");
          }
          else {
LAB_001d4bc2:
...
LAB_001d4bce:
        ...
        if (iVar5 != 0x100) goto LAB_001d4996;
        pcVar8 = (lex->value).string.val;
    ...
    if (iVar5 != 0x105) goto LAB_001d4996;
    json = json_null();
  }
LAB_001d49e8:
  if (json != (json_t *)0x0) {
