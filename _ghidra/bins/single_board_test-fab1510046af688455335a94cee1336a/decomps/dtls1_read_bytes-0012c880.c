...

{
  ...
  if (param_2 == 0 || param_2 == 0x17) {
    ...
    if (uVar14 != 0) goto LAB_0012ce18;
    if (param_2 != 0x16) goto LAB_0012c8fe;
  }
  else {
    if (param_2 != 0x16) {
LAB_0012ce18:
...
LAB_0012c9f0:
    ...
    if (iVar6 != 0x16) {
      ...
      if (iVar6 == 0x14) goto LAB_0012ca88;
      if (iVar6 == 0x17) {
...
LAB_0012ca88:
    if (((param_1->server != 0) || (pdVar15->change_cipher_spec_ok < 0xc)) ||
      ...
      if (*(uint *)(pdVar15->handshake_fragment + 4) < 2) {
        ...
        if ((pdVar15->change_cipher_spec_ok < 0xc) || (param_1->in_handshake != 0)) {
          ...
          if (param_1->version == 0x301) goto LAB_0012c9f0;
          iVar6 = 0x54f;
          goto LAB_0012cea0;
        }
        ...
        if ((psVar19->rrec).epoch == (uint)param_1->d1->r_epoch) {
          if (local_58[0] != '\x14') {
            ...
            if ((int)(param_1->options << 0x1d) < 0) goto LAB_0012c91c;
            psVar19 = param_1->s3;
    ...
    if (iVar6 != 3) goto LAB_0012c91c;
    psVar19 = param_1->s3;
    if ((psVar19->flags << 0x1f < 0) || (psVar19->renegotiate != 0)) goto LAB_0012c91e;
    param_1->d1->handshake_read_seq = param_1->d1->handshake_read_seq + 1;
    param_1->new_session = 1;
