...
LAB_001bc606:
    uVar18 = *puVar22;
    if (local_70 != 0) goto LAB_001bc6ba;
LAB_001bc610:
    if (uVar18 != 0) {
LAB_001bc616:
      puVar12 = puVar20;
...
LAB_001bc61c:
        ...
        if (local_70 != local_64) goto LAB_001bc606;
        iVar7 = local_70 + 0x1e;
        if (-1 < local_70 + -1) {
          iVar7 = local_70 + -1;
        }
...
LAB_001bc6a4:
        ...
        uVar18 = *puVar22;
        if (local_70 == 0) goto LAB_001bc610;
LAB_001bc6ba:
        if ((uVar18 & 1) != 0) {
          puVar12 = puVar20;
          puVar5 = puVar11;
          if (local_70 < 0x21) goto LAB_001bc616;
          goto LAB_001bc61c;
        }
        puVar12 = param_3->d;
