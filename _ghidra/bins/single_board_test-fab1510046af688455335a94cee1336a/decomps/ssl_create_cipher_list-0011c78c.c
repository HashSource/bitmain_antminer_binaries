...
LAB_0011c7d4:
  ...
  uVar29 = uVar15 | uVar6 | uVar11 | uVar9 | uVar4 | uVar19 | uVar22 | uVar10 | uVar14 | uVar5 |
                                     uVar20 | uVar29;
  if ((ssl_digest_methods._12_4_ == 0) || (DAT_0024d4f8 == 0)) {
    uVar9 = 8;
  }
  else {
    uVar9 = 0;
  ...
  if (iVar13 < 1) {
LAB_0011d0c2:
    if (local_34 == (int *)0x0) goto LAB_0011d14a;
    piVar7 = local_38;
    piVar16 = local_34;
    if (local_38 != (int *)0x0) goto LAB_0011cb52;
LAB_0011d088:
    local_38 = (int *)0x0;
  }
  else {
...
LAB_0011cb52:
    ...
    piVar7 = local_38;
    piVar16 = local_34;
    if (local_38 == (int *)0x0) goto LAB_0011d088;
    do {
    ...
    piVar16 = local_34;
    piVar12 = piVar7;
    if (piVar7 == (int *)0x0) goto LAB_0011d088;
    do {
      piVar31 = (int *)piVar7[3];
    ...
    piVar7 = piVar12;
    local_34 = piVar16;
    if (piVar12 == (int *)0x0) goto LAB_0011d088;
    do {
...
LAB_0011d14a:
      ...
      local_38 = piVar7;
      if (piVar31 == (int *)0x0) goto LAB_0011d14a;
      piVar16 = piVar7;
      local_34 = piVar31;
      piVar12 = piVar31;
      if (piVar7 == (int *)0x0) goto LAB_0011d088;
      ...
      local_38 = piVar7;
      if (piVar30 == (int *)0x0) goto LAB_0011d14a;
      local_34 = piVar30;
      if (piVar7 == (int *)0x0) goto LAB_0011d088;
      do {
...
LAB_0011d154:
    ...
    do {
      iVar34 = iVar13 + 1;
      HintPreloadData(iVar13 * 0x30 + 0x1f5608);
      piVar12 = piVar16;
...
LAB_0011d0b2:
    ...
    if (st != (_STACK *)0x0) {
      for (; piVar7 != (int *)0x0; piVar7 = (int *)piVar7[3]) {
        while (piVar7[1] == 0) {
          piVar7 = (int *)piVar7[3];
          if (piVar7 == (int *)0x0) goto LAB_0011d032;
        }
...
LAB_0011d032:
      ...
      if (p_Var8 != (_STACK *)0x0) {
        ...
        *param_3 = p_Var8;
        sk_set_cmp_func(p_Var8,(void *)0x1172d5);
