...

{
  ...
  do {
    ...
    if (iVar1 <= iVar4) {
      ...
      iVar4 = *piVar8;
      if (3 < iVar4) goto LAB_00173d00;
      puVar2 = (undefined4 *)piVar8[1];
      if (puVar2 == (undefined4 *)0x0) goto LAB_00173d5c;
      iVar4 = 0;
      goto LAB_00173d0a;
    }
...
LAB_00173d4a:
  ...
  if (iVar4 < iVar1) goto LAB_00173d3e;
  iVar4 = *piVar8;
LAB_00173d5c:
  if (iVar4 < 3) {
    iVar4 = 0;
