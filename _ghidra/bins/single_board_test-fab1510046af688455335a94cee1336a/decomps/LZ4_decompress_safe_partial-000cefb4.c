...
/* WARNING: Removing unreachable block (ram,0x000cf49a) */
/* WARNING: Removing unreachable block (ram,0x000cf4a4) */
/* WARNING: Removing unreachable block (ram,0x000cf4a6) */
/* WARNING: Removing unreachable block (ram,0x000cf4a8) */
/* WARNING: Removing unreachable block (ram,0x000cf4ae) */
/* WARNING: Removing unreachable block (ram,0x000cf07e) */
/* WARNING: Removing unreachable block (ram,0x000cf086) */
/* WARNING: Removing unreachable block (ram,0x000cf096) */
/* WARNING: Removing unreachable block (ram,0x000cf08e) */
...
LAB_000cf1d6:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000cf932;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000cf932;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_000cf1d6;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000cf932;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000cf932;
              op = pBVar10;
