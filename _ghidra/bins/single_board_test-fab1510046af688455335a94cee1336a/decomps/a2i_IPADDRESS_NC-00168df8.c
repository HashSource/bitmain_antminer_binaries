...

{
  ...
  if ((pcVar1 != (char *)0x0) && (__s = BUF_strdup(ipasc), __s != (char *)0x0)) {
    ...
    if (pcVar2 == (char *)0x0) {
      iVar3 = __isoc99_sscanf(__s,"%d.%d.%d.%d",local_60,local_58,local_50,local_48);
      if (((((iVar3 != 4) || (0xff < local_60[0])) || (local_58[0] < 0)) ||
          ((0xff < local_58[0] || (local_50[0] < 0)))) ||
         ((0xff < local_50[0] || ((local_48[0] < 0 || (0xff < local_48[0])))))) goto LAB_00168e82;
      iVar3 = 4;
      bVar6 = false;
      bVar5 = true;
      local_40[0] = (undefined1)local_60[0];
      local_40[1] = (undefined1)local_58[0];
      local_40[2] = (undefined1)local_50[0];
      local_40[3] = (undefined1)local_48[0];
    }
    else {
...
LAB_00168e82:
    ...
    if (pcVar1 == (char *)0x0) {
      iVar4 = __isoc99_sscanf(pcVar2,"%d.%d.%d.%d",local_60,local_58,local_50,local_48);
