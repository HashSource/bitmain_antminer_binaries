...

{
  ...
  local_20b4[0] = (_union_1051)0x1ae2d1;
  do {
  ...
  if (param_3 == 0) {
    ...
    if (is_a_tty == 0) goto LAB_001ae3fa;
    iVar2 = fileno(tty_in);
    iVar2 = tcsetattr(iVar2,0,(termios *)tty_new);
    if (iVar2 != -1) goto LAB_001ae3fa;
LAB_001ae424:
    uVar4 = 0;
  }
  else {
LAB_001ae3fa:
    ...
    if (((pcVar1 == (char *)0x0) || (iVar2 = feof(tty_in), iVar2 != 0)) ||
       (iVar2 = ferror(__stream), iVar2 != 0)) goto LAB_001ae424;
    pcVar1 = strchr(local_2028,10);
    if (pcVar1 == (char *)0x0) {
      do {
        pcVar1 = fgets(acStack_20bc,4,__stream);
        if (pcVar1 == (char *)0x0) goto LAB_001ae424;
  ...
  if (param_3 == 0) {
    fputc(10,tty_out);
    if (ps_8091 < 2) goto LAB_001ae53c;
    tty_new._0_4_ = tty_orig._0_4_;
    tty_new._4_4_ = tty_orig._4_4_;
    tty_new._8_4_ = tty_orig._8_4_;
    tty_new._16_4_ = tty_orig._16_4_;
...
LAB_001ae53c:
    if (ps_8091 != 1) goto LAB_001ae46a;
  }
  iVar2 = 1;
  for (iVar3 = 2;
      ((iVar2 == 10 || (iVar2 == 0xc)) ||
