...

{
  ...
  if (pBVar1 == (BIGNUM *)0x0) {
    ...
    if (iVar2 == 0) {
      *(undefined4 *)(param_1 + 0xa8) = 0x1c2411;
    }
    else {
      pBVar1 = BN_get0_nist_prime_224();
      iVar2 = BN_ucmp(pBVar1,param_2);
      if (iVar2 == 0) {
        *(undefined4 *)(param_1 + 0xa8) = 0x1c270d;
      }
      else {
        pBVar1 = BN_get0_nist_prime_256();
        iVar2 = BN_ucmp(pBVar1,param_2);
        if (iVar2 == 0) {
          *(undefined4 *)(param_1 + 0xa8) = 0x1c2a85;
        }
        else {
          pBVar1 = BN_get0_nist_prime_384();
          iVar2 = BN_ucmp(pBVar1,param_2);
          if (iVar2 == 0) {
            *(undefined4 *)(param_1 + 0xa8) = 0x1c2f65;
          }
          else {
            ...
            *(undefined4 *)(param_1 + 0xa8) = 0x1c35b5;
          }
        }
      }
    }
