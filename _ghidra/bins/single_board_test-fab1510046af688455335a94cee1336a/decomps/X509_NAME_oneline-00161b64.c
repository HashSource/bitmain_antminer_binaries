...
LAB_00161db2:
        ...
        if (local_88[2] == 0 && (local_88[0] == 0 && local_88[1] == 0)) goto LAB_00161db2;
        local_88[3] = 1;
        iVar3 = 1;
        local_88[2] = 1;
        local_88[1] = 1;
...
LAB_00161c12:
        ...
        local_88[0] = 1;
LAB_00161c0c:
        if (0 < (int)uVar13) goto LAB_00161c12;
        iVar15 = 0;
      }
      local_88[3] = 1;
      ...
      if (local_98 == (BUF_MEM *)0x0) {
        pcVar1 = buf;
        if (local_8c <= iVar15) goto LAB_00161d3c;
      }
      else {
        iVar7 = BUF_MEM_grow(local_98,iVar15 + 1);
        if (iVar7 == 0) goto LAB_00161c42;
