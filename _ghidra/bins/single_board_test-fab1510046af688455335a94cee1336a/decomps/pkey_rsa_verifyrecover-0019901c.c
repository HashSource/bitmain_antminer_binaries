    ...
    *param_3 = sVar4;
    ...
    if (*(int *)(iVar5 + 0x10) == 5) {
      ...
      if (to == (uchar *)0x0) {
        ...
        to = (uchar *)CRYPTO_malloc(iVar2,"rsa_pmeth.c",0x9c);
        *(uchar **)(iVar5 + 0x20) = to;
        if (to == (uchar *)0x0) {
          return 0xffffffff;
        }
      ...
      if (0 < iVar2) {
        ...
        if (bVar1 != uVar3) {
          ERR_put_error(4,0x8d,100,"rsa_pmeth.c",0x13c);
          return 0;
        }
        sVar4 = EVP_MD_size(*(EVP_MD **)(iVar5 + 0x14));
        if (sVar4 != iVar2 - 1U) {
          ERR_put_error(4,0x8d,0x8f,"rsa_pmeth.c",0x141);
          return 0;
        }
