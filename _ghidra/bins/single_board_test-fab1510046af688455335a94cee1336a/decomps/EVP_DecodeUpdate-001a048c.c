  ...
  if (inl == 0) {
    ...
    do {
      while( true ) {
        ...
        if ((bVar3 | 0x13) == 0xf3) {
          if (bVar3 == 0xff) goto LAB_001a0592;
        }
        else {
          if (0x4f < (int)n) {
        ...
        if (bVar3 == 0xf1) break;
        if ((bVar3 != 0xf0) || (iVar5 = iVar7, iVar7 == 0)) goto joined_r0x001a0576;
        iVar7 = 0;
LAB_001a05b4:
        iVar5 = 0;
        in = in + 1;
...
LAB_001a0588:
      ...
      iVar5 = iVar7;
      if (iVar7 != 0) goto LAB_001a05b4;
joined_r0x001a0576:
      if ((inl != iVar4) || (((n & 3) != 0 && (uVar6 == 0)))) {
        if (bVar3 == 0xf2) goto LAB_001a0600;
LAB_001a057c:
        if (0x3f < (int)n) {
          if (bVar3 == 0xf2) goto LAB_001a0612;
          iVar7 = 1;
          goto LAB_001a04e8;
        }
        iVar7 = 0;
        iVar2 = 0;
        if (iVar4 < inl) goto LAB_001a0538;
        goto LAB_001a0588;
      }
...
LAB_001a0680:
      ...
      iVar2 = iVar7;
      if (inl <= iVar4) goto LAB_001a0588;
LAB_001a0538:
      in = in + 1;
    } while (iVar5 != 0x50);
LAB_001a0592:
