...
/* WARNING: Removing unreachable block (ram,0x000cffe8) */
/* WARNING: Removing unreachable block (ram,0x000cfff2) */
/* WARNING: Removing unreachable block (ram,0x000cfff4) */
/* WARNING: Removing unreachable block (ram,0x000cfff6) */
/* WARNING: Removing unreachable block (ram,0x000cfffc) */
/* WARNING: Removing unreachable block (ram,0x000cfbc6) */
...
LAB_000cfd24:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000d0480;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000d0480;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_000cfd24;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000d0480;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000d0480;
              op = pBVar10;
