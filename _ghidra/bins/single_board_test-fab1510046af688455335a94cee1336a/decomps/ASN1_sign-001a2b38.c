  ...
  if (algor1 != (X509_ALGOR *)0x0) {
    if (type->pkey_type == 0x71) {
      ...
      if ((pAVar1 == (ASN1_TYPE *)0x0) || (pAVar1->type != 5)) {
        ...
        if (pAVar1 == (ASN1_TYPE *)0x0) goto LAB_001a2cf4;
        pAVar1->type = 5;
      }
    }
    ...
    if (pAVar2 != (ASN1_OBJECT *)0x0) {
      if (pAVar2->length != 0) goto LAB_001a2b9a;
LAB_001a2cfc:
...
LAB_001a2b9a:
  if (algor2 != (X509_ALGOR *)0x0) {
    ...
    if (pAVar2 == (ASN1_OBJECT *)0x0) goto LAB_001a2ce4;
    if (pAVar2->length == 0) goto LAB_001a2cfc;
  }
  cnt = (*(code *)i2d)(data,0);
  ...
  if (d == (void *)0x0 || md == (uchar *)0x0) {
    ...
    EVP_MD_CTX_cleanup(&EStack_40);
    if (d == (void *)0x0) goto LAB_001a2c40;
  }
  else {
    local_48 = d;
