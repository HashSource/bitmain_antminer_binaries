...
/* WARNING: Removing unreachable block (ram,0x000d3fde) */
/* WARNING: Removing unreachable block (ram,0x000d3fe8) */
/* WARNING: Removing unreachable block (ram,0x000d3fea) */
/* WARNING: Removing unreachable block (ram,0x000d3fec) */
/* WARNING: Removing unreachable block (ram,0x000d3ff2) */
/* WARNING: Removing unreachable block (ram,0x000d3b50) */
...
LAB_000d3dea:
                  ...
                  if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
                    if (local_48 == 0) {
                      if ((iend != ip + length) || (oend < cpy)) goto LAB_000d44ba;
                    }
                    else {
                      if (iend < ip + length) {
                ...
                if ((bVar8 & bVar6) == 0) goto LAB_000d3cd6;
...
LAB_000d407c:
                ...
                if ((local_4c == 2) && (match < local_50)) {
                  ...
                  if (cVar7 != '\0') {
                    if (local_48 == 0) goto LAB_000d44ba;
                ...
                if ((local_48 == 0) || (cpy <= oend + -0xc)) {
                  ...
                  if (cVar7 == '\0') {
                    ...
                    *(undefined4 *)(op + 0xc) = uVar2;
                    ...
                    oCopyLimit = oend + -7;
                    if (oend + -5 < cpy) goto LAB_000d44ba;
                    op = pBVar11;
