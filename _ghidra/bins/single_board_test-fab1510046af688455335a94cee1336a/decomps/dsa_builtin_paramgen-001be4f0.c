      ...
      while( true ) {
        ...
        if (__n != 0) {
          ...
          if (param_3 != 0 && 3 < __n) {
            ...
            if (__n == param_3 << 2) goto LAB_001be7ca;
          }
          do {
          ...
          while( true ) {
            ...
            do {
              ...
              if ((((iVar8 == 0) ||
                 ...
                 (iVar8 = BN_add(pBVar3,pBVar3,pBVar2), iVar8 == 0)) goto LAB_001be822;
              iVar16 = iVar16 + 1;
              iVar7 = iVar7 + __n * 8;
    ...
    if (iVar7 != 0) {
      ...
      *(BIGNUM **)(param_1 + 0x14) = pBVar2;
      if (((*(int *)(param_1 + 0xc) == 0) || (*(int *)(param_1 + 0x10) == 0)) ||
         (pBVar2 == (BIGNUM *)0x0)) goto LAB_001be838;
      if (param_8 != (int *)0x0) {
        *param_8 = local_114;
      }
      if (param_9 != (int *)0x0) {
