...

{
  ...
  if (*(RSA **)(param_1 + 0x1c) == (RSA *)0x0) {
    ...
    local_34 = local_38;
    if (local_38 != 0) goto LAB_00117df6;
  }
...
LAB_00117df6:
  ...
  if (*(DH **)(param_1 + 0x24) == (DH *)0x0) {
    ...
    local_3c = local_44;
    if (local_44 != 0) goto LAB_00117cb4;
  }
...
LAB_00117d16:
    ...
    uVar9 = *(uint *)(param_1 + 0xc4) & 1;
    uVar2 = uVar9;
    if (uVar9 != 0) goto LAB_00117f04;
LAB_00117d04:
    uVar4 = *(uint *)(param_1 + 0xe0) & 1;
    uVar9 = uVar2;
    if (*(int *)(param_1 + 0x100) != 0) goto LAB_00117d16;
LAB_00117f30:
    iVar5 = *(int *)(param_1 + 0xe4);
    uVar12 = 0x100;
    uVar6 = 0;
  ...
  if (uVar7 == 0) {
    ...
    if (local_34 == 0) goto LAB_00117d56;
  }
  uVar6 = uVar6 | 1;
LAB_00117d56:
  if (bVar11) {
