...

{
  ...
  goto LAB_001635be;
  while( true ) {
    local_24 = (X509_REVOKED *)X509_REVOKED_dup(puVar3);
    if (local_24 == (X509_REVOKED *)0x0) goto LAB_001635be;
...
LAB_00163668:
    do {
      ...
      puVar3 = (undefined4 *)sk_value(p_Var5,iVar1);
      iVar2 = X509_CRL_get0_by_serial(param_1,&local_24,(ASN1_INTEGER *)*puVar3);
      iVar1 = iVar4;
    } while (iVar2 != 0);
  }
