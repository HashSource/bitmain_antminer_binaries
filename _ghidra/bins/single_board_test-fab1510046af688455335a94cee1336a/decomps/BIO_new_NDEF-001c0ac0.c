...

{
  ...
  if (parg == (BIO *)0x0 || b == (BIO *)0x0) {
    if (b == (BIO *)0x0) goto LAB_001c0b10;
  }
  else if (pBVar1 != (BIO *)0x0) {
    BIO_asn1_set_prefix(b,(undefined1 *)0x1c0a41,(undefined1 *)0x1c099d);
    BIO_asn1_set_suffix(b,(undefined1 *)0x1c09c1,(undefined1 *)0x1c0a8d);
    local_28 = (BIO *)0x0;
    local_24 = 0;
    local_2c = pBVar1;
