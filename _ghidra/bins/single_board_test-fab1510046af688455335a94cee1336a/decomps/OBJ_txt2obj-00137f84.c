...

{
  ...
  if (no_name != 0) goto LAB_00137fee;
  local_40 = s;
  if (added == (_LHASH *)0x0) {
LAB_001380b8:
    pcVar1 = local_40;
    ...
    do {
      ...
      if ((-1 < iVar6) && (iVar4 = iVar8 + 1, iVar8 = iVar3, iVar6 == 0)) goto LAB_00138102;
      iVar3 = iVar8;
    } while (iVar4 < iVar8);
    if (iVar6 == 0) {
LAB_00138102:
      local_38 = *(uint *)(&DAT_001fc1c8 + iVar7 * 0x18);
      goto LAB_00137fba;
    }
  }
  else {
    ...
    if (pvVar2 == (void *)0x0) goto LAB_001380b8;
    local_38 = *(uint *)(*(int *)((int)pvVar2 + 4) + 8);
LAB_00137fba:
    if (local_38 != 0) goto LAB_0013805e;
  }
  local_3c = s;
  if (added == (_LHASH *)0x0) {
LAB_0013811c:
    ...
    do {
      ...
      iVar6 = strcmp(pcVar1,*(char **)(&DAT_001fc1c4 + iVar7 * 0x18));
      if ((-1 < iVar6) && (iVar4 = iVar8 + 1, iVar8 = iVar3, iVar6 == 0)) goto LAB_00138168;
      iVar3 = iVar8;
    } while (iVar4 < iVar8);
    if (iVar6 != 0) goto LAB_00137fee;
LAB_00138168:
    local_38 = *(uint *)(&DAT_001fc1c8 + iVar7 * 0x18);
  }
  else {
    ...
    local_48 = 2;
    pvVar2 = lh_retrieve(added,&local_48);
    if (pvVar2 == (void *)0x0) goto LAB_0013811c;
    local_38 = *(uint *)(*(int *)((int)pvVar2 + 4) + 8);
  }
  if (local_38 != 0) {
LAB_0013805e:
    if (local_38 < 0x3be) {
      if (*(int *)(&DAT_001fc1c8 + local_38 * 0x18) == 0) {
