...
LAB_001a7284:
  tntmp_16050 = (char *)&tnst_16051;
  pcVar1 = (char *)&DAT_002291cc;
LAB_001a729c:
  pcVar8 = pcVar1;
  HintPreloadData(pcVar8 + 0x58);
  if ((*(size_t *)(pcVar8 + -8) != param_2) ||
     (iVar2 = strncmp(*(char **)(pcVar8 + -0xc),param_1,param_2), iVar2 != 0)) goto LAB_001a7294;
  uVar5 = *(uint *)(pcVar8 + -4);
  if (uVar5 != 0xffffffff) {
    if ((uVar5 & 0x10000) == 0) {
      param_3[2] = uVar5;
...
LAB_001a75b0:
    ...
    case 0x10006:
      iVar6 = param_3[0x69];
      iVar2 = *param_3;
      if (iVar6 == 0x14) goto LAB_001a75b0;
...
LAB_001a72e0:
    ...
    ERR_add_error_data(2,&DAT_00229428,param_1);
    return 0xffffffff;
  }
  goto LAB_001a729c;
}
