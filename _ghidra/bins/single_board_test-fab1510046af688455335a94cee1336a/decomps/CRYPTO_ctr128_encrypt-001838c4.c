...

{
  ...
  if ((((uint)pbVar4 | (uint)pbVar3 | (uint)param_5) & 3) != 0) {
    if (param_3 != 0) {
      uVar2 = 0;
      do {
        if (uVar8 == 0) {
        ...
        pbVar9 = (byte *)(param_6 + uVar8);
        uVar8 = uVar8 + 1 & 0xf;
        pbVar4[uVar2] = pbVar3[uVar2] ^ *pbVar9;
        uVar2 = uVar2 + 1;
      } while (uVar2 != param_3);
    }
    *param_7 = uVar8;
  ...
  if (param_3 == 0) goto LAB_00183a44;
  (*param_8)(param_5,param_6,param_4);
  cVar1 = param_5[0xf];
  param_5[0xf] = cVar1 + '\x01';
  if (((((char)(cVar1 + '\x01') == '\0') &&
...
LAB_00183bc8:
    iVar6 = uVar2 + iVar6;
    do {
      pbVar4[uVar2] = pbVar3[uVar2] ^ *(byte *)(param_6 + uVar2);
      uVar2 = uVar2 + 1;
    ...
    iVar6 = iVar6 + uVar5 * -4;
    uVar2 = uVar5 * 4 + uVar8;
    if (param_3 != uVar5 * 4) goto LAB_00183bc8;
  }
  uVar8 = uVar8 + param_3;
LAB_00183a44:
  *param_7 = uVar8;
