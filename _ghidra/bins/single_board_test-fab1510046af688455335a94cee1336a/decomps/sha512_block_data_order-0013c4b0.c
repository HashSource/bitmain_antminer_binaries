  ...
  if (param_3 != 0) {
    ...
    do {
      ...
      do {
        ...
        HintPreloadData(&DAT_0020bb30 + local_cf0 * 2);
        HintPreloadData(&DAT_0020bb38 + local_cf0 * 2);
        ...
        HintPreloadData(&DAT_0020bb40 + local_cf0 * 2);
        HintPreloadData(&DAT_0020bb48 + local_cf0 * 2);
