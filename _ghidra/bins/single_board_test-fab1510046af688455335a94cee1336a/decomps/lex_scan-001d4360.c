...

{
  ...
  if (uVar1 != 0xfffffffe) {
    ...
    if (((uVar1 == 0x7b || uVar1 == 0x7d) || (uVar1 == 0x5b || uVar1 == 0x5d)) ||
       (uVar1 == 0x3a || uVar1 == 0x2c)) goto LAB_001d4470;
    if (uVar1 == 0x22) {
      (lex->value).string.val = (char *)0x0;
      lex->token = -1;
      uVar1 = lex_get_save(lex,error);
      while (uVar1 != 0x22) {
        if (uVar1 == 0xfffffffe) goto LAB_001d45e8;
        if (uVar1 == 0xffffffff) {
        ...
        if (uVar1 == 0x5c) {
          ...
          if (uVar1 == 0x75) {
            ...
            do {
              ...
              if ((bVar12 && !bVar11) && (5 < uVar1 - 0x61)) goto LAB_001d4854;
              uVar1 = lex_get_save(lex,error);
              iVar3 = iVar3 + -1;
            } while (iVar3 != 0);
          }
        ...
        while( true ) {
          ...
          if (bVar7 == 0x66) {
            *buffer = 0xc;
            ...
            if (bVar7 != 0x5c) {
              if (0x5c < bVar7) {
                if (bVar7 != 0x62) goto LAB_001d46d2;
                *buffer = 8;
                goto LAB_001d471e;
              }
...
LAB_001d471c:
            ...
            *buffer = 0xd;
            ...
            if (bVar7 != 0x74) {
              if (bVar7 != 0x6e) goto LAB_001d46d2;
              bVar7 = 10;
              goto LAB_001d471c;
            }
            *buffer = 9;
...
LAB_001d489c:
        ...
        else if (codepoint - 0xdc00U < 0x400) goto LAB_001d489c;
    ...
    if (!bVar11 || (uVar1 == 0x2d || uVar1 - 0x30 == 9)) {
      ...
      if (uVar1 == 0x30) {
        uVar1 = lex_get_save(lex,error);
        if (uVar1 - 0x30 < 10) goto LAB_001d46fc;
      }
      else {
        if (9 < uVar1 - 0x30) {
          lex_unget_unsave(lex,uVar1);
      ...
      if (((lex->flags & 8) == 0) && (uVar1 != 0x45 && uVar1 != 0x2e)) {
        ...
        if ((uVar1 & 0xffffffdf) != 0x45) goto LAB_001d4522;
      }
      uVar1 = lex_get_save(lex,error);
