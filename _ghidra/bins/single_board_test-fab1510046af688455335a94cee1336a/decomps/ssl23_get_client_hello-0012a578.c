...
LAB_0012aa92:
          ...
          uVar12 = param_1->references;
          if (bVar7 < 3) {
            if (bVar7 == 2) goto LAB_0012ab08;
LAB_0012aa56:
            if ((uVar12 & 0x4000000) != 0) goto LAB_0012aa92;
            iVar8 = 0x301;
          }
          else {
            if (-1 < (int)(uVar12 << 4)) {
...
LAB_0012ab08:
            if ((uVar12 & 0x10000000) != 0) goto LAB_0012aa56;
            iVar8 = 0x302;
          }
        }
        cVar17 = false;
...
LAB_0012aaa4:
      ...
      bVar7 = pbVar11[9];
      if (bVar7 < 3) goto LAB_0012a86a;
      if (pbVar11[4] < 6) goto LAB_0012aaa4;
    }
    else {
      bVar7 = pbVar11[9];
      if (bVar7 < 3) goto LAB_0012a86a;
    ...
    if (bVar7 < 4) {
      ...
      if (bVar7 == 0) {
        if (param_1->references << 6 < 0) {
          if (param_1->references << 5 < 0) goto LAB_0012a8ba;
LAB_0012ab5e:
        ...
        if (2 < bVar7) goto LAB_0012ab14;
        iVar14 = param_1->references;
        if (bVar7 != 1) goto LAB_0012ab3c;
LAB_0012ab30:
        if (-1 < iVar14 << 5) goto LAB_0012ab5e;
        if (iVar14 << 6 < 0) goto LAB_0012a8ba;
      }
...
LAB_0012ab14:
      ...
      if (iVar14 << 4 < 0) {
LAB_0012ab3c:
        if (iVar14 << 3 < 0) goto LAB_0012ab30;
...
LAB_0012a952:
  ...
  if (iVar8 == 2) {
    ...
    if (iVar8 != 0x303) goto LAB_0012a90c;
