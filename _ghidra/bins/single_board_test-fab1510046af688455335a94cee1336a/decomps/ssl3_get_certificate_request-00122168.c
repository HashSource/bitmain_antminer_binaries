          ...
          if (uVar6 != 0) {
            ...
            for (uVar7 = len + 2; uVar7 <= uVar6; uVar7 = uVar7 + len + 2) {
              ...
              if (data == (X509_NAME *)0x0) {
                if (param_1[0x40] << 2 < 0) goto LAB_001223a4;
                ssl3_send_alert(param_1,2,0x32);
              ...
              if (uVar6 <= uVar7) goto LAB_001223a8;
...
LAB_001223a8:
          ...
          *(undefined4 *)(iVar3 + 0x358) = 1;
          if (*(_STACK **)(iVar3 + 0x36c) != (_STACK *)0x0) {
            sk_pop_free(*(_STACK **)(iVar3 + 0x36c),(func *)0x15a3c9);
            iVar3 = param_1[0x16];
          }
