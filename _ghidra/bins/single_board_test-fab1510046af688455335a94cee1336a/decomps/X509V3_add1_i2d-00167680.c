...
LAB_00167726:
      ...
      goto joined_r0x0016772c;
    }
    st = sk_new_null();
    *x = (stack_st_X509_EXTENSION *)st;
    if (st != (_STACK *)0x0) goto LAB_00167726;
LAB_0016773e:
    iVar1 = -1;
  }
  else {
