...
LAB_0011bf74:
    if (bVar12 != 0x3a && bVar12 != 0x20) {
      iVar13 = 1;
LAB_0011bf96:
      if (bVar12 == 0x3b || bVar12 == 0x2c) goto LAB_0011bf7e;
      uVar11 = 0;
      local_40 = 0;
      local_48 = 0;
      local_4c = 0;
...
LAB_0011c30e:
          ...
          if (bVar12 == 0x20 || bVar12 == 0x3a) goto joined_r0x0011bf3a;
          break;
        }
        local_3c = 0;
LAB_0011c022:
        ...
        if (bVar12 == 0x3a || bVar12 == 0x20) goto joined_r0x0011bf3a;
      ...
      piVar9 = param_4;
      while( true ) {
        if (piVar8 == (int *)0x0) goto LAB_0011c022;
        __s2 = (char *)piVar8[1];
          ...
          ((local_54 = uVar2, uVar5 = piVar8[5], uVar2 = local_4c, uVar5 != 0 &&
           ((uVar2 = uVar5, local_4c != 0 && (uVar2 = local_4c & uVar5, (local_4c & uVar5) == 0)))))
                ...
                ((uVar2 = uVar5, local_48 != 0 &&
                 (uVar2 = local_48 & uVar5, (local_48 & uVar5) == 0)))))) goto LAB_0011c022;
      local_48 = uVar2;
      uVar2 = piVar8[8];
      if ((uVar2 & 3) != 0) {
        if ((uVar11 & 3) == 0) {
          ...
          if ((uVar11 & 3) == 0) goto LAB_0011c022;
        }
      }
      if ((uVar2 & 0x1fc) != 0) {
        if ((uVar11 & 0x1fc) == 0) {
          ...
          if ((uVar11 & 0x1fc) == 0) goto LAB_0011c022;
        }
      }
      uVar2 = local_40;
      if ((((*piVar8 == 0) && (uVar5 = piVar8[7], uVar5 != 0)) && (uVar2 = uVar5, local_40 != 0)) &&
         (uVar2 = local_40 & uVar5, (local_40 & uVar5) == 0)) goto LAB_0011c022;
      local_40 = uVar2;
      __s1 = param_1;
      if (uVar4 == 0x2b) goto LAB_0011bfae;
      bVar15 = iVar13 == 3;
      if (bVar15) {
        piVar9 = (int *)*param_2;
        piVar6 = (int *)*param_3;
      ...
      if ((piVar14 != (int *)0x0) && (piVar6 != (int *)0x0)) {
        uVar2 = uVar11 & 0x1fc;
        piVar7 = piVar6;
        if (!bVar15) goto LAB_0011c20a;
LAB_0011c152:
        piVar6 = (int *)piVar7[4];
        iVar1 = *piVar7;
        if (uVar11 == 3) goto LAB_0011c212;
LAB_0011c15a:
        if ((local_40 == 0xfffffffe) && (*(int *)(iVar1 + 0x1c) == 1)) {
          ...
          piVar3 = piVar8;
          if ((local_44 != 0) && ((local_44 & *(uint *)(iVar1 + 0xc)) == 0)) goto LAB_0011c1fa;
          if ((local_54 != 0) && ((local_54 & *(uint *)(iVar1 + 0x10)) == 0)) goto LAB_0011c1fa;
          if ((local_4c != 0) && ((local_4c & *(uint *)(iVar1 + 0x14)) == 0)) goto LAB_0011c1fa;
          if ((local_48 != 0) && ((local_48 & *(uint *)(iVar1 + 0x18)) == 0)) goto LAB_0011c1fa;
          if ((local_40 != 0) && ((local_40 & *(uint *)(iVar1 + 0x1c)) == 0)) goto LAB_0011c1fa;
          if (((uVar11 & 3) != 0) && ((uVar11 & *(uint *)(iVar1 + 0x20) & 3) == 0))
          goto LAB_0011c1fa;
          uVar4 = uVar2;
          if ((uVar2 != 0) && ((uVar11 & *(uint *)(iVar1 + 0x20) & 0x1fc) == 0)) goto LAB_0011c1fa;
        }
        if (iVar13 == 1) goto LAB_0011c21e;
LAB_0011c1be:
        piVar3 = piVar8;
        if (iVar13 == 4) {
...
LAB_0011c1fa:
        while (bVar16 = piVar14 != piVar7, piVar8 = piVar3, piVar7 = piVar3, bVar16) {
          while( true ) {
            piVar7 = piVar8;
            if (piVar6 == (int *)0x0) goto LAB_0011c258;
            piVar7 = piVar6;
            if (bVar15) goto LAB_0011c152;
LAB_0011c20a:
            piVar6 = (int *)piVar7[3];
            iVar1 = *piVar7;
            if (uVar11 != 3) goto LAB_0011c15a;
LAB_0011c212:
            uVar4 = *(int *)(iVar1 + 0x20) << 0x1e;
            if (-1 < (int)uVar4) goto LAB_0011c15a;
            if (iVar13 != 1) goto LAB_0011c1be;
LAB_0011c21e:
            piVar3 = piVar8;
            if (piVar7[1] != 0) break;
            if (piVar7 != piVar8) {
            ...
            piVar7[1] = 1;
            piVar8 = piVar7;
            if (piVar14 == piVar7) goto LAB_0011c258;
          }
        }
      }
LAB_0011c258:
...
joined_r0x0011c324:
  if ((bVar12 == 0x3b) || (bVar12 == 0x2c)) goto LAB_0011bf74;
  param_1 = param_1 + 1;
  bVar12 = *param_1;
  if (bVar12 == 0) {
    return local_3c;
