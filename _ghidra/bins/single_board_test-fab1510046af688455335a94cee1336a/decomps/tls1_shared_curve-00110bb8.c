...

{
  ...
  if (uVar5 == 0) {
    ...
    if (puVar8 != (char *)0x0) goto LAB_00110be2;
    puVar8 = eccurves_all;
...
LAB_00110be2:
  if ((int)(uVar7 << 0x1f) < 0) goto LAB_00110d48;
  uVar7 = uVar7 >> 1;
  if (uVar5 == 0) goto LAB_00110d1e;
...
LAB_00110d48:
    ...
    uVar2 = uVar2 >> 1;
    if ((uVar7 == 0) && (uVar5 != 0)) goto LAB_00110c3c;
LAB_00110d38:
    uVar9 = uVar2;
    if (uVar2 == 0) {
      uVar2 = 0;
      if (uVar5 != 0) goto LAB_00110d76;
      uVar9 = 0x1c;
      puVar6 = eccurves_all;
    }
  }
    ...
    if (puVar6 != (char *)0x0) goto LAB_00110d2a;
    puVar6 = eccurves_all;
    if (*(int *)(*(int *)(param_1 + 0x98) + 0x34) == 0) {
      uVar2 = 0x1c;
    }
    ...
    if (uVar7 != 0) goto LAB_00110d38;
LAB_00110c3c:
    if (uVar2 == 0) goto LAB_00110d76;
    puVar8 = eccurves_all;
    uVar7 = 0x1c;
    uVar9 = uVar2;
  }
