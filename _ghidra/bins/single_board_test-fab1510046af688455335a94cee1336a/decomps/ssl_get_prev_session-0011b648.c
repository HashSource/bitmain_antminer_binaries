...

{
  ...
  if (param_3 < 0x21) {
    if ((int)param_2 + param_3 <= param_4) {
      ...
      case 0:
      case 1:
        if (uVar8 == 0) goto switchD_0011b776_caseD_2;
        if (local_114 == (SSL_SESSION *)0x0) {
          iVar3 = param_1[0x5c];
          if (-1 < *(int *)(iVar3 + 0x20) << 0x17) {
            local_10c = *param_1;
            if (param_3 == 0) goto LAB_0011b756;
            local_c8 = param_3;
            ...
            if (local_114 != (SSL_SESSION *)0x0) goto LAB_0011b796;
            iVar3 = param_1[0x5c];
            *(int *)(iVar3 + 0x4c) = *(int *)(iVar3 + 0x4c) + 1;
          }
          if (*(code **)(iVar3 + 0x30) == (code *)0x0) goto LAB_0011b756;
          local_110 = 1;
...
LAB_0011b796:
      ...
      case 2:
      case 3:
switchD_0011b776_caseD_2:
        uVar8 = 0;
LAB_0011b718:
        if (local_114 == (SSL_SESSION *)0x0) goto LAB_0011b756;
        break;
      case 0xffffffff:
        bVar1 = true;
        pSVar7 = local_114;
        goto joined_r0x0011b8a4;
      default:
        ...
        if (((int)(param_1[0x32] << 0x1f) < 0) && (__n == 0)) {
          ...
          if (*(int *)(pSVar7->krb5_client_princ + 0x24) == 0) {
            ...
            *(undefined4 *)(pSVar7->krb5_client_princ + 0x24) = uVar2;
            pSVar7 = local_114;
            if (*(int *)(local_114->krb5_client_princ + 0x24) == 0) goto LAB_0011b724;
          }
...
joined_r0x0011b8a4:
        local_114 = pSVar7;
        if (pSVar7 != (SSL_SESSION *)0x0) goto LAB_0011b726;
      }
      else {
LAB_0011b724:
        bVar1 = false;
