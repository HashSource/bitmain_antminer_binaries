...
LAB_00149c06:
      ...
      if (a == (X509_SIG *)0x0) goto LAB_00149c6a;
      if (local_30 == to + __n) {
        local_2c[0] = (uchar *)0x0;
        len_00 = i2d_X509_SIG(a,local_2c);
        ptr = local_2c[0];
        if ((int)len_00 < 1) goto LAB_00149c24;
        if (__n != len_00) {
...
LAB_00149c3c:
    ...
    if (uVar8 == 0) goto LAB_00149c06;
    if (__n == 0x24) {
      uVar8 = 1;
      iVar1 = memcmp(to,param_2,0x24);
      if (iVar1 == 0) goto LAB_00149c6a;
    }
