...
LAB_0011148e:
    ...
    do {
      ...
      if (iVar14 <= iVar12) goto LAB_0011148e;
...
LAB_001116c4:
        ...
        if ((undefined4 *)puVar10 != (undefined4 *)0x0) goto LAB_001116c4;
...
LAB_00111c4c:
          ...
          if (__n != (ushort *)0x0) {
            if (*(int *)(__n + 2) == 0) goto LAB_001117e0;
            __n = (ushort *)0x0;
          }
        }
        else {
          if (*(int *)(pSVar19->krb5_client_princ + 0x54) == 0) goto LAB_0011175e;
          __n = *(ushort **)(pSVar19->krb5_client_princ + 0x58);
LAB_0011179c:
          if (__n == (ushort *)0x0) goto LAB_00111c4c;
        }
LAB_001117a2:
        ...
        *local_30 = '\0';
        ...
        if (pSVar19 == (SSL_SESSION *)0x0) goto LAB_00111c4c;
LAB_0011175e:
        __n = (ushort *)param_1->tlsext_opaque_prf_input_len;
        if (__n == (ushort *)0x0) goto LAB_001117a2;
        if (*(int *)(__n + 2) != 0) {
          __n = (ushort *)(uint)*__n;
