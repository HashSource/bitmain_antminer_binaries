...
LAB_00163ba2:
    if (x != (X509 *)0x0) goto LAB_00163ad8;
LAB_00163ba6:
    iVar2 = 1;
    r = (EVP_PKEY *)0x0;
  }
      ...
      if (-1 < (int)(uVar3 << 0x1c)) {
        if ((param_1->parent == (X509_STORE_CTX *)0x0) &&
          ...
          if (&(XStack_a0.chain)->stack != (_STACK *)0x0) {
            sk_pop_free(&(XStack_a0.chain)->stack,(func *)0x15a509);
...
LAB_00163b0e:
        ...
        if (s != (ASN1_TIME *)0x0) {
          ...
          if (iVar2 == 0) {
            ...
            if ((-1 < iVar2) || ((param_1->current_crl_score & 2U) != 0)) goto LAB_00163b2c;
            param_1->error = 0xc;
            iVar2 = (*param_1->verify_cb)(0,param_1);
          }
          if (iVar2 == 0) goto LAB_00163b8c;
