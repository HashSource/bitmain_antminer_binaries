...

{
  ...
  bp = BIO_new(type);
  if (bp == (BIO *)0x0) {
    ERR_put_error(0x14,0xdc,7,"ssl_rsa.c",0x2a5);
    return 0;
  }
  lVar1 = BIO_ctrl(bp,0x6c,3,file);
  if (lVar1 < 1) {
    ERR_put_error(0x14,0xdc,2,"ssl_rsa.c",0x2aa);
  }
  else {
...
LAB_0012fa5a:
        ...
        if ((uVar3 != 0) || (iVar2 == 0)) goto LAB_0012fa5a;
        ...
        do {
          ...
          if (a_00 == (X509 *)0x0) {
            ...
            if ((uVar3 >> 0x18 != 9) || ((uVar3 & 0xfff) != 0x6c)) goto LAB_0012fa5a;
            ERR_clear_error();
            goto LAB_0012fa5c;
          }
...
LAB_0012fa5c:
    ...
    ERR_put_error(0x14,0xdc,9,"ssl_rsa.c",0x2b1);
  }
  iVar2 = 0;
LAB_0012fa62:
  BIO_free(bp);
