...
LAB_0016e62e:
        ...
        if (iVar15 < 0) goto LAB_0016e548;
        if (iVar15 <= local_60) {
          local_60 = iVar15;
        }
        if (iVar16 != 0) goto LAB_0016e62e;
LAB_0016e54e:
            ...
            if (iVar15 != iVar1) {
              for (iVar1 = 0; iVar15 = sk_num(p_Var3), iVar1 < iVar15; iVar1 = iVar1 + 1) {
                ...
                if (iVar15 == 0) {
                  ...
                  if (puVar9 == (uint *)0x0) goto LAB_0016e37a;
...
LAB_0016e856:
      do {
        ...
        iVar17 = iVar14 + 1;
        if (iVar15 <= iVar14) goto LAB_0016e966;
        ...
        if (iVar1 == *(int *)((int)pvVar4 + 4)) {
          if (*(_STACK **)pXVar13 == (_STACK *)0x0) {
            ...
            *(_STACK **)pXVar13 = p_Var3;
            if (p_Var3 == (_STACK *)0x0) goto LAB_0016e37a;
          }
          else {
            iVar15 = sk_find(*(_STACK **)pXVar13,pvVar4);
            if (iVar15 != -1) goto LAB_0016e856;
...
LAB_0016e42c:
  ...
  *(_STACK **)(tree + 0xc) = p_Var3;
  if (p_Var3 != (_STACK *)0x0) goto LAB_0016eb32;
  goto LAB_0016e37e;
LAB_0016e966:
  iVar16 = iVar16 + 1;
  if (*(int *)(tree + 4) <= iVar16) goto LAB_0016e982;
  iVar1 = *(int *)(iVar11 + 0x18);
  HintPreloadData(iVar11 + 0x48);
  iVar11 = iVar11 + 0x10;
  if (iVar1 == 0) goto LAB_0016e982;
  goto LAB_0016e850;
  while( true ) {
    if (st == (_STACK *)0x0) {
      st = sk_new_null();
      *(_STACK **)(tree + 0x10) = st;
      if (st == (_STACK *)0x0) goto LAB_0016e42c;
    }
