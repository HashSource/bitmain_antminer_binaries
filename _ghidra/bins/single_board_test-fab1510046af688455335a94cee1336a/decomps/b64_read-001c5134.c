      ...
      if ((int)param_3 < 1) {
        ...
        if (0 < (int)outl[6]) {
          ...
          do {
            ...
            if (outl[5] == 0) {
LAB_001c524a:
              if (0x3ff < (int)puVar16) goto LAB_001c525a;
              if ((int)outl[6] < 1) {
                  ...
                  do {
                    ...
                    if (uVar3 == 0) {
                      ...
                      if ((pBVar19 == in) ||
                         ...
                         (int)puVar16 < 1)) goto LAB_001c57f0;
                    ...
                    if (in == pBVar19) {
                      ...
                      if (0 < (int)pBVar18) {
                        ...
                        if (uVar3 != 0 &&
                          ...
                          pBVar8 = (BIO *)(uVar3 * 8);
                          if (pBVar18 == (BIO *)(uVar3 * 8)) goto LAB_001c5558;
                        }
...
LAB_001c537a:
  puVar17 = puVar17 + 1;
  if (puVar17 == puVar16) goto LAB_001c53a2;
  goto LAB_001c5380;
}
