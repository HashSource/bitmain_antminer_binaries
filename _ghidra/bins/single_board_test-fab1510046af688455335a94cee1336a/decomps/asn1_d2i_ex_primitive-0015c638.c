...
int asn1_d2i_ex_primitive
              (ASN1_VALUE **param_1,int *param_2,undefined4 param_3,ASN1_ITEM *param_4,uint param_5,
...

{
  ...
  if (param_1 == (ASN1_VALUE **)0x0) {
    ERR_put_error(0xd,0x6c,0x7d,"tasn_dec.c",0x2d1);
    return 0;
  }
...
LAB_0015c7a0:
    ...
    if (local_50 == 0xfffffffc) {
      if (-1 < (int)param_5) {
        ERR_put_error(0xd,0x6c,0x7f,"tasn_dec.c",0x2df);
        return 0;
      }
LAB_0015c7b4:
      if (param_7 != '\0') {
        ERR_put_error(0xd,0x6c,0x7e,"tasn_dec.c",0x2e4);
        return 0;
      }
      local_48 = (uchar *)*param_2;
      iVar1 = asn1_check_tlen_constprop_1(0,&local_50,&local_38,0,0,&local_48,param_3,0,param_8);
      if (iVar1 == 0) {
        ERR_put_error(0xd,0x6c,0x3a,"tasn_dec.c",0x2eb);
        return 0;
      }
      if ((char)local_38 != '\0') {
        local_50 = 0xfffffffd;
  ...
  if (puVar4 == (uchar *)0x0) {
    if (local_60[0] == '\0') {
      ...
      if (((((local_50 & 0xfffffffb) == 1) || (local_50 == 6)) || (local_50 == 2)) ||
         (local_50 == 10)) {
        ERR_put_error(0xd,0x6c,0xda,"tasn_dec.c",799);
        return 0;
      }
      ...
      if (iVar1 == 0) {
        ERR_put_error(0xd,0x6c,0x41,"tasn_dec.c",0x332);
        return 0;
      }
...
LAB_0015c6fc:
    ...
    if ((uchar *)(uint)(local_50 == 0xfffffffd) == (uchar *)0x0) {
      if (local_60[0] == '\0') {
        ERR_put_error(0xd,0x6c,0x9c,"tasn_dec.c",0x30c);
        return 0;
      }
    }
    else if (param_8 != (undefined1 *)0x0) {
      *param_8 = 0;
    }
    puVar4 = (uchar *)*param_2;
    if (local_51 == '\0') {
      ...
      do {
        if (((puVar2 == (uchar *)0x1) || (*puVar5 != '\0')) || (puVar5[1] != '\0')) {
          ...
          if (iVar3 << 0x18 < 0) {
            ...
            ERR_put_error(0xd,0xbe,0x3a,"tasn_dec.c",0x3fb);
            goto LAB_0015c850;
          }
          if (iVar3 << 0x1f < 0) {
            iVar1 = iVar1 + 1;
    ...
    ERR_put_error(0xd,0xbe,0x89,"tasn_dec.c",0x405);
LAB_0015c850:
    iVar1 = 0;
  }
  if (local_58[0] == '\0') {
