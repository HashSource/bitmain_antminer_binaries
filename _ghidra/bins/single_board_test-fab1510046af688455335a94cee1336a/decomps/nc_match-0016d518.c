...

{
  ...
  for (iVar7 = 0; iVar2 = sk_num((_STACK *)*param_2), iVar7 < iVar2; iVar7 = iVar7 + 1) {
    ...
    piVar5 = (int *)*puVar3;
    iVar2 = *param_1;
    if (iVar2 != *piVar5) goto LAB_0016d526;
    if (puVar3[1] != 0) {
      return 0x31;
    }
    if (puVar3[2] != 0) {
...
LAB_0016d526:
  ...
  do {
    ...
    piVar5 = (int *)*puVar3;
    if (*param_1 != *piVar5) goto LAB_0016d626;
