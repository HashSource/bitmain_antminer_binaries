...
LAB_00174066:
    ...
    *puVar7 = pAVar4;
    ...
    len = EVP_CIPHER_CTX_key_length(local_3c);
    puVar6 = (uchar *)0x0;
    if (*(int *)(param_1 + 0x10) != 0) goto LAB_00173e72;
LAB_00173f64:
...
LAB_00173ec2:
      ...
      if (type_00 == (ASN1_TYPE *)0x0) {
        ...
        if (0 < iVar3) goto LAB_00173ec2;
        ERR_put_error(0x2e,0x78,0x66,"cms_enc.c",0xbf);
        bVar2 = false;
      }
    }
    ptr = *(void **)(param_1 + 0x10);
    if ((ptr == (void *)0x0) || (bVar1)) goto LAB_00173ece;
  }
