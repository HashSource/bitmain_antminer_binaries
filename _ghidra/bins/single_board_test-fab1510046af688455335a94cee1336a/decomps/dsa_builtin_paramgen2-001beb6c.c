        ...
        do {
          while( true ) {
            ...
            *s = *s | 0x80;
            ...
            if (pBVar5 == (BIGNUM *)0x0) goto LAB_001bec66;
            ...
            while( true ) {
              ...
              if ((iVar10 == 0) || (iVar10 = BN_sub(r_01,a,pBVar2), iVar10 == 0)) goto LAB_001bec66;
              iVar10 = BN_cmp(r_01,r_00);
              if (-1 < iVar10) {
                iVar10 = BN_is_prime_fasttest_ex(r_01,0x32,ctx,1,param_11);
                if (0 < iVar10) {
                  iVar4 = BN_GENCB_call(param_11,2,1);
                  if (iVar4 != 0) goto LAB_001bec54;
                  goto LAB_001bec66;
                }
                if (iVar10 != 0) goto LAB_001bec66;
              }
              local_d8 = local_d8 + 1;
      ...
      if ((iVar4 != 0) && (iVar4 = BN_div(pBVar2,(BIGNUM *)0x0,r_00,ret,ctx), iVar4 != 0)) {
        ...
        while (uVar1 = local_d4, iVar4 != 0) {
          while( true ) {
            ...
            if (((r->top != 1) || (*r->d != 1)) || (r->neg != 0)) {
              ...
              *(BIGNUM **)(param_1 + 0x14) = pBVar2;
              if (((*(int *)(param_1 + 0xc) == 0) || (*(int *)(param_1 + 0x10) == 0)) ||
                 (pBVar2 == (BIGNUM *)0x0)) goto LAB_001bec66;
              if (param_9 != (int *)0x0) {
                *param_9 = local_d8;
              }
              uVar9 = 1;
            ...
            if (param_7 < 0) break;
            uVar1 = local_d4;
            if (0xffff < local_d4) goto LAB_001bec66;
          }
          pBVar3 = BN_value_one();
