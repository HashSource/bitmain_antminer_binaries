...

{
  ...
  case 1:
    iVar3 = param_1[0x26];
    if ((iVar3 == 0) || (*(int *)(iVar3 + 0x1c) != 0)) goto switchD_00125170_caseD_9;
...
LAB_00125282:
  ...
  case 0x67:
    ...
    goto switchD_00125170_caseD_9;
  case 0x68:
    if (param_1[9] == 0) goto switchD_00125170_caseD_9;
    iVar3 = param_1[0x26];
    ...
    if (((((param_1[9] == 0) && (param_1[0x30] != 0)) &&
      ...
      if (*(rsa_st **)(iVar3 + 0xec) == (rsa_st *)0x0) {
        if (*(dh_st **)(iVar3 + 0xf0) == (dh_st *)0x0) {
          if (*(ec_key_st **)(iVar3 + 0xf4) == (ec_key_st *)0x0) goto LAB_00125852;
