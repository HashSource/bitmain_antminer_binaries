...
undefined4
rsa_pss_to_ctx(EVP_MD_CTX *param_1,EVP_PKEY_CTX *param_2,undefined4 *param_3,EVP_PKEY *param_4)

{
  ...
  if ((piVar6 == (int *)0x0) || (*piVar6 != 0x10)) {
LAB_001982c8:
    ERR_put_error(4,0xa2,0x95,"rsa_ameth.c",0x25a);
    RSA_PSS_PARAMS_free((RSA_PSS_PARAMS *)0x0);
    return 0xffffffff;
  }
  local_28 = (uchar *)((long *)piVar6[1])[2];
  a = d2i_RSA_PSS_PARAMS((RSA_PSS_PARAMS **)0x0,&local_28,*(long *)piVar6[1]);
  if (a == (RSA_PSS_PARAMS *)0x0) goto LAB_001982c8;
...
LAB_001981f8:
      if (a->hashAlgorithm == (X509_ALGOR *)0x0) {
        md = EVP_sha1();
        if (md == (EVP_MD *)0x0) goto LAB_00198246;
      }
      else {
      ...
      if (a->saltLength == (ASN1_INTEGER *)0x0) {
        ...
        if (iVar1 < 0) {
          ERR_put_error(4,0xa2,0x96,"rsa_ameth.c",0x26c);
          uVar9 = 0xffffffff;
          goto LAB_0019824a;
        }
      }
      if ((a->trailerField == (ASN1_INTEGER *)0x0) ||
        ...
        if (param_4 == (EVP_PKEY *)0x0) {
          ...
          if (0 < iVar4) {
            ...
            if (iVar4 == iVar5) goto LAB_00198276;
...
LAB_00198276:
        ...
        ERR_put_error(4,0xa2,0x8b,"rsa_ameth.c",0x277);
      }
    }
  }
  else {
    ...
    if (pXVar8 == (X509_ALGOR *)0x0) goto LAB_0019830a;
