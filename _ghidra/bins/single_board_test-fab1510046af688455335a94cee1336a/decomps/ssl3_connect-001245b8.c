...
LAB_0012462a:
  iVar13 = iVar3;
  if (0x1181 < iVar13) goto LAB_001246a6;
LAB_00124632:
  if (iVar13 < 0x1180) {
    if (iVar13 < 0x1132) {
      if (0x112f < iVar13) {
...
LAB_00124acc:
        ...
        if (local_2c[0] != 0) {
          ...
          if (psVar10->change_cipher_spec == 0) goto LAB_00124acc;
...
LAB_00124784:
      ...
      if (iVar13 < 0x1101) {
        if (iVar13 == 0x1000) goto LAB_001248ea;
        if (iVar13 == 0x1003) goto LAB_001248ea;
        if (iVar13 == 3) {
        ...
        if (iVar13 < 0x1112) {
          ...
          if (0 < val) {
            ...
            if (param_1->bbio == param_1->wbio) goto LAB_00124998;
      ...
      if (uVar2 == 0) {
        do {
          if ((param_1->ctx != (SSL_CTX *)0x0) &&
             (val = BIO_ctrl(param_1->wbio,0xb,uVar2,(void *)uVar2), val < 1)) goto LAB_001248b6;
          if (p_Var15 == (_func_3294 *)0x0) break;
          iVar13 = param_1->state;
          if (iVar3 == iVar13) goto LAB_0012462a;
          param_1->state = iVar3;
          (*p_Var15)(param_1,0x1001,1);
          param_1->state = iVar13;
          if (iVar13 < 0x1182) goto LAB_00124632;
LAB_001246a6:
          if (iVar13 < 0x11e2) {
            if (iVar13 < 0x11e0) {
              if (iVar13 < 0x11a2) {
                if (iVar13 < 0x11a0) {
                  if (1 < iVar13 - 0x1190U) goto LAB_001248a0;
...
LAB_00124998:
                ...
                if (iVar13 < 0x11b0) goto LAB_001248a0;
                if (iVar13 < 0x11b2) goto LAB_00124a7e;
                if (1 < iVar13 - 0x11d0U) goto LAB_001248a0;
                psVar10 = param_1->s3;
            ...
            if (iVar13 < 0x1200) {
              if (1 < iVar13 - 0x11f0U) goto LAB_001248a0;
            ...
            if ((iVar13 != 0x4000) && (iVar13 != 0x5000)) {
              if (iVar13 != 0x3004) goto LAB_001248a0;
...
LAB_001248ea:
            ...
            if (param_1->init_buf == (BUF_MEM *)0x0) {
              str = BUF_MEM_new();
              if (str == (BUF_MEM *)0x0) goto LAB_00124b42;
            ...
            if (iVar3 == 0) goto LAB_00124784;
            iVar3 = ssl_init_wbio_buffer(param_1,0);
            if (iVar3 == 0) goto LAB_00124b42;
