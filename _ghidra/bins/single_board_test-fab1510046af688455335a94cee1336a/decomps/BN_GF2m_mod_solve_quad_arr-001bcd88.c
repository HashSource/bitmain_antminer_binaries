    ...
    if (*param_3 == 0) {
      ...
      if (a != param_2) {
        ...
        if (a->dmax < iVar5) {
          ...
          if (pBVar2 == (BIGNUM *)0x0) goto LAB_001bce00;
          iVar5 = param_2->top;
        }
        if (0 < iVar5) {
          puVar8 = a->d;
            ...
            if (1 < iVar5) {
              ...
              do {
                ...
                if ((((iVar5 == 0) ||
                   ...
                   (iVar5 = BN_GF2m_add(a_00,a_00,pBVar4), iVar5 == 0)) goto LAB_001bceec;
                pBVar2 = (BIGNUM *)BN_GF2m_add(a_01,pBVar3,rnd);
                if (pBVar2 == (BIGNUM *)0x0) goto LAB_001bce00;
                iVar5 = *param_3;
              } while (iVar6 < iVar5);
            }
            if (a_01->top != 0) goto LAB_001bceae;
            local_2c = local_2c + -1;
          } while (local_2c != 0);
