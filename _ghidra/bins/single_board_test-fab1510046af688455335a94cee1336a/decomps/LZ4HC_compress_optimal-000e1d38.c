...
/* WARNING: Removing unreachable block (ram,0x000e7094) */
/* WARNING: Removing unreachable block (ram,0x000e7a74) */
/* WARNING: Heritage AFTER dead removal. Example location: s0xfffff834 : 0x000e3706 */
...
LAB_000e30ea:
      do {
        if ((matchIndex < lowestMatchIndex) || (nbAttempts < 1)) goto LAB_000e3106;
        matchLength_1 = 0;
...
LAB_000e2af8:
        if ((matchLength_1 == local_144) && (matchIndex + local_144 <= ipIndex)) {
          ...
          if (1 < distanceToNextMatch) {
            if (matchIndex < distanceToNextMatch) goto LAB_000e3106;
        ...
        if ((distNextMatch == 1) && (matchChainPos == 0)) {
          ...
          if (pattern != UVar3) goto LAB_000e30ba;
          iLimit = local_140;
          if (extDict != 0) {
            iLimit = dictEnd;
          }
          ...
          if ((currentSegmentLength < srcPatternLength) || (srcPatternLength < forwardPatternLength)
            ...
            if (iVar6 == 0) {
              ...
              if (lookBackLength == 0) {
                ...
                if (matchIndex < distToNextPattern) goto LAB_000e3106;
...
LAB_000e729e:
    if ((cur < last_match_pos) && (curPtr = ip + cur, curPtr <= mflimit)) {
      if (fullUpdate == 0) {
        if (opt[cur].price < opt[cur + 1].price) goto LAB_000e3d62;
      }
...
LAB_000e682c:
          do {
            if ((matchIndex_2 < lowestMatchIndex_2) || (nbAttempts_2 < 1)) goto LAB_000e6848;
            matchLength_5 = 0;
...
LAB_000e623a:
            if ((matchLength_5 == local_560) && (matchIndex_2 + local_560 <= ipIndex_2)) {
              ...
              if (1 < distanceToNextMatch_2) {
                if (matchIndex_2 < distanceToNextMatch_2) goto LAB_000e6848;
            ...
            if ((distNextMatch_2 == 1) && (matchChainPos_2 == 0)) {
              ...
              if (pattern_2 != UVar3) goto LAB_000e67fc;
              iLimit_2 = local_55c;
              if (extDict_2 != 0) {
                iLimit_2 = dictEnd_2;
              }
              ...
              if ((currentSegmentLength_2 < srcPatternLength_2) ||
                ...
                if (iVar6 == 0) {
                  ...
                  if (lookBackLength_2 == 0) {
                    ...
                    if (matchIndex_2 < distToNextPattern_2) goto LAB_000e6848;
...
LAB_000e5024:
        do {
          if ((matchIndex_1 < lowestMatchIndex_1) || (nbAttempts_1 < 1)) goto LAB_000e5040;
          matchLength_3 = 0;
...
LAB_000e4a32:
          if ((matchLength_3 == local_37c) && (matchIndex_1 + local_37c <= ipIndex_1)) {
            ...
            if (1 < distanceToNextMatch_1) {
              if (matchIndex_1 < distanceToNextMatch_1) goto LAB_000e5040;
          ...
          if ((distNextMatch_1 == 1) && (matchChainPos_1 == 0)) {
            ...
            if (pattern_1 != UVar3) goto LAB_000e4ff4;
            iLimit_1 = local_378;
            if (extDict_1 != 0) {
              iLimit_1 = dictEnd_1;
            }
            ...
            if ((currentSegmentLength_1 < srcPatternLength_1) ||
              ...
              if (iVar6 == 0) {
                ...
                if (lookBackLength_1 == 0) {
                  ...
                  if (matchIndex_1 < distToNextPattern_1) goto LAB_000e5040;
...
LAB_000e72e2:
  ...
  if (bVar14) goto code_r0x000e39ec;
  goto LAB_000e7784;
LAB_000e6848:
