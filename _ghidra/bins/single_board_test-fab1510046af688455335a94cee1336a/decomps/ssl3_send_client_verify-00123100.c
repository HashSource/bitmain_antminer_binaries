...
LAB_00123232:
    ...
    if ((*(uint *)(iVar3 + 0x38) & 2) != 0) goto LAB_00123194;
    iVar5 = pkey->type;
    if (iVar5 != 6) {
      if (iVar5 == 0x74) {
        iVar3 = DSA_sign(pkey->save_type,auStack_74,0x14,(uchar *)(iVar6 + 2),&local_a8,
                         (DSA *)(pkey->pkey).rsa);
        if (iVar3 == 0) {
          ERR_put_error(0x14,0x99,10,"s3_clnt.c",0xcb1);
          goto LAB_001232e2;
        }
LAB_001232a4:
      ...
      if (iVar5 == 0x198) {
        ...
        if (iVar3 == 0) {
          ERR_put_error(0x14,0x99,0x2a,"s3_clnt.c",0xcbe);
          goto LAB_001232e2;
        }
        goto LAB_001232a4;
      }
    ...
    if (iVar3 < 1) {
      ERR_put_error(0x14,0x99,4,"s3_clnt.c",0xca4);
      goto LAB_001232e2;
    }
...
LAB_001232e2:
    ...
    if (((iVar3 == 0) || (iVar3 = EVP_DigestUpdate(&EStack_9c,local_a4,cnt), iVar3 == 0)) ||
      ...
      ERR_put_error(0x14,0x99,6,"s3_clnt.c",0xc96);
      goto LAB_001232e2;
    }
