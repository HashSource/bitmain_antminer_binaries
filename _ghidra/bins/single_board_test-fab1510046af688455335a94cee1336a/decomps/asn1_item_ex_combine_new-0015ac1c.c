...

{
  ...
  case '\0':
    ...
    if (pAVar8 == (ASN1_TEMPLATE *)0x0) goto switchD_0015ac38_caseD_5;
    uVar6 = pAVar8->flags;
    if ((uVar6 & 1) != 0) {
      if ((uVar6 & 0x306) != 0) {
...
LAB_0015ae38:
  ...
  case '\x06':
    ...
    if (param_3 == 0) {
      ...
      *param_1 = pAVar5;
      if (pAVar5 == (ASN1_VALUE *)0x0) goto LAB_0015ac6e;
        ...
        if ((uVar6 & 1) == 0) {
          if ((uVar6 & 0x300) == 0) {
            if ((uVar6 & 6) == 0) {
              ...
              if (iVar4 == 0) goto LAB_0015ac6e;
            }
            else {
              p_Var2 = sk_new_null();
              if (p_Var2 == (_STACK *)0x0) goto LAB_0015ae38;
