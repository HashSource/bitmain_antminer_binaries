...

{
  ...
  if (enc == 0) {
    ...
    uVar16 = uVar27;
    uVar28 = uVar24;
    if (iVar11 == -8) goto switchD_001b6a16_default;
    ...
    case -7:
      goto LAB_001b6a64;
    case -6:
      goto switchD_001b6a16_caseD_fffffffa;
    case -5:
      goto LAB_001b6a50;
    case -4:
      goto switchD_001b6a16_caseD_fffffffc;
    case -3:
      break;
    default:
      goto switchD_001b6a16_default;
    }
    puVar22 = local_48 + -1;
    local_48[-1] = (uchar)uVar27;
switchD_001b6a16_caseD_fffffffc:
    local_48 = puVar22 + -1;
    puVar22[-1] = (uchar)(uVar24 >> 0x18);
LAB_001b6a50:
    puVar22 = local_48 + -1;
    local_48[-1] = (uchar)(uVar24 >> 0x10);
switchD_001b6a16_caseD_fffffffa:
    local_48 = puVar22 + -1;
    puVar22[-1] = (uchar)(uVar24 >> 8);
LAB_001b6a64:
    local_48[-1] = (uchar)uVar24;
switchD_001b6a16_default:
    (*ivec)[0] = (uchar)uVar28;
    (*ivec)[4] = (uchar)uVar16;
