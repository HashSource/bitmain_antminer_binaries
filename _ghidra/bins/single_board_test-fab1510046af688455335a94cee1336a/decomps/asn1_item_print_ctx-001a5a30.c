...
switchD_001a5a6a_caseD_5:
  ...
  if ((int)(uVar3 << 0x17) < 0) {
    ...
    if ((int)(uVar3 << 0x19) < 0) {
      if (param_6 == (char *)0x0) goto LAB_001a5c70;
LAB_001a5ed8:
...
LAB_001a5c2c:
      if (param_6 == (char *)0x0 && param_5 == (char *)0x0) goto LAB_001a5c70;
      if (param_5 == (char *)0x0) {
        if (param_6 != (char *)0x0) goto LAB_001a5ed8;
      }
      else {
...
LAB_001a5c70:
  ...
  if (uVar3 == 0xfffffffc) {
    ...
    if (-1 < (int)(*param_8 << 0x1b)) goto LAB_001a5ef8;
LAB_001a5d3e:
    if (uVar3 != 5) {
LAB_001a5d46:
      switch(uVar3) {
    ...
    if (-1 < (int)(*param_8 << 0x1c)) goto LAB_001a5d3e;
LAB_001a5ef8:
