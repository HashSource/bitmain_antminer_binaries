...

{
  ...
  *(undefined4 *)(pAVar2 + 0x3c) = 0;
  ...
  if (iVar1 == 0) goto LAB_001b0512;
  *puVar8 = uVar6;
  if (md == (EVP_MD *)0x0) {
    iVar1 = EVP_PKEY_get_default_digest_nid(pk,&local_34);
    if (iVar1 < 1) goto LAB_001b0512;
  ...
  if ((flags & 0x100) == 0) {
    if (*(int *)(pAVar2 + 0xc) == 0) {
      ...
      *(_STACK **)(pAVar2 + 0xc) = p_Var4;
      if (p_Var4 == (_STACK *)0x0) goto LAB_001b0500;
    }
