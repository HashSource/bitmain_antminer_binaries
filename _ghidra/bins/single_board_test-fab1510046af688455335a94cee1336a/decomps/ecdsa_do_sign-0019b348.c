...
LAB_0019b4b6:
    ...
    ECDSA_SIG_free(sig);
    if (ctx == (ECDSA_SIG *)0x0) goto LAB_0019b4e8;
    sig = (ECDSA_SIG *)0x0;
    ret = (BIGNUM *)0x0;
  }
  else {
    r = BN_new();
    if ((r == (BIGNUM *)0x0) || (ret = BN_new(), ret == (BIGNUM *)0x0)) goto LAB_0019b4b6;
...
LAB_0019b550:
        ...
        do {
          ...
          if (r_00->top != 0) goto LAB_0019b4d6;
