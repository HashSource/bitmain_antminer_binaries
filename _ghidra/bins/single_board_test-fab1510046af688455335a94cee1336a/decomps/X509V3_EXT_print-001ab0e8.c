...
LAB_001ab1ee:
  ...
  if (method->i2s == (X509V3_EXT_I2S)0x0) {
    if (method->i2v == (X509V3_EXT_I2V)0x0) {
      if (method->i2r == (X509V3_EXT_I2R)0x0) goto LAB_001ab15e;
      ...
      if (st == (_STACK *)0x0) goto LAB_001ab15e;
      iVar3 = 1;
    ...
    if (ptr != (char *)0x0) {
      ...
      sk_pop_free((_STACK *)0x0,(func *)0x167909);
      CRYPTO_free(ptr);
      it = method->it;
      goto joined_r0x001ab16e;
    }
LAB_001ab15e:
    iVar3 = 0;
    st = (_STACK *)0x0;
  }
  sk_pop_free(st,(func *)0x167909);
  it = method->it;
joined_r0x001ab16e:
  if (it == (ASN1_ITEM *)0x0) {
    (*method->ext_free)(val);
