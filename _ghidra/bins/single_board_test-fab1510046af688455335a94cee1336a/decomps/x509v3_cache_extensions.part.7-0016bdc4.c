...

{
  ...
  if (a != (BASIC_CONSTRAINTS *)0x0) {
    ...
    if (iVar20 == 0) {
      pAVar3 = a->pathlen;
      if (pAVar3 != (ASN1_INTEGER *)0x0) goto LAB_0016be10;
LAB_0016c136:
      ...
      if (pAVar3 == (ASN1_INTEGER *)0x0) goto LAB_0016c136;
LAB_0016be10:
...
LAB_0016be52:
  ...
  if (p_Var5 != (_STACK *)0x0) {
    ...
    sk_pop_free(p_Var5,(func *)0x158bd9);
  }
    ...
    if (pAVar8 != (AUTHORITY_KEYID *)0x0) {
      ...
      if (p_Var5 != (_STACK *)0x0) {
        ...
        do {
          ...
          if (iVar13 <= iVar20) goto LAB_0016c196;
  ...
  for (iVar20 = 0; iVar13 = sk_num(p_Var5), iVar20 < iVar13; iVar20 = iVar20 + 1) {
    ...
    if (((int *)*piVar14 != (int *)0x0) && (*(int *)*piVar14 == 1)) {
      ...
      do {
        ...
        if (iVar16 <= iVar13) goto LAB_0016c058;
...
LAB_0016c0d0:
    ...
    if (iVar20 != 0) {
      ...
      if ((local_1c == 0) ||
         (pvVar17 = OBJ_bsearch_(&local_1c,&supported_nids_16010,0xb,4,(cmp *)0x16b9cd),
         pvVar17 == (void *)0x0)) {
