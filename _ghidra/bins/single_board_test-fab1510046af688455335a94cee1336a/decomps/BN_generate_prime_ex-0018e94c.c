        ...
        if (safe != 0) {
          ...
          if (cb == (BN_GENCB *)0x0) {
            ...
            while( true ) {
              ...
              goto LAB_0018ea5c;
              if (iVar8 <= iVar6) goto LAB_0018ec9a;
            }
          }
          goto LAB_0018e9a4;
        }
        iVar7 = BN_is_prime_fasttest_ex_constprop_2(ret,iVar8,ctx,cb);
        if (iVar7 == -1) goto LAB_0018ea5c;
      } while (iVar7 == 0);
LAB_0018ec9a:
      iVar8 = 1;
    }
