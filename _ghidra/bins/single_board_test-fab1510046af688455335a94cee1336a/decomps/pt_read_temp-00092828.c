...

{
  ...
  while (*(int *)((int)arg + 0x55748) != 0) {
    ...
    *(char *)((int)arg + 0x5573b) = (char)iVar1;
    ...
    if ((*(int *)(*(int *)((int)arg + 0x55708) + 0x94) == 2) &&
       (3 < (int)((uint)*(byte *)((int)arg + 0x55738) - (uint)*(byte *)((int)arg + 0x55739)))) {
    ...
    sleep_counter = '\0';
    while ((*(int *)((int)arg + 0x55748) != 0 && (sleep_counter < 0x14))) {
      sleep(1);
