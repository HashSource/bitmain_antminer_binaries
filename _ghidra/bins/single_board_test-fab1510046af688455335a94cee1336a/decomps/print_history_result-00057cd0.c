...

{
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].asic_ok: %s",test_loop_counter,pcVar1);
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].nonce_rate_ok: %s",test_loop_counter,pcVar1);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].eeprom_ok: %s",test_loop_counter,pcVar1);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].pic_sensor_all_OK: %s",test_loop_counter,pcVar1);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].asic_sensor_all_OK: %s",test_loop_counter,pcVar1);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].ctrlborad_sensor_all_OK: %s",test_loop_counter,pcVar1);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].apw_power_ok: %s",test_loop_counter,pcVar1);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].pic_ok: %s",test_loop_counter,pcVar1);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].nonce_rate: %f",test_loop_counter,
           *(undefined4 *)&gHistory_Result[test_loop_counter].nonce_rate,
           *(undefined4 *)((int)&gHistory_Result[test_loop_counter].nonce_rate + 4));
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].level: %d",test_loop_counter,
           gHistory_Result[test_loop_counter].level);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].voltage: %d",test_loop_counter,
           gHistory_Result[test_loop_counter].voltage);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].pre_open_core_voltage: %d",test_loop_counter,
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].frequence: %d",test_loop_counter,
           gHistory_Result[test_loop_counter].frequence);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].valid_nonce_num: %d",test_loop_counter,
           gHistory_Result[test_loop_counter].valid_nonce_num);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].repeat_nonce_number: %d",test_loop_counter,
  ...
  for (i = 0; i < 4; i = i + 1) {
    ...
    snprintf(tmp1,0x800,"gHistory_Result[%d].pic_sensor_OK[%d]: %s",test_loop_counter,i,pcVar1);
    log_to_file(tmp1,time_stamp);
  }
  for (i = 0; i < 4; i = i + 1) {
  }
  for (i = 0; i < 2; i = i + 1) {
    ...
    snprintf(tmp1,0x800,"gHistory_Result[%d].ctrlboard_sensor_OK[%d]: %s",test_loop_counter,i,pcVar1
            );
    log_to_file(tmp1,time_stamp);
  }
  for (i = 0; i < 4; i = i + 1) {
  ...
  for (i = 0; i < 4; i = i + 1) {
    ...
    snprintf(tmp1,0x800,"gHistory_Result[%d].sensor_local_temperature_from_pic[%d]: %d",
             test_loop_counter,i,
             (int)gHistory_Result[test_loop_counter].sensor_local_temperature_from_pic[i]);
    log_to_file(tmp1,time_stamp);
  }
  for (i = 0; i < 2; i = i + 1) {
    ...
    snprintf(tmp1,0x800,"gHistory_Result[%d].sensor_local_temperature_from_ctrlboard[%d]: %d",
             test_loop_counter,i,
             (int)gHistory_Result[test_loop_counter].sensor_local_temperature_from_ctrlboard[i]);
    log_to_file(tmp1,time_stamp);
  }
  ...
  snprintf(tmp1,0x800,"gHistory_Result[%d].test_standard: %d",test_loop_counter,
           (uint)gHistory_Result[test_loop_counter].test_standard);
  log_to_file(tmp1,time_stamp);
  return;
}
