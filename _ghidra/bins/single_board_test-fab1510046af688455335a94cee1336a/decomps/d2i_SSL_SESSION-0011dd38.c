...
LAB_0011e35c:
          ...
          if ((byte *)local_44.slen == (byte *)0x0) goto LAB_0011dffc;
          goto LAB_0011dff4;
        }
      }
      local_44.line = 0x205;
...
LAB_0011dff4:
    ...
    pbVar11 = (byte *)local_68.length;
    pbVar2 = local_68.data;
    if (*local_44.p != 0xa4) goto LAB_0011dffc;
    local_44.q = local_44.p;
    iVar3 = ASN1_get_object(&local_44.p,(long *)&local_6c,&iStack_74,&iStack_70,local_44.slen);
    if (iVar3 << 0x18 < 0) {
      local_44.error = 0x3b;
...
LAB_0011e38e:
        ...
        pbVar11 = (byte *)local_68.length;
        pbVar2 = local_68.data;
        if (local_68.data == (byte *)0x0) goto LAB_0011dffc;
        if (0x20 < local_68.length) {
...
LAB_0011e53a:
        local_44.slen = local_44.slen + ((int)local_44.q - (int)local_44.p);
        if (local_68.data == (byte *)0x0) goto LAB_0011e03e;
...
LAB_0011e58a:
        local_44.slen = local_44.slen + ((int)local_44.q - (int)local_44.p);
        if (local_68.data == (byte *)0x0) goto LAB_0011e050;
        pcVar10 = BUF_strndup((char *)local_68.data,local_68.length);
...
LAB_0011e692:
        local_44.slen = local_44.slen + ((int)local_44.q - (int)local_44.p);
        if (local_68.data == (byte *)0x0) goto LAB_0011e062;
        pcVar10 = BUF_strndup((char *)local_68.data,local_68.length);
...
LAB_0011e654:
          ...
          *(uchar **)(ses->krb5_client_princ + 0x54) = local_68.data;
          if ((byte *)local_44.slen == (byte *)0x0) goto LAB_0011e1f2;
          goto LAB_0011e0ba;
        }
      }
      local_44.line = 599;
...
LAB_0011e612:
          ...
          local_68.length = 0;
          local_68.data = (byte *)0x0;
          if ((byte *)local_44.slen == (byte *)0x0) goto LAB_0011e0d2;
          goto LAB_0011e0ca;
        }
      }
      local_44.line = 0x263;
...
LAB_0011e0ca:
    local_68.data = (byte *)0x0;
    local_68.length = 0;
    if (*local_44.p != 0xac) goto LAB_0011e0d2;
    local_44.q = local_44.p;
    iVar3 = ASN1_get_object(&local_44.p,(long *)&local_6c,&iStack_74,&iStack_70,local_44.slen);
    if (iVar3 << 0x18 < 0) {
      local_44.error = 0x3b;
...
LAB_0011e6fc:
        local_44.slen = local_44.slen + ((int)local_44.q - (int)local_44.p);
        if (local_68.data == (byte *)0x0) goto LAB_0011e0d2;
        pcVar10 = BUF_strndup((char *)local_68.data,local_68.length);
