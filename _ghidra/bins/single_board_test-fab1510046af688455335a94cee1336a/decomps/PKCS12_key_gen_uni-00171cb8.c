...

{
  ...
  if (((d == (void *)0x0 || md == (uchar *)0x0) || (s == (uchar *)0x0 || d_00 == (void *)0x0)) ||
     (ret == (BIGNUM *)0x0 || ret_00 == (BIGNUM *)0x0)) goto LAB_00171ff4;
  uVar11 = 0;
  if (0 < (int)cnt) {
    uVar7 = -(int)d & 3U;
    if (cnt <= (-(int)d & 3U)) {
    ...
    if (uVar7 == 0) {
      ...
      if (cnt == uVar7) goto LAB_00171f16;
    }
    uVar13 = cnt - uVar7 >> 2;
    if (uVar13 != 0) {
      ...
      if (cnt - uVar7 == uVar13 * 4) goto LAB_00171f16;
    }
    uVar7 = uVar11 + 1;
    ...
    if (1 < iter) {
      ...
      do {
        ...
        if (((iVar9 == 0) || (iVar9 = EVP_DigestUpdate(&EStack_40,md,cnt_00), iVar9 == 0)) ||
           (iVar9 = EVP_DigestFinal_ex(&EStack_40,md,(uint *)0x0), iVar9 == 0)) goto LAB_00171ff4;
      } while (iVar3 != iter);
    }
    __n = n;
    if ((int)cnt_00 <= n) {
    ...
    if (0 < (int)cnt_01) {
      do {
        ...
        if (((pBVar5 == (BIGNUM *)0x0) || (iVar3 = BN_add(ret,ret,ret_00), iVar3 == 0)) ||
           (iVar3 = BN_bn2bin(ret,s), iVar3 == 0)) goto LAB_00171ff4;
