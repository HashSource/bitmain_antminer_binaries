...

{
  ...
  *(uint *)(param_1 + 0x24) = uVar8;
  ...
  if (param_4 < 0x10) {
    local_60 = param_3;
    if (param_4 != 0) goto LAB_0018883e;
  }
  else {
    puVar11 = param_3 + 8;
    puVar17 = param_2 + 8;
...
LAB_001888b4:
        ...
        uVar5 = uVar14;
        if (param_4 != uVar14) goto LAB_001888b4;
      }
      ...
      if (iVar6 != 0 ||
        ...
        if (param_4 == uVar14) goto LAB_00188954;
      }
      do {
...
LAB_00188954:
  ...
  if (uVar8 != 0) {
    ...
    if (uVar14 == uVar8) goto LAB_00188a08;
  }
  ...
  if (uVar7 != 0) {
    ...
    uVar5 = uVar5 + uVar7 * 4;
    if (uVar14 - uVar8 == uVar7 * 4) goto LAB_00188a08;
  }
  do {
    param_1[uVar5] = 0;
    uVar5 = uVar5 + 1;
