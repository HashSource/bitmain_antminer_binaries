...

{
  ...
  if (pXVar1 == (X509_POLICY_CACHE *)0x0) goto LAB_0016def8;
  *(undefined4 *)pXVar1 = 0;
  ...
  *(undefined4 *)(pXVar1 + 0x10) = 0xffffffff;
  ...
  if (a == (POLICY_CONSTRAINTS *)0x0) {
    if (local_2c[0] != -1) goto LAB_0016df0e;
LAB_0016de74:
    st = (_STACK *)X509_get_ext_d2i(param_1,0x59,local_2c,(int *)0x0);
    iVar8 = local_2c[0];
    if (st == (_STACK *)0x0) {
      if (local_2c[0] == -1) goto LAB_0016def8;
      goto LAB_0016df0e;
    }
...
LAB_0016de98:
    ...
    if (pvVar5 == (void *)0x0) {
      if (local_2c[0] == -1) goto LAB_0016dec6;
      goto LAB_0016df0e;
    }
...
LAB_0016dec6:
    ...
    if (pAVar2 == (ASN1_INTEGER *)0x0) {
      ...
      if (pAVar2 != (ASN1_INTEGER *)0x0) goto LAB_0016de64;
    }
    else if (pAVar2->type != 0x102) {
      lVar3 = ASN1_INTEGER_get(pAVar2);
      pAVar2 = a->inhibitPolicyMapping;
      *(long *)(pXVar1 + 0xc) = lVar3;
      if (pAVar2 == (ASN1_INTEGER *)0x0) goto LAB_0016de74;
LAB_0016de64:
      if (pAVar2->type != 0x102) {
        lVar3 = ASN1_INTEGER_get(pAVar2);
