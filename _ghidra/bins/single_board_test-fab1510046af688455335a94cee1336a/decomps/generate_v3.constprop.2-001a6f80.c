...
LAB_001a71f0:
      ...
      if (p_Var6 != (_STACK *)0x0) goto LAB_001a70ce;
    }
    else {
      section = local_1c0;
      if (local_1c0 != (_STACK *)0x0) {
        ...
        iVar8 = 0;
        if (section == (_STACK *)0x0) goto LAB_001a721c;
        do {
          iVar9 = sk_num(section);
          if (iVar9 <= iVar8) goto LAB_001a708a;
...
LAB_001a708a:
      ...
      if (a == (_STACK *)0x0) goto LAB_001a71f0;
      pAVar5 = ASN1_STRING_type_new(local_1d0[2]);
      a->data = (char **)pAVar5;
      if (pAVar5 == (ASN1_STRING *)0x0) goto LAB_001a71f0;
      a->num = local_1d0[2];
      pAVar5->length = iVar8;
