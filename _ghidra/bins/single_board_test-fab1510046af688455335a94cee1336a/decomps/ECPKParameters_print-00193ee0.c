...
LAB_001940c2:
                    ...
                    if (pEVar4 == (EC_POINT *)0x0) {
                      ...
                      if ((buf == (BIGNUM *)0x0) ||
                        ...
                        if (local_c8 == (BIGNUM *)0x0) goto LAB_00194018;
                        iVar5 = BN_num_bits(p);
                        iVar8 = iVar5 + 0xe;
                        if (-1 < iVar5 + 7) {
                          iVar8 = iVar5 + 7;
...
joined_r0x00194382:
                              if (((iVar2 != 0) &&
                                ...
                                if (((iVar2 != 0) &&
                                   ...
                                   , iVar2 != 0)) {
                                  if (puVar7 == (uchar *)0x0) goto LAB_00194092;
                                  if (off < 1) {
                                    local_c0 = 0;
                                  }
                                  else {
...
LAB_00194204:
        ...
        if ((cofactor != (BIGNUM *)0x0) &&
          ...
          if ((0 < iVar2) && (iVar2 = BIO_printf(bp,"\n"), 0 < iVar2)) {
            ...
            if (iVar2 != 0) {
              cofactor = (BIGNUM *)BIO_indent(bp,off,0x80);
              if (cofactor == (BIGNUM *)0x0) goto LAB_00193f14;
              iVar2 = BIO_printf(bp,"NIST CURVE: %s\n",iVar2);
              if (iVar2 < 1) goto LAB_001940f4;
            }
            cofactor = (BIGNUM *)0x0;
            order = (BIGNUM *)0x0;
            b = (BIGNUM *)0x0;
