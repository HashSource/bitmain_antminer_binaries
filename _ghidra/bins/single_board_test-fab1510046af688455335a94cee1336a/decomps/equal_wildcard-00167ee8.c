...

{
  ...
  if ((param_4 < (byte *)0x2) || (*param_3 != 0x2e)) {
      ...
      do {
        ...
        if (uVar3 == 0x2a) {
          ...
          if ((((pbVar10 != (byte *)0x0) || (bVar12 || iVar8 != 0)) ||
             ...
             (!bVar13 && (uVar6 & 1) == 0)) goto LAB_00168016;
          ...
          if (uVar6 != 0) goto LAB_00168016;
          iVar8 = iVar8 + 1;
          uVar6 = 1;
          bVar12 = false;
        }
        else {
          if ((uVar3 != 0x2d) || ((int)(uVar6 << 0x1d) < 0)) goto LAB_00168016;
          uVar6 = uVar6 | 4;
        }
        pbVar7 = pbVar4 + 1;
        pbVar11 = pbVar11 + 1;
    ...
    if ((int)(param_5 << 0x10) < 0) goto LAB_0016805a;
  }
  else {
LAB_00168016:
...
LAB_0016805a:
      if (param_4 == pbVar9) goto LAB_00168062;
    }
  }
