...

{
  ...
  for (iVar10 = 0; iVar3 = sk_num(&db->data->stack), iVar10 < iVar3; iVar10 = iVar10 + 1) {
    ...
    if (*(char *)*puVar2 == 'I') {
      ...
      if (puVar4 == (undefined4 *)0x0) goto LAB_00175c1c;
...
LAB_00175d0c:
        ...
        do {
          iVar6 = sk_num(sk);
          iVar12 = iVar3 + 1;
          if (iVar6 <= iVar3) goto LAB_00175d0c;
          puVar4 = (undefined4 *)sk_value(sk,iVar3);
          iVar3 = iVar12;
...
LAB_00175ca4:
        if (pcVar5 != (char *)0x0) {
          ...
          puVar7[5] = pcVar5;
          if (pcVar5 == (char *)0x0) goto LAB_00175cda;
        }
        ...
        if (iVar3 == 0) {
          ...
          local_3c = (char *)0x2;
          if (iVar3 != 0) goto LAB_00175acc;
        }
      }
      else {
        pcVar13 = BUF_strdup((char *)puVar2[3]);
        *puVar7 = pcVar13;
        if (pcVar13 != (char *)0x0) goto LAB_00175ca4;
LAB_00175cda:
        local_3c = (char *)0x4;
      }
      BN_free((BIGNUM *)puVar7[1]);
...
LAB_00175bfe:
      ...
      local_3c = (char *)0x2;
      if (puVar2 == (undefined4 *)0x0) goto LAB_00175c1c;
    }
    else {
      iVar10 = 0;
      do {
        iVar3 = sk_num(sk);
        iVar6 = iVar10 + 1;
        if (iVar3 <= iVar10) goto LAB_00175bfe;
