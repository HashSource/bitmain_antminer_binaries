...

{
  ...
  if ((uVar12 & 1) == 0) {
    ...
    pcVar7 = "SSLv3";
    if (uVar1 != 0x20) goto LAB_0011d21c;
LAB_0011d1fe:
    pcVar9 = "ECDH/RSA";
  }
  else {
    pcVar7 = "SSLv2";
LAB_0011d218:
    if (uVar1 == 0x20) goto LAB_0011d1fe;
LAB_0011d21c:
    if (uVar1 < 0x21) {
      if (uVar1 == 4) {
        pcVar9 = "DH/DSS";
        ...
        if (uVar1 != 0x10) goto LAB_0011d234;
        pcVar9 = "KRB5";
      }
    }
    else if (uVar1 == 0x100) {
...
LAB_0011d234:
      ...
      if (uVar1 != 0x400) goto LAB_0011d234;
      pcVar9 = "SRP";
    }
  }
  if (uVar4 == 0x20) {
...
LAB_0011d256:
      ...
      if (uVar4 != 0x10) goto LAB_0011d256;
      pcVar5 = "ECDH";
    }
  }
  else if (uVar4 == 0x100) {
    ...
    if (uVar4 == 0x40) {
      ...
      if (uVar4 != 0x80) goto LAB_0011d256;
      pcVar5 = "PSK";
    }
  }
  else if (uVar4 == 0x200) {
    ...
    if (uVar4 != 0x400) goto LAB_0011d256;
    pcVar5 = "SRP";
  }
  if (uVar3 == 0x40) {
    pcVar11 = "AES(128)";
