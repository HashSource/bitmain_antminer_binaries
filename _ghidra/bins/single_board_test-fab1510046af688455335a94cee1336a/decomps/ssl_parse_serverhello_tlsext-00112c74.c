...
LAB_00112d0c:
        ...
        if (puVar20 < puVar18) goto LAB_00112d0c;
...
LAB_00112ff0:
        ...
        if (sVar1 == 0xb) {
          ...
          if (uVar15 != uVar9 - 1) goto LAB_00112ce4;
          if (param_1->hit == 0) {
            pSVar16 = param_1->session;
...
LAB_0011304a:
        ...
        if (sVar1 == 0x23) {
          if ((param_1->tlsext_session_ticket != (TLS_SESSION_TICKET_EXT *)0x0) &&
             ...
             iVar6 == 0)) goto LAB_0011304a;
          lVar7 = SSL_ctrl(param_1,0x20,0,(void *)0x0);
          if ((lVar7 << 0x11 < 0) || (uVar9 != 0)) goto LAB_00113030;
          ...
          if (uVar9 != 0) {
            ...
            if (uVar10 != 0) {
              while( true ) {
                ...
                if (uVar10 == 0) goto LAB_0011305c;
              }
              if (uVar9 == uVar15) goto LAB_00112efe;
            }
LAB_0011305c:
            local_30 = 0x32;
            goto LAB_00112ce8;
...
LAB_00112efe:
        ...
        if (sVar1 == 0x10) {
          if (param_1[1].init_buf == (BUF_MEM *)0x0) goto LAB_00113030;
          if (((uVar9 < 4) || ((uint)CONCAT11(puVar13[4],puVar13[5]) != uVar9 - 2)) ||
             (uVar15 = (uint)(byte)puVar13[6], uVar15 != uVar9 - 3)) goto LAB_00112ce4;
          psVar17 = param_1->s3;
          ...
          if (pvVar5 == (void *)0x0) goto LAB_0011304a;
