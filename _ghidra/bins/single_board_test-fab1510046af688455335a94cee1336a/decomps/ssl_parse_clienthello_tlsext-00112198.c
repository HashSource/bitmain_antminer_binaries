            ...
            if ((uVar23 == uVar28 - 1) && (uVar23 != 0)) {
              if (param_1->hit == 0) {
                ...
                *(void **)(pSVar24->krb5_client_princ + 0x48) = pvVar6;
                if (pvVar6 == (void *)0x0) goto LAB_001127da;
                pSVar24 = param_1->session;
            ...
            if (sVar4 == 0xd) {
              ...
              if ((*(int *)(pcVar17 + 0x124) == 0) && (1 < uVar28)) {
                ...
                if ((uVar28 == uVar23) && ((-1 < (int)(uVar28 << 0x1f) && (uVar28 != 0)))) {
                  if (-1 < *(int *)(param_1->method->ssl3_enc + 0x38) << 0x1e) goto LAB_001128ec;
                    ...
                    if (-1 < iVar20) {
                      do {
                        ...
                        if (st == (_STACK *)0x0) {
                          ...
                          if (st != (_STACK *)0x0) goto LAB_00112a48;
LAB_00112aa2:
                          OCSP_RESPID_free(a);
                          local_34 = 0x50;
                          goto LAB_00112376;
...
LAB_00112a48:
                        iVar11 = sk_push(st,a);
                        if (iVar11 == 0) goto LAB_00112aa2;
                        puVar26 = puVar16 + 2;
                        if (iVar20 < 1) goto LAB_00112aba;
                        if (iVar20 < 4) break;
            ...
            if (sVar4 == 0xf) {
                  ...
                  if ((1 < uVar28) &&
                    ...
                    do {
                      ...
                      if (((uVar9 == 0) || (uVar28 = uVar9 + uVar12, CARRY4(uVar9,uVar12))) ||
                         (uVar23 < uVar28)) goto LAB_00112372;
                    } while (uVar28 < uVar23);
              ...
              if (((*(int *)(param_1->method->ssl3_enc + 0x38) << 0x1c < 0) &&
                 ...
                 ((sVar4 == 0xe &&
                  ...
                  iVar20 != 0)))) goto LAB_00112376;
            }
          }
LAB_001124e8:
          if (puVar18 < puVar26) goto LAB_00112538;
          puVar19 = puVar26 + 4;
          uVar28 = (uint)CONCAT11(puVar26[2],puVar26[3]);
          sVar4 = CONCAT11(*puVar26,puVar26[1]);
          puVar1 = puVar19 + uVar28;
          puVar16 = puVar26;
          if (puVar25 < puVar19 + uVar28) goto LAB_00112372;
          goto LAB_00112286;
        }
      }
    }
...
LAB_0011258c:
  ...
  return 1;
LAB_00112aba:
  if (uVar23 < 2) goto LAB_00112372;
LAB_001128a0:
  uVar23 = uVar23 - 2 & 0xffff;
  puVar26 = puVar16 + 2;
  uVar28 = (uint)CONCAT11(*puVar16,puVar16[1]);
  if (uVar28 != uVar23) goto LAB_00112372;
  local_30 = puVar26;
  if (uVar28 != 0) {
    if (&param_1->tlsext_ocsp_ids->stack != (_STACK *)0x0) {
      sk_pop_free(&param_1->tlsext_ocsp_ids->stack,(func *)0x15dd61);
    }
