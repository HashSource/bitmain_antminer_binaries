...
LAB_00172cf4:
        ...
        pbVar13 = local_30;
        if (1 < lVar4) {
          if (*local_30 != 0x30) goto LAB_00172e1c;
...
LAB_00172e1c:
            ...
            if (param_1[6] < uVar11) goto LAB_00172e1c;
...
LAB_00172d26:
        ...
        while ((sVar2 = BIO_ctrl((BIO *)param_1[4],3,0,&local_30), 0 < (int)sVar2 &&
          ...
          if ((int)uVar12 < 1) {
            ...
            pbVar13 = local_30;
            if (iVar5 != 0) goto LAB_00172dae;
            iVar5 = 0;
            goto LAB_00172f9e;
          }
          if (param_1[2] == uVar12) goto LAB_00172e1c;
          if (*param_1 == 1) {
...
LAB_00172e0e:
            ...
            *pbVar9 = 0;
            ...
            if (*local_2c[0] != 0) goto LAB_00172e1c;
            uVar12 = (uint)pbVar9[1];
            pbVar9 = pbVar9 + 1;
            if (uVar12 != 0) {
              puVar10 = *ppuVar7;
LAB_00172ebc:
              if ((int)((uint)puVar10[uVar12] << 0x12) < 0) goto LAB_00172eb6;
...
LAB_00172cf0:
            ...
            if (bVar1 == 10 || bVar1 == 0xd) {
              do {
                local_30 = local_30 + 1;
                bVar1 = *local_30;
                if (bVar1 == 0) goto LAB_00172cf0;
              } while (bVar1 == 10 || bVar1 == 0xd);
            }
          }
        }
        pbVar13 = local_30;
        if ((int)param_1[2] <= (int)sVar2) goto LAB_00172e1c;
      }
LAB_00172dae:
      local_30 = pbVar13;
      uVar12 = *param_1;
