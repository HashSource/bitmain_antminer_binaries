...

{
  ...
  if (pBVar4 != (BIGNUM *)0x0) {
    if (*(int *)(param_3 + 0x40) == 0) {
      ...
      if (iVar5 != 0) {
        if (*(int *)(param_4 + 0x40) == 0) goto LAB_00191dca;
LAB_00191d3a:
...
joined_r0x00191de6:
          if (iVar5 == 0) {
            ...
            iVar5 = (**(code **)(*(int *)param_1 + 0x8c))(param_1,pBVar3,a_01,b,param_5);
            if ((iVar5 != 0) &&
               (((iVar5 = BN_GF2m_add(pBVar3,pBVar3,b), iVar5 != 0 &&
                 (iVar5 = (**(code **)(*(int *)param_1 + 0x88))(param_1,pBVar1,pBVar3,param_5),
                 iVar5 != 0)) && (iVar5 = BN_GF2m_add(pBVar1,pBVar1,pBVar3), iVar5 != 0)))) {
              iVar5 = BN_GF2m_add(pBVar1,pBVar1,param_1 + 0x74);
              goto joined_r0x00191e62;
            }
          }
          else {
            ...
            if (((((iVar5 != 0) && (iVar5 = BN_GF2m_add(pBVar3,a_00,a_01), iVar5 != 0)) &&
                 (iVar5 = (**(code **)(*(int *)param_1 + 0x8c))
                                    (param_1,pBVar3,pBVar3,pBVar4,param_5), iVar5 != 0)) &&
                ((iVar5 = (**(code **)(*(int *)param_1 + 0x88))(param_1,pBVar1,pBVar3,param_5),
                 iVar5 != 0 && (iVar5 = BN_GF2m_add(pBVar1,pBVar1,param_1 + 0x74), iVar5 != 0)))) &&
...
joined_r0x00191e62:
              if (((iVar5 != 0) && (iVar5 = BN_GF2m_add(pBVar2,b,pBVar1), iVar5 != 0)) &&
                 ((iVar5 = (**(code **)(*(int *)param_1 + 0x84))
                                     (param_1,pBVar2,pBVar2,pBVar3,param_5), iVar5 != 0 &&
