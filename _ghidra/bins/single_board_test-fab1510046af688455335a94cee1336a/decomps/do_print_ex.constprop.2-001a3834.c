...
LAB_001a3858:
    iVar3 = do_dump(param_2,0x1a32b9,param_1,param_3);
    if (iVar3 < 0) {
      return -1;
    }
    return iVar3 + uVar5;
...
LAB_001a3918:
    ...
    if ((0x1d < iVar3 - 1U) || (uVar4 = (uint)(char)tag2nbyte[iVar3], uVar4 == 0xffffffff)) {
      if ((int)(param_2 << 0x17) < 0) goto LAB_001a3858;
      goto LAB_001a3872;
    }
    if (-1 < (int)(param_2 << 0x1b)) goto LAB_001a3878;
    if (uVar4 != 0) goto LAB_001a3918;
  }
  uVar4 = 1;
LAB_001a3878:
  ...
  if (-1 < iVar3) {
    ...
    if (local_28[0] == '\0') {
      ...
      iVar1 = BIO_write(param_1,&DAT_002340f4,1);
      if (iVar1 != 1) {
        return -1;
      }
    }
