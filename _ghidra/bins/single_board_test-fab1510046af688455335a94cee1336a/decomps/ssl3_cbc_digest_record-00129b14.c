...
LAB_00129eae:
    ...
    bVar25 = true;
    local_2e8 = 0x28;
    local_320 = (code *)0x129655;
    local_350 = 8;
    local_34c = 0x40;
    local_328 = (code *)0x13c18d;
    if (param_10 == '\0') goto LAB_00129ef0;
LAB_00129bc8:
...
LAB_00129b46:
    if (bVar25 || iVar6 < 0x2a0) {
      if (iVar6 == 4) {
        ...
        cnt = 0x10;
        local_2e8 = 0x30;
        local_328 = (code *)0x1396fd;
        local_320 = (code *)0x1295ad;
      }
      else {
        if (iVar6 != 0x40) {
LAB_00129b54:
        ...
        cnt = 0x14;
        local_350 = 8;
        local_328 = (code *)0x13ae41;
        local_320 = (code *)0x1295f9;
        local_34c = 0x40;
      }
    }
    else if (iVar6 == 0x2a2) {
      ...
      local_350 = 0x10;
      local_34c = 0x80;
      local_328 = (code *)0x142301;
      local_320 = (code *)0x1296e9;
    }
    else if (iVar6 < 0x2a2) {
      local_348 = 0x73;
      ...
      if (iVar6 != 0x2a3) goto LAB_00129b54;
      local_348 = 0x33;
    ...
    iVar6 = iVar23;
    uVar18 = cnt;
    if (param_10 != '\0') goto LAB_00129bc8;
LAB_00129ef0:
...
LAB_0012a35e:
      ...
      if (sVar15 != uVar18) goto LAB_0012a35e;
    }
  ...
  if (!CARRY4(local_33c,local_340)) {
    ...
    do {
      ...
      if (iVar6 == 0) {
        ...
        if (uVar11 != uVar24 << 2) goto LAB_0012a0de;
      }
      else {
LAB_0012a0de:
        do {
  ...
  if (param_10 == '\0') {
    ...
    if (uVar21 != 0) {
      ...
      if (uVar18 == sVar15) goto LAB_0012a210;
    }
    do {
