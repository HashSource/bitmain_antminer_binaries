    ...
    if (*(int *)param_1[2] == 0x1ffff) {
      ...
      if (uVar5 == 0xfefd) {
        if ((int)(param_1[0x40] << 4) < 0) {
          if ((*(uint *)(param_1[0x26] + 0x38) & 0x30000) == 0) goto LAB_00121cd0;
          goto LAB_00121d8e;
        }
...
LAB_00121b90:
            ...
            if (uVar5 == 0) goto LAB_00121a62;
LAB_00121b9a:
            pbVar6 = local_2c;
            if (uVar4 != uVar5) goto LAB_00121a62;
            iVar2 = memcmp(local_2c,(void *)(uVar10 + 0x48),uVar5);
            if (iVar2 != 0) goto LAB_00121c20;
...
LAB_00121b3c:
            ...
            uVar10 = param_1[0x30];
            if ((pcVar12 == (code *)0x0) || (*(int *)(uVar10 + 0xe4) == 0)) goto LAB_00121b90;
            uVar4 = param_1[0x5b];
            local_24 = 0;
