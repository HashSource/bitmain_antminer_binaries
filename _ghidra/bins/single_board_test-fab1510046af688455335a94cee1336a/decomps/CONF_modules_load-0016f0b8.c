...

{
  ...
  if (appname != (char *)0x0) {
    ...
    if (pcVar2 != (char *)0x0) goto LAB_0016f0da;
    if (-1 < (int)(flags << 0x1a)) goto LAB_0016f34a;
  }
...
LAB_0016f290:
        ...
        if ((code *)data[2] != (code *)0x0) {
          ...
          if (0 < iVar4) {
            bVar1 = true;
            goto joined_r0x0016f250;
          }
          pcVar10 = (code *)data[3];
          if (pcVar10 == (code *)0x0) goto LAB_0016f27e;
LAB_0016f2fc:
          (*pcVar10)(data_00);
LAB_0016f284:
          pvVar5 = (void *)data_00[1];
          if (pvVar5 != (void *)0x0) goto LAB_0016f28a;
          goto LAB_0016f290;
        }
        bVar1 = false;
joined_r0x0016f250:
        if (initialized_modules == (_STACK *)0x0) {
          ...
          iVar4 = 0x16c;
          if (initialized_modules != (_STACK *)0x0) goto LAB_0016f252;
LAB_0016f266:
          ERR_put_error(0xe,0x73,0x41,"conf_mod.c",iVar4);
          pcVar10 = (code *)data[3];
          if ((pcVar10 != (code *)0x0) && (bVar1)) goto LAB_0016f2fc;
LAB_0016f27e:
          if (data_00 == (undefined4 *)0x0) goto LAB_0016f2a0;
          goto LAB_0016f284;
        }
LAB_0016f252:
