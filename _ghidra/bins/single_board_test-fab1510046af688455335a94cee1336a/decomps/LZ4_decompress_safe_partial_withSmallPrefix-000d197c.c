...
/* WARNING: Removing unreachable block (ram,0x000d1e6a) */
/* WARNING: Removing unreachable block (ram,0x000d1e74) */
/* WARNING: Removing unreachable block (ram,0x000d1e76) */
/* WARNING: Removing unreachable block (ram,0x000d1e78) */
/* WARNING: Removing unreachable block (ram,0x000d1e7e) */
/* WARNING: Removing unreachable block (ram,0x000d1a4e) */
/* WARNING: Removing unreachable block (ram,0x000d1a56) */
/* WARNING: Removing unreachable block (ram,0x000d1a66) */
/* WARNING: Removing unreachable block (ram,0x000d1a5e) */
...
LAB_000d1ba6:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000d2302;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000d2302;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_000d1ba6;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000d2302;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000d2302;
              op = pBVar10;
