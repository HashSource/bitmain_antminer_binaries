...
LAB_00147a30:
  ...
  if (param_4 != (EC_POINT *)0x0) {
    ...
    while (*(int *)param_1 == iVar7) {
      pEVar8 = pEVar8 + 1;
      if (pEVar8 == param_4) goto LAB_00147a7e;
      puVar1 = puVar1 + 1;
      iVar7 = *(int *)*puVar1;
    }
    iVar7 = 0x172;
...
LAB_00147d48:
    ...
    local_70 = (EC_POINT *)
               EC_EX_DATA_get_data(*(undefined4 *)(param_1 + 0x44),0x1477c9,0x1479c5,0x147965);
    ...
    if (pEVar14 == pEVar11 + (int)pEVar13 * 4) {
      ...
      if (pEVar10 == (EC_POINT *)0x0) {
        ...
        for (local_70 = (EC_POINT *)0x0; local_70 != pEVar9; local_70 = local_70 + 1) {
          ...
          if (pEVar14 == (EC_POINT *)0x0) goto LAB_00147c04;
