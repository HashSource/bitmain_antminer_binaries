...
LAB_00166d26:
    iVar1 = from->trust;
    if (iVar1 != 0) {
      if (uVar18 == 0) goto LAB_00166d30;
LAB_00166d36:
      to->trust = iVar1;
    }
LAB_00166d38:
    iVar1 = from->depth;
    if (iVar1 == -1) goto LAB_00166d4a;
    if (uVar18 == 0) {
LAB_00166d44:
      if (to->depth != -1) goto LAB_00166d4a;
    }
    to->depth = iVar1;
    uVar8 = to->flags;
    if ((uVar8 & 2) == 0) {
    ...
    iVar1 = from->trust;
    if (iVar1 == 0) goto LAB_00166d38;
LAB_00166d30:
    if (to->trust == 0) goto LAB_00166d36;
    iVar1 = from->depth;
    if (iVar1 != -1) goto LAB_00166d44;
LAB_00166d4a:
    uVar8 = to->flags;
    if ((uVar8 & 2) == 0) {
      bVar19 = false;
...
LAB_00166de4:
      if (*piVar13 == 0) goto LAB_00166c56;
      if (uVar18 != 0) goto LAB_00166c10;
LAB_00166d74:
      piVar16 = (int *)to[1].name;
      piVar14 = piVar16;
      if (*piVar16 == 0) goto LAB_00166c26;
      if (piVar13[3] == 0) goto LAB_00166cfa;
      goto LAB_00166da2;
    }
LAB_00166c10:
    ...
    if (p_Var15 != (_STACK *)0x0) {
      sk_pop_free(p_Var15,(func *)0x166929);
      piVar14 = (int *)to[1].name;
      *piVar14 = 0;
    }
LAB_00166c26:
    piVar16 = piVar14;
    if (*piVar12 != 0) {
      iVar1 = sk_deep_copy(*piVar12,0x166a0d,0x166929);
      piVar16 = (int *)to[1].name;
      *piVar14 = iVar1;
      if (*piVar16 == 0) {
        return 0;
    ...
    if (bVar19) goto LAB_00166c68;
    piVar13 = (int *)from[1].name;
LAB_00166c56:
    if (piVar13[3] != 0) {
      if (uVar18 == 0) goto LAB_00166da0;
      piVar16 = (int *)to[1].name;
      goto LAB_00166c68;
    }
LAB_00166cfa:
...
LAB_00166d06:
    ...
    piVar13 = piVar12;
    if (p_Var15 == (_STACK *)0x0) goto LAB_00166de4;
    if (uVar18 != 0) goto LAB_00166bae;
    if (to->policies == (stack_st_ASN1_OBJECT *)0x0) goto LAB_00166bc0;
    if (*piVar12 != 0) goto LAB_00166d74;
    if (piVar12[3] == 0) goto LAB_00166cfa;
LAB_00166da0:
    piVar16 = (int *)to[1].name;
LAB_00166da2:
    if (piVar16[3] != 0) {
...
LAB_00166c68:
  ...
  if (((uint)siz_00 & 0xfffffffb) == 0) {
    ...
    if (pcVar10 == (char *)0x0) goto LAB_00166ce2;
    if (siz_00 != (char *)0x0) goto LAB_00166cd4;
    pcVar4 = BUF_strdup(pcVar10);
