...

{
  ...
  case 10:
    ...
    if (pAVar2 != (ASN1_INTEGER *)0x0) goto LAB_001a68f4;
...
LAB_001a68f4:
      ...
      iVar5 = CONF_parse_list((char *)param_1,0x2c,1,(list_cb *)0x1a6f15,pAVar1);
      if (iVar5 != 0) goto LAB_001a68f4;
  ...
  case 6:
    ...
    if (pAVar3 != (ASN1_OBJECT *)0x0) goto LAB_001a68f4;
...
LAB_001a6a14:
    ERR_put_error(0xd,0xb3,0x41,"asn1_gen.c",iVar5);
  }
  ERR_add_error_data(2,"string=",param_1);
LAB_001a6918:
  ASN1_TYPE_free(a);
  return (ASN1_TYPE *)0x0;
}
