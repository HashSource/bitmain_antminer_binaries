  ...
  do {
    if (uVar9 == 0) {
      ...
      if (str == (ASN1_STRING *)0x0) {
        ...
        line = 0xcb;
        if (str == (ASN1_STRING *)0x0) goto LAB_001c078a;
        bVar4 = true;
        *out = str;
      }
      else {
      ...
      switch(iVar10) {
      case 0x1000:
        goto switchD_001c04d6_caseD_1000;
      case 0x1001:
        pcVar13 = (code *)0x1c028d;
        iVar10 = local_64 + 1;
        goto LAB_001c0634;
      case 0x1002:
        pcVar13 = (code *)0x1c029d;
        local_64 = local_64 * 2;
        iVar10 = local_64 + 1;
        goto LAB_001c0634;
      default:
...
LAB_001c058c:
    ...
    pbVar11 = pbVar12;
    if ((int)(mask << 0x14) < 0) {
      if (uVar5 < 0x10000) goto joined_r0x001c03de;
...
switchD_001c04d6_caseD_1000:
  iVar10 = 1;
  local_64 = len;
  if (len == 0) goto LAB_001c074e;
  if (inform == 0x1001) {
    local_64 = 0;
    uVar9 = len;
    pbVar11 = in;
...
LAB_001c078a:
    ...
    if (len != 0) {
      pbVar11 = in;
      if (inform == 0x1001) goto LAB_001c06aa;
      do {
        if (inform == 0x1002) {
          bVar3 = *in;
          len = len - 2;
