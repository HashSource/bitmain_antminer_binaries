...
int ec_GFp_simple_is_on_curve(EC_GROUP *param_1,EC_POINT *param_2,BN_CTX *param_3)
      ...
      if (*(int *)(param_2 + 0x40) == 0) {
        ...
        if (((iVar1 != 0) && (iVar1 = (*pcVar6)(param_1,a,b,param_3), iVar1 != 0)) &&
          ...
          if (*(int *)(param_1 + 0x9c) == 0) {
            iVar1 = (*pcVar4)(param_1,b,a,param_1 + 0x74,param_3);
            if (iVar1 != 0) {
              iVar1 = BN_mod_add_quick(r,r,b,m);
              goto joined_r0x001c4b84;
            }
          }
          else {
...
joined_r0x001c4b84:
              if (((iVar1 != 0) && (iVar1 = (*pcVar4)(param_1,r,r,pEVar5,param_3), iVar1 != 0)) &&
                 (iVar1 = (*pcVar4)(param_1,b,param_1 + 0x88,pBVar2,param_3), iVar1 != 0)) {
                iVar1 = BN_mod_add_quick(r,r,b,m);
                goto joined_r0x001c4b3a;
              }
            }
          }
        }
        ...
        iVar1 = BN_mod_add_quick(r,r,(BIGNUM *)(param_1 + 0x74),m);
        if ((iVar1 != 0) && (iVar1 = (*pcVar4)(param_1,r,r,pEVar5,param_3), iVar1 != 0)) {
          iVar1 = BN_mod_add_quick(r,r,(BIGNUM *)(param_1 + 0x88),m);
joined_r0x001c4b3a:
