...
/* WARNING: Removing unreachable block (ram,0x000d2820) */
/* WARNING: Removing unreachable block (ram,0x000d282a) */
/* WARNING: Removing unreachable block (ram,0x000d282c) */
/* WARNING: Removing unreachable block (ram,0x000d282e) */
/* WARNING: Removing unreachable block (ram,0x000d2834) */
/* WARNING: Removing unreachable block (ram,0x000d23fe) */
...
LAB_000d255c:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000d2cbe;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000d2cbe;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar5) == 0) goto LAB_000d255c;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000d2cbe;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar6 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000d2cbe;
              op = pBVar11;
