...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (cipher != (EVP_CIPHER *)0x0) {
      if (pEVar5 != (EVP_CIPHER *)0x0) goto LAB_001522f8;
      goto LAB_00152330;
    }
    if (pEVar5 == (EVP_CIPHER *)0x0) goto LAB_001524d4;
LAB_0015237a:
...
LAB_001524d4:
      ...
      if ((cipher == (EVP_CIPHER *)0x0) || (cipher->nid == pEVar5->nid)) goto LAB_0015237a;
LAB_001522f8:
      uVar6 = ctx->flags;
...
LAB_00152330:
    if (impl == (ENGINE *)0x0) {
      ...
      if (impl != (ENGINE *)0x0) goto LAB_00152346;
LAB_00152358:
      ...
      if (-1 < (int)(uVar6 << 0x19)) goto LAB_0015237a;
...
LAB_00152346:
        ...
        iVar4 = 0x9d;
        if (cipher != (EVP_CIPHER *)0x0) goto LAB_00152358;
      }
    }
    ERR_put_error(6,0x7b,0x86,"evp_enc.c",iVar4);
switchD_00152410_default:
    iVar1 = 0;
  }
  return iVar1;
}
