...
LAB_0015c4f6:
  ...
  if (utype == 5) goto LAB_0015c4f6;
LAB_0015c46e:
  if (utype < 6) {
    if (utype == 2) {
LAB_0015c570:
      pAVar3 = c2i_ASN1_INTEGER(&a->integer,local_24,len);
      if (pAVar3 == (ASN1_INTEGER *)0x0) goto LAB_0015c52e;
...
joined_r0x0015c4ce:
      if (pAVar2 == (ASN1_OBJECT *)0x0) goto LAB_0015c52e;
    }
    else {
      if (utype != 1) goto LAB_0015c47c;
      if (len != 1) {
    ...
    if (utype == 10) goto LAB_0015c570;
    if (utype < 0xb) {
      if (utype == 6) {
        pAVar2 = c2i_ASN1_OBJECT(&a->object,local_24,len);
        goto joined_r0x0015c4ce;
      }
    }
    else if ((utype == 0x102) || (utype == 0x10a)) goto LAB_0015c570;
LAB_0015c47c:
    if (utype == 0x1e) {
      if ((len & 1U) == 0) {
LAB_0015c486:
      ...
      if ((utype != 0x1c) || ((len & 3U) == 0)) goto LAB_0015c486;
