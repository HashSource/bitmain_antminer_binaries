...

{
  ...
  if (((iVar1 < 1) || (iVar1 = EVP_PKEY_CTX_ctrl(param_1,6,0x3f8,0x1008,0,&local_1c), iVar1 < 1)) ||
     (iVar1 = EVP_PKEY_CTX_ctrl(param_1,6,0x18,0x1007,0,&local_14), iVar1 == 0)) goto LAB_00197b2e;
  if (local_14 == -1) {
  ...
  if (a == (RSA_PSS_PARAMS *)0x0) goto LAB_00197b2e;
  if (local_14 == 0x14) {
LAB_00197b3c:
    ...
    if (iVar1 != 0x40) {
      alg = X509_ALGOR_new();
      a->hashAlgorithm = alg;
      if (alg == (X509_ALGOR *)0x0) goto LAB_00197b28;
