...

{
  ...
  if ((a->flags << 0x1d < 0) || (n->flags << 0x1d < 0)) {
    ...
    if (pBVar8 == (BIGNUM *)0x0) {
      local_54 = (BIGNUM *)0x0;
joined_r0x0018defc:
      if (ret != (BIGNUM *)0x0) goto LAB_0018de1a;
    }
    else {
      local_54 = ret;
...
LAB_0018dd58:
          ...
          if (iVar12 == 0) goto joined_r0x0018defc;
        }
        if (pBVar3->top == 0) {
LAB_0018e182:
          ...
          do {
            ...
            if (((iVar9 == 0) || (iVar9 = BN_mul(pBVar4,pBVar5,pBVar7,ctx), iVar9 == 0)) ||
               (iVar9 = BN_add(pBVar4,pBVar4,pBVar10), iVar9 == 0)) goto joined_r0x0018defc;
            pBVar8 = pBVar2;
            pBVar6 = pBVar10;
            pBVar10 = pBVar7;
          } while (pBVar3->top != 0);
          if (iVar12 == -1) goto LAB_0018e182;
        }
        if (((pBVar2->top == 1) && (*pBVar2->d == 1)) && (pBVar2->neg == 0)) {
          ...
          if (pBVar6 != (BIGNUM *)0x0) goto LAB_0018de1c;
        }
        else {
...
LAB_0018dffe:
              ...
              if (iVar9 == iVar11 + 1) {
                ...
                if (iVar9 == 0) goto LAB_0018debc;
                iVar9 = BN_ucmp(pBVar4,pBVar8);
                if (iVar9 < 0) goto LAB_0018dffe;
            ...
            if (iVar9 == 1) {
              ...
              if (uVar13 != 1) {
                if (uVar13 == 2) {
                  if (pBVar5->neg != 0) goto LAB_0018e03a;
...
LAB_0018e03a:
                  ...
                  if (pBVar6 == (BIGNUM *)0x0) goto LAB_0018debc;
                  iVar9 = BN_mul_word(pBVar4,*pBVar5->d);
                }
                if (iVar9 != 0) goto LAB_0018dfc2;
                goto LAB_0018debc;
              }
              if (pBVar5->neg != 0) goto LAB_0018e03a;
        ...
        while( true ) {
          ...
          while (iVar9 = BN_is_bit_set(pBVar2,iVar12), iVar9 == 0) {
            ...
            if ((((0 < pBVar7->top) && ((int)(*pBVar7->d << 0x1f) < 0)) &&
               ...
               (iVar9 = BN_rshift1(pBVar7,pBVar7), iVar9 == 0)) goto LAB_0018debc;
          }
...
LAB_0018debc:
    if (ret == (BIGNUM *)0x0) goto LAB_0018dec2;
LAB_0018de1a:
    local_54 = (BIGNUM *)0x0;
  }
LAB_0018de1c:
