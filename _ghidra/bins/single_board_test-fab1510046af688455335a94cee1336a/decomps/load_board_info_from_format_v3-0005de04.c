...

{
  ...
  errmsg = (char *)0x0;
  if (data[1] == 'H') {
    _Var6 = data_dec((uint32_t *)(data + 2),0x48,'\x01','\x01');
    if (_Var6) {
      ...
      uVar7 = CRC5_long((uint8_t *)data,((byte)data[1] - 1) * 8);
      if (uVar7 == zhiju_eeprom_data.zhiju_information.zhiju_information_crc5) {
        ...
        uVar3 = zhiju_eeprom_data.zhiju_information.chip_ft_program_version._4_4_;
        uVar2 = zhiju_eeprom_data.zhiju_information.chip_ft_program_version._0_4_;
        ...
        if ((zhiju_eeprom_data.zhiju_information.chip_bin == '\0') ||
           (bVar1 = zhiju_eeprom_data.zhiju_information.chip_bin,
           9 < zhiju_eeprom_data.zhiju_information.chip_bin)) {
          if ((zhiju_eeprom_data.zhiju_information.chip_bin == '\0') ||
             (0x37 < zhiju_eeprom_data.zhiju_information.chip_bin)) {
            errmsg = "CHIP BIN";
            builtin_strncpy(qr_code.chip_bin,"BIN",4);
            zhiju_eeprom_data.zhiju_information.chip_ft_program_version[0] = (uint8_t)uVar2;
            zhiju_eeprom_data.zhiju_information.chip_ft_program_version[1] = SUB41(uVar2,1);
            zhiju_eeprom_data.zhiju_information.chip_ft_program_version[2] = SUB41(uVar2,2);
            zhiju_eeprom_data.zhiju_information.chip_ft_program_version[3] = SUB41(uVar2,3);
            ...
            zhiju_eeprom_data.zhiju_information.chip_ft_program_version[4] = (uint8_t)uVar3;
            zhiju_eeprom_data.zhiju_information.chip_ft_program_version[5] = SUB41(uVar3,1);
            zhiju_eeprom_data.zhiju_information.chip_ft_program_version[6] = SUB41(uVar3,2);
            zhiju_eeprom_data.zhiju_information.chip_ft_program_version[7] = SUB41(uVar3,3);
          ...
          qr_code.chip_bin[4] = zhiju_eeprom_data.zhiju_information.chip_bin % 10 + 0x30;
          bVar1 = zhiju_eeprom_data.zhiju_information.chip_bin / 10;
        }
        qr_code.chip_bin[3] = bVar1 + 0x30;
        qr_code.chip_bin[0] = 'B';
        qr_code.chip_bin[1] = 'I';
        qr_code.chip_bin[2] = 'N';
        uVar4 = qr_code.temp_sensor_type._5_3_;
        uVar5 = qr_code.temp_sensor_type._6_2_;
        if ((Local_Config_Information->Hash_Board).Sensor_Info.Read_Temperature_From_Pic == false) {
          if ((Local_Config_Information->Hash_Board).Sensor_Info.Read_Temperature_From_Asic != false
            ...
            case 10:
              ...
              qr_code.temp_sensor_type._4_4_ = CONCAT22(uVar5,qr_code.temp_sensor_type._4_2_);
              break;
            case 0xb:
            ...
            case 0xe:
              ...
              qr_code.temp_sensor_type._4_4_ = (uint)(uint3)uVar4 << 8;
              break;
            case 0xf:
        ...
        snprintf(tmp1,0x800,"pcb_version_v1: [0x%x] = %x",0x34,
                 (uint)zhiju_eeprom_data.zhiju_information.pcb_version_v1);
        ...
        snprintf(tmp1,0x800,"pcb_version_v2: [0x%x] = %x",0x35,
                 (uint)zhiju_eeprom_data.zhiju_information.pcb_version_v2);
        log_to_file(tmp1,time_stamp);
        print_time_stamp(time_stamp,0x30);
        printf("%s ",time_stamp);
        ...
        snprintf(tmp1,0x800,"bom_version_v1: [0x%x] = %x",0x36,
                 (uint)zhiju_eeprom_data.zhiju_information.bom_version_v1);
        log_to_file(tmp1,time_stamp);
        print_time_stamp(time_stamp,0x30);
        printf("%s ",time_stamp);
        ...
        snprintf(tmp1,0x800,"bom_version_v2: [0x%x] = %x",0x37,
                 (uint)zhiju_eeprom_data.zhiju_information.bom_version_v2);
        log_to_file(tmp1,time_stamp);
        ...
        builtin_strncpy(qr_code.factory_job,"FXDZ20210308001-Z(YZ",0x14);
        qr_code.factory_job[0x14] = ')';
        qr_code.factory_job[0x15] = '\0';
      }
      else {
        errmsg = "CRC5 ERROR";
      }
    ...
    printf("%s: enc 0x%x len 0x%x\n","load_board_info_from_format_v3",(uint)(byte)*data,
           (uint)(byte)data[1]);
    snprintf(tmp1,0x800,"enc 0x%x len 0x%x",(uint)(byte)*data,(uint)(byte)data[1]);
    log_to_file(tmp1,time_stamp);
    errmsg = "LEN ERROR";
  }
  return errmsg;
