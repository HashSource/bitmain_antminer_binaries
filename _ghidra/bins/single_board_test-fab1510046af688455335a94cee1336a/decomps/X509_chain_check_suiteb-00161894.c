...
LAB_001618f0:
        uVar5 = 0;
LAB_001618f4:
        if (pkey != (EVP_PKEY *)0x0) goto LAB_001618fa;
      }
      else {
...
LAB_001619da:
                ...
                if (iVar4 != 0x31a && iVar4 != -1) goto LAB_001619da;
                if (-1 < (int)(local_2c << 0xf)) goto LAB_0016195e;
              }
            }
            iVar4 = X509_get_signature_nid(param_2);
            if ((pkey->type == 0x198) &&
               (pEVar2 = EC_KEY_get0_group((EC_KEY *)(pkey->pkey).rsa), pEVar2 != (EC_GROUP *)0x0))
            {
              ...
              if (iVar3 == 0x2cb) {
                if (iVar4 == 0x31b || iVar4 == -1) {
                  iVar4 = 0;
                  if (-1 < (int)(local_2c << 0xe)) goto LAB_0016195e;
                  local_2c = local_2c & 0xfffeffff;
                }
                else {
LAB_00161a6a:
                ...
                if ((iVar4 != 0x31a) && (iVar4 != -1)) goto LAB_00161a6a;
        ...
        if ((param_4 & 0x10000) != 0) goto LAB_00161966;
        uVar5 = 0;
LAB_0016195e:
        iVar4 = 0x3c;
LAB_001618fa:
