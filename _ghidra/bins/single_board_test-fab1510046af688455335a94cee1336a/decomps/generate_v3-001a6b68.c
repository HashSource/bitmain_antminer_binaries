...

{
  ...
  local_2c = 0;
  local_1ec = (uchar *)0x0;
  puVar2 = (uchar *)CONF_parse_list(param_1,0x2c,1,(list_cb *)0x1a723d,local_1d0);
  if (puVar2 != (uchar *)0x0) {
    *param_4 = 0xc2;
...
LAB_001a6df2:
      ...
      if (st != (_STACK *)0x0) goto LAB_001a6cd0;
    }
    else {
      section = local_1c0;
      if (local_1c0 != (_STACK *)0x0) {
        section = &X509V3_get_section(param_2,(char *)local_1c0)->stack;
        if (section == (_STACK *)0x0) goto LAB_001a6e2c;
        param_3 = param_3 + 1;
        iVar9 = 0;
        do {
          iVar6 = sk_num(section);
          if (iVar6 <= iVar9) goto LAB_001a6c8c;
...
LAB_001a6c8c:
      ...
      if (pAVar3 == (ASN1_TYPE *)0x0) goto LAB_001a6df2;
      pAVar7 = ASN1_STRING_type_new(local_1d0[2]);
      (pAVar3->value).asn1_string = pAVar7;
      if (pAVar7 == (ASN1_STRING *)0x0) goto LAB_001a6df2;
