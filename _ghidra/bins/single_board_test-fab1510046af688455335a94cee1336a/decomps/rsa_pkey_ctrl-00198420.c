...
LAB_001987c0:
      ...
      if (puVar3 == (undefined4 *)0x0) goto LAB_001987c0;
...
LAB_001985b8:
          if ((undefined4 *)*puVar3 == (undefined4 *)0x0) {
            p2_00 = EVP_sha1();
            if (p2_00 == (EVP_MD *)0x0) goto LAB_0019889a;
          }
          else {
        ...
        if (iVar2 == 0x38f) {
          if (pXVar4 == (X509_ALGOR *)0x0) {
            ...
            if (p2 != (EVP_MD *)0x0) goto LAB_001985b8;
...
LAB_0019860a:
    ...
    pXVar4 = local_30;
    if (local_38 == 1) goto LAB_00198472;
    if (local_38 != 4) {
      return 0;
    }
...
LAB_0019875e:
      ...
      if (iVar6 == 0) goto LAB_001988f4;
      if (iVar2 == 0) {
LAB_0019894e:
        pAVar8 = ASN1_item_pack(puVar3,(ASN1_ITEM *)RSA_OAEP_PARAMS_it,&local_34);
        if (pAVar8 == (ASN1_STRING *)0x0) goto LAB_001988f4;
        ...
        puVar3[2] = pXVar4;
        if ((pXVar4 == (X509_ALGOR *)0x0) || (str == (ASN1_OCTET_STRING *)0x0)) goto LAB_001988f4;
