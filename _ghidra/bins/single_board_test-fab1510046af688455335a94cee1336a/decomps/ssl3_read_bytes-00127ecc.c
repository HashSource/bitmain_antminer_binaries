...

{
  ...
  if (param_2 == 0 || param_2 == 0x17) {
    ...
    if (uVar15 != 0) goto LAB_0012876a;
    if (param_2 != 0x16) goto LAB_00127f84;
  }
    ...
    do {
      ...
      if (((pSVar13 != (SSL_SESSION *)0x0) && (param_1->enc_read_ctx != (EVP_CIPHER_CTX *)0x0)) &&
        ...
        if ((uVar9 < uVar15) ||
          ...
          if ((psVar16->rrec).length <= iVar17 + 0x4400 + uVar15) goto LAB_001282ee;
LAB_001282d6:
...
LAB_00128384:
    ...
    if (uVar12 < uVar9) goto LAB_001283c0;
  }
  else {
    if (iVar17 == 0x15) {
  ...
  if (param_1->server == 0) {
    ...
    if (((3 < psVar23->handshake_fragment_len) && (psVar23->handshake_fragment[0] == '\0')) &&
      ...
      if ((*(uint *)psVar23->handshake_fragment & 0xffffff00) == 0) {
        ...
        if (iVar17 == 3) {
          psVar16 = param_1->s3;
          if ((psVar16->flags << 0x1f < 0) || (psVar16->renegotiate != 0)) goto LAB_00127f96;
...
LAB_00128484:
  ...
  if (1 < psVar23->alert_fragment_len) {
    ...
    if (uVar22 == '\x01') {
      ...
      if (uVar15 != 100) goto LAB_00127f96;
...
LAB_001284f8:
    ...
    if (iVar17 != 0x17) goto LAB_001284f8;
