...
LAB_0018b85c:
    ...
    if (m_ctx == (BN_MONT_CTX *)0x0) {
      ...
      if (local_38 == (BN_MONT_CTX *)0x0) goto LAB_0018b85c;
      iVar4 = BN_MONT_CTX_set(local_38,m,ctx);
      if (iVar4 != 0) goto LAB_0018b6fa;
      iVar1 = 0;
    }
    else {
      local_38 = m_ctx;
            ...
            if (w != uVar3) {
              if (bVar5) {
                ...
                if ((iVar4 == 0) ||
                   ...
                   rem = pBVar2, iVar4 == 0)) goto LAB_0018b890;
              }
            }
          }
          bVar6 = iVar1 != 0;
...
LAB_0018b8d2:
          ...
          a = w_00;
          if (bVar5) goto LAB_0018b8b2;
          iVar1 = BN_mul_word(a_00,w_00);
          if (iVar1 != 0) {
            iVar1 = BN_div((BIGNUM *)0x0,rem,a_00,m,ctx);
            a_00 = rem;
            goto joined_r0x0018b88e;
          }
LAB_0018b890:
          iVar1 = 0;
        }
      }
      if (m_ctx != (BN_MONT_CTX *)0x0) goto LAB_0018b85e;
    }
