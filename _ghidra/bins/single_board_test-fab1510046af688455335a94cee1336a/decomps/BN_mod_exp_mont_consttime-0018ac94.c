...

{
  ...
  if (in_mont == (BN_MONT_CTX *)0x0) {
    ...
    local_68 = pBVar7;
    if (pBVar7 == (BN_MONT_CTX *)0x0) goto LAB_0018adda;
    iVar17 = BN_MONT_CTX_set(pBVar7,m,ctx);
    if (iVar17 != 0) goto LAB_0018acd6;
...
LAB_0018ad22:
      ...
      if ((int)puVar23[(int)(puVar20 + -1)] < 0) {
        ...
        *puVar24 = ctx;
        ...
        if (pBVar7 == (BN_MONT_CTX *)0x0) goto LAB_0018adba;
      }
...
LAB_0018b06c:
          ...
          *puVar24 = ctx;
          ...
          if (-1 < (int)extraout_r1) goto LAB_0018b06c;
          puVar16 = (undefined1 *)0x0;
        }
          ...
          if (-1 < (int)puVar22) {
            ...
            do {
              ...
              if ((local_3c.dmax < (int)local_60) &&
                 ...
                 pBVar7 == (BN_MONT_CTX *)0x0)) goto LAB_0018adba;
              pBVar21 = local_70;
              if (local_6c != 0) {
                iVar17 = 0;
                do {
...
LAB_0018adba:
    if (in_mont == (BN_MONT_CTX *)0x0) goto LAB_0018ae56;
  }
