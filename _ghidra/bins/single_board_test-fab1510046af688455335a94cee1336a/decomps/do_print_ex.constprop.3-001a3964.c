...
LAB_001a3988:
    iVar4 = do_dump(param_2,0x1a329d,param_1,param_3);
    if (iVar4 < 0) {
      return -1;
    }
    return iVar4 + uVar6;
...
LAB_001a3a4c:
    ...
    if ((0x1d < iVar4 - 1U) || (uVar5 = (uint)(char)tag2nbyte[iVar4], uVar5 == 0xffffffff)) {
      if ((int)(param_2 << 0x17) < 0) goto LAB_001a3988;
      goto LAB_001a39a2;
    }
    if (-1 < (int)(param_2 << 0x1b)) goto LAB_001a39a8;
    if (uVar5 != 0) goto LAB_001a3a4c;
  }
  uVar5 = 1;
LAB_001a39a8:
  ...
  if (-1 < iVar4) {
    ...
    if (local_28[0] == '\0') {
      ...
      sVar2 = fwrite(&DAT_002340f4,1,1,param_1);
      if (sVar2 != 1) {
        return -1;
      }
    }
