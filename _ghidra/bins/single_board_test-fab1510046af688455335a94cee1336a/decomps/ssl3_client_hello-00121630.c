...

{
  ...
  if (param_1->state != 0x1110) goto LAB_00121808;
  ...
  if (((((pSVar10 == (SSL_SESSION *)0x0) || (pSVar10->ssl_version != param_1->version)) ||
     ...
     (iVar1 = ssl_get_new_session(param_1,0), iVar1 == 0)) goto LAB_001218a0;
  ...
  if (*(int *)(psVar3 + 0x38) << 0x1c < 0) {
    ...
    do {
      iVar6 = iVar1 + 1;
      if (param_1->s3->client_random[iVar1] != '\0') goto LAB_001216a0;
      iVar1 = iVar6;
    } while (iVar6 != 0x20);
  }
  iVar1 = ssl_fill_hello_random(param_1,0,param_1->s3->client_random,0x20);
  if (iVar1 < 1) goto LAB_001218a0;
