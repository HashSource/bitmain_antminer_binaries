...

{
  ...
  if (f_in == (FILE *)0x0) {
    ...
    __assert_fail("f_in != ((void *)0)","../zhiju/log_file/fileCompress.c",0x52,"decompress_file");
  }
  if (f_out == (FILE *)0x0) {
                    /* WARNING: Subroutine does not return */
    __assert_fail("f_out != ((void *)0)","../zhiju/log_file/fileCompress.c",0x52,"decompress_file");
  }
  ret = 0;
  buf = malloc(0x4000);
  if (buf == (void *)0x0) {
