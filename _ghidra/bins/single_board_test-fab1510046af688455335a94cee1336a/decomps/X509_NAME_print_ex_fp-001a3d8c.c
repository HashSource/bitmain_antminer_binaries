...
LAB_001a3df0:
    ...
    if (uVar10 == 0x20000) {
      ...
      local_88 = 3;
      local_80 = 3;
      local_84 = &DAT_002288f4;
      local_8c = ", ";
    }
    else if (uVar10 < 0x20001) {
      if (uVar10 != 0x10000) goto LAB_001a3df0;
      local_9c = 1;
      local_84 = &DAT_002288f8;
      local_8c = ",";
      local_88 = 1;
      local_80 = 1;
      local_7c = 1;
      ...
      if (uVar10 != 0x40000) goto LAB_001a3df0;
      local_9c = 1;
      local_7c = 1;
      local_88 = 3;
      local_80 = 3;
    ...
    if (0 < iVar1) {
      ...
      local_b4 = -1;
      local_b8 = 0;
      if ((flags & 0x100000) == 0) goto LAB_001a3fb4;
      do {
          ...
          if (local_b4 != -1) {
            if (local_b4 == iVar8) {
              if (fp != (FILE *)0x0) {
                ...
                if (sVar3 != local_88) goto LAB_001a3df0;
                local_b4 = ne->set;
              }
              ...
              if (fp != (FILE *)0x0) {
                ...
                if (sVar3 != local_9c) goto LAB_001a3df0;
                uVar11 = 0;
                if (uVar10 != 0) {
                  do {
                    sVar3 = fwrite(" ",1,1,fp);
                    if (sVar3 != 1) goto LAB_001a3df0;
                    uVar11 = uVar11 + 1;
                  } while (uVar11 != uVar10);
                }
                iVar8 = ne->set;
