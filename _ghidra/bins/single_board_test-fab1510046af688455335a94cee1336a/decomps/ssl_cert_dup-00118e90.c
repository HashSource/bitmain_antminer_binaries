...

{
  ...
  *__s = (int)__s + (iVar9 - (int)(param_1 + 0xf) & 0xfffffffcU) + 0x3c;
  ...
  pDVar1 = (DH *)param_1[9];
  __s[8] = param_1[8];
  if (pDVar1 == (DH *)0x0) goto LAB_00118f2a;
...
LAB_00118f88:
  ...
  if (iVar6 != 0) {
    ...
    __s[0x13] = (int)pvVar4;
    if (pvVar4 == (void *)0x0) goto LAB_00119768;
