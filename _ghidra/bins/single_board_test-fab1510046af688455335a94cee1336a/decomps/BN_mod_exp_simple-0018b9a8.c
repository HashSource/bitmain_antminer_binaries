      ...
      if (1 < iVar9) {
        ...
        do {
          ...
          if ((pBVar2 == (BIGNUM *)0x0) ||
             (iVar4 = BN_mod_mul(pBVar2,*ppBVar5,r_00,m,ctx), iVar4 == 0)) goto LAB_0018b9f6;
          ppBVar5 = ppBVar5 + 1;
        } while (iVar3 != iVar9);
      }
    }
    ...
    if (iVar3 != 0) {
      ...
      while( true ) {
        while (iVar3 = BN_is_bit_set(p,local_b8), iVar3 == 0) {
          if ((!bVar1) && (iVar3 = BN_mod_mul(r,r,r,m,ctx), iVar3 == 0)) goto LAB_0018b9f6;
          if (local_b8 == 0) goto LAB_0018bb96;
          local_b8 = local_b8 + -1;
        }
        if (local_b4 == 1) {
          uVar6 = 0;
