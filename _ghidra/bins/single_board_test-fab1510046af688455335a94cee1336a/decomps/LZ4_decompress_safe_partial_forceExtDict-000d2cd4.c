...
/* WARNING: Removing unreachable block (ram,0x000d31f2) */
/* WARNING: Removing unreachable block (ram,0x000d31fc) */
/* WARNING: Removing unreachable block (ram,0x000d31fe) */
/* WARNING: Removing unreachable block (ram,0x000d3200) */
/* WARNING: Removing unreachable block (ram,0x000d3206) */
/* WARNING: Removing unreachable block (ram,0x000d2dd6) */
/* WARNING: Removing unreachable block (ram,0x000d2dde) */
/* WARNING: Removing unreachable block (ram,0x000d2dee) */
/* WARNING: Removing unreachable block (ram,0x000d2de6) */
...
LAB_000d2f2e:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000d3690;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000d3690;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar5) == 0) goto LAB_000d2f2e;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000d3690;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar6 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000d3690;
              op = pBVar11;
