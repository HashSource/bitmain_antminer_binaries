...
LAB_00162cea:
      ...
      while ((iVar4 <= iVar21 &&
        ...
        if (pXVar14 == (X509 *)0x0) goto LAB_00162d5e;
        iVar18 = 0;
        do {
          iVar6 = sk_num(p_Var3);
          if (iVar6 <= iVar18) {
...
LAB_00162d6a:
      ...
      if ((int)(pXVar5->ex_flags << 0x12) < 0) {
        ...
        if (iVar8 == 1) {
          ...
          if (pXVar14 == (X509 *)0x0) goto LAB_00162de4;
          bVar1 = true;
        }
        else {
...
LAB_00162e58:
      ...
      for (iVar18 = ctx->last_untrusted; iVar7 = sk_num(&ctx->chain->stack), iVar18 < iVar7;
        ...
        if (iVar7 == 1) goto LAB_00162ee8;
        if (iVar7 == 2) {
          ctx->error_depth = iVar18;
          ctx->current_cert = pXVar9;
          ctx->error = 0x1c;
          iVar7 = (*p_Var15)(0,ctx);
          if (iVar7 == 0) goto LAB_00162de4;
        }
      }
      pXVar17 = ctx->param;
...
LAB_00162ee8:
      ...
      if (ctx->last_untrusted < 1) goto LAB_00163006;
      iVar18 = 0;
      iVar21 = -1;
      iVar6 = 0;
      iVar4 = 0;
    ...
    if (p_Var3 != (_STACK *)0x0) goto LAB_00162cea;
