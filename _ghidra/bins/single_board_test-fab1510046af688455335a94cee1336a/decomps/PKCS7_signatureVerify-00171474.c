...
LAB_00171526:
        ...
        if (iVar6 == 0) goto LAB_00171516;
        val = &si->auth_attr->stack;
        if ((val == (_STACK *)0x0) || (iVar6 = sk_num(val), iVar6 == 0)) goto LAB_0017153e;
        local_80 = (uchar *)0x0;
        iVar6 = EVP_DigestFinal_ex(&EStack_78,auStack_60,&local_7c);
        if (iVar6 == 0) goto LAB_00171516;
        b = OBJ_nid2obj(0x33);
        iVar6 = 0;
        if (b == (ASN1_OBJECT *)0x0) goto LAB_001715d4;
        goto LAB_001715c2;
      }
      pEVar2 = EVP_MD_CTX_md(local_84);
      iVar6 = EVP_MD_pkey_type(pEVar2);
      if (iVar6 == iVar1) goto LAB_00171526;
      bio = BIO_next(bp);
    } while (bio != (BIO *)0x0);
  }
  iVar6 = 0x41a;
...
LAB_001715c2:
    iVar4 = sk_num(val);
    if (iVar4 <= iVar6) goto LAB_001715d4;
  }
