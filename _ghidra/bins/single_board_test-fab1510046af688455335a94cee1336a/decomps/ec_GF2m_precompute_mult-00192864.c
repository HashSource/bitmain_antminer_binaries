...

{
  ...
  EC_EX_DATA_free_data(param_1 + 0x44,0x1477c9,0x1479c5,0x147965);
  ...
  *ptr = param_1;
  ...
  if (pEVar1 == (EC_POINT *)0x0) {
    ...
    if (param_2 == (BN_CTX *)0x0) goto LAB_00148488;
    BN_CTX_end(param_2);
    points = (EC_POINT *)0x0;
    pEVar7 = (EC_POINT *)0x0;
    pEVar4 = (EC_POINT *)0x0;
              ...
              if (iVar2 != 0) {
                ...
                if (iVar2 != 0) {
                  *ptr = param_1;
                  ...
                  ptr[3] = uStack_38;
                  ptr[5] = num;
                  iVar2 = EC_EX_DATA_set_data(param_1 + 0x44,ptr,0x1477c9,0x1479c5,0x147965);
                  if (iVar2 == 0) {
                    points = (EC_POINT *)0x0;
                    uVar9 = 0;
                  }
...
LAB_00148386:
      ...
      if (ptr == (undefined4 *)0x0) goto LAB_001483b2;
    }
  }
