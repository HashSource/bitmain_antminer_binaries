...

{
  ...
  if (iVar2 == 2) {
    ...
    if (*(int *)(iVar2 + 0x10) == 0) {
      ERR_put_error(0x2e,0x87,0x82,"cms_env.c",0x2ed);
      return 0;
    }
    iVar1 = OBJ_obj2nid((ASN1_OBJECT *)**(undefined4 **)(iVar2 + 8));
    if (iVar1 - 0x314U < 3) {
      iVar1 = *(int *)(&CSWTCH_9 + (iVar1 - 0x314U) * 4);
    }
    else {
      iVar1 = 0;
    }
    if (*(int *)(iVar2 + 0x14) != iVar1) {
      ERR_put_error(0x2e,0x87,0x76,"cms_env.c",0x2f4);
      return 0;
    }
    if (**(int **)(iVar2 + 0xc) < 0x10) {
      uVar3 = 0;
      ERR_put_error(0x2e,0x87,0x75,"cms_env.c",0x2fc);
    }
    else {
      iVar1 = AES_set_decrypt_key(*(uchar **)(iVar2 + 0x10),iVar1 << 3,&AStack_10c);
      if (iVar1 == 0) {
        puVar4 = (uchar *)CRYPTO_malloc(**(int **)(iVar2 + 0xc) + -8,"cms_env.c",0x306);
        if (puVar4 == (uchar *)0x0) {
          ERR_put_error(0x2e,0x87,0x41,"cms_env.c",0x309);
          uVar3 = 0;
        }
        else {
          ...
          if (iVar2 < 1) {
            ERR_put_error(0x2e,0x87,0x9d,"cms_env.c",0x312);
            CRYPTO_free(puVar4);
          }
          else {
        ...
        ERR_put_error(0x2e,0x87,0x73,"cms_env.c",0x302);
        uVar3 = 0;
      }
    }
  ...
  if (iVar2 != 0) {
    ERR_put_error(0x2e,0x86,0x9b,"cms_env.c",0x333);
    return 0;
  }
  iVar2 = *(int *)(ri + 4);
  iVar5 = *(int *)(*(int *)(cms + 4) + 0xc);
  if (*(EVP_PKEY **)(iVar2 + 0x14) == (EVP_PKEY *)0x0) {
    ERR_put_error(0x2e,0x8c,0x85,"cms_env.c",0x1ad);
    return 0;
  }
  ...
  *(EVP_PKEY_CTX **)(iVar2 + 0x18) = ctx;
  ...
  if ((0 < iVar1) && (iVar1 = cms_env_asn1_ctrl(ri,1), iVar1 != 0)) {
    ...
    if (iVar1 < 1) {
      ERR_put_error(0x2e,0x8c,0x6e,"cms_env.c",0x1bd);
      iVar1 = 0;
      iVar5 = 0;
      puVar4 = (uchar *)0x0;
      goto LAB_001739b2;
    ...
    if (0 < iVar1) {
      puVar4 = (uchar *)CRYPTO_malloc(local_110,"cms_env.c",0x1c6);
      if (puVar4 == (uchar *)0x0) {
        iVar1 = 0;
        ERR_put_error(0x2e,0x8c,0x41,"cms_env.c",0x1c9);
        iVar5 = iVar1;
      }
      else {
        ...
        ;
        if (iVar1 < 1) {
          ERR_put_error(0x2e,0x8c,0x68,"cms_env.c",0x1d0);
          iVar1 = 1;
          iVar5 = 0;
        }
        else {
