...

{
  ...
  if (thr_id < 0) {
    ...
    dVar13 = (double)__floatundidf((undefined4)hashes_done_local,hashes_done_local._4_4_);
    ...
    dVar13 = (double)__floatundidf(uVar8,uVar9);
  ...
  if (bVar1) {
    ...
    while( true ) {
      ...
      if (0.0 <= g_local_mhashes_dones[i]) {
        dVar12 = (double)__floatundidf((undefined4)local_mhashes_done_avg,
    ...
    dVar12 = (double)__floatundidf((undefined4)local_mhashes_done,local_mhashes_done._4_4_);
  ...
  dVar12 = (double)__floatundidf((undefined4)hashes_done_local,hashes_done_local._4_4_);
  g_local_mhashes_dones[g_local_mhashes_index] = dVar11 + dVar12;
