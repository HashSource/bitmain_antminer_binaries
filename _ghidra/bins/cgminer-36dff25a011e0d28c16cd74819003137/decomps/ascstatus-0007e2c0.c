  ...
  if (((0 < numasc) && (-1 < asc_local)) && (asc_local < numasc)) {
    ...
    if (-1 < dev) {
      ...
      if (uVar2 + uVar1 == 0 &&
        ...
        uVar2 = cgpu->hw_errors;
        uVar1 = (uint)cgpu->diff1;
        dVar4 = (double)__aeabi_l2d(uVar2 + uVar1,
                                    ((int)uVar2 >> 0x1f) + *(int *)((int)&cgpu->diff1 + 4) +
                                    (uint)CARRY4(uVar2,uVar1));
        hwp = (double)(longlong)iVar3 / dVar4;
      }
      ...
      if ((int)cgpu->diff1 == 0 && *(int *)((int)&cgpu->diff1 + 4) == 0) {
        ...
        dVar4 = (double)__aeabi_l2d((int)cgpu->diff1,*(undefined4 *)((int)&cgpu->diff1 + 4));
        rejp = dVar5 / dVar4;
      }
