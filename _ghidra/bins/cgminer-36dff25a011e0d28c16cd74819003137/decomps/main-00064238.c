...

{
  ...
  if ((opt_benchmark != false) || (opt_benchfile != (char *)0x0)) {
    ppVar9 = add_pool();
    pcVar5 = (char *)_cgmalloc(0xff,"cgminer.c","main",0x2d64);
    ...
    if (pFVar10 == (FILE *)0x0) {
      ...
      if ((int)pcVar5 < 1) {
        ...
        if (pcVar5 == (char *)0x0) {
          ...
          pcVar23 = "main";
          _cg_memcpy(g_miner_compiletime,tmp,(int)pcVar5 - (int)tmp,"cgminer.c","main",0x2d9f);
          strcpy(tmp,pcVar5 + 1);
          pcVar5 = strchr(tmp,10);
          if (pcVar5 == (char *)0x0) {
            ...
            pcVar23 = "main";
            _cg_memcpy(g_miner_type,tmp,(int)pcVar5 - (int)tmp,"cgminer.c","main",0x2da8);
          }
        }
  ...
  for (i = 0; i < total_pools; i = i + 1) {
    ...
    if (ppVar9->rpc_userpass == (char *)0x0) {
      ...
      size = sVar6 + sVar11 + 2;
      pcVar23 = (char *)_cgmalloc(size,"cgminer.c","main",0x2eb1);
  ...
  for (i = 0; i < mining_threads; i = i + 1) {
    ...
    ptVar13 = (thr_info *)_cgcalloc(1,0x40,"cgminer.c","main",0x2ec6);
    *pptVar12 = ptVar13;
  }
  k = 0;
  for (i = 0; i < total_devices; i = i + 1) {
    pcVar20 = devices[i];
    pptVar12 = (thr_info **)_cgmalloc((pcVar20->threads + 1) * 4,"cgminer.c","main",0x2ecf);
    ...
    for (j = 0; j < pcVar20->threads; j = j + 1) {
      ...
      if (_Var2) {
        iVar4 = thr_info_create(ptVar13,(pthread_attr_t *)0x0,miner_thread,ptVar13);
        if (iVar4 != 0) {
        ...
        if (pcVar20->deven != DEV_DISABLED) {
          ...
          _cgsem_post(&ptVar13->sem,"cgminer.c","main",0x2eeb);
        }
      }
      k = k + 1;
    }
  ...
  ptVar13 = control_thr;
  watchpool_thr_id = 2;
  iVar4 = thr_info_create(control_thr + 2,(pthread_attr_t *)0x0,watchpool_thread,(void *)0x0);
  uVar21 = tmp42._28_4_;
  if (iVar4 != 0) {
  ...
  ptVar13 = control_thr;
  watchdog_thr_id = 3;
  iVar4 = thr_info_create(control_thr + 3,(pthread_attr_t *)0x0,watchdog_thread,(void *)0x0);
  uVar21 = tmp42._28_4_;
  if (iVar4 != 0) {
  ...
  api_thr_id = 5;
  iVar4 = thr_info_create(control_thr + 5,(pthread_attr_t *)0x0,api_thread,control_thr + 5);
  if (iVar4 != 0) {
  ...
  do {
    while( true ) {
      ...
      if (ppVar9->has_stratum != false) break;
      if (opt_benchfile == (char *)0x0) {
