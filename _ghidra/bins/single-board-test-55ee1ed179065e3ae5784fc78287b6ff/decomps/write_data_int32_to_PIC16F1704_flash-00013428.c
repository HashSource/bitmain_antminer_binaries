...
undefined4 write_data_int32_to_PIC16F1704_flash(undefined1 param_1,undefined1 param_2)

{
  ...
  if ((local_1c[0] == 5) && (local_1c[1] == 1)) {
    ...
    printf("\n--- %s failed! read_back_data[0] = 0x%02x, read_back_data[1] = 0x%02x\n\n",
           "write_data_int32_to_PIC16F1704_flash",(uint)local_1c[0],(uint)local_1c[1]);
    uVar2 = 0;
  }
  return uVar2;
}
