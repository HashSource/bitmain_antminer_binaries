...
LAB_0001003a:
  ...
  local_1e = bVar2;
  local_1d = bVar1;
  if (-1 < (int)((uint)(fVar6 < 1e-06) << 0x1f)) goto LAB_00010148;
  goto LAB_00010170;
LAB_00010148:
...
LAB_00010170:
    ...
    do {
      bVar2 = local_21 - 1;
      if (local_21 < 3) goto LAB_0001024e;
...
LAB_0001036e:
      if (((local_20 <= local_1f) && (local_20 < 8)) ||
         (printf("--- %s: need recal 2","get_pllparam_divider"), local_18 <= 1400.0)) {
        local_21 = bVar2;
        if ((uint)local_22 == (uint)local_20 * (uint)local_1f) {
LAB_0001042e:
          if (param_4 != (float *)0x0) {
            *param_4 = ((25.0 / (float)local_1e) * (float)local_1d) /
