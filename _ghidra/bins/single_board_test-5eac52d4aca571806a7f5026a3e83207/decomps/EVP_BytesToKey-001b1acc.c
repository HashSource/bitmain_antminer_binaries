...
LAB_001b1b1c:
      do {
        ...
        if (((iVar4 == 0) ||
           ...
           (iVar4 = EVP_DigestFinal_ex(ctx,local_68,&local_6c), iVar4 == 0)) goto LAB_001b1b8c;
        sVar8 = sVar2;
        if ((uint)count < 2) {
          sVar1 = sVar2;
          sVar6 = local_6c;
          if (sVar2 != 0) goto LAB_001b1bbc;
joined_r0x001b1c54:
          sVar2 = sVar1;
          local_6c = sVar6;
          if ((iVar3 != 0) && (sVar2 != sVar6)) goto LAB_001b1bee;
        }
        else {
          iVar4 = 1;
          do {
            ...
            if (((iVar5 == 0) || (iVar5 = EVP_DigestUpdate(ctx,local_68,local_6c), iVar5 == 0)) ||
               (iVar5 = EVP_DigestFinal_ex(ctx,local_68,&local_6c), iVar5 == 0)) goto LAB_001b1b8c;
            iVar4 = iVar4 + 1;
          } while (iVar4 != count);
          if (sVar2 != 0) {
LAB_001b1bbc:
            ...
            if (local_6c != 0) {
              ...
              do {
                ...
                sVar8 = sVar8 - 1;
                sVar2 = sVar2 + 1;
                if (sVar8 == 0) goto LAB_001b1c24;
                puVar7 = key;
              } while (sVar2 != local_6c);
            }
            goto joined_r0x001b1c54;
          }
LAB_001b1c24:
          if (iVar3 == 0) break;
          if (local_6c == sVar2) {
