...
LAB_000e9ae2:
    ...
    if (-1 < *(int *)(*(int *)(param_1->type + 100) + 0x30) << 0x1c) goto LAB_000e9b0c;
...
LAB_000e9af8:
    ...
    do {
      ...
      if (p_Var7 != (_func_3297 *)0x0) goto LAB_000e9b0c;
...
LAB_000e9bce:
    ...
    p_Var7 = (_func_3297 *)((ulonglong)uVar18 >> 0x20);
    if ((int)uVar18 == 0) goto LAB_000e9ae2;
LAB_000e9bb8:
    iVar3 = param_1->mac_flags + 0xac;
    if (*(int *)(*(int *)(param_1->type + 100) + 0x30) << 0x1c < 0) goto LAB_000e9af8;
    if (param_1[2].tlsext_debug_cb == (_func_3297 *)0x0) goto LAB_000e9bce;
  }
LAB_000e9b0c:
...
LAB_000e9d36:
                    if (iVar8 < iVar6) goto LAB_000e9d3a;
                    iVar5 = *(int *)(iVar5 + 0x28);
                    if (iVar5 == 0x100) {
                      iVar5 = 0xff00;
                    }
