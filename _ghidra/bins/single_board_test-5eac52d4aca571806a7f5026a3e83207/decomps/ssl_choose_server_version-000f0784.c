      ...
      if ((iVar8 < 0x304 || iVar8 == 0x10000) || (int)(*(uint *)(piVar10[0x19] + 0x30) << 0x1c) < 0)
      {
        ...
        if (uVar11 != uVar9) {
          if ((*(uint *)(piVar10[0x19] + 0x30) & 8) == 0) {
            ...
            if (uVar11 == 0x100) {
              if (uVar9 == 0x100) goto LAB_000f09a8;
              uVar11 = 0xff00;
            }
            else if (uVar9 == 0x100) {
              uVar9 = 0xff00;
...
LAB_000f07f2:
    ...
    bVar1 = false;
    do {
      if (*(code **)((int)puVar13 + 8) == (code *)0x0) goto LAB_000f0856;
      if (uVar11 == uVar9) {
LAB_000f081e:
...
LAB_000f095e:
              ...
              if ((int)uVar4 < (int)uVar9) goto LAB_000f090e;
            }
            else {
              if (uVar4 == 0x100) {
                if (uVar9 == 0x100) goto LAB_000f0854;
                uVar4 = 0xff00;
              }
              else if (uVar9 == 0x100) {
                uVar9 = 0xff00;
              }
              if ((int)uVar9 < (int)uVar4) goto LAB_000f090e;
            }
          }
        }
        else if ((*(uint *)(*(int *)(param_1[1] + 100) + 0x30) & 8) == 0) {
          if ((int)uVar9 <= (int)uVar4) goto LAB_000f0840;
        }
        else {
          if (uVar4 == 0x100) {
            if (uVar9 == 0x100) goto LAB_000f0840;
            uVar5 = 0xff00;
          }
          else {
            uVar5 = uVar4;
          ...
          if ((int)uVar5 <= (int)uVar9) goto LAB_000f0840;
        }
LAB_000f0854:
        bVar1 = true;
      }
      else if ((*(uint *)(*(int *)(param_1[1] + 100) + 0x30) & 8) == 0) {
        if ((int)uVar9 <= (int)uVar11) goto LAB_000f081e;
      }
      else {
        if (uVar11 == 0x100) {
          if (uVar9 == 0x100) goto LAB_000f081e;
          uVar4 = 0xff00;
        }
        else {
          uVar4 = uVar11;
        ...
        if ((int)uVar4 <= (int)uVar9) goto LAB_000f081e;
      }
LAB_000f0856:
  ...
  uVar4 = *(uint *)(piVar10[0x19] + 0x30);
  if ((uVar4 & 8) != 0) goto LAB_000f07f2;
  ...
  for (pbVar12 = pbVar6 + 3; pbVar12 != pbVar6 + (uVar4 & 0xfe) + 3; pbVar12 = pbVar12 + 2) {
    ...
    if (uVar9 != uVar11) {
      if ((*(uint *)(*(int *)(param_1[1] + 100) + 0x30) & 8) == 0) {
        if (uVar11 <= uVar9) goto LAB_000f0a56;
      }
      else {
        uVar5 = uVar11;
        if (uVar9 == 0x100) {
          if (uVar11 == 0x100) goto LAB_000f0a56;
          uVar7 = 0xff00;
        }
        else {
          uVar7 = uVar9;
