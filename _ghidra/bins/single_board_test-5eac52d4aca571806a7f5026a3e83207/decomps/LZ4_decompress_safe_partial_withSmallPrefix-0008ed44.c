...
/* WARNING: Removing unreachable block (ram,0x0008f232) */
/* WARNING: Removing unreachable block (ram,0x0008f23c) */
/* WARNING: Removing unreachable block (ram,0x0008f23e) */
/* WARNING: Removing unreachable block (ram,0x0008f240) */
/* WARNING: Removing unreachable block (ram,0x0008f246) */
/* WARNING: Removing unreachable block (ram,0x0008ee16) */
/* WARNING: Removing unreachable block (ram,0x0008ee1e) */
/* WARNING: Removing unreachable block (ram,0x0008ee2e) */
/* WARNING: Removing unreachable block (ram,0x0008ee26) */
...
LAB_0008ef6e:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_0008f6ca;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_0008f6ca;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_0008ef6e;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_0008f6ca;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_0008f6ca;
              op = pBVar10;
