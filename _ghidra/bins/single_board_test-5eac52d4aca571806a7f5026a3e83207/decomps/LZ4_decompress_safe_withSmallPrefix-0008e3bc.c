...
/* WARNING: Removing unreachable block (ram,0x0008e898) */
/* WARNING: Removing unreachable block (ram,0x0008e8a2) */
/* WARNING: Removing unreachable block (ram,0x0008e8a4) */
/* WARNING: Removing unreachable block (ram,0x0008e8a6) */
/* WARNING: Removing unreachable block (ram,0x0008e8ac) */
/* WARNING: Removing unreachable block (ram,0x0008e476) */
...
LAB_0008e5d4:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_0008ed30;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_0008ed30;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_0008e5d4;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_0008ed30;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_0008ed30;
              op = pBVar10;
