...

{
  ...
  if (param_4 != 0) {
    ...
    do {
      ...
      do {
        if (*(short *)(puVar7 + 4) == *param_3) goto LAB_000f789e;
        puVar7 = puVar7 + 0x20;
                  ...
                  if ((*(int *)(param_1->mac_flags + 0x2a8) < 0x304) &&
                    ...
                    if (iVar1 < 1) {
                      ...
                      do {
                        ...
                        if ((iVar4 == 0) && (*(int *)(iVar3 + 0x10) << 0x1b < 0)) goto LAB_000f7956;
                      } while (iVar1 != iVar6);
                    }
                  }
                  goto LAB_000f7938;
...
LAB_000f7956:
          ...
          if ((iVar1 == 0x10000 || iVar1 < 0x304) || (*(int *)(puVar7 + 0x10) != 0x74)) {
            ...
            if (*(int *)(puVar7 + 0x10) != 0x74) {
              ...
              if (bVar11 && (uVar5 != 10 && uVar5 != 1)) goto LAB_000f78f6;
            }
          }
        }
      }
