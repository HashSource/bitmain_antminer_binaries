...

{
  ...
  if (res == true) {
    ...
    while (gPattern_test_counter < gTest_loop) {
      ...
      thread_ret = pthread_create(&show_id,(pthread_attr_t *)0x0,(__start_routine *)0x27335,
                                  (void *)0x0);
      if (thread_ret != 0) {
        print_time_stamp(time_stamp,0x30);
        printf("%s ",time_stamp);
      ...
      thread_ret = pthread_create(&read_temp_from_pic_id,(pthread_attr_t *)0x0,
                                  (__start_routine *)0x35b45,(void *)0x0);
      if (thread_ret != 0) {
        print_time_stamp(time_stamp,0x30);
        printf("%s ",time_stamp);
      ...
      usleep(50000);
      gStart_receive = true;
      thread_ret = pthread_create(&receive_id,(pthread_attr_t *)0x0,(__start_routine *)0xb3331,
                                  (void *)0x0);
      if (thread_ret != 0) {
        _power_down(gChain,false);
        clear_all_thread();
      ...
      do {
        iVar4 = get_ctrlboard_temp_max();
        if (0x32 < iVar4) goto LAB_000b70c8;
        print_time_stamp(time_stamp,0x30);
        printf("%s ",time_stamp);
        iVar4 = get_ctrlboard_temp_max();
...
LAB_000b70c8:
      ...
      log_to_file(tmp1,time_stamp);
      gNoncing = true;
      thread_ret = pthread_create(&send_id,(pthread_attr_t *)0x0,(__start_routine *)0xb363d,
                                  (void *)0x0);
      if (thread_ret != 0) {
        print_time_stamp(time_stamp,0x30);
        printf("%s ",time_stamp);
