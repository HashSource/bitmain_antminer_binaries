...
LAB_0018e21c:
      ...
      if ((((iVar2 == 0) ||
          ...
          iVar2 < 1)) || (iVar2 = CMS_SignerInfo_sign(si), iVar2 == 0)) goto LAB_0018e08a;
      local_80 = (EVP_PKEY_CTX *)0x0;
    }
    iVar5 = iVar5 + 1;
    EVP_MD_CTX_free(ctx);
  ...
  if ((iVar2 == 0) || (pcVar4 = *(code **)(iVar2 + 0x5c), pcVar4 == (code *)0x0)) goto LAB_0018e06e;
  iVar2 = (*pcVar4)(*(int *)(si + 0x20),5,0,si);
  if (iVar2 == -2) {
    ERR_put_error(0x2e,0xaa,0x7d,"crypto/cms/cms_sd.c",0xe7);
  }
  else {
    if (0 < iVar2) goto LAB_0018e06e;
