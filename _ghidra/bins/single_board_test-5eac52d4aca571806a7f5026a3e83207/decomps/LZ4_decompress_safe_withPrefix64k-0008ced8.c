...
/* WARNING: Removing unreachable block (ram,0x0008d3b0) */
/* WARNING: Removing unreachable block (ram,0x0008d3ba) */
/* WARNING: Removing unreachable block (ram,0x0008d3bc) */
/* WARNING: Removing unreachable block (ram,0x0008d3be) */
/* WARNING: Removing unreachable block (ram,0x0008d3c4) */
/* WARNING: Removing unreachable block (ram,0x0008cf8e) */
...
LAB_0008d0ec:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_0008d848;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_0008d848;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_0008d0ec;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_0008d848;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_0008d848;
              op = pBVar10;
