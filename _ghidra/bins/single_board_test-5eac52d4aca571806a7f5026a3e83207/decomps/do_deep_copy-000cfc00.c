...
switchD_000cfc12_default:
  ...
  case JSON_ARRAY:
    ...
    if (iVar2 == 0) {
      pjVar3 = json_array();
      if (pjVar3 != (json_t *)0x0) {
        if ((json->type != JSON_ARRAY) || (json[1].refcount == 0)) goto LAB_000cfc42;
        pjVar4 = (json_t *)0x0;
        uVar7 = 0;
        if (json[1].refcount != 0) goto LAB_000cfd46;
        while( true ) {
          pjVar4 = do_deep_copy(pjVar4,parents);
          iVar2 = json_array_append_new(pjVar3,pjVar4);
          if (iVar2 != 0) break;
          if (json->type != JSON_ARRAY) goto LAB_000cfc42;
          uVar7 = uVar7 + 1;
          if (json[1].refcount <= uVar7) goto LAB_000cfc42;
          pjVar4 = (json_t *)0x0;
...
LAB_000cfc8e:
  ...
  if (iter == (void *)0x0) goto LAB_000cfce8;
  goto LAB_000cfc9a;
}
