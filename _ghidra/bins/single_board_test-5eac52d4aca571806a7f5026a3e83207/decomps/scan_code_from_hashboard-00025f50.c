...

{
  ...
  if (gScanCodeGun_data_ready == '\x03') {
    ...
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : SN data::[%s]\n","scan_code_from_hashboard",0xb275f9);
    snprintf(tmp1,0x100,"SN data::[%s]",0xb275f9);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    ...
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : chip_die::[%s].\n","scan_code_from_hashboard",0xb27588);
    snprintf(tmp1,0x100,"chip_die::[%s].",0xb27588);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : chip_marking::[%s].\n","scan_code_from_hashboard",0xb27598);
    snprintf(tmp1,0x100,"chip_marking::[%s].",0xb27598);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : chip_bin::[%s].\n","scan_code_from_hashboard",0xb275a8);
    snprintf(tmp1,0x100,"chip_bin::[%s].",0xb275a8);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : chip_ftversion::[%s].\n","scan_code_from_hashboard",0xb275b8);
    snprintf(tmp1,0x100,"chip_ftversion::[%s].",0xb275b8);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : temp_sensor_type::[%s].\n","scan_code_from_hashboard",0xb275c8);
    snprintf(tmp1,0x100,"temp_sensor_type::[%s].",0xb275c8);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : hashboard_ctrl_code::[%s].\n","scan_code_from_hashboard",0xb275d8);
    snprintf(tmp1,0x100,"hashboard_ctrl_code::[%s].",0xb275d8);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s : hashboard_index::[%s].\n","scan_code_from_hashboard",0xb275e8);
    snprintf(tmp1,0x100,"hashboard_index::[%s].",0xb275e8);
    log_to_file(tmp1,time_stamp);
