...
LAB_0018a796:
                    ...
                    if (-1 < iVar6) {
                      if (n->neg == 0) {
                        pcVar8 = (code *)0x183341;
                      }
                      else {
                        pcVar8 = (code *)0x1832ed;
                      }
                      iVar6 = (*pcVar8)(r_01,r_01,n);
                      if (iVar6 == 0) goto LAB_0018a7a2;
                    }
                    iVar6 = BN_is_zero(r_01);
                    if (iVar6 != 0) goto LAB_0018a796;
                  }
                  iVar6 = BN_kronecker(r_01,pBVar5,ctx);
                  if (iVar6 + 1 < 0 != SCARRY4(iVar6,1)) goto LAB_0018a7a2;
                  if (iVar6 == 0) {
                    iVar1 = 0xc9;
LAB_0018a940:
...
LAB_0018a7a2:
      ...
      if (ret != (BIGNUM *)0x0) {
        uVar2 = BN_is_one(a);
        iVar1 = BN_set_word(ret,uVar2);
        goto joined_r0x0018a65c;
      }
      pBVar3 = BN_new();
      if (pBVar3 != (BIGNUM *)0x0) {
        uVar2 = BN_is_one(a);
        iVar1 = BN_set_word(pBVar3,uVar2);
        goto joined_r0x0018a968;
      }
    }
  }
  r_02 = (BIGNUM *)0x0;
...
joined_r0x0018aa3c:
  ...
  if (pBVar5 == (BIGNUM *)0x0) goto LAB_0018a7a2;
  iVar1 = iVar1 - iVar9;
  ...
  if ((iVar1 == 0) || (iVar1 = BN_mod_mul(r_00,r_00,r,n,ctx), iVar1 == 0)) goto LAB_0018a7a2;
