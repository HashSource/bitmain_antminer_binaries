...
/* WARNING: Removing unreachable block (ram,0x0008c862) */
/* WARNING: Removing unreachable block (ram,0x0008c86c) */
/* WARNING: Removing unreachable block (ram,0x0008c86e) */
/* WARNING: Removing unreachable block (ram,0x0008c870) */
/* WARNING: Removing unreachable block (ram,0x0008c876) */
/* WARNING: Removing unreachable block (ram,0x0008c446) */
/* WARNING: Removing unreachable block (ram,0x0008c44e) */
/* WARNING: Removing unreachable block (ram,0x0008c45e) */
/* WARNING: Removing unreachable block (ram,0x0008c456) */
...
LAB_0008c59e:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_0008ccfa;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_0008ccfa;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_0008c59e;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_0008ccfa;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_0008ccfa;
              op = pBVar10;
