...

{
  ...
  if (0x3fffffff < param_4) {
    ...
    do {
      ...
      CRYPTO_ofb128_encrypt(iVar4,iVar3,0x40000000,uVar1,uVar2,auStack_2c,0x1780d5);
  ...
  if (param_4 != 0) {
    ...
    uVar1 = EVP_CIPHER_CTX_get_cipher_data(param_1);
    uVar2 = EVP_CIPHER_CTX_iv_noconst(param_1);
    CRYPTO_ofb128_encrypt(iStack_38,iStack_3c,param_4,uVar1,uVar2,auStack_2c,0x1780d5);
    EVP_CIPHER_CTX_set_num(param_1,auStack_2c[0]);
  }
  return 1;
}
