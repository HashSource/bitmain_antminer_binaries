    ...
    if (param_2 != 0x85) {
      ...
      if ((int)(param_3 << 0x1c) < 0) {
        if ((param_3 & 2) == 0) {
          ...
          OPENSSL_strlcpy(acStack_1c,&DAT_00203a98,4);
        }
      }
      else if ((param_3 & 6) == 6) {
        OPENSSL_strlcpy(acStack_1c,&DAT_00203a9c,4);
      }
      ...
      ERR_add_error_data(5,"fopen(\'",param_4,&DAT_00203aa0,acStack_1c,&DAT_001fd708);
