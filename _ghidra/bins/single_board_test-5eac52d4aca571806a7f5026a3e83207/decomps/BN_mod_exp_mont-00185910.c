...
LAB_00185ab8:
    if (m_ctx != (BN_MONT_CTX *)0x0) goto LAB_00185abe;
  }
  else {
...
LAB_001859aa:
      if ((((a->neg != 0) || (iVar2 = BN_ucmp(a,m), -1 < iVar2)) &&
         ...
         (iVar2 = bn_to_mont_fixed_top(pBVar4,a,local_c0,ctx), iVar2 == 0)) goto LAB_00185ab8;
      if (local_bc < 0x2a0) {
        if (0xef < local_bc) {
          local_b4 = 0x10;
          local_b0 = 5;
      ...
      if (iVar2 != 0) {
        ...
        while( true ) {
          while (iVar2 = BN_is_bit_set(p,local_bc), iVar2 == 0) {
            ...
            if (local_bc == 0) goto LAB_00185bf6;
            local_bc = local_bc + -1;
          }
          if (local_b0 == 1) {
            iVar9 = 0;
