  ...
  if (param_2 != (uchar *)0x0) {
    ...
    if (b != (BIO *)0x0 && outl != (size_t *)0x0) {
      ...
      if ((0 < (int)param_3) && (0 < (int)outl[2])) {
        ...
        do {
          puVar5 = (uchar *)outl[7];
          if (puVar5 == in) goto LAB_001af872;
LAB_001af7be:
          sVar3 = (int)puVar5 - (int)in;
          puVar5 = param_2;
          if ((int)sVar3 < 1) goto LAB_001af822;
          if (0x100 < (int)param_3) goto LAB_001af898;
LAB_001af7ca:
          if (0xff < (int)sVar3) {
            sVar3 = 0x100;
          }
          ...
          if (sVar4 != 0) {
            while( true ) {
              ...
              if ((int)sVar4 < 1) goto LAB_001af7f6;
              ...
              sVar3 = sVar3 + sVar4;
              while( true ) {
                if (((int)param_3 < 1) || ((int)outl[2] < 1)) goto LAB_001af7f6;
                in = (uchar *)outl[6];
                puVar5 = (uchar *)outl[7];
                __n = sVar3;
                if (puVar5 != in) goto LAB_001af7be;
LAB_001af872:
                data = outl + 0x50;
                outl[6] = (size_t)data;
                outl[7] = (size_t)data;
                ...
                in = (uchar *)outl[6];
                outl[7] = outl[7] + sVar3;
                if ((int)param_3 < 0x101) goto LAB_001af7ca;
LAB_001af898:
                sVar6 = param_3 - iVar1;
                sVar4 = sVar6;
