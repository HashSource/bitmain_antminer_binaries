...
LAB_000f13b8:
    ...
    if (uVar5 < uVar4) goto LAB_000f13b8;
    *param_2 = puVar8 + uVar4 + 2;
    param_2[1] = uVar5 - uVar4;
    if (uVar4 == 0) {
LAB_000f13e0:
      OPENSSL_sk_pop_free(*(undefined4 *)(*(int *)(param_1 + 0x7c) + 0x224),(undefined *)0x169841);
...
LAB_000f139e:
  OPENSSL_sk_pop_free(iVar2,(undefined *)0x169841);
  X509_NAME_free(a);
  return 0;
}
