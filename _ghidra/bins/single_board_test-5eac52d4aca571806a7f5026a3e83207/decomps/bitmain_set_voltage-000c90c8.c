...

{
  ...
  case 4:
    ...
    break;
  default:
switchD_000c9340_caseD_1:
    f_tgt_vol = 0.0;
    goto LAB_000c9174;
  case 8:
    if ((int)((uint)(dVar9 < 0.0) << 0x1f) < 0) goto switchD_000c9340_caseD_1;
    dVar10 = 12.0;
  }
    ...
    if (v <= _g_power_state.eeprom.vol[0] - 0.001) {
      ...
      if ((-1 < (int)((uint)(v < dVar13 + 0.001) << 0x1f)) ||
         ...
         dVar11 = dVar11 + ((dVar11 - *(double *)
                           ...
                           (v - dVar13), dVar9 + 0.5 < dVar11)) goto LAB_000c9312;
      ...
      if (dVar9 + 0.5 < dVar11) goto LAB_000c9312;
      bVar8 = dVar11 < dVar10 - 0.5;
    }
