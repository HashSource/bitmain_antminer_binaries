...
/* WARNING: Removing unreachable block (ram,0x000913a6) */
/* WARNING: Removing unreachable block (ram,0x000913b0) */
/* WARNING: Removing unreachable block (ram,0x000913b2) */
/* WARNING: Removing unreachable block (ram,0x000913b4) */
/* WARNING: Removing unreachable block (ram,0x000913ba) */
/* WARNING: Removing unreachable block (ram,0x00090f18) */
...
LAB_000911b2:
                  ...
                  if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
                    if (local_48 == 0) {
                      if ((iend != ip + length) || (oend < cpy)) goto LAB_00091882;
                    }
                    else {
                      if (iend < ip + length) {
                ...
                if ((bVar8 & bVar6) == 0) goto LAB_0009109e;
...
LAB_00091444:
                ...
                if ((local_4c == 2) && (match < local_50)) {
                  ...
                  if (cVar7 != '\0') {
                    if (local_48 == 0) goto LAB_00091882;
                ...
                if ((local_48 == 0) || (cpy <= oend + -0xc)) {
                  ...
                  if (cVar7 == '\0') {
                    ...
                    *(undefined4 *)(op + 0xc) = uVar2;
                    ...
                    oCopyLimit = oend + -7;
                    if (oend + -5 < cpy) goto LAB_00091882;
                    op = pBVar11;
