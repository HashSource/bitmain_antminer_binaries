...
undefined4 cast5_ofb_cipher(undefined4 param_1,uchar *param_2,uchar *param_3,uint param_4)

{
  ...
  if (0x3fffffff < param_4) {
    ...
    do {
      ...
      CAST_ofb64_encrypt(in,puVar2,0x40000000,pCVar1,ivec,local_2c);
  ...
  if (param_4 != 0) {
    ...
    CAST_ofb64_encrypt(local_34,param_2,param_4,pCVar1,puVar2,local_2c);
    EVP_CIPHER_CTX_set_num(param_1,local_2c[0]);
  }
  return 1;
}
