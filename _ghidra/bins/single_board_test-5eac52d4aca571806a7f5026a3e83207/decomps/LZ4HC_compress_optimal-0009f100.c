...
/* WARNING: Removing unreachable block (ram,0x000a445c) */
/* WARNING: Removing unreachable block (ram,0x000a4e3c) */
/* WARNING: Heritage AFTER dead removal. Example location: s0xfffff834 : 0x000a0ace */
...
LAB_000a04b2:
      do {
        if ((matchIndex < lowestMatchIndex) || (nbAttempts < 1)) goto LAB_000a04ce;
        matchLength_1 = 0;
...
LAB_0009fec0:
        if ((matchLength_1 == local_144) && (matchIndex + local_144 <= ipIndex)) {
          ...
          if (1 < distanceToNextMatch) {
            if (matchIndex < distanceToNextMatch) goto LAB_000a04ce;
        ...
        if ((distNextMatch == 1) && (matchChainPos == 0)) {
          ...
          if (pattern != UVar3) goto LAB_000a0482;
          iLimit = local_140;
          if (extDict != 0) {
            iLimit = dictEnd;
          }
          ...
          if ((currentSegmentLength < srcPatternLength) || (srcPatternLength < forwardPatternLength)
            ...
            if (iVar6 == 0) {
              ...
              if (lookBackLength == 0) {
                ...
                if (matchIndex < distToNextPattern) goto LAB_000a04ce;
...
LAB_000a4666:
    if ((cur < last_match_pos) && (curPtr = ip + cur, curPtr <= mflimit)) {
      if (fullUpdate == 0) {
        if (opt[cur].price < opt[cur + 1].price) goto LAB_000a112a;
      }
...
LAB_000a3bf4:
          do {
            if ((matchIndex_2 < lowestMatchIndex_2) || (nbAttempts_2 < 1)) goto LAB_000a3c10;
            matchLength_5 = 0;
...
LAB_000a3602:
            if ((matchLength_5 == local_560) && (matchIndex_2 + local_560 <= ipIndex_2)) {
              ...
              if (1 < distanceToNextMatch_2) {
                if (matchIndex_2 < distanceToNextMatch_2) goto LAB_000a3c10;
            ...
            if ((distNextMatch_2 == 1) && (matchChainPos_2 == 0)) {
              ...
              if (pattern_2 != UVar3) goto LAB_000a3bc4;
              iLimit_2 = local_55c;
              if (extDict_2 != 0) {
                iLimit_2 = dictEnd_2;
              }
              ...
              if ((currentSegmentLength_2 < srcPatternLength_2) ||
                ...
                if (iVar6 == 0) {
                  ...
                  if (lookBackLength_2 == 0) {
                    ...
                    if (matchIndex_2 < distToNextPattern_2) goto LAB_000a3c10;
...
LAB_000a23ec:
        do {
          if ((matchIndex_1 < lowestMatchIndex_1) || (nbAttempts_1 < 1)) goto LAB_000a2408;
          matchLength_3 = 0;
...
LAB_000a1dfa:
          if ((matchLength_3 == local_37c) && (matchIndex_1 + local_37c <= ipIndex_1)) {
            ...
            if (1 < distanceToNextMatch_1) {
              if (matchIndex_1 < distanceToNextMatch_1) goto LAB_000a2408;
          ...
          if ((distNextMatch_1 == 1) && (matchChainPos_1 == 0)) {
            ...
            if (pattern_1 != UVar3) goto LAB_000a23bc;
            iLimit_1 = local_378;
            if (extDict_1 != 0) {
              iLimit_1 = dictEnd_1;
            }
            ...
            if ((currentSegmentLength_1 < srcPatternLength_1) ||
              ...
              if (iVar6 == 0) {
                ...
                if (lookBackLength_1 == 0) {
                  ...
                  if (matchIndex_1 < distToNextPattern_1) goto LAB_000a2408;
...
LAB_000a46aa:
  ...
  if (bVar14) goto code_r0x000a0db4;
  goto LAB_000a4b4c;
LAB_000a3c10:
