...

{
  ...
  if (pvVar3 != (void *)0x0) {
    ...
    case (ssl3_state_st *)0x15:
      goto switchD_000f30bc_caseD_0;
    case (ssl3_state_st *)0x1a:
switchD_000f30bc_caseD_1a:
      if (param_2 == 0x10) {
...
switchD_000f30bc_caseD_1b:
      if (param_2 == 0x10) goto LAB_000f31a6;
      break;
    case (ssl3_state_st *)0x1c:
switchD_000f30bc_caseD_1c:
      ...
      if ((psVar2 == (ssl3_state_st *)0x0) || (psVar2 = param_1->s3, psVar2 != (ssl3_state_st *)0x0)
         ) goto switchD_000f30bc_caseD_1d;
      bVar6 = param_2 == 0xf;
      if (bVar6) {
        pvVar3 = (void *)0x1d;
      }
...
switchD_000f30bc_caseD_1f:
      psVar2 = *(ssl3_state_st **)(param_1->mac_flags + 0x33c);
      if (psVar2 == (ssl3_state_st *)0x0) goto switchD_000f30bc_caseD_1e;
      if (param_2 == 0x43) {
        pvVar3 = (void *)0x1e;
        psVar2 = (ssl3_state_st *)0x1;
      }
...
switchD_000f3022_caseD_2:
  ...
  if (iVar5 == 0) {
    ...
    default:
      goto switchD_000f30bc_caseD_2;
    case (ssl3_state_st *)0x1a:
      goto switchD_000f30bc_caseD_1a;
    case (ssl3_state_st *)0x1b:
      goto switchD_000f30bc_caseD_1b;
    case (ssl3_state_st *)0x1c:
      goto switchD_000f30bc_caseD_1c;
    case (ssl3_state_st *)0x1d:
    case (ssl3_state_st *)0x24:
      goto switchD_000f30bc_caseD_1d;
    case (ssl3_state_st *)0x1e:
      goto switchD_000f30bc_caseD_1e;
    case (ssl3_state_st *)0x1f:
      goto switchD_000f30bc_caseD_1f;
    }
  }
  pvVar4 = (void *)0x0;
  switch(psVar2) {
  case (ssl3_state_st *)0x1:
    ...
    if (pvVar3 == (void *)0xb) goto switchD_000f30bc_caseD_2;
    if (param_2 != 0xb) {
      if (param_2 == 0x18) {
        pvVar3 = (void *)0x2c;
      }
    ...
    if (param_1[3].tlsext_status_type != 4) goto switchD_000f30bc_caseD_2;
    goto LAB_000f31e6;
  default:
    goto switchD_000f3022_caseD_2;
  case (ssl3_state_st *)0x1b:
  ...
  case (ssl3_state_st *)0x31:
    goto switchD_000f3022_caseD_24;
