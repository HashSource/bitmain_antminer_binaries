...
LAB_000d1626:
    ...
    iVar1 = *(int *)(param_1[2].sid_ctx + 0x1c);
    if (iVar1 == 0) goto LAB_000d1626;
    pEVar2 = EVP_MD_CTX_md((EVP_MD_CTX *)param_1[2].info_callback);
    if (pEVar2 == (EVP_MD *)0x0) goto LAB_000d1622;
    pEVar2 = EVP_MD_CTX_md((EVP_MD_CTX *)param_1[2].info_callback);
  ...
  if (param_6 != 0 || bVar20) {
    if (param_6 == 0) goto LAB_000d1666;
...
LAB_000d17e6:
        if (-1 < (int)(uVar10 << 0x1c)) {
          ...
          if (local_948 == 0) goto LAB_000d180a;
        }
...
LAB_000d1c88:
          if (((int)param_1->msg_callback_arg - 1U < 4) ||
             (param_1[2].tlsext_debug_cb == (_func_3297 *)0x1)) goto LAB_000d18ba;
        }
        else {
          ...
          if ((iVar8 == 0x10000 || iVar8 == 0x303) || iVar11 < 0 != bVar20) goto LAB_000d1c88;
LAB_000d18ba:
...
LAB_000d16c0:
      ...
      if (ctx == (EVP_CIPHER_CTX *)0x0) {
        ...
        uVar10 = *(uint *)(piVar7[0x19] + 0x30);
        pSVar12 = param_5;
        if ((uVar10 & 1) != 0) goto LAB_000d17e6;
        memset(local_628,0,0x600);
        local_948 = 0;
      }
      goto LAB_000d1868;
    ...
    if (ctx != (EVP_CIPHER_CTX *)0x0) {
      piVar7 = (int *)param_1->type;
      uVar10 = *(uint *)(piVar7[0x19] + 0x30);
      if (-1 < (int)(uVar10 << 0x1f)) goto LAB_000d1e80;
      goto LAB_000d17e6;
    }
LAB_000d1e80:
    memset(local_628,0,0x600);
  ...
  if (param_1->read_ahead == 2) {
    ...
    if (0 < iVar1) goto LAB_000d1ad8;
    iVar1 = ossl_statem_in_error(param_1);
    if (iVar1 != 0) goto LAB_000d16da;
    uVar9 = 0x3fa;
  }
  else {
