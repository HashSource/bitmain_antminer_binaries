...
LAB_00100a46:
  ...
  *psVar5 = __n;
  ...
  if (((uVar3 & 0xf0007) == 6) || (uVar3 = EVP_CIPHER_flags(cipher), (uVar3 & 0xf0007) == 7)) {
    arg = 4;
    if (param_2 == 0x21 || param_2 == 0x12) goto LAB_001006f8;
LAB_00100892:
    iVar8 = iVar7 + __n * 2;
...
LAB_001008b4:
    ...
    if (param_2 != 0x21 && param_2 != 0x12) goto LAB_00100892;
LAB_001006f8:
    iVar8 = __n * 2;
    iVar7 = iVar8 + iVar7 * 2;
    __src = pvVar12;
    if (*(uint *)(*(int *)(param_1 + 0x7c) + 0x228) < (uint)(iVar7 + arg * 2)) goto LAB_001008b4;
  }
