...
LAB_00170dfc:
    ...
    OPENSSL_sk_pop_free(iVar2,(undefined *)0x170685);
    return 0;
  }
  if (0 < iVar1) {
    local_48 = 0;
          ...
          if (iVar5 == 0) {
            ...
            if (psVar6 == (stack_st_CONF_VALUE *)0x0) {
              ...
              if (*pcVar11 == '@') {
                ...
                OPENSSL_sk_pop_free(psVar6,0x1752a9);
              }
              pGVar9 = pGVar7;
...
LAB_00170dd2:
            OPENSSL_sk_pop_free(pGVar9,(undefined *)0x1714fd);
            OPENSSL_sk_pop_free(pGVar12,0x169239);
            goto LAB_00170dea;
          }
                ...
                if (iVar4 == 0) {
                  ...
                  if (0 < iVar4) {
                    ...
                    if (*(int *)(iVar4 + 8) == 0) {
                      ...
                      pGVar9 = (GENERAL_NAMES *)0x0;
                      if (pDVar13 != (DIST_POINT_NAME *)0x0) goto LAB_00170dbc;
                      goto LAB_00170d32;
                    }
...
joined_r0x00170e52:
            if (pGVar7 == (GENERAL_NAMES *)0x0) goto LAB_00170dea;
          }
          else {
