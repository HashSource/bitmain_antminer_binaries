...
LAB_00164dae:
    ...
    if (-1 < (int)(uVar13 << 0x1e)) {
      ...
      if (-1 < *(int *)(*(int *)(param_1 + 0x10) + 0xc) << 0x13) {
        if ((uVar13 & 0x60) == 0) goto LAB_00164dd6;
        goto LAB_00164ebc;
      }
      if ((int)(uVar13 << 0x19) < 0) {
        if ((*(uint *)(iVar1 + 0x58) & ~local_78) != 0) goto LAB_00164dd6;
        goto LAB_00164ebc;
      }
      if (*(int *)(iVar1 + 0x60) != 0) goto LAB_00164ebc;
LAB_00164dd6:
      ...
      if (iVar4 == 0) {
        ...
        if (-1 < *(int *)(iVar1 + 0x54) << 0x1a) goto LAB_00164ebc;
        uVar13 = 0x100;
        uVar12 = 0;
      }
...
LAB_00164e20:
        ...
        if (ptVar15 == (time_t *)0x0) goto LAB_00164e20;
LAB_00165180:
        uVar13 = uVar13 | 0x40;
      }
LAB_00164e32:
      ...
      if ((iVar18 == 0) && ((uVar13 & 0x20) != 0)) {
        ...
        do {
          ...
          iVar16 = iVar4 + 1;
          if (iVar18 <= iVar4) {
            if (-1 < *(int *)(*(int *)(param_1 + 0x10) + 0xc) << 0x13) goto LAB_00164eb0;
            iVar4 = 0;
            goto LAB_00165104;
          }
          pXVar6 = (X509 *)OPENSSL_sk_value(*(undefined4 *)(param_1 + 0x50),iVar4);
...
LAB_00164eb0:
      if ((uVar13 & 4) == 0) goto LAB_00164ebc;
      goto LAB_00164fe6;
    }
    goto LAB_00164ebc;
  }
...
LAB_00165104:
    ...
    iVar16 = iVar4 + 1;
    if (iVar18 <= iVar4) goto LAB_00164eb0;
  }
  uVar13 = uVar13 | 4;
  local_6c = pXVar6;
LAB_00164fe6:
...
LAB_0016523c:
      ...
      if (((*(int **)(iVar1 + 0x50) == (int *)0x0) || (**(int **)(iVar1 + 0x50) == 0)) &&
         ((uVar13 & 0x20) != 0)) {
LAB_001651ae:
        if ((local_5c & ~local_78) == 0) goto LAB_00164ebc;
        uVar13 = uVar13 | 0x80;
  ...
  if ((int)local_70 <= (int)uVar13 && uVar13 != 0) {
    if (local_74 != 0 && local_70 == uVar13) {
      ...
      if ((iVar4 == 0) || ((local_30 < 1 && (local_2c[0] < 1)))) goto LAB_00164ebc;
    }
    local_68 = local_78;
    local_64 = local_6c;
    local_74 = iVar1;
...
LAB_00164ebc:
  iVar20 = iVar20 + 1;
  iVar1 = OPENSSL_sk_num(param_7);
  if (iVar1 <= iVar20) goto LAB_00164ec8;
  goto LAB_00164dae;
}
