...

{
  ...
  if (*(int *)(param_1 + 0x44c) == 1) {
    ...
    if (pcVar9 != (code *)0x0) goto LAB_000e46b8;
    if (local_1b0 == (SSL_SESSION *)0x0) goto LAB_000e470c;
    goto LAB_000e474a;
  }
  pcVar9 = *(code **)(param_1 + 0x4cc);
  uVar3 = 0;
...
LAB_000e46b8:
    ...
    if (iVar1 != 0) {
      if (local_1b0 == (SSL_SESSION *)0x0) goto LAB_000e470c;
      if (local_1b0->ssl_version == 0x304) goto LAB_000e474a;
    }
...
LAB_000e4802:
        ...
        if (puVar4 < puVar6) goto LAB_000e4802;
