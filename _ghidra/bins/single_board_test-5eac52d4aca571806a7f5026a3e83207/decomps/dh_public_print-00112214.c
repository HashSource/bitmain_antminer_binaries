...

{
  ...
  num = *(BIGNUM **)(iVar5 + 0x14);
  if (num == (BIGNUM *)0x0 || *(int *)(iVar5 + 8) == 0) {
    iVar5 = 0x43;
  }
  else {
    ...
    if (0 < iVar2) {
      off = param_3 + 4;
      iVar2 = ASN1_bn_print(param_1,"private-key:",(BIGNUM *)0x0,(uchar *)0x0,off);
      if (((((iVar2 != 0) &&
            (iVar2 = ASN1_bn_print(param_1,"public-key:",num,(uchar *)0x0,off), iVar2 != 0)) &&
