...
undefined4
sm4_ctr_cipher(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  CRYPTO_ctr128_encrypt(param_3,param_2,param_4,uVar1,uVar2,uVar3,local_2c,0x1bce7d);
