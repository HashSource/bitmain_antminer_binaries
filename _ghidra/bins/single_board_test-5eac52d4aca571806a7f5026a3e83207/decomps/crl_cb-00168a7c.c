...

{
  ...
  case 3:
    ...
    OPENSSL_sk_pop_free(data[1].idp,(undefined *)0x171555);
    return 1;
  case 4:
  ...
  if (pXVar2 == (X509_ALGOR *)0x0) {
    if (local_30 != -1) goto LAB_00168bbe;
  }
  else {
    ...
    if ((int)pAVar12 < 1) {
      unaff_r6 = iVar1;
      if (0 < (int)pAVar11) goto LAB_00168b64;
    }
    else {
...
LAB_00168bbe:
  ...
  if (pAVar5 == (AUTHORITY_KEYID *)0x0) {
    if (local_30 == -1) goto LAB_00168c0a;
  }
  else if (data[1].flags != 0) goto LAB_00168c0a;
  data->meth_data = (void *)((uint)data->meth_data | 0x80);
LAB_00168c0a:
  ...
  do {
    while( true ) {
      ...
      iVar18 = iVar1 + 1;
      if (iVar6 <= iVar1) goto LAB_00168c6a;
      ...
      if ((iVar18 != 0) && (iVar6 != 0x8c && (iVar6 != 0x5a && iVar6 != 0x302))) goto LAB_00168c62;
    }
...
LAB_00168dc4:
    ...
    if (a == (ASN1_INTEGER *)0x0) {
      if (local_2c[0] == -1) goto LAB_00168cb8;
LAB_00168dbc:
      data->meth_data = (void *)((uint)data->meth_data | 0x80);
      goto LAB_00168dc4;
    }
    ...
    if (pIVar9 == (ISSUING_DIST_POINT *)0x0) {
      ...
      data[1].idp = pIVar9;
      if (pIVar9 == (ISSUING_DIST_POINT *)0x0) goto LAB_00168d9a;
    }
...
LAB_00168cb8:
    ...
    if (a_00 == (ASN1_ENUMERATED *)0x0) {
      if (local_2c[0] != -1) goto LAB_00168dbc;
