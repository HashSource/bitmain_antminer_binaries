...
undefined4 aria_128_cbc_cipher(undefined4 param_1,int param_2,int param_3,uint param_4)

{
  ...
  if (param_4 != 0) {
    ...
    if (iVar4 != 0) {
      CRYPTO_cbc128_encrypt(iStack_30,iStack_34,param_4,uVar1,uVar2,0x1780d5);
      return 1;
    }
