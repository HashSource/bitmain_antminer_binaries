...
LAB_00107f40:
    local_88 = 1;
    if (param_8 != 2) goto LAB_00107f46;
LAB_001081d4:
    if (in_d0 != 0.0) {
...
LAB_0010834e:
    ...
    if (param_8 == 2) goto LAB_001081d4;
LAB_00107f46:
    if (param_8 != 0) {
      local_94 = param_8;
      if (in_d0 == 0.0) {
...
LAB_001082fa:
        ...
        if (param_8 == 2) goto LAB_001081e8;
      }
      goto LAB_0010834e;
    }
    local_94 = param_8;
  ...
  if (param_6 != 0) {
    ...
    do {
      ...
      if ((iVar14 == 0 && param_8 == 2) && (uVar20 % 10 == 0)) {
        param_6 = param_6 + -1;
        iVar13 = 0;
        if (param_6 == 0) goto code_r0x001080fc;
      }
      else {
        acStack_50[iVar14] = "0123456789"[uVar20 % 10];
        if (param_6 <= iVar13) goto LAB_00108102;
      }
      uVar20 = uVar20 / 10;
      iVar14 = iVar13;
    } while( true );
...
LAB_00108134:
    ...
    if (-1 < (int)(param_7 << 0x1b)) {
      if (0 < (int)local_88) {
        ...
        if (uVar20 != 0) goto LAB_0010840a;
LAB_001083c2:
        if (uVar19 <= uVar4) goto LAB_001083d6;
        iVar11 = *param_1;
        if (iVar11 == 0) goto LAB_00108472;
        do {
          *param_3 = uVar4 + 1;
...
LAB_00108472:
    ...
    if (local_88 == 0) goto LAB_00108134;
    piVar5 = param_2;
    if (local_84 != 0) {
      if (param_2 != (int *)0x0) {
        piVar5 = (int *)0x1;
      ...
      iVar11 = doapr_outch_part_0(param_1,param_2,param_3,param_4,local_84);
      if (iVar11 != 0) goto joined_r0x00108526;
      return 0;
    }
    if (param_2 != (int *)0x0) {
      piVar5 = (int *)0x1;
