  ...
  if ((pvVar7 == (void *)0x0) || (pcVar8 = *(code **)((int)pvVar7 + 0x10), pcVar8 == (code *)0x0)) {
    ...
    case '\x02':
      ...
      *pval = pAVar2;
      ...
      goto LAB_001059ca;
    default:
      goto switchD_00105950_caseD_3;
    case '\x04':
      if (pvVar7 == (void *)0x0) {
        return 1;
      }
      goto switchD_00105950_caseD_4;
    case '\x05':
      goto switchD_00105950_caseD_5;
    }
  }
  switch(it->itype) {
  case '\0':
...
LAB_00105a70:
    ...
    *pval = pAVar2;
    if (pAVar2 == (ASN1_VALUE *)0x0) goto LAB_001059ca;
...
LAB_00105b4c:
    ...
    if ((uVar4 & 6) == 0) {
      ...
      if (pAVar2 != (ASN1_VALUE *)0x0) goto LAB_00105b4c;
      ERR_put_error(0xd,0x85,0x41,"crypto/asn1/tasn_new.c",0xe7);
    }
    goto LAB_001059ca;
  }
  iVar1 = asn1_primitive_new(pval,it);
  goto joined_r0x001059f6;
}
