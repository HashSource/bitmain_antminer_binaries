...

{
  ...
  local_2c = 0;
  local_1e4 = 0;
  puVar2 = (uchar *)CONF_parse_list(param_1,0x2c,1,(list_cb *)0x180139,&local_1d0);
  iVar5 = local_1c4;
  if (puVar2 != (uchar *)0x0) {
    *param_4 = 0xc2;
...
LAB_0017fa90:
        ...
        if (psVar11 != (stack_st_CONF_VALUE *)0x0) {
          ...
          do {
            ...
            if (iVar4 <= iVar5) goto LAB_0017fa90;
...
LAB_0017fada:
    ...
    OPENSSL_sk_pop_free(a,(undefined *)0x105ff5);
  ...
  psVar11 = local_1c0;
  if (local_1c0 == (stack_st_CONF_VALUE *)0x0) {
    psVar11 = (stack_st_CONF_VALUE *)0x1f936c;
  }
  switch(local_1c8) {
  case 1:
    if (iVar5 != 1) {
  ...
  case 10:
    ...
    if (pAVar8 != (ASN1_INTEGER *)0x0) goto LAB_0017fde0;
...
LAB_0017fe9e:
      ...
      iVar5 = CONF_parse_list((char *)psVar11,0x2c,1,(list_cb *)0x180005,pAVar6);
      if (iVar5 != 0) goto LAB_0017fde0;
  ...
  case 6:
    ...
    if (pAVar7 != (ASN1_OBJECT *)0x0) goto LAB_0017fde0;
