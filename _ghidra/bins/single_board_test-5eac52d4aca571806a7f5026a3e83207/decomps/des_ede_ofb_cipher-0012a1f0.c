...
undefined4 des_ede_ofb_cipher(undefined4 param_1,uchar *param_2,uchar *param_3,uint param_4)

{
  ...
  if (0x3fffffff < param_4) {
    ...
    do {
      ...
      DES_ede3_ofb64_encrypt
                (in,out,0x40000000,pDVar1,(DES_key_schedule *)(iVar2 + 0x80),
                 (DES_key_schedule *)(iVar3 + 0x100),pauVar4,local_2c);
    ...
    iVar2 = (uVar5 & 0xc0000000) + 0x40000000;
