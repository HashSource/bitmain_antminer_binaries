...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (type != (EVP_MD *)0x0) goto LAB_00125122;
    if (ctx->digest == (EVP_MD *)0x0) goto LAB_0012523c;
LAB_001251d6:
    ctx_00 = ctx->pctx;
    if (ctx_00 != (EVP_PKEY_CTX *)0x0) goto LAB_0012519c;
  }
  else {
...
LAB_0012523c:
    ...
    else if ((type == (EVP_MD *)0x0) || (type->type == ctx->digest->type)) goto LAB_001251d6;
LAB_00125122:
    ENGINE_finish(ctx->engine);
    if (impl == (ENGINE *)0x0) {
      impl = ENGINE_get_digest_engine(type->type);
      if (impl != (ENGINE *)0x0) goto LAB_00125138;
    }
    else {
...
LAB_00125138:
    ...
    pEVar4 = ctx->digest;
    ctx->engine = impl;
    if (type == pEVar4) goto LAB_001251d6;
    ...
    if ((int)(ctx->flags << 0x17) < 0) {
      ...
      ctx_00 = ctx->pctx;
      if (ctx_00 == (EVP_PKEY_CTX *)0x0) goto LAB_001251e0;
    }
LAB_0012519c:
  ...
  type = ctx->digest;
LAB_001251e0:
                    /* WARNING: Could not recover jumptable at 0x001251ea. Too many branches */
