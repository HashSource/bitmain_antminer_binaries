...

{
  ...
  if (((ctx == (EVP_PKEY_CTX *)0x0) || (*(int *)ctx == 0)) ||
    ...
    ERR_put_error(6,0x94,0x96,"crypto/evp/pmeth_gn.c",0x29);
    iVar1 = -2;
  }
    ...
    if (ppkey == (EVP_PKEY **)0x0) {
      ...
      if (pEVar2 == (EVP_PKEY *)0x0) {
        ...
        *ppkey = pEVar2;
        if (pEVar2 == (EVP_PKEY *)0x0) {
          ERR_put_error(6,0x94,0x41,"crypto/evp/pmeth_gn.c",0x39);
          return -1;
        }
    ...
    ERR_put_error(6,0x94,0x97,"crypto/evp/pmeth_gn.c",0x2e);
    iVar1 = -1;
  }
  return iVar1;
}
