...
/* WARNING: Heritage AFTER dead removal. Example location: r0 : 0x000f4488 */
...
LAB_000f4644:
    ...
    if (*(int *)(((int *)param_1->type)[0x19] + 0x30) << 0x1c < 0) goto LAB_000f47f4;
    ...
    if (iVar15 != 0) {
      ...
      if (iVar4 << 0x1c < 0) goto LAB_000f47f4;
    }
LAB_000f473a:
    iVar15 = 0;
...
LAB_000f4926:
      ...
      if ((0x303 < iVar4) && (iVar4 != 0x10000)) {
        ...
        if (iVar4 << 0x1c < 0) goto LAB_000f4b00;
        iVar4 = *piVar21;
      }
      if ((iVar4 == 0x10000) || (iVar4 < 0x304)) goto LAB_000f4b00;
    }
    else {
LAB_000f490c:
      ...
      if (iVar4 == 0) goto LAB_000f456c;
      piVar21 = (int *)param_1->type;
      if (-1 < *(int *)(piVar21[0x19] + 0x30) << 0x1c) goto LAB_000f4926;
LAB_000f4b00:
...
LAB_000f4990:
    ...
    if ((char)piVar23[0x57] != '\0') {
      ...
      do {
        if (piVar21 == (int *)(piVar23[0x56] + 0x15b + (int)piVar23)) goto LAB_000f4990;
      ...
      if ((((0x300 < param_1->version) && (-1 < *(int *)(piVar21[0x19] + 0x30) << 0x1c)) &&
        ...
        iVar15 = (*param_1[3].generate_session_id)
                           (param_1,(uchar *)(param_1[2].tlsext_ticket_expected + 0x48),
                            (uint *)&local_28);
        iVar4 = local_3c;
        if ((iVar15 == 0) || ((int)local_28 < 1)) goto LAB_000f4b56;
...
LAB_000f49dc:
      ...
      if (param_1->enc_write_ctx == (EVP_CIPHER_CTX *)0x0) {
        ...
        puVar22 = (uint *)0x0;
LAB_000f4d1c:
        if (param_1->enc_write_ctx == (EVP_CIPHER_CTX *)0x0) goto LAB_000f4300;
        piVar21 = (int *)param_1->type;
      }
      else {
        puVar22 = (uint *)0x0;
      ...
      if (((-1 < *(int *)(piVar21[0x19] + 0x30) << 0x1c) && (0x303 < *piVar21)) &&
         (*piVar21 != 0x10000)) goto LAB_000f4300;
    }
    OPENSSL_sk_free(local_3c);
    OPENSSL_sk_free(local_38);
    CRYPTO_free((void *)piVar23[0x9a]);
...
LAB_000f43b8:
    ...
    if (-1 < (int)ptr) {
      ...
      if (iVar4 != 0) {
        if (iVar15 == 0x10000) goto LAB_000f43b8;
        goto LAB_000f445a;
      }
    }
