...
LAB_000f738a:
    ...
    pSVar6 = ses;
    if (pcVar5 == (code *)0x0) goto LAB_000f73a2;
    if (0xf < param_3) {
      param_3 = 0x10;
    }
    ...
    case 3:
    case 4:
      if (1 < local_80) goto switchD_000f748e_default;
      if (iVar3 == 3) {
        uVar4 = 5;
        break;
      }
      uVar4 = 6;
      if (*(int *)(param_1 + 0x58c) != 0) goto LAB_000f73a8;
      goto LAB_000f73d4;
    default:
switchD_000f748e_default:
      uVar4 = 1;
    }
    if (*(int *)(param_1 + 0x58c) == 0) goto LAB_000f73da;
LAB_000f73a8:
    if ((*(int *)((*(int **)(param_1 + 4))[0x19] + 0x30) << 0x1c < 0) ||
       (iVar3 = **(int **)(param_1 + 4), iVar3 == 0x10000 || iVar3 < 0x304)) goto LAB_000f73da;
  }
  else {
    if ((((*(int *)((*(int **)(param_1 + 4))[0x19] + 0x30) << 0x1c < 0) ||
