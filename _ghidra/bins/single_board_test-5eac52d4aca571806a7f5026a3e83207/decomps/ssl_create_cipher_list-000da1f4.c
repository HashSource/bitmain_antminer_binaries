...
LAB_000da308:
        iVar14 = iVar14 + 1;
        iVar11 = iVar7;
        if (iVar5 == iVar14) goto LAB_000da310;
      }
...
LAB_000da5fc:
    ...
    if (iVar5 == 0) {
      ...
      if (iVar7 != 0) {
        ...
        *param_4 = iVar7;
        OPENSSL_sk_set_cmp_func(iVar7,0xdd4cd);
