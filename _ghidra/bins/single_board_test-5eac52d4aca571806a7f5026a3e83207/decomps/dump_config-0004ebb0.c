...

{
  ...
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : %schain:%d\n","dump_config",&DAT_001efb24,ctx->chain);
  snprintf(tmp1,0x100,"%schain:%d",&DAT_001efb24,ctx->chain);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : %sasics:%d\n","dump_config",&DAT_001efb24,ctx->asics);
  snprintf(tmp1,0x100,"%sasics:%d",&DAT_001efb24,ctx->asics);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : %sdomains:%d\n","dump_config",&DAT_001efb24,ctx->domains);
  snprintf(tmp1,0x100,"%sdomains:%d",&DAT_001efb24,ctx->domains);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : %sasics_in_domain:%d\n","dump_config",&DAT_001efb24,ctx->asics_in_domain);
  snprintf(tmp1,0x100,"%sasics_in_domain:%d",&DAT_001efb24,ctx->asics_in_domain);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : %sasic_domain_num:%d\n","dump_config",&DAT_001efb24,ctx->asic_domain_num);
  snprintf(tmp1,0x100,"%sasic_domain_num:%d",&DAT_001efb24,ctx->asic_domain_num);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : %sbig_core:%d\n","dump_config",&DAT_001efb24,ctx->big_core);
  snprintf(tmp1,0x100,"%sbig_core:%d",&DAT_001efb24,ctx->big_core);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : %sasic_small_cores:%d\n","dump_config",&DAT_001efb24,ctx->asic_small_cores);
  snprintf(tmp1,0x100,"%sasic_small_cores:%d",&DAT_001efb24,ctx->asic_small_cores);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : %ssamll_core_num_in_big_core:%d\n","dump_config",&DAT_001efb24,
         ctx->samll_core_num_in_big_core);
  snprintf(tmp1,0x100,"%ssamll_core_num_in_big_core:%d",&DAT_001efb24,
           ctx->samll_core_num_in_big_core);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : %spatter_num:%d\n","dump_config",&DAT_001efb24,ctx->patter_num);
  snprintf(tmp1,0x100,"%spatter_num:%d",&DAT_001efb24,ctx->patter_num);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : %sabnormal_core:%d\n","dump_config",&DAT_001efb24,ctx->abnormal_core);
  snprintf(tmp1,0x100,"%sabnormal_core:%d",&DAT_001efb24,ctx->abnormal_core);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : %sinterval:%d\n","dump_config",&DAT_001efb24,ctx->interval);
  snprintf(tmp1,0x100,"%sinterval:%d",&DAT_001efb24,ctx->interval);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  printf("%s : %s{\n","dump_config",&DAT_001efb24);
  snprintf(tmp1,0x100,"%s{",&DAT_001efb24);
  log_to_file(tmp1,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
