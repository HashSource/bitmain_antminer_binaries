...
undefined4 aria_ccm_ctrl(undefined4 param_1,undefined4 param_2,size_t param_3,int *param_4)

{
  ...
  case 0x10:
    ...
    iVar4 = CRYPTO_ccm128_tag(iVar2 + 0x138,param_4,param_3);
    if (iVar4 == 0) {
      return 0;
    }
    uVar6 = 1;
  ...
  case 0x16:
    ...
    *(undefined4 *)(iVar2 + 0x130) = 0xd;
    ...
    iVar4 = EVP_CIPHER_CTX_encrypting(param_1);
    if (iVar4 == 0) {
      if ((int)(uint)uVar7 < *(int *)(iVar2 + 300)) {
        return 0;
      }
      uVar7 = uVar7 - (short)*(int *)(iVar2 + 300);
    }
    iVar4 = EVP_CIPHER_CTX_buf_noconst(param_1);
    *(char *)(iVar4 + 0xb) = (char)(uVar7 >> 8);
    iVar4 = EVP_CIPHER_CTX_buf_noconst(param_1);
    *(char *)(iVar4 + 0xc) = (char)uVar7;
    return *(undefined4 *)(iVar2 + 300);
  case 0x25:
    *param_4 = 0xf - *(int *)(iVar2 + 0x128);
    return 1;
  }
  return uVar6;
}
