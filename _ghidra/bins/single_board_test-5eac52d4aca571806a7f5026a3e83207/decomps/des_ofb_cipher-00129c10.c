...
undefined4 des_ofb_cipher(undefined4 param_1,uchar *param_2,uchar *param_3,uint param_4)

{
  ...
  if (0x3fffffff < param_4) {
    ...
    do {
      ...
      DES_ofb64_encrypt(in,out,0x40000000,pDVar1,pauVar2,local_2c);
  ...
  if (param_4 != 0) {
    ...
    pDVar1 = (DES_key_schedule *)EVP_CIPHER_CTX_get_cipher_data(param_1);
    pauVar2 = (DES_cblock *)EVP_CIPHER_CTX_iv_noconst(param_1);
    DES_ofb64_encrypt(local_34,param_2,param_4,pDVar1,pauVar2,local_2c);
    EVP_CIPHER_CTX_set_num(param_1,local_2c[0]);
  }
  return 1;
}
