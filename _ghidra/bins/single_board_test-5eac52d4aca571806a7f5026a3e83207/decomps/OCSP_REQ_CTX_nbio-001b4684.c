  ...
  do {
    while( true ) {
      ...
      if (0x1005 < (int)uVar10) {
        if (uVar10 == 0x1007) goto LAB_001b480a;
        if ((int)uVar10 < 0x1007) goto LAB_001b46e8;
        if (uVar10 == 0x1008) {
          return 1;
        }
        if (uVar10 != 0x1009) {
...
LAB_001b47aa:
        ...
        pbVar12 = local_28;
        if (1 < lVar4) {
          if (*local_28 != 0x30) goto LAB_001b488a;
          ...
          if (bVar14) {
            ...
            pbVar12 = local_28 + 1;
            if (lVar4 < 6) goto LAB_001b4712;
            uVar10 = uVar10 & 0x7f;
            if (3 < uVar10 - 1) goto LAB_001b488a;
            pbVar11 = local_28 + 2;
            uVar9 = 0;
            pbVar12 = pbVar11;
            do {
            ...
            if (param_1[6] < uVar9) goto LAB_001b488a;
...
LAB_001b47d8:
        ...
        while ((sVar6 = BIO_ctrl((BIO *)param_1[4],3,0,&local_28), 0 < (int)sVar6 &&
          ...
          if ((int)uVar10 < 1) {
            ...
            pbVar12 = local_28;
            if (iVar3 == 0) goto LAB_001b488a;
            goto LAB_001b4712;
          }
          if (uVar10 == param_1[2]) goto LAB_001b488a;
          if (*param_1 == 1) {
            __nptr = (char *)param_1[1];
            cVar2 = *__nptr;
            while( true ) {
              if (cVar2 == '\0') goto LAB_001b493c;
...
LAB_001b4878:
            ...
            *pcVar13 = '\0';
            ...
            if (*local_24[0] != '\0') goto LAB_001b488a;
            __s = pcVar13 + 1;
            cVar2 = pcVar13[1];
            while (cVar2 != '\0') {
              iVar3 = ossl_ctype_check(cVar2,8);
        ...
        pbVar12 = local_28;
        if ((int)param_1[2] <= (int)sVar6) goto LAB_001b488a;
      }
LAB_001b4712:
      local_28 = pbVar12;
      uVar10 = *param_1;
...
LAB_001b46e8:
    ...
    if (iVar3 < 1) goto LAB_001b49c4;
    uVar10 = param_1[5];
    param_1[5] = uVar10 - iVar3;
    pbVar12 = local_28;
    if (uVar10 - iVar3 != 0) goto LAB_001b4712;
    *param_1 = 0x1007;
