...
LAB_000d2046:
      ...
      *(undefined4 *)(param_1 + 0xf00) = 0;
      if (*(int *)(param_1 + 0x688) != 0) goto LAB_000d1fee;
    }
    else {
      *(undefined4 *)(param_1 + 0xf00) = 0;
    }
    ...
    if (param_4 < *(int *)(param_1 + 0xf10) + uVar12) goto LAB_000d2206;
    iVar1 = *(int *)(param_1 + 0x68);
    bVar13 = iVar1 != 4;
    if (bVar13) {
      iVar1 = 0;
    }
    if (!bVar13) goto LAB_000d2046;
...
LAB_000d20a8:
      ...
      if ((-1 < (int)(uVar4 << 8)) ||
         (-1 < *(int *)(*(int *)(*(int *)(param_1 + 4) + 100) + 0x30) << 0x1f)) goto LAB_000d20a8;
    }
