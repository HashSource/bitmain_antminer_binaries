...
LAB_000424f2:
        if (Mes_System_Test_Config_ptr != (Mes_System_Test_Config *)0x0) {
          iVar6 = strcmp(Mes_System_Test_Config_ptr->chip_technology,chip_technology);
          if (((iVar6 != 0) ||
              (iVar6 = strcmp(Mes_System_Test_Config_ptr->ft_version,ft_version), iVar6 != 0)) ||
             (Mes_System_Test_Config_ptr->bin != bin)) goto LAB_000424de;
