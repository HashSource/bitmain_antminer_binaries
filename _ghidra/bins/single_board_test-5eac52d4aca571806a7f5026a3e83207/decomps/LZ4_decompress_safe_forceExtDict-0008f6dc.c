...
/* WARNING: Removing unreachable block (ram,0x0008fbe8) */
/* WARNING: Removing unreachable block (ram,0x0008fbf2) */
/* WARNING: Removing unreachable block (ram,0x0008fbf4) */
/* WARNING: Removing unreachable block (ram,0x0008fbf6) */
/* WARNING: Removing unreachable block (ram,0x0008fbfc) */
/* WARNING: Removing unreachable block (ram,0x0008f7c6) */
...
LAB_0008f924:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_00090086;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_00090086;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar5) == 0) goto LAB_0008f924;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_00090086;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar6 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_00090086;
              op = pBVar11;
