...

{
  ...
  if (local_30 - 1 < 10) {
    unaff_r5 = (code *)((int)&switchD_00104730::switchdataD_00104734 +
                       (&switchD_00104730::switchdataD_00104734)[local_30 - 1]);
    switch(local_30) {
    case 1:
...
switchD_00104730_caseD_4:
  ...
  if (param_2 == (uchar **)0x0) goto LAB_001046ca;
  ...
  if ((*(int *)(param_3 + 0x10) == 0) ||
    ...
    if (*param_3 == '\0') {
      ...
      if (iVar6 != 1) {
        puVar5 = (uint *)*param_1;
        if (puVar5 == (uint *)0x0) goto switchD_00104784_caseD_5;
LAB_0010476e:
        if (iVar6 == -4) {
          param_1 = puVar5 + 1;
          local_30 = *puVar5;
...
LAB_0010489a:
        ...
        if (uVar4 == 0) {
          if (*(int *)(param_3 + 0x14) != 0) goto LAB_0010489a;
        }
        else if (*(int *)(param_3 + 0x14) < 1) goto LAB_0010489a;
      }
      break;
    case 2:
    case 10:
