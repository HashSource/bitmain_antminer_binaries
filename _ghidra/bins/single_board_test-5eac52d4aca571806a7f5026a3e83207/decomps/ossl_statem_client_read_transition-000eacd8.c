...

{
  ...
  if (puVar4 == (undefined1 *)0x0) {
    ...
    if (piVar1 == (int *)0x10000 || (int)piVar1 < 0x304) {
      ...
      case (void *)0x1:
        goto switchD_000eadd0_caseD_1;
      case (void *)0x3:
        goto switchD_000eadd0_caseD_3;
      case (void *)0x4:
        goto switchD_000eadd0_caseD_4;
      case (void *)0x5:
        goto switchD_000eadd0_caseD_5;
      case (void *)0x6:
        goto switchD_000eadd0_caseD_6;
      case (void *)0x7:
        goto switchD_000eadd0_caseD_7;
      case (void *)0x9:
        goto switchD_000eadd0_caseD_9;
      case (void *)0xa:
        goto switchD_000eadd0_caseD_a;
      case (void *)0xc:
        goto switchD_000eadd0_caseD_c;
      case (void *)0x12:
        goto switchD_000eadd0_caseD_12;
      case (void *)0x2e:
        goto switchD_000eadd0_caseD_2e;
      }
      goto switchD_000eadd0_caseD_2;
    }
...
LAB_000eafd4:
    ...
    case (EVP_CIPHER_CTX *)0x25:
      ...
      if (pEVar6 != (EVP_CIPHER_CTX *)0x0) goto switchD_000ead0c_caseD_26;
      pEVar6 = (EVP_CIPHER_CTX *)0x0;
      if (param_2 == 0xd) goto LAB_000eafd4;
...
switchD_000ead0c_caseD_26:
    ...
    goto switchD_000ead0c_caseD_1;
  }
  pvVar7 = (void *)((int)param_1->init_msg + -1);
  switch(pvVar7) {
  case (void *)0x0:
switchD_000eadd0_caseD_1:
    if (param_2 == 0) {
  ...
  default:
    ...
    goto LAB_000eae5c;
  case (void *)0x2:
switchD_000eadd0_caseD_3:
    if (param_1->enc_write_ctx != (EVP_CIPHER_CTX *)0x0) goto switchD_000eadd0_caseD_12;
    if (puVar4 != (undefined1 *)0x0) {
      puVar4 = (undefined1 *)0x1;
    }
    if (param_2 == 3) {
...
LAB_000eaf02:
    ...
    if ((uVar5 & 0x1a6) != 0) {
      if (param_2 == 0xc) goto LAB_000eaeb8;
      goto LAB_000eae5c;
    }
    if ((uVar5 & 0x1c8) != 0 && param_2 == 0xc) goto LAB_000eaeb8;
    if (param_2 != 0xd) {
      if (param_2 == 0xe) goto LAB_000eb076;
      goto LAB_000eae5c;
    }
    if ((0x300 < (int)piVar1) && ((int)(uVar3 << 0x1d) < 0)) goto switchD_000eadd0_caseD_2;
    goto joined_r0x000eaf3c;
  case (void *)0x3:
switchD_000eadd0_caseD_4:
...
switchD_000eadd0_caseD_6:
    if (param_2 != 0xd) {
switchD_000eadd0_caseD_7:
      if (param_2 == 0xe) {
LAB_000eb076:
...
LAB_000eaf1a:
    ...
    if (uVar3 != 0) goto LAB_000eaf02;
    goto LAB_000eae5c;
  case (void *)0x11:
switchD_000eadd0_caseD_12:
    if (param_1[3].compress == (COMP_CTX *)0x0) goto switchD_000eadd0_caseD_9;
    if (param_2 == 4) {
    ...
    break;
  case (void *)0x2d:
switchD_000eadd0_caseD_2e:
    if (param_2 == 2) goto LAB_000eaf1a;
  }
switchD_000ead0c_caseD_1:
  if (puVar4 != (undefined1 *)0x0) {
    puVar4 = (undefined1 *)0x1;
  }
LAB_000eae5c:
