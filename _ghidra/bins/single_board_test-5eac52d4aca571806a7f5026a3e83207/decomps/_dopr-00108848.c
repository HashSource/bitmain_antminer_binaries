...
joined_r0x0010887a:
  do {
    if (uVar11 == 0) goto LAB_0010887c;
    if ((param_2 == 0) && (uVar6 = *param_3, uVar6 <= local_2c[0])) goto LAB_00108bee;
    switch(uVar12) {
    case 0:
      if (uVar11 == 0x25) {
        uVar12 = 1;
...
joined_r0x00108aa8:
    ...
    case 2:
      ...
      break;
    case 3:
      if (uVar11 != 0x2e) goto LAB_00108a4a;
      uVar11 = (uint)*param_6;
      uVar12 = 4;
      param_6 = (byte *)((int)param_6 + 1);
      break;
...
LAB_00108a4a:
    ...
    case 5:
      ...
      case 0x4c:
        ...
        param_6 = (byte *)((int)param_6 + 1);
        uVar12 = 6;
        goto joined_r0x0010887a;
      default:
        goto switchD_00108986_caseD_4d;
      case 0x68:
        iVar13 = 1;
        uVar11 = (uint)*param_6;
        uVar12 = 6;
      ...
      case 0x7a:
        ...
        iVar13 = 5;
        uVar12 = 6;
        goto joined_r0x00108aa8;
      }
      param_6 = param_6 + 1;
switchD_00108986_caseD_4d:
      uVar12 = 6;
      break;
    case 6:
      switch(uVar11) {
      case 0x25:
        ...
        break;
      default:
        goto switchD_001088d0_caseD_26;
      case 0x45:
        uVar7 = uVar7 | 0x20;
      case 0x65:
...
LAB_00108b54:
      ...
      case 0x73:
        ...
        if ((int)local_58 < 0) {
          ...
          if (-1 < (int)local_58) goto LAB_00108c90;
          local_44 = OPENSSL_strnlen(pcVar14,0xffffffff);
          uVar12 = uVar10 - local_44;
          if (-1 < (int)(uVar12 | uVar10)) goto LAB_00108cbe;
          if ((uVar7 & 1) == 0) {
            iVar13 = 0;
            uVar12 = 0;
            goto LAB_00108f90;
...
LAB_00108cbe:
          if ((uVar7 & 1) != 0) goto LAB_00108ede;
          if (uVar12 == 0) {
            iVar13 = 0;
            uVar12 = 0;
          }
            ...
            local_3c = local_58 >> 0x1f;
            if (local_58 == 0) goto switchD_001088d0_caseD_26;
            uVar11 = param_2;
            if (param_2 != 0) {
              uVar11 = 1;
            }
            ...
            do {
              ...
              uVar12 = uVar12 - 1;
              if (uVar12 == 0) {
                if (local_44 != 0) goto LAB_00108ef0;
                goto switchD_001088d0_caseD_26;
              }
              uVar7 = local_58 >> 0x1f;
...
LAB_00108f90:
          if (local_44 == 0) goto switchD_001088d0_caseD_26;
          local_3c = local_58 >> 0x1f;
        }
LAB_00108ef0:
        uVar11 = local_3c;
        ...
        if (uVar11 != 0) {
          ...
          do {
            ...
            if (pcVar14 + 1 == pcVar9) goto LAB_00108fae;
            uVar7 = local_3c;
            if (local_44 < (int)local_58) {
              uVar7 = 1;
            }
...
switchD_001088d0_caseD_26:
      ...
      break;
    default:
      goto switchD_001088ba_default;
    }
  } while( true );
switchD_001088ba_default:
  if (uVar12 == 7) {
LAB_0010887c:
    if (param_2 == 0) {
      uVar6 = *param_3;
