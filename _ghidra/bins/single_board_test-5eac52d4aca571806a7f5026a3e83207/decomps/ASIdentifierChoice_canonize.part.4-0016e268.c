  ...
  if (0 < iVar1 + -1) {
    do {
      ...
      if (*piVar2 == 0) {
        ...
        if (*piVar2 != 1) goto LAB_0016e3be;
        pAVar7 = (ASN1_INTEGER *)((undefined4 *)piVar2[1])[1];
        local_38 = *(ASN1_INTEGER **)piVar2[1];
      }
      if (a == (ASIdOrRange *)0x0) goto LAB_0016e3c0;
      if (a->type == 0) {
        y = (a->u).id;
        local_30 = y;
      }
      else {
        if (a->type != 1) goto LAB_0016e3be;
        y = ((a->u).range)->min;
      ...
      if (((0 < iVar3) || (iVar3 = ASN1_INTEGER_cmp(local_38,pAVar7), 0 < iVar3)) ||
         (iVar3 = ASN1_INTEGER_cmp(y,local_30), 0 < iVar3)) goto LAB_0016e3be;
      ...
      if (iVar3 == 0) {
        if (*piVar2 == 0) {
          ...
          *piVar2 = 1;
          ...
          if (pAVar7 != (ASN1_INTEGER *)0x0) goto LAB_0016e36c;
LAB_0016e40a:
          (a->u).id = pAVar7;
        }
        else {
          ...
          pAVar7 = (ASN1_INTEGER *)a->type;
          if (pAVar7 == (ASN1_INTEGER *)0x0) goto LAB_0016e40a;
LAB_0016e36c:
