...

{
  ...
  json_t *CtrlBoard_Sensor_Addr_array [4];
  ...
  CtrlBoard_Sensor_Addr_array[2] = (json_t *)0x0;
  CtrlBoard_Sensor_Addr_array[3] = (json_t *)0x0;
                                    ...
                                    if ((pjVar7 == (json_t *)0x0) || (pjVar7->type != JSON_STRING))
                                    {
                                      ...
                                      if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_ARRAY))
                                      {
                                        ...
                                        if (gCtrlBoard_sensor_num < 5) {
                                          ...
                                          log_to_file(tmp1,time_stamp);
                                          memset(gCtrlBoard_sensor_low_3_bits_addr,0,4);
