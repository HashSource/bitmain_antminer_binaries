...
LAB_00102732:
    if (param_5 == 0xffffffff) goto LAB_00102816;
  }
  pbVar7 = (byte *)*param_2;
  local_4c = pbVar7;
  local_3c = pbVar7;
  if (param_8 == (byte *)0x0) {
    ...
    if (-1 < (int)(uVar1 << 0x18)) goto LAB_00102768;
...
LAB_00102a54:
  ...
  case 3:
    ...
    goto joined_r0x00102a2e;
  default:
    if (uVar1 == 0x1e) {
      if (-1 < (int)omax << 0x1f) goto LAB_00102ad0;
