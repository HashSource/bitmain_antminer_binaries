...

{
  ...
  if (param_4 == (undefined1 *)0x0) {
    ...
    param_5 = local_ac;
    if (param_3 == 0) goto LAB_000f9374;
LAB_000f9210:
...
LAB_000f9338:
    ...
    if (param_3 != 0) goto LAB_000f9210;
LAB_000f9374:
    p2 = &default_zeros;
    local_b4 = param_3;
  }
  ...
  if (0 < iVar1) {
    ...
    if ((((0 < iVar1) && (iVar1 = EVP_PKEY_CTX_ctrl(ctx,-1,0x400,0x1003,0,param_2), 0 < iVar1)) &&
       ...
       ((iVar1 = EVP_PKEY_CTX_ctrl(ctx,-1,0x400,0x1004,local_b4,p2), 0 < iVar1 &&
        (iVar1 = EVP_PKEY_derive(ctx,param_6,&local_ac), 0 < iVar1)))) goto LAB_000f9324;
  }
  uVar2 = 0;
