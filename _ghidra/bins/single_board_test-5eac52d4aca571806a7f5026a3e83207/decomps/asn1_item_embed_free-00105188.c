...

{
  ...
  if (cVar1 != '\0') {
    ...
    if (pvVar4 != (void *)0x0) goto LAB_0010519e;
    switch(cVar1) {
    case '\x01':
    case '\x06':
switchD_001052ea_caseD_1:
      iVar2 = asn1_do_lock(param_1,-1,param_2);
      if (iVar2 != 0) {
        return;
      }
      asn1_enc_free(param_1,param_2);
      if (param_2->tcount < 1) goto LAB_001052c8;
...
LAB_0010528a:
      ...
      if (pcVar6 == (code *)0x0) goto LAB_001052c8;
      break;
    case '\x02':
switchD_001052ea_caseD_2:
...
LAB_00105362:
        ...
        if (pcVar6 != (code *)0x0) goto LAB_001051de;
      }
joined_r0x00105384:
      if (param_3 == 0) {
        CRYPTO_free(*param_1);
    ...
    default:
      goto switchD_001051ae_caseD_3;
    case '\x05':
      goto switchD_001051ae_caseD_5;
    }
LAB_001052be:
...
LAB_0010519e:
  ...
  if (pcVar6 != (code *)0x0) {
    ...
    case '\x06':
      ...
      asn1_enc_free(param_1,param_2);
      pAVar5 = param_2->templates + param_2->tcount;
      if (0 < param_2->tcount) goto LAB_0010528a;
      goto LAB_001052be;
    case '\x02':
      iVar2 = (*pcVar6)(2,param_1,param_2,0);
      if (iVar2 == 2) {
      ...
      iVar2 = asn1_get_choice_selector(param_1,param_2);
      if ((-1 < iVar2) && (iVar2 < param_2->tcount)) goto LAB_00105362;
LAB_001051de:
      (*pcVar6)(3,param_1,param_2,0);
      goto joined_r0x00105384;
    default:
      goto switchD_001051ae_caseD_3;
    case '\x04':
switchD_001051ae_caseD_4:
      if (*(code **)((int)pvVar4 + 8) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00105250. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (**(code **)((int)pvVar4 + 8))(param_1,param_2);
        return;
      }
switchD_001051ae_caseD_3:
      return;
    case '\x05':
      goto switchD_001051ae_caseD_5;
    }
  ...
  case '\x01':
  case '\x06':
    goto switchD_001052ea_caseD_1;
  case '\x02':
    goto switchD_001052ea_caseD_2;
  default:
    goto switchD_001051ae_caseD_3;
  case '\x04':
    goto switchD_001051ae_caseD_4;
  case '\x05':
    goto switchD_001051ae_caseD_5;
  }
}
