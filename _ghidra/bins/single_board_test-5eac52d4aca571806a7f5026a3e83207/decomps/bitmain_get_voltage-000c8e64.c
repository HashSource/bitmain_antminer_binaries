...

{
  ...
  if (!bVar4 || (uVar3 == 0x62 || _g_power_state.power_version - 100 == 2)) {
    ...
    if (iVar2 == 0) {
      ...
      uVar7 = (uint)(0.0 < fVar5 * extraout_s5) * (int)(fVar5 * extraout_s5);
    }
    else {
  ...
  else if ((_g_power_state.power_open == 0) && (uVar7 = bitmain_power_open(), (int)uVar7 < 0)) {
    ...
    if (iVar2 == 0) {
      ...
      uVar7 = (uint)(0.0 < dVar6 * 100.0) * (int)(longlong)(dVar6 * 100.0);
    }
    else {
