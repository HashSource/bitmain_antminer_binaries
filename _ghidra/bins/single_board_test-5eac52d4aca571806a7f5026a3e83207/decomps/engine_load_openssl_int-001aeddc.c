...

{
  ...
  if (((iVar1 != 0) && (iVar1 = ENGINE_set_name(e,"Software engine support"), iVar1 != 0)) &&
     (iVar1 = ENGINE_set_destroy_function(e,(ENGINE_GEN_INT_FUNC_PTR)0x1aeb79), iVar1 != 0)) {
      ...
      if (iVar1 != 0) {
        ...
        if (iVar1 != 0) {
          ...
          if (iVar1 != 0) {
            ...
            if (((iVar1 != 0) &&
                (iVar1 = ENGINE_set_ciphers(e,(ENGINE_CIPHERS_PTR)0x1aeacd), iVar1 != 0)) &&
               ((iVar1 = ENGINE_set_digests(e,(ENGINE_DIGESTS_PTR)0x1aec25), iVar1 != 0 &&
                (iVar1 = ENGINE_set_load_privkey_function(e,(ENGINE_LOAD_KEY_PTR)0x1ae941),
                iVar1 != 0)))) {
              ENGINE_add(e);
              ENGINE_free(e);
              ERR_clear_error();
