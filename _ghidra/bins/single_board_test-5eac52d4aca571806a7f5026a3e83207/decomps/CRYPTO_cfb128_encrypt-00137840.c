...

{
  ...
  if (param_7 != 0) {
    ...
    uVar9 = param_3;
    if (param_3 < 0x10) {
      if (param_3 == 0) goto LAB_00137954;
      (*param_8)(param_5,param_5,param_4);
      iVar8 = param_3 - 1;
    }
    else {
    ...
    if ((((uint)pbVar1 | (uint)pbVar16 | (uint)pbVar2) & 3) != 0 ||
      ...
      *(byte *)(param_5 + uVar11) = bVar6;
      ...
      if (iVar8 == 0) goto LAB_00137d08;
      iVar3 = uVar11 + 2;
      bVar6 = *(byte *)(param_5 + iVar14) ^ param_1[iVar14];
      *(byte *)(param_5 + iVar14) = bVar6;
      param_2[iVar14] = bVar6;
      if (iVar8 == 1) goto LAB_00137d08;
      iVar14 = uVar11 + 3;
      bVar6 = *(byte *)(param_5 + iVar3) ^ param_1[iVar3];
      *(byte *)(param_5 + iVar3) = bVar6;
      param_2[iVar3] = bVar6;
      if (iVar8 == 2) goto LAB_00137d08;
      bVar6 = *(byte *)(param_5 + iVar14) ^ param_1[iVar14];
      *(byte *)(param_5 + iVar14) = bVar6;
      param_2[iVar14] = bVar6;
      if (iVar8 == 3) goto LAB_00137d08;
      iVar14 = uVar11 + 5;
      bVar6 = *(byte *)(param_5 + iVar13) ^ param_1[iVar13];
      *(byte *)(param_5 + iVar13) = bVar6;
      param_2[iVar13] = bVar6;
      if (iVar8 == 4) goto LAB_00137d08;
      iVar13 = uVar11 + 6;
      bVar6 = *(byte *)(param_5 + iVar14) ^ param_1[iVar14];
      *(byte *)(param_5 + iVar14) = bVar6;
      param_2[iVar14] = bVar6;
      if (iVar8 == 5) goto LAB_00137d08;
      iVar14 = uVar11 + 7;
      bVar6 = *(byte *)(param_5 + iVar13) ^ param_1[iVar13];
      *(byte *)(param_5 + iVar13) = bVar6;
      param_2[iVar13] = bVar6;
      if (iVar8 == 6) goto LAB_00137d08;
      iVar13 = uVar11 + 8;
      bVar6 = *(byte *)(param_5 + iVar14) ^ param_1[iVar14];
      *(byte *)(param_5 + iVar14) = bVar6;
      param_2[iVar14] = bVar6;
      if (iVar8 == 7) goto LAB_00137d08;
      iVar14 = uVar11 + 9;
      bVar6 = *(byte *)(param_5 + iVar13) ^ param_1[iVar13];
      *(byte *)(param_5 + iVar13) = bVar6;
      param_2[iVar13] = bVar6;
      if (iVar8 == 8) goto LAB_00137d08;
      iVar13 = uVar11 + 10;
      bVar6 = *(byte *)(param_5 + iVar14) ^ param_1[iVar14];
      *(byte *)(param_5 + iVar14) = bVar6;
      param_2[iVar14] = bVar6;
      if (iVar8 == 9) goto LAB_00137d08;
      iVar14 = uVar11 + 0xb;
      bVar6 = *(byte *)(param_5 + iVar13) ^ param_1[iVar13];
      *(byte *)(param_5 + iVar13) = bVar6;
      param_2[iVar13] = bVar6;
      if (iVar8 == 10) goto LAB_00137d08;
      iVar13 = uVar11 + 0xc;
      bVar6 = *(byte *)(param_5 + iVar14) ^ param_1[iVar14];
      *(byte *)(param_5 + iVar14) = bVar6;
      param_2[iVar14] = bVar6;
      if (iVar8 == 0xb) goto LAB_00137d08;
      iVar14 = uVar11 + 0xd;
      bVar6 = *(byte *)(param_5 + iVar13) ^ param_1[iVar13];
      *(byte *)(param_5 + iVar13) = bVar6;
      param_2[iVar13] = bVar6;
      if (iVar8 == 0xc) goto LAB_00137d08;
      iVar13 = uVar11 + 0xe;
      bVar6 = *(byte *)(param_5 + iVar14) ^ param_1[iVar14];
      *(byte *)(param_5 + iVar14) = bVar6;
      param_2[iVar14] = bVar6;
      if (iVar8 == 0xd) goto LAB_00137d08;
    }
    else {
      iVar14 = (iVar8 - 3U >> 2) + 1;
      ...
      *(uint *)(param_2 + uVar11) = uVar9;
      ...
      if (iVar14 * 4 == iVar8 + 1U) goto LAB_00137d08;
      iVar14 = iVar13 + 1;
      bVar6 = *(byte *)(param_5 + iVar13) ^ param_1[iVar13];
      *(byte *)(param_5 + iVar13) = bVar6;
      param_2[iVar13] = bVar6;
      if (iVar3 == 0) goto LAB_00137d08;
      iVar13 = iVar13 + 2;
      bVar6 = *(byte *)(param_5 + iVar14) ^ param_1[iVar14];
      *(byte *)(param_5 + iVar14) = bVar6;
      param_2[iVar14] = bVar6;
      if (iVar3 == 1) goto LAB_00137d08;
    }
    bVar6 = *(byte *)(param_5 + iVar13) ^ param_1[iVar13];
    *(byte *)(param_5 + iVar13) = bVar6;
    param_2[iVar13] = bVar6;
...
LAB_00137954:
  ...
  if ((((uint)pbVar2 | (uint)pbVar5 | (uint)pbVar17) & 3) == 0 &&
    ...
    *(uint *)(param_5 + uVar11) = uVar9;
    ...
    iVar13 = uVar11 + iVar14 * 4;
    iVar3 = iVar8 + iVar14 * -4;
    if (iVar8 + 1U == iVar14 * 4) goto LAB_00137d08;
