...
LAB_0016af12:
      ...
      *(uint *)(local_54 + 4) = uVar1;
      ...
      if (puVar8 == (uint *)0x0) goto LAB_0016aef6;
...
LAB_0016b4da:
      ...
      local_44 = uVar17 & 4;
      if (local_44 != 0) goto LAB_0016ae5a;
    }
    local_44 = uVar17 & 2;
    if (local_44 != 0) {
LAB_0016ada8:
...
LAB_0016b13e:
  ...
  if (iVar2 == 0) {
    ...
    if ((1 < iVar19) && (iVar19 = *(int *)(iVar16 + 8), iVar19 != 0)) goto LAB_0016b1ce;
LAB_0016b30e:
