...
LAB_000d059e:
          ...
          uVar5 = param_1[5].options;
          if (uVar5 != 0x15) goto LAB_000d059e;
        }
...
LAB_000d06ee:
          ...
          if (uVar5 == 0x14) {
            if (param_3 != (ulong *)0x0 && param_2 == 0x16) goto LAB_000d07e2;
            if ((int)(uVar8 << 0x1f) < 0) {
LAB_000d08f0:
              param_1->bbio = (BIO *)0x1;
              param_1[5].tlsext_debug_arg = (void *)0x1;
...
LAB_000d091c:
                ...
                if (uVar5 != 0x17) goto LAB_000d091c;
