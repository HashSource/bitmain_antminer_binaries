...
LAB_001663e4:
  ...
  if (0 < iVar3) {
    if (iVar1 != 0) {
      ...
      if (*(int *)(&minbits_table + (iVar3 + -1) * 4) <= iVar1) goto LAB_001662d8;
    }
...
LAB_00166364:
    ...
    if (iVar1 == 0) {
      if (((psVar5[1].stack.num & 5U) != 0) || (-1 < (int)psVar5[1].stack.data)) goto LAB_00166364;
