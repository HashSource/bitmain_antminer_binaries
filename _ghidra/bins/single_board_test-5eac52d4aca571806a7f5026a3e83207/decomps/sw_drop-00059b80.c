...

{
  ...
  else if ((eep_ctx->data).field_2.raw[0x59] == '\x01') {
    if ((eep_ctx->data).field_2.format_v1.sweep.sweep_hashrate == 0x2b67) {
      print_time_stamp(time_stamp,0x30);
      printf("%s ",time_stamp);
      ...
      freq = (int)(eep_ctx->data).field_2.format_v1.pt2.frequency;
