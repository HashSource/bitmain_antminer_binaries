...
/* WARNING: Removing unreachable block (ram,0x001488da) */
/* WARNING: Removing unreachable block (ram,0x001488ce) */
/* WARNING: Removing unreachable block (ram,0x001488fc) */
/* WARNING: Removing unreachable block (ram,0x00148a8a) */
/* WARNING: Removing unreachable block (ram,0x00148a96) */
/* WARNING: Removing unreachable block (ram,0x00148900) */
...
LAB_00148938:
        ...
        piVar5 = __errno_location();
        iVar4 = *piVar5;
        if (iVar4 != 0x26) goto LAB_00148938;
        lVar6 = syscall(0x180,uVar3,iVar2,0);
        if (0 < lVar6) goto LAB_00148920;
        if (lVar6 != 0) {
          iVar4 = *piVar5;
          goto LAB_00148938;
        }
    ...
    if (__nbytes != 0) {
      ...
      do {
        if ((((*(int *)(iVar2 + -0x34) == -1) ||
          ...
          iVar7 = open((&random_device_paths)[uVar10],0);
          ...
          if (iVar7 != -1) {
            ...
            do {
              while( true ) {
                ...
                iVar4 = 2;
                if (__nbytes == 0) goto LAB_00148a1e;
              }
              if ((sVar8 != 0) && (piVar5 = __errno_location(), *piVar5 != 4)) goto LAB_00148a24;
              bVar1 = 0 < iVar4;
              iVar4 = iVar4 + -1;
            } while (bVar1);
            if (sVar8 < 0) {
...
LAB_00148a1e:
              if (keep_random_devices_open == 0) goto LAB_00148a24;
            }
            __nbytes = rand_pool_bytes_needed(param_1,1);
          }
        }
