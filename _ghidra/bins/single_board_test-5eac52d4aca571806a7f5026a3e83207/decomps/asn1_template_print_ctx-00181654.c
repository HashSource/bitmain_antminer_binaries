  ...
  if ((uVar6 & 6) != 0) {
    ...
    if (0 < iVar1) {
      do {
        ...
        if (pAVar9->itype != '\0') {
          if (local_88 == (ASN1_UTCTIME *)0x0) goto LAB_00181742;
          switch(pAVar9->itype) {
          case '\x01':
          case '\x06':
            if (local_a8 != (code *)0x0) {
          ...
          case '\x04':
            ...
            break;
          case '\x05':
            goto switchD_001817d2_caseD_5;
          }
          goto LAB_0018175c;
        }
        if ((pAVar9->utype != 1) && (local_88 == (ASN1_UTCTIME *)0x0)) {
LAB_00181742:
          if (-1 < (int)(*param_5 << 0x1f)) goto LAB_0018175c;
          iVar1 = BIO_puts(param_1,"<ABSENT>\n");
          goto joined_r0x00181758;
        }
...
switchD_00181abe_caseD_1:
          iVar1 = *piVar15;
          if (iVar1 == -1) {
            iVar1 = pAVar9->size;
            pcVar8 = "BOOL ABSENT";
            if (iVar1 != -1) goto LAB_00181bae;
          }
          else {
LAB_00181bae:
            pcVar8 = local_94;
...
LAB_00181940:
        if (uVar6 == 0xfffffffc) {
          ...
          if ((int)(*param_5 << 0x1b) < 0) goto LAB_00181956;
          pcVar8 = ASN1_tag2str(uVar6);
LAB_00181a8a:
          if (uVar6 == 5) goto LAB_0018195e;
          if (pcVar8 != (char *)0x0) {
...
LAB_0018195e:
        ...
        case 4:
          ...
          if (a_00->length < 1) goto LAB_0018175c;
...
LAB_001819b2:
  ...
  if ((pAVar9->utype != 1) && ((ASN1_VALUE *)*param_2 == (ASN1_VALUE *)0x0)) goto LAB_001819b2;
  if (pAVar9->templates != (ASN1_TEMPLATE *)0x0) {
...
LAB_00181eb2:
  if (uVar6 != 0xfffffffc) {
    if ((int)(*param_5 << 0x1c) < 0) goto LAB_00181f3e;
LAB_00181ec0:
    if (uVar6 != 5) goto LAB_00181f68;
LAB_00181ec4:
    iVar1 = BIO_puts(param_1,"NULL\n");
    goto joined_r0x00181fac;
  }
  param_2 = &a->type;
  uVar6 = a->length;
  a = (ASN1_GENERALIZEDTIME *)a->type;
  if ((int)(*param_5 << 0x1b) < 0) goto LAB_00181ec0;
LAB_00181f3e:
  pcVar8 = ASN1_tag2str(uVar6);
  if (uVar6 == 5) goto LAB_00181ec4;
  if (pcVar8 != (char *)0x0) {
    iVar1 = BIO_puts(param_1,pcVar8);
    if (iVar1 < 1) {
      return 0;
