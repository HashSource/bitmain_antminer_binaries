        ...
        *pclass = uVar11 & 0xc0;
        if (0 < iVar8) {
          ...
          if (uVar6 == 0x80) {
            ...
            *plength = 0;
            uVar6 = 1;
            if ((bVar1 & 0x20) == 0) goto LAB_00101940;
          }
          else {
            uVar7 = uVar6 & 0x7f;
            pbVar9 = unaff_r10 + 1;
            if ((int)(uVar6 << 0x18) < 0) {
              if (iVar8 + -1 <= (int)uVar7) goto LAB_00101940;
              if ((*unaff_r10 & 0x7f) == 0) {
LAB_00101a34:
                uVar7 = 0;
              }
                ...
                if (unaff_r10[1] == 0) {
                  ...
                  do {
                    pbVar9 = pbVar5;
                    uVar6 = uVar6 - 1;
                    if (uVar6 == 0) goto LAB_00101a34;
                    pbVar5 = pbVar9 + 1;
                  } while (*pbVar9 == 0);
                }
                if (4 < (int)uVar6) goto LAB_00101940;
                uVar7 = (uint)*pbVar9;
                if (uVar6 != 1) {
                ...
                pbVar9 = pbVar9 + uVar6;
                if ((int)uVar7 < 0) goto LAB_00101940;
              }
            }
            uVar6 = 0;
            *plength = uVar7;
