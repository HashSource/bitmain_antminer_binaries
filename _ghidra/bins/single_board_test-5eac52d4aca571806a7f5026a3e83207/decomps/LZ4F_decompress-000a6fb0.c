...
switchD_000a7070_caseD_9:
    ...
    case dstage_getSuffix:
      ...
      if ((dctx->frameInfo).contentChecksumFlag != LZ4F_noContentChecksum) {
        ...
        if (dctx->dStage == dstage_storeSuffix) goto switchD_000a7070_caseD_b;
        goto LAB_000a7b40;
      }
      nextSrcSizeHint = 0;
...
LAB_000a7b40:
    ...
    case dstage_getSFrameSize:
      ...
      if (dctx->dStage == dstage_storeSFrameSize) goto switchD_000a7070_caseD_d;
      goto LAB_000a7c3c;
    case dstage_storeSFrameSize:
switchD_000a7070_caseD_d:
      uVar16 = dctx->tmpInTarget - dctx->tmpInSize;
      if ((uint)((int)pBVar17 - (int)srcPtr) <= uVar16) {
        uVar16 = (int)pBVar17 - (int)srcPtr;
      }
