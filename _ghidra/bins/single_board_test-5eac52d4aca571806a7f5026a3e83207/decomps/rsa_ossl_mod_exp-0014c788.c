...

{
  ...
  if (r_00 != (BIGNUM *)0x0) {
    if (*(int *)(param_3 + 4) == 1) {
      ...
      if (2 < iVar9 - 1U) goto LAB_0014c7f2;
    }
    else {
      iVar9 = 0;
    }
    ...
    if (iVar6 << 0x1d < 0) {
      mod = BN_new();
      if (mod == (BIGNUM *)0x0) goto LAB_0014c7f2;
...
LAB_0014ca10:
          ...
          BN_free(mod);
          if (*(undefined **)(*(int *)(param_3 + 8) + 0x18) != (undefined *)0x185911)
          goto LAB_0014ca10;
          iVar8 = BN_num_bits(*(BIGNUM **)(param_3 + 0x20));
          iVar4 = BN_num_bits(*(BIGNUM **)(param_3 + 0x1c));
          iVar6 = *(int *)(param_3 + 0x40);
          if (iVar8 != iVar4) goto LAB_0014c7de;
          if ((((((iVar6 << 0x1e < 0) &&
                 (pBVar2 = BN_MONT_CTX_set_locked
...
LAB_0014c7de:
    if (((-1 < iVar6 << 0x1e) ||
      ...
      if (mod != (BIGNUM *)0x0) {
        ...
        if (pBVar7 == (BIGNUM *)0x0) goto LAB_0014ca18;
        BN_free(mod);
        if (iVar9 != 0) {
          mod = BN_new();
          a = BN_new();
...
LAB_0014c962:
        ...
        if (((iVar6 != 0) &&
          ...
          if ((((iVar6 == 0) ||
            ...
            if (iVar9 != 0) {
              pBVar1 = BN_new();
              if (pBVar1 == (BIGNUM *)0x0) goto LAB_0014c7f2;
              iVar6 = 0;
              do {
