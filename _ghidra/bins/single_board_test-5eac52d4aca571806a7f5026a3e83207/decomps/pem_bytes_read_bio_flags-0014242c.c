...
LAB_0014246e:
  while( true ) {
    ...
    if (iVar1 == 0) goto LAB_001424ea;
    iVar1 = strcmp(param_4,"ANY PRIVATE KEY");
    if (iVar1 != 0) break;
    iVar1 = strcmp(str,"ENCRYPTED PRIVATE KEY");
    if ((iVar1 == 0) || (iVar1 = strcmp(str,"PRIVATE KEY"), iVar1 == 0)) goto LAB_001424ea;
...
joined_r0x00142626:
  ...
  if ((((iVar1 == 0) && (iVar1 = strcmp(param_4,"DH PARAMETERS"), iVar1 == 0)) ||
     ...
     ((iVar2 = strcmp(str,"NEW CERTIFICATE REQUEST"), iVar2 == 0 &&
      (iVar2 = strcmp(param_4,"CERTIFICATE REQUEST"), iVar2 == 0)))) goto LAB_001424ea;
  iVar2 = strcmp(str,"CERTIFICATE");
  pcVar7 = str;
  if (iVar2 == 0) {
    iVar1 = strcmp(param_4,"TRUSTED CERTIFICATE");
    if ((iVar1 == 0) || (iVar1 = strcmp(param_4,"PKCS7"), iVar1 == 0)) goto LAB_001424ea;
    if (*param_4 != 'C') goto LAB_0014246e;
    cVar9 = param_4[1];
    if (((cVar9 == 'M') && (param_4[2] == 'S')) && (param_4[3] == '\0')) goto LAB_001424ea;
    iVar1 = strcmp(str,"PKCS7");
    if (iVar1 != 0) goto LAB_0014246e;
  }
  else {
    if (((iVar1 == 0) && (iVar1 = strcmp(param_4,"TRUSTED CERTIFICATE"), iVar1 == 0)) ||
       ((iVar1 = strcmp(str,"PKCS #7 SIGNED DATA"), iVar1 == 0 &&
        (iVar1 = strcmp(param_4,"PKCS7"), iVar1 == 0)))) goto LAB_001424ea;
    iVar1 = strcmp(str,"PKCS7");
    if ((iVar1 != 0) || (*param_4 != 'C')) goto LAB_0014246e;
    cVar9 = param_4[1];
  }
  if (((cVar9 != 'M') || (param_4[2] != 'S')) || (param_4[3] != '\0')) goto LAB_0014246e;
LAB_001424ea:
