...
LAB_000ec620:
    ...
    *param_2 = (int)(pbVar15 + 2);
    ...
    if ((uVar9 == 0) && (*piVar22 != 0x10000 && 0x303 < *piVar22)) {
      if ((__n == 0) || (uVar13 < __n)) goto LAB_000ec5e8;
LAB_000ec66a:
...
LAB_000ec66e:
      ...
      *(int *)(param_1 + 0x474) = iVar14;
      ...
      if (__n != uVar13) goto LAB_000ec5e8;
      if (__n == 0) {
        return 3;
      }
      if ((uVar9 == 0) && (*piVar22 != 0x10000 && 0x303 < *piVar22)) goto LAB_000ec66a;
      iVar14 = *(int *)(param_1 + 0x474);
      if (*(int *)(iVar14 + 0x148) != 0) goto LAB_000ec66e;
    }
