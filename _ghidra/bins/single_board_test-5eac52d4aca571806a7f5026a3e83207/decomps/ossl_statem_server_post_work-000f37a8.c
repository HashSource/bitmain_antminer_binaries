...

{
  ...
  case (void *)0x16:
    ...
    if ((iVar5 != 0) && (param_1[2].tlsext_debug_cb == (_func_3297 *)0x1)) {
      ...
      goto switchD_000f37ba_caseD_1a;
    }
    ...
    else if (param_1[2].tlsext_debug_cb == (_func_3297 *)0x1) goto LAB_000f39c6;
    goto LAB_000f3868;
  case (void *)0x19:
...
LAB_000f39c6:
    ...
    piVar2 = (int *)param_1->type;
    iVar1 = piVar2[0x19];
    if (*(int *)(iVar1 + 0x30) << 0x1c < 0) goto LAB_000f3996;
LAB_000f3868:
