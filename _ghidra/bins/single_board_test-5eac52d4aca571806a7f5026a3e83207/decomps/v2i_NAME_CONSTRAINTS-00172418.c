...
LAB_001724dc:
  ...
  do {
    ...
    if (a_00 == (GENERAL_SUBTREE *)0x0) goto LAB_001724c8;
    pGVar1 = v2i_GENERAL_NAME_ex(a_00->base,param_1,param_2,&CStack_34,1);
    if (pGVar1 == (GENERAL_NAME *)0x0) goto LAB_001724dc;
    ...
    if (psVar2 == (stack_st_GENERAL_SUBTREE *)0x0) {
      ...
      if (psVar2 == (stack_st_GENERAL_SUBTREE *)0x0) goto LAB_001724ca;
    }
    iVar3 = OPENSSL_sk_push(psVar2,a_00);
    if (iVar3 == 0) goto LAB_001724ca;
    iVar5 = iVar5 + 1;
  } while( true );
}
