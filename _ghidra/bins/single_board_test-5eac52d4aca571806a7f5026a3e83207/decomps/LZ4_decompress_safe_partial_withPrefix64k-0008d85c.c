...
/* WARNING: Removing unreachable block (ram,0x0008dd46) */
/* WARNING: Removing unreachable block (ram,0x0008dd50) */
/* WARNING: Removing unreachable block (ram,0x0008dd52) */
/* WARNING: Removing unreachable block (ram,0x0008dd54) */
/* WARNING: Removing unreachable block (ram,0x0008dd5a) */
/* WARNING: Removing unreachable block (ram,0x0008d92a) */
/* WARNING: Removing unreachable block (ram,0x0008d932) */
/* WARNING: Removing unreachable block (ram,0x0008d942) */
/* WARNING: Removing unreachable block (ram,0x0008d93a) */
...
LAB_0008da82:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_0008e1de;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_0008e1de;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_0008da82;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_0008e1de;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_0008e1de;
              op = pBVar10;
