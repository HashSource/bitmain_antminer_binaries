...
LAB_000dab26:
    ...
    if (uVar6 != 0x100) goto LAB_000dab26;
    pcVar9 = "DHEPSK";
  }
  if (uVar7 == 8) {
    pcVar8 = "ECDSA";
...
LAB_000daad6:
    ...
    if (uVar7 != 0xa0) goto LAB_000daad6;
    pcVar8 = "GOST12";
  }
  if (uVar3 == 0x400) {
LAB_000dabc0:
...
LAB_000dac3a:
      ...
      if (uVar3 == 0x20) {
        ...
        if (uVar3 != 0x40) goto LAB_000dac3a;
        pcVar4 = "AES(128)";
      }
    }
    else if (uVar3 == 0x100) {
      ...
      if (uVar3 != 0x200) goto LAB_000dac3a;
      pcVar4 = "Camellia(256)";
    }
  }
    ...
    if (uVar3 == 0x2000) {
      ...
      if (uVar3 == 0x800) {
        ...
        if (uVar3 != 0x1000) goto LAB_000dac3a;
        pcVar4 = "AESGCM(128)";
      }
    }
      ...
      if (uVar3 != 0x8000) goto LAB_000dac3a;
      pcVar4 = "AESCCM(256)";
    }
  }
    ...
    if (uVar3 != 0x20000) {
      if (uVar3 == 0x40000) goto LAB_000dabc0;
      goto LAB_000dac3a;
    }
    pcVar4 = "AESCCM8(256)";
  }
    ...
    if (uVar3 != 0x200000) goto LAB_000dac3a;
    pcVar4 = "ARIAGCM(256)";
  }
  if (uVar5 == 0x10) {
    pcVar2 = "SHA256";
...
LAB_000dac12:
      ...
      if (uVar5 == 0x200) goto LAB_000dabf0;
    }
  }
  pcVar2 = "unknown";
LAB_000daa86:
