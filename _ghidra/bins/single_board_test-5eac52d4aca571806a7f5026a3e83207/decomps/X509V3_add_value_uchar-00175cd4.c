...
LAB_00175d6e:
    ...
    if (ptr == (undefined4 *)0x0) goto LAB_00175d24;
...
LAB_00175d06:
      ...
      if (pvVar3 == (void *)0x0) {
        ...
        if (name != (char *)0x0) goto LAB_00175d6e;
      }
      else {
        name = (char *)0x0;
      }
...
LAB_00175cf4:
      ...
      if (pcVar2 != (char *)0x0) goto LAB_00175d06;
      name = (char *)0x0;
    }
LAB_00175d24:
    ptr = (undefined4 *)0x0;
    ERR_put_error(0x22,0xae,0x41,"crypto/x509v3/v3_utl.c",0x45);
    if (psVar5 != (stack_st_CONF_VALUE *)0x0) goto LAB_00175d3e;
    ptr = (undefined4 *)0x0;
  }
