...
LAB_00165444:
          ...
          if (iVar2 == 0) {
            ...
            if ((iVar2 != 0) || (local_30 == (X509_CRL *)0x0)) {
              ...
              OPENSSL_sk_pop_free(iVar2,(undefined *)0x169025);
              goto LAB_0016542a;
            }
          }
          else {
LAB_0016542a:
            if (local_30 == (X509_CRL *)0x0) goto LAB_00165444;
          }
...
LAB_00165474:
            ...
            goto LAB_00165474;
            if (iVar2 != 2) goto LAB_001653c0;
          }
          X509_CRL_free(local_40);
          X509_CRL_free(a_00);
          iVar2 = *(int *)(param_1 + 0x74);
          local_40 = (X509_CRL *)0x0;
          if (iVar3 == iVar2) goto LAB_00165444;
          iVar3 = iVar2;
        } while (iVar2 != 0x807f);
        X509_CRL_free((X509_CRL *)0x0);
        X509_CRL_free((X509_CRL *)0x0);
