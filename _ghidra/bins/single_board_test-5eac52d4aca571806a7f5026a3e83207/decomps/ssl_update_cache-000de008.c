...

{
  ...
  if ((uVar4 & param_2) == 0) goto LAB_000de0f4;
...
LAB_000de088:
        if ((((*(int *)(param_1 + 0x1c) != 0 && (0x303 < iVar2 && iVar2 != 0x10000)) &&
           ...
           (-1 < *(int *)(param_1 + 0x4ec) << 0x11)) goto LAB_000de0d0;
      }
    ...
    if (*(int *)((*(int **)(param_1 + 4))[0x19] + 0x30) << 0x1c < 0) goto LAB_000de0f4;
    iVar2 = **(int **)(param_1 + 4);
    iVar5 = iVar2 + -0x10000;
    if (iVar5 != 0) {
      iVar5 = 1;
    ...
    if (iVar5 == 0) goto LAB_000de0f4;
    if ((uVar4 & 0x200) == 0) goto LAB_000de088;
  }
LAB_000de0d0:
