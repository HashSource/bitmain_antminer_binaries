...
undefined4 tls_construct_ctos_maxfragmentlen(int param_1,undefined4 param_2)
  ...
  if (iVar1 != 0) {
    ...
    if ((((int)uVar2 != 0) &&
        (iVar1 = WPACKET_put_bytes__(param_2,(int)((ulonglong)uVar2 >> 0x20),
                                     *(undefined1 *)(param_1 + 0x5c0),0,1), iVar1 != 0)) &&
       (iVar1 = WPACKET_close(param_2), iVar1 != 0)) {
      return 1;
    }
  }
  ossl_statem_fatal(param_1,0x50,0x225,0x44,"ssl/statem/extensions_clnt.c",0x51);
  return 0;
}
