...

{
  ...
  iVar1 = CRYPTO_THREAD_run_once(&rand_drbg_init,0x1475c5,param_3,param_4,param_4);
  if ((iVar1 != 0) && (do_rand_drbg_init_ossl_ret_ != 0)) {
    iVar1 = CRYPTO_THREAD_get_local(&public_drbg);
    if (iVar1 == 0) {
      ...
      CRYPTO_THREAD_set_local(&public_drbg,iVar1);
    }
    return iVar1;
  }
  return 0;
