...
LAB_000c7670:
    ...
    if (uVar20 < 0x6b) {
      if (uVar20 != 0x62) {
        if (uVar20 < 99) {
          if (uVar20 != 0x1a) {
            if (uVar20 != 0x41) goto switchD_000c7624_caseD_1;
            goto LAB_000c726a;
          }
        }
        else if (2 < uVar20 - 100) goto switchD_000c7624_caseD_1;
      }
      goto LAB_000c7670;
    }
    if (0x78 < uVar20) {
      if (1 < uVar20 - 0xc1) goto switchD_000c7624_caseD_1;
      goto LAB_000c7670;
    }
    if (((uVar20 < 0x75) && (uVar20 != 0x71)) && (uVar20 != 0x73)) goto switchD_000c7624_caseD_1;
LAB_000c726a:
    addr = '@';
  }
  ...
  if (iVar15 != 0) goto switchD_000c7624_caseD_1;
...
LAB_000c7842:
  ...
  if ((_g_calibration_mode != 0) && ((buffer._0_4_ & 0xfe) == 8)) {
    ...
    if ((uint)CONCAT11(buffer2[0x11],buffer2[0x12]) != (uVar18 | uVar16 << 8)) goto LAB_000c7842;
  }
  ...
  do {
    ...
    if (*puVar22 == 0x80) {
      ...
      if (bVar35 && (uVar20 != 0x62 && _g_power_state.power_version - 100 != 2)) {
        if (iVar28 - 1U < 0xff) goto LAB_000c7490;
        goto switchD_000c7624_caseD_1;
      }
      if (_g_power_state.eeprom.num != 1) goto LAB_000c761c;
      goto switchD_000c7624_caseD_1;
    }
    iVar28 = iVar28 + 1;
  } while (iVar28 != 0xe);
...
switchD_000c7624_caseD_1:
      ...
      return 0;
    case 8:
      if ((int)((uint)(dVar36 < 0.0) << 0x1f) < 0) goto switchD_000c7624_caseD_1;
      dVar37 = 12.0;
    }
