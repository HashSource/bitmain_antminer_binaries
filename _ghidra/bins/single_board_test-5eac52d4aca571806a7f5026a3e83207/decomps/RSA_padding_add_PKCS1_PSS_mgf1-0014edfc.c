...
LAB_0014ee38:
    ...
    if (uVar9 == 0) {
      ...
      *EM = '\0';
      EM = EM + 1;
      if ((int)(cnt + 1) < iVar4) goto LAB_0014ee5c;
LAB_0014eee2:
      iVar4 = 0xbb;
    }
    else {
      if (iVar4 <= (int)(cnt + 1)) goto LAB_0014eee2;
LAB_0014ee5c:
      iVar10 = iVar4 - cnt;
      if (sLen == 0xfffffffd) {
        sLen = iVar10 - 2;
LAB_0014ee72:
      ...
      if (sLen < iVar10 + -1) goto LAB_0014ee72;
      iVar4 = 0xc2;
    }
    iVar10 = 0x6e;
  }
    ...
    uVar9 = sLen;
    if (sLen + 3 < 0 == SCARRY4(sLen,3)) goto LAB_0014ee38;
    iVar4 = 0xaf;
    iVar10 = 0x88;
  }
  pEVar6 = (EVP_MD_CTX *)0x0;
