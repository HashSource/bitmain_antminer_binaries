...
undefined4 sm4_ofb_cipher(undefined4 param_1,int param_2,int param_3,uint param_4)

{
  ...
  if (0x3fffffff < param_4) {
    ...
    do {
      ...
      CRYPTO_ofb128_encrypt(iVar4,iVar3,0x40000000,uVar1,uVar2,local_2c,0x1bce7d);
  ...
  if (param_4 != 0) {
    ...
    uVar1 = EVP_CIPHER_CTX_get_cipher_data(param_1);
    uVar2 = EVP_CIPHER_CTX_iv_noconst(param_1);
    CRYPTO_ofb128_encrypt(local_38,local_3c,param_4,uVar1,uVar2,local_2c,0x1bce7d);
    EVP_CIPHER_CTX_set_num(param_1,local_2c[0]);
  }
  return 1;
}
