...
LAB_001809b0:
    ...
    iVar5 = local_b8;
    pbVar13 = local_c0;
    if (iVar6 < 1) goto LAB_001806a6;
    if (local_ec != 0) {
      iVar12 = BIO_write(param_1,"\n",1);
      if (iVar12 < 1) goto LAB_001806a6;
      if (local_b8 <= param_3) {
    ...
    if (local_b4 == 1) {
      if (local_b8 == 1) {
        ...
        bVar2 = true;
        if (local_b8 < 1) goto LAB_00180aa0;
      }
...
LAB_00180aa0:
        ...
        if (0 < iVar5) {
          ...
          iVar5 = BIO_puts(param_1,"]");
          if (0 < iVar5) goto LAB_0018082e;
        }
        goto LAB_001806a6;
      }
      goto LAB_0018082e;
    }
    if (local_b4 == 0x1e) goto LAB_0018082e;
    if (local_b4 != 4) {
      if (local_b4 != 2) {
        if (local_b4 != 10) {
          iVar5 = param_7;
          ...
          if ((param_7 == 0 || local_b8 == 0) || iVar5 < 0) goto LAB_0018082e;
          iVar5 = BIO_write(param_1,"\n",1);
          if (iVar5 < 1) goto LAB_001806a6;
          if ((param_7 == -1) || (iVar5 = param_7, local_b8 < param_7)) {
            iVar5 = local_b8;
          }
          iVar5 = BIO_dump_indent(param_1,(char *)local_c0,iVar5,6);
          goto joined_r0x00180800;
        }
        local_bc = pbVar9;
        ...
        if (a_00 == (ASN1_ENUMERATED *)0x0) {
          ...
          iVar5 = BIO_write(param_1,":",1);
          if ((iVar5 < 1) ||
             ((a_00->type == 0x10a && (iVar5 = BIO_write(param_1,&DAT_00219c9c,1), iVar5 < 1)))) {
LAB_00180a64:
            pAVar11 = (ASN1_STRING *)0x0;
            a_01 = (ASN1_STRING *)0x0;
            a = pAVar11;
...
LAB_00180c54:
        ...
        iVar5 = BIO_write(param_1,":",1);
        if ((0 < iVar5) &&
           ((a->type != 0x102 || (iVar5 = BIO_write(param_1,&DAT_00219c9c,1), 0 < iVar5)))) {
          iVar5 = a->length;
          if (0 < iVar5) {
            iVar12 = 0;
            do {
...
LAB_00180b76:
            if (param_7 == 0) {
              ...
              if (a_01->length < 1) goto LAB_00180c48;
              iVar5 = 0;
              goto LAB_00180ba2;
            }
            iVar5 = BIO_write(param_1,"\n",1);
            if (iVar5 < 1) goto LAB_00180bb4;
            iVar5 = a_01->length;
        ...
        else if ((bVar1 & 0xfb) != 9) goto LAB_00180b76;
        pbVar14 = pbVar9;
...
LAB_00180856:
  ...
  if (param_3 < 1) goto LAB_00180aec;
  goto LAB_0018061c;
LAB_00180aec:
  a_00 = (ASN1_STRING *)0x0;
  pAVar11 = (ASN1_STRING *)0x1;
