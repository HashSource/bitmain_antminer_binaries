...

{
  ...
  *(undefined4 *)(iVar3 + 0xc) = 1;
  if (param_2 < 0x1a) {
    iVar1 = extension_is_relevant(param_1,(&DAT_0026ab48)[param_2 * 8]);
    if (iVar1 == 0) {
      return 1;
    }
    UNRECOVERED_JUMPTABLE = *(code **)(&DAT_0026ab54 + param_2 * 0x20);
    if (*(int *)(param_1 + 0x1c) != 0) {
      UNRECOVERED_JUMPTABLE = *(code **)(&DAT_0026ab50 + param_2 * 0x20);
    }
    if (UNRECOVERED_JUMPTABLE != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x000e3208. Too many branches */
