              ...
              if ((*(short *)(iVar4 + 4) == (short)local_2c[0]->type) &&
                ...
                if ((iVar14 != 0) &&
                   ((iVar1 = *(int *)(iVar1 + 0x18), iVar1 != 0 &&
                    ...
                    iVar1 != 0)))) {
                  if (iVar9 != iVar11) goto LAB_000f8b04;
                  break;
                }
              }
              iVar11 = iVar11 + 1;
...
LAB_000f8e0a:
        ...
        if (*(int *)(param_1 + 0xf8c) == 0) goto LAB_000f8c5c;
...
LAB_000f8b78:
        ...
        if (uVar10 == uVar2) goto LAB_000f8c4c;
      }
      if (uVar12 != 0xffffffff) goto LAB_000f8c2a;
    }
    else {
      iVar4 = tls1_get_legacy_sigalg(param_1,0xffffffff);
      if (iVar4 == 0) {
