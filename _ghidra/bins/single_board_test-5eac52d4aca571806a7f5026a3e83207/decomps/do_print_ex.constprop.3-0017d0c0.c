...
LAB_0017d0f4:
    if (param_1 == (FILE *)0x0) {
      if ((int)(param_2 << 0x16) < 0) goto LAB_0017d96a;
      pcVar14 = (char *)(param_3.asn1_string)->length;
    }
    else {
      sVar2 = fwrite(&DAT_0021ef60,1,1,param_1);
      if (sVar2 != 1) {
        return -1;
      }
      ...
      do {
        while( true ) {
          ...
          case 2:
            ...
            if (pbVar19 == pbVar21) goto LAB_0017d48a;
            goto LAB_0017d26a;
          default:
            goto LAB_0017d116;
          case 4:
...
LAB_0017d2ae:
                ...
                if ((uVar16 & 0x61) == 0) goto LAB_0017d2ae;
...
LAB_0017d87c:
                ...
                uVar16 = *(ushort *)(&char_type + uVar16 * 2) & uVar11;
                if ((uVar16 & 0x61) == 0) goto LAB_0017d87c;
                if ((int)(uVar16 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017d85a:
                ...
                uVar16 = *(ushort *)(&char_type + uVar16 * 2) & uVar11;
                if ((uVar16 & 0x61) == 0) goto LAB_0017d85a;
                if ((int)(uVar16 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017d8e4:
                ...
                if ((uVar16 & 0x61) == 0) goto LAB_0017d8e4;
                if ((int)(uVar16 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017d8c2:
                ...
                if ((uVar16 & 0x61) == 0) goto LAB_0017d8c2;
                if ((int)(uVar16 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
              ...
              if (iVar4 != 5) {
                if ((int)((uint)local_37 << 0x18) < 0) {
                  ...
                  if ((uVar11 & 0x61) != 0) goto LAB_0017d3aa;
                }
                if ((uVar11 & 0x406) == 0) goto LAB_0017d3b6;
                BIO_snprintf((char *)local_34,0xb,"\\%02X");
                iVar15 = iVar15 + 3;
              }
            }
...
LAB_0017d7ea:
                ...
                if ((uVar6 & 0x61) == 0) goto LAB_0017d7ea;
                if ((int)(uVar6 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017da46:
                ...
                uVar6 = *(ushort *)(&char_type + uVar16 * 2) & uVar11;
                if ((uVar6 & 0x61) == 0) goto LAB_0017da46;
                if ((int)(uVar6 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017da30:
                ...
                uVar6 = *(ushort *)(&char_type + uVar16 * 2) & uVar11;
                if ((uVar6 & 0x61) == 0) goto LAB_0017da30;
                if ((int)(uVar6 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017da1a:
                ...
                uVar6 = *(ushort *)(&char_type + uVar16 * 2) & uVar11;
                if ((uVar6 & 0x61) == 0) goto LAB_0017da1a;
                if ((int)(uVar6 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017da04:
                ...
                uVar6 = *(ushort *)(&char_type + uVar16 * 2) & uVar11;
                if ((uVar6 & 0x61) == 0) goto LAB_0017da04;
                if ((int)(uVar6 << 0x1c) < 0) {
                  iVar9 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017d7ac:
              ...
              if ((uVar11 & 0x61) == 0) goto LAB_0017d7ac;
LAB_0017d3aa:
...
LAB_0017d3b8:
          pbVar18 = pbVar19;
          if (pbVar19 == pbVar21) goto LAB_0017d3c4;
        }
LAB_0017d26a:
        if (bVar7 != 0) goto LAB_0017d270;
LAB_0017d498:
...
LAB_0017d3c4:
    ...
    if (local_42 == '\0') {
      ...
      sVar2 = fwrite(&DAT_00238504,1,1,param_1);
      if (sVar2 != 1) {
        return -1;
      }
    }
...
LAB_0017d81e:
    ...
    else if ((bVar1 == 4) && ((uVar11 & 3) != 0)) goto LAB_0017d168;
    if (pbVar17 != pbVar21) {
      bVar8 = bVar8 & 8;
      pbVar18 = pbVar17;
      do {
            ...
            do {
              while( true ) {
                ...
                if (((int)(uVar10 << 0x18) < 0) ||
                   ...
                   (uVar6 & 0x61) == 0)) break;
                if ((-1 < (int)(uVar6 << 0x1c)) &&
                   (sVar2 = fwrite(&DAT_0021ef54,1,1,param_1), sVar2 != 1)) {
                  return -1;
                }
LAB_0017d564:
...
LAB_0017d574:
                if (ppbVar12 == ppbVar20) goto LAB_0017d57c;
              }
              if ((uVar6 & 0x406) == 0) {
                if ((uVar10 != 0x5c) || (uVar5 == 0)) goto LAB_0017d564;
                sVar2 = fwrite(&DAT_001fac38,1,2,param_1);
                if (sVar2 != 2) {
                  return -1;
                }
                goto LAB_0017d574;
...
LAB_0017d57c:
    ...
    if ((local_42 == '\0') || (sVar2 = fwrite(&DAT_00238504,1,1,param_1), sVar2 == 1)) {
      return local_68;
    }
  }
  else {
    if ((0x1d < iVar15 - 1U) || (bVar1 = tag2nbyte[iVar15], bVar1 == 0xff)) {
      if ((int)(param_2 << 0x17) < 0) goto LAB_0017d0f4;
      goto LAB_0017d1b8;
    }
    bVar8 = bVar1;
    if ((int)(param_2 << 0x1b) < 0) {
...
LAB_0017d144:
    ...
    pbVar21 = pbVar17 + local_64;
    if (bVar1 == 2) {
      if ((int)(local_64 << 0x1f) < 0) goto LAB_0017d81e;
      goto LAB_0017d1d0;
    }
    if ((bVar1 != 4) || ((local_64 & 3) == 0)) goto LAB_0017d1d0;
LAB_0017d168:
