...

{
  ...
  if (iVar1 == 6) {
    ...
    do {
      iVar3 = iVar2 + 1;
      printf((char *)(uVar5 | 0x1f0000),iVar2,(uint)*pbVar4);
      iVar2 = iVar3;
      pbVar4 = pbVar4 + 1;
    } while (iVar3 != 5);
    putchar(10);
    uVar5 = (uint)read_back_data._0_4_ >> 8 & 0xff;
    if ((((read_back_data._0_4_ & 0xff) == 5) && (uVar5 == 7)) && (read_back_data[2] == 0xfe)) {
      iVar1 = 0;
      goto LAB_000c3ec8;
    }
    snprintf(tmp42,0x800,"%s failed! read_back_data[0] = 0x%02x, read_back_data[1] = 0x%02x\n\n",
             "_bitmain_pic_reset_common",read_back_data._0_4_ & 0xff,uVar5);
