...

{
  ...
  uVar7 = DAT_00b25644;
  uVar6 = DAT_00b25640;
  if ((param_1 < DAT_00b25640) || (DAT_00b25640 + DAT_00b25644 <= param_1)) {
                    /* WARNING: Subroutine does not return */
    OPENSSL_die("assertion failed: WITHIN_ARENA(ptr)","crypto/mem_sec.c",0x285);
  }
  uVar4 = __aeabi_uidiv((param_1 + DAT_00b25644) - DAT_00b25640,DAT_00b25650);
  iVar3 = DAT_00b25654;
  uVar1 = uVar2;
  while ((uVar1 = uVar1 - 1, uVar4 != 0 &&
         (-1 < (int)((uint)(*(byte *)(DAT_00b25654 + (uVar4 >> 3)) >> (uVar4 & 7)) << 0x1f)))) {
    if ((int)(uVar4 << 0x1f) < 0) {
                    /* WARNING: Subroutine does not return */
