        ...
        do {
          ...
          do {
            while( true ) {
              ...
              uVar12 = (uint)*pbVar7;
              iVar8 = iVar8 + -1;
              if (uVar12 == 0x2e || uVar12 == 0x20) goto LAB_0017b682;
              ...
              if (((a == (BIGNUM *)0x0) && (a = BN_new(), a == (BIGNUM *)0x0)) ||
                 (iVar4 = BN_set_word(a,w), iVar4 == 0)) goto LAB_0017b730;
              bVar2 = true;
LAB_0017b664:
              iVar4 = BN_mul_word(a,10);
              if ((iVar4 == 0) || (iVar4 = BN_add_word(a,uVar12 - 0x30), iVar4 == 0))
              goto LAB_0017b730;
              if (iVar8 == 0) goto LAB_0017b682;
            }
            if (bVar2) goto LAB_0017b664;
            w = (uVar12 - 0x30) + w * 10;
          } while (iVar8 != 0);
LAB_0017b682:
          if (local_5c == 0) {
...
LAB_0017b7b4:
            ...
            if (local_48 < iVar4) {
              ...
              if (local_64 == (uchar *)0x0) goto LAB_0017b738;
LAB_0017b7fa:
              iVar10 = 0;
              puVar13 = local_64 + -1;
              do {
                ...
                iVar10 = iVar10 + 1;
                if (uVar6 == 0xffffffff) goto LAB_0017b730;
                puVar13 = puVar13 + 1;
                *puVar13 = (uchar)uVar6;
              } while (iVar4 != iVar10);
            }
            else {
              if (iVar4 != 0) goto LAB_0017b7fa;
              iVar10 = 0;
            }
          }
          if (out == (uchar *)0x0) {
