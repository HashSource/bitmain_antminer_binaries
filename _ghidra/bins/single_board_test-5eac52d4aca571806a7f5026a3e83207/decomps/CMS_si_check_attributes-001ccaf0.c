...

{
  ...
  do {
    while( true ) {
      ...
      {
        if ((0 < iVar1) && ((uVar7 & 0x11) == 0x11)) goto LAB_001ccb48;
      }
      else {
        ...
        goto LAB_001ccb48;
        if ((int)(uVar7 << 0x19) < 0) {
          if (iVar5 != 1) goto LAB_001ccb48;
        }
        else if (iVar5 == 0) goto LAB_001ccb48;
      }
      psVar8 = *(stack_st_X509_ATTRIBUTE **)(param_1 + 0x18);
      iVar3 = X509at_get_attr_by_NID(psVar8,nid,-1);
      if ((-1 < iVar3) && (pXVar4 = X509at_get_attr(psVar8,iVar3), pXVar4 != (X509_ATTRIBUTE *)0x0))
      break;
      if (iVar2 < 1) goto LAB_001ccba8;
      if ((uVar7 & 0x12) == 0x12) goto LAB_001ccb48;
      piVar6 = piVar6 + 2;
