...
LAB_000d8102:
  ...
  if (iVar3 != 0) {
    if ((char *)param_1[0x41] != (char *)0x0) {
      ...
      ptr[0x41] = (int)pcVar5;
      if (pcVar5 == (char *)0x0) goto LAB_000d81f6;
    }
    return ptr;
  }
LAB_000d81f6:
