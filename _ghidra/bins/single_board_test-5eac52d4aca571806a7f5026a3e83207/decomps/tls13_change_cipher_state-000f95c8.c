...

{
  ...
  if (-1 < (int)(param_2 << 0x1f)) {
    *(undefined4 *)(param_1 + 0x60) = 1;
    ...
    if ((param_2 & 0x12) != 0x12) goto LAB_000f967e;
LAB_000f9606:
...
LAB_000f9be4:
  ...
  if ((param_2 & 0x12) == 0x12) goto LAB_000f9606;
LAB_000f967e:
  if ((param_2 & 0x21) == 0x21) goto LAB_000f9606;
  if ((param_2 & 0x80) == 0) {
    pcVar7 = "s ap traffic";
...
LAB_000f971c:
    ...
    if (pcVar7 == "s ap traffic") {
      ...
      if ((iVar1 == 0) ||
         ...
         sVar2 = local_ec, iVar1 == 0)) goto LAB_000f9724;
    }
    else {
      pcVar8 = "c ap traffic";
      if (pcVar7 == "c ap traffic") {
