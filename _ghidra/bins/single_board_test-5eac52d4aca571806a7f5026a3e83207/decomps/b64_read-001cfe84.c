...
LAB_001cff60:
  do {
    ...
    if (outl[5] == 0) {
LAB_001cff90:
      if (((int)uVar14 < 0x400) && (0 < (int)outl[6])) goto LAB_001cff60;
LAB_001cffa0:
...
LAB_001d00e0:
        ...
        outl[5] = 0;
LAB_001d0100:
        if ((uVar14 != sVar5) || (local_2c[0] != 0)) goto LAB_001d027c;
        if (in == puVar4) {
          if (uVar14 == 0x400) {
            outl[2] = 0;
            outl[3] = 1;
