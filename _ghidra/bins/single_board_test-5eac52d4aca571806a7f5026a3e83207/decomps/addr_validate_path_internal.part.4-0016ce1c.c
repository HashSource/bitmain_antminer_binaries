...

{
  ...
  if (param_3 == 0) {
    ...
    iVar1 = 1;
    if (param_3 == 0) goto LAB_0016d020;
    iVar8 = 1;
    uVar5 = 0;
  }
  ...
  if (iVar1 == 0) {
    if (param_1 != 0) {
      ...
      *(int *)(param_1 + 100) = iVar6;
      ...
      if (iVar1 != 0) {
        OPENSSL_sk_set_cmp_func(param_3,0x16b62d);
...
LAB_0016ce82:
      ...
      if (iVar8 < (int)uVar10) {
        do {
          ...
          if (iVar2 == 0) {
            if (param_1 == 0) goto LAB_0016d072;
            *(int *)(param_1 + 0x5c) = iVar8;
            *(undefined4 *)(param_1 + 0x60) = 0x29;
            *(int *)(param_1 + 100) = iVar6;
            iVar1 = (**(code **)(param_1 + 0x1c))(0,param_1);
            if (iVar1 == 0) goto LAB_0016d020;
          }
          iVar2 = *(int *)(iVar6 + 0xa8);
          if (iVar2 == 0) {
            do {
              iVar3 = OPENSSL_sk_num(param_3);
              if (iVar3 <= iVar2) goto LAB_0016cfa8;
...
LAB_0016d05a:
            *(int *)(param_1 + 100) = iVar6;
            ...
            OPENSSL_sk_set_cmp_func(iVar2,0x16b62d);
