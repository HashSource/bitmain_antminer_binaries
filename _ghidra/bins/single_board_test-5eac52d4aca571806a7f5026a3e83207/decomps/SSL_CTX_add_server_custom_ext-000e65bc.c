...

{
  ...
  *ptr_00 = param_7;
  ...
  if (param_2 == 0x12) {
    ...
    if (iVar1 != 0) goto LAB_000e6618;
    SSL_extension_supported(0x12);
  }
  else {
    iVar1 = SSL_extension_supported(param_2);
    if ((iVar1 != 0) || (0xffff < param_2)) goto LAB_000e6618;
  }
  ...
  if ((iVar1 == 0) &&
    ...
    *(undefined4 *)((int)__s + 0x1c) = 0xe5eb9;
    *(undefined4 *)((int)__s + 4) = 1;
    *(undefined4 *)((int)__s + 0x10) = 0xe5e81;
    *(undefined4 *)((int)__s + 0x14) = 0xe5ea1;
