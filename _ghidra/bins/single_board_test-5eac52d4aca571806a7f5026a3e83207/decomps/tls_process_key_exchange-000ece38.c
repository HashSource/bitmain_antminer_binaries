...

{
  ...
  *(undefined4 *)(*(int *)(param_1 + 0x7c) + 0x358) = 0;
  if ((uVar15 & 0x1c8) == 0) goto LAB_000ece6c;
  if ((uint)param_2[1] < 2) {
LAB_000ecec8:
    ...
    if (uVar11 < uVar14) goto LAB_000ecec8;
                  ...
                  if (param_2[1] != 0) {
                    ...
                    if (uVar11 <= uVar14) {
                      *param_2 = (int)((byte *)*param_2 + uVar11 + 1);
                      ...
                      if ((-1 < iVar18 << 0x1c) && (-1 < iVar18 << 0x1f)) goto LAB_000ece92;
LAB_000ed0fa:
                      pEVar6 = (EVP_PKEY *)
                               X509_get0_pubkey(*(undefined4 *)(*(int *)(param_1 + 0x474) + 0x19c));
                      if (pEVar6 == (EVP_PKEY *)0x0) goto LAB_000ece90;
                      uVar15 = param_2[1];
                      ctx = (EVP_MD_CTX *)0x0;
                      local_30 = (EVP_MD *)0x0;
                              ...
                              *(BIGNUM **)(param_1 + 0x62c) = pBVar17;
                              if (pBVar17 != (BIGNUM *)0x0) {
                                ...
                                if (iVar12 != 0) {
                                  ...
                                  uVar11 = *(uint *)(*(int *)(iVar12 + 0x210) + 0x14);
joined_r0x000ed0f6:
                                  if ((uVar11 & 3) != 0) goto LAB_000ed0fa;
                                  goto LAB_000ece92;
                                }
                                goto LAB_000ecee4;
                              }
