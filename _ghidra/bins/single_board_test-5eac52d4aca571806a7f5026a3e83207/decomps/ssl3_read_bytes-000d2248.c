...
LAB_000d22f4:
      do {
        ...
        if (pvVar24 == (void *)0x0) goto LAB_000d2498;
...
LAB_000d2370:
          ...
          if (piVar25[2] != 0) goto LAB_000d2370;
        }
          ...
          if (iVar10 == 0x10000) {
            ...
            if (param_1->new_session << 0x1f < 0) {
              ...
              if (uVar18 != 0) {
                ...
                piVar25[8] = 1;
                piVar25[2] = 0;
                if (-1 < iVar15 << 0x1d) goto LAB_000d26c6;
                goto LAB_000d22f4;
              }
LAB_000d23de:
              uVar18 = 4 - uVar16;
...
LAB_000d2456:
                  ...
                  if (iVar15 != 0x17) goto LAB_000d2716;
              ...
              if (iVar15 == 0x16) goto LAB_000d23de;
              if (iVar15 != 0x14) {
                if (3 < uVar16) goto LAB_000d2440;
                if (0x13 < iVar15) goto LAB_000d2456;
                goto LAB_000d2716;
              }
            }
            uVar22 = 0x677;
            ...
            if (iVar15 == 2) {
              ...
              if (cVar3 == '\x01') {
                ...
                *(uint *)(param_1->mac_flags + 0xe0) = uVar16;
                ...
                if (pKVar20 == (KSSL_CTX *)&DAT_00000005) goto LAB_000d27e0;
                if (bVar6) {
                  if (uVar16 != 0x5a) goto LAB_000d2784;
                  goto LAB_000d22f4;
                }
                if (uVar16 == 0) goto LAB_000d2a1e;
LAB_000d2880:
                bVar4 = bVar7;
                if (cVar3 == '\x02') {
                  bVar4 = true;
...
LAB_000d2a1e:
                ...
                if (cVar3 == '\x02') goto LAB_000d2a2a;
              }
              if (cVar3 != '\x01') {
...
LAB_000d280c:
            ...
            else if (piVar25[2] == uVar18) goto LAB_000d280c;
            uVar16 = uVar16 + uVar18;
          } while (pvVar23 < pvVar24 && (uVar16 < param_5 && bVar4));
        }
        if (uVar16 != 0) {
