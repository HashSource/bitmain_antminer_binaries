            ...
            if ((iVar5 != 0) &&
              ...
              *s = *s | 0x80;
              ...
              if (pBVar4 != (BIGNUM *)0x0) {
                ...
                if (iVar5 < 1) {
                  if (iVar5 == 0) {
                    if (param_5 == (void *)0x0) goto LAB_00194726;
                    ...
                    do {
                      ...
                      if (-1 < iVar5) {
                        ...
                        do {
                          ...
                          if ((((iVar7 == 0) ||
                             ...
                             (iVar7 = BN_add(pBVar2,pBVar2,pBVar1), iVar7 == 0)) goto LAB_001946d0;
                          iVar13 = iVar13 + 1;
                          iVar11 = iVar11 + len * 8;
                        } while (iVar13 <= iVar5);
                      }
                      ...
                      if (-1 < iVar11) {
                        ...
                        if (0 < iVar11) {
                          ...
                          if (iVar3 == 0) goto LAB_00194290;
                          goto LAB_0019427e;
                        }
                        if (iVar11 != 0) break;
                      }
                      local_b8 = local_b8 + 1;
                      if ((int)(param_2 << 2) <= local_b8) goto LAB_001947c4;
              ...
              while( true ) {
                ...
                if (iVar3 == 0) {
                  ...
                  *(BIGNUM **)(param_1 + 0x10) = pBVar1;
                  if ((*(int *)(param_1 + 8) == 0) ||
                     (pBVar1 == (BIGNUM *)0x0 || *(int *)(param_1 + 0xc) == 0)) goto LAB_00194290;
                  if (param_9 != (int *)0x0) {
                    *param_9 = local_b8;
                  }
                  uVar10 = 1;
