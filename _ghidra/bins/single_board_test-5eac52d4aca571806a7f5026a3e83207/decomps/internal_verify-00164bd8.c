...

{
  ...
  pXVar4 = pXVar2;
  if (iVar3 == 0) {
    if ((*(uint *)(*(int *)(param_1 + 0x10) + 0xc) & 0x80000) != 0) goto LAB_00164c16;
    if (iVar7 < 1) {
    ...
    do {
      ...
      if ((*(int *)(*(int *)(param_1 + 0x10) + 0xc) << 0x11 < 0) &&
        ...
        if (pXVar4[1].references << 0x1b < 0) {
          ...
          iVar1 = iVar7;
          if (iVar3 == 0) goto LAB_00164c7a;
          *(int *)(param_1 + 0x5c) = iVar7;
          goto LAB_00164c6a;
        }
        r = (EVP_PKEY *)X509_get0_pubkey(pXVar4);
        pXVar8 = pXVar4;
        if (r != (EVP_PKEY *)0x0) goto LAB_00164c84;
        *(int *)(param_1 + 0x5c) = iVar7;
        goto LAB_00164d32;
      }
LAB_00164c16:
