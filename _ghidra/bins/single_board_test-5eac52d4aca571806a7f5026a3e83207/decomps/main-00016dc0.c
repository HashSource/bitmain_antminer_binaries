...
/* WARNING: Removing unreachable block (ram,0x00017938) */
...

{
  ...
  handler.sa_flags = 0;
  handler.__sigaction_handler = (anon_union_4_2_5ad2d23e_for___sigaction_handler)(code *)0x16b41;
  ...
  sa.__sigaction_handler = (anon_union_4_2_5ad2d23e_for___sigaction_handler)(code *)0x16b2d;
  ...
  printf("%s : build version information::  %s.\n\n","main",
         "version: 6eec27e318c6eb489e1c617136e1a6aadec82c7f commit: 2024-07-05 13:57:53 build: 2024-07-05 14:15:22"
        );
  ...
  printf("%s : author information::  %s.\n\n","main",
         "author: guangji.yang      email: guangji.yang@bitmain.com");
  ...
  if (2 < argc) {
    ...
    if (3 < argc) {
      ...
      snprintf(tmp1,0x100,"input board_sn %s",0xb26d20);
      log_to_file(tmp1,time_stamp);
      pcVar10 = argv[4];
      sVar4 = strlen(argv[4]);
      ...
      snprintf(tmp1,0x100,"input chip_die %s",0xb26cb4);
      log_to_file(tmp1,time_stamp);
      pcVar10 = argv[5];
      sVar4 = strlen(argv[5]);
      ...
      snprintf(tmp1,0x100,"input chip_marking %s",0xb26cc4);
      log_to_file(tmp1,time_stamp);
      pcVar10 = argv[6];
      sVar4 = strlen(argv[6]);
      ...
      snprintf(tmp1,0x100,"input chip_ftversion %s",0xb26cd4);
      log_to_file(tmp1,time_stamp);
      pcVar10 = argv[7];
      sVar4 = strlen(argv[7]);
      ...
      snprintf(tmp1,0x100,"input chip_tech %s",0xb26d14);
      log_to_file(tmp1,time_stamp);
      pcVar10 = argv[8];
      sVar4 = strlen(argv[8]);
      ...
      snprintf(tmp1,0x100,"input board_name %s",0xb26d17);
      log_to_file(tmp1,time_stamp);
      pcVar10 = argv[9];
      sVar4 = strlen(argv[9]);
                    ...
                    if (iVar3 == 0) {
                      ...
                      if (iVar3 == 0) {
                        ...
                        printf("%s : SN:%s  %s result:%d send failed to mes, response_msg:%s\n",
                               "main",board_sn,&DAT_001ddf88,(uint)bVar7,response_msg);
                        bVar11 = uVar5 == 0;
                        if (bVar11) {
                          uVar5 = 1;
                        }
                        ...
                        snprintf(tmp1,0x100,
                                 ...
                                 &DAT_001ddf88,(uint)bVar7,response_msg);
                        log_to_file(tmp1,time_stamp_27);
                        lcd_clear_result();
                      ...
                      printf("%s : SN:%s %s test is disallowed by MES, response_msg:%s\n","main",
                             board_sn,&DAT_001ddf88,response_msg);
                      ...
                      if (iVar3 == 0) {
                        ...
                        if (iVar3 == 0) {
                          ...
                          if (iVar3 == 0) {
                            ...
                            printf("%s : SN:%s  %s result:%d send failed to mes, response_msg:%s\n",
                                   "main",board_sn_2,&DAT_001de0ec,(uint)bVar7,response_msg);
                            bVar11 = uVar5 == 0;
                            if (bVar11) {
                              uVar5 = 1;
                            }
                            ...
                            snprintf(tmp1,0x100,
                                     "SN:%s  %s result:%d send failed to mes, response_msg:%s",
                                     board_sn_2,&DAT_001de0ec,(uint)bVar7,response_msg);
                            log_to_file(tmp1,time_stamp_27);
                            lcd_clear_result();
                            lcd_show(0,"send mes failed");
                          ...
                          printf("%s ",time_stamp_27);
                          printf("%s : SN:%s %s test is disallowed by MES, response_msg:%s\n","main"
                                 ,board_sn_2,&DAT_001de0ec,response_msg);
                          snprintf(tmp1,0x100,"SN:%s %s test is disallowed by MES, response_msg:%s",
                                   board_sn_2,&DAT_001de0ec,response_msg);
                          log_to_file(tmp1,time_stamp_27);
                          lcd_clear_result();
                        ...
                        if (iVar3 == 0) {
                          ...
                          if (iVar3 == 0) {
                            ...
                            if (iVar3 == 0) {
                              ...
                              printf("%s : SN:%s  %s result:%d send failed to mes, response_msg:%s\n"
                                     ,"main",board_sn_3,&DAT_001ddb50,(uint)bVar7,response_msg);
                              bVar11 = uVar5 == 0;
                              if (bVar11) {
                                uVar5 = 1;
                              }
                              ...
                              snprintf(tmp1,0x100,
                                       "SN:%s  %s result:%d send failed to mes, response_msg:%s",
                                       board_sn_3,&DAT_001ddb50,(uint)bVar7,response_msg);
                              log_to_file(tmp1,time_stamp_27);
                              lcd_clear_result();
                              lcd_show(0,"send mes failed");
                            ...
                            printf("%s ",time_stamp_27);
                            printf("%s : SN:%s %s test is disallowed by MES, response_msg:%s\n",
                                   "main",board_sn_3,&DAT_001ddb50,response_msg);
                            snprintf(tmp1,0x100,
                                     "SN:%s %s test is disallowed by MES, response_msg:%s",
                                     board_sn_3,&DAT_001ddb50,response_msg);
                            log_to_file(tmp1,time_stamp_27);
                            lcd_clear_result();
                            lcd_show(0,"mes disallowed");
                          ...
                          if (iVar3 == 0) {
                            ...
                            if (iVar3 == 0) {
                              ...
                              printf("%s ",time_stamp_27);
                              printf("%s : SN:%s %s test is disallowed by MES, response_msg:%s\n",
                                     "main",board_sn_4,"SWEEP",response_msg);
                              snprintf(tmp1,0x100,
                                       "SN:%s %s test is disallowed by MES, response_msg:%s",
                            ...
                            if (iVar3 == 0) {
                              ...
                              if (iVar3 == 0) {
                                ...
                                if (iVar3 == 0) {
                                  ...
                                  printf("%s : SN:%s %s result:%d send ok to mes\n","main",
                                         board_sn_5,&DAT_001ddb54,(uint)bVar7);
                                  bVar11 = uVar5 == 0;
                                  if (bVar11) {
                                    uVar5 = 1;
                                  }
                                  ...
                                  printf("%s : SN:%s  %s result:%d send failed to mes, response_msg:%s\n"
                                         ,"main",board_sn_5,&DAT_001ddb54,(uint)bVar7,response_msg);
                                  bVar11 = uVar5 == 0;
                                  if (bVar11) {
                                    uVar5 = 1;
                                  }
                                  ...
                                  snprintf(tmp1,0x100,
                                           "SN:%s  %s result:%d send failed to mes, response_msg:%s"
                                           ,board_sn_5,&DAT_001ddb54,(uint)bVar7,response_msg);
                                  log_to_file(tmp1,time_stamp_27);
                                  lcd_clear_result();
                                  lcd_show(0,"send mes failed");
                                ...
                                printf("%s ",time_stamp_27);
                                printf("%s : SN:%s %s test is disallowed by MES, response_msg:%s\n",
                                       "main",board_sn_5,&DAT_001ddb54,response_msg);
                                snprintf(tmp1,0x100,
                                         "SN:%s %s test is disallowed by MES, response_msg:%s",
                                         board_sn_5,&DAT_001ddb54,response_msg);
                                log_to_file(tmp1,time_stamp_27);
                                lcd_clear_result();
                                lcd_show(0,"mes disallowed");
