...

{
  ...
  if (stopped == 0) {
    ...
    if ((((iVar1 != 0) && (iVar1 = CRYPTO_THREAD_run_once(&ssl_base,0xdb1e1), iVar1 != 0)) &&
        (ossl_init_ssl_base_ossl_ret_ != 0)) &&
       (((param_1 & 0x100000) == 0 ||
        ((iVar1 = CRYPTO_THREAD_run_once(&ssl_strings,0xdb1bd), iVar1 != 0 &&
         (ossl_init_load_ssl_strings_ossl_ret_ != 0)))))) {
      if ((param_1 & 0x200000) == 0) {
        return 1;
      }
      iVar1 = CRYPTO_THREAD_run_once(&ssl_strings,0xdb1cd);
      if (iVar1 != 0) {
