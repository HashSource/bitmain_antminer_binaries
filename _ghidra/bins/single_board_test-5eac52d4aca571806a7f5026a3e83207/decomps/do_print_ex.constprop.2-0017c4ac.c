...
LAB_0017c4e0:
    if (param_1 == (BIO *)0x0) {
      if ((int)(param_2 << 0x16) < 0) goto LAB_0017cd42;
      pcVar13 = (char *)(param_3.asn1_string)->length;
    }
    else {
      iVar14 = BIO_write(param_1,&DAT_0021ef60,1);
      if (iVar14 != 1) {
        return -1;
      }
      ...
      do {
        while( true ) {
          ...
          case 2:
            ...
            if (pbVar18 == pbVar20) goto LAB_0017c872;
            goto LAB_0017c652;
          default:
            goto LAB_0017c500;
          case 4:
...
LAB_0017c696:
                ...
                if ((uVar15 & 0x61) == 0) goto LAB_0017c696;
...
LAB_0017cc56:
                ...
                uVar15 = *(ushort *)(&char_type + uVar15 * 2) & uVar10;
                if ((uVar15 & 0x61) == 0) goto LAB_0017cc56;
                if ((int)(uVar15 << 0x1c) < 0) {
                  iVar8 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017cc34:
                ...
                uVar15 = *(ushort *)(&char_type + uVar15 * 2) & uVar10;
                if ((uVar15 & 0x61) == 0) goto LAB_0017cc34;
                if ((int)(uVar15 << 0x1c) < 0) {
                  iVar8 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017ccbe:
                ...
                if ((uVar15 & 0x61) == 0) goto LAB_0017ccbe;
                if ((int)(uVar15 << 0x1c) < 0) {
                  iVar8 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017cc9c:
                ...
                if ((uVar15 & 0x61) == 0) goto LAB_0017cc9c;
                if ((int)(uVar15 << 0x1c) < 0) {
                  iVar8 = 1;
                  local_42 = '\x01';
                }
              ...
              if (iVar3 != 5) {
                if ((int)((uint)local_37 << 0x18) < 0) {
                  ...
                  if ((uVar10 & 0x61) != 0) goto LAB_0017c792;
                }
                if ((uVar10 & 0x406) == 0) goto LAB_0017c79e;
                BIO_snprintf((char *)local_34,0xb,"\\%02X");
                iVar14 = iVar14 + 3;
              }
            }
...
LAB_0017cbc4:
                ...
                if ((uVar5 & 0x61) == 0) goto LAB_0017cbc4;
                if ((int)(uVar5 << 0x1c) < 0) {
                  iVar8 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017ce1c:
                ...
                uVar5 = *(ushort *)(&char_type + uVar15 * 2) & uVar10;
                if ((uVar5 & 0x61) == 0) goto LAB_0017ce1c;
                if ((int)(uVar5 << 0x1c) < 0) {
                  iVar8 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017ce06:
                ...
                uVar5 = *(ushort *)(&char_type + uVar15 * 2) & uVar10;
                if ((uVar5 & 0x61) == 0) goto LAB_0017ce06;
                if ((int)(uVar5 << 0x1c) < 0) {
                  iVar8 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017cdf0:
                ...
                uVar5 = *(ushort *)(&char_type + uVar15 * 2) & uVar10;
                if ((uVar5 & 0x61) == 0) goto LAB_0017cdf0;
                if ((int)(uVar5 << 0x1c) < 0) {
                  iVar8 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017cdda:
                ...
                uVar5 = *(ushort *)(&char_type + uVar15 * 2) & uVar10;
                if ((uVar5 & 0x61) == 0) goto LAB_0017cdda;
                if ((int)(uVar5 << 0x1c) < 0) {
                  iVar8 = 1;
                  local_42 = '\x01';
                }
...
LAB_0017cb86:
              ...
              if ((uVar10 & 0x61) == 0) goto LAB_0017cb86;
LAB_0017c792:
...
LAB_0017c7a0:
          pbVar17 = pbVar18;
          if (pbVar18 == pbVar20) goto LAB_0017c7ac;
        }
LAB_0017c652:
        if (bVar6 != 0) goto LAB_0017c658;
LAB_0017c880:
...
LAB_0017c7ac:
    ...
    if (local_42 == '\0') {
      ...
      iVar14 = BIO_write(param_1,&DAT_00238504,1);
      if (iVar14 != 1) {
        return -1;
      }
    }
...
LAB_0017cbf8:
    ...
    else if ((bVar1 == 4) && ((uVar10 & 3) != 0)) goto LAB_0017c552;
    if (pbVar16 != pbVar20) {
      bVar7 = bVar7 & 8;
      pbVar17 = pbVar16;
      do {
            ...
            do {
              while( true ) {
                ...
                if (((int)(uVar9 << 0x18) < 0) ||
                   ...
                   (uVar5 & 0x61) == 0)) break;
                if ((-1 < (int)(uVar5 << 0x1c)) &&
                   (iVar14 = BIO_write(param_1,&DAT_0021ef54,1), iVar14 != 1)) {
                  return -1;
                }
LAB_0017c94a:
...
LAB_0017c95a:
                if (ppbVar11 == ppbVar19) goto LAB_0017c962;
              }
              if ((uVar5 & 0x406) == 0) {
                if ((uVar9 != 0x5c) || (uVar4 == 0)) goto LAB_0017c94a;
                iVar14 = BIO_write(param_1,&DAT_001fac38,2);
                if (iVar14 != 2) {
                  return -1;
                }
                goto LAB_0017c95a;
...
LAB_0017c962:
    ...
    if ((local_42 == '\0') || (iVar14 = BIO_write(param_1,&DAT_00238504,1), iVar14 == 1)) {
      return local_68;
    }
  }
  else {
    if ((0x1d < iVar14 - 1U) || (bVar1 = tag2nbyte[iVar14], bVar1 == 0xff)) {
      if ((int)(param_2 << 0x17) < 0) goto LAB_0017c4e0;
      goto LAB_0017c59e;
    }
    bVar7 = bVar1;
    if ((int)(param_2 << 0x1b) < 0) {
...
LAB_0017c52e:
    ...
    pbVar20 = pbVar16 + local_64;
    if (bVar1 == 2) {
      if ((int)(local_64 << 0x1f) < 0) goto LAB_0017cbf8;
      goto LAB_0017c5b6;
    }
    if ((bVar1 != 4) || ((local_64 & 3) == 0)) goto LAB_0017c5b6;
LAB_0017c552:
