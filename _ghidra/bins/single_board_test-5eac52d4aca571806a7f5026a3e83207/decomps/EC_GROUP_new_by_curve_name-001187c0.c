...

{
  ...
  do {
    ...
    if (nid == (&curve_list)[iVar5 * 4]) {
      piVar4 = (int *)(&DAT_00259ec4)[iVar5 * 4];
      pEVar3 = (EC_METHOD *)(&DAT_00259ec8)[iVar5 * 4];
      if (piVar4 == (int *)0x0) {
...
LAB_001188be:
          ...
          if (a == (BIGNUM *)0x0) goto LAB_0011889a;
          puVar6 = puVar6 + iVar5;
          b = BN_bin2bn(puVar6,iVar5,(BIGNUM *)0x0);
          if (b == (BIGNUM *)0x0) goto LAB_0011889e;
          if (pEVar3 != (EC_METHOD *)0x0) {
            pEVar3 = (EC_METHOD *)(*(code *)pEVar3)();
            group = (BIGNUM *)EC_GROUP_new(pEVar3);
            if (group != (BIGNUM *)0x0) {
              iVar1 = (*(code *)group->d[6])(group,p,a,b,ctx);
              if (iVar1 != 0) goto LAB_00118956;
            }
...
LAB_00118a12:
          ...
          if (local_3c == (BIGNUM *)0x0) goto LAB_00118a12;
