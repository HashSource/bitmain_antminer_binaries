...
LAB_000ee840:
  ...
  do {
    ...
    if (ppVar7 == (pitem *)0x0) goto LAB_000ee86a;
LAB_000ee854:
    pvVar19 = ppVar7->data;
    iVar6 = param_1[0x20];
...
LAB_000eeb66:
        ...
        if (ppVar7 != (pitem *)0x0) goto LAB_000ee854;
        goto LAB_000ee86a;
      }
...
LAB_000eebb8:
      ...
      if (uVar20 != local_150) goto LAB_000eeb66;
      uVar15 = 0x454c;
