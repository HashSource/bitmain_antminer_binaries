...
LAB_000d4c80:
        ...
        if ((0 < iVar7) && (local_28 == uVar9)) goto LAB_000d4db8;
LAB_000d4ca0:
...
LAB_000d4db8:
      ...
      *(undefined2 *)((int)param_1 + 0xf26) = *(undefined2 *)(pbVar10 + 9);
      ...
      if (bVar1 == 0x15 || param_1[0x140] != 0) {
        if ((((uint)CONCAT11(bVar5,bVar2) ^ *param_1) & 0xff00) == 0) goto LAB_000d4d80;
      }
...
LAB_000d4d80:
        if ((uVar9 < 0x4541) &&
          ...
          if (param_1[0x3bf] - 0xd < uVar9) goto LAB_000d4c80;
          goto LAB_000d4db8;
        }
      }
    }
