...
LAB_00188d28:
                  ...
                  if (iVar6 == 0) goto LAB_00188d4c;
                  iVar6 = BN_is_one(a_00);
                  if (iVar6 != 0) goto LAB_00188d28;
                  iVar6 = BN_cmp(a_00,pBVar3);
                }
              }
              iVar2 = BN_GENCB_call(cb,1,local_30);
              if (iVar2 == 0) goto LAB_00188d4c;
              local_30 = local_30 + 1;
...
LAB_00188b98:
    ...
    do {
      ...
      if (uVar5 == 0xffffffff) goto LAB_00188c16;
      if (uVar5 == 0) {
        iVar2 = BN_is_word(p,(uint)uVar1);
        return iVar2;
      }
    } while (puVar7 != (ushort *)&UNK_00220c46);
    iVar2 = BN_GENCB_call(cb,1,-1);
    if (iVar2 != 0) goto LAB_00188b4c;
  }
LAB_00188c16:
  iVar2 = -1;
  mont = (BN_MONT_CTX *)0x0;
