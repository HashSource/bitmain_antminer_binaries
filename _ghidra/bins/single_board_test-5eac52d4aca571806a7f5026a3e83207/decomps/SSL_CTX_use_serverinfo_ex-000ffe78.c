        ...
        while ((1 < uVar4 - 2 && (uVar5 = (uint)CONCAT11(pbVar2[2],pbVar2[3]), uVar5 <= uVar4 - 4)))
        {
          ...
          if (uVar6 == 0) {
            ...
            *(uint *)(**(int **)(param_1 + 0xc0) + 0x10) = param_4;
            if (3 < param_4) goto LAB_000fffc8;
            goto LAB_0010003c;
          }
  ...
  while( true ) {
    ...
    if (uVar5 == 0x1d0) {
      iVar3 = SSL_CTX_add_server_custom_ext
                        (param_1,CONCAT11(param_3[4],param_3[5]),0xff0ad,0,0,0xfebc1,0);
    }
    else {
      iVar3 = SSL_CTX_add_custom_ext
                        (param_1,CONCAT11(param_3[4],param_3[5]),uVar5,0xff019,0,0,0xfebad,0);
    }
    if (iVar3 == 0) break;
    if (param_4 == 0) {
      return 1;
