...

{
  ...
  do {
    ...
    if ((app_methods == (_STACK *)0x0) || (iVar2 = sk_find(app_methods,local_8c), iVar2 < 0)) {
      puVar1 = (undefined4 *)OBJ_bsearch_(&local_90,&standard_methods,0xc,4,(cmp *)0xbbec5);
...
LAB_000bbf6c:
      ...
      if (pEVar3 == (EVP_PKEY_ASN1_METHOD *)0x0) goto LAB_000bbf6c;
    }
    if (-1 < *(int *)(pEVar3 + 8) << 0x1f) goto LAB_000bbf6c;
    type = *(int *)(pEVar3 + 4);
  } while( true );
}
