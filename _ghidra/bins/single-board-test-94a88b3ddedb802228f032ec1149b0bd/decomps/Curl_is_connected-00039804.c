...
int Curl_is_connected(int *param_1,int param_2,undefined1 *param_3)

{
  ...
  *param_3 = 0;
  ...
  if (*(char *)((int)param_1 + param_2 + 0x1f6) == '\0') {
    ...
    if (iVar1 < 0) {
      Curl_failf(iVar8,"Connection time-out");
      iVar7 = 0x1c;
    }
    else {
      uVar5 = 0;
        ...
        if (piVar9[0x57] != -1) {
          ...
          if (iVar2 == 0) {
            ...
            if (param_1[0x85] <= iVar2) {
              Curl_infof(iVar8,"After %ldms connect time, move on!\n");
              local_64 = 0x6e;
            }
            ...
            if (iVar2 != 0) {
              ...
              *(undefined1 *)((int)param_1 + param_2 + 0x1f6) = 1;
              *param_3 = 1;
              if (param_2 == 0) {
            ...
            Curl_infof(iVar8,"Connection failed\n");
          }
          ...
          if (local_64 != 0) {
            ...
            *piVar3 = iVar2;
            if (piVar9[0x14] != 0) {
              ...
              Curl_infof(iVar8,"connect to %s port %ld failed: %s\n",auStack_58,iVar7,uVar4);
              iVar7 = iVar1 >> 1;
      ...
      if ((iVar7 == 0) ||
        ...
        iVar6 = param_1[0x2c];
        uVar4 = Curl_strerror(param_1,local_64);
        Curl_failf(iVar8,"Failed to connect to %s port %ld: %s",iVar1,iVar6,uVar4);
      }
    }
  }
  else {
