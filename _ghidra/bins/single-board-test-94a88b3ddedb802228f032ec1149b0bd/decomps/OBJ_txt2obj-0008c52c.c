...
LAB_0008c660:
    ...
    do {
      ...
      if ((-1 < iVar6) && (iVar4 = iVar8 + 1, iVar8 = iVar3, iVar6 == 0)) goto LAB_0008c6aa;
      iVar3 = iVar8;
    } while (iVar4 < iVar8);
    if (iVar6 == 0) {
LAB_0008c6aa:
      local_38 = *(uint *)(&DAT_00147268 + iVar7 * 0x18);
      goto LAB_0008c562;
    }
  }
  else {
...
LAB_0008c6c4:
    ...
    do {
      ...
      iVar6 = strcmp(pcVar1,*(char **)(&DAT_00147264 + iVar7 * 0x18));
      if ((-1 < iVar6) && (iVar4 = iVar8 + 1, iVar8 = iVar3, iVar6 == 0)) goto LAB_0008c710;
      iVar3 = iVar8;
    } while (iVar4 < iVar8);
...
LAB_0008c606:
    if (local_38 < 0x3be) {
      if (*(int *)(&DAT_00147268 + local_38 * 0x18) == 0) {
