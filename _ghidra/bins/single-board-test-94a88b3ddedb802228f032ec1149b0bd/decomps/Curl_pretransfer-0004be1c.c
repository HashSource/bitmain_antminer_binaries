...

{
  ...
  if (iVar2 == 0) {
    ...
    *(undefined1 *)(param_1 + 0x8640) = 0;
    *(undefined4 *)(param_1 + 0x8630) = *(undefined4 *)(param_1 + 0x178);
    *(undefined1 *)(param_1 + 0x85a8) = 0;
    pcVar1 = Curl_cfree;
    *(undefined1 *)(param_1 + 0x85c8) = 0;
    (*pcVar1)(*(undefined4 *)(param_1 + 0x8720));
    *(undefined4 *)(param_1 + 0x8720) = 0;
    if (*(int *)(param_1 + 0x278) == 4) {
      puVar4 = (undefined4 *)(param_1 + 0x218);
    }
    else {
      puVar4 = (undefined4 *)(param_1 + 0x198);
    }
    uVar5 = puVar4[1];
    *(undefined4 *)(param_1 + 0x86b0) = *puVar4;
    *(undefined4 *)(param_1 + 0x86b4) = uVar5;
