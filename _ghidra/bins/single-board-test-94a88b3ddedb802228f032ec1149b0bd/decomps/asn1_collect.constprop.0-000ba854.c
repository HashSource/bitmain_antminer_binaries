...
asn1_collect_constprop_0
          (BUF_MEM *param_1,undefined4 *param_2,uchar *param_3,uint param_4,int param_5)
    ...
    if (0 < (int)param_3) {
      do {
        ...
        if (((param_3 != (uchar *)0x1) && (*local_3c == '\0')) && (local_3c[1] == '\0')) {
          local_3c = local_3c + 2;
          if (param_4 == 0) {
            ERR_put_error(0xd,0x6a,0x9f,"tasn_dec.c",0x434);
            return 0;
          }
          goto LAB_000ba8a2;
        }
        local_2c[0] = local_3c;
        uVar4 = ASN1_get_object(local_2c,(long *)&local_30,&iStack_38,&iStack_34,(long)param_3);
        if ((int)(uVar4 << 0x18) < 0) {
          ERR_put_error(0xd,0x68,0x66,"tasn_dec.c",0x4a2);
          ERR_put_error(0xd,0x6a,0x3a,"tasn_dec.c",0x43d);
          return 0;
        }
        __n = local_30;
        if ((uVar4 & 1) != 0) {
        ...
        if ((int)(uVar4 << 0x1a) < 0) {
          if (4 < param_5) {
            ERR_put_error(0xd,0x6a,0xc5,"tasn_dec.c",0x444);
            return 0;
          }
          ...
          if (param_1 != (BUF_MEM *)0x0) {
            ...
            if (iVar3 == 0) {
              ERR_put_error(0xd,0x8c,0x41,"tasn_dec.c",0x45b);
              return 0;
            }
...
LAB_000ba8a2:
      ...
      *param_2 = local_3c;
      ...
      ERR_put_error(0xd,0x6a,0x89,"tasn_dec.c",0x44e);
      uVar2 = 0;
    }
  }
  else {
