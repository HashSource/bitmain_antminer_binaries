...
int pop3_do(int *param_1,undefined1 *param_2)
...
LAB_00051502:
    ...
    iVar1 = Curl_pp_sendf(param_1 + 0xf0,"%s",pcVar4);
  }
  else {
    ...
    iVar1 = Curl_pp_sendf(param_1 + 0xf0,"%s %s",pcVar4);
  }
  if (iVar1 != 0) {
    return iVar1;
  }
