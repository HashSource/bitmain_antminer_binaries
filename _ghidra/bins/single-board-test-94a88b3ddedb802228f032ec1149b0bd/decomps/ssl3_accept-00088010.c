...
LAB_0008808a:
  iVar13 = iVar3;
  if (0x2181 < iVar13) goto LAB_000880e8;
LAB_0008808e:
  if (0x217f < iVar13) goto code_r0x00088094;
  if (iVar13 == 0x2122) {
    uVar2 = 0;
    param_1->state = 3;
    psVar11 = param_1->s3;
  ...
  if (iVar13 < 0x2123) {
    if (0x2112 < iVar13) {
      if (iVar13 == 0x2115) goto LAB_00088462;
      if ((iVar13 < 0x2115) || (iVar13 < 0x2120)) goto LAB_00088222;
      param_1->shutdown = 0;
      if (iVar13 == 0x2120) {
...
LAB_00088332:
      ...
      iVar3 = iVar13;
      if (uVar2 != 0) goto LAB_0008833c;
LAB_000880b4:
      if ((param_1->ctx != (SSL_CTX *)0x0) &&
         (local_34 = BIO_ctrl(param_1->wbio,0xb,uVar2,(void *)uVar2), local_34 < 1))
      goto LAB_00088238;
      if (p_Var12 == (_func_3294 *)0x0) goto LAB_0008833c;
      iVar13 = param_1->state;
      if (iVar3 == iVar13) goto LAB_0008808a;
      param_1->state = iVar3;
      (*p_Var12)(param_1,0x2001,1);
      param_1->state = iVar13;
      if (iVar13 < 0x2182) goto LAB_0008808e;
LAB_000880e8:
      if (0x21e1 < iVar13) {
        if (iVar13 < 0x2212) {
          if (iVar13 < 0x2210) {
            if (iVar13 < 0x21f0) goto LAB_00088222;
            if (iVar13 < 0x21f2) {
              ...
              if (1 < iVar13 - 0x2200U) goto LAB_00088222;
          ...
          if ((iVar13 != 0x4000) && (iVar13 != 0x6000)) {
            if (iVar13 != 0x3004) goto LAB_00088222;
...
LAB_00088a68:
      ...
      if (iVar13 < 0x21a2) {
        if (iVar13 < 0x21a0) {
          if (1 < iVar13 - 0x2190U) goto LAB_00088222;
      ...
      if (iVar13 < 0x21c0) goto LAB_00088222;
      if (iVar13 < 0x21c2) {
        psVar11 = param_1->s3;
        if (psVar11->change_cipher_spec == 0) {
          psVar11->flags = psVar11->flags | 0x80;
...
LAB_0008874e:
      ...
      if (1 < iVar13 - 0x21d0U) goto LAB_00088222;
      psVar15 = param_1->method->ssl3_enc;
...
LAB_000883e0:
    ...
    if (iVar13 == 0x2000) goto LAB_000882ba;
    if (iVar13 < 0x2001) {
      if (iVar13 != 3) goto LAB_00088222;
    ...
    if (iVar13 == 0x2003) goto LAB_000882ba;
    if (iVar13 == 0x2100) {
      param_1->rwstate = 2;
...
LAB_000886c4:
        ...
        if ((int)(uVar2 << 0x1f) < 0) {
          ...
          if ((int)(pSVar8->algo_strength << 0x1e) < 0) {
            ...
            if (iVar6 + iVar3 * -8 < 0 != SBORROW4(iVar6,iVar3 * 8)) goto LAB_000886c4;
          }
        }
        uVar2 = 1;
      }
    ...
    if (0x2161 < iVar13) {
      if (1 < iVar13 - 0x2170U) goto LAB_00088222;
      if (iVar13 == 0x2170) {
