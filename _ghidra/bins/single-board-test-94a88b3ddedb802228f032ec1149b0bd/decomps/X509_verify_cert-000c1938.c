...
LAB_000c196a:
      ...
      while ((iVar4 <= iVar21 &&
        ...
        if (pXVar14 == (X509 *)0x0) goto LAB_000c19de;
        iVar18 = 0;
        do {
          iVar6 = sk_num(p_Var3);
          if (iVar6 <= iVar18) {
...
LAB_000c19ea:
      ...
      if ((int)(pXVar5->ex_flags << 0x12) < 0) {
        ...
        if (iVar8 == 1) {
          ...
          if (pXVar14 == (X509 *)0x0) goto LAB_000c1a64;
          bVar1 = true;
        }
        else {
...
LAB_000c1cfc:
        if ((pXVar17->flags & 0x108000) == 0) {
          ...
          do {
            ...
            if ((int)pXVar14 < 0) goto LAB_000c1a64;
            iVar18 = iVar4 + -1;
