    ...
    *param_2 = *(undefined4 *)(ssl_cipher_methods + iVar1 * 4);
    ...
    if (0x40 < uVar5) {
      if (uVar5 == 0x400) {
        ...
        if (uVar5 == 0x100) {
          ...
          if (uVar5 != 0x80) goto LAB_000800f4;
          iVar1 = 7;
        }
      }
        ...
        if (uVar5 != 0x800) goto LAB_000800f4;
        iVar1 = 0xb;
      }
      goto LAB_0008010a;
    }
    ...
    if (4 < uVar5) {
      if (uVar5 == 0x10) {
        ...
        if (uVar5 != 8) goto LAB_000800f4;
        iVar1 = 3;
      }
      goto LAB_0008010a;
    }
    if (uVar5 == 1) goto LAB_0008010a;
    if (uVar5 == 2) {
      iVar1 = 1;
      goto LAB_0008010a;
    }
...
LAB_00080114:
  ...
  if ((iVar1 - 1U < 0x20) && (uVar5 = (uint)(char)(&DAT_00141cc3)[iVar1], uVar5 < 6)) {
  ...
  if (iVar1 == 4) {
    ...
    if (pEVar4 != (EVP_CIPHER *)0x0) goto LAB_000801c4;
    iVar1 = *(int *)(iVar6 + 0x14);
  }
  if (iVar1 == 0x40) {
    iVar1 = *(int *)(iVar6 + 0x18);
