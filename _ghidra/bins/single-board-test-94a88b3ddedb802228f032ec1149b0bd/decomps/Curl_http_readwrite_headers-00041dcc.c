...

{
  ...
  do {
    ...
    *(void **)(param_1 + 0xb4) = pvVar3;
    ...
    sVar17 = (int)pvVar3 + (1 - (int)pcVar14);
    *param_3 = sVar16 - sVar17;
      ...
      if (iVar7 - 100U < 100) {
        ...
        *(undefined4 *)(param_1 + 0xa0) = 0;
        if (iVar7 == 100) {
          ...
          Curl_infof(param_1,"Received 101\n");
...
LAB_00041ea2:
          ...
          if (iVar7 == 2) {
            Curl_infof(param_1,"Connection closure while negotiating auth (HTTP 1.0?)\n");
            *(undefined1 *)(param_1 + 0x8640) = 1;
          }
        }
      }
      else {
        *(undefined1 *)(param_1 + 0x98) = 0;
        ...
        if (((*(int *)(param_2 + 0x13c) == 0xb) &&
           ...
           (*(int *)(param_1 + 0x278) != 5)) {
          Curl_infof(param_1,"no chunk, no close, no size. Assume close to signal end\n");
          iVar7 = *(int *)(param_1 + 200);
          *(undefined1 *)(param_2 + 0x1ed) = 1;
          goto LAB_00041ea2;
        }
      }
LAB_00041eb6:
      ...
      if (iVar7 != 0) {
        Curl_failf(param_1,"The requested URL returned error: %d",*(undefined4 *)(param_1 + 200));
        return 0x16;
      }
      ...
      cVar13 = *param_4;
      iVar11 = *(int *)(param_1 + 0x80) + iVar7;
      *(int *)(param_1 + 0x80) = iVar11;
      if (99 < *(int *)(param_1 + 200) - 100U) {
        iVar11 = 0;
      }
      *(int *)(param_1 + 0x84) = iVar11;
...
joined_r0x00042220:
          ...
          goto LAB_00041f18;
          Curl_infof(param_1,"HTTP error before end of send, stop sending\n");
        ...
        Curl_infof(param_1,"Keep sending data to get tossed away!\n");
        *(uint *)(param_1 + 0x130) = *(uint *)(param_1 + 0x130) | 2;
      }
LAB_00041f18:
...
LAB_00042116:
          ...
          *param_4 = '\x01';
LAB_00041f36:
          if (iVar12 == -1 && iVar11 == -1) goto LAB_00042116;
          Curl_pgrsSetDownloadSize(param_1);
          iVar11 = *(int *)(param_1 + 0x50);
          iVar12 = *(int *)(param_1 + 0x54);
          *(int *)(param_1 + 0x60) = iVar11;
...
joined_r0x00042238:
      ...
      *(int *)(param_1 + 0xa0) = iVar7 + 1;
      if (iVar7 == 0) {
        ...
        if ((uVar4 & 3) == 0) {
          if ((-1 < (int)(uVar4 << 0xd)) ||
             (iVar7 = __isoc99_sscanf(pcVar14," RTSP/%d.%d %3d",&local_30,param_2 + 0x140,
                                      param_1 + 200), iVar7 != 3)) {
LAB_0004203a:
            *(undefined1 *)(param_1 + 0x98) = 0;
            return 0;
          ...
          *(int *)(param_2 + 0x140) = *(int *)(param_2 + 0x140) + local_30 * 10;
          ...
          iVar7 = __isoc99_sscanf(pcVar14," HTTP/%d.%d %d",&local_34,param_2 + 0x13c,param_1 + 200);
          if (iVar7 == 3) {
            iVar11 = *(int *)(param_1 + 0xd8);
            iVar7 = *(int *)(param_2 + 0x13c) + local_34 * 10;
            *(int *)(param_2 + 0x13c) = iVar7;
            if ((iVar11 == 2) && (iVar7 != 0x14)) {
              Curl_infof(param_1,"Lying server, not serving HTTP/2\n");
              iVar7 = *(int *)(param_2 + 0x13c);
            }
          }
          else {
            iVar11 = __isoc99_sscanf(*(undefined4 *)(param_1 + 0xb8)," HTTP %3d",param_1 + 200);
...
joined_r0x0004277a:
          ...
          if (((*(int *)(param_1 + 0x8698) == 0 && *(int *)(param_1 + 0x869c) == 0) ||
            ...
            if (((iVar7 == 0) && (pcVar14 = strchr(pcVar14,0x20), pcVar14 != (char *)0x0)) &&
              ...
              *pcVar6 = '\0';
              Curl_failf(param_1,"The requested URL returned error: %s",pcVar14);
              *pcVar6 = cVar13;
            }
            else {
LAB_0004293c:
              Curl_failf(param_1,"The requested URL returned error: %d",iVar11);
            }
            return 0x16;
          }
        }
LAB_00042332:
        if (iVar7 == 10) {
          Curl_infof(param_1,"HTTP 1.0, assume close after body\n");
          iVar11 = *(int *)(param_1 + 200);
          *(undefined1 *)(param_2 + 0x1ed) = 1;
        }
        else if ((iVar7 == 0x14) || ((*(int *)(param_1 + 0xd8) == 1 && (iVar11 == 0x65)))) {
      ...
      if ((cVar13 == '\0') && (*(char *)(param_1 + 0x327) == '\0')) {
        iVar7 = Curl_raw_nequal("Content-Length:",pcVar14,0xf);
        if (iVar7 == 0) {
          pcVar14 = *(char **)(param_1 + 0xb8);
          goto LAB_00041f9c;
        }
        lVar18 = strtoll((char *)(*(int *)(param_1 + 0xb8) + 0xf),(char **)0x0,10);
        iVar7 = (int)((ulonglong)lVar18 >> 0x20);
        uVar4 = (uint)lVar18;
        uVar10 = *(uint *)(param_1 + 0x2e0);
        iVar11 = *(int *)(param_1 + 0x2e4);
        if ((uVar10 != 0 || iVar11 != 0) &&
           ((int)((iVar11 - iVar7) - (uint)(uVar10 < uVar4)) < 0 !=
            (SBORROW4(iVar11,iVar7) != SBORROW4(iVar11 - iVar7,(uint)(uVar10 < uVar4))))) {
          Curl_failf(param_1,"Maximum file size exceeded");
          return 0x3f;
        }
        if (lVar18 < 0) {
          *(undefined1 *)(param_2 + 0x1ed) = 1;
          Curl_infof(param_1,"Negative content-length: %lld, closing after transfer\n",uVar4,iVar7);
          iVar7 = *(int *)(param_1 + 0xb8);
        }
        else {
          *(longlong *)(param_1 + 0x50) = lVar18;
          *(longlong *)(param_1 + 0x60) = lVar18;
...
LAB_00041f9c:
        iVar7 = Curl_raw_nequal("Content-Type:",pcVar14,0xd);
        if (iVar7 == 0) {
          iVar7 = Curl_raw_nequal("Server:",*(undefined4 *)(param_1 + 0xb8),7);
          iVar11 = *(int *)(param_2 + 0x13c);
          if (iVar7 != 0) {
            if (iVar11 < 0x14) {
          ...
          if (iVar11 == 10) {
            if (*(char *)(param_2 + 0x1f0) != '\0') {
              iVar7 = Curl_compareheader(*(undefined4 *)(param_1 + 0xb8),"Proxy-Connection:",
                                         "keep-alive");
              if (iVar7 != 0) {
                *(undefined1 *)(param_2 + 0x1ed) = 0;
                Curl_infof(param_1,"HTTP/1.0 proxy connection set to keep alive!\n");
                iVar7 = *(int *)(param_1 + 0xb8);
                goto LAB_00041fd8;
              }
              iVar11 = *(int *)(param_2 + 0x13c);
...
LAB_000423fe:
            iVar7 = Curl_compareheader(*(undefined4 *)(param_1 + 0xb8),"Connection:","keep-alive");
            if (iVar7 != 0) {
              *(undefined1 *)(param_2 + 0x1ed) = 0;
              Curl_infof(param_1,"HTTP/1.0 connection set to keep alive!\n");
              iVar7 = *(int *)(param_1 + 0xb8);
              goto LAB_00041fd8;
            }
          }
...
LAB_00042122:
            if (iVar11 == 0xb) {
              if (*(char *)(param_2 + 0x1f0) != '\0') {
                ...
                if (iVar7 != 0) {
                  *(undefined1 *)(param_2 + 0x1ed) = 1;
                  Curl_infof(param_1,"HTTP/1.1 proxy connection set close!\n");
                  iVar7 = *(int *)(param_1 + 0xb8);
                  goto LAB_00041fd8;
                }
                iVar11 = *(int *)(param_2 + 0x13c);
...
LAB_00042128:
              if (iVar11 == 10) goto LAB_000423fe;
            }
          }
          iVar7 = Curl_compareheader(*(undefined4 *)(param_1 + 0xb8),"Connection:","close");
          if (iVar7 == 0) {
            iVar7 = Curl_raw_nequal("Transfer-Encoding:",*(undefined4 *)(param_1 + 0xb8),0x12);
            if (iVar7 != 0) {
...
LAB_0004259a:
              do {
                ...
                while( true ) {
                  ...
                  iVar7 = Curl_raw_nequal("chunked",pbVar15,7);
                  if (iVar7 != 0) {
                  ...
                  iVar7 = Curl_raw_nequal("identity",pbVar15,8);
                  if (iVar7 == 0) break;
                  pbVar15 = pbVar15 + 8;
                  *(undefined4 *)(param_1 + 0xdc) = 0;
                  bVar1 = *pbVar15;
                }
                iVar7 = Curl_raw_nequal("deflate",pbVar15,7);
                if (iVar7 != 0) {
                  pbVar15 = pbVar15 + 7;
                  *(undefined4 *)(param_1 + 0xdc) = 1;
                  goto LAB_0004259a;
                }
                iVar7 = Curl_raw_nequal(&DAT_00136518,pbVar15,4);
                if (iVar7 == 0) {
                  iVar7 = Curl_raw_nequal("x-gzip",pbVar15,6);
            ...
            iVar7 = Curl_raw_nequal("Content-Encoding:",*(undefined4 *)(param_1 + 0xb8),0x11);
            if ((iVar7 == 0) || (*(int *)(param_1 + 0x35c) == 0)) {
              iVar7 = Curl_raw_nequal("Content-Range:",*(undefined4 *)(param_1 + 0xb8),0xe);
              if (iVar7 == 0) {
                if ((*(int *)(param_1 + 0x468) == 0) ||
                   (iVar7 = Curl_raw_nequal("Set-Cookie:",*(undefined4 *)(param_1 + 0xb8),0xb),
                   iVar7 == 0)) {
                  iVar7 = Curl_raw_nequal("Last-Modified:",*(undefined4 *)(param_1 + 0xb8),0xe);
                  if ((iVar7 != 0) &&
                  ...
                  iVar7 = Curl_raw_nequal("WWW-Authenticate:",*(undefined4 *)(param_1 + 0xb8),0x11);
                  if ((iVar7 == 0) || (iVar7 = *(int *)(param_1 + 200), iVar7 != 0x191)) {
                    iVar11 = Curl_raw_nequal("Proxy-authenticate:",*(undefined4 *)(param_1 + 0xb8),
                                             0x13);
                    iVar7 = *(int *)(param_1 + 200);
                    if ((iVar11 != 0) && (iVar7 == 0x197)) goto LAB_00042a5a;
                    if (((99 < iVar7 - 300U) ||
                        (iVar7 = Curl_raw_nequal("Location:",*(undefined4 *)(param_1 + 0xb8),9),
...
LAB_00042a5a:
                    iVar11 = Curl_copy_header_value(*(undefined4 *)(param_1 + 0xb8));
                    if (iVar11 == 0) {
                      return 0x1b;
                    }
                    uVar4 = Curl_http_input_auth(param_2,iVar7 == 0x197,iVar11);
                    (*Curl_cfree)(iVar11);
joined_r0x00042b1a:
                    if (uVar4 != 0) {
                      return uVar4;
...
LAB_00042848:
                  lVar18 = strtoll((char *)pbVar15,(char **)0x0,10);
                  *(longlong *)(param_1 + 0xc0) = lVar18;
                  if (lVar18 != *(longlong *)(param_1 + 0x8698)) goto LAB_000420e2;
                  iVar7 = *(int *)(param_1 + 0xb8);
              ...
              if (iVar7 == 0) {
                ...
                if (iVar7 == 0) {
                  iVar7 = Curl_raw_nequal(&DAT_00136518,pbVar15,4);
                  if ((iVar7 == 0) && (iVar7 = Curl_raw_nequal("x-gzip",pbVar15,6), iVar7 == 0))
                  goto LAB_000420e2;
                  iVar7 = *(int *)(param_1 + 0xb8);
                  *(undefined4 *)(param_1 + 0xdc) = 2;
                }
