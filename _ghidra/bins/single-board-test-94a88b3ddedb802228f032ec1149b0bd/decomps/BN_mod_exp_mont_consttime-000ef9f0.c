...

{
  ...
  if (in_mont == (BN_MONT_CTX *)0x0) {
    ...
    local_68 = pBVar7;
    if (pBVar7 == (BN_MONT_CTX *)0x0) goto LAB_000efb36;
...
LAB_000efa7e:
      ...
      if ((int)puVar23[(int)(puVar20 + -1)] < 0) {
        ...
        *puVar24 = ctx;
        ...
        if (pBVar7 == (BN_MONT_CTX *)0x0) goto LAB_000efb16;
      }
          ...
          if (-1 < (int)puVar22) {
            ...
            do {
              ...
              if ((local_3c.dmax < (int)local_60) &&
                 ...
                 pBVar7 == (BN_MONT_CTX *)0x0)) goto LAB_000efb16;
              pBVar21 = local_70;
              if (local_6c != 0) {
                iVar17 = 0;
                do {
