...
LAB_000631da:
  ...
  while( true ) {
    ...
    if ((int)(uVar21 << 0x1b) < 0) {
      ...
      if (-1 < (int)(uVar21 << 0x1b)) goto joined_r0x00063298;
      goto LAB_000632ca;
    }
  ...
  if (puVar5 == (undefined1 *)0x0) {
    ...
    if (puVar18 < puVar19) {
      ...
      if (uVar7 != 0 &&
        ...
        if (puVar18 == puVar29) goto LAB_000634d4;
      }
...
LAB_000637c8:
        ...
        if (puVar30 != puVar29) goto LAB_000637c8;
      }
      ...
      if (puVar5 < puVar19) {
        ...
        if (((((uint)puVar41 | (uint)puVar34) & 3) == 0 &&
          ...
          if (puVar5 != puVar25) goto LAB_000638fa;
        }
        else {
LAB_000638fa:
    ...
    if (puVar18 < puVar19) {
      ...
      if (uVar7 != 0 &&
        ...
        local_a4 = puVar18 + uVar7 * -4;
        if (puVar18 == puVar8) goto LAB_000634d4;
      }
      local_a4 = local_ac + (int)local_a4;
      do {
        local_ac = local_ac + 1;
