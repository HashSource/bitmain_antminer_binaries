...

{
  ...
  if (iVar4 == 0) {
    if (param_2 == (char *)0x0) {
      ...
      pcVar3 = (char *)CRYPTO_malloc(sVar1 + 1,"dso_dlfcn.c",0x137);
      iVar4 = 0x139;
      if (pcVar3 != (char *)0x0) {
    ...
    if (*param_2 != '/') {
      ...
      pcVar3 = (char *)CRYPTO_malloc(iVar4 + 2,"dso_dlfcn.c",0x14e);
      if (pcVar3 != (char *)0x0) {
        strcpy(pcVar3,param_3);
        pcVar3[sVar1] = '/';
  ...
  pcVar3 = (char *)CRYPTO_malloc(sVar1 + 1,"dso_dlfcn.c",300);
  iVar4 = 0x12e;
  if (pcVar3 != (char *)0x0) {
...
LAB_00126766:
  ERR_put_error(0x25,0x82,0x41,"dso_dlfcn.c",iVar4);
  return pcVar3;
}
