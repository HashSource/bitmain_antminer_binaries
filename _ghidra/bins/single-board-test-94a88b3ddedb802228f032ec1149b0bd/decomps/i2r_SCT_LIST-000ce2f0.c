...
LAB_000ce300:
  ...
  do {
    ...
    iVar1 = param_4 + 4;
    BIO_printf(param_3,"%*sSigned Certificate Timestamp:",param_4,&DAT_0013a6fc);
    BIO_printf(param_3,"\n%*sVersion   : ",iVar1,&DAT_0013a6fc);
    if (*(char *)((int)puVar2 + 6) == '\0') {
      iVar8 = param_4 + 0x10;
      BIO_printf(param_3,"v1(0)");
      BIO_printf(param_3,"\n%*sLog ID    : ",iVar1,&DAT_0013a6fc);
      BIO_hex_string(param_3,iVar8,0x10,puVar2[2],*(undefined2 *)(puVar2 + 3));
      BIO_printf(param_3,"\n%*sTimestamp : ",iVar1,&DAT_0013a6fc);
      uVar6 = puVar2[4];
      uVar7 = puVar2[5];
      ...
      BIO_printf(param_3,"\n%*sExtensions: ",iVar1,&DAT_0013a6fc);
      if (*(short *)(puVar2 + 7) == 0) {
