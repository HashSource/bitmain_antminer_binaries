...
undefined4 i2r_PKEY_USAGE_PERIOD(undefined4 param_1,int *param_2,BIO *param_3,undefined4 param_4)

{
  BIO_printf(param_3,"%*s",param_4,&DAT_0013a6fc,param_4);
  if (*param_2 != 0) {
    ...
    BIO_write(param_3,&DAT_0013677c,2);
  }
  if (param_2[1] != 0) {
