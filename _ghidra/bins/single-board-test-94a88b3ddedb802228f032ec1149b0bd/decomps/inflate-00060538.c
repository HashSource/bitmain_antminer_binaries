...
LAB_000605a8:
  ...
  case 0:
    ...
    if (puVar28 < &DAT_00000010) {
      do {
        if (puVar27 == (uint *)0x0) goto LAB_00060cf6;
        __src = pbVar17 + 1;
        ...
        pbVar17 = __src;
      } while (puVar28 <= &DAT_0000000f);
    }
    if (((int)(uVar10 << 0x1e) < 0) && (puVar25 == (uint *)0x8b1f)) {
      puVar28 = (uint *)0x0;
      uVar10 = crc32(0,0,0);
      local_2c = 0x1f;
      puVar29[6] = uVar10;
...
LAB_0006096e:
    ...
    break;
  case 2:
    if (puVar28 < (uint *)0x20) goto LAB_0006096e;
LAB_00060996:
    if (puVar29[8] != 0) {
...
LAB_000609b6:
    ...
    goto LAB_00060cf6;
  case 3:
    if (puVar28 < &DAT_00000010) goto LAB_000609b6;
LAB_000609de:
    uVar10 = puVar29[8];
    if (uVar10 != 0) {
...
LAB_00060a68:
    if (uVar19 != 0) {
      ...
      pbVar17 = __src;
      if (puVar14 != (uint *)0x0) goto LAB_00060cf6;
      uVar10 = puVar29[4];
    }
    puVar29[0x10] = 0;
    *puVar29 = 6;
...
LAB_00060b52:
  ...
  case 4:
    uVar10 = puVar29[4];
    if (-1 < (int)(uVar10 << 0x15)) goto LAB_000613fe;
    if (puVar28 < &DAT_00000010) goto joined_r0x00060a18;
    goto LAB_00060a42;
  case 5:
    uVar10 = puVar29[4];
    uVar19 = uVar10 & 0x400;
...
switchD_000605ae_caseD_b:
    pbVar17 = __src;
    if ((char *)((int)param_2 + -5) < (char *)0x2) goto LAB_00060cf6;
switchD_000605ae_caseD_c:
  ...
  case 0xd:
    ...
    for (puVar28 = (uint *)((uint)puVar28 & 0xfffffff8); pbVar17 = __src, puVar28 < (uint *)0x20;
        puVar28 = puVar28 + 2) {
      if (puVar27 == (uint *)0x0) goto LAB_00060cf6;
      puVar27 = (uint *)((int)puVar27 + -1);
      puVar25 = (uint *)((int)puVar25 + ((uint)*__src << ((uint)puVar28 & 0xff)));
...
LAB_00060f32:
  ...
  case 0x11:
    uVar10 = puVar29[0x17];
    uVar19 = puVar29[0x1a];
    if (uVar19 < uVar10) goto LAB_00060f32;
LAB_00060f7a:
    if (uVar19 < 0x13) {
      puVar6 = (ushort *)(order_6170 + (uVar19 - 1) * 2);
      do {
...
LAB_00060ff2:
      ...
      uVar10 = puVar29[0x19];
      while (pbVar17 = __src, puVar14 < (uint *)(uVar10 + (int)local_50)) {
...
LAB_000610be:
          ...
          if ((uint *)(uVar10 + (int)local_50) < puVar12) goto LAB_00061c64;
          uVar21 = uVar19 - 1;
...
LAB_0006119a:
            ...
            if (uVar19 - uVar24 != uVar20 * 2) goto LAB_0006119a;
          }
      ...
      if ((short)puVar29[0x9c] == 0) {
        ...
        *puVar29 = 0x1d;
        ...
        if (local_5c == 0) {
          ...
          if (local_5c == 0) {
            *puVar29 = 0x13;
            if (param_2 == (uint *)&DAT_00000006) goto LAB_00060cf6;
...
LAB_000615ac:
                      ...
                      if ((uint *)(uVar10 * 4) != puVar16) goto LAB_000615ac;
                    }
