...

{
  ...
  st_00 = sk_new_null();
  CRYPTO_lock(9,0xb,"x509_lu.c",0x21a);
  x509_object_idx_cnt(st->ctx->objs,2,nm,&local_2c);
  CRYPTO_lock(10,0xb,"x509_lu.c",0x221);
  ...
  if (iVar1 == 0) {
    ...
    CRYPTO_lock(9,0xb,"x509_lu.c",0x227);
    iVar1 = x509_object_idx_cnt(st->ctx->objs,2,nm,&local_2c);
    if (iVar1 < 0) {
      CRYPTO_lock(10,0xb,"x509_lu.c",0x22a);
      p_Var5 = (_STACK *)0x0;
      sk_free(st_00);
    }
    else {
      if (0 < local_2c) {
        ...
        do {
          ...
          CRYPTO_add_lock(&a->references,1,6,"x509_lu.c",0x232);
          iVar3 = sk_push(st_00,a);
          if (iVar3 == 0) {
            CRYPTO_lock(10,0xb,"x509_lu.c",0x234);
            X509_CRL_free(a);
      ...
      CRYPTO_lock(10,0xb,"x509_lu.c",0x23a);
      p_Var5 = st_00;
    }
  }
