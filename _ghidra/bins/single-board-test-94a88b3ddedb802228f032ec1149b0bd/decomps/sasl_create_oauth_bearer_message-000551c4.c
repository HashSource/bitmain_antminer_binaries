...

{
  ...
  if (param_3 == 0) {
    if (param_4 == 0 || param_4 == 0x50) {
      __s = (char *)curl_maprintf(&DAT_0013a6e4,param_2,param_5);
      goto joined_r0x00055228;
    }
  }
  else if (param_4 == 0 || param_4 == 0x50) {
    __s = (char *)curl_maprintf(&DAT_0013a700,param_2,param_3,param_5);
    goto joined_r0x00055228;
  }
  __s = (char *)curl_maprintf(&DAT_0013a724,param_2,param_3,param_4,param_5);
joined_r0x00055228:
  if (__s == (char *)0x0) {
    uVar2 = 0x1b;
  }
