...

{
  ...
  if ((((((iVar1 != 0) && (iVar1 = ENGINE_set_name(e,"Nuron hardware engine support"), iVar1 != 0))
      ...
      ((iVar1 = ENGINE_set_destroy_function(e,(ENGINE_GEN_INT_FUNC_PTR)0xdcba5), iVar1 != 0 &&
       ((iVar1 = ENGINE_set_init_function(e,(ENGINE_GEN_INT_FUNC_PTR)0xdcce5), iVar1 != 0 &&
        (iVar1 = ENGINE_set_finish_function(e,(ENGINE_GEN_INT_FUNC_PTR)0xdcbe9), iVar1 != 0)))))) &&
     ((iVar1 = ENGINE_set_ctrl_function(e,(ENGINE_CTRL_FUNC_PTR)0xdcc51), iVar1 != 0 &&
