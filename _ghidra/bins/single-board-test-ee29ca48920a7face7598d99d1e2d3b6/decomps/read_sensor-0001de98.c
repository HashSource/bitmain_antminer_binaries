...
undefined4
read_sensor(undefined1 param_1,int param_2,undefined1 param_3,byte param_4,undefined1 *param_5)

{
  ...
  local_18 = 0;
  iVar1 = i2c_recv(param_1,*(undefined1 *)((int)&sensor_chip_addr + param_2),param_3,param_4,
                   &local_18);
  if (iVar1 == 0) {
