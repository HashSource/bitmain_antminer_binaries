...

{
  ...
  show_id_alive = 1;
  pthread_create((pthread_t *)(cgpu + 8),(pthread_attr_t *)0x0,(__start_routine *)0x2af05,
                 (void *)0x0);
  init_fpga();
  set_fpga_baud(0x1a);
  check_chain();
  if (gChain == 0xff) {
    ...
    pthread_create((pthread_t *)(cgpu + 0xc),(pthread_attr_t *)0x0,(__start_routine *)0x263ed,
                   &chain_info + gChain);
