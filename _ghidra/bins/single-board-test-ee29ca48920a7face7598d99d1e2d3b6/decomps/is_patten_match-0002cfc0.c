...

{
  ...
  pthread_mutex_lock((pthread_mutex_t *)(g_patten + 0x84));
  ...
  if ((iVar1 == 0) && (iVar2 == 0)) {
    ...
    *piVar3 = *piVar3 + 1;
    ...
    printf("Patten Success Rate %.2f recv %d total %d asic %d recv %d\n",g_patten._120_4_,
           SUB84((double)((float)g_patten._124_4_ * 100.0),0),
           (int)((ulonglong)(double)((float)g_patten._124_4_ * 100.0) >> 0x20),g_patten._112_4_,
           g_patten._120_4_,g_patten._96_4_,*(undefined4 *)(g_patten._96_4_ * 4 + g_patten._116_4_))
    ;
    local_14 = 0;
  }
  else {
  ...
  pthread_mutex_unlock((pthread_mutex_t *)(g_patten + 0x84));
  return local_14;
}
