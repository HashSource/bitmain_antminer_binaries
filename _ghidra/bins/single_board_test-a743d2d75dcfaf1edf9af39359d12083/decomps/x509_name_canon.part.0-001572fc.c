  ...
  if (st == (_STACK *)0x0) {
    ...
    if (0 < iVar2) {
      do {
        ...
        if (val == (ASN1_VALUE *)0x0) goto LAB_0015738c;
                ...
                while (pbVar14 = pbVar11, bVar1 = *pbVar10, (bVar1 & 0x80) == 0) {
                  ...
                  if ((int)((uint)(*ppuVar7)[(short)(ushort)bVar1] << 0x12) < 0) {
                    ...
                    do {
                      pbVar10 = pbVar10 + 1;
                      iVar12 = iVar12 + 1;
                      if ((int)((uint)*pbVar10 << 0x18) < 0) goto LAB_001573a8;
                  ...
                  pbVar11 = pbVar14 + 1;
                  if (iVar2 <= iVar12) goto LAB_001573b2;
                }
                pbVar10 = pbVar10 + 1;
                iVar12 = iVar12 + 1;
                pbVar14[-1] = bVar1;
