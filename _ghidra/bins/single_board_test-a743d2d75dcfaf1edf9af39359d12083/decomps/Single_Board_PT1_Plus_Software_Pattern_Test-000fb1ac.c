...

{
  ...
  while( true ) {
    ...
    iVar3 = pthread_create(&show_id,(pthread_attr_t *)0x0,(__start_routine *)0x5be19,(void *)0x0);
    if (iVar3 != 0) {
    ...
    if ((Local_Config_Information->Hash_Board).Sensor_Info.Read_Temperature_From_Pic != false) {
      ...
      iVar3 = pthread_create(&read_temp_from_pic_id,(pthread_attr_t *)0x0,(__start_routine *)0x60ac1
                             ,(void *)0x0);
      if (iVar3 != 0) {
    ...
    gStart_receive = true;
    iVar3 = pthread_create(&receive_id,(pthread_attr_t *)0x0,(__start_routine *)0xf6095,(void *)0x0)
    ;
    if (iVar3 != 0) break;
