...

{
  ...
  *(uint *)(param_1 + 0x24) = uVar8;
  ...
  if (param_4 < 0x10) {
    local_60 = param_3;
    if (param_4 != 0) goto LAB_00185cfe;
  }
  else {
    puVar11 = param_3 + 8;
    puVar17 = param_2 + 8;
...
LAB_00185d74:
        ...
        uVar5 = uVar14;
        if (param_4 != uVar14) goto LAB_00185d74;
      }
      ...
      if (iVar6 != 0 ||
        ...
        if (param_4 == uVar14) goto LAB_00185e14;
      }
      do {
...
LAB_00185e14:
  ...
  if (uVar8 != 0) {
    ...
    if (uVar14 == uVar8) goto LAB_00185ec8;
  }
  ...
  if (uVar7 != 0) {
    ...
    uVar5 = uVar5 + uVar7 * 4;
    if (uVar14 - uVar8 == uVar7 * 4) goto LAB_00185ec8;
  }
  do {
    param_1[uVar5] = 0;
    uVar5 = uVar5 + 1;
