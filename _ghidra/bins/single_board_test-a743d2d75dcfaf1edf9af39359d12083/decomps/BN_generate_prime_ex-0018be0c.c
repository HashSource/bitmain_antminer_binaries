        ...
        if (safe != 0) {
          ...
          if (cb == (BN_GENCB *)0x0) {
            ...
            while( true ) {
              ...
              goto LAB_0018bf1c;
              if (iVar8 <= iVar6) goto LAB_0018c15a;
            }
          }
          goto LAB_0018be64;
        }
        iVar7 = BN_is_prime_fasttest_ex_constprop_2(ret,iVar8,ctx,cb);
        if (iVar7 == -1) goto LAB_0018bf1c;
      } while (iVar7 == 0);
LAB_0018c15a:
      iVar8 = 1;
    }
