    ...
    *(uint *)(param_1 + 0x7c) = uVar7;
    if (pEVar8 == (EVP_CIPHER_CTX *)0x0) {
      ...
      *(EVP_CIPHER_CTX **)(param_1 + 0x80) = pEVar8;
      if (pEVar8 == (EVP_CIPHER_CTX *)0x0) goto LAB_00111d9c;
...
LAB_00111d9c:
      ...
      if (local_100 == (EVP_MD_CTX *)0x0) goto LAB_00111d9c;
...
LAB_00111e1c:
    ...
    if (*(int *)(*(int *)(param_1 + 0x58) + 0x374) < iVar6 + local_110) goto LAB_00111e1c;
  }
