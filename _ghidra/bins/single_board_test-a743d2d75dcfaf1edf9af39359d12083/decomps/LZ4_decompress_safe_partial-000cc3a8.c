...
/* WARNING: Removing unreachable block (ram,0x000cc88e) */
/* WARNING: Removing unreachable block (ram,0x000cc898) */
/* WARNING: Removing unreachable block (ram,0x000cc89a) */
/* WARNING: Removing unreachable block (ram,0x000cc89c) */
/* WARNING: Removing unreachable block (ram,0x000cc8a2) */
/* WARNING: Removing unreachable block (ram,0x000cc472) */
/* WARNING: Removing unreachable block (ram,0x000cc47a) */
/* WARNING: Removing unreachable block (ram,0x000cc48a) */
/* WARNING: Removing unreachable block (ram,0x000cc482) */
...
LAB_000cc5ca:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000ccd26;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000ccd26;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_000cc5ca;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000ccd26;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000ccd26;
              op = pBVar10;
