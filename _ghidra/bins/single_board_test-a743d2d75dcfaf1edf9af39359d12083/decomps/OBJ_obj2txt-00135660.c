...

{
  ...
  if (uVar11 == 0) {
    ...
    if ((added == (_LHASH *)0x0) ||
      ...
      uVar11 = *(uint *)(&DAT_001f7880 + *piVar7 * 0x18);
    }
    else {
      uVar11 = *(uint *)(*(int *)((int)pvVar5 + 4) + 8);
    }
    if (uVar11 != 0) goto LAB_00135898;
  }
  else {
LAB_00135898:
    if (uVar11 < 0x3be) {
      puVar10 = &nid_objs + uVar11 * 0x18;
      if (*(int *)(&DAT_001f7880 + uVar11 * 0x18) == 0) {
        iVar13 = 0x176;
        goto LAB_001358b4;
      }
LAB_00135926:
      pcVar6 = *(char **)(puVar10 + 4);
      if (pcVar6 != (char *)0x0) goto LAB_001358e0;
    }
...
LAB_0013569a:
  ...
  do {
    ...
    while( true ) {
      ...
      bVar1 = *pbVar16;
      iVar13 = iVar13 + -1;
      if ((iVar13 == 0 & bVar1 >> 7) != 0) goto joined_r0x00135980;
      if (bVar14) {
        iVar3 = BN_add_word(a_00,bVar1 & 0x7f);
        if (iVar3 == 0) goto joined_r0x00135980;
      }
      else {
