...
LAB_001a86ae:
  ...
  if (method->i2s == (X509V3_EXT_I2S)0x0) {
    if (method->i2v == (X509V3_EXT_I2V)0x0) {
      if (method->i2r == (X509V3_EXT_I2R)0x0) goto LAB_001a861e;
      ...
      if (st == (_STACK *)0x0) goto LAB_001a861e;
      iVar3 = 1;
    ...
    if (ptr != (char *)0x0) {
      ...
      sk_pop_free((_STACK *)0x0,(func *)0x164dc9);
      CRYPTO_free(ptr);
      it = method->it;
      goto joined_r0x001a862e;
    }
LAB_001a861e:
    iVar3 = 0;
    st = (_STACK *)0x0;
  }
  sk_pop_free(st,(func *)0x164dc9);
  it = method->it;
joined_r0x001a862e:
  if (it == (ASN1_ITEM *)0x0) {
    (*method->ext_free)(val);
