...

{
  ...
  *piVar5 = 0;
  uVar6 = param_1->state;
  if (0x2041 < (int)uVar6) goto LAB_0012d454;
LAB_0012d40c:
  if (0x203f < (int)uVar6) {
    if (uVar6 == 0x2040) {
...
LAB_0012dace:
        ...
        if (iVar7 < 1) goto LAB_0012d632;
      }
      else {
        pBVar12 = param_1->init_buf;
        pcVar8 = pBVar12->data;
        if (uVar6 == 0x2011) goto LAB_0012dba4;
        psVar15 = param_1->s2;
LAB_0012d4bc:
        pcVar8 = pBVar12->data;
        ...
        if (iVar22 != iVar7) goto LAB_0012dace;
...
LAB_0012e318:
          ...
          if (iVar7 != 1) {
            if (iVar7 == -1) goto LAB_0012e318;
            if (param_1->cert != (cert_st *)0x0) goto LAB_0012d528;
...
LAB_0012d436:
      if (p_Var19 == (_func_3294 *)0x0) goto LAB_0012d44a;
      if (uVar20 == uVar6) goto LAB_0012d44a;
      do {
        param_1->state = uVar6;
...
LAB_0012d44a:
        do {
          uVar6 = uVar20;
          if (uVar6 < 0x2042) goto LAB_0012d40c;
LAB_0012d454:
          if ((int)uVar6 < 0x2062) {
            if (0x205f < (int)uVar6) {
              if (uVar6 == 0x2060) {
            ...
            if (1 < uVar6 - 0x2050) goto LAB_0012d61c;
            pcVar8 = param_1->init_buf->data;
            if (uVar6 == 0x2050) {
...
LAB_0012da0e:
              ...
              iVar7 = ssl2_read(param_1,pcVar8 + param_1->init_num,iVar22);
              if (iVar7 < iVar22) goto LAB_0012dbee;
              if (param_1->msg_callback != (_func_3292 *)0x0) {
                (*param_1->msg_callback)
          ...
          if (uVar6 != 0x2080) {
            if (0x2080 < (int)uVar6) {
              if ((uVar6 == 0x4000) || (uVar6 == 0x6000)) goto LAB_0012d87a;
              goto LAB_0012d61c;
            }
            if (3 < uVar6 - 0x2070) goto LAB_0012d61c;
...
LAB_0012e04e:
                ...
                if (iVar7 < 3 - param_1->init_num) goto LAB_0012de90;
...
LAB_0012d5ea:
              ...
              if (uVar6 == 0x2071) goto LAB_0012e034;
              if (uVar6 == 0x2072) {
...
LAB_0012d994:
    ...
    if (uVar6 == 0x2000) goto LAB_0012d87a;
    if (uVar6 == 0x2003) goto LAB_0012d87a;
    if (uVar6 != 3) goto LAB_0012d61c;
...
LAB_0012d61c:
  ...
  if (0x2021 < (int)uVar6) {
    if (1 < uVar6 - 0x2030) goto LAB_0012d61c;
    pBVar12 = param_1->init_buf;
...
LAB_0012e248:
      ...
      if (iVar22 != iVar7) goto LAB_0012dae2;
      if (param_1->msg_callback != (_func_3292 *)0x0) {
        (*param_1->msg_callback)
    ...
    *pcVar8 = '\x04';
    ...
    if (iVar7 == 0) {
      ...
      *(undefined4 *)(pSVar18->krb5_client_princ + 8) = uVar11;
      ...
      if (param_1->cert == (cert_st *)0x0) goto LAB_0012e442;
      pcVar8[2] = '\x01';
...
LAB_0012d87a:
  ...
  if (param_1->init_buf == (BUF_MEM *)0x0) {
    pBVar12 = BUF_MEM_new();
    if (pBVar12 == (BUF_MEM *)0x0) goto LAB_0012ddd2;
