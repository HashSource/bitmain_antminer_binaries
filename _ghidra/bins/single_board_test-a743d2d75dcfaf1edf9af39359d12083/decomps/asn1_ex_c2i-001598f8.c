...
LAB_001599b6:
  ...
  if (utype == 5) goto LAB_001599b6;
LAB_0015992e:
  if (utype < 6) {
    if (utype == 2) {
LAB_00159a30:
      pAVar3 = c2i_ASN1_INTEGER(&a->integer,local_24,len);
      if (pAVar3 == (ASN1_INTEGER *)0x0) goto LAB_001599ee;
...
joined_r0x0015998e:
      if (pAVar2 == (ASN1_OBJECT *)0x0) goto LAB_001599ee;
    }
    else {
      if (utype != 1) goto LAB_0015993c;
      if (len != 1) {
    ...
    if (utype == 10) goto LAB_00159a30;
    if (utype < 0xb) {
      if (utype == 6) {
        pAVar2 = c2i_ASN1_OBJECT(&a->object,local_24,len);
        goto joined_r0x0015998e;
      }
    }
    else if ((utype == 0x102) || (utype == 0x10a)) goto LAB_00159a30;
LAB_0015993c:
    if (utype == 0x1e) {
      if ((len & 1U) == 0) {
LAB_00159946:
      ...
      if ((utype != 0x1c) || ((len & 3U) == 0)) goto LAB_00159946;
