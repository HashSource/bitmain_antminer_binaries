...

{
  ...
  if (param_3 < 0x21) {
    if ((int)param_2 + param_3 <= param_4) {
      ...
      case 0:
      case 1:
        if (uVar8 == 0) goto switchD_00118c36_caseD_2;
        if (local_114 == (SSL_SESSION *)0x0) {
          iVar3 = param_1[0x5c];
          if (-1 < *(int *)(iVar3 + 0x20) << 0x17) {
            local_10c = *param_1;
            if (param_3 == 0) goto LAB_00118c16;
            local_c8 = param_3;
            ...
            if (local_114 != (SSL_SESSION *)0x0) goto LAB_00118c56;
            iVar3 = param_1[0x5c];
            *(int *)(iVar3 + 0x4c) = *(int *)(iVar3 + 0x4c) + 1;
          }
          if (*(code **)(iVar3 + 0x30) == (code *)0x0) goto LAB_00118c16;
          local_110 = 1;
...
LAB_00118c56:
      ...
      case 2:
      case 3:
switchD_00118c36_caseD_2:
        uVar8 = 0;
LAB_00118bd8:
        if (local_114 == (SSL_SESSION *)0x0) goto LAB_00118c16;
        break;
      case 0xffffffff:
        bVar1 = true;
        pSVar7 = local_114;
        goto joined_r0x00118d64;
      default:
        ...
        if (((int)(param_1[0x32] << 0x1f) < 0) && (__n == 0)) {
          ...
          if (*(int *)(pSVar7->krb5_client_princ + 0x24) == 0) {
            ...
            *(undefined4 *)(pSVar7->krb5_client_princ + 0x24) = uVar2;
            pSVar7 = local_114;
            if (*(int *)(local_114->krb5_client_princ + 0x24) == 0) goto LAB_00118be4;
          }
...
joined_r0x00118d64:
        local_114 = pSVar7;
        if (pSVar7 != (SSL_SESSION *)0x0) goto LAB_00118be6;
      }
      else {
LAB_00118be4:
        bVar1 = false;
