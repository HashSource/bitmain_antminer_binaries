...
LAB_00131b1c:
    iVar16 = iVar5;
    if (0x2171 < iVar16) goto LAB_00131b90;
LAB_00131b24:
    if (iVar16 < 0x2170) {
      if (iVar16 < 0x2122) {
        if (iVar16 < 0x2120) {
          if (iVar16 == 0x2100) {
            ...
            if (iVar16 == 0x2000) goto LAB_00131e00;
            if (iVar16 == 0x2003) goto LAB_00131e00;
            if (iVar16 != 3) goto LAB_00131db0;
            ...
            if (iVar16 < 0x2110) goto LAB_00131db0;
            if (iVar16 < 0x2113) {
              param_1->shutdown = 0;
              ...
              if (0 < iVar3) {
                ...
                *(undefined4 *)(psVar8->write_sequence + 4) = uVar7;
                if (param_1->state != 0x2130) goto LAB_00131fcc;
                pdVar10 = param_1->d1;
                iVar3 = 2;
                pdVar10->mtu = 0;
              ...
              if (0x2114 < iVar16) goto LAB_00131db0;
              if (iVar16 == 0x2113) {
        ...
        if (iVar16 < 0x2140) {
          ...
          if (1 < iVar16 - 0x2130U) goto LAB_00131db0;
...
LAB_00131d12:
              ...
              if ((param_1->ctx != (SSL_CTX *)0x0) &&
                 (iVar3 = BIO_ctrl(param_1->wbio,0xb,0,(void *)0x0), iVar3 < 1)) goto LAB_00131c7c;
              if (p_Var15 == (_func_3294 *)0x0) goto LAB_00131d12;
              iVar16 = param_1->state;
              if (iVar5 == iVar16) goto LAB_00131b1c;
              param_1->state = iVar5;
              (*p_Var15)(param_1,0x2001,1);
              param_1->state = iVar16;
              if (iVar16 < 0x2172) goto LAB_00131b24;
LAB_00131b90:
              if (iVar16 < 0x21d2) {
                if (0x21cf < iVar16) {
...
LAB_001323d8:
                ...
                if (iVar16 < 0x2192) {
                  if (iVar16 < 0x2190) {
                    if (1 < iVar16 - 0x2180U) goto LAB_00131db0;
                    psVar8 = param_1->s3;
...
LAB_00131fcc:
                  ...
                  if (iVar16 < 0x21a0) goto LAB_00131db0;
                  if (iVar16 < 0x21a2) {
                    ...
                    if (1 < iVar16 - 0x21c0U) goto LAB_00131db0;
                ...
                if (iVar16 < 0x2200) {
                  if (iVar16 < 0x21e0) goto LAB_00131db0;
                  if (iVar16 < 0x21e2) {
                    psVar6 = param_1->method->ssl3_enc;
                    ...
                    if (1 < iVar16 - 0x21f0U) goto LAB_00131db0;
                ...
                if ((iVar16 != 0x4000) && (iVar16 != 0x6000)) {
                  if (iVar16 != 0x3004) goto LAB_00131db0;
...
LAB_00131e00:
                ...
                if (param_1->init_buf == (BUF_MEM *)0x0) {
                  str = BUF_MEM_new();
                  if (str == (BUF_MEM *)0x0) goto LAB_001323d8;
        ...
        if (0x214f < iVar16) {
          if (iVar16 < 0x2152) {
            ...
            if (((-1 < (int)(uVar2 << 0x17)) ||
              ...
              if ((int)(uVar2 << 0x1f) < 0) {
                if (*(EVP_PKEY **)(param_1->cert + 0x40) == (EVP_PKEY *)0x0) goto LAB_00132050;
                if ((int)(pSVar14->algo_strength << 0x1e) < 0) {
                  ...
                  if (iVar5 + iVar3 * -8 < 0 != SBORROW4(iVar5,iVar3 * 8)) goto LAB_00132050;
                }
              }
              uVar9 = 1;
LAB_00132068:
