...

{
  ...
  if (param_3 != 0) {
    ...
    do {
      iVar3 = *(int *)(param_2 + -8);
      iVar2 = DAT_002482f4;
      if ((((iVar3 == tls12_md) || (iVar2 = DAT_002482fc, iVar3 == DAT_002482f8)) ||
          (iVar2 = DAT_00248304, iVar3 == DAT_00248300)) ||
         (iVar2 = DAT_0024830c, iVar3 == DAT_00248308)) {
LAB_00110d7a:
        iVar3 = *(int *)(param_2 + -4);
        if (iVar3 != tls12_sig._0_4_) goto LAB_00110d5e;
LAB_00110d84:
        puVar5 = tls12_sig;
      }
      else {
        if (iVar3 == DAT_00248310) {
          puVar4 = &DAT_00248310;
LAB_00110d78:
          iVar2 = puVar4[1];
          goto LAB_00110d7a;
        }
        if (iVar3 == DAT_00248318) {
          puVar4 = &DAT_00248318;
          goto LAB_00110d78;
        }
        iVar3 = *(int *)(param_2 + -4);
        iVar2 = -1;
        if (iVar3 == tls12_sig._0_4_) goto LAB_00110d84;
LAB_00110d5e:
        if (iVar3 == tls12_sig._8_4_) {
          puVar5 = (undefined1 *)0x248328;
        }
        else {
          if (iVar3 != tls12_sig._16_4_) goto LAB_00110d6a;
          puVar5 = (undefined1 *)0x248330;
        }
      }
      iVar3 = *(int *)(puVar5 + 4);
      if (iVar3 == -1 || iVar2 == -1) {
