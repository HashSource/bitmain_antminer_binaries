...

{
  ...
  iVar4 = pthread_create(&show_id,(pthread_attr_t *)0x0,(__start_routine *)0x5bc39,(void *)0x0);
  if (iVar4 != 0) {
  ...
  gStart_receive = true;
  iVar4 = pthread_create(&receive_id,(pthread_attr_t *)0x0,(__start_routine *)0xf6095,(void *)0x0);
  if (iVar4 != 0) {
    gStart_heart_beat = false;
