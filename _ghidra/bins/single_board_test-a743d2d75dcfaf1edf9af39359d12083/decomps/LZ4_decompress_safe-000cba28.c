...
/* WARNING: Removing unreachable block (ram,0x000cbefc) */
/* WARNING: Removing unreachable block (ram,0x000cbf06) */
/* WARNING: Removing unreachable block (ram,0x000cbf08) */
/* WARNING: Removing unreachable block (ram,0x000cbf0a) */
/* WARNING: Removing unreachable block (ram,0x000cbf10) */
/* WARNING: Removing unreachable block (ram,0x000cbada) */
...
LAB_000cbc38:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000cc394;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000cc394;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_000cbc38;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000cc394;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000cc394;
              op = pBVar10;
