...
LAB_001282c4:
  iVar15 = iVar3;
  if (0x1173 < iVar15) goto LAB_0012832c;
LAB_001282cc:
  if (iVar15 < 0x1170) {
    if (iVar15 < 0x1128) {
      if (0x1125 < iVar15) {
        ...
        if (local_2c[0] == 0) {
          if (local_34 < 1) goto LAB_00128442;
        }
        else {
          psVar11 = param_1->s3;
      ...
      if (iVar15 < 0x1101) {
        if (iVar15 == 0x1000) goto LAB_00128578;
        if (iVar15 == 0x1003) goto LAB_00128578;
        if (iVar15 == 3) {
...
LAB_00128602:
        ...
        if (p_Var14 == (_func_3294 *)0x0) goto LAB_00128602;
        iVar15 = param_1->state;
        if (iVar3 == iVar15) goto LAB_001282c4;
        param_1->state = iVar3;
        (*p_Var14)(param_1,0x1001,1);
        param_1->state = iVar15;
        if (iVar15 < 0x1174) goto LAB_001282cc;
LAB_0012832c:
        if (iVar15 < 0x11d2) {
          if (iVar15 < 0x11d0) {
            if (iVar15 < 0x1192) {
              if (iVar15 < 0x1190) {
                if (1 < iVar15 - 0x1180U) goto LAB_0012842c;
                dtls1_start_timer(param_1);
              ...
              if (iVar15 < 0x11a0) goto LAB_0012842c;
              if (iVar15 < 0x11a2) {
                if (param_1->hit == 0) {
                  dtls1_start_timer(param_1);
                }
                ...
                *(SSL_COMP **)(pSVar12->krb5_client_princ + 0x20) = pSVar9;
                ...
                if ((iVar3 == 0) ||
                   ...
                   iVar3 == 0)) goto LAB_00128928;
                dtls1_reset_seq_numbers(param_1,2);
                psVar11 = param_1->s3;
                uVar2 = 0;
              }
              else {
                if (1 < iVar15 - 0x11b0U) goto LAB_0012842c;
                if (param_1->hit == 0) {
                  dtls1_start_timer(param_1);
                }
          ...
          if (iVar15 < 0x11f0) {
            if (1 < iVar15 - 0x11e0U) goto LAB_0012842c;
          ...
          if ((iVar15 != 0x4000) && (iVar15 != 0x5000)) {
            if (iVar15 != 0x3004) goto LAB_0012842c;
...
LAB_00128578:
          ...
          if (param_1->init_buf == (BUF_MEM *)0x0) {
            str = BUF_MEM_new();
            if (str == (BUF_MEM *)0x0) goto LAB_00128928;
