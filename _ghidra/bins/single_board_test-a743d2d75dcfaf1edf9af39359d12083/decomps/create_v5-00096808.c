...

{
  ...
  if (g_pt1.board_sn[0] == '\0') {
    ...
    len = 0x20;
    snprintf(board_sn,0x20,"%s",0x106c074);
    (*v5->board_sn_set)(v5,board_sn,&len);
    snprintf(tmp42,0x100,"board_sn:%s",0x106c074);
    puts(tmp42);
    len = 0x10;
    memset(chip_die,0,0x10);
    snprintf(chip_die,0x10,"%s",0x106c008);
    (*v5->chip_die_set)(v5,chip_die,&len);
    snprintf(tmp42,0x100,"chip_die:%s",0x106c008);
    puts(tmp42);
    len = 0x10;
    memset(chip_marking,0,0x10);
    snprintf(chip_marking,0x10,"%s",0x106c018);
    (*v5->chip_marking_set)(v5,chip_marking,&len);
    snprintf(tmp42,0x100,"chip_marking:%s",0x106c018);
    puts(tmp42);
    len = 0x10;
    memset(chip_ftversion,0,0x10);
    snprintf(chip_ftversion,0x10,"%s",0x106c028);
    (*v5->ft_version_set)(v5,chip_ftversion,&len);
    snprintf(tmp42,0x100,"chip_ftversion:%s",0x106c028);
    puts(tmp42);
    len = 3;
    memset(chip_tech,0,3);
    snprintf(chip_tech,3,"%s",0x106c068);
    (*v5->chip_tech_set)(v5,chip_tech,&len);
    snprintf(tmp42,0x100,"chip_tech:%s",0x106c068);
    puts(tmp42);
    ...
    snprintf(board_name,9,"%s",0x106c06b);
    (*v5->board_name_set)(v5,board_name,&len);
    snprintf(tmp42,0x100,"board_name:%s",0x106c06b);
    puts(tmp42);
    len = 0x20;
