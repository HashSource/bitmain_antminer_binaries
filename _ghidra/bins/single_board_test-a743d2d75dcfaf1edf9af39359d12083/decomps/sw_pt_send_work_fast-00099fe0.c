...

{
  ...
  uVar3 = *(uint *)(*(int *)((int)args + 0x55508) + 4);
  uVar4 = *(uint *)(*(int *)((int)args + 0x55508) + 0x18);
  iVar5 = *(int *)(*(int *)((int)args + 0x55508) + 0x14);
  uVar6 = *(uint *)(*(int *)((int)args + 0x55508) + 0x1c);
  uVar7 = *(uint *)(*(int *)((int)args + 0x55508) + 0x20);
  count = 0;
  send_nonce = 0;
  ...
  for (which_asic = 0; which_asic < uVar3; which_asic = which_asic + 1) {
    iVar8 = *(int *)((int)args + (which_asic + 0x15442) * 4);
    for (which_core = 0; which_core < uVar4; which_core = uVar6 + which_core) {
      for (which_pattern = 0; which_pattern < uVar7; which_pattern = which_pattern + 1) {
        while (uVar1 = is_work_fifo_ready(**(uint32_t **)((int)args + 0x55508)), uVar1 == '\0') {
          usleep(100);
        }
        memset(&work_buf,0,0x214);
        work_buf.work_type = '\x01';
        work_buf.chain_id = (byte)**(undefined4 **)((int)args + 0x55508) | 0x80;
        ...
        for (i = 0; i < uVar6; i = i + 1) {
          uVar2 = *(int *)(*(int *)((int)args + 0x55508) + 0x1c) *
                  *(int *)(*(int *)((int)args + 0x55508) + 0x24);
  ...
  received_nonce_num = *(uint32_t *)((int)args + 0x54a34);
  while( true ) {
    while (*(uint32_t *)((int)args + 0x54a34) != received_nonce_num) {
      count = 0;
      received_nonce_num = *(uint32_t *)((int)args + 0x54a34);
      usleep(200000);
    }
