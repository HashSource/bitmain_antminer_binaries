...
LAB_0012736e:
    ...
    bVar25 = true;
    local_2e8 = 0x28;
    local_320 = (code *)0x126b15;
    local_350 = 8;
    local_34c = 0x40;
    local_328 = (code *)0x13964d;
    if (param_10 == '\0') goto LAB_001273b0;
LAB_00127088:
...
LAB_00127006:
    if (bVar25 || iVar6 < 0x2a0) {
      if (iVar6 == 4) {
        ...
        cnt = 0x10;
        local_2e8 = 0x30;
        local_328 = (code *)0x136bbd;
        local_320 = (code *)0x126a6d;
      }
      else {
        if (iVar6 != 0x40) {
LAB_00127014:
        ...
        cnt = 0x14;
        local_350 = 8;
        local_328 = (code *)0x138301;
        local_320 = (code *)0x126ab9;
        local_34c = 0x40;
      }
    }
    else if (iVar6 == 0x2a2) {
      ...
      local_350 = 0x10;
      local_34c = 0x80;
      local_328 = (code *)0x13f7c1;
      local_320 = (code *)0x126ba9;
    }
    else if (iVar6 < 0x2a2) {
      local_348 = 0x73;
      ...
      if (iVar6 != 0x2a3) goto LAB_00127014;
      local_348 = 0x33;
    ...
    iVar6 = iVar23;
    uVar18 = cnt;
    if (param_10 != '\0') goto LAB_00127088;
LAB_001273b0:
...
LAB_0012781e:
      ...
      if (sVar15 != uVar18) goto LAB_0012781e;
    }
  ...
  if (!CARRY4(local_33c,local_340)) {
    ...
    do {
      ...
      if (iVar6 == 0) {
        ...
        if (uVar11 != uVar24 << 2) goto LAB_0012759e;
      }
      else {
LAB_0012759e:
        do {
  ...
  if (param_10 == '\0') {
    ...
    if (uVar21 != 0) {
      ...
      if (uVar18 == sVar15) goto LAB_001276d0;
    }
    do {
