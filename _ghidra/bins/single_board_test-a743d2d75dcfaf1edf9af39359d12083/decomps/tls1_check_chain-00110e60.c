...
LAB_00110fba:
    ...
    if (pEVar2 == (EVP_PKEY *)0x0) goto LAB_00111178;
...
LAB_00111172:
        ...
        if (pEVar5 == (EC_POINT *)0x0) goto LAB_00111172;
        ...
        if (iVar15 != 0) {
          uVar21 = param_1[0x26];
          if ((*(uint *)(uVar21 + 0x38) & 0x30000) == 0) goto LAB_00110fd6;
          if (local_30 == '\0') {
            if (local_2f == '\x17') {
              iVar15 = 0x31a;
            }
            else {
              if (local_2f != '\x18') goto LAB_00111178;
              iVar15 = 0x31b;
            }
            if (*(int *)(uVar21 + 0x140) != 0) {
              if (*(int *)(*(int *)(uVar21 + 0x13c) + 8) != iVar15) {
                ...
                do {
                  iVar12 = iVar12 + 1;
                  if (iVar12 == *(int *)(uVar21 + 0x140)) goto LAB_00111178;
...
LAB_00111178:
      uVar21 = local_44;
      if (local_4c == 0) goto LAB_00110edc;
    }
    else {
      EVP_PKEY_free(pEVar2);
LAB_00110fd6:
...
LAB_001113ba:
          ...
          if (0 < iVar15) {
            if (*pcVar19 != cVar14) {
              ...
              do {
                if (pcVar19 == pcVar7) goto LAB_001113e8;
                pcVar19 = pcVar19 + 1;
...
LAB_001113e8:
          ...
          if (0x74 < iVar15) {
            if (iVar15 != 0x198) {
              if (iVar15 == 0x398) goto LAB_00111426;
              goto LAB_0011100a;
            }
            cVar14 = '@';
            goto LAB_001113ba;
...
LAB_00111426:
            ...
            else if (cVar14 == '\0') goto LAB_0011100a;
            goto LAB_001113ba;
          }
LAB_0011100a:
          local_44 = local_44 | 0x400;
...
LAB_0011146e:
          ...
          if (iVar15 < iVar9) goto LAB_00111460;
...
LAB_0011107a:
      ...
      local_44 = uVar24;
      if (param_1[9] == 0) goto LAB_00110ff0;
    }
    local_44 = local_44 | 0x600;
    if (local_4c == 0) goto LAB_001110a2;
    goto LAB_00111300;
  }
  iVar15 = 0;
  if (piVar25[0x49] != 0) {
    ...
    if (iVar15 == 0) {
      if (piVar25[0x50] != 0) {
        if (iVar9 != *(int *)(piVar25[0x4f] + 8)) {
          ...
          do {
            iVar12 = iVar12 + 1;
            if (iVar12 == piVar25[0x50]) goto LAB_001110fa;
...
LAB_001110f4:
      if (iVar9 == iVar15) goto LAB_001114ec;
    }
LAB_001110fa:
    uVar21 = local_44;
    if (local_4c == 0) goto LAB_00110edc;
...
LAB_0011115e:
            uVar16 = local_44;
            if (local_4c != 0) goto LAB_0011116c;
            goto LAB_00110edc;
          }
          if (iVar12 != *(int *)(piVar25[0x4f] + 8)) {
            ...
            do {
              iVar18 = iVar18 + 1;
              if (iVar18 == piVar25[0x50]) goto LAB_0011115e;
              piVar1 = (int *)(iVar17 + 0x18);
              iVar17 = iVar17 + 0x10;
            } while (iVar12 != *piVar1);
          }
        }
        else if (iVar12 != iVar15) goto LAB_0011115e;
      }
    }
    uVar16 = uVar21;
    if (local_4c != 0) goto LAB_0011116c;
...
LAB_001110ee:
  ...
  if (uVar16 != 0) {
    ...
    if (uVar16 != uVar21) goto LAB_001110ee;
  }
  uVar16 = local_44;
  if (local_4c != 0) goto LAB_0011116c;
LAB_00110f26:
...
LAB_0011102a:
  if (local_4c == 0) {
    uVar21 = local_44;
    if ((int)(local_44 << 0x16) < 0) goto LAB_001110a2;
  }
  else {
LAB_00111300:
    uVar21 = local_44;
...
LAB_00110edc:
  uVar24 = *param_1;
  local_44 = uVar21;
  if (((int)uVar24 >> 8 == 3) && (0x302 < (int)uVar24)) goto LAB_00110f26;
LAB_00110ee4:
