...

{
  ...
  pcVar16 = *(code **)(param_1 + 0x170);
  bVar20 = uVar12 < 0x10;
  if (uVar12 == 0xf) {
    bVar20 = uVar9 < 0xffffffe1;
  }
  uVar17 = *(undefined4 *)(param_1 + 0x174);
  if (!bVar20) {
    return 0xffffffff;
  }
...
LAB_00184b3c:
    ...
    do {
      ...
      *(byte *)local_40 = (byte)uVar12 ^ *(byte *)(iVar7 + 0x10);
      *(byte *)(iVar7 + 0x40) = (byte)uVar12 ^ *(byte *)(iVar7 + 0x40);
      puVar13 = param_2;
      local_40 = puVar10;
    } while (uVar6 != 0);
    if (uVar9 != 0) goto LAB_00184b3c;
    gcm_gmult_4bit(param_1 + 0x40,param_1 + 0x60);
  }
      ...
      do {
        while( true ) {
          ...
          *(byte *)(param_1 + 0x40) = bVar1 ^ *(byte *)(param_1 + 0x40);
          if (uVar12 == local_44) goto LAB_00184c18;
        }
        bVar1 = *(byte *)((int)param_2 + uVar12);
...
LAB_00184ce2:
    if (local_44 == 0) goto LAB_00184ce6;
  }
  else {
    gcm_ghash_4bit(param_1 + 0x40,param_1 + 0x60,param_2);
    if (0xf < local_44) {
      uVar6 = local_44 - 0x10 >> 4;
      uVar12 = local_3c + 1;
      uVar9 = uVar12;
      puVar13 = param_2;
      puVar10 = local_40;
  ...
  (*pcVar16)(param_1,puVar11,uVar17);
  puVar10 = (uint *)(param_1 + 0x44);
  puVar13 = param_2 + 1;
  puVar8 = local_40 + 1;
  bVar21 = param_2 <= puVar10;
  bVar20 = puVar10 == param_2;
  if (bVar21 && !bVar20) {
    bVar21 = local_38 <= puVar13;
    bVar20 = puVar13 == local_38;
  }
  bVar22 = local_40 <= puVar13;
  bVar19 = puVar13 == local_40;
  if (bVar22 && !bVar19) {
    bVar22 = param_2 <= puVar8;
    bVar19 = puVar8 == param_2;
  }
  iVar14 = local_3c + 1;
  uVar12 = local_44 >> 2;
  ...
  *(char *)(param_1 + 0xe) = (char)((uint)iVar14 >> 8);
  if (uVar12 == 0 ||
      ...
      ((local_44 < 4 || (bVar21 && !bVar20 || bVar22 && !bVar19)) ||
    ...
    if (uVar12 < 9) {
      ...
      do {
        ...
        puVar13[-8] = puVar13[-8] ^ uVar6;
        *puVar8 = puVar13[-0x14] ^ uVar6;
        uVar6 = local_3c + 8;
        uVar15 = puVar10[1];
        uVar18 = local_3c + 9;
        puVar13[-7] = puVar13[-7] ^ uVar15;
        puVar8[1] = puVar13[-0x13] ^ uVar15;
        uVar15 = puVar10[2];
        puVar13[-6] = puVar13[-6] ^ uVar15;
        puVar8[2] = puVar13[-0x12] ^ uVar15;
        uVar15 = puVar10[3];
        puVar13[-5] = puVar13[-5] ^ uVar15;
        puVar8[3] = puVar13[-0x11] ^ uVar15;
        uVar15 = puVar10[4];
        puVar13[-4] = puVar13[-4] ^ uVar15;
        puVar8[4] = puVar13[-0x10] ^ uVar15;
        uVar15 = puVar10[5];
        puVar13[-3] = puVar13[-3] ^ uVar15;
        puVar8[5] = puVar13[-0xf] ^ uVar15;
        uVar15 = puVar10[6];
        puVar13[-2] = puVar13[-2] ^ uVar15;
        puVar8[6] = puVar13[-0xe] ^ uVar15;
        puVar11 = puVar13 + -0xc;
        uVar15 = puVar10[7];
        puVar13[-1] = uVar15 ^ puVar13[-1];
        puVar8[7] = uVar15 ^ puVar13[-0xd];
        puVar5 = puVar13 + 8;
        puVar10 = local_38;
        puVar8 = local_34;
        local_3c = uVar6;
      } while (uVar18 < uVar12 - 7);
    }
    iVar14 = 0;
    do {
      uVar15 = *(uint *)((int)local_38 + iVar14);
      uVar6 = uVar6 + 1;
      *(uint *)((int)puVar13 + iVar14) = uVar15 ^ *(uint *)((int)puVar13 + iVar14);
      *(uint *)((int)local_34 + iVar14) = uVar15 ^ *(uint *)((int)puVar11 + iVar14);
      iVar14 = iVar14 + 4;
    } while (uVar6 < uVar12);
    iVar7 = iVar7 + uVar12 * -4;
    if (uVar9 == local_44) goto LAB_00184ce6;
  }
  iVar7 = uVar9 + iVar7;
  do {
