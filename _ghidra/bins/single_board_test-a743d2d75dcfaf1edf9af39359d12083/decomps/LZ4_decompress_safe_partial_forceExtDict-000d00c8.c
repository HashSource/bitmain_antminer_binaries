...
/* WARNING: Removing unreachable block (ram,0x000d05e6) */
/* WARNING: Removing unreachable block (ram,0x000d05f0) */
/* WARNING: Removing unreachable block (ram,0x000d05f2) */
/* WARNING: Removing unreachable block (ram,0x000d05f4) */
/* WARNING: Removing unreachable block (ram,0x000d05fa) */
/* WARNING: Removing unreachable block (ram,0x000d01ca) */
/* WARNING: Removing unreachable block (ram,0x000d01d2) */
/* WARNING: Removing unreachable block (ram,0x000d01e2) */
/* WARNING: Removing unreachable block (ram,0x000d01da) */
...
LAB_000d0322:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000d0a84;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000d0a84;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar5) == 0) goto LAB_000d0322;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000d0a84;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar6 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000d0a84;
              op = pBVar11;
