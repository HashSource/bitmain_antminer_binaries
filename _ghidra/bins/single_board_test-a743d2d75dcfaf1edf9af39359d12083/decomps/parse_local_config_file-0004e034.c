...

{
  ...
  char tmp1 [2048];
  json_error_t error;
  json_t *Test_Loop_array [10];
  json_t *CtrlBoard_Sensor_Addr_array [2];
  json_t *Asic_Sensor_Addr_array [4];
  ...
  json_t *Asic_Sensor_Addr;
  json_t *Asic_Sensor_Model;
  json_t *Asic_Sensor;
  json_t *Pic_Sensor_Addr;
  json_t *Pic_Sensor_Model;
  json_t *Pic_Sensor;
  json_t *Read_Temperature_From_Switch;
  ...
  Asic_Sensor_Addr_array[0] = (json_t *)0x0;
  Asic_Sensor_Addr_array[1] = (json_t *)0x0;
  Asic_Sensor_Addr_array[2] = (json_t *)0x0;
  Asic_Sensor_Addr_array[3] = (json_t *)0x0;
  CtrlBoard_Sensor_Addr_array[0] = (json_t *)0x0;
  CtrlBoard_Sensor_Addr_array[1] = (json_t *)0x0;
  memset(Test_Loop_array,0,0x28);
  ret = true;
  ...
  if ((json == (json_t *)0x0) || (json->type != JSON_OBJECT)) {
    ...
    snprintf(tmp1,0x800,"Can\'t read out local config file : %s",config_file_path);
    ...
    if ((pjVar4 == (json_t *)0x0) || (pjVar4->type != JSON_STRING)) {
      ...
      snprintf(tmp1,0x800,"Can\'t read out Test_Process in %s",config_file_path);
      log_to_file(tmp1,time_stamp);
      ret = false;
    }
    else {
      ...
      if ((pjVar4 == (json_t *)0x0) || (pjVar4->type != JSON_OBJECT)) {
        ...
        snprintf(tmp1,0x800,"Can\'t read out Hash_Board in %s",config_file_path);
        log_to_file(tmp1,time_stamp);
        ret = false;
      }
      else {
        ...
        if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_STRING)) {
          ...
          snprintf(tmp1,0x800,"Can\'t read out Miner_Type in %s",config_file_path);
          log_to_file(tmp1,time_stamp);
          ret = false;
        }
        else {
          ...
          if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_STRING)) {
            ...
            printf("%s: Can\'t read out Board_Name in %s\n","parse_local_config_file",
                   config_file_path);
            snprintf(tmp1,0x800,"Can\'t read out Board_Name in %s",config_file_path);
            log_to_file(tmp1,time_stamp);
            ret = false;
          }
          else {
            ...
            if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_STRING)) {
              ...
              printf("%s: Can\'t read out Asic_Type in %s\n","parse_local_config_file",
                     config_file_path);
              snprintf(tmp1,0x800,"Can\'t read out Asic_Type in %s",config_file_path);
              log_to_file(tmp1,time_stamp);
              ret = false;
            }
            else {
              ...
              if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_INTEGER)) {
                ...
                printf("%s: Can\'t read out Asic_Num in %s\n","parse_local_config_file",
                       config_file_path);
                snprintf(tmp1,0x800,"Can\'t read out Asic_Num in %s",config_file_path);
                log_to_file(tmp1,time_stamp);
                ret = false;
              }
              else {
                ...
                if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_INTEGER)) {
                  ...
                  printf("%s: Can\'t read out Voltage_Domain in %s\n","parse_local_config_file",
                         config_file_path);
                  snprintf(tmp1,0x800,"Can\'t read out Voltage_Domain in %s",config_file_path);
                  log_to_file(tmp1,time_stamp);
                  ret = false;
                }
                else {
                  ...
                  snprintf(tmp1,0x800,"Voltage_Domain : %d",
                           (Local_Config_Information->Hash_Board).Voltage_Domain);
                  log_to_file(tmp1,time_stamp);
                  ...
                  if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_INTEGER)) {
                    ...
                    printf("%s: Can\'t read out Asic_Num_Per_Voltage_Domain in %s\n",
                           "parse_local_config_file",config_file_path);
                    snprintf(tmp1,0x800,"Can\'t read out Asic_Num_Per_Voltage_Domain in %s",
                             config_file_path);
                    log_to_file(tmp1,time_stamp);
                    ret = false;
                  }
                    ...
                    if (((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_TRUE)) &&
                      ...
                      printf("%s: Can\'t read out Has_Pic in %s,will set default value\n",
                             "parse_local_config_file",config_file_path);
                      snprintf(tmp1,0x800,"Can\'t read out Has_Pic in %s,will set default value",
                               config_file_path);
                      log_to_file(tmp1,time_stamp);
                      ...
                      snprintf(tmp1,0x800,"Has_Pic : %s",pcVar5);
                      log_to_file(tmp1,time_stamp);
                    }
                    ...
                    if (((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_TRUE)) &&
                      ...
                      snprintf(tmp1,0x800,"Smooth_Voltage : %s",pcVar5);
                      log_to_file(tmp1,time_stamp);
                    }
                    ...
                    if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_INTEGER)) {
                      ...
                      snprintf(tmp1,0x800,"Inc_Freq_Delay : %d",
                               (Local_Config_Information->Hash_Board).Inc_Freq_Delay);
                      log_to_file(tmp1,time_stamp);
                    }
                    else {
                    ...
                    if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_INTEGER)) {
                      ...
                      snprintf(tmp1,0x800,"Voltage_Adjust_Step : %d",
                               (Local_Config_Information->Hash_Board).Voltage_Adjust_Step);
                      log_to_file(tmp1,time_stamp);
                    }
                    else {
                    ...
                    if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_INTEGER)) {
                      ...
                      snprintf(tmp1,0x800,"Wait_Board_Temp : %d",
                               (Local_Config_Information->Hash_Board).Wait_Board_Temp);
                      log_to_file(tmp1,time_stamp);
                    }
                    else {
                    ...
                    if ((pjVar6 == (json_t *)0x0) || (pjVar6->type != JSON_OBJECT)) {
                      ...
                      printf("%s: Can\'t read out Sensor_Info in %s\n","parse_local_config_file",
                             config_file_path);
                      snprintf(tmp1,0x800,"Can\'t read out Sensor_Info in %s",config_file_path);
                      log_to_file(tmp1,time_stamp);
                      ret = false;
                    }
                    else {
                      ...
                      if (((pjVar7 == (json_t *)0x0) || (pjVar7->type != JSON_TRUE)) &&
                        ...
                        printf("%s: Can\'t read out Read_Temperature_From_Pic in %s\n",
                               "parse_local_config_file",config_file_path);
                        snprintf(tmp1,0x800,"Can\'t read out Read_Temperature_From_Pic in %s",
                                 config_file_path);
                        log_to_file(tmp1,time_stamp);
                        ret = false;
                      }
                        ...
                        snprintf(tmp1,0x800,"Read_Temperature_From_Pic : %s",pcVar5);
                        log_to_file(tmp1,time_stamp);
                        ...
                        if (((pjVar7 == (json_t *)0x0) || (pjVar7->type != JSON_TRUE)) &&
                          ...
                          printf("%s: Can\'t read out Read_Temperature_From_Asic in %s\n",
                                 "parse_local_config_file",config_file_path);
                          snprintf(tmp1,0x800,"Can\'t read out Read_Temperature_From_Asic in %s",
                                   config_file_path);
                          log_to_file(tmp1,time_stamp);
                          ret = false;
                        }
                          ...
                          snprintf(tmp1,0x800,"Read_Temperature_From_Asic : %s",pcVar5);
                          log_to_file(tmp1,time_stamp);
                          ...
                          if (((pjVar7 == (json_t *)0x0) || (pjVar7->type != JSON_TRUE)) &&
                            ...
                            print_time_stamp(time_stamp,0x30);
                            printf("%s ",time_stamp);
                            printf("%s: Can\'t read out Read_Temperature_From_CtrlBoard in %s\n",
                                   "parse_local_config_file",config_file_path);
                            snprintf(tmp1,0x800,
                                     "Can\'t read out Read_Temperature_From_CtrlBoard in %s",
                                     config_file_path);
                            log_to_file(tmp1,time_stamp);
                            ret = false;
                          }
                            ...
                            snprintf(tmp1,0x800,"Read_Temperature_From_CtrlBoard : %s",pcVar5);
                            log_to_file(tmp1,time_stamp);
                            pjVar7 = json_object_get(pjVar6,"Read_Temperature_From_Switch");
                            if (((pjVar7 == (json_t *)0x0) || (pjVar7->type != JSON_TRUE)) &&
                               ((pjVar7 == (json_t *)0x0 || (pjVar7->type != JSON_FALSE)))) {
                              print_time_stamp(time_stamp,0x30);
                              printf("%s ",time_stamp);
                              printf("%s: Can\'t read out Read_Temperature_From_Switch in %s\n",
                                     "parse_local_config_file",config_file_path);
                              snprintf(tmp1,0x800,
                                       "Can\'t read out Read_Temperature_From_Switch in %s",
                                       config_file_path);
                              log_to_file(tmp1,time_stamp);
                              ret = false;
                            }
                              ...
                              (Local_Config_Information->Hash_Board).Sensor_Info.
                              Read_Temperature_From_Switch = _Var3;
                              print_time_stamp(time_stamp,0x30);
                              printf("%s ",time_stamp);
                              if ((Local_Config_Information->Hash_Board).Sensor_Info.
                                  Read_Temperature_From_Switch == false) {
                                pcVar5 = "false";
                              }
                              else {
                                pcVar5 = "true";
                              ...
                              snprintf(tmp1,0x800,"Read_Temperature_From_Switch : %s",pcVar5);
                              log_to_file(tmp1,time_stamp);
                              ...
                              if ((pjVar7 == (json_t *)0x0) || (pjVar7->type != JSON_OBJECT)) {
                                ...
                                printf("%s: Can\'t read out Pic_Sensor in %s\n",
                                       "parse_local_config_file",config_file_path);
                                snprintf(tmp1,0x800,"Can\'t read out Pic_Sensor in %s",
                                         config_file_path);
                                log_to_file(tmp1,time_stamp);
                                ret = false;
                              }
                                ...
                                if ((pjVar8 == (json_t *)0x0) || (pjVar8->type != JSON_STRING)) {
                                  ...
                                  printf("%s: Can\'t read out Pic_Sensor_Model in %s\n",
                                         "parse_local_config_file",config_file_path);
                                  snprintf(tmp1,0x800,"Can\'t read out Pic_Sensor_Model in %s",
                                           config_file_path);
                                  log_to_file(tmp1,time_stamp);
                                  ret = false;
                                }
                                  ...
                                  _Var3 = check_pic_sensor_type
                                                    ((Local_Config_Information->Hash_Board).
                                                     Sensor_Info.Pic_Sensor.Pic_Sensor_Model);
                                  if (!_Var3) {
                                    return false;
                                  }
                                  ...
                                  if ((pjVar7 == (json_t *)0x0) || (pjVar7->type != JSON_ARRAY)) {
                                    ...
                                    printf("%s: Can\'t read out Pic_Sensor_Addr in %s\n",
                                           "parse_local_config_file",config_file_path);
                                    snprintf(tmp1,0x800,"Can\'t read out Pic_Sensor_Addr in %s",
                                             config_file_path);
                                    log_to_file(tmp1,time_stamp);
                                    ret = false;
                                  }
                                    ...
                                    if (gPic_sensor_num < 5) {
                                      ...
                                      for (index = 0; index < gPic_sensor_num; index = index + 1) {
                                        ...
                                        if ((Pic_Sensor_Addr_array[index] == (json_t *)0x0) ||
                                          ...
                                          snprintf(tmp1,0x800,
                                                   "Can\'t find Pic_Sensor_Addr_array[%d]",index);
                                          log_to_file(tmp1,time_stamp);
                                          ret = false;
                                          goto LAB_000550ae;
                                        }
                                        ...
                                        pLVar2 = Local_Config_Information;
                                        jVar11 = json_integer_value(Pic_Sensor_Addr_array[index]);
                                        (pLVar2->Hash_Board).Sensor_Info.Pic_Sensor.Pic_Sensor_Addr
                                        [index] = (uint32_t)jVar11;
                                        print_time_stamp(time_stamp,0x30);
                                        printf("%s ",time_stamp);
                                        printf("%s: gPic_sensor_low_3_bits_addr[%d] : %d\n",
                                               "parse_local_config_file",index,
                                               (uint)gPic_sensor_low_3_bits_addr[index]);
                                        snprintf(tmp1,0x800,"gPic_sensor_low_3_bits_addr[%d] : %d",
                                                 index,(uint)gPic_sensor_low_3_bits_addr[index]);
                                        log_to_file(tmp1,time_stamp);
                                      }
                                      pjVar7 = json_object_get(pjVar6,"Asic_Sensor");
                                      if ((pjVar7 == (json_t *)0x0) || (pjVar7->type != JSON_OBJECT)
                                         ) {
                                        print_time_stamp(time_stamp,0x30);
                                        printf("%s ",time_stamp);
                                        printf("%s: Can\'t read out Asic_Sensor in %s\n",
                                               "parse_local_config_file",config_file_path);
                                        snprintf(tmp1,0x800,"Can\'t read out Asic_Sensor in %s",
                                                 config_file_path);
                                        log_to_file(tmp1,time_stamp);
                                        ret = false;
                                      }
                                      else {
                                        pjVar8 = json_object_get(pjVar7,"Asic_Sensor_Model");
                                        if ((pjVar8 == (json_t *)0x0) ||
                                           (pjVar8->type != JSON_STRING)) {
                                          print_time_stamp(time_stamp,0x30);
                                          printf("%s ",time_stamp);
                                          printf("%s: Can\'t read out Asic_Sensor_Model in %s\n",
                                                 "parse_local_config_file",config_file_path);
                                          snprintf(tmp1,0x800,
                                                   "Can\'t read out Asic_Sensor_Model in %s",
                                                   config_file_path);
                                          log_to_file(tmp1,time_stamp);
                                          ret = false;
                                        }
                                          ...
                                          pHVar10 = &Local_Config_Information->Hash_Board;
                                          pcVar5 = json_string_value(pjVar8);
                                          strcpy((pHVar10->Sensor_Info).Asic_Sensor.
                                                 Asic_Sensor_Model,pcVar5);
                                          print_time_stamp(time_stamp,0x30);
                                          printf("%s ",time_stamp);
                                          ...
                                          snprintf(tmp1,0x800,"Asic_Sensor_Model : %s",
                                                   &(Local_Config_Information->Hash_Board).
                                                    Sensor_Info.Asic_Sensor);
                                          log_to_file(tmp1,time_stamp);
                                          _Var3 = check_asic_sensor_type
                                                            ((Local_Config_Information->Hash_Board).
                                                             Sensor_Info.Asic_Sensor.
                                                             Asic_Sensor_Model);
                                          if (!_Var3) {
                                          ...
                                          pjVar7 = json_object_get(pjVar7,"Asic_Sensor_Addr");
                                          if ((pjVar7 == (json_t *)0x0) ||
                                            ...
                                            printf("%s: Can\'t read out Asic_Sensor_Addr in %s\n",
                                                   "parse_local_config_file",config_file_path);
                                            snprintf(tmp1,0x800,
                                                     "Can\'t read out Asic_Sensor_Addr in %s",
                                                     config_file_path);
                                            log_to_file(tmp1,time_stamp);
                                            ret = false;
                                          }
                                          else {
                                            gAsic_sensor_num = json_array_size(pjVar7);
                                            if (gAsic_sensor_num < 5) {
                                              print_time_stamp(time_stamp,0x30);
                                              printf("%s ",time_stamp);
                                              printf("%s: gAsic_sensor_num : %d\n",
                                                     "parse_local_config_file",gAsic_sensor_num);
                                              snprintf(tmp1,0x800,"gAsic_sensor_num : %d",
                                                       gAsic_sensor_num);
                                              log_to_file(tmp1,time_stamp);
                                              memset(gAsic_sensor_addr,0,4);
                                              for (index = 0; index < gAsic_sensor_num;
                                                  index = index + 1) {
                                                pjVar8 = json_array_get(pjVar7,index);
                                                Asic_Sensor_Addr_array[index] = pjVar8;
                                                if ((Asic_Sensor_Addr_array[index] == (json_t *)0x0)
                                                   || (Asic_Sensor_Addr_array[index]->type !=
                                                       JSON_INTEGER)) {
                                                  print_time_stamp(time_stamp,0x30);
                                                  printf("%s ",time_stamp);
                                                  printf(
                                                  "%s: Can\'t find Asic_Sensor_Addr_array[%d]\n",
                                                  "parse_local_config_file",index);
                                                  snprintf(tmp1,0x800,
                                                           "Can\'t find Asic_Sensor_Addr_array[%d]",
                                                           index);
                                                  log_to_file(tmp1,time_stamp);
                                                  ret = false;
                                                  goto LAB_000550ae;
                                                }
                                                jVar11 = json_integer_value(Asic_Sensor_Addr_array
                                                                            [index]);
                                                gAsic_sensor_addr[index] = (uint8_t)jVar11;
                                                print_time_stamp(time_stamp,0x30);
                                                printf("%s ",time_stamp);
                                                printf("%s: gAsic_sensor_addr[%d] : %d\n",
                                                       "parse_local_config_file",index,
                                                       (uint)gAsic_sensor_addr[index]);
                                                snprintf(tmp1,0x800,"gAsic_sensor_addr[%d] : %d",
                                                         index,(uint)gAsic_sensor_addr[index]);
                                                log_to_file(tmp1,time_stamp);
                                              }
                                              ...
                                              if ((pjVar6 == (json_t *)0x0) ||
                                                ...
                                                printf("%s ",time_stamp);
                                                printf(
                                                  "%s: Can\'t read out CtrlBoard_Sensor in %s\n",
                                                  "parse_local_config_file",config_file_path);
                                                snprintf(tmp1,0x800,
                                                         "Can\'t read out CtrlBoard_Sensor in %s",
                                                         config_file_path);
                                                log_to_file(tmp1,time_stamp);
                                                ret = false;
                                              }
                                                ...
                                                if ((pjVar7 == (json_t *)0x0) ||
                                                  ...
                                                  ret = false;
                                                    ...
                                                    if (gCtrlBoard_sensor_num < 3) {
                                                      ...
                                                      for (index = 0; index < gCtrlBoard_sensor_num;
                                                        ...
                                                        if ((CtrlBoard_Sensor_Addr_array[index] ==
                                                             (json_t *)0x0) ||
                                                  ...
                                                  jVar11 = json_integer_value(
                                                  CtrlBoard_Sensor_Addr_array[index]);
                                                  ...
                                                  "gCtrlBoard_sensor_low_3_bits_addr[%d] : %d",index
                                                  ,(uint)gCtrlBoard_sensor_low_3_bits_addr[index]);
                                                  log_to_file(tmp1,time_stamp);
                                                  }
                                                  ...
                                                  if ((pjVar4 == (json_t *)0x0) ||
                                                    ...
                                                    printf("%s ",time_stamp);
                                                    printf(
                                                  "%s: Can\'t read out Power_Version in %s\n",
                                                  "parse_local_config_file",config_file_path);
                                                  snprintf(tmp1,0x800,
                                                  ...
                                                  ret = false;
                                                    ...
                                                    gPower_version_array_size =
                                                         json_array_size(pjVar4);
                                                    if (gPower_version_array_size < 9) {
                                                      print_time_stamp(time_stamp,0x30);
                                                      printf("%s ",time_stamp);
                                                      printf("%s: Can support %d apw power type\n",
                                                             ...
                                                             gPower_version_array_size);
                                                      snprintf(tmp1,0x800,
                                                               "Can support %d apw power type",
                                                               gPower_version_array_size);
                                                      log_to_file(tmp1,time_stamp);
                                                      for (index = 0;
                                                          index < gPower_version_array_size;
                                                          index = index + 1) {
                                                  ...
                                                  snprintf(tmp1,0x800,"APW_power_version[%d] = %d",
                                                  ...
                                                  if ((pjVar4 == (json_t *)0x0) ||
                                                    ...
                                                    if (((pjVar6 == (json_t *)0x0) ||
                                                      ...
                                                      printf("%s ",time_stamp);
                                                      printf(
                                                  "%s: Can\'t read out Factory_Mode in %s\n",
                                                  "parse_local_config_file",config_file_path);
                                                  snprintf(tmp1,0x800,
                                                  ...
                                                  ret = false;
                                                    ...
                                                    snprintf(tmp1,0x800,"Factory_Mode : %s",pcVar5);
                                                    log_to_file(tmp1,time_stamp);
                                                  ...
                                                  ret = false;
                                                    ...
                                                    snprintf(tmp1,0x800,"Bypass_Scan_Code_Gun : %s",
                                                             pcVar5);
                                                    log_to_file(tmp1,time_stamp);
                                                  ...
                                                  ret = false;
                                                    ...
                                                    snprintf(tmp1,0x800,"Software_Pattern : %s",
                                                             pcVar5);
                                                    log_to_file(tmp1,time_stamp);
                                                    pjVar7 = json_object_get(pjVar6,
                                                  "Hardware_Pattern");
                                                  ...
                                                  ret = false;
                                                    ...
                                                    snprintf(tmp1,0x800,"Hardware_Pattern : %s",
                                                             pcVar5);
                                                    log_to_file(tmp1,time_stamp);
                                                    pjVar7 = json_object_get(pjVar6,
                                                  "Autogen_Pattern");
                                                  ...
                                                  ret = false;
                                                    ...
                                                    snprintf(tmp1,0x800,"Autogen_Pattern : %s",
                                                             pcVar5);
                                                    log_to_file(tmp1,time_stamp);
                                                    pjVar7 = json_object_get(pjVar6,
                                                  "Midstate_Number");
                                                  ...
                                                  if (((pjVar7 == (json_t *)0x0) ||
                                                    ...
                                                    printf("%s ",time_stamp);
                                                    printf(
                                                  "%s: Can\'t read out Super_Software_Pattern in %s\n"
                                                  ,"parse_local_config_file",config_file_path);
                                                  snprintf(tmp1,0x800,
                                                                                                                      
                                                  "Can\'t read out Super_Software_Pattern in %s",
                                                  config_file_path);
                                                  log_to_file(tmp1,time_stamp);
                                                  ret = false;
                                                  }
                                                  ...
                                                  Capture_Pattern = false;
                                                    ...
                                                    snprintf(tmp1,0x800,"Capture_Pattern : %s",
                                                             pcVar5);
                                                    log_to_file(tmp1,time_stamp);
                                                  }
                                                  ...
                                                  snprintf(tmp1,0x800,"Force_Reset_Power_Mode : %s",
                                                           pcVar5);
                                                  log_to_file(tmp1,time_stamp);
                                                  pjVar7 = json_object_get(pjVar6,
                                                  ...
                                                  snprintf(tmp1,0x800,"Force_PT2_Before_Sweep : %s",
                                                           pcVar5);
                                                  log_to_file(tmp1,time_stamp);
                                                  pjVar7 = json_object_get(pjVar6,"Data_Reuse_Mode")
                                                  ;
                                                  if (((pjVar7 == (json_t *)0x0) ||
                                                      (pjVar7->type != JSON_TRUE)) &&
                                                     ((pjVar7 == (json_t *)0x0 ||
                                                  ...
                                                  snprintf(tmp1,0x800,"Data_Reuse_Mode : %s",pcVar5)
                                                  ;
                                                  log_to_file(tmp1,time_stamp);
                                                  pjVar7 = json_object_get(pjVar6,
                                                  "Freq_Float_Percent");
                                                  ...
                                                  snprintf(tmp1,0x800,"Freq_Float_Percent : %d",
                                                           (Local_Config_Information->Test_Info).
                                                           Sweep_Cfg.Freq_Float_Percent);
                                                  log_to_file(tmp1,time_stamp);
                                                  pjVar7 = json_object_get(pjVar6,
                                                  ...
                                                  snprintf(tmp1,0x800,"Force_Reset_Freq_Range : %s",
                                                           pcVar5);
                                                  log_to_file(tmp1,time_stamp);
                                                  ...
                                                  snprintf(tmp1,0x800,"Sweep_Min_Freq : %d",
                                                           (Local_Config_Information->Test_Info).
                                                           Sweep_Cfg.Sweep_Min_Freq);
                                                  log_to_file(tmp1,time_stamp);
                                                  ...
                                                  snprintf(tmp1,0x800,"Sweep_Max_Freq : %d",
                                                           (Local_Config_Information->Test_Info).
                                                           Sweep_Cfg.Sweep_Max_Freq);
                                                  log_to_file(tmp1,time_stamp);
                                                  pjVar6 = json_object_get(pjVar6,
                                                  ...
                                                  snprintf(tmp1,0x800,"Force_Local_Cfg_Level : %s",
                                                           pcVar5);
                                                  log_to_file(tmp1,time_stamp);
                                                  }
                                                  ...
                                                  ret = false;
                                                    ...
                                                    if ((pjVar6 == (json_t *)0x0) ||
                                                      ...
                                                      print_time_stamp(time_stamp,0x30);
                                                      printf("%s ",time_stamp);
                                                      printf("%s: Can\'t read out Test_Loop in %s\n"
                                                             ,"parse_local_config_file",
                                                             config_file_path);
                                                      snprintf(tmp1,0x800,
                                                  ...
                                                  for (index = 0; index < gTest_loop;
                                                    ...
                                                    if ((Test_Loop_array[index] == (json_t *)0x0) ||
                                                      ...
                                                      print_time_stamp(time_stamp,0x30);
                                                      printf("%s ",time_stamp);
                                                      printf("%s: Can\'t find Test_Loop_array[%d]\n"
                                                             ,"parse_local_config_file",index);
                                                      snprintf(tmp1,0x800,
                                                    ...
                                                    jVar11 = json_integer_value(pjVar7);
                                                    (pLVar2->Test_Info).Test_Standard.Test_Loop
                                                    [index].Level = (uint32_t)jVar11;
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                    printf("%s: Level : %d\n",
                                                           "parse_local_config_file",
                                                  ...
                                                  printf("%s: Pre_Open_Core_Voltage : %d\n",
                                                         ...
                                                         Pre_Open_Core_Voltage);
                                                  snprintf(tmp1,0x800,"Pre_Open_Core_Voltage : %d",
                                                           (Local_Config_Information->Test_Info).
                                                           Test_Standard.Test_Loop[index].
                                                           Pre_Open_Core_Voltage);
                                                  log_to_file(tmp1,time_stamp);
                                                  ...
                                                  snprintf(tmp1,0x800,"Frequence : %d",
                                                           (Local_Config_Information->Test_Info).
                                                           Test_Standard.Test_Loop[index].Frequence)
                                                  ;
                                                  log_to_file(tmp1,time_stamp);
                                                  ...
                                                  if ((pjVar6 == (json_t *)0x0) ||
                                                    ...
                                                    if ((pjVar7 == (json_t *)0x0) ||
                                                      ...
                                                      printf("%s: Baudrate : %d\n",
                                                             ...
                                                             (Local_Config_Information->Test_Info).
                                                             Test_Speed.Baudrate);
                                                      snprintf(tmp1,0x800,"Baudrate : %d",
                                                               (Local_Config_Information->Test_Info)
                                                               .Test_Speed.Baudrate);
                                                      log_to_file(tmp1,time_stamp);
                                                      ...
                                                      if ((pjVar6 == (json_t *)0x0) ||
                                                        ...
                                                        print_time_stamp(time_stamp,0x30);
                                                        printf("%s ",time_stamp);
                                                        printf("%s: Can\'t read out Timeout in %s\n"
                                                               ,"parse_local_config_file",
                                                               config_file_path);
                                                        snprintf(tmp1,0x800,
                                                        ...
                                                        printf("%s: Timeout : %d\n",
                                                               ...
                                                               (Local_Config_Information->Test_Info)
                                                               .Test_Speed.Timeout);
                                                        snprintf(tmp1,0x800,"Timeout : %d",
                                                                 (Local_Config_Information->
                                                                 Test_Info).Test_Speed.Timeout);
                                                        log_to_file(tmp1,time_stamp);
                                                        pjVar6 = json_object_get(pjVar4,
                                                  "Asic_Register");
                                                  if ((pjVar6 == (json_t *)0x0) ||
                                                  ...
                                                  ret = false;
                                                    ...
                                                    if ((pjVar7 == (json_t *)0x0) ||
                                                      ...
                                                      print_time_stamp(time_stamp,0x30);
                                                      printf("%s ",time_stamp);
                                                      printf("%s: Can\'t read out CCdly_Sel in %s\n"
                                                             ,"parse_local_config_file",
                                                             config_file_path);
                                                      snprintf(tmp1,0x800,
                                                      ...
                                                      snprintf(tmp1,0x800,"CCdly_Sel : %d",
                                                               (Local_Config_Information->Test_Info)
                                                               .Asic_Register.CCdly_Sel);
                                                      log_to_file(tmp1,time_stamp);
                                                  ...
                                                  ret = false;
                                                    ...
                                                    snprintf(tmp1,0x800,"Pwth_Sel : %d",
                                                             (Local_Config_Information->Test_Info).
                                                             Asic_Register.Pwth_Sel);
                                                    log_to_file(tmp1,time_stamp);
                                                    ...
                                                    if ((pjVar7 == (json_t *)0x0) ||
                                                      ...
                                                      print_time_stamp(time_stamp,0x30);
                                                      printf("%s ",time_stamp);
                                                      printf("%s: Can\'t read out Swpf_Mode in %s\n"
                                                             ,"parse_local_config_file",
                                                             config_file_path);
                                                      snprintf(tmp1,0x800,
                                                      ...
                                                      snprintf(tmp1,0x800,"Swpf_Mode : %d",
                                                               (Local_Config_Information->Test_Info)
                                                               .Asic_Register.Swpf_Mode);
                                                      log_to_file(tmp1,time_stamp);
                                                  ...
                                                  ret = false;
                                                    ...
                                                    Start_Temp_Gap_Pic = (uint32_t)jVar11;
                                                    print_time_stamp(time_stamp,0x30);
                                                    printf("%s ",time_stamp);
                                                  ...
                                                  ret = false;
                                                    ...
                                                    printf("%s: Fan_Speed : %d\n",
                                                           ...
                                                           .Fan_Speed);
                                                    snprintf(tmp1,0x800,"Fan_Speed : %d",
                                                             (Local_Config_Information->Test_Info).
                                                             Fan.Fan_Speed);
                                                    log_to_file(tmp1,time_stamp);
                                                  ...
                                                  printf("%s: Work_Fan_Speed : %d\n",
                                                         ...
                                                         (Local_Config_Information->Test_Info).Fan.
                                                         Work_Fan_Speed);
                                                  snprintf(tmp1,0x800,"Work_Fan_Speed : %d",
                                                           (Local_Config_Information->Test_Info).Fan
                                                           .Work_Fan_Speed);
                                                  log_to_file(tmp1,time_stamp);
                                                  }
                                                  ...
                                                  ret = false;
                                                    ...
                                                    printf("%s: Voltage_Accuracy : %d\n",
                                                           ...
                                                           (Local_Config_Information->Test_Info).
                                                           Voltage_Accuracy);
                                                    snprintf(tmp1,0x800,"Voltage_Accuracy : %d",
                                                             (Local_Config_Information->Test_Info).
                                                             Voltage_Accuracy);
                                                    log_to_file(tmp1,time_stamp);
                                                  ...
                                                  ret = false;
                                                    ...
                                                    snprintf(tmp1,0x800,"Clear_EEPROM_Data : %s",
                                                             pcVar5);
                                                    log_to_file(tmp1,time_stamp);
                                                  ...
                                                  Enable_Repair = false;
                                                    ...
                                                    snprintf(tmp1,0x800,"Enable_Repair : %s",pcVar5)
                                                    ;
                                                    log_to_file(tmp1,time_stamp);
                                                  }
                                                  }
                                                  ...
                                                  ,"parse_local_config_file",gTest_loop,10);
                                                  snprintf(tmp1,0x800,
                                                  ...
                                                  ret = false;
                                                    ...
                                                    printf("%s ",time_stamp);
                                                    printf(
                                                  "%s: There are %d ctrlboard sensors in local config file, but LOCAL_CONFIG_MAX_CTRLBOARD_SENSOR_NUM is %d\n"
                                              ...
                                              printf(
                                                  ...
                                                  ,"parse_local_config_file",gAsic_sensor_num,4);
                                              snprintf(tmp1,0x800,
