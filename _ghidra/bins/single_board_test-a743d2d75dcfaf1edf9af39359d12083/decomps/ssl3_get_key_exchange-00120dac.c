...
LAB_00120ee2:
              pkey = pDVar3;
              if (pDVar3 == (DH *)0x0) goto LAB_00120eea;
              iVar10 = 0x99;
              iVar9 = 1999;
              goto LAB_00121300;
            }
...
LAB_001217d2:
      ...
      *(DH **)(param_1 + 0x1b0) = local_e4;
      if (local_e4 == (DH *)0x0) goto LAB_001217d2;
      if ((int)pDVar3 - iVar9 < 2) {
        ...
        if ((int)uVar14 <= (int)pDVar3 - iVar9) {
          ...
          *(DH **)(param_1 + 0x1b4) = local_e4;
          ...
          if ((uVar12 & 1) == 0) {
            if ((uVar12 & 2) == 0) goto LAB_0012104a;
...
LAB_00121194:
          if (pkey == (DH *)0x0) goto LAB_0012104a;
...
LAB_0012104a:
        if ((uVar12 & 0x404) != 0) goto LAB_00120ee2;
...
LAB_001219ec:
          ...
          if ((int)uVar11 <= (int)((int)&pDVar3[-1].engine + 2)) {
            ...
            if (pkey == (DH *)0x0) goto LAB_001219ce;
            if ((int)((int)pDVar3 - (uVar11 + 2)) < 2) {
              iVar10 = 0x6b2;
              goto LAB_001219ec;
            }
