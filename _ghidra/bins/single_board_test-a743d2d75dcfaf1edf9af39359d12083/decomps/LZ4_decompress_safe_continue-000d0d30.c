...
/* WARNING: Removing unreachable block (ram,0x000d13d2) */
/* WARNING: Removing unreachable block (ram,0x000d13dc) */
/* WARNING: Removing unreachable block (ram,0x000d13de) */
/* WARNING: Removing unreachable block (ram,0x000d13e0) */
/* WARNING: Removing unreachable block (ram,0x000d13e6) */
/* WARNING: Removing unreachable block (ram,0x000d0f44) */
...
LAB_000d11de:
                  ...
                  if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
                    if (local_48 == 0) {
                      if ((iend != ip + length) || (oend < cpy)) goto LAB_000d18ae;
                    }
                    else {
                      if (iend < ip + length) {
                ...
                if ((bVar8 & bVar6) == 0) goto LAB_000d10ca;
...
LAB_000d1470:
                ...
                if ((local_4c == 2) && (match < local_50)) {
                  ...
                  if (cVar7 != '\0') {
                    if (local_48 == 0) goto LAB_000d18ae;
                ...
                if ((local_48 == 0) || (cpy <= oend + -0xc)) {
                  ...
                  if (cVar7 == '\0') {
                    ...
                    *(undefined4 *)(op + 0xc) = uVar2;
                    ...
                    oCopyLimit = oend + -7;
                    if (oend + -5 < cpy) goto LAB_000d18ae;
                    op = pBVar11;
