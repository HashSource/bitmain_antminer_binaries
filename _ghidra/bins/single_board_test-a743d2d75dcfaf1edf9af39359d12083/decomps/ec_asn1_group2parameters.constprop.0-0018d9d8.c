...

{
  ...
  *(undefined4 *)val = 1;
  if (puVar14 == (undefined4 *)0x0 || param_1 == (EC_GROUP *)0x0) goto LAB_0018da7e;
...
LAB_0018de0a:
  ...
  if (iVar4 == 0x196) {
    pBVar8 = BN_new();
    iVar4 = 0x14e;
    if (pBVar8 == (BIGNUM *)0x0) goto LAB_0018dda0;
...
joined_r0x0018df64:
          ...
          if (to != (uchar *)0x0) {
            ...
            if (local_34 != 0) goto LAB_0018dc3c;
...
joined_r0x0018df64:
        if (puVar15 != (uchar *)0x0) goto LAB_0018df06;
      }
      else {
...
LAB_0018de06:
          ...
          if (iVar4 != 2) goto LAB_0018da6c;
          pAVar5 = OBJ_nid2obj(0x2aa);
          *(ASN1_OBJECT **)(pAVar6 + 4) = pAVar5;
          if (pAVar5 == (ASN1_OBJECT *)0x0) goto LAB_0018de06;
          pEVar3 = EC_GROUP_method_of(param_1);
          iVar4 = EC_METHOD_get_field_type(pEVar3);
          if (((iVar4 == 0x197) && (*(int *)(param_1 + 0x5c) != 0)) &&
