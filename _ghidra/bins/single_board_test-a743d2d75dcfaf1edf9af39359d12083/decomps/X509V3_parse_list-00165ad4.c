            ...
            *pbVar1 = 0;
            ...
            if (uVar5 != 0) {
              ...
              while ((int)((uint)puVar9[uVar5] << 0x12) < 0) {
                __s = __s + 1;
                uVar5 = (uint)*__s;
                if (uVar5 == 0) goto LAB_00165d1c;
              }
              sVar4 = strlen((char *)__s);
              pbVar1 = __s + (sVar4 - 1);
              do {
                pbVar8 = pbVar1;
                if (pbVar8 == __s) goto LAB_00165ccc;
                pbVar1 = pbVar8 + -1;
...
LAB_00165d1c:
          ...
          if (uVar5 != 0x2c) goto LAB_00165b10;
          *pbVar1 = 0;
          uVar5 = (uint)*__s;
          if (uVar5 != 0) {
            ppuVar3 = __ctype_b_loc();
            ...
            while ((int)((uint)puVar9[uVar5] << 0x12) < 0) {
              __s = __s + 1;
              uVar5 = (uint)*__s;
              if (uVar5 == 0) goto LAB_00165d30;
            }
            sVar4 = strlen((char *)__s);
            pbVar1 = __s + (sVar4 - 1);
            do {
              pbVar8 = pbVar1;
              if (pbVar8 == __s) goto LAB_00165b8a;
              pbVar1 = pbVar8 + -1;
            } while ((puVar9[*pbVar8] & 0x2000) != 0);
            pbVar8[1] = 0;
LAB_00165b8a:
          ...
          *pbVar1 = 0;
          ...
          if (uVar5 != 0) {
            ...
            while ((int)((uint)puVar9[uVar5] << 0x12) < 0) {
              __s = __s + 1;
              uVar5 = (uint)*__s;
              if (uVar5 == 0) goto LAB_00165cf8;
            }
            sVar4 = strlen((char *)__s);
            pbVar1 = __s + (sVar4 - 1);
            do {
              pbVar2 = pbVar1;
              if (pbVar2 == __s) goto LAB_00165c5c;
              pbVar1 = pbVar2 + -1;
...
joined_r0x00165d62:
    pbVar6 = pbVar1;
    if (pbVar6 == __s) goto LAB_00165d84;
  }
  if (pbVar6 != __s) {
    pbVar6[1] = 0;
  }
...
joined_r0x00165bde:
    pbVar8 = pbVar1;
    if (pbVar8 == __s) goto LAB_00165c00;
  }
  if (pbVar8 != __s) {
    pbVar8[1] = 0;
  }
...
LAB_00165d0a:
  CRYPTO_free(ptr);
  sk_pop_free(local_24,(func *)0x164dc9);
