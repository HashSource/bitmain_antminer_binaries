...

{
  ...
  if ((uVar8 != 0) && (out != (BIO *)0x0)) {
    uVar9 = 0;
    do {
      iVar1 = BIO_write(out,&DAT_0022055c,1);
      if (iVar1 != 1) {
        return -1;
      }
      uVar9 = uVar9 + 1;
  ...
  local_ac = -1;
  local_b0 = 0;
  if ((flags & 0x100000) == 0) goto LAB_001a116a;
  do {
      ...
      if (local_ac != -1) {
        if (local_ac == iVar7) {
          ...
          if (out != (BIO *)0x0) {
            ...
            if (uVar9 != 0) {
              do {
                iVar7 = BIO_write(out,&DAT_0022055c,1);
                if (iVar7 != 1) {
                  return -1;
                }
                uVar10 = uVar10 + 1;
      ...
      if (uVar6 != 0x600000) {
        ...
        if (((int)len < (int)sVar13) && ((flags & 0x2000000) != 0)) {
          ...
          if ((0 < iVar12) && (out != (BIO *)0x0)) {
            iVar11 = 0;
            do {
              iVar5 = BIO_write(out,&DAT_0022055c,1);
              if (iVar5 != 1) {
                return -1;
              }
              iVar11 = iVar11 + 1;
