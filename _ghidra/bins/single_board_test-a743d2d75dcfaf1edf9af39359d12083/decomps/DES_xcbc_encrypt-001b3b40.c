...

{
  ...
  if (enc == 0) {
    ...
    uVar16 = uVar27;
    uVar28 = uVar24;
    if (iVar11 == -8) goto switchD_001b3ed6_default;
    ...
    case -7:
      goto LAB_001b3f24;
    case -6:
      goto switchD_001b3ed6_caseD_fffffffa;
    case -5:
      goto LAB_001b3f10;
    case -4:
      goto switchD_001b3ed6_caseD_fffffffc;
    case -3:
      break;
    default:
      goto switchD_001b3ed6_default;
    }
    puVar22 = local_48 + -1;
    local_48[-1] = (uchar)uVar27;
switchD_001b3ed6_caseD_fffffffc:
    local_48 = puVar22 + -1;
    puVar22[-1] = (uchar)(uVar24 >> 0x18);
LAB_001b3f10:
    puVar22 = local_48 + -1;
    local_48[-1] = (uchar)(uVar24 >> 0x10);
switchD_001b3ed6_caseD_fffffffa:
    local_48 = puVar22 + -1;
    puVar22[-1] = (uchar)(uVar24 >> 8);
LAB_001b3f24:
    local_48[-1] = (uchar)uVar24;
switchD_001b3ed6_default:
    (*ivec)[0] = (uchar)uVar28;
    (*ivec)[4] = (uchar)uVar16;
