...
LAB_0016e91a:
  ...
  case 0x18:
    ...
    if (local_94 == (ASN1_OCTET_STRING *)0x0) {
      local_94 = ASN1_STRING_type_new(4);
      iVar2 = 0x30a;
      if (local_94 == (ASN1_STRING *)0x0) goto LAB_0016e91a;
...
LAB_0016e68e:
        ...
        while( true ) {
          ...
          if (pBVar6 == (BIO *)0x0) goto LAB_0016e5ec;
          BIO_ctrl(pBVar6,0x78,0,&local_8c);
          if (local_8c == (EVP_MD_CTX *)0x0) goto LAB_0016e692;
...
LAB_0016e76a:
        ...
        do {
          iVar3 = sk_num(p_Var9);
          if (iVar3 <= iVar2) goto LAB_0016e6fa;
        ...
        if (((puVar4[1] != 0) || (iVar2 = sk_num((_STACK *)puVar4[2]), iVar2 == 0)) ||
           (pvVar5 = sk_value((_STACK *)puVar4[2],0), pvVar5 == (void *)0x0)) goto LAB_0016e6fa;
LAB_0016e706:
...
LAB_0016e502:
    ...
    if ((iVar1 != 0x16) || (lVar7 = PKCS7_ctrl(p7,2,0,(char *)0x0), lVar7 == 0)) {
      if (local_94 == (ASN1_STRING *)0x0) goto LAB_0016e5fe;
