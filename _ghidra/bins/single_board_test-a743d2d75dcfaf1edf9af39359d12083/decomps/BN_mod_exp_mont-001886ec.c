...
LAB_001887ec:
  ...
  if (m_ctx == (BN_MONT_CTX *)0x0) {
    ...
    if (local_c0 == (BN_MONT_CTX *)0x0) goto LAB_001887ec;
    iVar5 = BN_MONT_CTX_set(local_c0,m,ctx);
    if (iVar5 != 0) goto LAB_0018877a;
    iVar5 = 0;
  }
  else {
    local_c0 = m_ctx;
...
LAB_00188834:
        ...
        if ((int)puVar16[iVar5 + -1] < 0) {
          if (a_00->dmax < iVar5) {
            ...
            if (pBVar3 == (BIGNUM *)0x0) goto LAB_001887e8;
            puVar16 = m->d;
          }
          puVar7 = a_00->d;
          *puVar7 = -*puVar16;
...
LAB_001888d0:
        ...
        while( true ) {
          while (iVar5 = BN_is_bit_set(p,local_bc), iVar5 == 0) {
            ...
            if (local_bc == 0) goto LAB_001889ce;
            local_bc = local_bc + -1;
          }
          if (local_b8 == 1) {
            uVar13 = 0;
...
LAB_001887e8:
    ...
    if (m_ctx != (BN_MONT_CTX *)0x0) goto LAB_001887ee;
  }
