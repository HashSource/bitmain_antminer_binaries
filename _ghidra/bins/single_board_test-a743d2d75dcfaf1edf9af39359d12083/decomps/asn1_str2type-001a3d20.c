...

{
  ...
  case 10:
    ...
    if (pAVar2 != (ASN1_INTEGER *)0x0) goto LAB_001a3db4;
...
LAB_001a3db4:
      ...
      iVar5 = CONF_parse_list((char *)param_1,0x2c,1,(list_cb *)0x1a43d5,pAVar1);
      if (iVar5 != 0) goto LAB_001a3db4;
  ...
  case 6:
    ...
    if (pAVar3 != (ASN1_OBJECT *)0x0) goto LAB_001a3db4;
