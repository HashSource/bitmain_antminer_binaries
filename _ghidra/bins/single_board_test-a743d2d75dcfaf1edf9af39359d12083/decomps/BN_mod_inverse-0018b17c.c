...

{
  ...
  if ((a->flags << 0x1d < 0) || (n->flags << 0x1d < 0)) {
    ...
    if (pBVar8 == (BIGNUM *)0x0) {
      local_54 = (BIGNUM *)0x0;
joined_r0x0018b3bc:
      if (ret != (BIGNUM *)0x0) goto LAB_0018b2da;
    }
    else {
      local_54 = ret;
...
LAB_0018b218:
          ...
          if (iVar12 == 0) goto joined_r0x0018b3bc;
        }
        if (pBVar3->top == 0) {
LAB_0018b642:
          ...
          do {
            ...
            if (((iVar9 == 0) || (iVar9 = BN_mul(pBVar4,pBVar5,pBVar7,ctx), iVar9 == 0)) ||
               (iVar9 = BN_add(pBVar4,pBVar4,pBVar10), iVar9 == 0)) goto joined_r0x0018b3bc;
            pBVar8 = pBVar2;
            pBVar6 = pBVar10;
            pBVar10 = pBVar7;
          } while (pBVar3->top != 0);
          if (iVar12 == -1) goto LAB_0018b642;
        }
        if (((pBVar2->top == 1) && (*pBVar2->d == 1)) && (pBVar2->neg == 0)) {
          ...
          if (pBVar6 != (BIGNUM *)0x0) goto LAB_0018b2dc;
        }
        else {
...
LAB_0018b4be:
              ...
              if (iVar9 == iVar11 + 1) {
                ...
                if (iVar9 == 0) goto LAB_0018b37c;
                iVar9 = BN_ucmp(pBVar4,pBVar8);
                if (iVar9 < 0) goto LAB_0018b4be;
            ...
            if (iVar9 == 1) {
              ...
              if (uVar13 != 1) {
                if (uVar13 == 2) {
                  if (pBVar5->neg != 0) goto LAB_0018b4fa;
...
LAB_0018b4fa:
                  ...
                  if (pBVar6 == (BIGNUM *)0x0) goto LAB_0018b37c;
                  iVar9 = BN_mul_word(pBVar4,*pBVar5->d);
                }
                if (iVar9 != 0) goto LAB_0018b482;
                goto LAB_0018b37c;
              }
              if (pBVar5->neg != 0) goto LAB_0018b4fa;
        ...
        while( true ) {
          ...
          while (iVar9 = BN_is_bit_set(pBVar2,iVar12), iVar9 == 0) {
            ...
            if ((((0 < pBVar7->top) && ((int)(*pBVar7->d << 0x1f) < 0)) &&
               ...
               (iVar9 = BN_rshift1(pBVar7,pBVar7), iVar9 == 0)) goto LAB_0018b37c;
          }
...
LAB_0018b37c:
    if (ret == (BIGNUM *)0x0) goto LAB_0018b382;
LAB_0018b2da:
    local_54 = (BIGNUM *)0x0;
  }
LAB_0018b2dc:
