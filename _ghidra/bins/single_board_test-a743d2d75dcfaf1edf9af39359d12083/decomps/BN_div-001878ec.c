...
LAB_001879d6:
  ...
  if ((r_00 == (BIGNUM *)0x0 || dv == (BIGNUM *)0x0) ||
     (pBVar3 == (BIGNUM *)0x0 || r == (BIGNUM *)0x0)) goto LAB_00187976;
  iVar7 = BN_num_bits(d);
  iVar4 = BN_lshift(r_00,d,0x20 - iVar7 % 0x20);
  if (iVar4 == 0) goto LAB_00187976;
  iVar4 = 0x40 - iVar7 % 0x20;
  r_00->neg = 0;
  iVar7 = BN_lshift(r,m,iVar4);
  if (iVar7 == 0) goto LAB_00187976;
  r->neg = 0;
  if (local_a4 == 0) {
    local_a0 = r->top;
    local_3c.d = r->d;
    ...
    if (iVar7 < iVar13) {
      if (r->dmax <= iVar13) {
        ...
        if (pBVar5 == (BIGNUM *)0x0) goto LAB_00187976;
        iVar13 = r->top;
      }
      local_3c.d = r->d;
      local_3c.d[iVar13] = 0;
...
LAB_00187cea:
        ...
        local_a0 = r_00->top;
        iVar13 = r->top;
        if (iVar13 <= local_a0 + 1) goto LAB_00187cea;
        local_3c.d = r->d;
      }
      local_a0 = local_a0 + 2;
      r->top = local_a0;
