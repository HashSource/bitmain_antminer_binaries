...
LAB_00166f8a:
        ...
        if (param_2->flags != 1) {
          if (param_2->subject_cert == (X509 *)0x0) {
            if (param_2->subject_req == (X509_REQ *)0x0) goto LAB_00167080;
...
LAB_00167032:
          ...
          if (param_2->flags != 1) {
            if (param_2->subject_cert == (X509 *)0x0) {
              if (param_2->subject_req == (X509_REQ *)0x0) goto LAB_00167098;
              pXVar2 = param_2->subject_req->req_info->subject;
            }
            else {
              pXVar2 = X509_get_subject_name(param_2->subject_cert);
          ...
          if (pGVar6 == (GENERAL_NAME *)0x0) goto LAB_00166f8a;
          sk_push(st,pGVar6);
        }
      }
    }
