...
/* WARNING: Removing unreachable block (ram,0x000ce8c4) */
/* WARNING: Removing unreachable block (ram,0x000ce8ce) */
/* WARNING: Removing unreachable block (ram,0x000ce8d0) */
/* WARNING: Removing unreachable block (ram,0x000ce8d2) */
/* WARNING: Removing unreachable block (ram,0x000ce8d8) */
/* WARNING: Removing unreachable block (ram,0x000ce4a2) */
...
LAB_000ce600:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000ced5c;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000ced5c;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_000ce600;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000ced5c;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000ced5c;
              op = pBVar10;
