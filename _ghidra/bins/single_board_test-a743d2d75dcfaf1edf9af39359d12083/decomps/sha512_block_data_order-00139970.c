  ...
  if (param_3 != 0) {
    ...
    do {
      ...
      do {
        ...
        HintPreloadData(&DAT_002071e8 + local_cf0 * 2);
        HintPreloadData(&DAT_002071f0 + local_cf0 * 2);
        ...
        HintPreloadData(&DAT_002071f8 + local_cf0 * 2);
        HintPreloadData(&DAT_00207200 + local_cf0 * 2);
