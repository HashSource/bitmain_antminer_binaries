...
/* WARNING: Removing unreachable block (ram,0x000cdd72) */
/* WARNING: Removing unreachable block (ram,0x000cdd7c) */
/* WARNING: Removing unreachable block (ram,0x000cdd7e) */
/* WARNING: Removing unreachable block (ram,0x000cdd80) */
/* WARNING: Removing unreachable block (ram,0x000cdd86) */
/* WARNING: Removing unreachable block (ram,0x000cd956) */
/* WARNING: Removing unreachable block (ram,0x000cd95e) */
/* WARNING: Removing unreachable block (ram,0x000cd96e) */
/* WARNING: Removing unreachable block (ram,0x000cd966) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

int LZ4_decompress_safe_partial_withPrefix64k
...

{
  ...
  if (dstCapacity <= targetOutputSize) {
    targetOutputSize = dstCapacity;
  }
  local_2c = (BYTE *)(dest + -0x10000);
  local_24 = 1;
  local_28 = 1;
  if ((source == (char *)0x0) || (targetOutputSize < 0)) {
    pBVar8 = (BYTE *)0xffffffff;
  }
  else {
    iend = (BYTE *)(source + compressedSize);
    oend = (BYTE *)(dest + targetOutputSize);
    dictEnd = (BYTE *)0x0;
    checkOffset = 1;
    shortiend = iend + -0x10;
    shortoend = oend + -0x20;
    iVar9 = targetOutputSize;
...
LAB_000cdaae:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000ce20a;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000ce20a;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_000cdaae;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000ce20a;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000ce20a;
              op = pBVar10;
