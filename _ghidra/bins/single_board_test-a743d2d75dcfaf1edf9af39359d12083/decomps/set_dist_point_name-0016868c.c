...

{
  ...
  if (iVar1 == 0) {
    ...
    if (*pcVar4 == '@') {
      ...
      sk_pop_free(p_Var5,(func *)0x164dc9);
    }
    if (st == (_STACK *)0x0) {
      return 0xffffffff;
    }
  ...
  if (st != (_STACK *)0x0) {
    sk_pop_free(st,(func *)0x1665e1);
  }
joined_r0x00168764:
  if (p_Var5 == (_STACK *)0x0) {
    return 0xffffffff;
  }
  sk_pop_free(p_Var5,(func *)0x1572f1);
  return 0xffffffff;
}
