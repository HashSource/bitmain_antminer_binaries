...

{
  ...
  if (pcVar7 != pcVar4) {
    pcVar9 = pcVar6->right;
    if (pcVar6->right == pcVar4) goto LAB_001c6fd4;
    do {
      pcVar8 = pcVar9;
      pcVar9 = pcVar8->left;
    } while (pcVar9 != pcVar4);
      ...
      while( true ) {
        ...
        if (pcVar7 == pcVar9) {
          ...
          if (pcVar9->left->color == 0) {
            if (pcVar6->color == 0) goto LAB_001c704c;
          }
        ...
        if (pcVar6->color != 0) goto LAB_001c707c;
LAB_001c704c:
        pcVar6 = pTree->root;
        pcVar9->color = 1;
        pcVar7 = pcVar4;
        if (pcVar4 == pcVar6) goto LAB_001c7058;
      }
      if (pcVar6->color == 0) {
