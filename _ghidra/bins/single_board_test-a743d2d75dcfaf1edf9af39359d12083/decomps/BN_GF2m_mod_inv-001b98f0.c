...
LAB_001b9ac6:
    uVar18 = *puVar22;
    if (local_70 != 0) goto LAB_001b9b7a;
LAB_001b9ad0:
    if (uVar18 != 0) {
LAB_001b9ad6:
      puVar12 = puVar20;
...
LAB_001b9adc:
        ...
        if (local_70 != local_64) goto LAB_001b9ac6;
        iVar7 = local_70 + 0x1e;
        if (-1 < local_70 + -1) {
          iVar7 = local_70 + -1;
        }
...
LAB_001b9b64:
        ...
        uVar18 = *puVar22;
        if (local_70 == 0) goto LAB_001b9ad0;
LAB_001b9b7a:
        if ((uVar18 & 1) != 0) {
          puVar12 = puVar20;
          puVar5 = puVar11;
          if (local_70 < 0x21) goto LAB_001b9ad6;
          goto LAB_001b9adc;
        }
        puVar12 = param_3->d;
