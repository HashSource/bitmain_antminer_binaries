    ...
    do {
      ...
      if (iVar2 != 0) {
        ...
        do {
          ...
          if ((bVar14 && !bVar13) && (5 < uVar5 - 0x41)) goto LAB_001a38e4;
          iVar2 = iVar2 + -1;
          pbVar4 = pbVar4 + -1;
        } while (iVar2 != 0);
      }
          ...
          while( true ) {
            ...
            if (9 < uVar5) {
              if (uVar8 - 0x61 < 6) {
                ...
                if (5 < uVar8 - 0x41) goto LAB_001a39c0;
                uVar5 = uVar8 - 0x37;
              }
            }
...
LAB_001a396e:
            ...
            *pbVar11 = (byte)uVar6 | (byte)(uVar8 << 4);
            pbVar11 = pbVar11 + 1;
            if (pbVar4 == (byte *)(buf + iVar2 * 2)) goto LAB_001a39a6;
          }
          if (5 < uVar5 - 0x61) {
            if (5 < uVar5 - 0x41) {
LAB_001a39c0:
