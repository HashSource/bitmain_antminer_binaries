...
LAB_00147c2a:
    ...
    if (pBVar7 == (BIGNUM *)0x0) goto LAB_00147c48;
    pBVar3 = (BIGNUM *)0x0;
    pBVar5 = pBVar7;
    ...
    if (rnd == (BIGNUM *)0x0) {
      rnd = BN_new();
      if (rnd == (BIGNUM *)0x0) goto LAB_00147d10;
      bVar1 = true;
    }
    else {
      bVar1 = false;
    ...
    if ((*(uint *)(param_1 + 0x1c) & 1) == 0) {
      ...
      if (pBVar4 == (BN_MONT_CTX *)0x0) goto LAB_00147c2a;
    }
    if (bVar1) {
