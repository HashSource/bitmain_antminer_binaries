...
LAB_00198976:
    ...
    ECDSA_SIG_free(sig);
    if (ctx == (ECDSA_SIG *)0x0) goto LAB_001989a8;
    sig = (ECDSA_SIG *)0x0;
    ret = (BIGNUM *)0x0;
  }
  else {
    r = BN_new();
    if ((r == (BIGNUM *)0x0) || (ret = BN_new(), ret == (BIGNUM *)0x0)) goto LAB_00198976;
...
LAB_00198a10:
        ...
        do {
          ...
          if (r_00->top != 0) goto LAB_00198996;
