...

{
  ...
  iVar7 = param_1[0x16];
  if (*(int *)(iVar7 + 0x108) != 0) goto LAB_00124fa2;
...
LAB_00124fb0:
    ...
    uVar4 = param_1[0x23];
    if (uVar4 == 0) goto LAB_00124fb0;
    pEVar1 = EVP_MD_CTX_md((EVP_MD_CTX *)param_1[0x24]);
    if (pEVar1 == (EVP_MD *)0x0) goto LAB_00124fac;
    pEVar1 = EVP_MD_CTX_md((EVP_MD_CTX *)param_1[0x24]);
...
LAB_0012500c:
    ...
    *(uint *)(iVar7 + 0x104) = uVar4;
    ...
    if (param_5 == 0) goto LAB_0012500c;
    local_2c = 0;
...
LAB_00124e6c:
  ...
  *(int *)(iVar6 + 0x130) = param_2;
  ...
  if ((param_1[0xd] == 0x1111) && (param_1[100] == 0)) {
    iVar9 = *param_1;
    iVar8 = iVar9;
    if (iVar9 >> 8 != 3) goto LAB_00124e88;
    if (0x301 < iVar9) {
      unaff_r11 = puVar5 + 3;
      iVar8 = 1;
    }
    uVar3 = (undefined1)iVar8;
    if (iVar9 < 0x302) goto LAB_00124e88;
  }
  else {
    iVar8 = *param_1;
LAB_00124e88:
...
LAB_00124ea8:
    ...
    if ((uVar2 & 0xf0007) == 2) {
      ...
      if (local_30 < 2) goto LAB_00124ea8;
    }
    else {
      if ((uVar2 & 0xf0007) != 6) goto LAB_00124ea8;
      local_30 = 8;
    }
  }
