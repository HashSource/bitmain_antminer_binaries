...
LAB_0016dd30:
        ...
        if (p_Var13 != (_STACK *)0x0) {
          if (p_Var13->num != 4) goto LAB_0016dd30;
...
LAB_0016ddc0:
  ...
  case 0x18:
    ...
    iVar3 = 0x129;
    if (cipher == (BIO *)0x0) goto LAB_0016ddc0;
    p_Var15 = (_STACK *)0x0;
    p_Var13 = p_Var15;
    break;
  case 0x19:
...
LAB_0016dad0:
        ...
        p_Var13 = (_STACK *)(ppVar11->d).data;
        if (p_Var13 != (_STACK *)0x0) {
          if (p_Var13->num != 4) goto LAB_0016dad0;
          p_Var13 = (_STACK *)p_Var13->data;
        }
      }
    }
  ...
  do {
    ...
    if (iVar4 <= iVar3) {
      if ((p_Var15 == (_STACK *)0x0) ||
        ...
        pBVar2 = local_84;
        if (cipher == (BIO *)0x0) goto LAB_0016dd64;
        pBVar5 = BIO_f_cipher();
...
LAB_0016dc5a:
  ...
  if (iVar4 <= iVar3) goto LAB_0016dd46;
  pvVar7 = sk_value(local_98,iVar3);
  pkey = X509_get_pubkey(*(X509 **)((int)pvVar7 + 0x10));
  if ((pkey == (EVP_PKEY *)0x0) ||
     (ctx = EVP_PKEY_CTX_new(pkey,(ENGINE *)0x0), ctx == (EVP_PKEY_CTX *)0x0)) goto LAB_0016dcb8;
...
LAB_0016dd64:
  local_84 = pBVar2;
  if (bio != (BIO *)0x0) goto LAB_0016dd68;
  iVar3 = OBJ_obj2nid(p7->type);
