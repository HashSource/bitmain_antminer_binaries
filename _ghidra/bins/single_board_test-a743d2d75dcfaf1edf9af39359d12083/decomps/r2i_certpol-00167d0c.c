...
LAB_00167d6c:
      iVar3 = sk_num(st_00);
      if (iVar3 <= local_48) {
        sk_pop_free(st_00,(func *)0x164dc9);
        return st;
      }
...
LAB_00168010:
                          ...
                          *(ASN1_OBJECT **)pAVar5 = pAVar2;
                          if (pAVar2 == (ASN1_OBJECT *)0x0) {
                            ...
                            if (pAVar8 == (ASN1_VALUE *)0x0) goto LAB_00168010;
...
LAB_00167f16:
                                ...
                                if (iVar9 == 0) {
                                  ...
                                  if (pAVar15 == (ASN1_VALUE *)0x0) {
                                    ...
                                    if (pAVar15 == (ASN1_VALUE *)0x0) goto LAB_00168010;
                                ...
                                if (pAVar15 == (ASN1_VALUE *)0x0) {
                                  ...
                                  if (pAVar15 != (ASN1_VALUE *)0x0) {
                                    *(ASN1_VALUE **)pAVar8 = pAVar15;
                                    ...
                                    if (st_01 != (_STACK *)0x0) goto LAB_00167f82;
LAB_00168090:
                                    iVar3 = 0x8d;
                                    iVar16 = 0x152;
                                    goto LAB_0016809c;
                                ...
                                st_01 = &X509V3_parse_list((char *)puVar4[2])->stack;
                                if (st_01 == (_STACK *)0x0) goto LAB_00168090;
LAB_00167f82:
                                iVar9 = sk_num(st_01);
                                if (iVar9 == 0) goto LAB_00168090;
...
LAB_00167fb0:
                                ...
                                if (iVar9 < iVar11) {
                                  ...
                                  data = s2i_ASN1_INTEGER((X509V3_EXT_METHOD *)0x0,
                                                          *(char **)((int)pvVar10 + 4));
                                  if (data != (ASN1_INTEGER *)0x0) goto code_r0x00167fa8;
                                  ERR_put_error(0x22,0x85,0x8c,"v3_cpols.c",0x17c);
                                  goto LAB_0016804c;
                                }
                                sk_pop_free(st_01,(func *)0x164dc9);
                              }
                            }
                            piVar13 = *(int **)pAVar8;
...
LAB_00168194:
                ...
                pAVar5 = ASN1_item_new((ASN1_ITEM *)POLICYQUALINFO_it);
                if ((pAVar5 == (ASN1_VALUE *)0x0) ||
                   (iVar16 = sk_push(*(_STACK **)(val + 4),pAVar5), iVar16 == 0)) goto LAB_00167e5c;
                ...
                *(ASN1_STRING **)(pAVar5 + 4) = pAVar6;
                if (pAVar6 == (ASN1_STRING *)0x0) goto LAB_00167e5c;
                pcVar14 = (char *)puVar4[2];
                sVar7 = strlen(pcVar14);
                iVar16 = ASN1_STRING_set(pAVar6,pcVar14,sVar7);
                if (iVar16 == 0) goto LAB_00167e5c;
              }
LAB_00167dd8:
            }
            if (*(int *)val != 0) {
...
LAB_0016804c:
    sk_pop_free(st_02,(func *)0x15b849);
    sk_pop_free(st_01,(func *)0x164dc9);
    goto LAB_00168022;
  }
  goto LAB_00167fb0;
