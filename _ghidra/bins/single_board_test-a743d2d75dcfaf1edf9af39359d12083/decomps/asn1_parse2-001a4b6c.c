...
LAB_001a4b90:
    ...
    if (iVar4 < 1) goto LAB_001a4c0e;
    if (uVar3 == 0x21) {
      iVar4 = BIO_printf(param_1,"d=%-2d hl=%ld l=inf  ",param_5,iVar10);
      if (0 < iVar4) goto LAB_001a4be0;
      goto LAB_001a4c0e;
    }
...
LAB_001a4be0:
      ...
      if (local_b8 <= param_3) {
        if ((uVar3 == 0x21) && (local_b8 == 0)) {
          while( true ) {
            ...
            a = pAVar9;
            if (pAVar9 == (ASN1_STRING *)0x0) goto LAB_001a4c14;
            if (pAVar9 == (ASN1_STRING *)0x2) break;
            if (pbVar7 <= local_c0) goto LAB_001a4e80;
          }
        }
        else {
    ...
    if (local_b4 != 6) {
      ...
      if (local_b4 == 0x1e) goto LAB_001a4d30;
      if (local_b4 == 4) {
        local_bc = pbVar12;
        a = d2i_ASN1_OCTET_STRING((ASN1_OCTET_STRING **)0x0,&local_bc,iVar10 + local_b8);
        if (a == (ASN1_OCTET_STRING *)0x0) goto LAB_001a4d30;
        if (0 < a->length) {
          local_bc = a->data;
          pbVar11 = local_bc;
          do {
...
LAB_001a4f96:
                if (param_7 == 0) {
                  ...
                  if (a->length < 1) goto LAB_001a50c6;
                  iVar4 = 0;
                  goto LAB_001a4fc2;
                }
                iVar4 = BIO_write(param_1,"\n",1);
                if (iVar4 < 1) goto LAB_001a4fd4;
                iVar4 = a->length;
            ...
            else if ((uVar3 != 0xd) && (uVar3 != 9)) goto LAB_001a4f96;
            pbVar11 = pbVar8;
      ...
      if (local_b4 != 2) {
        if (local_b4 == 10) {
          ...
          if (a_00 != (ASN1_ENUMERATED *)0x0) {
            iVar4 = BIO_write(param_1,":",1);
            if ((0 < iVar4) &&
               ((a_00->type != 0x10a || (iVar4 = BIO_write(param_1,&DAT_002075c8,1), 0 < iVar4)))) {
              iVar4 = a_00->length;
              if (0 < iVar4) {
                iVar10 = 0;
                do {
          ...
          goto joined_r0x001a519e;
        }
        if ((local_b8 < 1) || (param_7 == 0)) goto LAB_001a4d30;
        iVar4 = BIO_write(param_1,"\n",1);
        if (iVar4 < 1) goto LAB_001a4c0e;
        iVar4 = local_b8;
      ...
      if (a_00 != (ASN1_INTEGER *)0x0) {
        iVar4 = BIO_write(param_1,":",1);
        if ((0 < iVar4) &&
           ((a_00->type != 0x102 || (iVar4 = BIO_write(param_1,&DAT_002075c8,1), 0 < iVar4)))) {
          iVar4 = a_00->length;
          if (0 < iVar4) {
            iVar10 = 0;
            do {
...
LAB_001a503c:
          if ((iVar4 != 0) || (iVar4 = BIO_write(param_1,"00",2), 0 < iVar4)) goto LAB_001a5040;
        }
        goto LAB_001a4c0e;
      }
...
LAB_001a4d56:
  ...
  if (pbVar7 <= local_c0 || local_c0 <= pbVar12) goto LAB_001a4e80;
  goto LAB_001a4b90;
LAB_001a4e80:
  pAVar9 = (ASN1_STRING *)0x1;
  a = (ASN1_STRING *)0x0;
