...

{
  ...
  iVar5 = *(int *)(*(int *)((int)args + 0x55508) + 0x18);
  uVar6 = *(uint *)(*(int *)((int)args + 0x55508) + 0x14);
  uVar7 = *(uint *)(*(int *)((int)args + 0x55508) + 0x1c);
  uVar8 = *(uint *)(*(int *)((int)args + 0x55508) + 0x20);
  send_nonce = 0;
  bVar1 = false;
  while (pwVar2 = pattern_info.works[0], !bVar1) {
    for (which_pattern = 0; which_pattern < uVar8; which_pattern = which_pattern + 1) {
      for (which_core = 0; which_core < uVar6; which_core = which_core + 1) {
        while (uVar3 = is_work_fifo_ready(**(uint32_t **)((int)args + 0x55508)), uVar3 == '\0') {
          usleep(100);
        }
