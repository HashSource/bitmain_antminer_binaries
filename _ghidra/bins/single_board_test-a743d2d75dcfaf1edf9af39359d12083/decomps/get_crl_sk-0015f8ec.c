...
LAB_0015f91e:
    ...
    if (-1 < (int)(uVar9 << 0x1e)) {
      if ((*(uint *)(*(int *)(param_1 + 0x14) + 0xc) & 0x1000) == 0) {
        uVar10 = 0;
        if ((uVar9 & 0x60) == 0) goto LAB_0015f950;
        goto LAB_0015fa1e;
      }
      if ((uVar9 & 0x40) != 0) {
        if ((piVar2[8] & ~local_68) != 0) goto LAB_0015f950;
        uVar10 = 0;
        goto LAB_0015fa1e;
      }
      if (piVar2[10] != 0) {
...
LAB_0015f99a:
      ...
      if ((iVar1 == 0) && ((uVar9 & 0x20) != 0)) {
        ...
        do {
          ...
          iVar13 = iVar1 + 1;
          if (iVar12 <= iVar1) {
            if (-1 < *(int *)(*(int *)(param_1 + 0x14) + 0xc) << 0x13) goto LAB_0015fa14;
            iVar1 = 0;
            goto LAB_0015fc8c;
          }
...
LAB_0015fc8c:
    ...
    iVar13 = iVar1 + 1;
    if (iVar12 <= iVar1) goto LAB_0015fa14;
  }
  uVar9 = uVar9 | 4;
  local_60 = pXVar4;
LAB_0015fb7a:
...
LAB_0015fa1e:
  ...
  iVar17 = iVar17 + 1;
  iVar1 = sk_num(param_7);
  if (iVar1 <= iVar17) goto LAB_0015fa42;
  goto LAB_0015f91e;
}
