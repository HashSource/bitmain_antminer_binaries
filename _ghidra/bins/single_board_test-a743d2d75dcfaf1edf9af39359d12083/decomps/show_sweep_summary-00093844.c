...

{
  ...
  snprintf(tmp42,0x100,"online_case_time[%lld], end_case_time[%lld], validate_case_time[%lld]",tmp42
  ...
  puts(tmp42);
  snprintf(tmp42,0x100,"matrix online freq min[%f]",tmp42,(double)g_rt.sweep.sweep_online_min);
  puts(tmp42);
  snprintf(tmp42,0x100,"matrix online freq max[%f]",tmp42,(double)g_rt.sweep.sweep_online_max);
  puts(tmp42);
  snprintf(tmp42,0x100,"matrix online freq avg[%f]",tmp42,(double)g_rt.sweep.sweep_online_avg);
  puts(tmp42);
  snprintf(tmp42,0x100,"matrix online freq var[%f]",tmp42,(double)g_rt.sweep.sweep_online_var);
  puts(tmp42);
  snprintf(tmp42,0x100,"matrix online sweep to max freq board nonce rate [%f]",tmp42,
  ...
  fVar1 = get_freq_matrix_min(matrix,(g_rt.config)->asics);
  snprintf(tmp42,0x800,"matrix freq min[%f]",tmp42,(double)fVar1);
  ...
  printf("%s: matrix freq max[%f]\n","show_sweep_summary",SUB84((double)fVar1,0),
         (int)((ulonglong)(double)fVar1 >> 0x20));
  fVar1 = get_freq_matrix_max(matrix,(g_rt.config)->asics);
  snprintf(tmp42,0x800,"matrix freq max[%f]",tmp42,(double)fVar1);
  log_to_file(tmp42,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  printf("%s: matrix freq avg[%f]\n","show_sweep_summary",SUB84((double)fVar1,0),
         (int)((ulonglong)(double)fVar1 >> 0x20));
  fVar1 = get_avg_matrix(matrix,(g_rt.config)->asics);
  snprintf(tmp42,0x800,"matrix freq avg[%f]",tmp42,(double)fVar1);
  log_to_file(tmp42,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  printf("%s: matrix freq var[%f]\n","show_sweep_summary",SUB84((double)fVar1,0),
         (int)((ulonglong)(double)fVar1 >> 0x20));
  fVar1 = get_var_matrix(matrix,(g_rt.config)->asics);
  snprintf(tmp42,0x800,"matrix freq var[%f]",tmp42,(double)fVar1);
  log_to_file(tmp42,time_stamp);
  print_time_stamp(time_stamp,0x30);
  printf("%s ",time_stamp);
  ...
  snprintf(tmp42,0x800,"matrix sweep to max freq board nonce rate [%f]\n",tmp42,
           (double)g_rt.nonce_rate);
  log_to_file(tmp42,time_stamp);
  return;
}
