...
LAB_0010e94e:
    ...
    do {
      ...
      if (iVar14 <= iVar12) goto LAB_0010e94e;
...
LAB_0010eb84:
        ...
        if ((undefined4 *)puVar10 != (undefined4 *)0x0) goto LAB_0010eb84;
...
LAB_0010f10c:
          ...
          if (__n != (ushort *)0x0) {
            if (*(int *)(__n + 2) == 0) goto LAB_0010eca0;
            __n = (ushort *)0x0;
          }
        }
        else {
          if (*(int *)(pSVar19->krb5_client_princ + 0x54) == 0) goto LAB_0010ec1e;
          __n = *(ushort **)(pSVar19->krb5_client_princ + 0x58);
LAB_0010ec5c:
          if (__n == (ushort *)0x0) goto LAB_0010f10c;
        }
LAB_0010ec62:
        ...
        *local_30 = '\0';
        ...
        if (pSVar19 == (SSL_SESSION *)0x0) goto LAB_0010f10c;
LAB_0010ec1e:
        __n = (ushort *)param_1->tlsext_opaque_prf_input_len;
        if (__n == (ushort *)0x0) goto LAB_0010ec62;
        if (*(int *)(__n + 2) != 0) {
          __n = (ushort *)(uint)*__n;
