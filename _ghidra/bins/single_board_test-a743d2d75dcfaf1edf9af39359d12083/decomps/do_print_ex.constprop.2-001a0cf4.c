...
LAB_001a0d18:
    iVar3 = do_dump(param_2,0x1a0779,param_1,param_3);
    if (iVar3 < 0) {
      return -1;
    }
    return iVar3 + uVar5;
...
LAB_001a0dd8:
    ...
    if ((0x1d < iVar3 - 1U) || (uVar4 = (uint)(char)tag2nbyte[iVar3], uVar4 == 0xffffffff)) {
      if ((int)(param_2 << 0x17) < 0) goto LAB_001a0d18;
      goto LAB_001a0d32;
    }
    if (-1 < (int)(param_2 << 0x1b)) goto LAB_001a0d38;
    if (uVar4 != 0) goto LAB_001a0dd8;
  }
  uVar4 = 1;
LAB_001a0d38:
  ...
  if (-1 < iVar3) {
    ...
    if (local_28[0] == '\0') {
      ...
      iVar1 = BIO_write(param_1,&DAT_0022f7b4,1);
      if (iVar1 != 1) {
        return -1;
      }
    }
