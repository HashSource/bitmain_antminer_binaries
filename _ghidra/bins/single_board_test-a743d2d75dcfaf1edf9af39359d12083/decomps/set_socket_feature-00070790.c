...

{
  ...
  snprintf(tmp1,0x800,"socket_fd = %d",socket_fd);
  ...
  if (ret < 0) {
    ...
    snprintf(tmp1,0x800,"Set socket send timeout fail, ret = %d",ret);
    log_to_file(tmp1,time_stamp);
    _Var1 = false;
  }
  else {
    ...
    if (ret < 0) {
      ...
      if (ret < 0) {
        ...
        snprintf(tmp1,0x800,"Set socket keep alive fail, ret = %d",ret);
        log_to_file(tmp1,time_stamp);
        _Var1 = false;
      }
      else {
        ...
        if (ret < 0) {
          ...
          snprintf(tmp1,0x800,"Set socket no delay fail, ret = %d",ret);
          log_to_file(tmp1,time_stamp);
          _Var1 = false;
        }
        else {
          ...
          if (ret < 0) {
            ...
            snprintf(tmp1,0x800,"Set socket keep cnt fail, ret = %d",ret);
            log_to_file(tmp1,time_stamp);
            _Var1 = false;
          }
          else {
            ...
            if (ret < 0) {
              ...
              snprintf(tmp1,0x800,"Set socket keep idle fail, ret = %d",ret);
              log_to_file(tmp1,time_stamp);
              _Var1 = false;
            }
            else {
              ...
              if (ret < 0) {
                ...
                snprintf(tmp1,0x800,"Set socket keep intvl fail, ret = %d",ret);
                log_to_file(tmp1,time_stamp);
                _Var1 = false;
              }
              else {
