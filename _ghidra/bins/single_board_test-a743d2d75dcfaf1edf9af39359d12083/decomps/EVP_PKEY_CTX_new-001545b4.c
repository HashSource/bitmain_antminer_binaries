...

{
  ...
  if ((pkey->engine == (ENGINE *)0x0) && (e_00 = e, e == (ENGINE *)0x0)) {
    ...
    if (e_00 != (ENGINE *)0x0) goto LAB_001545da;
    local_88 = local_84;
    local_84[0] = iVar5;
    if ((app_pkey_methods == (_STACK *)0x0) ||
       (iVar5 = sk_find(app_pkey_methods,local_88), iVar5 < 0)) {
      puVar3 = (undefined4 *)OBJ_bsearch_(&local_88,&standard_methods,7,4,(cmp *)0x154479);
      if (puVar3 == (undefined4 *)0x0) goto LAB_00154696;
