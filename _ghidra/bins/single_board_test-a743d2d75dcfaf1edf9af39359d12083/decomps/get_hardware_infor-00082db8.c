...

{
  ...
  snprintf(tmp1,0x800,"pcb_version_v1 = %d",(uint)zhiju_eeprom_data.zhiju_information.pcb_version_v1
          );
  ...
  snprintf(tmp1,0x800,"pcb_version_v2 = %02d",
           (uint)zhiju_eeprom_data.zhiju_information.pcb_version_v2);
  log_to_file(tmp1,time_stamp);
  ...
  snprintf(tmp1,0x800,"bom_version_v1 = %d",(uint)zhiju_eeprom_data.zhiju_information.bom_version_v1
          );
  log_to_file(tmp1,time_stamp);
  ...
  snprintf(tmp1,0x800,"bom_version_v2 = %d",(uint)zhiju_eeprom_data.zhiju_information.bom_version_v2
          );
  log_to_file(tmp1,time_stamp);
  return;
}
