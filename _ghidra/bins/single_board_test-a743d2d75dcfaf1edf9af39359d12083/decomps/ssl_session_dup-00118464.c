...

{
  ...
  __dest = CRYPTO_malloc(0xf4,"ssl_sess.c",0xee);
  if (__dest == (void *)0x0) {
    ERR_put_error(0x14,0x15c,0x41,"ssl_sess.c",0x15d);
    return (void *)0x0;
  }
  memcpy(__dest,param_1,0xf4);
  *(undefined1 *)((int)__dest + 0xc0) = 0;
  *(undefined1 *)((int)__dest + 0xc1) = 0;
  *(undefined1 *)((int)__dest + 0xc2) = 0;
  *(undefined1 *)((int)__dest + 0xc3) = 0;
  *(undefined1 *)((int)__dest + 0xc4) = 0;
  *(undefined1 *)((int)__dest + 0xc5) = 0;
  *(undefined1 *)((int)__dest + 0xc6) = 0;
  *(undefined1 *)((int)__dest + 199) = 0;
  ...
  *(undefined4 *)((int)__dest + 0xa4) = 1;
  if (iVar1 != 0) {
    CRYPTO_add_lock((int *)(iVar1 + 0xf8),1,0xf,"ssl_sess.c",0x111);
  }
  ...
  if (*(char **)((int)param_1 + 0x8c) != (char *)0x0) {
    ...
    *(char **)((int)__dest + 0x8c) = pcVar2;
    if (pcVar2 == (char *)0x0) goto LAB_001185bc;
  }
  ...
  if (*(_STACK **)((int)param_1 + 0xbc) != (_STACK *)0x0) {
    ...
    *(_STACK **)((int)__dest + 0xbc) = p_Var3;
    if (p_Var3 == (_STACK *)0x0) goto LAB_001185bc;
  }
  ...
  if (iVar1 != 0) {
    ...
    if (*(void **)((int)param_1 + 0xd8) != (void *)0x0) {
      ...
      *(void **)((int)__dest + 0xd8) = pvVar4;
      if (pvVar4 == (void *)0x0) goto LAB_001185bc;
    }
...
LAB_001185bc:
  ERR_put_error(0x14,0x15c,0x41,"ssl_sess.c",0x15d);
  iVar1 = CRYPTO_add_lock((int *)((int)__dest + 0xa4),-1,0xe,"ssl_sess.c",0x352);
  if (iVar1 < 1) {
