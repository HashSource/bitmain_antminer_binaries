...

{
  ...
  if (dso == (DSO *)0x0) {
    ERR_put_error(0x25,0x6f,0x43,"dso_lib.c",0x88);
    iVar1 = 0;
  }
  else {
    iVar1 = CRYPTO_add_lock(&dso->references,-1,0x1c,"dso_lib.c",0x8c);
    if (iVar1 < 1) {
      pDVar2 = dso->meth;
      if (pDVar2->dso_unload != (_func_3875 *)0x0) {
        iVar1 = (*pDVar2->dso_unload)(dso);
        if (iVar1 == 0) {
          ERR_put_error(0x25,0x6f,0x6b,"dso_lib.c",0x9a);
          return 0;
        }
        pDVar2 = dso->meth;
      }
      if ((pDVar2->finish == (_func_3880 *)0x0) || (iVar1 = (*pDVar2->finish)(dso), iVar1 != 0)) {
        ...
        ERR_put_error(0x25,0x6f,0x66,"dso_lib.c",0x9f);
        iVar1 = 0;
      }
    }
    else {
