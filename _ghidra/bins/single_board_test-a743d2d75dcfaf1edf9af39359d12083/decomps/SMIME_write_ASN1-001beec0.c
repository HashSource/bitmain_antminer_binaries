...
LAB_001bf0be:
            ...
            if (0x2a1 < iVar8) {
              if (iVar8 != 0x329) goto LAB_001bf0be;
...
LAB_001bf27e:
  ...
  if (ctype_nid == 0x17) {
    ...
    if (econt_nid == 0xcc) {
      ...
      pcVar19 = (char *)(iVar3 >> 0x20 & 0x22f708);
      if (cVar21 == '\0') {
        pcVar19 = "signed-data";
      }
    }
    ...
    if (ctype_nid != 0x312) {
      ...
      BIO_printf(bio,"MIME-Version: 1.0%s",pcVar18);
      BIO_printf(bio,"Content-Disposition: attachment;");
      BIO_printf(bio," filename=\"%s\"%s",&DAT_0022f6fc,pcVar18);
