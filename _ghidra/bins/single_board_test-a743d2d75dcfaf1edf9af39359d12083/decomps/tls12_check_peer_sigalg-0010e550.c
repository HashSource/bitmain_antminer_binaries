...

{
  ...
  if (iVar9 == tls12_sig._0_4_) {
    ...
    puVar10 = (undefined1 *)0x248328;
  }
  else {
    if (iVar9 != tls12_sig._16_4_) {
      return 0xffffffff;
    }
    puVar10 = (undefined1 *)0x248330;
  }
...
LAB_0010e5c8:
  ...
  if (uVar11 == uVar8) goto LAB_0010e6b4;
  switch(cVar7) {
  case '\x01':
    pEVar5 = EVP_md5();
    break;
  case '\x02':
    goto switchD_0010e5f0_caseD_2;
  case '\x03':
    pEVar5 = EVP_sha224();
    break;
  case '\x04':
