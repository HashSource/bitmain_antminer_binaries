          ...
          do {
            ...
            do {
              while( true ) {
                ...
                uVar10 = (uint)*pbVar6;
                iVar13 = iVar13 + -1;
                if (uVar10 == 0x20 || uVar10 == 0x2e) goto LAB_00155b8c;
                if (9 < uVar10 - 0x30) {
                ...
                if (((a == (BIGNUM *)0x0) && (a = BN_new(), a == (BIGNUM *)0x0)) ||
                   (iVar5 = BN_set_word(a,w), iVar5 == 0)) goto LAB_00155c74;
                bVar2 = true;
LAB_00155b70:
                iVar5 = BN_mul_word(a,10);
                if ((iVar5 == 0) || (iVar5 = BN_add_word(a,uVar10 - 0x30), iVar5 == 0))
                goto LAB_00155c74;
                if (iVar13 == 0) goto LAB_00155b8c;
              }
              if (bVar2) goto LAB_00155b70;
              w = (uVar10 + w * 10) - 0x30;
            } while (iVar13 != 0);
LAB_00155b8c:
            if (local_64 == 0) {
...
LAB_00155cce:
              ...
              if (local_48 < iVar5) {
                ...
                if (local_5c == (uchar *)0x0) goto LAB_00155c7c;
              }
              if (iVar5 != 0) {
                iVar11 = 0;
                do {
