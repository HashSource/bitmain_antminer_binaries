...

{
  ...
  iVar20 = 0;
joined_r0x0014b6c2:
  if (uVar12 == 0) goto LAB_0014b846;
  if ((param_2 == (int *)0x0) && (uVar6 = *param_3, uVar6 <= local_54)) goto LAB_0014b84a;
  switch(iVar17) {
  case 0:
    if (uVar12 == 0x25) {
      iVar17 = 1;
  ...
  case 2:
    ...
    goto joined_r0x0014b6c2;
  case 3:
    if (uVar12 != 0x2e) goto LAB_0014b89a;
    uVar12 = (uint)*pbVar18;
    iVar17 = 4;
    pbVar18 = pbVar18 + 1;
    goto joined_r0x0014b6c2;
...
LAB_0014be80:
    ...
    case 0x66:
      ...
      if ((int)(local_74 << 0x1f) < 0) {
        uVar6 = -uVar6;
        if (-1 < (int)(local_74 << 0x1b)) goto LAB_0014bf10;
LAB_0014bc7e:
        if ((int)uVar6 < 1) goto LAB_0014bf10;
        if (local_78 != 0) {
          doapr_outch(param_1,param_2,&local_54,param_3,local_5c);
          goto joined_r0x0014bfea;
        }
        do {
...
joined_r0x0014bfea:
        ...
        if ((int)(local_74 << 0x1b) < 0) goto LAB_0014bc7e;
        if (0 < (int)uVar6) {
          do {
...
LAB_0014be08:
    ...
    goto joined_r0x0014b6c2;
  default:
    goto switchD_0014b6d4_default;
  }
  uVar12 = (uint)*pbVar18;
  pbVar18 = pbVar18 + 1;
  goto joined_r0x0014b6c2;
switchD_0014b6d4_default:
  if (iVar17 == 7) goto LAB_0014b846;
  goto joined_r0x0014b6c2;
LAB_0014b846:
  uVar6 = *param_3;
LAB_0014b84a:
  ...
  if ((param_2 != (int *)0x0) && (uVar12 == local_54)) {
    ...
    *param_3 = uVar12;
    if (pvVar3 == (void *)0x0) {
      ...
      *param_2 = (int)pvVar3;
      if (pvVar3 == (void *)0x0) goto LAB_0014b884;
      if (local_54 != 0) {
