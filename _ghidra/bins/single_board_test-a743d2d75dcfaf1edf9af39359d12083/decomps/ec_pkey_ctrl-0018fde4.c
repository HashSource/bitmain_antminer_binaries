        ...
        if (iVar13 == 0x198) {
          if ((local_28 == 5) || (local_28 == -1)) {
            ...
            if (pEVar3 != (EVP_PKEY *)0x0) {
              ...
              if (local_2c == (EVP_MD *)0x0) goto LAB_00190104;
              iVar13 = EC_KEY_set_group((EC_KEY *)local_2c,group);
              if (iVar13 != 0) goto LAB_0019030c;
            }
            goto LAB_001900ea;
          }
      ...
      if ((iVar13 != 0) && (iVar13 = OBJ_find_sigid_algs(iVar13,&local_28,&local_40), iVar13 != 0))
      {
        ...
        if ((0 < iVar13) &&
          ...
          if ((pEVar8 != (EVP_MD *)0x0) &&
            ...
            if (*local_34->ln != (char *)0x10) goto LAB_0019014a;
...
LAB_0019014a:
    ...
    if (param_3 != (EVP_MD *)0x0) goto switchD_0018fdf6_caseD_2;
    local_2c = param_3;
    pEVar2 = (EVP_PKEY_CTX *)CMS_RecipientInfo_get0_pkey_ctx(param_4);
    if (pEVar2 == (EVP_PKEY_CTX *)0x0) {
      return 0;
...
LAB_0018fe5c:
      ...
      if (pXVar14 == (X509_ALGOR *)0x0) goto LAB_0018fe54;
