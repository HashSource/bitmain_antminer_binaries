...
undefined4 int_dup_ex_data(undefined4 param_1,int *param_2,int *param_3)

{
  ...
  if (*param_3 != 0) {
    ...
    puVar8 = (undefined4 *)((int)ptr + (iVar3 + -1) * 4);
    do {
      iVar7 = iVar3 + 1;
      pvVar4 = sk_value(*(_STACK **)(iVar1 + 4),iVar3);
      puVar8 = puVar8 + 1;
    ...
    CRYPTO_lock(6,2,"ex_data.c",0x1df);
    iVar1 = 0;
    puVar8 = (undefined4 *)((int)ptr + -4);
    do {
      if (((_STACK *)*param_3 == (_STACK *)0x0) ||
         (iVar3 = sk_num((_STACK *)*param_3), iVar3 <= iVar1)) {
        local_2c[0] = (void *)0x0;
      }
      else {
        local_2c[0] = sk_value((_STACK *)*param_3,iVar1);
      }
      puVar8 = puVar8 + 1;
      puVar9 = (undefined4 *)*puVar8;
      if ((puVar9 != (undefined4 *)0x0) && ((code *)puVar9[4] != (code *)0x0)) {
        (*(code *)puVar9[4])(param_2,param_3,local_2c,iVar1,*puVar9,puVar9[1]);
      }
      pvVar4 = local_2c[0];
      p_Var5 = (_STACK *)*param_2;
      if (p_Var5 == (_STACK *)0x0) {
        p_Var5 = sk_new_null();
        *param_2 = (int)p_Var5;
        if (p_Var5 != (_STACK *)0x0) goto LAB_001342fc;
...
LAB_001342fc:
        ...
        do {
          if (iVar1 < iVar3) {
            sk_set((_STACK *)*param_2,iVar1,pvVar4);
            goto LAB_00134320;
          }
          iVar3 = iVar3 + 1;
          iVar7 = sk_push((_STACK *)*param_2,(void *)0x0);
        } while (iVar7 != 0);
