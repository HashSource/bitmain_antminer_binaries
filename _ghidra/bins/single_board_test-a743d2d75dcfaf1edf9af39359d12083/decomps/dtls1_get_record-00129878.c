...
LAB_00129b1e:
      ...
      if (uVar19 != uVar8) goto LAB_00129a6c;
    }
LAB_00129a4a:
    pdVar14 = param_1->d1;
    ...
    if (uVar16 == pdVar14->r_epoch) {
      ...
      if ((uVar16 != pdVar14->r_epoch + 1) || (1 < (psVar17->rrec).type - 0x15U)) goto LAB_00129a6c;
    ...
    if ((((pdVar14->mtu == 0) || ((psVar17->rrec).type != 0x16)) || (param_1->packet_length < 0xe))
      ...
      if (((int)uVar19 < 1) &&
         ((0x1e < -uVar19 && uVar19 != 0xffffffe1 ||
          ((int)((pDVar20->map >> (-uVar19 & 0xff)) << 0x1f) < 0)))) goto LAB_00129a6c;
    ...
    if ((psVar17->rrec).length == 0) goto LAB_00129a72;
    if (!bVar4) {
    ...
    if (param_1->packet_length != 0xd) goto LAB_00129a70;
    param_1->rstate = 0xf1;
    buf = param_1->packet;
...
LAB_00129b0e:
        if (uVar8 < 0x4541) {
          if (param_1->packet_length - 0xd < uVar8) goto LAB_00129b1e;
          goto LAB_00129a4a;
        }
        goto LAB_00129a6c;
      }
    ...
    if ((((uint)CONCAT11(bVar2,bVar1) ^ param_1->version) & 0xff00) == 0) goto LAB_00129b0e;
  }
LAB_00129a6c:
  (psVar17->rrec).length = 0;
LAB_00129a70:
