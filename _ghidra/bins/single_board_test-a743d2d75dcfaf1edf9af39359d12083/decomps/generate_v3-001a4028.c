...

{
  ...
  local_2c = 0;
  local_1ec = (uchar *)0x0;
  puVar2 = (uchar *)CONF_parse_list(param_1,0x2c,1,(list_cb *)0x1a46fd,local_1d0);
  if (puVar2 != (uchar *)0x0) {
    *param_4 = 0xc2;
...
LAB_001a42b2:
      ...
      if (st != (_STACK *)0x0) goto LAB_001a4190;
    }
    else {
      section = local_1c0;
      if (local_1c0 != (_STACK *)0x0) {
        section = &X509V3_get_section(param_2,(char *)local_1c0)->stack;
        if (section == (_STACK *)0x0) goto LAB_001a42ec;
        param_3 = param_3 + 1;
        iVar9 = 0;
        do {
          iVar6 = sk_num(section);
          if (iVar6 <= iVar9) goto LAB_001a414c;
...
LAB_001a414c:
      ...
      if (pAVar3 == (ASN1_TYPE *)0x0) goto LAB_001a42b2;
      pAVar7 = ASN1_STRING_type_new(local_1d0[2]);
      (pAVar3->value).asn1_string = pAVar7;
      if (pAVar7 == (ASN1_STRING *)0x0) goto LAB_001a42b2;
