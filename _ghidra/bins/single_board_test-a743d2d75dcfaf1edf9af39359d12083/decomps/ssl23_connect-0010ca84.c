...

{
  ...
  *piVar5 = 0;
  ...
  do {
    ...
    if (iVar33 < 0x1212) {
      if (iVar33 < 0x1210) {
        if ((iVar33 != 0x1000) && (iVar33 != 0x1003)) goto LAB_0010cd76;
        goto LAB_0010ccea;
      }
...
LAB_0010cb0a:
      ...
      if (((int)(uVar6 << 6) < 0) && ((uVar6 & uVar21) != uVar21)) {
        ...
        if (iVar7 != 0x1210) goto LAB_0010cdf8;
LAB_0010cb7a:
        psVar27 = param_1->s3;
        ...
        if (!bVar38) {
          ...
          *(undefined4 *)(pbVar31 + 0x23) = uVar29;
          ...
          iVar7 = ssl_cipher_list_to_bytes(param_1,psVar9,pbVar28,0x1234b1);
          if (iVar7 == 0) {
            iVar7 = 0x1fe;
LAB_0010d3d0:
...
LAB_0010cc9c:
        ...
        if (1 < iVar7) goto LAB_0010ce06;
LAB_0010ccb2:
        if (iVar7 != 1) goto LAB_0010cd8a;
LAB_0010ccb4:
        param_1->init_num = 0;
        ...
        pbVar31 = (byte *)param_1->init_buf->data;
        if (iVar7 == 0x1210) goto LAB_0010cb7a;
LAB_0010cdf8:
        iVar7 = ssl23_write_bytes(param_1);
        if (iVar7 < 2) goto LAB_0010ccb2;
LAB_0010ce06:
        p_Var34 = param_1->msg_callback;
        if (p_Var34 == (_func_3292 *)0x0) goto LAB_0010ccb4;
        if (bVar38) {
              ...
              if ((((-1 < (int)((uint)bVar1 << 0x18)) || (pbVar31[2] != 4)) || (pbVar31[5] != 0)) ||
                ...
                if ((pbVar31[1] == 3) && (bVar2 = pbVar31[2], bVar2 < 4)) {
                  if (bVar1 == 0x16) {
                    ...
                    if ((bVar1 != 0x15) || (pbVar31[3] != 0)) goto LAB_0010d08a;
                    bVar1 = pbVar31[4];
                  }
                  if (bVar1 == 2) {
                    if (bVar2 == 0) {
                      if (param_1->references << 6 < 0) goto LAB_0010d062;
                      param_1->version = 0x300;
                      pSVar13 = SSLv3_client_method();
                      param_1->method = pSVar13;
                    }
                    else if (bVar2 == 1) {
                      if (param_1->references << 5 < 0) goto LAB_0010d062;
...
LAB_0010d062:
                      ...
                      if ((bVar2 != 3) || (param_1->references << 4 < 0)) goto LAB_0010d062;
...
LAB_0010cd90:
        ...
        else if (iVar33 == 0x5000) goto LAB_0010ccea;
LAB_0010cd76:
        iVar7 = -1;
...
LAB_0010ccea:
      ...
      if (param_1->init_buf == (BUF_MEM *)0x0) {
        str = BUF_MEM_new();
        if (str == (BUF_MEM *)0x0) goto LAB_0010d01c;
