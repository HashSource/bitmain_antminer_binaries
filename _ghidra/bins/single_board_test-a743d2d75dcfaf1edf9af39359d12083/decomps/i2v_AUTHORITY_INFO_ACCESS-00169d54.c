...

{
  ...
  while (iVar5 = sk_num(param_2), iVar6 < iVar5) {
    puVar1 = (undefined4 *)sk_value(param_2,iVar6);
    param_3 = &i2v_GENERAL_NAME(param_1,(GENERAL_NAME *)puVar1[1],(stack_st_CONF_VALUE *)param_3)->
               stack;
    if (param_3 == (_STACK *)0x0) goto LAB_00169df0;
    pvVar2 = sk_value(param_3,iVar6);
    i2t_ASN1_OBJECT(acStack_70,0x50,(ASN1_OBJECT *)*puVar1);
    sVar3 = strlen(acStack_70);
    sVar4 = strlen(*(char **)((int)pvVar2 + 4));
    sVar3 = sVar3 + sVar4 + 5;
    dst = (char *)CRYPTO_malloc(sVar3,"v3_info.c",0x7f);
    if (dst == (char *)0x0) {
