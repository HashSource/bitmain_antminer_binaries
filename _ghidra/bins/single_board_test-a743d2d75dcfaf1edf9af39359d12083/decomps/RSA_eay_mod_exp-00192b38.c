...
joined_r0x00192e26:
    if ((int)(uVar2 << 0x1e) < 0) {
      ...
      if (pBVar4 == (BN_MONT_CTX *)0x0) goto LAB_00192df0;
      uVar2 = *(uint *)(param_3 + 0x3c);
    }
    if ((uVar2 & 0x100) == 0) {
    ...
    if (iVar3 != 0) {
      ...
      if (iVar3 != 0) {
        if ((*(uint *)(param_3 + 0x3c) & 0x100) == 0) {
          ...
          if (iVar3 != 0) {
            if (*(int *)(param_3 + 0x3c) << 0x17 < 0) goto LAB_00192eea;
LAB_00192c10:
          ...
          if (iVar3 != 0) {
            if (-1 < *(int *)(param_3 + 0x3c) << 0x17) goto LAB_00192c10;
LAB_00192eea:
