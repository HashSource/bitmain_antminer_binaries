...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (cipher != (EVP_CIPHER *)0x0) {
      if (pEVar5 != (EVP_CIPHER *)0x0) goto LAB_0014f7b8;
      goto LAB_0014f7f0;
    }
    if (pEVar5 == (EVP_CIPHER *)0x0) goto LAB_0014f994;
LAB_0014f83a:
...
LAB_0014f994:
      ...
      if ((cipher == (EVP_CIPHER *)0x0) || (cipher->nid == pEVar5->nid)) goto LAB_0014f83a;
LAB_0014f7b8:
      uVar6 = ctx->flags;
...
LAB_0014f7f0:
    if (impl == (ENGINE *)0x0) {
      ...
      if (impl != (ENGINE *)0x0) goto LAB_0014f806;
LAB_0014f818:
      ...
      if (-1 < (int)(uVar6 << 0x19)) goto LAB_0014f83a;
...
LAB_0014f806:
        ...
        iVar4 = 0x9d;
        if (cipher != (EVP_CIPHER *)0x0) goto LAB_0014f818;
      }
    }
    ERR_put_error(6,0x7b,0x86,"evp_enc.c",iVar4);
switchD_0014f8d0_default:
    iVar1 = 0;
  }
  return iVar1;
}
