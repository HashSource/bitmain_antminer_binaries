...

{
  ...
  *piVar3 = 0;
  ...
  iVar5 = param_1->state;
  if (0x1041 < iVar5) goto LAB_0011cd14;
LAB_0011ccd6:
  if (0x103f < iVar5) {
    if (iVar5 == 0x1040) {
...
LAB_0011ccf8:
            if (p_Var27 == (_func_3294 *)0x0) goto LAB_0011cd0e;
            if (iVar6 == iVar5) goto LAB_0011cd0e;
            do {
              param_1->state = iVar5;
...
LAB_0011cd0e:
              do {
                iVar5 = iVar6;
                if (iVar6 < 0x1042) goto LAB_0011ccd6;
LAB_0011cd14:
                iVar6 = 0x1071;
                if (iVar5 < 0x1072) {
                  if (iVar5 < 0x1070) {
                    if (iVar5 < 0x1050) goto LAB_0011cea4;
                    if (iVar5 < 0x1054) goto LAB_0011ced2;
                    if (1 < iVar5 - 0x1060U) goto LAB_0011cea4;
...
LAB_0011d188:
                    ...
                    if (iVar6 < iVar7) goto LAB_0011d400;
                  ...
                  if (iVar5 == 0x1070) {
                    ...
                    if (iVar7 < 1 - param_1->init_num) goto LAB_0011d5a4;
                      ...
                      if (iVar6 == 1) {
                        if (local_44 == (EVP_PKEY *)0x0) {
                          if ((local_48 != (X509 *)0x0) &&
                             (X509_free(local_48), local_44 != (EVP_PKEY *)0x0)) goto LAB_0011d74a;
                        }
                        else {
                          if (local_48 != (X509 *)0x0) {
                            param_1->state = 0x1052;
...
LAB_0011cf18:
                ...
                if (0x1090 < iVar5) {
                  if ((iVar5 == 0x4000) || (iVar5 == 0x5000)) goto LAB_0011d026;
                  goto LAB_0011cea4;
                }
                if (iVar5 != 0x1080) goto LAB_0011cea4;
                iVar6 = ssl2_enc_init(param_1,1);
                if (iVar6 == 0) goto LAB_0011d558;
                iVar6 = 0x1040;
...
LAB_0011cf52:
        ...
        if (iVar7 != iVar6) goto LAB_0011d39c;
        if (param_1->msg_callback != (_func_3292 *)0x0) {
          (*param_1->msg_callback)
        ...
        if (param_1->hit == 0) {
          if ((param_1->session->session_id_length != 0) &&
             (iVar6 = ssl_get_new_session(param_1), iVar6 == 0)) goto LAB_0011d81c;
          ...
          iVar6 = 0;
          sk_set_cmp_func(st,(void *)0x114795);
          p_Var9 = &SSL_get_ciphers(param_1)->stack;
          sk_set_cmp_func(p_Var9,(void *)0x114795);
          p_Var2 = p_Var9;
...
LAB_0011cfd0:
      ...
      if (1 < iVar5 - 0x1030U) goto LAB_0011cea4;
      pcVar22 = param_1->init_buf->data;
      if (iVar5 != 0x1030) {
LAB_0011d156:
        iVar6 = ssl2_do_write(param_1);
...
LAB_0011d0d4:
  ...
  if (iVar5 < 0x1010) {
    if (iVar5 == 0x1000) goto LAB_0011d026;
    if (iVar5 == 0x1003) goto LAB_0011d026;
    if (iVar5 != 3) goto LAB_0011cea4;
...
LAB_0011d026:
  ...
  param_1->version = 2;
  param_1->type = 0x1000;
  if ((str == (BUF_MEM *)0x0) && (str = BUF_MEM_new(), str == (BUF_MEM *)0x0)) goto LAB_0011d558;
  iVar6 = BUF_MEM_grow(str,0x3fff);
  if (iVar6 == 0) {
    if (str == param_1->init_buf) goto LAB_0011d558;
    iVar6 = -1;
    param_1->in_handshake = param_1->in_handshake + -1;
    BUF_MEM_free(str);
    goto LAB_0011d0d4;
