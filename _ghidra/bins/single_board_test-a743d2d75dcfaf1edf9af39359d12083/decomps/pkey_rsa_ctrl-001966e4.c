    ...
    if (param_2 != 0xd) {
      ...
      if ((undefined1 *)((int)&param_3[-1].md_ctrl + 3) <= &DAT_00000005) {
        ...
        if (pEVar5 != (EVP_MD *)0x0) {
          if (param_3 == (EVP_MD *)0x3) goto LAB_0019691c;
          if (param_3 == (EVP_MD *)&DAT_00000005) {
            iVar4 = EVP_MD_type(pEVar5);
            iVar4 = RSA_X931_hash_id(iVar4);
            if (iVar4 == -1) goto LAB_00196906;
            goto LAB_0019677a;
          }
        }
        if (param_3 == (EVP_MD *)&DAT_00000006) {
          ...
          if (param_3 != (EVP_MD *)0x4) goto LAB_0019677a;
...
LAB_0019677a:
  ...
  if (param_2 == 0x1007) goto LAB_00196802;
  if (param_2 < 0x1008) {
    if (param_2 == 0x1004) {
      if (param_4 == (EVP_MD *)0x0) {
        return;
...
LAB_001968c4:
    ...
    if (param_2 < 0x100b) {
      if (param_2 == 0x1008) goto LAB_001968c4;
      if (param_2 != 0x1009) {
        return;
      }
    }
