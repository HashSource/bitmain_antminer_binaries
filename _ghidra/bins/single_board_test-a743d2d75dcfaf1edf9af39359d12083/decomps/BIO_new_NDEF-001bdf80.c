...

{
  ...
  if (parg == (BIO *)0x0 || b == (BIO *)0x0) {
    if (b == (BIO *)0x0) goto LAB_001bdfd0;
  }
  else if (pBVar1 != (BIO *)0x0) {
    BIO_asn1_set_prefix(b,(undefined1 *)0x1bdf01,(undefined1 *)0x1bde5d);
    BIO_asn1_set_suffix(b,(undefined1 *)0x1bde81,(undefined1 *)0x1bdf4d);
    local_28 = (BIO *)0x0;
    local_24 = 0;
    local_2c = pBVar1;
