...
LAB_001461c0:
    if ((*(int *)(src + 8) != 0) && (pEVar1 = *(EC_GROUP **)(src + 4), pEVar1 != (EC_GROUP *)0x0)) {
      ...
      *(EC_POINT **)(dst + 8) = dst_00;
      if ((dst_00 == (EC_POINT *)0x0) ||
         (iVar2 = EC_POINT_copy(dst_00,*(EC_POINT **)(src + 8)), iVar2 == 0)) goto LAB_00146232;
    }
    ...
    if (pBVar3 != (BIGNUM *)0x0) {
      ...
      if (a == (BIGNUM *)0x0) {
        a = BN_new();
        *(BIGNUM **)(dst + 0xc) = a;
        if (a == (BIGNUM *)0x0) goto LAB_00146232;
        pBVar3 = *(BIGNUM **)(src + 0xc);
      }
      pBVar3 = BN_copy(a,pBVar3);
      if (pBVar3 == (BIGNUM *)0x0) goto LAB_00146232;
    }
    ...
    *(EC_GROUP **)(dst + 4) = pEVar1;
    if ((pEVar1 != (EC_GROUP *)0x0) &&
       (iVar2 = EC_GROUP_copy(pEVar1,*(EC_GROUP **)(src + 4)), iVar2 != 0)) goto LAB_001461c0;
LAB_00146232:
    dst = (EC_KEY *)0x0;
  }
  return dst;
