    ...
    if (*(int *)param_1[2] == 0x1ffff) {
      ...
      if (uVar5 == 0xfefd) {
        if ((int)(param_1[0x40] << 4) < 0) {
          if ((*(uint *)(param_1[0x26] + 0x38) & 0x30000) == 0) goto LAB_0011f190;
          goto LAB_0011f24e;
        }
...
LAB_0011f050:
            ...
            if (uVar5 == 0) goto LAB_0011ef22;
LAB_0011f05a:
            pbVar6 = local_2c;
            if (uVar4 != uVar5) goto LAB_0011ef22;
            iVar2 = memcmp(local_2c,(void *)(uVar10 + 0x48),uVar5);
            if (iVar2 != 0) goto LAB_0011f0e0;
...
LAB_0011effc:
            ...
            uVar10 = param_1[0x30];
            if ((pcVar12 == (code *)0x0) || (*(int *)(uVar10 + 0xe4) == 0)) goto LAB_0011f050;
            uVar4 = param_1[0x5b];
            local_24 = 0;
