...
LAB_00193908:
      ...
      if (iVar6 < 0) {
          ...
          if (((int)(uVar7 << 0x1e) < 0) &&
             (pBVar5 = BN_MONT_CTX_set_locked
                                 ((BN_MONT_CTX **)(param_4 + 0x40),9,*(BIGNUM **)(param_4 + 0x10),
                                  ctx), pBVar5 == (BN_MONT_CTX *)0x0)) goto LAB_00193908;
        ...
        if ((iVar6 == 0) ||
           ((b != (BN_BLINDING *)0x0 &&
            (iVar6 = BN_BLINDING_invert_ex(n,local_44,b,ctx), iVar6 == 0)))) goto LAB_00193908;
        if (param_5 == 5) {
        ...
        if (0 < (int)uVar7) {
          ...
          if (uVar11 == 0) {
            ...
            if (uVar7 == uVar11) goto LAB_0019364a;
          }
          ...
          if (uVar13 != 0) {
            ...
            if (uVar7 - uVar11 == uVar13 * 4) goto LAB_0019364a;
          }
          uVar11 = uVar8 + 1;
