...
LAB_001b889e:
  ...
  if (m_ctx == (BN_MONT_CTX *)0x0) {
    ...
    if (local_150 == (BN_MONT_CTX *)0x0) goto LAB_001b889e;
    iVar6 = BN_MONT_CTX_set(local_150,m,ctx);
    if (iVar6 != 0) goto LAB_001b8870;
    iVar2 = 0;
  }
  else {
    local_150 = m_ctx;
...
LAB_001b8a12:
    if (m_ctx != (BN_MONT_CTX *)0x0) goto LAB_001b88a0;
  }
