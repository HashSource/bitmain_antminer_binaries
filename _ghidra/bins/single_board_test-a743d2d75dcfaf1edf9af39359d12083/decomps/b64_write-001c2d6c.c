        ...
        if (0 < iVar5) {
          do {
            ...
            if (iVar5 < (int)puVar2) {
              ...
              outl[1] = (int)puVar4;
              if ((int)puVar4 < 0x5df) goto LAB_001c2ef6;
LAB_001c2f36:
              OpenSSLDie("bio_b64.c",0x1d1,"ctx->buf_off <= (int)sizeof(ctx->buf)");
              if (*outl < outl[1]) goto LAB_001c2f4a;
            }
            else {
              puVar4 = puVar2 + outl[1];
              outl[1] = (int)puVar4;
              if (0x5de < (int)puVar4) goto LAB_001c2f36;
LAB_001c2ef6:
              if (*outl < (int)puVar4) {
LAB_001c2f4a:
    ...
    while (local_30 = (uchar *)BIO_write(param_1->next_bio,(void *)((int)outl + iVar1 + 0x7c),iVar5)
      ...
      if (iVar5 < (int)local_30) {
        ...
        outl[1] = (int)puVar3;
        if ((int)puVar3 < 0x5df) goto LAB_001c2dd4;
LAB_001c2e14:
        OpenSSLDie("bio_b64.c",0x186,"ctx->buf_off <= (int)sizeof(ctx->buf)");
        if (*outl < outl[1]) goto LAB_001c2e28;
      }
      else {
        puVar3 = local_30 + outl[1];
        outl[1] = (int)puVar3;
        if (0x5de < (int)puVar3) goto LAB_001c2e14;
LAB_001c2dd4:
        if (*outl < (int)puVar3) {
LAB_001c2e28:
      ...
      if (iVar5 - (int)local_30 < 1) goto LAB_001c2e38;
      iVar1 = outl[1];
