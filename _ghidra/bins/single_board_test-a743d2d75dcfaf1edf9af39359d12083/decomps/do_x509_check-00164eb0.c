...

{
  ...
  if (param_5 == 1) {
    ...
    sVar10 = 0x16;
    nid = 0xd;
    local_34 = (code *)0x164dfd;
    if ((local_3c & 2) == 0) {
      local_34 = (code *)0x1653a9;
    }
  }
  else {
    sVar10 = 4;
    nid = 0;
    local_34 = (code *)0x165175;
  }
  if (param_3 == 0) {
      ...
      if (*piVar4 == param_5) {
        ...
        if (((__s1 != (void *)0x0) && (sVar6 = *psVar9, sVar6 != 0)) && (sVar10 == psVar9[1])) {
          if (sVar10 == 0x16) {
            ...
            goto LAB_00164f52;
            if (puVar7 != (undefined4 *)0x0) goto LAB_00164f62;
          }
          else if ((sVar6 == param_3) && (iVar3 = memcmp(__s1,param_2,param_3), iVar3 == 0)) {
            puVar7 = (undefined4 *)0x1;
            if (param_6 == (undefined4 *)0x0) goto LAB_00164f62;
LAB_00164f52:
