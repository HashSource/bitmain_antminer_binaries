...

{
  ...
  if (appname != (char *)0x0) {
    ...
    if (pcVar2 != (char *)0x0) goto LAB_0016c59a;
    if (-1 < (int)(flags << 0x1a)) goto LAB_0016c80a;
  }
...
LAB_0016c750:
        ...
        if ((code *)data[2] != (code *)0x0) {
          ...
          if (0 < iVar4) {
            bVar1 = true;
            goto joined_r0x0016c710;
          }
          pcVar10 = (code *)data[3];
          if (pcVar10 == (code *)0x0) goto LAB_0016c73e;
LAB_0016c7bc:
          (*pcVar10)(data_00);
LAB_0016c744:
          pvVar5 = (void *)data_00[1];
          if (pvVar5 != (void *)0x0) goto LAB_0016c74a;
          goto LAB_0016c750;
        }
        bVar1 = false;
joined_r0x0016c710:
        if (initialized_modules == (_STACK *)0x0) {
          ...
          iVar4 = 0x16c;
          if (initialized_modules != (_STACK *)0x0) goto LAB_0016c712;
LAB_0016c726:
          ERR_put_error(0xe,0x73,0x41,"conf_mod.c",iVar4);
          pcVar10 = (code *)data[3];
          if ((pcVar10 != (code *)0x0) && (bVar1)) goto LAB_0016c7bc;
LAB_0016c73e:
          if (data_00 == (undefined4 *)0x0) goto LAB_0016c760;
          goto LAB_0016c744;
        }
LAB_0016c712:
