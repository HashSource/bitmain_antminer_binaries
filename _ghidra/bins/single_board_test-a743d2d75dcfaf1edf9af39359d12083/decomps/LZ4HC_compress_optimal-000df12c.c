...
/* WARNING: Removing unreachable block (ram,0x000e4488) */
/* WARNING: Removing unreachable block (ram,0x000e4e68) */
/* WARNING: Heritage AFTER dead removal. Example location: s0xfffff834 : 0x000e0afa */
...
LAB_000e04de:
      do {
        if ((matchIndex < lowestMatchIndex) || (nbAttempts < 1)) goto LAB_000e04fa;
        matchLength_1 = 0;
...
LAB_000dfeec:
        if ((matchLength_1 == local_144) && (matchIndex + local_144 <= ipIndex)) {
          ...
          if (1 < distanceToNextMatch) {
            if (matchIndex < distanceToNextMatch) goto LAB_000e04fa;
        ...
        if ((distNextMatch == 1) && (matchChainPos == 0)) {
          ...
          if (pattern != UVar3) goto LAB_000e04ae;
          iLimit = local_140;
          if (extDict != 0) {
            iLimit = dictEnd;
          }
          ...
          if ((currentSegmentLength < srcPatternLength) || (srcPatternLength < forwardPatternLength)
            ...
            if (iVar6 == 0) {
              ...
              if (lookBackLength == 0) {
                ...
                if (matchIndex < distToNextPattern) goto LAB_000e04fa;
...
LAB_000e4692:
    if ((cur < last_match_pos) && (curPtr = ip + cur, curPtr <= mflimit)) {
      if (fullUpdate == 0) {
        if (opt[cur].price < opt[cur + 1].price) goto LAB_000e1156;
      }
...
LAB_000e3c20:
          do {
            if ((matchIndex_2 < lowestMatchIndex_2) || (nbAttempts_2 < 1)) goto LAB_000e3c3c;
            matchLength_5 = 0;
...
LAB_000e362e:
            if ((matchLength_5 == local_560) && (matchIndex_2 + local_560 <= ipIndex_2)) {
              ...
              if (1 < distanceToNextMatch_2) {
                if (matchIndex_2 < distanceToNextMatch_2) goto LAB_000e3c3c;
            ...
            if ((distNextMatch_2 == 1) && (matchChainPos_2 == 0)) {
              ...
              if (pattern_2 != UVar3) goto LAB_000e3bf0;
              iLimit_2 = local_55c;
              if (extDict_2 != 0) {
                iLimit_2 = dictEnd_2;
              }
              ...
              if ((currentSegmentLength_2 < srcPatternLength_2) ||
                ...
                if (iVar6 == 0) {
                  ...
                  if (lookBackLength_2 == 0) {
                    ...
                    if (matchIndex_2 < distToNextPattern_2) goto LAB_000e3c3c;
...
LAB_000e2418:
        do {
          if ((matchIndex_1 < lowestMatchIndex_1) || (nbAttempts_1 < 1)) goto LAB_000e2434;
          matchLength_3 = 0;
...
LAB_000e1e26:
          if ((matchLength_3 == local_37c) && (matchIndex_1 + local_37c <= ipIndex_1)) {
            ...
            if (1 < distanceToNextMatch_1) {
              if (matchIndex_1 < distanceToNextMatch_1) goto LAB_000e2434;
          ...
          if ((distNextMatch_1 == 1) && (matchChainPos_1 == 0)) {
            ...
            if (pattern_1 != UVar3) goto LAB_000e23e8;
            iLimit_1 = local_378;
            if (extDict_1 != 0) {
              iLimit_1 = dictEnd_1;
            }
            ...
            if ((currentSegmentLength_1 < srcPatternLength_1) ||
              ...
              if (iVar6 == 0) {
                ...
                if (lookBackLength_1 == 0) {
                  ...
                  if (matchIndex_1 < distToNextPattern_1) goto LAB_000e2434;
...
LAB_000e46d6:
  ...
  if (bVar14) goto code_r0x000e0de0;
  goto LAB_000e4b78;
LAB_000e3c3c:
