...
LAB_00164be6:
      ...
      goto joined_r0x00164bec;
    }
    st = sk_new_null();
    *x = (stack_st_X509_EXTENSION *)st;
    if (st != (_STACK *)0x0) goto LAB_00164be6;
LAB_00164bfe:
    iVar1 = -1;
  }
  else {
