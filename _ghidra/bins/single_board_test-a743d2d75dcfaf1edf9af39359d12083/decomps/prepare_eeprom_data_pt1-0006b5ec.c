...

{
  ...
  len = 0x20;
  (*ctx->board_sn_set)(ctx,(char *)0x1016631,&len);
  len = 2;
  (*ctx->chip_die_set)(ctx,(char *)0x10165c0,&len);
  len = 0xd;
  (*ctx->chip_marking_set)(ctx,(char *)0x10165d0,&len);
  len = 9;
  (*ctx->ft_version_set)(ctx,(char *)0x10165f0,&len);
  len = 2;
  (*ctx->chip_tech_set)(ctx,(char *)0x1016615,&len);
  ...
  __isoc99_sscanf(buf,&DAT_001d984c,&i);
