...
LAB_00188d1c:
    ...
    if (m_ctx == (BN_MONT_CTX *)0x0) {
      ...
      if (local_38 == (BN_MONT_CTX *)0x0) goto LAB_00188d1c;
      iVar4 = BN_MONT_CTX_set(local_38,m,ctx);
      if (iVar4 != 0) goto LAB_00188bba;
      iVar1 = 0;
    }
    else {
      local_38 = m_ctx;
            ...
            if (w != uVar3) {
              if (bVar5) {
                ...
                if ((iVar4 == 0) ||
                   ...
                   rem = pBVar2, iVar4 == 0)) goto LAB_00188d50;
              }
            }
          }
          bVar6 = iVar1 != 0;
...
LAB_00188d92:
          ...
          a = w_00;
          if (bVar5) goto LAB_00188d72;
          iVar1 = BN_mul_word(a_00,w_00);
          if (iVar1 != 0) {
            iVar1 = BN_div((BIGNUM *)0x0,rem,a_00,m,ctx);
            a_00 = rem;
            goto joined_r0x00188d4e;
          }
LAB_00188d50:
          iVar1 = 0;
        }
      }
      if (m_ctx != (BN_MONT_CTX *)0x0) goto LAB_00188d1e;
    }
