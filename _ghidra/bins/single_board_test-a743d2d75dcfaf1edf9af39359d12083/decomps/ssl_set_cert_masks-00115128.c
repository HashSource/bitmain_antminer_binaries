...

{
  ...
  if (*(RSA **)(param_1 + 0x1c) == (RSA *)0x0) {
    ...
    local_34 = local_38;
    if (local_38 != 0) goto LAB_001152b6;
  }
...
LAB_001152b6:
  ...
  if (*(DH **)(param_1 + 0x24) == (DH *)0x0) {
    ...
    local_3c = local_44;
    if (local_44 != 0) goto LAB_00115174;
  }
...
LAB_001151d6:
    ...
    uVar9 = *(uint *)(param_1 + 0xc4) & 1;
    uVar2 = uVar9;
    if (uVar9 != 0) goto LAB_001153c4;
LAB_001151c4:
    uVar4 = *(uint *)(param_1 + 0xe0) & 1;
    uVar9 = uVar2;
    if (*(int *)(param_1 + 0x100) != 0) goto LAB_001151d6;
LAB_001153f0:
    iVar5 = *(int *)(param_1 + 0xe4);
    uVar12 = 0x100;
    uVar6 = 0;
  ...
  if (uVar7 == 0) {
    ...
    if (local_34 == 0) goto LAB_00115216;
  }
  uVar6 = uVar6 | 1;
LAB_00115216:
  if (bVar11) {
