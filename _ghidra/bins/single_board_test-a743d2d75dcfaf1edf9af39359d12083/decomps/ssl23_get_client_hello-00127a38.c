...

{
  ...
  if (param_1->state == 0x2210) {
    ...
    local_34 = *(undefined4 *)pbVar11;
    uStack_30 = *(undefined4 *)(pbVar11 + 4);
    local_2a = pbVar11[10];
    local_2c = *(undefined2 *)(pbVar11 + 8);
    __n_00 = 0xb;
    if (((int)((uint)*pbVar11 << 0x18) < 0) && (pbVar11[2] == 1)) {
      if (pbVar11[3] == 0) {
        if ((pbVar11[4] == 2) && ((param_1->references & 0x1000000U) == 0)) {
          iVar14 = -1;
...
LAB_00127f52:
          ...
          uVar12 = param_1->references;
          if (bVar7 < 3) {
            if (bVar7 == 2) goto LAB_00127fc8;
LAB_00127f16:
            if ((uVar12 & 0x4000000) != 0) goto LAB_00127f52;
            iVar8 = 0x301;
          }
          else {
            if (-1 < (int)(uVar12 << 4)) {
...
LAB_00127fc8:
            if ((uVar12 & 0x10000000) != 0) goto LAB_00127f16;
            iVar8 = 0x302;
          }
        }
        cVar17 = false;
...
LAB_00127d7a:
    ...
    if (((*pbVar11 != 0x16) || (pbVar11[1] != 3)) || (pbVar11[5] != 1)) {
LAB_00127d2a:
      iVar14 = strncmp("GET ",(char *)pbVar11,4);
      if (((iVar14 == 0) || (iVar14 = strncmp("POST ",(char *)pbVar11,5), iVar14 == 0)) ||
         ((iVar14 = strncmp("HEAD ",(char *)pbVar11,5), iVar14 == 0 ||
          (iVar14 = strncmp("PUT ",(char *)pbVar11,4), iVar14 == 0)))) {
        ERR_put_error(0x14,0x76,0x9c,"s23_srvr.c",0x18a);
        return -1;
      }
      iVar14 = strncmp("CONNECT",(char *)pbVar11,7);
      if (iVar14 == 0) {
...
LAB_00127f64:
      ...
      bVar7 = pbVar11[9];
      if (bVar7 < 3) goto LAB_00127d2a;
      if (pbVar11[4] < 6) goto LAB_00127f64;
    }
    else {
      bVar7 = pbVar11[9];
      if (bVar7 < 3) goto LAB_00127d2a;
    ...
    if (bVar7 < 4) {
      ...
      if (bVar7 == 0) {
        if (param_1->references << 6 < 0) {
          if (param_1->references << 5 < 0) goto LAB_00127d7a;
LAB_0012801e:
        ...
        if (2 < bVar7) goto LAB_00127fd4;
        iVar14 = param_1->references;
        if (bVar7 != 1) goto LAB_00127ffc;
LAB_00127ff0:
        if (-1 < iVar14 << 5) goto LAB_0012801e;
        if (iVar14 << 6 < 0) goto LAB_00127d7a;
      }
...
LAB_00127fd4:
      ...
      if (iVar14 << 4 < 0) {
LAB_00127ffc:
        if (iVar14 << 3 < 0) goto LAB_00127ff0;
...
LAB_00127a5c:
  ...
  if ((iVar8 < 0x303) && ((*(uint *)(param_1->cert + 0x38) & 0x30000) != 0)) {
    ERR_put_error(0x14,0x76,0x17b,"s23_srvr.c",0x197);
    return -1;
  }
  if (param_1->state == 0x2211) {
    ...
    if (0x1000 < __n_00) {
      ERR_put_error(0x14,0x76,0xd6,"s23_srvr.c",0x1bc);
      return -1;
    }
    if (__n_00 < 9) {
      iVar14 = 0x1c1;
LAB_00127e12:
      ERR_put_error(0x14,0x76,0xd5,"s23_srvr.c",iVar14);
      return -1;
    }
  ...
  if (iVar8 == 2) {
    ...
    if (iVar8 != 0x303) goto LAB_00127dcc;
...
LAB_00127a82:
    if (2 < uVar12) {
      ERR_put_error(0x14,0x76,0xfc,"s23_srvr.c",0x280);
      return -1;
    }
    param_1->init_num = 0;
...
LAB_00127dcc:
  ERR_put_error(0x14,0x76,0x102,"s23_srvr.c",0x25a);
  return -1;
}
