...
LAB_0019542a:
    ...
    if (a == (RSA_PSS_PARAMS *)0x0) goto LAB_0019542a;
...
LAB_00195406:
      ...
      if (a->hashAlgorithm == (X509_ALGOR *)0x0) {
        ...
        if (0 < iVar1) goto LAB_0019547a;
        goto LAB_00195406;
      }
      iVar1 = i2a_ASN1_OBJECT(param_1,a->hashAlgorithm->algorithm);
      if (iVar1 < 1) goto LAB_00195406;
LAB_0019547a:
      iVar1 = BIO_puts(param_1,"\n");
      if (((iVar1 < 1) || (iVar1 = BIO_indent(param_1,param_4,0x80), iVar1 == 0)) ||
         (iVar1 = BIO_puts(param_1,"Mask Algorithm: "), iVar1 < 1)) goto LAB_00195406;
      if (a->maskGenAlgorithm == (X509_ALGOR *)0x0) {
        ...
        if ((iVar1 < 1) || (iVar1 = BIO_puts(param_1," with "), iVar1 < 1)) goto LAB_00195406;
