...

{
  ...
  if ((it->itype != '\0') && (*pval == (ASN1_VALUE *)0x0)) goto switchD_00159010_default;
  constructed = pcVar5;
  if (pcVar5 != (code *)0x0) {
  ...
  case '\0':
    ...
    if ((local_38 & 6) == 0) {
      ...
      p_Var7 = (_STACK *)*pval;
      if (p_Var7 == (_STACK *)0x0) goto switchD_00159010_default;
      if ((local_38 & 2) == 0) {
        local_3c = 0;
      }
      ...
      if ((constructed == (code *)0x0) || (iVar6 = (*constructed)(6,pval,it,0), iVar6 != 0)) {
        ...
        if (0 < it->tcount) {
          ...
          do {
            ...
            if (pAVar3 == (ASN1_TEMPLATE *)0x0) goto switchD_00159010_default;
