...

{
  ...
  if (((bVar1 & 0xfc) != 0) && ((uVar5 & 0xfffffffc) != 4)) {
    iVar6 = 0x13e;
LAB_00192a10:
    ERR_put_error(0x10,0xa0,0x66,"ec2_oct.c",iVar6);
    return 0;
  }
  if ((bVar1 & 0xfa) == 0) {
    if ((bVar1 & 1) != 0) {
      ERR_put_error(0x10,0xa0,0x66,"ec2_oct.c",0x142);
  ...
  if ((pBVar3 != (BIGNUM *)0x0) &&
    ...
    iVar2 = BN_ucmp(ret,(BIGNUM *)(param_1 + 0x48));
    if (iVar2 < 0) {
      if (uVar7 == 2) {
        ...
        if (pBVar4 == (BIGNUM *)0x0) goto LAB_001929f6;
        iVar6 = BN_ucmp(ret_00,(BIGNUM *)(param_1 + 0x48));
        if (-1 < iVar6) {
          iVar6 = 0x175;
          goto LAB_001929e8;
        }
        if (uVar7 == 6) {
          iVar6 = (**(code **)(*(int *)param_1 + 0x8c))(param_1,pBVar3,ret_00,ret,param_5);
          if (iVar6 == 0) goto LAB_001929f6;
          if (pBVar3->top < 1) {
            uVar7 = 0;
          }
          else {
