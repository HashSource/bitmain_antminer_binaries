...

{
  ...
  if (*param_1 == 0) {
    p_Var3 = lh_new((LHASH_HASH_FN_TYPE)0x19af99,(LHASH_COMP_FN_TYPE)0x19af9d);
    ...
    do {
      while( true ) {
        ...
        if (ptr == (undefined4 *)0x0) {
          ...
          if (ptr == (undefined4 *)0x0) goto LAB_0019b0dc;
          ptr[3] = 1;
          *ptr = *param_4;
          p_Var2 = sk_new_null();
          ptr[1] = p_Var2;
        ...
        ptr[3] = 1;
        param_4 = param_4 + 1;
        if (param_5 == 0) goto LAB_0019b0a4;
      }
      param_5 = param_5 + -1;
      param_4 = param_4 + 1;
    } while (param_5 != 0);
