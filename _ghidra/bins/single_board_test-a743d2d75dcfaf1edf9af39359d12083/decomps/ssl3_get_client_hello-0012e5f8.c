...

{
  ...
  local_30 = (_STACK *)0x0;
  if (iVar14 == 0x2112) {
    if (param_1->max_cert_list != 0) goto LAB_0012e61c;
    iVar14 = -1;
LAB_0012e6f4:
...
LAB_0012e61c:
    ...
    if (-1 < iVar14 << 0x1c) {
      if (param_1->version <= (int)uVar15) goto LAB_0012e772;
LAB_0012e690:
...
LAB_0012e772:
    ...
    *(undefined4 *)(psVar26->client_random + 0x18) = uVar29;
    ...
    if ((param_1->new_session == 0) || (-1 < param_1->references << 0xf)) {
      ...
      if (iVar14 == 1) {
        if (param_1->version != param_1->session->ssl_version) goto LAB_0012e81e;
        param_1->hit = 1;
        goto LAB_0012e82a;
      }
      if (iVar14 != -1) goto LAB_0012e81e;
    }
    else {
LAB_0012e81e:
...
LAB_0012ed24:
              ...
              if (param_1->method->version != 0x1ffff) goto LAB_0012e894;
...
LAB_0012ea1c:
              ...
              if (pbVar11[1] != 0) {
                do {
                  if (pbVar16 == pbVar11 + uVar15) goto LAB_0012ea1c;
                  pbVar16 = pbVar16 + 1;
                } while (*pbVar16 != 0);
              }
...
LAB_0012eb44:
                  if ((psVar26->tmp).new_compression == (SSL_COMP *)0x0) {
                    ...
                    do {
                      pbVar11 = pbVar11 + 1;
                      if (*pbVar11 == uVar25) {
                        if (iVar6 < (int)uVar15) goto LAB_0012eb68;
                        break;
                      }
                      iVar6 = iVar6 + 1;
