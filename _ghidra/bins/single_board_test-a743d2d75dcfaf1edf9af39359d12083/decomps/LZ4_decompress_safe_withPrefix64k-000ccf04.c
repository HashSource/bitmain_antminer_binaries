...
/* WARNING: Removing unreachable block (ram,0x000cd3dc) */
/* WARNING: Removing unreachable block (ram,0x000cd3e6) */
/* WARNING: Removing unreachable block (ram,0x000cd3e8) */
/* WARNING: Removing unreachable block (ram,0x000cd3ea) */
/* WARNING: Removing unreachable block (ram,0x000cd3f0) */
/* WARNING: Removing unreachable block (ram,0x000ccfba) */
...
LAB_000cd118:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000cd874;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000cd874;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_000cd118;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000cd874;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000cd874;
              op = pBVar10;
