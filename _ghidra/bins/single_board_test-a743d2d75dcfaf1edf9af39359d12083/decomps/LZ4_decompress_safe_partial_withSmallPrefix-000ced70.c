...
/* WARNING: Removing unreachable block (ram,0x000cf25e) */
/* WARNING: Removing unreachable block (ram,0x000cf268) */
/* WARNING: Removing unreachable block (ram,0x000cf26a) */
/* WARNING: Removing unreachable block (ram,0x000cf26c) */
/* WARNING: Removing unreachable block (ram,0x000cf272) */
/* WARNING: Removing unreachable block (ram,0x000cee42) */
/* WARNING: Removing unreachable block (ram,0x000cee4a) */
/* WARNING: Removing unreachable block (ram,0x000cee5a) */
/* WARNING: Removing unreachable block (ram,0x000cee52) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

int LZ4_decompress_safe_partial_withSmallPrefix
...
LAB_000cef9a:
            ...
            if (length == 0xf) {
              ...
              if (addl == 0xffffffff) goto LAB_000cf6f6;
              length = addl + length;
              pBVar8 = op;
              if (op + length < op) {
                pBVar8 = (BYTE *)0x1;
            ...
            if ((oend + -0xc < cpy) || (iend + -8 < ip + length)) {
              if (local_24 == 0) {
                if ((iend != ip + length) || (oend < cpy)) goto LAB_000cf6f6;
              }
              else {
                if (iend < ip + length) {
            ...
            if ((bVar7 & bVar6) == 0) goto LAB_000cef9a;
          ...
          if (length == 0xf) {
            ...
            if (addl_1 == 0xffffffff) goto LAB_000cf6f6;
          ...
          if ((local_24 == 0) || (cpy <= oend + -0xc)) {
            ...
            if (cVar5 == '\0') {
              ...
              *(undefined4 *)(op + 0xc) = uVar2;
              ...
              oCopyLimit = oend + -7;
              if (oend + -5 < cpy) goto LAB_000cf6f6;
              op = pBVar10;
