...

{
  ...
  if (gScanCodeGun_data_ready == '\x03') {
    ...
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s: SN data::[%s]\n","scan_code_from_hashboard",0x1016631);
    snprintf(tmp1,0x800,"SN data::[%s]",0x1016631);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    ...
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s: chip_die::[%s].\n","scan_code_from_hashboard",0x10165c0);
    snprintf(tmp1,0x800,"chip_die::[%s].",0x10165c0);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s: chip_marking::[%s].\n","scan_code_from_hashboard",0x10165d0);
    snprintf(tmp1,0x800,"chip_marking::[%s].",0x10165d0);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s: chip_bin::[%s].\n","scan_code_from_hashboard",0x10165e0);
    snprintf(tmp1,0x800,"chip_bin::[%s].",0x10165e0);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s: chip_ftversion::[%s].\n","scan_code_from_hashboard",0x10165f0);
    snprintf(tmp1,0x800,"chip_ftversion::[%s].",0x10165f0);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s: temp_sensor_type::[%s].\n","scan_code_from_hashboard",0x1016600);
    snprintf(tmp1,0x800,"temp_sensor_type::[%s].",0x1016600);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s: hashboard_ctrl_code::[%s].\n","scan_code_from_hashboard",0x1016610);
    snprintf(tmp1,0x800,"hashboard_ctrl_code::[%s].",0x1016610);
    log_to_file(tmp1,time_stamp);
    print_time_stamp(time_stamp,0x30);
    printf("%s ",time_stamp);
    printf("%s: hashboard_index::[%s].\n","scan_code_from_hashboard",0x1016620);
    snprintf(tmp1,0x800,"hashboard_index::[%s].",0x1016620);
    log_to_file(tmp1,time_stamp);
