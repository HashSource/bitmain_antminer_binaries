...
LAB_0012b346:
  ...
  if (uVar14 == 0xc) {
    ...
    {
      if (local_158[1] < uVar17 + uVar14) goto LAB_0012b478;
      local_16c[0] = '\0';
      local_16c[1] = '\0';
      local_16c[2] = '\0';
      local_16c[3] = '\0';
      ...
      if ((((uVar14 < (local_158[2] & 0xffff)) && ((local_158[2] & 0xffff) <= uVar14 + 10)) &&
        ...
        if (uVar17 != local_158[1]) goto LAB_0012b5be;
        uVar14 = param_1[0x42];
        if (uVar14 < 0x454c) {
          uVar14 = 0x454c;
        }
...
LAB_0012b52e:
          ...
          if (ppVar8 != (pitem *)0x0) {
            ...
            if (ppVar8 != (pitem *)0x0) goto LAB_0012b196;
          ...
          if (uVar17 == uVar14) {
            if (0 < (int)uVar14) goto LAB_0012b52e;
          }
          else {
            uVar14 = 0xffffffff;
          }
...
LAB_0012b56c:
  ...
  if (0 < (int)uVar14) goto LAB_0012b566;
  uVar12 = uVar14 + 3;
LAB_0012b47e:
  *param_6 = 0;
LAB_0012b34a:
