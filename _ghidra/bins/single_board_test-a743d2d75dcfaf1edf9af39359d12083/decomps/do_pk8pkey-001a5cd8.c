...

{
  ...
  if (param_4 != -1 || param_5 != (EVP_CIPHER *)0x0) {
    ...
    if (param_3 == 0) {
      iVar1 = PEM_ASN1_write_bio((undefined1 *)0x156ea5,"ENCRYPTED PRIVATE KEY",param_1,p8,
  ...
  if (param_3 == 0) {
    iVar1 = PEM_ASN1_write_bio((undefined1 *)0x15c04d,"PRIVATE KEY",param_1,p8inf,(EVP_CIPHER *)0x0,
