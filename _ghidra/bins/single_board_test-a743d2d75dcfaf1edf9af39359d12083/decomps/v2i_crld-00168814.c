              ...
              if (p_Var6 == (_STACK *)0x0) {
                ...
                *(undefined4 *)(pAVar3 + 8) = 0;
                ...
                if (*pcVar9 == '@') {
                  ...
                  sk_pop_free(p_Var6,(func *)0x164dc9);
                }
                *(GENERAL_NAMES **)(pAVar3 + 8) = pGVar7;
                if (pGVar7 != (GENERAL_NAMES *)0x0) goto LAB_001688d0;
              }
              goto LAB_0016894c;
            }
          }
LAB_001688d0:
        ...
        if (p_Var6 == (_STACK *)0x0) goto LAB_001689e4;
