...

{
  ...
  if (((0 < numasc) && (-1 < asc_local)) && (asc_local < numasc)) {
    ...
    if (-1 < dev) {
      ...
      uVar2 = (uint)cgpu->diff1;
      if (uVar1 + uVar2 == 0 &&
          ((int)uVar1 >> 0x1f) + *(int *)((int)&cgpu->diff1 + 4) + (uint)CARRY4(uVar1,uVar2) == 0) {
        hwp = 0.0;
      }
      else {
        ...
        uVar1 = cgpu->hw_errors;
        uVar2 = (uint)cgpu->diff1;
        dVar4 = (double)__aeabi_l2d(uVar1 + uVar2,
                                    ((int)uVar1 >> 0x1f) +
                                    *(int *)((int)&cgpu->diff1 + 4) + (uint)CARRY4(uVar1,uVar2));
