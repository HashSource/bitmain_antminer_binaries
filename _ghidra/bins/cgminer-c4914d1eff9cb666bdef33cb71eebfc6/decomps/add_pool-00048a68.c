...

{
  ...
  ppVar2 = (pool *)_cgcalloc(0x738,1,"cgminer.c","add_pool",0x2e5);
  uVar1 = tmp42._32_4_;
  ...
  *pppVar4 = ppVar2;
  _mutex_init(&ppVar2->pool_lock,"cgminer.c","add_pool",0x2f4);
  ...
  _cglock_init(&ppVar2->data_lock,"cgminer.c","add_pool",0x2fb);
  _mutex_init(&ppVar2->stratum_lock,"cgminer.c","add_pool",0x2fc);
  _cglock_init(&ppVar2->gbt_lock,"cgminer.c","add_pool",0x2fd);
